...
type
  Call_ApproveSkill_593774 = ref object of OpenApiRestCall_593437
proc url_ApproveSkill_593776(protocol: Scheme; host: string; base: string;
...
proc validate_ApproveSkill_593775(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593932: Call_ApproveSkill_593774; path: JsonNode; query: JsonNode;
...
proc call*(call_594003: Call_ApproveSkill_593774; body: JsonNode): Recallable =
  ## approveSkill
  ## Associates a skill with the organization under the customer's AWS account. If a skill is private, the user implicitly accepts access to this skill during enablement.
  ##   body: JObject (required)
...
var approveSkill* = Call_ApproveSkill_593774(name: "approveSkill",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ApproveSkill",
    validator: validate_ApproveSkill_593775, base: "/", url: url_ApproveSkill_593776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateContactWithAddressBook_594043 = ref object of OpenApiRestCall_593437
proc url_AssociateContactWithAddressBook_594045(protocol: Scheme; host: string;
...
proc validate_AssociateContactWithAddressBook_594044(path: JsonNode;
...
proc call*(call_594055: Call_AssociateContactWithAddressBook_594043;
...
proc call*(call_594056: Call_AssociateContactWithAddressBook_594043; body: JsonNode): Recallable =
...
var associateContactWithAddressBook* = Call_AssociateContactWithAddressBook_594043(
    ...
    validator: validate_AssociateContactWithAddressBook_594044, base: "/",
    url: url_AssociateContactWithAddressBook_594045,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateDeviceWithNetworkProfile_594058 = ref object of OpenApiRestCall_593437
proc url_AssociateDeviceWithNetworkProfile_594060(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AssociateDeviceWithNetworkProfile_594059(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594070: Call_AssociateDeviceWithNetworkProfile_594058;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Associates a device with the specified network profile.
  ## 
...
proc call*(call_594071: Call_AssociateDeviceWithNetworkProfile_594058;
          body: JsonNode): Recallable =
...
var associateDeviceWithNetworkProfile* = Call_AssociateDeviceWithNetworkProfile_594058(
    ...
    validator: validate_AssociateDeviceWithNetworkProfile_594059, base: "/",
    url: url_AssociateDeviceWithNetworkProfile_594060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateDeviceWithRoom_594073 = ref object of OpenApiRestCall_593437
proc url_AssociateDeviceWithRoom_594075(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateDeviceWithRoom_594074(path: JsonNode; query: JsonNode;
...
proc call*(call_594085: Call_AssociateDeviceWithRoom_594073; path: JsonNode;
...
proc call*(call_594086: Call_AssociateDeviceWithRoom_594073; body: JsonNode): Recallable =
...
var associateDeviceWithRoom* = Call_AssociateDeviceWithRoom_594073(
    name: "associateDeviceWithRoom", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.AssociateDeviceWithRoom",
    validator: validate_AssociateDeviceWithRoom_594074, base: "/",
    url: url_AssociateDeviceWithRoom_594075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateSkillGroupWithRoom_594088 = ref object of OpenApiRestCall_593437
proc url_AssociateSkillGroupWithRoom_594090(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AssociateSkillGroupWithRoom_594089(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594100: Call_AssociateSkillGroupWithRoom_594088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a skill group with a given room. This enables all skills in the associated skill group on all devices in the room.
  ## 
...
proc call*(call_594101: Call_AssociateSkillGroupWithRoom_594088; body: JsonNode): Recallable =
...
var associateSkillGroupWithRoom* = Call_AssociateSkillGroupWithRoom_594088(
    name: "associateSkillGroupWithRoom", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.AssociateSkillGroupWithRoom",
    validator: validate_AssociateSkillGroupWithRoom_594089, base: "/",
    url: url_AssociateSkillGroupWithRoom_594090,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateSkillWithSkillGroup_594103 = ref object of OpenApiRestCall_593437
proc url_AssociateSkillWithSkillGroup_594105(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AssociateSkillWithSkillGroup_594104(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594115: Call_AssociateSkillWithSkillGroup_594103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a skill with a skill group.
  ## 
...
proc call*(call_594116: Call_AssociateSkillWithSkillGroup_594103; body: JsonNode): Recallable =
...
var associateSkillWithSkillGroup* = Call_AssociateSkillWithSkillGroup_594103(
    ...
    validator: validate_AssociateSkillWithSkillGroup_594104, base: "/",
    url: url_AssociateSkillWithSkillGroup_594105,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateSkillWithUsers_594118 = ref object of OpenApiRestCall_593437
proc url_AssociateSkillWithUsers_594120(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_AssociateSkillWithUsers_594119(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594130: Call_AssociateSkillWithUsers_594118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Makes a private skill available for enrolled users to enable on their devices.
  ## 
...
proc call*(call_594131: Call_AssociateSkillWithUsers_594118; body: JsonNode): Recallable =
...
var associateSkillWithUsers* = Call_AssociateSkillWithUsers_594118(
    name: "associateSkillWithUsers", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.AssociateSkillWithUsers",
    validator: validate_AssociateSkillWithUsers_594119, base: "/",
    url: url_AssociateSkillWithUsers_594120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAddressBook_594133 = ref object of OpenApiRestCall_593437
proc url_CreateAddressBook_594135(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAddressBook_594134(path: JsonNode; query: JsonNode;
...
proc call*(call_594145: Call_CreateAddressBook_594133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates an address book with the specified details.
  ## 
...
proc call*(call_594146: Call_CreateAddressBook_594133; body: JsonNode): Recallable =
  ## createAddressBook
  ## Creates an address book with the specified details.
  ##   body: JObject (required)
...
var createAddressBook* = Call_CreateAddressBook_594133(name: "createAddressBook",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateAddressBook",
    validator: validate_CreateAddressBook_594134, base: "/",
    url: url_CreateAddressBook_594135, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateBusinessReportSchedule_594148 = ref object of OpenApiRestCall_593437
proc url_CreateBusinessReportSchedule_594150(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateBusinessReportSchedule_594149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594160: Call_CreateBusinessReportSchedule_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a recurring schedule for usage reports to deliver to the specified S3 location with a specified daily or weekly interval.
  ## 
...
proc call*(call_594161: Call_CreateBusinessReportSchedule_594148; body: JsonNode): Recallable =
...
var createBusinessReportSchedule* = Call_CreateBusinessReportSchedule_594148(
    ...
    validator: validate_CreateBusinessReportSchedule_594149, base: "/",
    url: url_CreateBusinessReportSchedule_594150,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateConferenceProvider_594163 = ref object of OpenApiRestCall_593437
proc url_CreateConferenceProvider_594165(protocol: Scheme; host: string;
...
proc validate_CreateConferenceProvider_594164(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594175: Call_CreateConferenceProvider_594163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds a new conference provider under the user's AWS account.
  ## 
...
proc call*(call_594176: Call_CreateConferenceProvider_594163; body: JsonNode): Recallable =
...
var createConferenceProvider* = Call_CreateConferenceProvider_594163(
    name: "createConferenceProvider", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateConferenceProvider",
    validator: validate_CreateConferenceProvider_594164, base: "/",
    url: url_CreateConferenceProvider_594165, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateContact_594178 = ref object of OpenApiRestCall_593437
proc url_CreateContact_594180(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateContact_594179(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594190: Call_CreateContact_594178; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a contact with the specified details.
  ## 
...
proc call*(call_594191: Call_CreateContact_594178; body: JsonNode): Recallable =
  ## createContact
  ## Creates a contact with the specified details.
  ##   body: JObject (required)
...
var createContact* = Call_CreateContact_594178(name: "createContact",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateContact",
    validator: validate_CreateContact_594179, base: "/", url: url_CreateContact_594180,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateGatewayGroup_594193 = ref object of OpenApiRestCall_593437
proc url_CreateGatewayGroup_594195(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateGatewayGroup_594194(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594205: Call_CreateGatewayGroup_594193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a gateway group with the specified details.
  ## 
...
proc call*(call_594206: Call_CreateGatewayGroup_594193; body: JsonNode): Recallable =
  ## createGatewayGroup
  ## Creates a gateway group with the specified details.
  ##   body: JObject (required)
...
var createGatewayGroup* = Call_CreateGatewayGroup_594193(
    name: "createGatewayGroup", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateGatewayGroup",
    validator: validate_CreateGatewayGroup_594194, base: "/",
    url: url_CreateGatewayGroup_594195, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateNetworkProfile_594208 = ref object of OpenApiRestCall_593437
proc url_CreateNetworkProfile_594210(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateNetworkProfile_594209(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594220: Call_CreateNetworkProfile_594208; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a network profile with the specified details.
  ## 
...
proc call*(call_594221: Call_CreateNetworkProfile_594208; body: JsonNode): Recallable =
...
var createNetworkProfile* = Call_CreateNetworkProfile_594208(
    name: "createNetworkProfile", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateNetworkProfile",
    validator: validate_CreateNetworkProfile_594209, base: "/",
    url: url_CreateNetworkProfile_594210, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProfile_594223 = ref object of OpenApiRestCall_593437
proc url_CreateProfile_594225(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateProfile_594224(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594235: Call_CreateProfile_594223; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new room profile with the specified details.
  ## 
...
proc call*(call_594236: Call_CreateProfile_594223; body: JsonNode): Recallable =
  ## createProfile
  ## Creates a new room profile with the specified details.
  ##   body: JObject (required)
...
var createProfile* = Call_CreateProfile_594223(name: "createProfile",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateProfile",
    validator: validate_CreateProfile_594224, base: "/", url: url_CreateProfile_594225,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRoom_594238 = ref object of OpenApiRestCall_593437
proc url_CreateRoom_594240(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateRoom_594239(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594250: Call_CreateRoom_594238; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a room with the specified details.
  ## 
...
proc call*(call_594251: Call_CreateRoom_594238; body: JsonNode): Recallable =
  ## createRoom
  ## Creates a room with the specified details.
  ##   body: JObject (required)
...
var createRoom* = Call_CreateRoom_594238(name: "createRoom",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.CreateRoom",
                                      validator: validate_CreateRoom_594239,
                                      base: "/", url: url_CreateRoom_594240,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSkillGroup_594253 = ref object of OpenApiRestCall_593437
proc url_CreateSkillGroup_594255(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSkillGroup_594254(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594265: Call_CreateSkillGroup_594253; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a skill group with a specified name and description.
  ## 
...
proc call*(call_594266: Call_CreateSkillGroup_594253; body: JsonNode): Recallable =
  ## createSkillGroup
  ## Creates a skill group with a specified name and description.
  ##   body: JObject (required)
...
var createSkillGroup* = Call_CreateSkillGroup_594253(name: "createSkillGroup",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.CreateSkillGroup",
    validator: validate_CreateSkillGroup_594254, base: "/",
    url: url_CreateSkillGroup_594255, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUser_594268 = ref object of OpenApiRestCall_593437
proc url_CreateUser_594270(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUser_594269(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a user.
  ## 
  var section: JsonNode
...
proc call*(call_594280: Call_CreateUser_594268; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a user.
  ## 
...
proc call*(call_594281: Call_CreateUser_594268; body: JsonNode): Recallable =
  ## createUser
  ## Creates a user.
  ##   body: JObject (required)
...
var createUser* = Call_CreateUser_594268(name: "createUser",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.CreateUser",
                                      validator: validate_CreateUser_594269,
                                      base: "/", url: url_CreateUser_594270,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAddressBook_594283 = ref object of OpenApiRestCall_593437
proc url_DeleteAddressBook_594285(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAddressBook_594284(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594295: Call_DeleteAddressBook_594283; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an address book by the address book ARN.
  ## 
...
proc call*(call_594296: Call_DeleteAddressBook_594283; body: JsonNode): Recallable =
  ## deleteAddressBook
  ## Deletes an address book by the address book ARN.
  ##   body: JObject (required)
...
var deleteAddressBook* = Call_DeleteAddressBook_594283(name: "deleteAddressBook",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteAddressBook",
    validator: validate_DeleteAddressBook_594284, base: "/",
    url: url_DeleteAddressBook_594285, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBusinessReportSchedule_594298 = ref object of OpenApiRestCall_593437
proc url_DeleteBusinessReportSchedule_594300(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteBusinessReportSchedule_594299(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594310: Call_DeleteBusinessReportSchedule_594298; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the recurring report delivery schedule with the specified schedule ARN.
  ## 
...
proc call*(call_594311: Call_DeleteBusinessReportSchedule_594298; body: JsonNode): Recallable =
...
var deleteBusinessReportSchedule* = Call_DeleteBusinessReportSchedule_594298(
    ...
    validator: validate_DeleteBusinessReportSchedule_594299, base: "/",
    url: url_DeleteBusinessReportSchedule_594300,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConferenceProvider_594313 = ref object of OpenApiRestCall_593437
proc url_DeleteConferenceProvider_594315(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteConferenceProvider_594314(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594325: Call_DeleteConferenceProvider_594313; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a conference provider.
  ## 
...
proc call*(call_594326: Call_DeleteConferenceProvider_594313; body: JsonNode): Recallable =
...
var deleteConferenceProvider* = Call_DeleteConferenceProvider_594313(
    name: "deleteConferenceProvider", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteConferenceProvider",
    validator: validate_DeleteConferenceProvider_594314, base: "/",
    url: url_DeleteConferenceProvider_594315, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteContact_594328 = ref object of OpenApiRestCall_593437
proc url_DeleteContact_594330(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteContact_594329(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594340: Call_DeleteContact_594328; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a contact by the contact ARN.
  ## 
...
proc call*(call_594341: Call_DeleteContact_594328; body: JsonNode): Recallable =
  ## deleteContact
  ## Deletes a contact by the contact ARN.
  ##   body: JObject (required)
...
var deleteContact* = Call_DeleteContact_594328(name: "deleteContact",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteContact",
    validator: validate_DeleteContact_594329, base: "/", url: url_DeleteContact_594330,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDevice_594343 = ref object of OpenApiRestCall_593437
proc url_DeleteDevice_594345(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDevice_594344(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594355: Call_DeleteDevice_594343; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a device from Alexa For Business.
  ## 
...
proc call*(call_594356: Call_DeleteDevice_594343; body: JsonNode): Recallable =
  ## deleteDevice
  ## Removes a device from Alexa For Business.
  ##   body: JObject (required)
...
var deleteDevice* = Call_DeleteDevice_594343(name: "deleteDevice",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteDevice",
    validator: validate_DeleteDevice_594344, base: "/", url: url_DeleteDevice_594345,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDeviceUsageData_594358 = ref object of OpenApiRestCall_593437
proc url_DeleteDeviceUsageData_594360(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDeviceUsageData_594359(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594370: Call_DeleteDeviceUsageData_594358; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## When this action is called for a specified shared device, it allows authorized users to delete the device's entire previous history of voice input data and associated response data. This action can be called once every 24 hours for a specific shared device.
  ## 
...
proc call*(call_594371: Call_DeleteDeviceUsageData_594358; body: JsonNode): Recallable =
...
var deleteDeviceUsageData* = Call_DeleteDeviceUsageData_594358(
    name: "deleteDeviceUsageData", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteDeviceUsageData",
    validator: validate_DeleteDeviceUsageData_594359, base: "/",
    url: url_DeleteDeviceUsageData_594360, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteGatewayGroup_594373 = ref object of OpenApiRestCall_593437
proc url_DeleteGatewayGroup_594375(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteGatewayGroup_594374(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594385: Call_DeleteGatewayGroup_594373; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a gateway group.
  ## 
...
proc call*(call_594386: Call_DeleteGatewayGroup_594373; body: JsonNode): Recallable =
  ## deleteGatewayGroup
  ## Deletes a gateway group.
  ##   body: JObject (required)
...
var deleteGatewayGroup* = Call_DeleteGatewayGroup_594373(
    name: "deleteGatewayGroup", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteGatewayGroup",
    validator: validate_DeleteGatewayGroup_594374, base: "/",
    url: url_DeleteGatewayGroup_594375, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteNetworkProfile_594388 = ref object of OpenApiRestCall_593437
proc url_DeleteNetworkProfile_594390(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteNetworkProfile_594389(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594400: Call_DeleteNetworkProfile_594388; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a network profile by the network profile ARN.
  ## 
...
proc call*(call_594401: Call_DeleteNetworkProfile_594388; body: JsonNode): Recallable =
...
var deleteNetworkProfile* = Call_DeleteNetworkProfile_594388(
    name: "deleteNetworkProfile", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteNetworkProfile",
    validator: validate_DeleteNetworkProfile_594389, base: "/",
    url: url_DeleteNetworkProfile_594390, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProfile_594403 = ref object of OpenApiRestCall_593437
proc url_DeleteProfile_594405(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProfile_594404(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594415: Call_DeleteProfile_594403; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a room profile by the profile ARN.
  ## 
...
proc call*(call_594416: Call_DeleteProfile_594403; body: JsonNode): Recallable =
  ## deleteProfile
  ## Deletes a room profile by the profile ARN.
  ##   body: JObject (required)
...
var deleteProfile* = Call_DeleteProfile_594403(name: "deleteProfile",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteProfile",
    validator: validate_DeleteProfile_594404, base: "/", url: url_DeleteProfile_594405,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRoom_594418 = ref object of OpenApiRestCall_593437
proc url_DeleteRoom_594420(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRoom_594419(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594430: Call_DeleteRoom_594418; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a room by the room ARN.
  ## 
...
proc call*(call_594431: Call_DeleteRoom_594418; body: JsonNode): Recallable =
  ## deleteRoom
  ## Deletes a room by the room ARN.
  ##   body: JObject (required)
...
var deleteRoom* = Call_DeleteRoom_594418(name: "deleteRoom",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.DeleteRoom",
                                      validator: validate_DeleteRoom_594419,
                                      base: "/", url: url_DeleteRoom_594420,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRoomSkillParameter_594433 = ref object of OpenApiRestCall_593437
proc url_DeleteRoomSkillParameter_594435(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteRoomSkillParameter_594434(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594445: Call_DeleteRoomSkillParameter_594433; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes room skill parameter details by room, skill, and parameter key ID.
  ## 
...
proc call*(call_594446: Call_DeleteRoomSkillParameter_594433; body: JsonNode): Recallable =
...
var deleteRoomSkillParameter* = Call_DeleteRoomSkillParameter_594433(
    name: "deleteRoomSkillParameter", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteRoomSkillParameter",
    validator: validate_DeleteRoomSkillParameter_594434, base: "/",
    url: url_DeleteRoomSkillParameter_594435, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSkillAuthorization_594448 = ref object of OpenApiRestCall_593437
proc url_DeleteSkillAuthorization_594450(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteSkillAuthorization_594449(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594460: Call_DeleteSkillAuthorization_594448; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Unlinks a third-party account from a skill.
  ## 
...
proc call*(call_594461: Call_DeleteSkillAuthorization_594448; body: JsonNode): Recallable =
...
var deleteSkillAuthorization* = Call_DeleteSkillAuthorization_594448(
    name: "deleteSkillAuthorization", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteSkillAuthorization",
    validator: validate_DeleteSkillAuthorization_594449, base: "/",
    url: url_DeleteSkillAuthorization_594450, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSkillGroup_594463 = ref object of OpenApiRestCall_593437
proc url_DeleteSkillGroup_594465(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteSkillGroup_594464(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594475: Call_DeleteSkillGroup_594463; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a skill group by skill group ARN.
  ## 
...
proc call*(call_594476: Call_DeleteSkillGroup_594463; body: JsonNode): Recallable =
  ## deleteSkillGroup
  ## Deletes a skill group by skill group ARN.
  ##   body: JObject (required)
...
var deleteSkillGroup* = Call_DeleteSkillGroup_594463(name: "deleteSkillGroup",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DeleteSkillGroup",
    validator: validate_DeleteSkillGroup_594464, base: "/",
    url: url_DeleteSkillGroup_594465, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUser_594478 = ref object of OpenApiRestCall_593437
proc url_DeleteUser_594480(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUser_594479(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594490: Call_DeleteUser_594478; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a specified user by user ARN and enrollment ARN.
  ## 
...
proc call*(call_594491: Call_DeleteUser_594478; body: JsonNode): Recallable =
  ## deleteUser
  ## Deletes a specified user by user ARN and enrollment ARN.
  ##   body: JObject (required)
...
var deleteUser* = Call_DeleteUser_594478(name: "deleteUser",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.DeleteUser",
                                      validator: validate_DeleteUser_594479,
                                      base: "/", url: url_DeleteUser_594480,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateContactFromAddressBook_594493 = ref object of OpenApiRestCall_593437
proc url_DisassociateContactFromAddressBook_594495(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateContactFromAddressBook_594494(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594505: Call_DisassociateContactFromAddressBook_594493;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Disassociates a contact from a given address book.
  ## 
...
proc call*(call_594506: Call_DisassociateContactFromAddressBook_594493;
          body: JsonNode): Recallable =
...
var disassociateContactFromAddressBook* = Call_DisassociateContactFromAddressBook_594493(
    ...
    validator: validate_DisassociateContactFromAddressBook_594494, base: "/",
    url: url_DisassociateContactFromAddressBook_594495,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateDeviceFromRoom_594508 = ref object of OpenApiRestCall_593437
proc url_DisassociateDeviceFromRoom_594510(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateDeviceFromRoom_594509(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594520: Call_DisassociateDeviceFromRoom_594508; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates a device from its current room. The device continues to be connected to the Wi-Fi network and is still registered to the account. The device settings and skills are removed from the room.
  ## 
...
proc call*(call_594521: Call_DisassociateDeviceFromRoom_594508; body: JsonNode): Recallable =
...
var disassociateDeviceFromRoom* = Call_DisassociateDeviceFromRoom_594508(
    name: "disassociateDeviceFromRoom", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DisassociateDeviceFromRoom",
    validator: validate_DisassociateDeviceFromRoom_594509, base: "/",
    url: url_DisassociateDeviceFromRoom_594510,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateSkillFromSkillGroup_594523 = ref object of OpenApiRestCall_593437
proc url_DisassociateSkillFromSkillGroup_594525(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateSkillFromSkillGroup_594524(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594535: Call_DisassociateSkillFromSkillGroup_594523;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Disassociates a skill from a skill group.
  ## 
...
proc call*(call_594536: Call_DisassociateSkillFromSkillGroup_594523; body: JsonNode): Recallable =
...
var disassociateSkillFromSkillGroup* = Call_DisassociateSkillFromSkillGroup_594523(
    ...
    validator: validate_DisassociateSkillFromSkillGroup_594524, base: "/",
    url: url_DisassociateSkillFromSkillGroup_594525,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateSkillFromUsers_594538 = ref object of OpenApiRestCall_593437
proc url_DisassociateSkillFromUsers_594540(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateSkillFromUsers_594539(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594550: Call_DisassociateSkillFromUsers_594538; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Makes a private skill unavailable for enrolled users and prevents them from enabling it on their devices.
  ## 
...
proc call*(call_594551: Call_DisassociateSkillFromUsers_594538; body: JsonNode): Recallable =
...
var disassociateSkillFromUsers* = Call_DisassociateSkillFromUsers_594538(
    name: "disassociateSkillFromUsers", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.DisassociateSkillFromUsers",
    validator: validate_DisassociateSkillFromUsers_594539, base: "/",
    url: url_DisassociateSkillFromUsers_594540,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateSkillGroupFromRoom_594553 = ref object of OpenApiRestCall_593437
proc url_DisassociateSkillGroupFromRoom_594555(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateSkillGroupFromRoom_594554(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594565: Call_DisassociateSkillGroupFromRoom_594553; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates a skill group from a specified room. This disables all skills in the skill group on all devices in the room.
  ## 
...
proc call*(call_594566: Call_DisassociateSkillGroupFromRoom_594553; body: JsonNode): Recallable =
...
var disassociateSkillGroupFromRoom* = Call_DisassociateSkillGroupFromRoom_594553(
    ...
    validator: validate_DisassociateSkillGroupFromRoom_594554, base: "/",
    url: url_DisassociateSkillGroupFromRoom_594555,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ForgetSmartHomeAppliances_594568 = ref object of OpenApiRestCall_593437
proc url_ForgetSmartHomeAppliances_594570(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ForgetSmartHomeAppliances_594569(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594580: Call_ForgetSmartHomeAppliances_594568; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Forgets smart home appliances associated to a room.
  ## 
...
proc call*(call_594581: Call_ForgetSmartHomeAppliances_594568; body: JsonNode): Recallable =
...
var forgetSmartHomeAppliances* = Call_ForgetSmartHomeAppliances_594568(
    name: "forgetSmartHomeAppliances", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ForgetSmartHomeAppliances",
    validator: validate_ForgetSmartHomeAppliances_594569, base: "/",
    url: url_ForgetSmartHomeAppliances_594570,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAddressBook_594583 = ref object of OpenApiRestCall_593437
proc url_GetAddressBook_594585(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAddressBook_594584(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594595: Call_GetAddressBook_594583; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets address the book details by the address book ARN.
  ## 
...
proc call*(call_594596: Call_GetAddressBook_594583; body: JsonNode): Recallable =
  ## getAddressBook
  ## Gets address the book details by the address book ARN.
  ##   body: JObject (required)
...
var getAddressBook* = Call_GetAddressBook_594583(name: "getAddressBook",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetAddressBook",
    validator: validate_GetAddressBook_594584, base: "/", url: url_GetAddressBook_594585,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetConferencePreference_594598 = ref object of OpenApiRestCall_593437
proc url_GetConferencePreference_594600(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetConferencePreference_594599(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594610: Call_GetConferencePreference_594598; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the existing conference preferences.
  ## 
...
proc call*(call_594611: Call_GetConferencePreference_594598; body: JsonNode): Recallable =
...
var getConferencePreference* = Call_GetConferencePreference_594598(
    name: "getConferencePreference", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetConferencePreference",
    validator: validate_GetConferencePreference_594599, base: "/",
    url: url_GetConferencePreference_594600, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetConferenceProvider_594613 = ref object of OpenApiRestCall_593437
proc url_GetConferenceProvider_594615(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetConferenceProvider_594614(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594625: Call_GetConferenceProvider_594613; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets details about a specific conference provider.
  ## 
...
proc call*(call_594626: Call_GetConferenceProvider_594613; body: JsonNode): Recallable =
...
var getConferenceProvider* = Call_GetConferenceProvider_594613(
    name: "getConferenceProvider", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetConferenceProvider",
    validator: validate_GetConferenceProvider_594614, base: "/",
    url: url_GetConferenceProvider_594615, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetContact_594628 = ref object of OpenApiRestCall_593437
proc url_GetContact_594630(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetContact_594629(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594640: Call_GetContact_594628; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the contact details by the contact ARN.
  ## 
...
proc call*(call_594641: Call_GetContact_594628; body: JsonNode): Recallable =
  ## getContact
  ## Gets the contact details by the contact ARN.
  ##   body: JObject (required)
...
var getContact* = Call_GetContact_594628(name: "getContact",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.GetContact",
                                      validator: validate_GetContact_594629,
                                      base: "/", url: url_GetContact_594630,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDevice_594643 = ref object of OpenApiRestCall_593437
proc url_GetDevice_594645(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDevice_594644(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594655: Call_GetDevice_594643; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of a device by device ARN.
  ## 
...
proc call*(call_594656: Call_GetDevice_594643; body: JsonNode): Recallable =
  ## getDevice
  ## Gets the details of a device by device ARN.
  ##   body: JObject (required)
...
var getDevice* = Call_GetDevice_594643(name: "getDevice", meth: HttpMethod.HttpPost,
                                    host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.GetDevice",
                                    validator: validate_GetDevice_594644,
                                    base: "/", url: url_GetDevice_594645,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetGateway_594658 = ref object of OpenApiRestCall_593437
proc url_GetGateway_594660(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetGateway_594659(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594670: Call_GetGateway_594658; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the details of a gateway.
  ## 
...
proc call*(call_594671: Call_GetGateway_594658; body: JsonNode): Recallable =
  ## getGateway
  ## Retrieves the details of a gateway.
  ##   body: JObject (required)
...
var getGateway* = Call_GetGateway_594658(name: "getGateway",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.GetGateway",
                                      validator: validate_GetGateway_594659,
                                      base: "/", url: url_GetGateway_594660,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetGatewayGroup_594673 = ref object of OpenApiRestCall_593437
proc url_GetGatewayGroup_594675(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetGatewayGroup_594674(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594685: Call_GetGatewayGroup_594673; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the details of a gateway group.
  ## 
...
proc call*(call_594686: Call_GetGatewayGroup_594673; body: JsonNode): Recallable =
  ## getGatewayGroup
  ## Retrieves the details of a gateway group.
  ##   body: JObject (required)
...
var getGatewayGroup* = Call_GetGatewayGroup_594673(name: "getGatewayGroup",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetGatewayGroup",
    validator: validate_GetGatewayGroup_594674, base: "/", url: url_GetGatewayGroup_594675,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInvitationConfiguration_594688 = ref object of OpenApiRestCall_593437
proc url_GetInvitationConfiguration_594690(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetInvitationConfiguration_594689(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594700: Call_GetInvitationConfiguration_594688; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the configured values for the user enrollment invitation email template.
  ## 
...
proc call*(call_594701: Call_GetInvitationConfiguration_594688; body: JsonNode): Recallable =
...
var getInvitationConfiguration* = Call_GetInvitationConfiguration_594688(
    name: "getInvitationConfiguration", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetInvitationConfiguration",
    validator: validate_GetInvitationConfiguration_594689, base: "/",
    url: url_GetInvitationConfiguration_594690,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetNetworkProfile_594703 = ref object of OpenApiRestCall_593437
proc url_GetNetworkProfile_594705(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetNetworkProfile_594704(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594715: Call_GetNetworkProfile_594703; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the network profile details by the network profile ARN.
  ## 
...
proc call*(call_594716: Call_GetNetworkProfile_594703; body: JsonNode): Recallable =
  ## getNetworkProfile
  ## Gets the network profile details by the network profile ARN.
  ##   body: JObject (required)
...
var getNetworkProfile* = Call_GetNetworkProfile_594703(name: "getNetworkProfile",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetNetworkProfile",
    validator: validate_GetNetworkProfile_594704, base: "/",
    url: url_GetNetworkProfile_594705, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetProfile_594718 = ref object of OpenApiRestCall_593437
proc url_GetProfile_594720(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetProfile_594719(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594730: Call_GetProfile_594718; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of a room profile by profile ARN.
  ## 
...
proc call*(call_594731: Call_GetProfile_594718; body: JsonNode): Recallable =
  ## getProfile
  ## Gets the details of a room profile by profile ARN.
  ##   body: JObject (required)
...
var getProfile* = Call_GetProfile_594718(name: "getProfile",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.GetProfile",
                                      validator: validate_GetProfile_594719,
                                      base: "/", url: url_GetProfile_594720,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRoom_594733 = ref object of OpenApiRestCall_593437
proc url_GetRoom_594735(protocol: Scheme; host: string; base: string; route: string;
                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRoom_594734(path: JsonNode; query: JsonNode; header: JsonNode;
                            formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594745: Call_GetRoom_594733; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets room details by room ARN.
  ## 
...
proc call*(call_594746: Call_GetRoom_594733; body: JsonNode): Recallable =
  ## getRoom
  ## Gets room details by room ARN.
  ##   body: JObject (required)
...
var getRoom* = Call_GetRoom_594733(name: "getRoom", meth: HttpMethod.HttpPost,
                                host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.GetRoom",
                                validator: validate_GetRoom_594734, base: "/",
                                url: url_GetRoom_594735,
                                schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRoomSkillParameter_594748 = ref object of OpenApiRestCall_593437
proc url_GetRoomSkillParameter_594750(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRoomSkillParameter_594749(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594760: Call_GetRoomSkillParameter_594748; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets room skill parameter details by room, skill, and parameter key ARN.
  ## 
...
proc call*(call_594761: Call_GetRoomSkillParameter_594748; body: JsonNode): Recallable =
...
var getRoomSkillParameter* = Call_GetRoomSkillParameter_594748(
    name: "getRoomSkillParameter", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetRoomSkillParameter",
    validator: validate_GetRoomSkillParameter_594749, base: "/",
    url: url_GetRoomSkillParameter_594750, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSkillGroup_594763 = ref object of OpenApiRestCall_593437
proc url_GetSkillGroup_594765(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetSkillGroup_594764(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594775: Call_GetSkillGroup_594763; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets skill group details by skill group ARN.
  ## 
...
proc call*(call_594776: Call_GetSkillGroup_594763; body: JsonNode): Recallable =
  ## getSkillGroup
  ## Gets skill group details by skill group ARN.
  ##   body: JObject (required)
...
var getSkillGroup* = Call_GetSkillGroup_594763(name: "getSkillGroup",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.GetSkillGroup",
    validator: validate_GetSkillGroup_594764, base: "/", url: url_GetSkillGroup_594765,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListBusinessReportSchedules_594778 = ref object of OpenApiRestCall_593437
proc url_ListBusinessReportSchedules_594780(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListBusinessReportSchedules_594779(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594781 = query.getOrDefault("NextToken")
  valid_594781 = validateParameter(valid_594781, JString, required = false,
                                 default = nil)
  if valid_594781 != nil:
    section.add "NextToken", valid_594781
  var valid_594782 = query.getOrDefault("MaxResults")
  valid_594782 = validateParameter(valid_594782, JString, required = false,
                                 default = nil)
  if valid_594782 != nil:
    section.add "MaxResults", valid_594782
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594792: Call_ListBusinessReportSchedules_594778; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the details of the schedules that a user configured.
  ## 
...
proc call*(call_594793: Call_ListBusinessReportSchedules_594778; body: JsonNode;
  ...
  add(query_594794, "NextToken", newJString(NextToken))
  if body != nil:
    body_594795 = body
  add(query_594794, "MaxResults", newJString(MaxResults))
  result = call_594793.call(nil, query_594794, nil, nil, body_594795)

var listBusinessReportSchedules* = Call_ListBusinessReportSchedules_594778(
    name: "listBusinessReportSchedules", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListBusinessReportSchedules",
    validator: validate_ListBusinessReportSchedules_594779, base: "/",
    url: url_ListBusinessReportSchedules_594780,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListConferenceProviders_594797 = ref object of OpenApiRestCall_593437
proc url_ListConferenceProviders_594799(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListConferenceProviders_594798(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594800 = query.getOrDefault("NextToken")
  valid_594800 = validateParameter(valid_594800, JString, required = false,
                                 default = nil)
  if valid_594800 != nil:
    section.add "NextToken", valid_594800
  var valid_594801 = query.getOrDefault("MaxResults")
  valid_594801 = validateParameter(valid_594801, JString, required = false,
                                 default = nil)
  if valid_594801 != nil:
    section.add "MaxResults", valid_594801
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594811: Call_ListConferenceProviders_594797; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists conference providers under a specific AWS account.
  ## 
...
proc call*(call_594812: Call_ListConferenceProviders_594797; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_594813, "NextToken", newJString(NextToken))
  if body != nil:
    body_594814 = body
  add(query_594813, "MaxResults", newJString(MaxResults))
  result = call_594812.call(nil, query_594813, nil, nil, body_594814)

var listConferenceProviders* = Call_ListConferenceProviders_594797(
    name: "listConferenceProviders", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListConferenceProviders",
    validator: validate_ListConferenceProviders_594798, base: "/",
    url: url_ListConferenceProviders_594799, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeviceEvents_594815 = ref object of OpenApiRestCall_593437
proc url_ListDeviceEvents_594817(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDeviceEvents_594816(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594818 = query.getOrDefault("NextToken")
  valid_594818 = validateParameter(valid_594818, JString, required = false,
                                 default = nil)
  if valid_594818 != nil:
    section.add "NextToken", valid_594818
  var valid_594819 = query.getOrDefault("MaxResults")
  valid_594819 = validateParameter(valid_594819, JString, required = false,
                                 default = nil)
  if valid_594819 != nil:
    section.add "MaxResults", valid_594819
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594829: Call_ListDeviceEvents_594815; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the device event history, including device connection status, for up to 30 days.
  ## 
...
proc call*(call_594830: Call_ListDeviceEvents_594815; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listDeviceEvents
  ## Lists the device event history, including device connection status, for up to 30 days.
  ##   NextToken: string
  ...
  add(query_594831, "NextToken", newJString(NextToken))
  if body != nil:
    body_594832 = body
  add(query_594831, "MaxResults", newJString(MaxResults))
  result = call_594830.call(nil, query_594831, nil, nil, body_594832)

var listDeviceEvents* = Call_ListDeviceEvents_594815(name: "listDeviceEvents",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListDeviceEvents",
    validator: validate_ListDeviceEvents_594816, base: "/",
    url: url_ListDeviceEvents_594817, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListGatewayGroups_594833 = ref object of OpenApiRestCall_593437
proc url_ListGatewayGroups_594835(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListGatewayGroups_594834(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594836 = query.getOrDefault("NextToken")
  valid_594836 = validateParameter(valid_594836, JString, required = false,
                                 default = nil)
  if valid_594836 != nil:
    section.add "NextToken", valid_594836
...
proc call*(call_594847: Call_ListGatewayGroups_594833; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list of gateway group summaries. Use GetGatewayGroup to retrieve details of a specific gateway group.
  ## 
...
proc call*(call_594848: Call_ListGatewayGroups_594833; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listGatewayGroups
  ## Retrieves a list of gateway group summaries. Use GetGatewayGroup to retrieve details of a specific gateway group.
  ##   NextToken: string
  ...
  add(query_594849, "NextToken", newJString(NextToken))
  if body != nil:
    body_594850 = body
  add(query_594849, "MaxResults", newJString(MaxResults))
  result = call_594848.call(nil, query_594849, nil, nil, body_594850)

var listGatewayGroups* = Call_ListGatewayGroups_594833(name: "listGatewayGroups",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListGatewayGroups",
    validator: validate_ListGatewayGroups_594834, base: "/",
    url: url_ListGatewayGroups_594835, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListGateways_594851 = ref object of OpenApiRestCall_593437
proc url_ListGateways_594853(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListGateways_594852(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594854 = query.getOrDefault("NextToken")
  valid_594854 = validateParameter(valid_594854, JString, required = false,
                                 default = nil)
  if valid_594854 != nil:
    section.add "NextToken", valid_594854
  var valid_594855 = query.getOrDefault("MaxResults")
  valid_594855 = validateParameter(valid_594855, JString, required = false,
                                 default = nil)
  if valid_594855 != nil:
    section.add "MaxResults", valid_594855
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594865: Call_ListGateways_594851; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list of gateway summaries. Use GetGateway to retrieve details of a specific gateway. An optional gateway group ARN can be provided to only retrieve gateway summaries of gateways that are associated with that gateway group ARN.
  ## 
...
proc call*(call_594866: Call_ListGateways_594851; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listGateways
  ## Retrieves a list of gateway summaries. Use GetGateway to retrieve details of a specific gateway. An optional gateway group ARN can be provided to only retrieve gateway summaries of gateways that are associated with that gateway group ARN.
  ##   NextToken: string
  ...
  add(query_594867, "NextToken", newJString(NextToken))
  if body != nil:
    body_594868 = body
  add(query_594867, "MaxResults", newJString(MaxResults))
  result = call_594866.call(nil, query_594867, nil, nil, body_594868)

var listGateways* = Call_ListGateways_594851(name: "listGateways",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListGateways",
    validator: validate_ListGateways_594852, base: "/", url: url_ListGateways_594853,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSkills_594869 = ref object of OpenApiRestCall_593437
proc url_ListSkills_594871(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSkills_594870(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594883: Call_ListSkills_594869; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all enabled skills in a specific skill group.
  ## 
...
proc call*(call_594884: Call_ListSkills_594869; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listSkills
  ## Lists all enabled skills in a specific skill group.
  ##   NextToken: string
...
var listSkills* = Call_ListSkills_594869(name: "listSkills",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.ListSkills",
                                      validator: validate_ListSkills_594870,
                                      base: "/", url: url_ListSkills_594871,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSkillsStoreCategories_594887 = ref object of OpenApiRestCall_593437
proc url_ListSkillsStoreCategories_594889(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSkillsStoreCategories_594888(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594890 = query.getOrDefault("NextToken")
  valid_594890 = validateParameter(valid_594890, JString, required = false,
                                 default = nil)
  if valid_594890 != nil:
    section.add "NextToken", valid_594890
  var valid_594891 = query.getOrDefault("MaxResults")
  valid_594891 = validateParameter(valid_594891, JString, required = false,
                                 default = nil)
  if valid_594891 != nil:
    section.add "MaxResults", valid_594891
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_594896 = header.getOrDefault("X-Amz-Algorithm")
  valid_594896 = validateParameter(valid_594896, JString, required = false,
                                 default = nil)
  if valid_594896 != nil:
    section.add "X-Amz-Algorithm", valid_594896
...
proc call*(call_594901: Call_ListSkillsStoreCategories_594887; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all categories in the Alexa skill store.
  ## 
...
proc call*(call_594902: Call_ListSkillsStoreCategories_594887; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_594903, "NextToken", newJString(NextToken))
  if body != nil:
    body_594904 = body
  add(query_594903, "MaxResults", newJString(MaxResults))
  result = call_594902.call(nil, query_594903, nil, nil, body_594904)

var listSkillsStoreCategories* = Call_ListSkillsStoreCategories_594887(
    name: "listSkillsStoreCategories", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListSkillsStoreCategories",
    validator: validate_ListSkillsStoreCategories_594888, base: "/",
    url: url_ListSkillsStoreCategories_594889,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSkillsStoreSkillsByCategory_594905 = ref object of OpenApiRestCall_593437
proc url_ListSkillsStoreSkillsByCategory_594907(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSkillsStoreSkillsByCategory_594906(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594908 = query.getOrDefault("NextToken")
  valid_594908 = validateParameter(valid_594908, JString, required = false,
                                 default = nil)
  if valid_594908 != nil:
    section.add "NextToken", valid_594908
  var valid_594909 = query.getOrDefault("MaxResults")
  valid_594909 = validateParameter(valid_594909, JString, required = false,
                                 default = nil)
  if valid_594909 != nil:
    section.add "MaxResults", valid_594909
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594912 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_594912 != nil:
    section.add "X-Amz-Target", valid_594912
...
proc call*(call_594919: Call_ListSkillsStoreSkillsByCategory_594905;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists all skills in the Alexa skill store by category.
  ## 
...
proc call*(call_594920: Call_ListSkillsStoreSkillsByCategory_594905;
  ...
  add(query_594921, "NextToken", newJString(NextToken))
  if body != nil:
    body_594922 = body
  add(query_594921, "MaxResults", newJString(MaxResults))
  result = call_594920.call(nil, query_594921, nil, nil, body_594922)

var listSkillsStoreSkillsByCategory* = Call_ListSkillsStoreSkillsByCategory_594905(
    ...
    validator: validate_ListSkillsStoreSkillsByCategory_594906, base: "/",
    url: url_ListSkillsStoreSkillsByCategory_594907,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSmartHomeAppliances_594923 = ref object of OpenApiRestCall_593437
proc url_ListSmartHomeAppliances_594925(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListSmartHomeAppliances_594924(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594926 = query.getOrDefault("NextToken")
  valid_594926 = validateParameter(valid_594926, JString, required = false,
                                 default = nil)
  if valid_594926 != nil:
    section.add "NextToken", valid_594926
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594930 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_594930 != nil:
    section.add "X-Amz-Target", valid_594930
...
proc call*(call_594937: Call_ListSmartHomeAppliances_594923; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all of the smart home appliances associated with a room.
  ## 
...
proc call*(call_594938: Call_ListSmartHomeAppliances_594923; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_594939, "NextToken", newJString(NextToken))
  if body != nil:
    body_594940 = body
  add(query_594939, "MaxResults", newJString(MaxResults))
  result = call_594938.call(nil, query_594939, nil, nil, body_594940)

var listSmartHomeAppliances* = Call_ListSmartHomeAppliances_594923(
    name: "listSmartHomeAppliances", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.ListSmartHomeAppliances",
    validator: validate_ListSmartHomeAppliances_594924, base: "/",
    url: url_ListSmartHomeAppliances_594925, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTags_594941 = ref object of OpenApiRestCall_593437
proc url_ListTags_594943(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTags_594942(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594944 = query.getOrDefault("NextToken")
  valid_594944 = validateParameter(valid_594944, JString, required = false,
                                 default = nil)
  if valid_594944 != nil:
    section.add "NextToken", valid_594944
  var valid_594945 = query.getOrDefault("MaxResults")
  valid_594945 = validateParameter(valid_594945, JString, required = false,
                                 default = nil)
  if valid_594945 != nil:
    section.add "MaxResults", valid_594945
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594955: Call_ListTags_594941; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all tags for the specified resource.
  ## 
...
proc call*(call_594956: Call_ListTags_594941; body: JsonNode; NextToken: string = "";
  ...
  add(query_594957, "NextToken", newJString(NextToken))
  if body != nil:
    body_594958 = body
  add(query_594957, "MaxResults", newJString(MaxResults))
  result = call_594956.call(nil, query_594957, nil, nil, body_594958)

var listTags* = Call_ListTags_594941(name: "listTags", meth: HttpMethod.HttpPost,
                                  host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.ListTags",
                                  validator: validate_ListTags_594942, base: "/",
                                  url: url_ListTags_594943,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutConferencePreference_594959 = ref object of OpenApiRestCall_593437
proc url_PutConferencePreference_594961(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_PutConferencePreference_594960(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594963 = header.getOrDefault("X-Amz-Security-Token")
  valid_594963 = validateParameter(valid_594963, JString, required = false,
                                 default = nil)
  if valid_594963 != nil:
    section.add "X-Amz-Security-Token", valid_594963
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594964 = header.getOrDefault("X-Amz-Target")
  valid_594964 = validateParameter(valid_594964, JString, required = true, default = newJString(
      "AlexaForBusiness.PutConferencePreference"))
  if valid_594964 != nil:
    section.add "X-Amz-Target", valid_594964
...
proc call*(call_594971: Call_PutConferencePreference_594959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sets the conference preferences on a specific conference provider at the account level.
  ## 
...
proc call*(call_594972: Call_PutConferencePreference_594959; body: JsonNode): Recallable =
...
var putConferencePreference* = Call_PutConferencePreference_594959(
    name: "putConferencePreference", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.PutConferencePreference",
    validator: validate_PutConferencePreference_594960, base: "/",
    url: url_PutConferencePreference_594961, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutInvitationConfiguration_594974 = ref object of OpenApiRestCall_593437
proc url_PutInvitationConfiguration_594976(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutInvitationConfiguration_594975(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594986: Call_PutInvitationConfiguration_594974; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Configures the email template for the user enrollment invitation with the specified attributes.
  ## 
...
proc call*(call_594987: Call_PutInvitationConfiguration_594974; body: JsonNode): Recallable =
...
var putInvitationConfiguration* = Call_PutInvitationConfiguration_594974(
    name: "putInvitationConfiguration", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.PutInvitationConfiguration",
    validator: validate_PutInvitationConfiguration_594975, base: "/",
    url: url_PutInvitationConfiguration_594976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutRoomSkillParameter_594989 = ref object of OpenApiRestCall_593437
proc url_PutRoomSkillParameter_594991(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutRoomSkillParameter_594990(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594994 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_594994 != nil:
    section.add "X-Amz-Target", valid_594994
...
proc call*(call_595001: Call_PutRoomSkillParameter_594989; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates room skill parameter details by room, skill, and parameter key ID. Not all skills have a room skill parameter.
  ## 
...
proc call*(call_595002: Call_PutRoomSkillParameter_594989; body: JsonNode): Recallable =
...
var putRoomSkillParameter* = Call_PutRoomSkillParameter_594989(
    name: "putRoomSkillParameter", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.PutRoomSkillParameter",
    validator: validate_PutRoomSkillParameter_594990, base: "/",
    url: url_PutRoomSkillParameter_594991, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutSkillAuthorization_595004 = ref object of OpenApiRestCall_593437
proc url_PutSkillAuthorization_595006(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutSkillAuthorization_595005(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_595009 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_595009 != nil:
    section.add "X-Amz-Target", valid_595009
...
proc call*(call_595016: Call_PutSkillAuthorization_595004; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Links a user's account to a third-party skill provider. If this API operation is called by an assumed IAM role, the skill being linked must be a private skill. Also, the skill must be owned by the AWS account that assumed the IAM role.
  ## 
...
proc call*(call_595017: Call_PutSkillAuthorization_595004; body: JsonNode): Recallable =
...
var putSkillAuthorization* = Call_PutSkillAuthorization_595004(
    name: "putSkillAuthorization", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.PutSkillAuthorization",
    validator: validate_PutSkillAuthorization_595005, base: "/",
    url: url_PutSkillAuthorization_595006, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterAVSDevice_595019 = ref object of OpenApiRestCall_593437
proc url_RegisterAVSDevice_595021(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterAVSDevice_595020(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_595027 = header.getOrDefault("X-Amz-Signature")
  valid_595027 = validateParameter(valid_595027, JString, required = false,
                                 default = nil)
  if valid_595027 != nil:
    section.add "X-Amz-Signature", valid_595027
...
proc call*(call_595031: Call_RegisterAVSDevice_595019; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Registers an Alexa-enabled device built by an Original Equipment Manufacturer (OEM) using Alexa Voice Service (AVS).
  ## 
...
proc call*(call_595032: Call_RegisterAVSDevice_595019; body: JsonNode): Recallable =
  ## registerAVSDevice
  ## Registers an Alexa-enabled device built by an Original Equipment Manufacturer (OEM) using Alexa Voice Service (AVS).
  ##   body: JObject (required)
...
var registerAVSDevice* = Call_RegisterAVSDevice_595019(name: "registerAVSDevice",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.RegisterAVSDevice",
    validator: validate_RegisterAVSDevice_595020, base: "/",
    url: url_RegisterAVSDevice_595021, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectSkill_595034 = ref object of OpenApiRestCall_593437
proc url_RejectSkill_595036(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RejectSkill_595035(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  valid_595039 = validateParameter(valid_595039, JString, required = true, default = newJString(
...
proc call*(call_595046: Call_RejectSkill_595034; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates a skill from the organization under a user's AWS account. If the skill is a private skill, it moves to an AcceptStatus of PENDING. Any private or public skill that is rejected can be added later by calling the ApproveSkill API. 
  ## 
...
proc call*(call_595047: Call_RejectSkill_595034; body: JsonNode): Recallable =
  ## rejectSkill
  ## Disassociates a skill from the organization under a user's AWS account. If the skill is a private skill, it moves to an AcceptStatus of PENDING. Any private or public skill that is rejected can be added later by calling the ApproveSkill API. 
  ##   body: JObject (required)
...
var rejectSkill* = Call_RejectSkill_595034(name: "rejectSkill",
                                        meth: HttpMethod.HttpPost,
                                        host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.RejectSkill",
                                        validator: validate_RejectSkill_595035,
                                        base: "/", url: url_RejectSkill_595036,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ResolveRoom_595049 = ref object of OpenApiRestCall_593437
proc url_ResolveRoom_595051(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResolveRoom_595050(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  valid_595054 = validateParameter(valid_595054, JString, required = true, default = newJString(
...
proc call*(call_595061: Call_ResolveRoom_595049; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Determines the details for the room from which a skill request was invoked. This operation is used by skill developers.
  ## 
...
proc call*(call_595062: Call_ResolveRoom_595049; body: JsonNode): Recallable =
  ## resolveRoom
  ## Determines the details for the room from which a skill request was invoked. This operation is used by skill developers.
  ##   body: JObject (required)
...
var resolveRoom* = Call_ResolveRoom_595049(name: "resolveRoom",
                                        meth: HttpMethod.HttpPost,
                                        host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.ResolveRoom",
                                        validator: validate_ResolveRoom_595050,
                                        base: "/", url: url_ResolveRoom_595051,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_RevokeInvitation_595064 = ref object of OpenApiRestCall_593437
proc url_RevokeInvitation_595066(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RevokeInvitation_595065(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_595076: Call_RevokeInvitation_595064; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Revokes an invitation and invalidates the enrollment URL.
  ## 
...
proc call*(call_595077: Call_RevokeInvitation_595064; body: JsonNode): Recallable =
  ## revokeInvitation
  ## Revokes an invitation and invalidates the enrollment URL.
  ##   body: JObject (required)
  var body_595078 = newJObject()
  if body != nil:
    body_595078 = body
  result = call_595077.call(nil, nil, nil, nil, body_595078)

var revokeInvitation* = Call_RevokeInvitation_595064(name: "revokeInvitation",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.RevokeInvitation",
    validator: validate_RevokeInvitation_595065, base: "/",
    url: url_RevokeInvitation_595066, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchAddressBooks_595079 = ref object of OpenApiRestCall_593437
proc url_SearchAddressBooks_595081(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchAddressBooks_595080(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595082 = query.getOrDefault("NextToken")
  valid_595082 = validateParameter(valid_595082, JString, required = false,
                                 default = nil)
  if valid_595082 != nil:
    section.add "NextToken", valid_595082
  var valid_595083 = query.getOrDefault("MaxResults")
  valid_595083 = validateParameter(valid_595083, JString, required = false,
                                 default = nil)
  if valid_595083 != nil:
    section.add "MaxResults", valid_595083
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_595093: Call_SearchAddressBooks_595079; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches address books and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595094: Call_SearchAddressBooks_595079; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchAddressBooks
  ## Searches address books and lists the ones that meet a set of filter and sort criteria.
  ##   NextToken: string
  ...
  add(query_595095, "NextToken", newJString(NextToken))
  if body != nil:
    body_595096 = body
  add(query_595095, "MaxResults", newJString(MaxResults))
  result = call_595094.call(nil, query_595095, nil, nil, body_595096)

var searchAddressBooks* = Call_SearchAddressBooks_595079(
    name: "searchAddressBooks", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchAddressBooks",
    validator: validate_SearchAddressBooks_595080, base: "/",
    url: url_SearchAddressBooks_595081, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchContacts_595097 = ref object of OpenApiRestCall_593437
proc url_SearchContacts_595099(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchContacts_595098(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595100 = query.getOrDefault("NextToken")
  valid_595100 = validateParameter(valid_595100, JString, required = false,
                                 default = nil)
  if valid_595100 != nil:
    section.add "NextToken", valid_595100
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_595104 = header.getOrDefault("X-Amz-Target")
  valid_595104 = validateParameter(valid_595104, JString, required = true, default = newJString(
      "AlexaForBusiness.SearchContacts"))
  if valid_595104 != nil:
    section.add "X-Amz-Target", valid_595104
  var valid_595105 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_595105 = validateParameter(valid_595105, JString, required = false,
                                 default = nil)
  if valid_595105 != nil:
    section.add "X-Amz-Content-Sha256", valid_595105
  ...
  var valid_595107 = header.getOrDefault("X-Amz-Signature")
  valid_595107 = validateParameter(valid_595107, JString, required = false,
                                 default = nil)
  if valid_595107 != nil:
    section.add "X-Amz-Signature", valid_595107
  var valid_595108 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_595108 = validateParameter(valid_595108, JString, required = false,
                                 default = nil)
  if valid_595108 != nil:
    section.add "X-Amz-SignedHeaders", valid_595108
...
proc call*(call_595111: Call_SearchContacts_595097; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches contacts and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595112: Call_SearchContacts_595097; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchContacts
  ## Searches contacts and lists the ones that meet a set of filter and sort criteria.
  ##   NextToken: string
  ...
  var body_595114 = newJObject()
  add(query_595113, "NextToken", newJString(NextToken))
  if body != nil:
    body_595114 = body
  add(query_595113, "MaxResults", newJString(MaxResults))
  result = call_595112.call(nil, query_595113, nil, nil, body_595114)

var searchContacts* = Call_SearchContacts_595097(name: "searchContacts",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchContacts",
    validator: validate_SearchContacts_595098, base: "/", url: url_SearchContacts_595099,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchDevices_595115 = ref object of OpenApiRestCall_593437
proc url_SearchDevices_595117(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchDevices_595116(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_595119 = query.getOrDefault("MaxResults")
  valid_595119 = validateParameter(valid_595119, JString, required = false,
                                 default = nil)
  if valid_595119 != nil:
    section.add "MaxResults", valid_595119
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_595122 = header.getOrDefault("X-Amz-Target")
  valid_595122 = validateParameter(valid_595122, JString, required = true, default = newJString(
      "AlexaForBusiness.SearchDevices"))
  if valid_595122 != nil:
    section.add "X-Amz-Target", valid_595122
  var valid_595123 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_595123 = validateParameter(valid_595123, JString, required = false,
                                 default = nil)
  if valid_595123 != nil:
    section.add "X-Amz-Content-Sha256", valid_595123
  var valid_595124 = header.getOrDefault("X-Amz-Algorithm")
  valid_595124 = validateParameter(valid_595124, JString, required = false,
                                 default = nil)
  if valid_595124 != nil:
    section.add "X-Amz-Algorithm", valid_595124
  ...
  var valid_595126 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_595126 = validateParameter(valid_595126, JString, required = false,
                                 default = nil)
  if valid_595126 != nil:
    section.add "X-Amz-SignedHeaders", valid_595126
  var valid_595127 = header.getOrDefault("X-Amz-Credential")
  valid_595127 = validateParameter(valid_595127, JString, required = false,
                                 default = nil)
  if valid_595127 != nil:
    section.add "X-Amz-Credential", valid_595127
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_595129: Call_SearchDevices_595115; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches devices and lists the ones that meet a set of filter criteria.
  ## 
...
proc call*(call_595130: Call_SearchDevices_595115; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchDevices
  ## Searches devices and lists the ones that meet a set of filter criteria.
  ##   NextToken: string
  ...
  if body != nil:
    body_595132 = body
  add(query_595131, "MaxResults", newJString(MaxResults))
  result = call_595130.call(nil, query_595131, nil, nil, body_595132)

var searchDevices* = Call_SearchDevices_595115(name: "searchDevices",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchDevices",
    validator: validate_SearchDevices_595116, base: "/", url: url_SearchDevices_595117,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchNetworkProfiles_595133 = ref object of OpenApiRestCall_593437
proc url_SearchNetworkProfiles_595135(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchNetworkProfiles_595134(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595136 = query.getOrDefault("NextToken")
  valid_595136 = validateParameter(valid_595136, JString, required = false,
                                 default = nil)
  if valid_595136 != nil:
    section.add "NextToken", valid_595136
  var valid_595137 = query.getOrDefault("MaxResults")
  valid_595137 = validateParameter(valid_595137, JString, required = false,
                                 default = nil)
  if valid_595137 != nil:
    section.add "MaxResults", valid_595137
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_595147: Call_SearchNetworkProfiles_595133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches network profiles and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595148: Call_SearchNetworkProfiles_595133; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_595149, "NextToken", newJString(NextToken))
  if body != nil:
    body_595150 = body
  add(query_595149, "MaxResults", newJString(MaxResults))
  result = call_595148.call(nil, query_595149, nil, nil, body_595150)

var searchNetworkProfiles* = Call_SearchNetworkProfiles_595133(
    name: "searchNetworkProfiles", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchNetworkProfiles",
    validator: validate_SearchNetworkProfiles_595134, base: "/",
    url: url_SearchNetworkProfiles_595135, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchProfiles_595151 = ref object of OpenApiRestCall_593437
proc url_SearchProfiles_595153(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchProfiles_595152(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_595165: Call_SearchProfiles_595151; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches room profiles and lists the ones that meet a set of filter criteria.
  ## 
...
proc call*(call_595166: Call_SearchProfiles_595151; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchProfiles
  ## Searches room profiles and lists the ones that meet a set of filter criteria.
  ##   NextToken: string
...
var searchProfiles* = Call_SearchProfiles_595151(name: "searchProfiles",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchProfiles",
    validator: validate_SearchProfiles_595152, base: "/", url: url_SearchProfiles_595153,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchRooms_595169 = ref object of OpenApiRestCall_593437
proc url_SearchRooms_595171(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchRooms_595170(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595172 = query.getOrDefault("NextToken")
  valid_595172 = validateParameter(valid_595172, JString, required = false,
                                 default = nil)
  if valid_595172 != nil:
    section.add "NextToken", valid_595172
...
proc call*(call_595183: Call_SearchRooms_595169; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches rooms and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595184: Call_SearchRooms_595169; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchRooms
  ## Searches rooms and lists the ones that meet a set of filter and sort criteria.
  ##   NextToken: string
  ...
  if body != nil:
    body_595186 = body
  add(query_595185, "MaxResults", newJString(MaxResults))
  result = call_595184.call(nil, query_595185, nil, nil, body_595186)

var searchRooms* = Call_SearchRooms_595169(name: "searchRooms",
                                        meth: HttpMethod.HttpPost,
                                        host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.SearchRooms",
                                        validator: validate_SearchRooms_595170,
                                        base: "/", url: url_SearchRooms_595171,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchSkillGroups_595187 = ref object of OpenApiRestCall_593437
proc url_SearchSkillGroups_595189(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchSkillGroups_595188(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595190 = query.getOrDefault("NextToken")
  valid_595190 = validateParameter(valid_595190, JString, required = false,
                                 default = nil)
  if valid_595190 != nil:
    section.add "NextToken", valid_595190
  var valid_595191 = query.getOrDefault("MaxResults")
  valid_595191 = validateParameter(valid_595191, JString, required = false,
                                 default = nil)
  if valid_595191 != nil:
    section.add "MaxResults", valid_595191
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_595201: Call_SearchSkillGroups_595187; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches skill groups and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595202: Call_SearchSkillGroups_595187; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchSkillGroups
  ## Searches skill groups and lists the ones that meet a set of filter and sort criteria.
  ##   NextToken: string
  ...
  var body_595204 = newJObject()
  add(query_595203, "NextToken", newJString(NextToken))
  if body != nil:
    body_595204 = body
  add(query_595203, "MaxResults", newJString(MaxResults))
  result = call_595202.call(nil, query_595203, nil, nil, body_595204)

var searchSkillGroups* = Call_SearchSkillGroups_595187(name: "searchSkillGroups",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SearchSkillGroups",
    validator: validate_SearchSkillGroups_595188, base: "/",
    url: url_SearchSkillGroups_595189, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SearchUsers_595205 = ref object of OpenApiRestCall_593437
proc url_SearchUsers_595207(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SearchUsers_595206(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_595208 = query.getOrDefault("NextToken")
  valid_595208 = validateParameter(valid_595208, JString, required = false,
                                 default = nil)
  if valid_595208 != nil:
    section.add "NextToken", valid_595208
  var valid_595209 = query.getOrDefault("MaxResults")
  valid_595209 = validateParameter(valid_595209, JString, required = false,
                                 default = nil)
  if valid_595209 != nil:
    section.add "MaxResults", valid_595209
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_595213 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_595213 = validateParameter(valid_595213, JString, required = false,
                                 default = nil)
  if valid_595213 != nil:
    section.add "X-Amz-Content-Sha256", valid_595213
  ...
  var valid_595215 = header.getOrDefault("X-Amz-Signature")
  valid_595215 = validateParameter(valid_595215, JString, required = false,
                                 default = nil)
  if valid_595215 != nil:
    section.add "X-Amz-Signature", valid_595215
  var valid_595216 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_595216 = validateParameter(valid_595216, JString, required = false,
                                 default = nil)
  if valid_595216 != nil:
    section.add "X-Amz-SignedHeaders", valid_595216
  var valid_595217 = header.getOrDefault("X-Amz-Credential")
  valid_595217 = validateParameter(valid_595217, JString, required = false,
                                 default = nil)
  if valid_595217 != nil:
    section.add "X-Amz-Credential", valid_595217
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_595219: Call_SearchUsers_595205; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Searches users and lists the ones that meet a set of filter and sort criteria.
  ## 
...
proc call*(call_595220: Call_SearchUsers_595205; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## searchUsers
  ## Searches users and lists the ones that meet a set of filter and sort criteria.
  ##   NextToken: string
  ...
  add(query_595221, "NextToken", newJString(NextToken))
  if body != nil:
    body_595222 = body
  add(query_595221, "MaxResults", newJString(MaxResults))
  result = call_595220.call(nil, query_595221, nil, nil, body_595222)

var searchUsers* = Call_SearchUsers_595205(name: "searchUsers",
                                        meth: HttpMethod.HttpPost,
                                        host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.SearchUsers",
                                        validator: validate_SearchUsers_595206,
                                        base: "/", url: url_SearchUsers_595207,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendAnnouncement_595223 = ref object of OpenApiRestCall_593437
proc url_SendAnnouncement_595225(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendAnnouncement_595224(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_595235: Call_SendAnnouncement_595223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Triggers an asynchronous flow to send text, SSML, or audio announcements to rooms that are identified by a search or filter. 
  ## 
...
proc call*(call_595236: Call_SendAnnouncement_595223; body: JsonNode): Recallable =
  ## sendAnnouncement
  ## Triggers an asynchronous flow to send text, SSML, or audio announcements to rooms that are identified by a search or filter. 
  ##   body: JObject (required)
...
var sendAnnouncement* = Call_SendAnnouncement_595223(name: "sendAnnouncement",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SendAnnouncement",
    validator: validate_SendAnnouncement_595224, base: "/",
    url: url_SendAnnouncement_595225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendInvitation_595238 = ref object of OpenApiRestCall_593437
proc url_SendInvitation_595240(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendInvitation_595239(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_595250: Call_SendInvitation_595238; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sends an enrollment invitation email with a URL to a user. The URL is valid for 30 days or until you call this operation again, whichever comes first. 
  ## 
...
proc call*(call_595251: Call_SendInvitation_595238; body: JsonNode): Recallable =
  ## sendInvitation
  ## Sends an enrollment invitation email with a URL to a user. The URL is valid for 30 days or until you call this operation again, whichever comes first. 
  ##   body: JObject (required)
...
var sendInvitation* = Call_SendInvitation_595238(name: "sendInvitation",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.SendInvitation",
    validator: validate_SendInvitation_595239, base: "/", url: url_SendInvitation_595240,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartDeviceSync_595253 = ref object of OpenApiRestCall_593437
proc url_StartDeviceSync_595255(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartDeviceSync_595254(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_595265: Call_StartDeviceSync_595253; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Resets a device and its account to the known default settings. This clears all information and settings set by previous users in the following ways:</p> <ul> <li> <p>Bluetooth - This unpairs all bluetooth devices paired with your echo device.</p> </li> <li> <p>Volume - This resets the echo device's volume to the default value.</p> </li> <li> <p>Notifications - This clears all notifications from your echo device.</p> </li> <li> <p>Lists - This clears all to-do items from your echo device.</p> </li> <li> <p>Settings - This internally syncs the room's profile (if the device is assigned to a room), contacts, address books, delegation access for account linking, and communications (if enabled on the room profile).</p> </li> </ul>
  ## 
...
proc call*(call_595266: Call_StartDeviceSync_595253; body: JsonNode): Recallable =
  ## startDeviceSync
  ## <p>Resets a device and its account to the known default settings. This clears all information and settings set by previous users in the following ways:</p> <ul> <li> <p>Bluetooth - This unpairs all bluetooth devices paired with your echo device.</p> </li> <li> <p>Volume - This resets the echo device's volume to the default value.</p> </li> <li> <p>Notifications - This clears all notifications from your echo device.</p> </li> <li> <p>Lists - This clears all to-do items from your echo device.</p> </li> <li> <p>Settings - This internally syncs the room's profile (if the device is assigned to a room), contacts, address books, delegation access for account linking, and communications (if enabled on the room profile).</p> </li> </ul>
  ##   body: JObject (required)
...
var startDeviceSync* = Call_StartDeviceSync_595253(name: "startDeviceSync",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.StartDeviceSync",
    validator: validate_StartDeviceSync_595254, base: "/", url: url_StartDeviceSync_595255,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSmartHomeApplianceDiscovery_595268 = ref object of OpenApiRestCall_593437
proc url_StartSmartHomeApplianceDiscovery_595270(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartSmartHomeApplianceDiscovery_595269(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595280: Call_StartSmartHomeApplianceDiscovery_595268;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Initiates the discovery of any smart home appliances associated with the room.
  ## 
...
proc call*(call_595281: Call_StartSmartHomeApplianceDiscovery_595268;
          body: JsonNode): Recallable =
...
var startSmartHomeApplianceDiscovery* = Call_StartSmartHomeApplianceDiscovery_595268(
    ...
    validator: validate_StartSmartHomeApplianceDiscovery_595269, base: "/",
    url: url_StartSmartHomeApplianceDiscovery_595270,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_595283 = ref object of OpenApiRestCall_593437
proc url_TagResource_595285(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_595284(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595295: Call_TagResource_595283; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds metadata tags to a specified resource.
  ## 
...
proc call*(call_595296: Call_TagResource_595283; body: JsonNode): Recallable =
  ## tagResource
  ## Adds metadata tags to a specified resource.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_595283(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.TagResource",
                                        validator: validate_TagResource_595284,
                                        base: "/", url: url_TagResource_595285,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_595298 = ref object of OpenApiRestCall_593437
proc url_UntagResource_595300(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_595299(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595310: Call_UntagResource_595298; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes metadata tags from a specified resource.
  ## 
...
proc call*(call_595311: Call_UntagResource_595298; body: JsonNode): Recallable =
  ## untagResource
  ## Removes metadata tags from a specified resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_595298(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UntagResource",
    validator: validate_UntagResource_595299, base: "/", url: url_UntagResource_595300,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAddressBook_595313 = ref object of OpenApiRestCall_593437
proc url_UpdateAddressBook_595315(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAddressBook_595314(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_595325: Call_UpdateAddressBook_595313; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates address book details by the address book ARN.
  ## 
...
proc call*(call_595326: Call_UpdateAddressBook_595313; body: JsonNode): Recallable =
  ## updateAddressBook
  ## Updates address book details by the address book ARN.
  ##   body: JObject (required)
...
var updateAddressBook* = Call_UpdateAddressBook_595313(name: "updateAddressBook",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateAddressBook",
    validator: validate_UpdateAddressBook_595314, base: "/",
    url: url_UpdateAddressBook_595315, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBusinessReportSchedule_595328 = ref object of OpenApiRestCall_593437
proc url_UpdateBusinessReportSchedule_595330(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateBusinessReportSchedule_595329(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595340: Call_UpdateBusinessReportSchedule_595328; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the configuration of the report delivery schedule with the specified schedule ARN.
  ## 
...
proc call*(call_595341: Call_UpdateBusinessReportSchedule_595328; body: JsonNode): Recallable =
...
var updateBusinessReportSchedule* = Call_UpdateBusinessReportSchedule_595328(
    ...
    validator: validate_UpdateBusinessReportSchedule_595329, base: "/",
    url: url_UpdateBusinessReportSchedule_595330,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateConferenceProvider_595343 = ref object of OpenApiRestCall_593437
proc url_UpdateConferenceProvider_595345(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateConferenceProvider_595344(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595355: Call_UpdateConferenceProvider_595343; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing conference provider's settings.
  ## 
...
proc call*(call_595356: Call_UpdateConferenceProvider_595343; body: JsonNode): Recallable =
...
var updateConferenceProvider* = Call_UpdateConferenceProvider_595343(
    name: "updateConferenceProvider", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateConferenceProvider",
    validator: validate_UpdateConferenceProvider_595344, base: "/",
    url: url_UpdateConferenceProvider_595345, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateContact_595358 = ref object of OpenApiRestCall_593437
proc url_UpdateContact_595360(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateContact_595359(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595370: Call_UpdateContact_595358; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the contact details by the contact ARN.
  ## 
...
proc call*(call_595371: Call_UpdateContact_595358; body: JsonNode): Recallable =
  ## updateContact
  ## Updates the contact details by the contact ARN.
  ##   body: JObject (required)
...
var updateContact* = Call_UpdateContact_595358(name: "updateContact",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateContact",
    validator: validate_UpdateContact_595359, base: "/", url: url_UpdateContact_595360,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDevice_595373 = ref object of OpenApiRestCall_593437
proc url_UpdateDevice_595375(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDevice_595374(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595385: Call_UpdateDevice_595373; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the device name by device ARN.
  ## 
...
proc call*(call_595386: Call_UpdateDevice_595373; body: JsonNode): Recallable =
  ## updateDevice
  ## Updates the device name by device ARN.
  ##   body: JObject (required)
...
var updateDevice* = Call_UpdateDevice_595373(name: "updateDevice",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateDevice",
    validator: validate_UpdateDevice_595374, base: "/", url: url_UpdateDevice_595375,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateGateway_595388 = ref object of OpenApiRestCall_593437
proc url_UpdateGateway_595390(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateGateway_595389(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595400: Call_UpdateGateway_595388; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of a gateway. If any optional field is not provided, the existing corresponding value is left unmodified.
  ## 
...
proc call*(call_595401: Call_UpdateGateway_595388; body: JsonNode): Recallable =
  ## updateGateway
  ## Updates the details of a gateway. If any optional field is not provided, the existing corresponding value is left unmodified.
  ##   body: JObject (required)
...
var updateGateway* = Call_UpdateGateway_595388(name: "updateGateway",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateGateway",
    validator: validate_UpdateGateway_595389, base: "/", url: url_UpdateGateway_595390,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateGatewayGroup_595403 = ref object of OpenApiRestCall_593437
proc url_UpdateGatewayGroup_595405(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateGatewayGroup_595404(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_595415: Call_UpdateGatewayGroup_595403; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of a gateway group. If any optional field is not provided, the existing corresponding value is left unmodified.
  ## 
...
proc call*(call_595416: Call_UpdateGatewayGroup_595403; body: JsonNode): Recallable =
  ## updateGatewayGroup
  ## Updates the details of a gateway group. If any optional field is not provided, the existing corresponding value is left unmodified.
  ##   body: JObject (required)
...
var updateGatewayGroup* = Call_UpdateGatewayGroup_595403(
    name: "updateGatewayGroup", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateGatewayGroup",
    validator: validate_UpdateGatewayGroup_595404, base: "/",
    url: url_UpdateGatewayGroup_595405, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNetworkProfile_595418 = ref object of OpenApiRestCall_593437
proc url_UpdateNetworkProfile_595420(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateNetworkProfile_595419(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595430: Call_UpdateNetworkProfile_595418; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a network profile by the network profile ARN.
  ## 
...
proc call*(call_595431: Call_UpdateNetworkProfile_595418; body: JsonNode): Recallable =
...
var updateNetworkProfile* = Call_UpdateNetworkProfile_595418(
    name: "updateNetworkProfile", meth: HttpMethod.HttpPost,
    host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateNetworkProfile",
    validator: validate_UpdateNetworkProfile_595419, base: "/",
    url: url_UpdateNetworkProfile_595420, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProfile_595433 = ref object of OpenApiRestCall_593437
proc url_UpdateProfile_595435(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProfile_595434(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595445: Call_UpdateProfile_595433; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing room profile by room profile ARN.
  ## 
...
proc call*(call_595446: Call_UpdateProfile_595433; body: JsonNode): Recallable =
  ## updateProfile
  ## Updates an existing room profile by room profile ARN.
  ##   body: JObject (required)
...
var updateProfile* = Call_UpdateProfile_595433(name: "updateProfile",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateProfile",
    validator: validate_UpdateProfile_595434, base: "/", url: url_UpdateProfile_595435,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateRoom_595448 = ref object of OpenApiRestCall_593437
proc url_UpdateRoom_595450(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateRoom_595449(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_595460: Call_UpdateRoom_595448; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates room details by room ARN.
  ## 
...
proc call*(call_595461: Call_UpdateRoom_595448; body: JsonNode): Recallable =
  ## updateRoom
  ## Updates room details by room ARN.
  ##   body: JObject (required)
...
var updateRoom* = Call_UpdateRoom_595448(name: "updateRoom",
                                      meth: HttpMethod.HttpPost,
                                      host: "a4b.amazonaws.com", route: "/#X-Amz-Target=AlexaForBusiness.UpdateRoom",
                                      validator: validate_UpdateRoom_595449,
                                      base: "/", url: url_UpdateRoom_595450,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSkillGroup_595463 = ref object of OpenApiRestCall_593437
proc url_UpdateSkillGroup_595465(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSkillGroup_595464(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_595475: Call_UpdateSkillGroup_595463; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates skill group details by skill group ARN.
  ## 
...
proc call*(call_595476: Call_UpdateSkillGroup_595463; body: JsonNode): Recallable =
  ## updateSkillGroup
  ## Updates skill group details by skill group ARN.
  ##   body: JObject (required)
...
var updateSkillGroup* = Call_UpdateSkillGroup_595463(name: "updateSkillGroup",
    meth: HttpMethod.HttpPost, host: "a4b.amazonaws.com",
    route: "/#X-Amz-Target=AlexaForBusiness.UpdateSkillGroup",
    validator: validate_UpdateSkillGroup_595464, base: "/",
    url: url_UpdateSkillGroup_595465, schemes: {Scheme.Https, Scheme.Http})
export
  rest
