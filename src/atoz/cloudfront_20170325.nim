...
type
  Call_CreateCloudFrontOriginAccessIdentity20170325_594031 = ref object of OpenApiRestCall_593437
proc url_CreateCloudFrontOriginAccessIdentity20170325_594033(protocol: Scheme;
...
proc validate_CreateCloudFrontOriginAccessIdentity20170325_594032(path: JsonNode;
...
proc call*(call_594042: Call_CreateCloudFrontOriginAccessIdentity20170325_594031;
...
proc call*(call_594043: Call_CreateCloudFrontOriginAccessIdentity20170325_594031;
          body: JsonNode): Recallable =
...
var createCloudFrontOriginAccessIdentity20170325* = Call_CreateCloudFrontOriginAccessIdentity20170325_594031(
    ...
    validator: validate_CreateCloudFrontOriginAccessIdentity20170325_594032,
    base: "/", url: url_CreateCloudFrontOriginAccessIdentity20170325_594033,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCloudFrontOriginAccessIdentities20170325_593774 = ref object of OpenApiRestCall_593437
proc url_ListCloudFrontOriginAccessIdentities20170325_593776(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListCloudFrontOriginAccessIdentities20170325_593775(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593919: Call_ListCloudFrontOriginAccessIdentities20170325_593774;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists origin access identities.
  ## 
...
proc call*(call_593990: Call_ListCloudFrontOriginAccessIdentities20170325_593774;
...
var listCloudFrontOriginAccessIdentities20170325* = Call_ListCloudFrontOriginAccessIdentities20170325_593774(
    name: "listCloudFrontOriginAccessIdentities20170325",
    meth: HttpMethod.HttpGet, host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/origin-access-identity/cloudfront",
    validator: validate_ListCloudFrontOriginAccessIdentities20170325_593775,
    base: "/", url: url_ListCloudFrontOriginAccessIdentities20170325_593776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDistribution20170325_594060 = ref object of OpenApiRestCall_593437
proc url_CreateDistribution20170325_594062(protocol: Scheme; host: string;
...
proc validate_CreateDistribution20170325_594061(path: JsonNode; query: JsonNode;
...
proc call*(call_594071: Call_CreateDistribution20170325_594060; path: JsonNode;
...
proc call*(call_594072: Call_CreateDistribution20170325_594060; body: JsonNode): Recallable =
...
var createDistribution20170325* = Call_CreateDistribution20170325_594060(
    name: "createDistribution20170325", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/distribution",
    validator: validate_CreateDistribution20170325_594061, base: "/",
    url: url_CreateDistribution20170325_594062,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDistributions20170325_594045 = ref object of OpenApiRestCall_593437
proc url_ListDistributions20170325_594047(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDistributions20170325_594046(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## List distributions. 
  ## 
  var section: JsonNode
...
proc call*(call_594057: Call_ListDistributions20170325_594045; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List distributions. 
  ## 
...
proc call*(call_594058: Call_ListDistributions20170325_594045; Marker: string = "";
...
var listDistributions20170325* = Call_ListDistributions20170325_594045(
    name: "listDistributions20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/distribution",
    validator: validate_ListDistributions20170325_594046, base: "/",
    url: url_ListDistributions20170325_594047,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDistributionWithTags20170325_594074 = ref object of OpenApiRestCall_593437
proc url_CreateDistributionWithTags20170325_594076(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDistributionWithTags20170325_594075(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594086: Call_CreateDistributionWithTags20170325_594074;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Create a new distribution with tags.
  ## 
...
proc call*(call_594087: Call_CreateDistributionWithTags20170325_594074;
...
var createDistributionWithTags20170325* = Call_CreateDistributionWithTags20170325_594074(
    ...
    validator: validate_CreateDistributionWithTags20170325_594075, base: "/",
    url: url_CreateDistributionWithTags20170325_594076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateInvalidation20170325_594121 = ref object of OpenApiRestCall_593437
proc url_CreateInvalidation20170325_594123(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateInvalidation20170325_594122(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594133: Call_CreateInvalidation20170325_594121; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create a new invalidation. 
  ## 
...
proc call*(call_594134: Call_CreateInvalidation20170325_594121; body: JsonNode;
...
var createInvalidation20170325* = Call_CreateInvalidation20170325_594121(
    name: "createInvalidation20170325", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distribution/{DistributionId}/invalidation",
    validator: validate_CreateInvalidation20170325_594122, base: "/",
    url: url_CreateInvalidation20170325_594123,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListInvalidations20170325_594090 = ref object of OpenApiRestCall_593437
proc url_ListInvalidations20170325_594092(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListInvalidations20170325_594091(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594117: Call_ListInvalidations20170325_594090; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists invalidation batches. 
  ## 
...
proc call*(call_594118: Call_ListInvalidations20170325_594090;
...
var listInvalidations20170325* = Call_ListInvalidations20170325_594090(
    name: "listInvalidations20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distribution/{DistributionId}/invalidation",
    validator: validate_ListInvalidations20170325_594091, base: "/",
    url: url_ListInvalidations20170325_594092,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateStreamingDistribution20170325_594152 = ref object of OpenApiRestCall_593437
proc url_CreateStreamingDistribution20170325_594154(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateStreamingDistribution20170325_594153(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594163: Call_CreateStreamingDistribution20170325_594152;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Creates a new RMTP distribution. An RTMP distribution is similar to a web distribution, but an RTMP distribution streams media files using the Adobe Real-Time Messaging Protocol (RTMP) instead of serving files using HTTP. </p> <p>To create a new web distribution, submit a <code>POST</code> request to the <i>CloudFront API version</i>/distribution resource. The request body must include a document with a <i>StreamingDistributionConfig</i> element. The response echoes the <code>StreamingDistributionConfig</code> element and returns other information about the RTMP distribution.</p> <p>To get the status of your request, use the <i>GET StreamingDistribution</i> API action. When the value of <code>Enabled</code> is <code>true</code> and the value of <code>Status</code> is <code>Deployed</code>, your distribution is ready. A distribution usually deploys in less than 15 minutes.</p> <p>For more information about web distributions, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-rtmp.html">Working with RTMP Distributions</a> in the <i>Amazon CloudFront Developer Guide</i>.</p> <important> <p>Beginning with the 2012-05-05 version of the CloudFront API, we made substantial changes to the format of the XML document that you include in the request body when you create or update a web distribution or an RTMP distribution, and when you invalidate objects. With previous versions of the API, we discovered that it was too easy to accidentally delete one or more values for an element that accepts multiple values, for example, CNAMEs and trusted signers. Our changes for the 2012-05-05 release are intended to prevent these accidental deletions and to notify you when there's a mismatch between the number of values you say you're specifying in the <code>Quantity</code> element and the number of values specified.</p> </important>
  ## 
...
proc call*(call_594164: Call_CreateStreamingDistribution20170325_594152;
          body: JsonNode): Recallable =
...
var createStreamingDistribution20170325* = Call_CreateStreamingDistribution20170325_594152(
    ...
    validator: validate_CreateStreamingDistribution20170325_594153, base: "/",
    url: url_CreateStreamingDistribution20170325_594154,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListStreamingDistributions20170325_594137 = ref object of OpenApiRestCall_593437
proc url_ListStreamingDistributions20170325_594139(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListStreamingDistributions20170325_594138(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594149: Call_ListStreamingDistributions20170325_594137;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List streaming distributions. 
  ## 
...
proc call*(call_594150: Call_ListStreamingDistributions20170325_594137;
          Marker: string = ""; MaxItems: string = ""): Recallable =
...
var listStreamingDistributions20170325* = Call_ListStreamingDistributions20170325_594137(
    name: "listStreamingDistributions20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/streaming-distribution",
    validator: validate_ListStreamingDistributions20170325_594138, base: "/",
    url: url_ListStreamingDistributions20170325_594139,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateStreamingDistributionWithTags20170325_594166 = ref object of OpenApiRestCall_593437
proc url_CreateStreamingDistributionWithTags20170325_594168(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateStreamingDistributionWithTags20170325_594167(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594178: Call_CreateStreamingDistributionWithTags20170325_594166;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Create a new streaming distribution with tags.
  ## 
...
proc call*(call_594179: Call_CreateStreamingDistributionWithTags20170325_594166;
          WithTags: bool; body: JsonNode): Recallable =
...
var createStreamingDistributionWithTags20170325* = Call_CreateStreamingDistributionWithTags20170325_594166(
    name: "createStreamingDistributionWithTags20170325",
    meth: HttpMethod.HttpPost, host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/streaming-distribution#WithTags",
    validator: validate_CreateStreamingDistributionWithTags20170325_594167,
    base: "/", url: url_CreateStreamingDistributionWithTags20170325_594168,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCloudFrontOriginAccessIdentity20170325_594182 = ref object of OpenApiRestCall_593437
proc url_GetCloudFrontOriginAccessIdentity20170325_594184(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCloudFrontOriginAccessIdentity20170325_594183(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594193: Call_GetCloudFrontOriginAccessIdentity20170325_594182;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the information about an origin access identity. 
  ## 
...
proc call*(call_594194: Call_GetCloudFrontOriginAccessIdentity20170325_594182;
...
var getCloudFrontOriginAccessIdentity20170325* = Call_GetCloudFrontOriginAccessIdentity20170325_594182(
    ...
    validator: validate_GetCloudFrontOriginAccessIdentity20170325_594183,
    base: "/", url: url_GetCloudFrontOriginAccessIdentity20170325_594184,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteCloudFrontOriginAccessIdentity20170325_594196 = ref object of OpenApiRestCall_593437
proc url_DeleteCloudFrontOriginAccessIdentity20170325_594198(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteCloudFrontOriginAccessIdentity20170325_594197(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594208: Call_DeleteCloudFrontOriginAccessIdentity20170325_594196;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Delete an origin access identity. 
  ## 
...
proc call*(call_594209: Call_DeleteCloudFrontOriginAccessIdentity20170325_594196;
          Id: string): Recallable =
...
var deleteCloudFrontOriginAccessIdentity20170325* = Call_DeleteCloudFrontOriginAccessIdentity20170325_594196(
    name: "deleteCloudFrontOriginAccessIdentity20170325",
    meth: HttpMethod.HttpDelete, host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/origin-access-identity/cloudfront/{Id}",
    validator: validate_DeleteCloudFrontOriginAccessIdentity20170325_594197,
    base: "/", url: url_DeleteCloudFrontOriginAccessIdentity20170325_594198,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDistribution20170325_594211 = ref object of OpenApiRestCall_593437
proc url_GetDistribution20170325_594213(protocol: Scheme; host: string; base: string;
...
proc validate_GetDistribution20170325_594212(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594222: Call_GetDistribution20170325_594211; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the information about a distribution. 
  ## 
...
proc call*(call_594223: Call_GetDistribution20170325_594211; Id: string): Recallable =
...
var getDistribution20170325* = Call_GetDistribution20170325_594211(
    name: "getDistribution20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/distribution/{Id}",
    validator: validate_GetDistribution20170325_594212, base: "/",
    url: url_GetDistribution20170325_594213, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDistribution20170325_594225 = ref object of OpenApiRestCall_593437
proc url_DeleteDistribution20170325_594227(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDistribution20170325_594226(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594237: Call_DeleteDistribution20170325_594225; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a distribution. 
  ## 
...
proc call*(call_594238: Call_DeleteDistribution20170325_594225; Id: string): Recallable =
...
var deleteDistribution20170325* = Call_DeleteDistribution20170325_594225(
    name: "deleteDistribution20170325", meth: HttpMethod.HttpDelete,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/distribution/{Id}",
    validator: validate_DeleteDistribution20170325_594226, base: "/",
    url: url_DeleteDistribution20170325_594227,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteServiceLinkedRole20170325_594240 = ref object of OpenApiRestCall_593437
proc url_DeleteServiceLinkedRole20170325_594242(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteServiceLinkedRole20170325_594241(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  var section: JsonNode
  result = newJObject()
  ## parameters in `path` object:
  ...
  var valid_594243 = path.getOrDefault("RoleName")
  valid_594243 = validateParameter(valid_594243, JString, required = true,
                                 default = nil)
  if valid_594243 != nil:
    section.add "RoleName", valid_594243
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594251: Call_DeleteServiceLinkedRole20170325_594240;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
...
proc call*(call_594252: Call_DeleteServiceLinkedRole20170325_594240;
          RoleName: string): Recallable =
  ## deleteServiceLinkedRole20170325
  ##   RoleName: string (required)
  var path_594253 = newJObject()
  add(path_594253, "RoleName", newJString(RoleName))
  result = call_594252.call(path_594253, nil, nil, nil, nil)

var deleteServiceLinkedRole20170325* = Call_DeleteServiceLinkedRole20170325_594240(
    name: "deleteServiceLinkedRole20170325", meth: HttpMethod.HttpDelete,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/service-linked-role/{RoleName}",
    validator: validate_DeleteServiceLinkedRole20170325_594241, base: "/",
    url: url_DeleteServiceLinkedRole20170325_594242,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetStreamingDistribution20170325_594254 = ref object of OpenApiRestCall_593437
proc url_GetStreamingDistribution20170325_594256(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetStreamingDistribution20170325_594255(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594265: Call_GetStreamingDistribution20170325_594254;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets information about a specified RTMP distribution, including the distribution configuration.
  ## 
...
proc call*(call_594266: Call_GetStreamingDistribution20170325_594254; Id: string): Recallable =
  ## getStreamingDistribution20170325
  ## Gets information about a specified RTMP distribution, including the distribution configuration.
  ##   Id: string (required)
  ##     : The streaming distribution's ID.
  var path_594267 = newJObject()
  add(path_594267, "Id", newJString(Id))
  result = call_594266.call(path_594267, nil, nil, nil, nil)

var getStreamingDistribution20170325* = Call_GetStreamingDistribution20170325_594254(
    name: "getStreamingDistribution20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/streaming-distribution/{Id}",
    validator: validate_GetStreamingDistribution20170325_594255, base: "/",
    url: url_GetStreamingDistribution20170325_594256,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteStreamingDistribution20170325_594268 = ref object of OpenApiRestCall_593437
proc url_DeleteStreamingDistribution20170325_594270(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteStreamingDistribution20170325_594269(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594274 = header.getOrDefault("If-Match")
  valid_594274 = validateParameter(valid_594274, JString, required = false,
                                 default = nil)
  if valid_594274 != nil:
    section.add "If-Match", valid_594274
...
proc call*(call_594280: Call_DeleteStreamingDistribution20170325_594268;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Delete a streaming distribution. To delete an RTMP distribution using the CloudFront API, perform the following steps.</p> <p> <b>To delete an RTMP distribution using the CloudFront API</b>:</p> <ol> <li> <p>Disable the RTMP distribution.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to get the current configuration and the <code>Etag</code> header for the distribution. </p> </li> <li> <p>Update the XML document that was returned in the response to your <code>GET Streaming Distribution Config</code> request to change the value of <code>Enabled</code> to <code>false</code>.</p> </li> <li> <p>Submit a <code>PUT Streaming Distribution Config</code> request to update the configuration for your distribution. In the request body, include the XML document that you updated in Step 3. Then set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to the <code>PUT Streaming Distribution Config</code> request to confirm that the distribution was successfully disabled.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to confirm that your changes have propagated. When propagation is complete, the value of <code>Status</code> is <code>Deployed</code>.</p> </li> <li> <p>Submit a <code>DELETE Streaming Distribution</code> request. Set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to your <code>DELETE Streaming Distribution</code> request to confirm that the distribution was successfully deleted.</p> </li> </ol> <p>For information about deleting a distribution using the CloudFront console, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowToDeleteDistribution.html">Deleting a Distribution</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>
  ## 
...
proc call*(call_594281: Call_DeleteStreamingDistribution20170325_594268; Id: string): Recallable =
...
var deleteStreamingDistribution20170325* = Call_DeleteStreamingDistribution20170325_594268(
    name: "deleteStreamingDistribution20170325", meth: HttpMethod.HttpDelete,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/streaming-distribution/{Id}",
    validator: validate_DeleteStreamingDistribution20170325_594269, base: "/",
    url: url_DeleteStreamingDistribution20170325_594270,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateCloudFrontOriginAccessIdentity20170325_594297 = ref object of OpenApiRestCall_593437
proc url_UpdateCloudFrontOriginAccessIdentity20170325_594299(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateCloudFrontOriginAccessIdentity20170325_594298(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594303 = header.getOrDefault("If-Match")
  valid_594303 = validateParameter(valid_594303, JString, required = false,
                                 default = nil)
  if valid_594303 != nil:
    section.add "If-Match", valid_594303
...
proc call*(call_594310: Call_UpdateCloudFrontOriginAccessIdentity20170325_594297;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update an origin access identity. 
  ## 
...
proc call*(call_594311: Call_UpdateCloudFrontOriginAccessIdentity20170325_594297;
  ...
  add(path_594312, "Id", newJString(Id))
  if body != nil:
    body_594313 = body
  result = call_594311.call(path_594312, nil, nil, nil, body_594313)

var updateCloudFrontOriginAccessIdentity20170325* = Call_UpdateCloudFrontOriginAccessIdentity20170325_594297(
    ...
    validator: validate_UpdateCloudFrontOriginAccessIdentity20170325_594298,
    base: "/", url: url_UpdateCloudFrontOriginAccessIdentity20170325_594299,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCloudFrontOriginAccessIdentityConfig20170325_594283 = ref object of OpenApiRestCall_593437
proc url_GetCloudFrontOriginAccessIdentityConfig20170325_594285(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCloudFrontOriginAccessIdentityConfig20170325_594284(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_594294: Call_GetCloudFrontOriginAccessIdentityConfig20170325_594283;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the configuration information about an origin access identity. 
  ## 
...
proc call*(call_594295: Call_GetCloudFrontOriginAccessIdentityConfig20170325_594283;
          Id: string): Recallable =
  ...
  add(path_594296, "Id", newJString(Id))
  result = call_594295.call(path_594296, nil, nil, nil, nil)

var getCloudFrontOriginAccessIdentityConfig20170325* = Call_GetCloudFrontOriginAccessIdentityConfig20170325_594283(
    name: "getCloudFrontOriginAccessIdentityConfig20170325",
    meth: HttpMethod.HttpGet, host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/origin-access-identity/cloudfront/{Id}/config",
    validator: validate_GetCloudFrontOriginAccessIdentityConfig20170325_594284,
    base: "/", url: url_GetCloudFrontOriginAccessIdentityConfig20170325_594285,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDistribution20170325_594328 = ref object of OpenApiRestCall_593437
proc url_UpdateDistribution20170325_594330(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDistribution20170325_594329(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594334 = header.getOrDefault("If-Match")
  valid_594334 = validateParameter(valid_594334, JString, required = false,
                                 default = nil)
  if valid_594334 != nil:
    section.add "If-Match", valid_594334
...
proc call*(call_594341: Call_UpdateDistribution20170325_594328; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates the configuration for a web distribution. Perform the following steps.</p> <p>For information about updating a distribution using the CloudFront console, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-creating-console.html">Creating or Updating a Web Distribution Using the CloudFront Console </a> in the <i>Amazon CloudFront Developer Guide</i>.</p> <p> <b>To update a web distribution using the CloudFront API</b> </p> <ol> <li> <p>Submit a <a>GetDistributionConfig</a> request to get the current configuration and an <code>Etag</code> header for the distribution.</p> <note> <p>If you update the distribution again, you need to get a new <code>Etag</code> header.</p> </note> </li> <li> <p>Update the XML document that was returned in the response to your <code>GetDistributionConfig</code> request to include the desired changes. You can't change the value of <code>CallerReference</code>. If you try to change this value, CloudFront returns an <code>IllegalUpdate</code> error.</p> <important> <p>The new configuration replaces the existing configuration; the values that you specify in an <code>UpdateDistribution</code> request are not merged into the existing configuration. When you add, delete, or replace values in an element that allows multiple values (for example, <code>CNAME</code>), you must specify all of the values that you want to appear in the updated distribution. In addition, you must update the corresponding <code>Quantity</code> element.</p> </important> </li> <li> <p>Submit an <code>UpdateDistribution</code> request to update the configuration for your distribution:</p> <ul> <li> <p>In the request body, include the XML document that you updated in Step 2. The request body must include an XML document with a <code>DistributionConfig</code> element.</p> </li> <li> <p>Set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GetDistributionConfig</code> request in Step 1.</p> </li> </ul> </li> <li> <p>Review the response to the <code>UpdateDistribution</code> request to confirm that the configuration was successfully updated.</p> </li> <li> <p>Optional: Submit a <a>GetDistribution</a> request to confirm that your changes have propagated. When propagation is complete, the value of <code>Status</code> is <code>Deployed</code>.</p> <important> <p>Beginning with the 2012-05-05 version of the CloudFront API, we made substantial changes to the format of the XML document that you include in the request body when you create or update a distribution. With previous versions of the API, we discovered that it was too easy to accidentally delete one or more values for an element that accepts multiple values, for example, CNAMEs and trusted signers. Our changes for the 2012-05-05 release are intended to prevent these accidental deletions and to notify you when there's a mismatch between the number of values you say you're specifying in the <code>Quantity</code> element and the number of values you're actually specifying.</p> </important> </li> </ol>
  ## 
...
proc call*(call_594342: Call_UpdateDistribution20170325_594328; Id: string;
          body: JsonNode): Recallable =
  ...
  add(path_594343, "Id", newJString(Id))
  if body != nil:
    body_594344 = body
  result = call_594342.call(path_594343, nil, nil, nil, body_594344)

var updateDistribution20170325* = Call_UpdateDistribution20170325_594328(
    name: "updateDistribution20170325", meth: HttpMethod.HttpPut,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distribution/{Id}/config",
    validator: validate_UpdateDistribution20170325_594329, base: "/",
    url: url_UpdateDistribution20170325_594330,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDistributionConfig20170325_594314 = ref object of OpenApiRestCall_593437
proc url_GetDistributionConfig20170325_594316(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDistributionConfig20170325_594315(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594325: Call_GetDistributionConfig20170325_594314; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the configuration information about a distribution. 
  ## 
...
proc call*(call_594326: Call_GetDistributionConfig20170325_594314; Id: string): Recallable =
  ## getDistributionConfig20170325
  ## Get the configuration information about a distribution. 
  ##   Id: string (required)
  ##     : The distribution's ID.
  var path_594327 = newJObject()
  add(path_594327, "Id", newJString(Id))
  result = call_594326.call(path_594327, nil, nil, nil, nil)

var getDistributionConfig20170325* = Call_GetDistributionConfig20170325_594314(
    name: "getDistributionConfig20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distribution/{Id}/config",
    validator: validate_GetDistributionConfig20170325_594315, base: "/",
    url: url_GetDistributionConfig20170325_594316,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInvalidation20170325_594345 = ref object of OpenApiRestCall_593437
proc url_GetInvalidation20170325_594347(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetInvalidation20170325_594346(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `Id` field"
  var valid_594348 = path.getOrDefault("Id")
  valid_594348 = validateParameter(valid_594348, JString, required = true,
                                 default = nil)
  if valid_594348 != nil:
    section.add "Id", valid_594348
  var valid_594349 = path.getOrDefault("DistributionId")
  valid_594349 = validateParameter(valid_594349, JString, required = true,
                                 default = nil)
  if valid_594349 != nil:
    section.add "DistributionId", valid_594349
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594357: Call_GetInvalidation20170325_594345; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the information about an invalidation. 
  ## 
...
proc call*(call_594358: Call_GetInvalidation20170325_594345; Id: string;
          DistributionId: string): Recallable =
  ...
  add(path_594359, "DistributionId", newJString(DistributionId))
  result = call_594358.call(path_594359, nil, nil, nil, nil)

var getInvalidation20170325* = Call_GetInvalidation20170325_594345(
    name: "getInvalidation20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distribution/{DistributionId}/invalidation/{Id}",
    validator: validate_GetInvalidation20170325_594346, base: "/",
    url: url_GetInvalidation20170325_594347, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateStreamingDistribution20170325_594374 = ref object of OpenApiRestCall_593437
proc url_UpdateStreamingDistribution20170325_594376(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateStreamingDistribution20170325_594375(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594380 = header.getOrDefault("If-Match")
  valid_594380 = validateParameter(valid_594380, JString, required = false,
                                 default = nil)
  if valid_594380 != nil:
    section.add "If-Match", valid_594380
...
proc call*(call_594387: Call_UpdateStreamingDistribution20170325_594374;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update a streaming distribution. 
  ## 
...
proc call*(call_594388: Call_UpdateStreamingDistribution20170325_594374;
          Id: string; body: JsonNode): Recallable =
  ...
  add(path_594389, "Id", newJString(Id))
  if body != nil:
    body_594390 = body
  result = call_594388.call(path_594389, nil, nil, nil, body_594390)

var updateStreamingDistribution20170325* = Call_UpdateStreamingDistribution20170325_594374(
    name: "updateStreamingDistribution20170325", meth: HttpMethod.HttpPut,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/streaming-distribution/{Id}/config",
    validator: validate_UpdateStreamingDistribution20170325_594375, base: "/",
    url: url_UpdateStreamingDistribution20170325_594376,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetStreamingDistributionConfig20170325_594360 = ref object of OpenApiRestCall_593437
proc url_GetStreamingDistributionConfig20170325_594362(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetStreamingDistributionConfig20170325_594361(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594371: Call_GetStreamingDistributionConfig20170325_594360;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the configuration information about a streaming distribution. 
  ## 
...
proc call*(call_594372: Call_GetStreamingDistributionConfig20170325_594360;
          Id: string): Recallable =
  ...
  add(path_594373, "Id", newJString(Id))
  result = call_594372.call(path_594373, nil, nil, nil, nil)

var getStreamingDistributionConfig20170325* = Call_GetStreamingDistributionConfig20170325_594360(
    name: "getStreamingDistributionConfig20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/streaming-distribution/{Id}/config",
    validator: validate_GetStreamingDistributionConfig20170325_594361, base: "/",
    url: url_GetStreamingDistributionConfig20170325_594362,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDistributionsByWebACLId20170325_594391 = ref object of OpenApiRestCall_593437
proc url_ListDistributionsByWebACLId20170325_594393(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDistributionsByWebACLId20170325_594392(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594394 = path.getOrDefault("WebACLId")
  valid_594394 = validateParameter(valid_594394, JString, required = true,
                                 default = nil)
  if valid_594394 != nil:
    section.add "WebACLId", valid_594394
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ...
  section = newJObject()
  var valid_594395 = query.getOrDefault("Marker")
  valid_594395 = validateParameter(valid_594395, JString, required = false,
                                 default = nil)
  if valid_594395 != nil:
    section.add "Marker", valid_594395
  var valid_594396 = query.getOrDefault("MaxItems")
  valid_594396 = validateParameter(valid_594396, JString, required = false,
                                 default = nil)
  if valid_594396 != nil:
    section.add "MaxItems", valid_594396
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594404: Call_ListDistributionsByWebACLId20170325_594391;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List the distributions that are associated with a specified AWS WAF web ACL. 
  ## 
...
proc call*(call_594405: Call_ListDistributionsByWebACLId20170325_594391;
  ...
  add(query_594407, "Marker", newJString(Marker))
  add(query_594407, "MaxItems", newJString(MaxItems))
  add(path_594406, "WebACLId", newJString(WebACLId))
  result = call_594405.call(path_594406, query_594407, nil, nil, nil)

var listDistributionsByWebACLId20170325* = Call_ListDistributionsByWebACLId20170325_594391(
    name: "listDistributionsByWebACLId20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/distributionsByWebACLId/{WebACLId}",
    validator: validate_ListDistributionsByWebACLId20170325_594392, base: "/",
    url: url_ListDistributionsByWebACLId20170325_594393,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource20170325_594408 = ref object of OpenApiRestCall_593437
proc url_ListTagsForResource20170325_594410(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource20170325_594409(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594419: Call_ListTagsForResource20170325_594408; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List tags for a CloudFront resource.
  ## 
...
proc call*(call_594420: Call_ListTagsForResource20170325_594408; Resource: string): Recallable =
  ## listTagsForResource20170325
  ## List tags for a CloudFront resource.
  ##   Resource: string (required)
  ##           :  An ARN of a CloudFront resource.
  var query_594421 = newJObject()
  add(query_594421, "Resource", newJString(Resource))
  result = call_594420.call(nil, query_594421, nil, nil, nil)

var listTagsForResource20170325* = Call_ListTagsForResource20170325_594408(
    name: "listTagsForResource20170325", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2017-03-25/tagging#Resource",
    validator: validate_ListTagsForResource20170325_594409, base: "/",
    url: url_ListTagsForResource20170325_594410,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource20170325_594422 = ref object of OpenApiRestCall_593437
proc url_TagResource20170325_594424(protocol: Scheme; host: string; base: string;
...
proc validate_TagResource20170325_594423(path: JsonNode; query: JsonNode;
  ...
  assert query != nil,
        "query argument is necessary due to required `Resource` field"
  var valid_594425 = query.getOrDefault("Resource")
  valid_594425 = validateParameter(valid_594425, JString, required = true,
                                 default = nil)
  if valid_594425 != nil:
    section.add "Resource", valid_594425
  var valid_594439 = query.getOrDefault("Operation")
  valid_594439 = validateParameter(valid_594439, JString, required = true,
                                 default = newJString("Tag"))
  if valid_594439 != nil:
    section.add "Operation", valid_594439
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594448: Call_TagResource20170325_594422; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Add tags to a CloudFront resource.
  ## 
...
proc call*(call_594449: Call_TagResource20170325_594422; Resource: string;
  ...
  add(query_594450, "Resource", newJString(Resource))
  add(query_594450, "Operation", newJString(Operation))
  if body != nil:
    body_594451 = body
  result = call_594449.call(nil, query_594450, nil, nil, body_594451)

var tagResource20170325* = Call_TagResource20170325_594422(
    name: "tagResource20170325", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/tagging#Operation=Tag&Resource",
    validator: validate_TagResource20170325_594423, base: "/",
    url: url_TagResource20170325_594424, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource20170325_594452 = ref object of OpenApiRestCall_593437
proc url_UntagResource20170325_594454(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource20170325_594453(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert query != nil,
        "query argument is necessary due to required `Resource` field"
  var valid_594455 = query.getOrDefault("Resource")
  valid_594455 = validateParameter(valid_594455, JString, required = true,
                                 default = nil)
  if valid_594455 != nil:
    section.add "Resource", valid_594455
  var valid_594456 = query.getOrDefault("Operation")
  valid_594456 = validateParameter(valid_594456, JString, required = true,
                                 default = newJString("Untag"))
  if valid_594456 != nil:
    section.add "Operation", valid_594456
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594465: Call_UntagResource20170325_594452; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Remove tags from a CloudFront resource.
  ## 
...
proc call*(call_594466: Call_UntagResource20170325_594452; Resource: string;
  ...
  add(query_594467, "Resource", newJString(Resource))
  add(query_594467, "Operation", newJString(Operation))
  if body != nil:
    body_594468 = body
  result = call_594466.call(nil, query_594467, nil, nil, body_594468)

var untagResource20170325* = Call_UntagResource20170325_594452(
    name: "untagResource20170325", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2017-03-25/tagging#Operation=Untag&Resource",
    validator: validate_UntagResource20170325_594453, base: "/",
    url: url_UntagResource20170325_594454, schemes: {Scheme.Https, Scheme.Http})
export
  rest
