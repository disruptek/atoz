...
type
  Call_CreateAccelerator_600774 = ref object of OpenApiRestCall_600437
proc url_CreateAccelerator_600776(protocol: Scheme; host: string; base: string;
...
proc validate_CreateAccelerator_600775(path: JsonNode; query: JsonNode;
...
proc call*(call_600932: Call_CreateAccelerator_600774; path: JsonNode;
...
proc call*(call_601003: Call_CreateAccelerator_600774; body: JsonNode): Recallable =
  ## createAccelerator
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var createAccelerator* = Call_CreateAccelerator_600774(name: "createAccelerator",
    ...
    validator: validate_CreateAccelerator_600775, base: "/",
    url: url_CreateAccelerator_600776, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpointGroup_601043 = ref object of OpenApiRestCall_600437
proc url_CreateEndpointGroup_601045(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpointGroup_601044(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601055: Call_CreateEndpointGroup_601043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_601056: Call_CreateEndpointGroup_601043; body: JsonNode): Recallable =
  ## createEndpointGroup
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createEndpointGroup* = Call_CreateEndpointGroup_601043(
    ...
    validator: validate_CreateEndpointGroup_601044, base: "/",
    url: url_CreateEndpointGroup_601045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateListener_601058 = ref object of OpenApiRestCall_600437
proc url_CreateListener_601060(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateListener_601059(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601070: Call_CreateListener_601058; path: JsonNode; query: JsonNode;
...
proc call*(call_601071: Call_CreateListener_601058; body: JsonNode): Recallable =
  ## createListener
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createListener* = Call_CreateListener_601058(name: "createListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener",
    validator: validate_CreateListener_601059, base: "/", url: url_CreateListener_601060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAccelerator_601073 = ref object of OpenApiRestCall_600437
proc url_DeleteAccelerator_601075(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAccelerator_601074(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601085: Call_DeleteAccelerator_601073; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ## 
...
proc call*(call_601086: Call_DeleteAccelerator_601073; body: JsonNode): Recallable =
  ## deleteAccelerator
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ##   body: JObject (required)
...
var deleteAccelerator* = Call_DeleteAccelerator_601073(name: "deleteAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator",
    validator: validate_DeleteAccelerator_601074, base: "/",
    url: url_DeleteAccelerator_601075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpointGroup_601088 = ref object of OpenApiRestCall_600437
proc url_DeleteEndpointGroup_601090(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpointGroup_601089(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601100: Call_DeleteEndpointGroup_601088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an endpoint group from a listener.
  ## 
...
proc call*(call_601101: Call_DeleteEndpointGroup_601088; body: JsonNode): Recallable =
  ## deleteEndpointGroup
  ## Delete an endpoint group from a listener.
  ##   body: JObject (required)
...
var deleteEndpointGroup* = Call_DeleteEndpointGroup_601088(
    name: "deleteEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup",
    validator: validate_DeleteEndpointGroup_601089, base: "/",
    url: url_DeleteEndpointGroup_601090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteListener_601103 = ref object of OpenApiRestCall_600437
proc url_DeleteListener_601105(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteListener_601104(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601115: Call_DeleteListener_601103; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a listener from an accelerator.
  ## 
...
proc call*(call_601116: Call_DeleteListener_601103; body: JsonNode): Recallable =
  ## deleteListener
  ## Delete a listener from an accelerator.
  ##   body: JObject (required)
...
var deleteListener* = Call_DeleteListener_601103(name: "deleteListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener",
    validator: validate_DeleteListener_601104, base: "/", url: url_DeleteListener_601105,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccelerator_601118 = ref object of OpenApiRestCall_600437
proc url_DescribeAccelerator_601120(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccelerator_601119(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601130: Call_DescribeAccelerator_601118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_601131: Call_DescribeAccelerator_601118; body: JsonNode): Recallable =
  ## describeAccelerator
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeAccelerator* = Call_DescribeAccelerator_601118(
    name: "describeAccelerator", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator",
    validator: validate_DescribeAccelerator_601119, base: "/",
    url: url_DescribeAccelerator_601120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAcceleratorAttributes_601133 = ref object of OpenApiRestCall_600437
proc url_DescribeAcceleratorAttributes_601135(protocol: Scheme; host: string;
...
proc validate_DescribeAcceleratorAttributes_601134(path: JsonNode; query: JsonNode;
...
proc call*(call_601145: Call_DescribeAcceleratorAttributes_601133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe the attributes of an accelerator.
  ## 
...
proc call*(call_601146: Call_DescribeAcceleratorAttributes_601133; body: JsonNode): Recallable =
...
var describeAcceleratorAttributes* = Call_DescribeAcceleratorAttributes_601133(
    ...
    validator: validate_DescribeAcceleratorAttributes_601134, base: "/",
    url: url_DescribeAcceleratorAttributes_601135,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointGroup_601148 = ref object of OpenApiRestCall_600437
proc url_DescribeEndpointGroup_601150(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpointGroup_601149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601160: Call_DescribeEndpointGroup_601148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an endpoint group.
  ## 
...
proc call*(call_601161: Call_DescribeEndpointGroup_601148; body: JsonNode): Recallable =
...
var describeEndpointGroup* = Call_DescribeEndpointGroup_601148(
    name: "describeEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup",
    validator: validate_DescribeEndpointGroup_601149, base: "/",
    url: url_DescribeEndpointGroup_601150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeListener_601163 = ref object of OpenApiRestCall_600437
proc url_DescribeListener_601165(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeListener_601164(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ## Describe a listener.
  ## 
...
proc call*(call_601175: Call_DescribeListener_601163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe a listener.
  ## 
...
proc call*(call_601176: Call_DescribeListener_601163; body: JsonNode): Recallable =
  ## describeListener
  ## Describe a listener.
  ##   body: JObject (required)
...
var describeListener* = Call_DescribeListener_601163(name: "describeListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener",
    validator: validate_DescribeListener_601164, base: "/",
    url: url_DescribeListener_601165, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAccelerators_601178 = ref object of OpenApiRestCall_600437
proc url_ListAccelerators_601180(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAccelerators_601179(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601190: Call_ListAccelerators_601178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the accelerators for an AWS account.
  ## 
...
proc call*(call_601191: Call_ListAccelerators_601178; body: JsonNode): Recallable =
  ## listAccelerators
  ## List the accelerators for an AWS account.
  ##   body: JObject (required)
...
var listAccelerators* = Call_ListAccelerators_601178(name: "listAccelerators",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators",
    validator: validate_ListAccelerators_601179, base: "/",
    url: url_ListAccelerators_601180, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEndpointGroups_601193 = ref object of OpenApiRestCall_600437
proc url_ListEndpointGroups_601195(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEndpointGroups_601194(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601205: Call_ListEndpointGroups_601193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the endpoint groups that are associated with a listener.
  ## 
...
proc call*(call_601206: Call_ListEndpointGroups_601193; body: JsonNode): Recallable =
  ## listEndpointGroups
  ## List the endpoint groups that are associated with a listener.
  ##   body: JObject (required)
...
var listEndpointGroups* = Call_ListEndpointGroups_601193(
    name: "listEndpointGroups", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups",
    validator: validate_ListEndpointGroups_601194, base: "/",
    url: url_ListEndpointGroups_601195, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListListeners_601208 = ref object of OpenApiRestCall_600437
proc url_ListListeners_601210(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListListeners_601209(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601220: Call_ListListeners_601208; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the listeners for an accelerator.
  ## 
...
proc call*(call_601221: Call_ListListeners_601208; body: JsonNode): Recallable =
  ## listListeners
  ## List the listeners for an accelerator.
  ##   body: JObject (required)
...
var listListeners* = Call_ListListeners_601208(name: "listListeners",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners",
    validator: validate_ListListeners_601209, base: "/", url: url_ListListeners_601210,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAccelerator_601223 = ref object of OpenApiRestCall_600437
proc url_UpdateAccelerator_601225(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAccelerator_601224(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601235: Call_UpdateAccelerator_601223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_601236: Call_UpdateAccelerator_601223; body: JsonNode): Recallable =
  ## updateAccelerator
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var updateAccelerator* = Call_UpdateAccelerator_601223(name: "updateAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator",
    validator: validate_UpdateAccelerator_601224, base: "/",
    url: url_UpdateAccelerator_601225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAcceleratorAttributes_601238 = ref object of OpenApiRestCall_600437
proc url_UpdateAcceleratorAttributes_601240(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAcceleratorAttributes_601239(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601250: Call_UpdateAcceleratorAttributes_601238; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update the attributes for an accelerator. To see an AWS CLI example of updating an accelerator to enable flow logs, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_601251: Call_UpdateAcceleratorAttributes_601238; body: JsonNode): Recallable =
...
var updateAcceleratorAttributes* = Call_UpdateAcceleratorAttributes_601238(
    ...
    validator: validate_UpdateAcceleratorAttributes_601239, base: "/",
    url: url_UpdateAcceleratorAttributes_601240,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEndpointGroup_601253 = ref object of OpenApiRestCall_600437
proc url_UpdateEndpointGroup_601255(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEndpointGroup_601254(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601265: Call_UpdateEndpointGroup_601253; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_601266: Call_UpdateEndpointGroup_601253; body: JsonNode): Recallable =
  ## updateEndpointGroup
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateEndpointGroup* = Call_UpdateEndpointGroup_601253(
    name: "updateEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup",
    validator: validate_UpdateEndpointGroup_601254, base: "/",
    url: url_UpdateEndpointGroup_601255, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateListener_601268 = ref object of OpenApiRestCall_600437
proc url_UpdateListener_601270(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateListener_601269(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Update a listener.
  ## 
...
proc call*(call_601280: Call_UpdateListener_601268; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a listener.
  ## 
...
proc call*(call_601281: Call_UpdateListener_601268; body: JsonNode): Recallable =
  ## updateListener
  ## Update a listener.
  ##   body: JObject (required)
...
var updateListener* = Call_UpdateListener_601268(name: "updateListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener",
    validator: validate_UpdateListener_601269, base: "/", url: url_UpdateListener_601270,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
