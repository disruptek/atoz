...
type
  Call_CreateAccelerator_602803 = ref object of OpenApiRestCall_602466
proc url_CreateAccelerator_602805(protocol: Scheme; host: string; base: string;
...
proc validate_CreateAccelerator_602804(path: JsonNode; query: JsonNode;
...
proc call*(call_602961: Call_CreateAccelerator_602803; path: JsonNode;
...
proc call*(call_603032: Call_CreateAccelerator_602803; body: JsonNode): Recallable =
  ## createAccelerator
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var createAccelerator* = Call_CreateAccelerator_602803(name: "createAccelerator",
    ...
    validator: validate_CreateAccelerator_602804, base: "/",
    url: url_CreateAccelerator_602805, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpointGroup_603072 = ref object of OpenApiRestCall_602466
proc url_CreateEndpointGroup_603074(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpointGroup_603073(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603084: Call_CreateEndpointGroup_603072; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603085: Call_CreateEndpointGroup_603072; body: JsonNode): Recallable =
  ## createEndpointGroup
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createEndpointGroup* = Call_CreateEndpointGroup_603072(
    ...
    validator: validate_CreateEndpointGroup_603073, base: "/",
    url: url_CreateEndpointGroup_603074, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateListener_603087 = ref object of OpenApiRestCall_602466
proc url_CreateListener_603089(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateListener_603088(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_603099: Call_CreateListener_603087; path: JsonNode; query: JsonNode;
...
proc call*(call_603100: Call_CreateListener_603087; body: JsonNode): Recallable =
  ## createListener
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createListener* = Call_CreateListener_603087(name: "createListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener",
    validator: validate_CreateListener_603088, base: "/", url: url_CreateListener_603089,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAccelerator_603102 = ref object of OpenApiRestCall_602466
proc url_DeleteAccelerator_603104(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAccelerator_603103(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603114: Call_DeleteAccelerator_603102; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ## 
...
proc call*(call_603115: Call_DeleteAccelerator_603102; body: JsonNode): Recallable =
  ## deleteAccelerator
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ##   body: JObject (required)
...
var deleteAccelerator* = Call_DeleteAccelerator_603102(name: "deleteAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator",
    validator: validate_DeleteAccelerator_603103, base: "/",
    url: url_DeleteAccelerator_603104, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpointGroup_603117 = ref object of OpenApiRestCall_602466
proc url_DeleteEndpointGroup_603119(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpointGroup_603118(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603129: Call_DeleteEndpointGroup_603117; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an endpoint group from a listener.
  ## 
...
proc call*(call_603130: Call_DeleteEndpointGroup_603117; body: JsonNode): Recallable =
  ## deleteEndpointGroup
  ## Delete an endpoint group from a listener.
  ##   body: JObject (required)
...
var deleteEndpointGroup* = Call_DeleteEndpointGroup_603117(
    name: "deleteEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup",
    validator: validate_DeleteEndpointGroup_603118, base: "/",
    url: url_DeleteEndpointGroup_603119, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteListener_603132 = ref object of OpenApiRestCall_602466
proc url_DeleteListener_603134(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteListener_603133(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_603144: Call_DeleteListener_603132; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a listener from an accelerator.
  ## 
...
proc call*(call_603145: Call_DeleteListener_603132; body: JsonNode): Recallable =
  ## deleteListener
  ## Delete a listener from an accelerator.
  ##   body: JObject (required)
...
var deleteListener* = Call_DeleteListener_603132(name: "deleteListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener",
    validator: validate_DeleteListener_603133, base: "/", url: url_DeleteListener_603134,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccelerator_603147 = ref object of OpenApiRestCall_602466
proc url_DescribeAccelerator_603149(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccelerator_603148(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603159: Call_DescribeAccelerator_603147; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603160: Call_DescribeAccelerator_603147; body: JsonNode): Recallable =
  ## describeAccelerator
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeAccelerator* = Call_DescribeAccelerator_603147(
    name: "describeAccelerator", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator",
    validator: validate_DescribeAccelerator_603148, base: "/",
    url: url_DescribeAccelerator_603149, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAcceleratorAttributes_603162 = ref object of OpenApiRestCall_602466
proc url_DescribeAcceleratorAttributes_603164(protocol: Scheme; host: string;
...
proc validate_DescribeAcceleratorAttributes_603163(path: JsonNode; query: JsonNode;
...
proc call*(call_603174: Call_DescribeAcceleratorAttributes_603162; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe the attributes of an accelerator.
  ## 
...
proc call*(call_603175: Call_DescribeAcceleratorAttributes_603162; body: JsonNode): Recallable =
...
var describeAcceleratorAttributes* = Call_DescribeAcceleratorAttributes_603162(
    ...
    validator: validate_DescribeAcceleratorAttributes_603163, base: "/",
    url: url_DescribeAcceleratorAttributes_603164,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointGroup_603177 = ref object of OpenApiRestCall_602466
proc url_DescribeEndpointGroup_603179(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpointGroup_603178(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603189: Call_DescribeEndpointGroup_603177; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an endpoint group.
  ## 
...
proc call*(call_603190: Call_DescribeEndpointGroup_603177; body: JsonNode): Recallable =
...
var describeEndpointGroup* = Call_DescribeEndpointGroup_603177(
    name: "describeEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup",
    validator: validate_DescribeEndpointGroup_603178, base: "/",
    url: url_DescribeEndpointGroup_603179, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeListener_603192 = ref object of OpenApiRestCall_602466
proc url_DescribeListener_603194(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeListener_603193(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ## Describe a listener.
  ## 
...
proc call*(call_603204: Call_DescribeListener_603192; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe a listener.
  ## 
...
proc call*(call_603205: Call_DescribeListener_603192; body: JsonNode): Recallable =
  ## describeListener
  ## Describe a listener.
  ##   body: JObject (required)
...
var describeListener* = Call_DescribeListener_603192(name: "describeListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener",
    validator: validate_DescribeListener_603193, base: "/",
    url: url_DescribeListener_603194, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAccelerators_603207 = ref object of OpenApiRestCall_602466
proc url_ListAccelerators_603209(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAccelerators_603208(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603219: Call_ListAccelerators_603207; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the accelerators for an AWS account.
  ## 
...
proc call*(call_603220: Call_ListAccelerators_603207; body: JsonNode): Recallable =
  ## listAccelerators
  ## List the accelerators for an AWS account.
  ##   body: JObject (required)
...
var listAccelerators* = Call_ListAccelerators_603207(name: "listAccelerators",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators",
    validator: validate_ListAccelerators_603208, base: "/",
    url: url_ListAccelerators_603209, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEndpointGroups_603222 = ref object of OpenApiRestCall_602466
proc url_ListEndpointGroups_603224(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEndpointGroups_603223(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603234: Call_ListEndpointGroups_603222; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the endpoint groups that are associated with a listener.
  ## 
...
proc call*(call_603235: Call_ListEndpointGroups_603222; body: JsonNode): Recallable =
  ## listEndpointGroups
  ## List the endpoint groups that are associated with a listener.
  ##   body: JObject (required)
...
var listEndpointGroups* = Call_ListEndpointGroups_603222(
    name: "listEndpointGroups", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups",
    validator: validate_ListEndpointGroups_603223, base: "/",
    url: url_ListEndpointGroups_603224, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListListeners_603237 = ref object of OpenApiRestCall_602466
proc url_ListListeners_603239(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListListeners_603238(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603249: Call_ListListeners_603237; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the listeners for an accelerator.
  ## 
...
proc call*(call_603250: Call_ListListeners_603237; body: JsonNode): Recallable =
  ## listListeners
  ## List the listeners for an accelerator.
  ##   body: JObject (required)
...
var listListeners* = Call_ListListeners_603237(name: "listListeners",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners",
    validator: validate_ListListeners_603238, base: "/", url: url_ListListeners_603239,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAccelerator_603252 = ref object of OpenApiRestCall_602466
proc url_UpdateAccelerator_603254(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAccelerator_603253(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603264: Call_UpdateAccelerator_603252; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_603265: Call_UpdateAccelerator_603252; body: JsonNode): Recallable =
  ## updateAccelerator
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var updateAccelerator* = Call_UpdateAccelerator_603252(name: "updateAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator",
    validator: validate_UpdateAccelerator_603253, base: "/",
    url: url_UpdateAccelerator_603254, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAcceleratorAttributes_603267 = ref object of OpenApiRestCall_602466
proc url_UpdateAcceleratorAttributes_603269(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAcceleratorAttributes_603268(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603279: Call_UpdateAcceleratorAttributes_603267; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update the attributes for an accelerator. To see an AWS CLI example of updating an accelerator to enable flow logs, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603280: Call_UpdateAcceleratorAttributes_603267; body: JsonNode): Recallable =
...
var updateAcceleratorAttributes* = Call_UpdateAcceleratorAttributes_603267(
    ...
    validator: validate_UpdateAcceleratorAttributes_603268, base: "/",
    url: url_UpdateAcceleratorAttributes_603269,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEndpointGroup_603282 = ref object of OpenApiRestCall_602466
proc url_UpdateEndpointGroup_603284(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEndpointGroup_603283(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603294: Call_UpdateEndpointGroup_603282; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603295: Call_UpdateEndpointGroup_603282; body: JsonNode): Recallable =
  ## updateEndpointGroup
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateEndpointGroup* = Call_UpdateEndpointGroup_603282(
    name: "updateEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup",
    validator: validate_UpdateEndpointGroup_603283, base: "/",
    url: url_UpdateEndpointGroup_603284, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateListener_603297 = ref object of OpenApiRestCall_602466
proc url_UpdateListener_603299(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateListener_603298(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Update a listener.
  ## 
...
proc call*(call_603309: Call_UpdateListener_603297; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a listener.
  ## 
...
proc call*(call_603310: Call_UpdateListener_603297; body: JsonNode): Recallable =
  ## updateListener
  ## Update a listener.
  ##   body: JObject (required)
...
var updateListener* = Call_UpdateListener_603297(name: "updateListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener",
    validator: validate_UpdateListener_603298, base: "/", url: url_UpdateListener_603299,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
