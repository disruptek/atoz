...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_AdvertiseByoipCidr_21625779 = ref object of OpenApiRestCall_21625435
proc url_AdvertiseByoipCidr_21625781(protocol: Scheme; host: string; base: string;
...
proc validate_AdvertiseByoipCidr_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_AdvertiseByoipCidr_21625779; path: JsonNode = nil;
...
proc call*(call_21625992: Call_AdvertiseByoipCidr_21625779; body: JsonNode): Recallable =
  ## advertiseByoipCidr
  ## <p>Advertises an IPv4 address range that is provisioned for use with your AWS resources through bring your own IP addresses (BYOIP). It can take a few minutes before traffic to the specified addresses starts routing to AWS because of propagation delays. To see an AWS CLI example of advertising an address range, scroll down to <b>Example</b>.</p> <p>To stop advertising the BYOIP address range, use <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/WithdrawByoipCidr.html"> WithdrawByoipCidr</a>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ##   body: JObject (required)
...
var advertiseByoipCidr* = Call_AdvertiseByoipCidr_21625779(
    ...
    validator: validate_AdvertiseByoipCidr_21625780, base: "/",
    makeUrl: url_AdvertiseByoipCidr_21625781, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAccelerator_21626029 = ref object of OpenApiRestCall_21625435
proc url_CreateAccelerator_21626031(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAccelerator_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_CreateAccelerator_21626029; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <p>If you bring your own IP address ranges to AWS Global Accelerator (BYOIP), you can assign IP addresses from your own pool to your accelerator as the static IP address entry points. Only one IP address from each of your IP address ranges can be used for each accelerator.</p> <important> <p>You must specify the US West (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_21626042: Call_CreateAccelerator_21626029; body: JsonNode): Recallable =
  ## createAccelerator
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <p>If you bring your own IP address ranges to AWS Global Accelerator (BYOIP), you can assign IP addresses from your own pool to your accelerator as the static IP address entry points. Only one IP address from each of your IP address ranges can be used for each accelerator.</p> <important> <p>You must specify the US West (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var createAccelerator* = Call_CreateAccelerator_21626029(name: "createAccelerator",
    ...
    validator: validate_CreateAccelerator_21626030, base: "/",
    makeUrl: url_CreateAccelerator_21626031, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpointGroup_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateEndpointGroup_21626046(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpointGroup_21626045(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626056: Call_CreateEndpointGroup_21626044; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626057: Call_CreateEndpointGroup_21626044; body: JsonNode): Recallable =
  ## createEndpointGroup
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createEndpointGroup* = Call_CreateEndpointGroup_21626044(
    name: "createEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateEndpointGroup",
    validator: validate_CreateEndpointGroup_21626045, base: "/",
    makeUrl: url_CreateEndpointGroup_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateListener_21626059 = ref object of OpenApiRestCall_21625435
proc url_CreateListener_21626061(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateListener_21626060(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626071: Call_CreateListener_21626059; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626072: Call_CreateListener_21626059; body: JsonNode): Recallable =
  ## createListener
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createListener* = Call_CreateListener_21626059(name: "createListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener",
    validator: validate_CreateListener_21626060, base: "/",
    makeUrl: url_CreateListener_21626061, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAccelerator_21626074 = ref object of OpenApiRestCall_21625435
proc url_DeleteAccelerator_21626076(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAccelerator_21626075(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_DeleteAccelerator_21626074; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Delete an accelerator. Before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups). To disable the accelerator, update the accelerator to set <code>Enabled</code> to false.</p> <important> <p>When you create an accelerator, by default, Global Accelerator provides you with a set of two static IP addresses. Alternatively, you can bring your own IP address ranges to Global Accelerator and assign IP addresses from those ranges. </p> <p>The IP addresses are assigned to your accelerator for as long as it exists, even if you disable the accelerator and it no longer accepts or routes traffic. However, when you <i>delete</i> an accelerator, you lose the static IP addresses that are assigned to the accelerator, so you can no longer route traffic by using them. As a best practice, ensure that you have permissions in place to avoid inadvertently deleting accelerators. You can use IAM policies with Global Accelerator to limit the users who have permissions to delete an accelerator. For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/auth-and-access-control.html">Authentication and Access Control</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p> </important>
  ## 
...
proc call*(call_21626087: Call_DeleteAccelerator_21626074; body: JsonNode): Recallable =
  ## deleteAccelerator
  ## <p>Delete an accelerator. Before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups). To disable the accelerator, update the accelerator to set <code>Enabled</code> to false.</p> <important> <p>When you create an accelerator, by default, Global Accelerator provides you with a set of two static IP addresses. Alternatively, you can bring your own IP address ranges to Global Accelerator and assign IP addresses from those ranges. </p> <p>The IP addresses are assigned to your accelerator for as long as it exists, even if you disable the accelerator and it no longer accepts or routes traffic. However, when you <i>delete</i> an accelerator, you lose the static IP addresses that are assigned to the accelerator, so you can no longer route traffic by using them. As a best practice, ensure that you have permissions in place to avoid inadvertently deleting accelerators. You can use IAM policies with Global Accelerator to limit the users who have permissions to delete an accelerator. For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/auth-and-access-control.html">Authentication and Access Control</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p> </important>
  ##   body: JObject (required)
...
var deleteAccelerator* = Call_DeleteAccelerator_21626074(name: "deleteAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator",
    validator: validate_DeleteAccelerator_21626075, base: "/",
    makeUrl: url_DeleteAccelerator_21626076, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpointGroup_21626089 = ref object of OpenApiRestCall_21625435
proc url_DeleteEndpointGroup_21626091(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpointGroup_21626090(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_DeleteEndpointGroup_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Delete an endpoint group from a listener.
  ## 
...
proc call*(call_21626102: Call_DeleteEndpointGroup_21626089; body: JsonNode): Recallable =
  ## deleteEndpointGroup
  ## Delete an endpoint group from a listener.
  ##   body: JObject (required)
...
var deleteEndpointGroup* = Call_DeleteEndpointGroup_21626089(
    name: "deleteEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup",
    validator: validate_DeleteEndpointGroup_21626090, base: "/",
    makeUrl: url_DeleteEndpointGroup_21626091,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteListener_21626104 = ref object of OpenApiRestCall_21625435
proc url_DeleteListener_21626106(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteListener_21626105(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_DeleteListener_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Delete a listener from an accelerator.
  ## 
...
proc call*(call_21626117: Call_DeleteListener_21626104; body: JsonNode): Recallable =
  ## deleteListener
  ## Delete a listener from an accelerator.
  ##   body: JObject (required)
...
var deleteListener* = Call_DeleteListener_21626104(name: "deleteListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener",
    validator: validate_DeleteListener_21626105, base: "/",
    makeUrl: url_DeleteListener_21626106, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeprovisionByoipCidr_21626119 = ref object of OpenApiRestCall_21625435
proc url_DeprovisionByoipCidr_21626121(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeprovisionByoipCidr_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_DeprovisionByoipCidr_21626119; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Releases the specified address range that you provisioned to use with your AWS resources through bring your own IP addresses (BYOIP) and deletes the corresponding address pool. To see an AWS CLI example of deprovisioning an address range, scroll down to <b>Example</b>.</p> <p>Before you can release an address range, you must stop advertising it by using <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/WithdrawByoipCidr.html">WithdrawByoipCidr</a> and you must not have any accelerators that are using static IP addresses allocated from its address range. </p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ## 
...
proc call*(call_21626132: Call_DeprovisionByoipCidr_21626119; body: JsonNode): Recallable =
...
var deprovisionByoipCidr* = Call_DeprovisionByoipCidr_21626119(
    name: "deprovisionByoipCidr", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeprovisionByoipCidr",
    validator: validate_DeprovisionByoipCidr_21626120, base: "/",
    makeUrl: url_DeprovisionByoipCidr_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccelerator_21626134 = ref object of OpenApiRestCall_21625435
proc url_DescribeAccelerator_21626136(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccelerator_21626135(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_DescribeAccelerator_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626147: Call_DescribeAccelerator_21626134; body: JsonNode): Recallable =
  ## describeAccelerator
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeAccelerator* = Call_DescribeAccelerator_21626134(
    name: "describeAccelerator", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator",
    validator: validate_DescribeAccelerator_21626135, base: "/",
    makeUrl: url_DescribeAccelerator_21626136,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAcceleratorAttributes_21626149 = ref object of OpenApiRestCall_21625435
proc url_DescribeAcceleratorAttributes_21626151(protocol: Scheme; host: string;
...
proc validate_DescribeAcceleratorAttributes_21626150(path: JsonNode;
...
proc call*(call_21626161: Call_DescribeAcceleratorAttributes_21626149;
...
proc call*(call_21626162: Call_DescribeAcceleratorAttributes_21626149;
...
var describeAcceleratorAttributes* = Call_DescribeAcceleratorAttributes_21626149(
    ...
    validator: validate_DescribeAcceleratorAttributes_21626150, base: "/",
    makeUrl: url_DescribeAcceleratorAttributes_21626151,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointGroup_21626164 = ref object of OpenApiRestCall_21625435
proc url_DescribeEndpointGroup_21626166(protocol: Scheme; host: string; base: string;
...
proc validate_DescribeEndpointGroup_21626165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_DescribeEndpointGroup_21626164;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Describe an endpoint group.
  ## 
...
proc call*(call_21626177: Call_DescribeEndpointGroup_21626164; body: JsonNode): Recallable =
...
var describeEndpointGroup* = Call_DescribeEndpointGroup_21626164(
    name: "describeEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup",
    validator: validate_DescribeEndpointGroup_21626165, base: "/",
    makeUrl: url_DescribeEndpointGroup_21626166,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeListener_21626179 = ref object of OpenApiRestCall_21625435
proc url_DescribeListener_21626181(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeListener_21626180(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626191: Call_DescribeListener_21626179; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describe a listener. To see an AWS CLI example of describing a listener, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626192: Call_DescribeListener_21626179; body: JsonNode): Recallable =
  ## describeListener
  ## Describe a listener. To see an AWS CLI example of describing a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeListener* = Call_DescribeListener_21626179(name: "describeListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener",
    validator: validate_DescribeListener_21626180, base: "/",
    makeUrl: url_DescribeListener_21626181, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAccelerators_21626194 = ref object of OpenApiRestCall_21625435
proc url_ListAccelerators_21626196(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAccelerators_21626195(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626206: Call_ListAccelerators_21626194; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## List the accelerators for an AWS account. To see an AWS CLI example of listing the accelerators for an AWS account, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626207: Call_ListAccelerators_21626194; body: JsonNode): Recallable =
  ## listAccelerators
  ## List the accelerators for an AWS account. To see an AWS CLI example of listing the accelerators for an AWS account, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var listAccelerators* = Call_ListAccelerators_21626194(name: "listAccelerators",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators",
    validator: validate_ListAccelerators_21626195, base: "/",
    makeUrl: url_ListAccelerators_21626196, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListByoipCidrs_21626209 = ref object of OpenApiRestCall_21625435
proc url_ListByoipCidrs_21626211(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListByoipCidrs_21626210(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626221: Call_ListByoipCidrs_21626209; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists the IP address ranges that were specified in calls to <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/ProvisionByoipCidr.html">ProvisionByoipCidr</a>.</p> <p>To see an AWS CLI example of listing BYOIP CIDR addresses, scroll down to <b>Example</b>.</p>
  ## 
...
proc call*(call_21626222: Call_ListByoipCidrs_21626209; body: JsonNode): Recallable =
  ## listByoipCidrs
  ## <p>Lists the IP address ranges that were specified in calls to <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/ProvisionByoipCidr.html">ProvisionByoipCidr</a>.</p> <p>To see an AWS CLI example of listing BYOIP CIDR addresses, scroll down to <b>Example</b>.</p>
  ##   body: JObject (required)
...
var listByoipCidrs* = Call_ListByoipCidrs_21626209(name: "listByoipCidrs",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListByoipCidrs",
    validator: validate_ListByoipCidrs_21626210, base: "/",
    makeUrl: url_ListByoipCidrs_21626211, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEndpointGroups_21626224 = ref object of OpenApiRestCall_21625435
proc url_ListEndpointGroups_21626226(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEndpointGroups_21626225(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626236: Call_ListEndpointGroups_21626224; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## List the endpoint groups that are associated with a listener. To see an AWS CLI example of listing the endpoint groups for listener, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626237: Call_ListEndpointGroups_21626224; body: JsonNode): Recallable =
  ## listEndpointGroups
  ## List the endpoint groups that are associated with a listener. To see an AWS CLI example of listing the endpoint groups for listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var listEndpointGroups* = Call_ListEndpointGroups_21626224(
    name: "listEndpointGroups", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups",
    validator: validate_ListEndpointGroups_21626225, base: "/",
    makeUrl: url_ListEndpointGroups_21626226, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListListeners_21626239 = ref object of OpenApiRestCall_21625435
proc url_ListListeners_21626241(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListListeners_21626240(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626251: Call_ListListeners_21626239; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## List the listeners for an accelerator. To see an AWS CLI example of listing the listeners for an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626252: Call_ListListeners_21626239; body: JsonNode): Recallable =
  ## listListeners
  ## List the listeners for an accelerator. To see an AWS CLI example of listing the listeners for an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var listListeners* = Call_ListListeners_21626239(name: "listListeners",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners",
    validator: validate_ListListeners_21626240, base: "/",
    makeUrl: url_ListListeners_21626241, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_21626254 = ref object of OpenApiRestCall_21625435
proc url_ListTagsForResource_21626256(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_21626255(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626266: Call_ListTagsForResource_21626254; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>List all tags for an accelerator. To see an AWS CLI example of listing tags for an accelerator, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>. </p>
  ## 
...
proc call*(call_21626267: Call_ListTagsForResource_21626254; body: JsonNode): Recallable =
  ## listTagsForResource
  ## <p>List all tags for an accelerator. To see an AWS CLI example of listing tags for an accelerator, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>. </p>
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_21626254(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListTagsForResource",
    validator: validate_ListTagsForResource_21626255, base: "/",
    makeUrl: url_ListTagsForResource_21626256,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ProvisionByoipCidr_21626269 = ref object of OpenApiRestCall_21625435
proc url_ProvisionByoipCidr_21626271(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProvisionByoipCidr_21626270(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626281: Call_ProvisionByoipCidr_21626269; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Provisions an IP address range to use with your AWS resources through bring your own IP addresses (BYOIP) and creates a corresponding address pool. After the address range is provisioned, it is ready to be advertised using <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/AdvertiseByoipCidr.html"> AdvertiseByoipCidr</a>.</p> <p>To see an AWS CLI example of provisioning an address range for BYOIP, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ## 
...
proc call*(call_21626282: Call_ProvisionByoipCidr_21626269; body: JsonNode): Recallable =
  ## provisionByoipCidr
  ## <p>Provisions an IP address range to use with your AWS resources through bring your own IP addresses (BYOIP) and creates a corresponding address pool. After the address range is provisioned, it is ready to be advertised using <a href="https://docs.aws.amazon.com/global-accelerator/latest/api/AdvertiseByoipCidr.html"> AdvertiseByoipCidr</a>.</p> <p>To see an AWS CLI example of provisioning an address range for BYOIP, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ##   body: JObject (required)
...
var provisionByoipCidr* = Call_ProvisionByoipCidr_21626269(
    name: "provisionByoipCidr", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ProvisionByoipCidr",
    validator: validate_ProvisionByoipCidr_21626270, base: "/",
    makeUrl: url_ProvisionByoipCidr_21626271, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_21626284 = ref object of OpenApiRestCall_21625435
proc url_TagResource_21626286(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_21626285(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21626296: Call_TagResource_21626284; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Add tags to an accelerator resource. To see an AWS CLI example of adding tags to an accelerator, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>. </p>
  ## 
...
proc call*(call_21626297: Call_TagResource_21626284; body: JsonNode): Recallable =
  ## tagResource
  ## <p>Add tags to an accelerator resource. To see an AWS CLI example of adding tags to an accelerator, scroll down to <b>Example</b>.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>. </p>
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_21626284(name: "tagResource",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.TagResource",
    validator: validate_TagResource_21626285, base: "/", makeUrl: url_TagResource_21626286,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_21626299 = ref object of OpenApiRestCall_21625435
proc url_UntagResource_21626301(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_21626300(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626311: Call_UntagResource_21626299; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Remove tags from a Global Accelerator resource. When you specify a tag key, the action removes both that key and its associated value. To see an AWS CLI example of removing tags from an accelerator, scroll down to <b>Example</b>. The operation succeeds even if you attempt to remove tags from an accelerator that was already removed.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ## 
...
proc call*(call_21626312: Call_UntagResource_21626299; body: JsonNode): Recallable =
  ## untagResource
  ## <p>Remove tags from a Global Accelerator resource. When you specify a tag key, the action removes both that key and its associated value. To see an AWS CLI example of removing tags from an accelerator, scroll down to <b>Example</b>. The operation succeeds even if you attempt to remove tags from an accelerator that was already removed.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/tagging-in-global-accelerator.html">Tagging in AWS Global Accelerator</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_21626299(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UntagResource",
    validator: validate_UntagResource_21626300, base: "/",
    makeUrl: url_UntagResource_21626301, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAccelerator_21626314 = ref object of OpenApiRestCall_21625435
proc url_UpdateAccelerator_21626316(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAccelerator_21626315(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626326: Call_UpdateAccelerator_21626314; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US West (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_21626327: Call_UpdateAccelerator_21626314; body: JsonNode): Recallable =
  ## updateAccelerator
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US West (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var updateAccelerator* = Call_UpdateAccelerator_21626314(name: "updateAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator",
    validator: validate_UpdateAccelerator_21626315, base: "/",
    makeUrl: url_UpdateAccelerator_21626316, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAcceleratorAttributes_21626329 = ref object of OpenApiRestCall_21625435
proc url_UpdateAcceleratorAttributes_21626331(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAcceleratorAttributes_21626330(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626341: Call_UpdateAcceleratorAttributes_21626329;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Update the attributes for an accelerator. To see an AWS CLI example of updating an accelerator to enable flow logs, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626342: Call_UpdateAcceleratorAttributes_21626329; body: JsonNode): Recallable =
...
var updateAcceleratorAttributes* = Call_UpdateAcceleratorAttributes_21626329(
    ...
    validator: validate_UpdateAcceleratorAttributes_21626330, base: "/",
    makeUrl: url_UpdateAcceleratorAttributes_21626331,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEndpointGroup_21626344 = ref object of OpenApiRestCall_21625435
proc url_UpdateEndpointGroup_21626346(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEndpointGroup_21626345(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626356: Call_UpdateEndpointGroup_21626344; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626357: Call_UpdateEndpointGroup_21626344; body: JsonNode): Recallable =
  ## updateEndpointGroup
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateEndpointGroup* = Call_UpdateEndpointGroup_21626344(
    name: "updateEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup",
    validator: validate_UpdateEndpointGroup_21626345, base: "/",
    makeUrl: url_UpdateEndpointGroup_21626346,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateListener_21626359 = ref object of OpenApiRestCall_21625435
proc url_UpdateListener_21626361(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateListener_21626360(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626371: Call_UpdateListener_21626359; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Update a listener. To see an AWS CLI example of updating listener, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_21626372: Call_UpdateListener_21626359; body: JsonNode): Recallable =
  ## updateListener
  ## Update a listener. To see an AWS CLI example of updating listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateListener* = Call_UpdateListener_21626359(name: "updateListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener",
    validator: validate_UpdateListener_21626360, base: "/",
    makeUrl: url_UpdateListener_21626361, schemes: {Scheme.Https, Scheme.Http})
type
  Call_WithdrawByoipCidr_21626374 = ref object of OpenApiRestCall_21625435
proc url_WithdrawByoipCidr_21626376(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_WithdrawByoipCidr_21626375(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626386: Call_WithdrawByoipCidr_21626374; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Stops advertising an address range that is provisioned as an address pool. You can perform this operation at most once every 10 seconds, even if you specify different address ranges each time. To see an AWS CLI example of withdrawing an address range for BYOIP so it will no longer be advertised by AWS, scroll down to <b>Example</b>.</p> <p>It can take a few minutes before traffic to the specified addresses stops routing to AWS because of propagation delays.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ## 
...
proc call*(call_21626387: Call_WithdrawByoipCidr_21626374; body: JsonNode): Recallable =
  ## withdrawByoipCidr
  ## <p>Stops advertising an address range that is provisioned as an address pool. You can perform this operation at most once every 10 seconds, even if you specify different address ranges each time. To see an AWS CLI example of withdrawing an address range for BYOIP so it will no longer be advertised by AWS, scroll down to <b>Example</b>.</p> <p>It can take a few minutes before traffic to the specified addresses stops routing to AWS because of propagation delays.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring Your Own IP Addresses (BYOIP)</a> in the <i>AWS Global Accelerator Developer Guide</i>.</p>
  ##   body: JObject (required)
...
var withdrawByoipCidr* = Call_WithdrawByoipCidr_21626374(name: "withdrawByoipCidr",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.WithdrawByoipCidr",
    validator: validate_WithdrawByoipCidr_21626375, base: "/",
    makeUrl: url_WithdrawByoipCidr_21626376, schemes: {Scheme.Https, Scheme.Http})
export
  rest
