...
type
  Call_CreateAccelerator_593774 = ref object of OpenApiRestCall_593437
proc url_CreateAccelerator_593776(protocol: Scheme; host: string; base: string;
...
proc validate_CreateAccelerator_593775(path: JsonNode; query: JsonNode;
...
proc call*(call_593932: Call_CreateAccelerator_593774; path: JsonNode;
...
proc call*(call_594003: Call_CreateAccelerator_593774; body: JsonNode): Recallable =
  ## createAccelerator
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var createAccelerator* = Call_CreateAccelerator_593774(name: "createAccelerator",
    ...
    validator: validate_CreateAccelerator_593775, base: "/",
    url: url_CreateAccelerator_593776, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpointGroup_594043 = ref object of OpenApiRestCall_593437
proc url_CreateEndpointGroup_594045(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpointGroup_594044(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594055: Call_CreateEndpointGroup_594043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_594056: Call_CreateEndpointGroup_594043; body: JsonNode): Recallable =
  ## createEndpointGroup
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createEndpointGroup* = Call_CreateEndpointGroup_594043(
    ...
    validator: validate_CreateEndpointGroup_594044, base: "/",
    url: url_CreateEndpointGroup_594045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateListener_594058 = ref object of OpenApiRestCall_593437
proc url_CreateListener_594060(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateListener_594059(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594070: Call_CreateListener_594058; path: JsonNode; query: JsonNode;
...
proc call*(call_594071: Call_CreateListener_594058; body: JsonNode): Recallable =
  ## createListener
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createListener* = Call_CreateListener_594058(name: "createListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener",
    validator: validate_CreateListener_594059, base: "/", url: url_CreateListener_594060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAccelerator_594073 = ref object of OpenApiRestCall_593437
proc url_DeleteAccelerator_594075(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAccelerator_594074(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594085: Call_DeleteAccelerator_594073; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ## 
...
proc call*(call_594086: Call_DeleteAccelerator_594073; body: JsonNode): Recallable =
  ## deleteAccelerator
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ##   body: JObject (required)
...
var deleteAccelerator* = Call_DeleteAccelerator_594073(name: "deleteAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator",
    validator: validate_DeleteAccelerator_594074, base: "/",
    url: url_DeleteAccelerator_594075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpointGroup_594088 = ref object of OpenApiRestCall_593437
proc url_DeleteEndpointGroup_594090(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpointGroup_594089(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594100: Call_DeleteEndpointGroup_594088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an endpoint group from a listener.
  ## 
...
proc call*(call_594101: Call_DeleteEndpointGroup_594088; body: JsonNode): Recallable =
  ## deleteEndpointGroup
  ## Delete an endpoint group from a listener.
  ##   body: JObject (required)
...
var deleteEndpointGroup* = Call_DeleteEndpointGroup_594088(
    name: "deleteEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup",
    validator: validate_DeleteEndpointGroup_594089, base: "/",
    url: url_DeleteEndpointGroup_594090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteListener_594103 = ref object of OpenApiRestCall_593437
proc url_DeleteListener_594105(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteListener_594104(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594115: Call_DeleteListener_594103; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a listener from an accelerator.
  ## 
...
proc call*(call_594116: Call_DeleteListener_594103; body: JsonNode): Recallable =
  ## deleteListener
  ## Delete a listener from an accelerator.
  ##   body: JObject (required)
...
var deleteListener* = Call_DeleteListener_594103(name: "deleteListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener",
    validator: validate_DeleteListener_594104, base: "/", url: url_DeleteListener_594105,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccelerator_594118 = ref object of OpenApiRestCall_593437
proc url_DescribeAccelerator_594120(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccelerator_594119(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594130: Call_DescribeAccelerator_594118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_594131: Call_DescribeAccelerator_594118; body: JsonNode): Recallable =
  ## describeAccelerator
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeAccelerator* = Call_DescribeAccelerator_594118(
    name: "describeAccelerator", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator",
    validator: validate_DescribeAccelerator_594119, base: "/",
    url: url_DescribeAccelerator_594120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAcceleratorAttributes_594133 = ref object of OpenApiRestCall_593437
proc url_DescribeAcceleratorAttributes_594135(protocol: Scheme; host: string;
...
proc validate_DescribeAcceleratorAttributes_594134(path: JsonNode; query: JsonNode;
...
proc call*(call_594145: Call_DescribeAcceleratorAttributes_594133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe the attributes of an accelerator.
  ## 
...
proc call*(call_594146: Call_DescribeAcceleratorAttributes_594133; body: JsonNode): Recallable =
...
var describeAcceleratorAttributes* = Call_DescribeAcceleratorAttributes_594133(
    ...
    validator: validate_DescribeAcceleratorAttributes_594134, base: "/",
    url: url_DescribeAcceleratorAttributes_594135,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointGroup_594148 = ref object of OpenApiRestCall_593437
proc url_DescribeEndpointGroup_594150(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpointGroup_594149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594160: Call_DescribeEndpointGroup_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an endpoint group.
  ## 
...
proc call*(call_594161: Call_DescribeEndpointGroup_594148; body: JsonNode): Recallable =
...
var describeEndpointGroup* = Call_DescribeEndpointGroup_594148(
    name: "describeEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup",
    validator: validate_DescribeEndpointGroup_594149, base: "/",
    url: url_DescribeEndpointGroup_594150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeListener_594163 = ref object of OpenApiRestCall_593437
proc url_DescribeListener_594165(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeListener_594164(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ## Describe a listener.
  ## 
...
proc call*(call_594175: Call_DescribeListener_594163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe a listener.
  ## 
...
proc call*(call_594176: Call_DescribeListener_594163; body: JsonNode): Recallable =
  ## describeListener
  ## Describe a listener.
  ##   body: JObject (required)
...
var describeListener* = Call_DescribeListener_594163(name: "describeListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener",
    validator: validate_DescribeListener_594164, base: "/",
    url: url_DescribeListener_594165, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAccelerators_594178 = ref object of OpenApiRestCall_593437
proc url_ListAccelerators_594180(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAccelerators_594179(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594190: Call_ListAccelerators_594178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the accelerators for an AWS account.
  ## 
...
proc call*(call_594191: Call_ListAccelerators_594178; body: JsonNode): Recallable =
  ## listAccelerators
  ## List the accelerators for an AWS account.
  ##   body: JObject (required)
...
var listAccelerators* = Call_ListAccelerators_594178(name: "listAccelerators",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators",
    validator: validate_ListAccelerators_594179, base: "/",
    url: url_ListAccelerators_594180, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEndpointGroups_594193 = ref object of OpenApiRestCall_593437
proc url_ListEndpointGroups_594195(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEndpointGroups_594194(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594205: Call_ListEndpointGroups_594193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the endpoint groups that are associated with a listener.
  ## 
...
proc call*(call_594206: Call_ListEndpointGroups_594193; body: JsonNode): Recallable =
  ## listEndpointGroups
  ## List the endpoint groups that are associated with a listener.
  ##   body: JObject (required)
...
var listEndpointGroups* = Call_ListEndpointGroups_594193(
    name: "listEndpointGroups", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups",
    validator: validate_ListEndpointGroups_594194, base: "/",
    url: url_ListEndpointGroups_594195, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListListeners_594208 = ref object of OpenApiRestCall_593437
proc url_ListListeners_594210(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListListeners_594209(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_594220: Call_ListListeners_594208; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the listeners for an accelerator.
  ## 
...
proc call*(call_594221: Call_ListListeners_594208; body: JsonNode): Recallable =
  ## listListeners
  ## List the listeners for an accelerator.
  ##   body: JObject (required)
...
var listListeners* = Call_ListListeners_594208(name: "listListeners",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners",
    validator: validate_ListListeners_594209, base: "/", url: url_ListListeners_594210,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAccelerator_594223 = ref object of OpenApiRestCall_593437
proc url_UpdateAccelerator_594225(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAccelerator_594224(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594235: Call_UpdateAccelerator_594223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_594236: Call_UpdateAccelerator_594223; body: JsonNode): Recallable =
  ## updateAccelerator
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var updateAccelerator* = Call_UpdateAccelerator_594223(name: "updateAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator",
    validator: validate_UpdateAccelerator_594224, base: "/",
    url: url_UpdateAccelerator_594225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAcceleratorAttributes_594238 = ref object of OpenApiRestCall_593437
proc url_UpdateAcceleratorAttributes_594240(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAcceleratorAttributes_594239(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594250: Call_UpdateAcceleratorAttributes_594238; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update the attributes for an accelerator. To see an AWS CLI example of updating an accelerator to enable flow logs, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_594251: Call_UpdateAcceleratorAttributes_594238; body: JsonNode): Recallable =
...
var updateAcceleratorAttributes* = Call_UpdateAcceleratorAttributes_594238(
    ...
    validator: validate_UpdateAcceleratorAttributes_594239, base: "/",
    url: url_UpdateAcceleratorAttributes_594240,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEndpointGroup_594253 = ref object of OpenApiRestCall_593437
proc url_UpdateEndpointGroup_594255(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEndpointGroup_594254(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594265: Call_UpdateEndpointGroup_594253; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_594266: Call_UpdateEndpointGroup_594253; body: JsonNode): Recallable =
  ## updateEndpointGroup
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateEndpointGroup* = Call_UpdateEndpointGroup_594253(
    name: "updateEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup",
    validator: validate_UpdateEndpointGroup_594254, base: "/",
    url: url_UpdateEndpointGroup_594255, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateListener_594268 = ref object of OpenApiRestCall_593437
proc url_UpdateListener_594270(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateListener_594269(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Update a listener.
  ## 
...
proc call*(call_594280: Call_UpdateListener_594268; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a listener.
  ## 
...
proc call*(call_594281: Call_UpdateListener_594268; body: JsonNode): Recallable =
  ## updateListener
  ## Update a listener.
  ##   body: JObject (required)
...
var updateListener* = Call_UpdateListener_594268(name: "updateListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener",
    validator: validate_UpdateListener_594269, base: "/", url: url_UpdateListener_594270,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
