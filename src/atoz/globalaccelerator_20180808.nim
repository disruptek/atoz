...
type
  Call_CreateAccelerator_602770 = ref object of OpenApiRestCall_602433
proc url_CreateAccelerator_602772(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateAccelerator_602771(path: JsonNode; query: JsonNode;
...
proc call*(call_602928: Call_CreateAccelerator_602770; path: JsonNode;
...
proc call*(call_602999: Call_CreateAccelerator_602770; body: JsonNode): Recallable =
  ## createAccelerator
  ## <p>Create an accelerator. An accelerator includes one or more listeners that process inbound connections and direct traffic to one or more endpoint groups, each of which includes endpoints, such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var createAccelerator* = Call_CreateAccelerator_602770(name: "createAccelerator",
    ...
    validator: validate_CreateAccelerator_602771, base: "/",
    url: url_CreateAccelerator_602772, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpointGroup_603039 = ref object of OpenApiRestCall_602433
proc url_CreateEndpointGroup_603041(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateEndpointGroup_603040(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603051: Call_CreateEndpointGroup_603039; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603052: Call_CreateEndpointGroup_603039; body: JsonNode): Recallable =
  ## createEndpointGroup
  ## Create an endpoint group for the specified listener. An endpoint group is a collection of endpoints in one AWS Region. To see an AWS CLI example of creating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createEndpointGroup* = Call_CreateEndpointGroup_603039(
    ...
    validator: validate_CreateEndpointGroup_603040, base: "/",
    url: url_CreateEndpointGroup_603041, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateListener_603054 = ref object of OpenApiRestCall_602433
proc url_CreateListener_603056(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateListener_603055(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_603066: Call_CreateListener_603054; path: JsonNode; query: JsonNode;
...
proc call*(call_603067: Call_CreateListener_603054; body: JsonNode): Recallable =
  ## createListener
  ## Create a listener to process inbound connections from clients to an accelerator. Connections arrive to assigned static IP addresses on a port, port range, or list of port ranges that you specify. To see an AWS CLI example of creating a listener, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var createListener* = Call_CreateListener_603054(name: "createListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener",
    validator: validate_CreateListener_603055, base: "/", url: url_CreateListener_603056,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAccelerator_603069 = ref object of OpenApiRestCall_602433
proc url_DeleteAccelerator_603071(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteAccelerator_603070(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603081: Call_DeleteAccelerator_603069; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ## 
...
proc call*(call_603082: Call_DeleteAccelerator_603069; body: JsonNode): Recallable =
  ## deleteAccelerator
  ## Delete an accelerator. Note: before you can delete an accelerator, you must disable it and remove all dependent resources (listeners and endpoint groups).
  ##   body: JObject (required)
...
var deleteAccelerator* = Call_DeleteAccelerator_603069(name: "deleteAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator",
    validator: validate_DeleteAccelerator_603070, base: "/",
    url: url_DeleteAccelerator_603071, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpointGroup_603084 = ref object of OpenApiRestCall_602433
proc url_DeleteEndpointGroup_603086(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteEndpointGroup_603085(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603096: Call_DeleteEndpointGroup_603084; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an endpoint group from a listener.
  ## 
...
proc call*(call_603097: Call_DeleteEndpointGroup_603084; body: JsonNode): Recallable =
  ## deleteEndpointGroup
  ## Delete an endpoint group from a listener.
  ##   body: JObject (required)
...
var deleteEndpointGroup* = Call_DeleteEndpointGroup_603084(
    name: "deleteEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup",
    validator: validate_DeleteEndpointGroup_603085, base: "/",
    url: url_DeleteEndpointGroup_603086, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteListener_603099 = ref object of OpenApiRestCall_602433
proc url_DeleteListener_603101(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteListener_603100(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_603111: Call_DeleteListener_603099; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a listener from an accelerator.
  ## 
...
proc call*(call_603112: Call_DeleteListener_603099; body: JsonNode): Recallable =
  ## deleteListener
  ## Delete a listener from an accelerator.
  ##   body: JObject (required)
...
var deleteListener* = Call_DeleteListener_603099(name: "deleteListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener",
    validator: validate_DeleteListener_603100, base: "/", url: url_DeleteListener_603101,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccelerator_603114 = ref object of OpenApiRestCall_602433
proc url_DescribeAccelerator_603116(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeAccelerator_603115(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603126: Call_DescribeAccelerator_603114; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603127: Call_DescribeAccelerator_603114; body: JsonNode): Recallable =
  ## describeAccelerator
  ## Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var describeAccelerator* = Call_DescribeAccelerator_603114(
    name: "describeAccelerator", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator",
    validator: validate_DescribeAccelerator_603115, base: "/",
    url: url_DescribeAccelerator_603116, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAcceleratorAttributes_603129 = ref object of OpenApiRestCall_602433
proc url_DescribeAcceleratorAttributes_603131(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeAcceleratorAttributes_603130(path: JsonNode; query: JsonNode;
...
proc call*(call_603141: Call_DescribeAcceleratorAttributes_603129; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe the attributes of an accelerator.
  ## 
...
proc call*(call_603142: Call_DescribeAcceleratorAttributes_603129; body: JsonNode): Recallable =
...
var describeAcceleratorAttributes* = Call_DescribeAcceleratorAttributes_603129(
    ...
    validator: validate_DescribeAcceleratorAttributes_603130, base: "/",
    url: url_DescribeAcceleratorAttributes_603131,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointGroup_603144 = ref object of OpenApiRestCall_602433
proc url_DescribeEndpointGroup_603146(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeEndpointGroup_603145(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603156: Call_DescribeEndpointGroup_603144; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe an endpoint group.
  ## 
...
proc call*(call_603157: Call_DescribeEndpointGroup_603144; body: JsonNode): Recallable =
...
var describeEndpointGroup* = Call_DescribeEndpointGroup_603144(
    name: "describeEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup",
    validator: validate_DescribeEndpointGroup_603145, base: "/",
    url: url_DescribeEndpointGroup_603146, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeListener_603159 = ref object of OpenApiRestCall_602433
proc url_DescribeListener_603161(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeListener_603160(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ## Describe a listener.
  ## 
...
proc call*(call_603171: Call_DescribeListener_603159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describe a listener.
  ## 
...
proc call*(call_603172: Call_DescribeListener_603159; body: JsonNode): Recallable =
  ## describeListener
  ## Describe a listener.
  ##   body: JObject (required)
...
var describeListener* = Call_DescribeListener_603159(name: "describeListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener",
    validator: validate_DescribeListener_603160, base: "/",
    url: url_DescribeListener_603161, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAccelerators_603174 = ref object of OpenApiRestCall_602433
proc url_ListAccelerators_603176(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListAccelerators_603175(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603186: Call_ListAccelerators_603174; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the accelerators for an AWS account.
  ## 
...
proc call*(call_603187: Call_ListAccelerators_603174; body: JsonNode): Recallable =
  ## listAccelerators
  ## List the accelerators for an AWS account.
  ##   body: JObject (required)
...
var listAccelerators* = Call_ListAccelerators_603174(name: "listAccelerators",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators",
    validator: validate_ListAccelerators_603175, base: "/",
    url: url_ListAccelerators_603176, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEndpointGroups_603189 = ref object of OpenApiRestCall_602433
proc url_ListEndpointGroups_603191(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListEndpointGroups_603190(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603201: Call_ListEndpointGroups_603189; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the endpoint groups that are associated with a listener.
  ## 
...
proc call*(call_603202: Call_ListEndpointGroups_603189; body: JsonNode): Recallable =
  ## listEndpointGroups
  ## List the endpoint groups that are associated with a listener.
  ##   body: JObject (required)
...
var listEndpointGroups* = Call_ListEndpointGroups_603189(
    name: "listEndpointGroups", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups",
    validator: validate_ListEndpointGroups_603190, base: "/",
    url: url_ListEndpointGroups_603191, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListListeners_603204 = ref object of OpenApiRestCall_602433
proc url_ListListeners_603206(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListListeners_603205(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603216: Call_ListListeners_603204; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the listeners for an accelerator.
  ## 
...
proc call*(call_603217: Call_ListListeners_603204; body: JsonNode): Recallable =
  ## listListeners
  ## List the listeners for an accelerator.
  ##   body: JObject (required)
...
var listListeners* = Call_ListListeners_603204(name: "listListeners",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners",
    validator: validate_ListListeners_603205, base: "/", url: url_ListListeners_603206,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAccelerator_603219 = ref object of OpenApiRestCall_602433
proc url_UpdateAccelerator_603221(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateAccelerator_603220(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603231: Call_UpdateAccelerator_603219; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ## 
...
proc call*(call_603232: Call_UpdateAccelerator_603219; body: JsonNode): Recallable =
  ## updateAccelerator
  ## <p>Update an accelerator. To see an AWS CLI example of updating an accelerator, scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2 (Oregon) Region to create or update accelerators.</p> </important>
  ##   body: JObject (required)
...
var updateAccelerator* = Call_UpdateAccelerator_603219(name: "updateAccelerator",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator",
    validator: validate_UpdateAccelerator_603220, base: "/",
    url: url_UpdateAccelerator_603221, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAcceleratorAttributes_603234 = ref object of OpenApiRestCall_602433
proc url_UpdateAcceleratorAttributes_603236(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateAcceleratorAttributes_603235(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603246: Call_UpdateAcceleratorAttributes_603234; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update the attributes for an accelerator. To see an AWS CLI example of updating an accelerator to enable flow logs, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603247: Call_UpdateAcceleratorAttributes_603234; body: JsonNode): Recallable =
...
var updateAcceleratorAttributes* = Call_UpdateAcceleratorAttributes_603234(
    ...
    validator: validate_UpdateAcceleratorAttributes_603235, base: "/",
    url: url_UpdateAcceleratorAttributes_603236,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEndpointGroup_603249 = ref object of OpenApiRestCall_602433
proc url_UpdateEndpointGroup_603251(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateEndpointGroup_603250(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603261: Call_UpdateEndpointGroup_603249; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ## 
...
proc call*(call_603262: Call_UpdateEndpointGroup_603249; body: JsonNode): Recallable =
  ## updateEndpointGroup
  ## Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to <b>Example</b>.
  ##   body: JObject (required)
...
var updateEndpointGroup* = Call_UpdateEndpointGroup_603249(
    name: "updateEndpointGroup", meth: HttpMethod.HttpPost,
    host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup",
    validator: validate_UpdateEndpointGroup_603250, base: "/",
    url: url_UpdateEndpointGroup_603251, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateListener_603264 = ref object of OpenApiRestCall_602433
proc url_UpdateListener_603266(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateListener_603265(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Update a listener.
  ## 
...
proc call*(call_603276: Call_UpdateListener_603264; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a listener.
  ## 
...
proc call*(call_603277: Call_UpdateListener_603264; body: JsonNode): Recallable =
  ## updateListener
  ## Update a listener.
  ##   body: JObject (required)
...
var updateListener* = Call_UpdateListener_603264(name: "updateListener",
    meth: HttpMethod.HttpPost, host: "globalaccelerator.amazonaws.com",
    route: "/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener",
    validator: validate_UpdateListener_603265, base: "/", url: url_UpdateListener_603266,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
