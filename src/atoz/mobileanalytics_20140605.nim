...
proc validate_PutEvents_402656289(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  var valid_402656372 = header.getOrDefault("x-amz-Client-Context-Encoding")
  valid_402656372 = validateParameter(valid_402656372, JString,
                                      required = false, default = nil)
  if valid_402656372 != nil:
    section.add "x-amz-Client-Context-Encoding", valid_402656372
  ...
  var valid_402656375 = header.getOrDefault("x-amz-Client-Context")
  valid_402656375 = validateParameter(valid_402656375, JString, required = true,
                                      default = nil)
  if valid_402656375 != nil:
    section.add "x-amz-Client-Context", valid_402656375
...
proc call*(call_402656395: Call_PutEvents_402656288; path: JsonNode = nil;
...
proc call*(call_402656444: Call_PutEvents_402656288; body: JsonNode): Recallable =
  ## putEvents
  ## The PutEvents operation records one or more events. You can have up to 1,500 unique custom events per app, any combination of up to 40 attributes and metrics per custom event, and any number of attribute or metric values.
  ##   
                                                                                                                                                                                                                                  ## body: JObject (required)
  var body_402656445 = newJObject()
  if body != nil:
    body_402656445 = body
  result = call_402656444.call(nil, nil, nil, nil, body_402656445)

var putEvents* = Call_PutEvents_402656288(name: "putEvents",
    meth: HttpMethod.HttpPost, host: "mobileanalytics.amazonaws.com",
    route: "/2014-06-05/events#x-amz-Client-Context",
    validator: validate_PutEvents_402656289, base: "/", makeUrl: url_PutEvents_402656290,
