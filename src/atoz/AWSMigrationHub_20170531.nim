...
type
  Call_AssociateCreatedArtifact_602770 = ref object of OpenApiRestCall_602433
proc url_AssociateCreatedArtifact_602772(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateCreatedArtifact_602771(path: JsonNode; query: JsonNode;
...
proc call*(call_602928: Call_AssociateCreatedArtifact_602770; path: JsonNode;
...
proc call*(call_602999: Call_AssociateCreatedArtifact_602770; body: JsonNode): Recallable =
...
var associateCreatedArtifact* = Call_AssociateCreatedArtifact_602770(
    ...
    validator: validate_AssociateCreatedArtifact_602771, base: "/",
    url: url_AssociateCreatedArtifact_602772, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateDiscoveredResource_603039 = ref object of OpenApiRestCall_602433
proc url_AssociateDiscoveredResource_603041(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateDiscoveredResource_603040(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603051: Call_AssociateDiscoveredResource_603039; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a discovered resource ID from Application Discovery Service (ADS) with a migration task.
  ## 
...
proc call*(call_603052: Call_AssociateDiscoveredResource_603039; body: JsonNode): Recallable =
...
var associateDiscoveredResource* = Call_AssociateDiscoveredResource_603039(
    name: "associateDiscoveredResource", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.AssociateDiscoveredResource",
    validator: validate_AssociateDiscoveredResource_603040, base: "/",
    url: url_AssociateDiscoveredResource_603041,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProgressUpdateStream_603054 = ref object of OpenApiRestCall_602433
proc url_CreateProgressUpdateStream_603056(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateProgressUpdateStream_603055(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603066: Call_CreateProgressUpdateStream_603054; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a progress update stream which is an AWS resource used for access control as well as a namespace for migration task names that is implicitly linked to your AWS account. It must uniquely identify the migration tool as it is used for all updates made by the tool; however, it does not need to be unique for each AWS account because it is scoped to the AWS account.
  ## 
...
proc call*(call_603067: Call_CreateProgressUpdateStream_603054; body: JsonNode): Recallable =
...
var createProgressUpdateStream* = Call_CreateProgressUpdateStream_603054(
    name: "createProgressUpdateStream", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.CreateProgressUpdateStream",
    validator: validate_CreateProgressUpdateStream_603055, base: "/",
    url: url_CreateProgressUpdateStream_603056,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProgressUpdateStream_603069 = ref object of OpenApiRestCall_602433
proc url_DeleteProgressUpdateStream_603071(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteProgressUpdateStream_603070(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603081: Call_DeleteProgressUpdateStream_603069; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a progress update stream, including all of its tasks, which was previously created as an AWS resource used for access control. This API has the following traits:</p> <ul> <li> <p>The only parameter needed for <code>DeleteProgressUpdateStream</code> is the stream name (same as a <code>CreateProgressUpdateStream</code> call).</p> </li> <li> <p>The call will return, and a background process will asynchronously delete the stream and all of its resources (tasks, associated resources, resource attributes, created artifacts).</p> </li> <li> <p>If the stream takes time to be deleted, it might still show up on a <code>ListProgressUpdateStreams</code> call.</p> </li> <li> <p> <code>CreateProgressUpdateStream</code>, <code>ImportMigrationTask</code>, <code>NotifyMigrationTaskState</code>, and all Associate[*] APIs realted to the tasks belonging to the stream will throw "InvalidInputException" if the stream of the same name is in the process of being deleted.</p> </li> <li> <p>Once the stream and all of its resources are deleted, <code>CreateProgressUpdateStream</code> for a stream of the same name will succeed, and that stream will be an entirely new logical resource (without any resources associated with the old stream).</p> </li> </ul>
  ## 
...
proc call*(call_603082: Call_DeleteProgressUpdateStream_603069; body: JsonNode): Recallable =
...
var deleteProgressUpdateStream* = Call_DeleteProgressUpdateStream_603069(
    name: "deleteProgressUpdateStream", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DeleteProgressUpdateStream",
    validator: validate_DeleteProgressUpdateStream_603070, base: "/",
    url: url_DeleteProgressUpdateStream_603071,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeApplicationState_603084 = ref object of OpenApiRestCall_602433
proc url_DescribeApplicationState_603086(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeApplicationState_603085(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603096: Call_DescribeApplicationState_603084; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the migration status of an application.
  ## 
...
proc call*(call_603097: Call_DescribeApplicationState_603084; body: JsonNode): Recallable =
...
var describeApplicationState* = Call_DescribeApplicationState_603084(
    name: "describeApplicationState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DescribeApplicationState",
    validator: validate_DescribeApplicationState_603085, base: "/",
    url: url_DescribeApplicationState_603086, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMigrationTask_603099 = ref object of OpenApiRestCall_602433
proc url_DescribeMigrationTask_603101(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeMigrationTask_603100(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603111: Call_DescribeMigrationTask_603099; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list of all attributes associated with a specific migration task.
  ## 
...
proc call*(call_603112: Call_DescribeMigrationTask_603099; body: JsonNode): Recallable =
...
var describeMigrationTask* = Call_DescribeMigrationTask_603099(
    name: "describeMigrationTask", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DescribeMigrationTask",
    validator: validate_DescribeMigrationTask_603100, base: "/",
    url: url_DescribeMigrationTask_603101, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateCreatedArtifact_603114 = ref object of OpenApiRestCall_602433
proc url_DisassociateCreatedArtifact_603116(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateCreatedArtifact_603115(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603126: Call_DisassociateCreatedArtifact_603114; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Disassociates a created artifact of an AWS resource with a migration task performed by a migration tool that was previously associated. This API has the following traits:</p> <ul> <li> <p>A migration user can call the <code>DisassociateCreatedArtifacts</code> operation to disassociate a created AWS Artifact from a migration task.</p> </li> <li> <p>The created artifact name must be provided in ARN (Amazon Resource Name) format which will contain information about type and region; for example: <code>arn:aws:ec2:us-east-1:488216288981:image/ami-6d0ba87b</code>.</p> </li> <li> <p>Examples of the AWS resource behind the created artifact are, AMI's, EC2 instance, or RDS instance, etc.</p> </li> </ul>
  ## 
...
proc call*(call_603127: Call_DisassociateCreatedArtifact_603114; body: JsonNode): Recallable =
...
var disassociateCreatedArtifact* = Call_DisassociateCreatedArtifact_603114(
    name: "disassociateCreatedArtifact", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DisassociateCreatedArtifact",
    validator: validate_DisassociateCreatedArtifact_603115, base: "/",
    url: url_DisassociateCreatedArtifact_603116,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateDiscoveredResource_603129 = ref object of OpenApiRestCall_602433
proc url_DisassociateDiscoveredResource_603131(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateDiscoveredResource_603130(path: JsonNode;
...
proc call*(call_603141: Call_DisassociateDiscoveredResource_603129; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociate an Application Discovery Service (ADS) discovered resource from a migration task.
  ## 
...
proc call*(call_603142: Call_DisassociateDiscoveredResource_603129; body: JsonNode): Recallable =
...
var disassociateDiscoveredResource* = Call_DisassociateDiscoveredResource_603129(
    ...
    validator: validate_DisassociateDiscoveredResource_603130, base: "/",
    url: url_DisassociateDiscoveredResource_603131,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ImportMigrationTask_603144 = ref object of OpenApiRestCall_602433
proc url_ImportMigrationTask_603146(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ImportMigrationTask_603145(path: JsonNode; query: JsonNode;
...
proc call*(call_603156: Call_ImportMigrationTask_603144; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Registers a new migration task which represents a server, database, etc., being migrated to AWS by a migration tool.</p> <p>This API is a prerequisite to calling the <code>NotifyMigrationTaskState</code> API as the migration tool must first register the migration task with Migration Hub.</p>
  ## 
...
proc call*(call_603157: Call_ImportMigrationTask_603144; body: JsonNode): Recallable =
  ## importMigrationTask
  ## <p>Registers a new migration task which represents a server, database, etc., being migrated to AWS by a migration tool.</p> <p>This API is a prerequisite to calling the <code>NotifyMigrationTaskState</code> API as the migration tool must first register the migration task with Migration Hub.</p>
  ##   body: JObject (required)
...
var importMigrationTask* = Call_ImportMigrationTask_603144(
    name: "importMigrationTask", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ImportMigrationTask",
    validator: validate_ImportMigrationTask_603145, base: "/",
    url: url_ImportMigrationTask_603146, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCreatedArtifacts_603159 = ref object of OpenApiRestCall_602433
proc url_ListCreatedArtifacts_603161(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListCreatedArtifacts_603160(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603171: Call_ListCreatedArtifacts_603159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the created artifacts attached to a given migration task in an update stream. This API has the following traits:</p> <ul> <li> <p>Gets the list of the created artifacts while migration is taking place.</p> </li> <li> <p>Shows the artifacts created by the migration tool that was associated by the <code>AssociateCreatedArtifact</code> API. </p> </li> <li> <p>Lists created artifacts in a paginated interface. </p> </li> </ul>
  ## 
...
proc call*(call_603172: Call_ListCreatedArtifacts_603159; body: JsonNode): Recallable =
...
var listCreatedArtifacts* = Call_ListCreatedArtifacts_603159(
    name: "listCreatedArtifacts", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListCreatedArtifacts",
    validator: validate_ListCreatedArtifacts_603160, base: "/",
    url: url_ListCreatedArtifacts_603161, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDiscoveredResources_603174 = ref object of OpenApiRestCall_602433
proc url_ListDiscoveredResources_603176(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListDiscoveredResources_603175(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603186: Call_ListDiscoveredResources_603174; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists discovered resources associated with the given <code>MigrationTask</code>.
  ## 
...
proc call*(call_603187: Call_ListDiscoveredResources_603174; body: JsonNode): Recallable =
...
var listDiscoveredResources* = Call_ListDiscoveredResources_603174(
    name: "listDiscoveredResources", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListDiscoveredResources",
    validator: validate_ListDiscoveredResources_603175, base: "/",
    url: url_ListDiscoveredResources_603176, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListMigrationTasks_603189 = ref object of OpenApiRestCall_602433
proc url_ListMigrationTasks_603191(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListMigrationTasks_603190(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603201: Call_ListMigrationTasks_603189; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all, or filtered by resource name, migration tasks associated with the user account making this call. This API has the following traits:</p> <ul> <li> <p>Can show a summary list of the most recent migration tasks.</p> </li> <li> <p>Can show a summary list of migration tasks associated with a given discovered resource.</p> </li> <li> <p>Lists migration tasks in a paginated interface.</p> </li> </ul>
  ## 
...
proc call*(call_603202: Call_ListMigrationTasks_603189; body: JsonNode): Recallable =
  ## listMigrationTasks
  ## <p>Lists all, or filtered by resource name, migration tasks associated with the user account making this call. This API has the following traits:</p> <ul> <li> <p>Can show a summary list of the most recent migration tasks.</p> </li> <li> <p>Can show a summary list of migration tasks associated with a given discovered resource.</p> </li> <li> <p>Lists migration tasks in a paginated interface.</p> </li> </ul>
  ##   body: JObject (required)
...
var listMigrationTasks* = Call_ListMigrationTasks_603189(
    name: "listMigrationTasks", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListMigrationTasks",
    validator: validate_ListMigrationTasks_603190, base: "/",
    url: url_ListMigrationTasks_603191, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProgressUpdateStreams_603204 = ref object of OpenApiRestCall_602433
proc url_ListProgressUpdateStreams_603206(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListProgressUpdateStreams_603205(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603216: Call_ListProgressUpdateStreams_603204; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists progress update streams associated with the user account making this call.
  ## 
...
proc call*(call_603217: Call_ListProgressUpdateStreams_603204; body: JsonNode): Recallable =
...
var listProgressUpdateStreams* = Call_ListProgressUpdateStreams_603204(
    name: "listProgressUpdateStreams", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListProgressUpdateStreams",
    validator: validate_ListProgressUpdateStreams_603205, base: "/",
    url: url_ListProgressUpdateStreams_603206,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyApplicationState_603219 = ref object of OpenApiRestCall_602433
proc url_NotifyApplicationState_603221(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_NotifyApplicationState_603220(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603231: Call_NotifyApplicationState_603219; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sets the migration state of an application. For a given application identified by the value passed to <code>ApplicationId</code>, its status is set or updated by passing one of three values to <code>Status</code>: <code>NOT_STARTED | IN_PROGRESS | COMPLETED</code>.
  ## 
...
proc call*(call_603232: Call_NotifyApplicationState_603219; body: JsonNode): Recallable =
...
var notifyApplicationState* = Call_NotifyApplicationState_603219(
    name: "notifyApplicationState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.NotifyApplicationState",
    validator: validate_NotifyApplicationState_603220, base: "/",
    url: url_NotifyApplicationState_603221, schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyMigrationTaskState_603234 = ref object of OpenApiRestCall_602433
proc url_NotifyMigrationTaskState_603236(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_NotifyMigrationTaskState_603235(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603246: Call_NotifyMigrationTaskState_603234; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Notifies Migration Hub of the current status, progress, or other detail regarding a migration task. This API has the following traits:</p> <ul> <li> <p>Migration tools will call the <code>NotifyMigrationTaskState</code> API to share the latest progress and status.</p> </li> <li> <p> <code>MigrationTaskName</code> is used for addressing updates to the correct target.</p> </li> <li> <p> <code>ProgressUpdateStream</code> is used for access control and to provide a namespace for each migration tool.</p> </li> </ul>
  ## 
...
proc call*(call_603247: Call_NotifyMigrationTaskState_603234; body: JsonNode): Recallable =
...
var notifyMigrationTaskState* = Call_NotifyMigrationTaskState_603234(
    name: "notifyMigrationTaskState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.NotifyMigrationTaskState",
    validator: validate_NotifyMigrationTaskState_603235, base: "/",
    url: url_NotifyMigrationTaskState_603236, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutResourceAttributes_603249 = ref object of OpenApiRestCall_602433
proc url_PutResourceAttributes_603251(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutResourceAttributes_603250(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603261: Call_PutResourceAttributes_603249; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Provides identifying details of the resource being migrated so that it can be associated in the Application Discovery Service (ADS)'s repository. This association occurs asynchronously after <code>PutResourceAttributes</code> returns.</p> <important> <ul> <li> <p>Keep in mind that subsequent calls to PutResourceAttributes will override previously stored attributes. For example, if it is first called with a MAC address, but later, it is desired to <i>add</i> an IP address, it will then be required to call it with <i>both</i> the IP and MAC addresses to prevent overiding the MAC address.</p> </li> <li> <p>Note the instructions regarding the special use case of the <a href="https://docs.aws.amazon.com/migrationhub/latest/ug/API_PutResourceAttributes.html#migrationhub-PutResourceAttributes-request-ResourceAttributeList"> <code>ResourceAttributeList</code> </a> parameter when specifying any "VM" related value. </p> </li> </ul> </important> <note> <p>Because this is an asynchronous call, it will always return 200, whether an association occurs or not. To confirm if an association was found based on the provided details, call <code>ListDiscoveredResources</code>.</p> </note>
  ## 
...
proc call*(call_603262: Call_PutResourceAttributes_603249; body: JsonNode): Recallable =
...
var putResourceAttributes* = Call_PutResourceAttributes_603249(
    name: "putResourceAttributes", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.PutResourceAttributes",
    validator: validate_PutResourceAttributes_603250, base: "/",
    url: url_PutResourceAttributes_603251, schemes: {Scheme.Https, Scheme.Http})
export
  rest
