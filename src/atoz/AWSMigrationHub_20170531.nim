...
type
  Call_AssociateCreatedArtifact_772933 = ref object of OpenApiRestCall_772597
proc url_AssociateCreatedArtifact_772935(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateCreatedArtifact_772934(path: JsonNode; query: JsonNode;
...
proc call*(call_773091: Call_AssociateCreatedArtifact_772933; path: JsonNode;
...
proc call*(call_773162: Call_AssociateCreatedArtifact_772933; body: JsonNode): Recallable =
...
var associateCreatedArtifact* = Call_AssociateCreatedArtifact_772933(
    ...
    validator: validate_AssociateCreatedArtifact_772934, base: "/",
    url: url_AssociateCreatedArtifact_772935, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateDiscoveredResource_773202 = ref object of OpenApiRestCall_772597
proc url_AssociateDiscoveredResource_773204(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateDiscoveredResource_773203(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773214: Call_AssociateDiscoveredResource_773202; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a discovered resource ID from Application Discovery Service (ADS) with a migration task.
  ## 
...
proc call*(call_773215: Call_AssociateDiscoveredResource_773202; body: JsonNode): Recallable =
...
var associateDiscoveredResource* = Call_AssociateDiscoveredResource_773202(
    name: "associateDiscoveredResource", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.AssociateDiscoveredResource",
    validator: validate_AssociateDiscoveredResource_773203, base: "/",
    url: url_AssociateDiscoveredResource_773204,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProgressUpdateStream_773217 = ref object of OpenApiRestCall_772597
proc url_CreateProgressUpdateStream_773219(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateProgressUpdateStream_773218(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773229: Call_CreateProgressUpdateStream_773217; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a progress update stream which is an AWS resource used for access control as well as a namespace for migration task names that is implicitly linked to your AWS account. It must uniquely identify the migration tool as it is used for all updates made by the tool; however, it does not need to be unique for each AWS account because it is scoped to the AWS account.
  ## 
...
proc call*(call_773230: Call_CreateProgressUpdateStream_773217; body: JsonNode): Recallable =
...
var createProgressUpdateStream* = Call_CreateProgressUpdateStream_773217(
    name: "createProgressUpdateStream", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.CreateProgressUpdateStream",
    validator: validate_CreateProgressUpdateStream_773218, base: "/",
    url: url_CreateProgressUpdateStream_773219,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProgressUpdateStream_773232 = ref object of OpenApiRestCall_772597
proc url_DeleteProgressUpdateStream_773234(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteProgressUpdateStream_773233(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773244: Call_DeleteProgressUpdateStream_773232; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a progress update stream, including all of its tasks, which was previously created as an AWS resource used for access control. This API has the following traits:</p> <ul> <li> <p>The only parameter needed for <code>DeleteProgressUpdateStream</code> is the stream name (same as a <code>CreateProgressUpdateStream</code> call).</p> </li> <li> <p>The call will return, and a background process will asynchronously delete the stream and all of its resources (tasks, associated resources, resource attributes, created artifacts).</p> </li> <li> <p>If the stream takes time to be deleted, it might still show up on a <code>ListProgressUpdateStreams</code> call.</p> </li> <li> <p> <code>CreateProgressUpdateStream</code>, <code>ImportMigrationTask</code>, <code>NotifyMigrationTaskState</code>, and all Associate[*] APIs realted to the tasks belonging to the stream will throw "InvalidInputException" if the stream of the same name is in the process of being deleted.</p> </li> <li> <p>Once the stream and all of its resources are deleted, <code>CreateProgressUpdateStream</code> for a stream of the same name will succeed, and that stream will be an entirely new logical resource (without any resources associated with the old stream).</p> </li> </ul>
  ## 
...
proc call*(call_773245: Call_DeleteProgressUpdateStream_773232; body: JsonNode): Recallable =
...
var deleteProgressUpdateStream* = Call_DeleteProgressUpdateStream_773232(
    name: "deleteProgressUpdateStream", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DeleteProgressUpdateStream",
    validator: validate_DeleteProgressUpdateStream_773233, base: "/",
    url: url_DeleteProgressUpdateStream_773234,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeApplicationState_773247 = ref object of OpenApiRestCall_772597
proc url_DescribeApplicationState_773249(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeApplicationState_773248(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773259: Call_DescribeApplicationState_773247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the migration status of an application.
  ## 
...
proc call*(call_773260: Call_DescribeApplicationState_773247; body: JsonNode): Recallable =
...
var describeApplicationState* = Call_DescribeApplicationState_773247(
    name: "describeApplicationState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DescribeApplicationState",
    validator: validate_DescribeApplicationState_773248, base: "/",
    url: url_DescribeApplicationState_773249, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMigrationTask_773262 = ref object of OpenApiRestCall_772597
proc url_DescribeMigrationTask_773264(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeMigrationTask_773263(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773274: Call_DescribeMigrationTask_773262; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list of all attributes associated with a specific migration task.
  ## 
...
proc call*(call_773275: Call_DescribeMigrationTask_773262; body: JsonNode): Recallable =
...
var describeMigrationTask* = Call_DescribeMigrationTask_773262(
    name: "describeMigrationTask", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DescribeMigrationTask",
    validator: validate_DescribeMigrationTask_773263, base: "/",
    url: url_DescribeMigrationTask_773264, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateCreatedArtifact_773277 = ref object of OpenApiRestCall_772597
proc url_DisassociateCreatedArtifact_773279(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateCreatedArtifact_773278(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773289: Call_DisassociateCreatedArtifact_773277; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Disassociates a created artifact of an AWS resource with a migration task performed by a migration tool that was previously associated. This API has the following traits:</p> <ul> <li> <p>A migration user can call the <code>DisassociateCreatedArtifacts</code> operation to disassociate a created AWS Artifact from a migration task.</p> </li> <li> <p>The created artifact name must be provided in ARN (Amazon Resource Name) format which will contain information about type and region; for example: <code>arn:aws:ec2:us-east-1:488216288981:image/ami-6d0ba87b</code>.</p> </li> <li> <p>Examples of the AWS resource behind the created artifact are, AMI's, EC2 instance, or RDS instance, etc.</p> </li> </ul>
  ## 
...
proc call*(call_773290: Call_DisassociateCreatedArtifact_773277; body: JsonNode): Recallable =
...
var disassociateCreatedArtifact* = Call_DisassociateCreatedArtifact_773277(
    name: "disassociateCreatedArtifact", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.DisassociateCreatedArtifact",
    validator: validate_DisassociateCreatedArtifact_773278, base: "/",
    url: url_DisassociateCreatedArtifact_773279,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateDiscoveredResource_773292 = ref object of OpenApiRestCall_772597
proc url_DisassociateDiscoveredResource_773294(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateDiscoveredResource_773293(path: JsonNode;
...
proc call*(call_773304: Call_DisassociateDiscoveredResource_773292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociate an Application Discovery Service (ADS) discovered resource from a migration task.
  ## 
...
proc call*(call_773305: Call_DisassociateDiscoveredResource_773292; body: JsonNode): Recallable =
...
var disassociateDiscoveredResource* = Call_DisassociateDiscoveredResource_773292(
    ...
    validator: validate_DisassociateDiscoveredResource_773293, base: "/",
    url: url_DisassociateDiscoveredResource_773294,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ImportMigrationTask_773307 = ref object of OpenApiRestCall_772597
proc url_ImportMigrationTask_773309(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ImportMigrationTask_773308(path: JsonNode; query: JsonNode;
...
proc call*(call_773319: Call_ImportMigrationTask_773307; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Registers a new migration task which represents a server, database, etc., being migrated to AWS by a migration tool.</p> <p>This API is a prerequisite to calling the <code>NotifyMigrationTaskState</code> API as the migration tool must first register the migration task with Migration Hub.</p>
  ## 
...
proc call*(call_773320: Call_ImportMigrationTask_773307; body: JsonNode): Recallable =
  ## importMigrationTask
  ## <p>Registers a new migration task which represents a server, database, etc., being migrated to AWS by a migration tool.</p> <p>This API is a prerequisite to calling the <code>NotifyMigrationTaskState</code> API as the migration tool must first register the migration task with Migration Hub.</p>
  ##   body: JObject (required)
...
var importMigrationTask* = Call_ImportMigrationTask_773307(
    name: "importMigrationTask", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ImportMigrationTask",
    validator: validate_ImportMigrationTask_773308, base: "/",
    url: url_ImportMigrationTask_773309, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCreatedArtifacts_773322 = ref object of OpenApiRestCall_772597
proc url_ListCreatedArtifacts_773324(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListCreatedArtifacts_773323(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773334: Call_ListCreatedArtifacts_773322; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the created artifacts attached to a given migration task in an update stream. This API has the following traits:</p> <ul> <li> <p>Gets the list of the created artifacts while migration is taking place.</p> </li> <li> <p>Shows the artifacts created by the migration tool that was associated by the <code>AssociateCreatedArtifact</code> API. </p> </li> <li> <p>Lists created artifacts in a paginated interface. </p> </li> </ul>
  ## 
...
proc call*(call_773335: Call_ListCreatedArtifacts_773322; body: JsonNode): Recallable =
...
var listCreatedArtifacts* = Call_ListCreatedArtifacts_773322(
    name: "listCreatedArtifacts", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListCreatedArtifacts",
    validator: validate_ListCreatedArtifacts_773323, base: "/",
    url: url_ListCreatedArtifacts_773324, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDiscoveredResources_773337 = ref object of OpenApiRestCall_772597
proc url_ListDiscoveredResources_773339(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListDiscoveredResources_773338(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773349: Call_ListDiscoveredResources_773337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists discovered resources associated with the given <code>MigrationTask</code>.
  ## 
...
proc call*(call_773350: Call_ListDiscoveredResources_773337; body: JsonNode): Recallable =
...
var listDiscoveredResources* = Call_ListDiscoveredResources_773337(
    name: "listDiscoveredResources", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListDiscoveredResources",
    validator: validate_ListDiscoveredResources_773338, base: "/",
    url: url_ListDiscoveredResources_773339, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListMigrationTasks_773352 = ref object of OpenApiRestCall_772597
proc url_ListMigrationTasks_773354(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListMigrationTasks_773353(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_773364: Call_ListMigrationTasks_773352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all, or filtered by resource name, migration tasks associated with the user account making this call. This API has the following traits:</p> <ul> <li> <p>Can show a summary list of the most recent migration tasks.</p> </li> <li> <p>Can show a summary list of migration tasks associated with a given discovered resource.</p> </li> <li> <p>Lists migration tasks in a paginated interface.</p> </li> </ul>
  ## 
...
proc call*(call_773365: Call_ListMigrationTasks_773352; body: JsonNode): Recallable =
  ## listMigrationTasks
  ## <p>Lists all, or filtered by resource name, migration tasks associated with the user account making this call. This API has the following traits:</p> <ul> <li> <p>Can show a summary list of the most recent migration tasks.</p> </li> <li> <p>Can show a summary list of migration tasks associated with a given discovered resource.</p> </li> <li> <p>Lists migration tasks in a paginated interface.</p> </li> </ul>
  ##   body: JObject (required)
...
var listMigrationTasks* = Call_ListMigrationTasks_773352(
    name: "listMigrationTasks", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListMigrationTasks",
    validator: validate_ListMigrationTasks_773353, base: "/",
    url: url_ListMigrationTasks_773354, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProgressUpdateStreams_773367 = ref object of OpenApiRestCall_772597
proc url_ListProgressUpdateStreams_773369(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListProgressUpdateStreams_773368(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773379: Call_ListProgressUpdateStreams_773367; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists progress update streams associated with the user account making this call.
  ## 
...
proc call*(call_773380: Call_ListProgressUpdateStreams_773367; body: JsonNode): Recallable =
...
var listProgressUpdateStreams* = Call_ListProgressUpdateStreams_773367(
    name: "listProgressUpdateStreams", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.ListProgressUpdateStreams",
    validator: validate_ListProgressUpdateStreams_773368, base: "/",
    url: url_ListProgressUpdateStreams_773369,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyApplicationState_773382 = ref object of OpenApiRestCall_772597
proc url_NotifyApplicationState_773384(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_NotifyApplicationState_773383(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773394: Call_NotifyApplicationState_773382; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sets the migration state of an application. For a given application identified by the value passed to <code>ApplicationId</code>, its status is set or updated by passing one of three values to <code>Status</code>: <code>NOT_STARTED | IN_PROGRESS | COMPLETED</code>.
  ## 
...
proc call*(call_773395: Call_NotifyApplicationState_773382; body: JsonNode): Recallable =
...
var notifyApplicationState* = Call_NotifyApplicationState_773382(
    name: "notifyApplicationState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.NotifyApplicationState",
    validator: validate_NotifyApplicationState_773383, base: "/",
    url: url_NotifyApplicationState_773384, schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyMigrationTaskState_773397 = ref object of OpenApiRestCall_772597
proc url_NotifyMigrationTaskState_773399(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_NotifyMigrationTaskState_773398(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773409: Call_NotifyMigrationTaskState_773397; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Notifies Migration Hub of the current status, progress, or other detail regarding a migration task. This API has the following traits:</p> <ul> <li> <p>Migration tools will call the <code>NotifyMigrationTaskState</code> API to share the latest progress and status.</p> </li> <li> <p> <code>MigrationTaskName</code> is used for addressing updates to the correct target.</p> </li> <li> <p> <code>ProgressUpdateStream</code> is used for access control and to provide a namespace for each migration tool.</p> </li> </ul>
  ## 
...
proc call*(call_773410: Call_NotifyMigrationTaskState_773397; body: JsonNode): Recallable =
...
var notifyMigrationTaskState* = Call_NotifyMigrationTaskState_773397(
    name: "notifyMigrationTaskState", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.NotifyMigrationTaskState",
    validator: validate_NotifyMigrationTaskState_773398, base: "/",
    url: url_NotifyMigrationTaskState_773399, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutResourceAttributes_773412 = ref object of OpenApiRestCall_772597
proc url_PutResourceAttributes_773414(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutResourceAttributes_773413(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773424: Call_PutResourceAttributes_773412; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Provides identifying details of the resource being migrated so that it can be associated in the Application Discovery Service (ADS)'s repository. This association occurs asynchronously after <code>PutResourceAttributes</code> returns.</p> <important> <ul> <li> <p>Keep in mind that subsequent calls to PutResourceAttributes will override previously stored attributes. For example, if it is first called with a MAC address, but later, it is desired to <i>add</i> an IP address, it will then be required to call it with <i>both</i> the IP and MAC addresses to prevent overiding the MAC address.</p> </li> <li> <p>Note the instructions regarding the special use case of the <a href="https://docs.aws.amazon.com/migrationhub/latest/ug/API_PutResourceAttributes.html#migrationhub-PutResourceAttributes-request-ResourceAttributeList"> <code>ResourceAttributeList</code> </a> parameter when specifying any "VM" related value. </p> </li> </ul> </important> <note> <p>Because this is an asynchronous call, it will always return 200, whether an association occurs or not. To confirm if an association was found based on the provided details, call <code>ListDiscoveredResources</code>.</p> </note>
  ## 
...
proc call*(call_773425: Call_PutResourceAttributes_773412; body: JsonNode): Recallable =
...
var putResourceAttributes* = Call_PutResourceAttributes_773412(
    name: "putResourceAttributes", meth: HttpMethod.HttpPost,
    host: "mgh.amazonaws.com",
    route: "/#X-Amz-Target=AWSMigrationHub.PutResourceAttributes",
    validator: validate_PutResourceAttributes_773413, base: "/",
    url: url_PutResourceAttributes_773414, schemes: {Scheme.Https, Scheme.Http})
