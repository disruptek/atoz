...
type
  Call_AssociateIpGroups_601727 = ref object of OpenApiRestCall_601389
proc url_AssociateIpGroups_601729(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateIpGroups_601728(path: JsonNode; query: JsonNode;
...
proc call*(call_601885: Call_AssociateIpGroups_601727; path: JsonNode;
...
proc call*(call_601956: Call_AssociateIpGroups_601727; body: JsonNode): Recallable =
  ## associateIpGroups
  ## Associates the specified IP access control group with the specified directory.
  ##   body: JObject (required)
...
var associateIpGroups* = Call_AssociateIpGroups_601727(name: "associateIpGroups",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.AssociateIpGroups",
    validator: validate_AssociateIpGroups_601728, base: "/",
    url: url_AssociateIpGroups_601729, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AuthorizeIpRules_601996 = ref object of OpenApiRestCall_601389
proc url_AuthorizeIpRules_601998(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizeIpRules_601997(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602008: Call_AuthorizeIpRules_601996; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Adds one or more rules to the specified IP access control group.</p> <p>This action gives users permission to access their WorkSpaces from the CIDR address ranges specified in the rules.</p>
  ## 
...
proc call*(call_602009: Call_AuthorizeIpRules_601996; body: JsonNode): Recallable =
  ## authorizeIpRules
  ## <p>Adds one or more rules to the specified IP access control group.</p> <p>This action gives users permission to access their WorkSpaces from the CIDR address ranges specified in the rules.</p>
  ##   body: JObject (required)
...
var authorizeIpRules* = Call_AuthorizeIpRules_601996(name: "authorizeIpRules",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.AuthorizeIpRules",
    validator: validate_AuthorizeIpRules_601997, base: "/",
    url: url_AuthorizeIpRules_601998, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CopyWorkspaceImage_602011 = ref object of OpenApiRestCall_601389
proc url_CopyWorkspaceImage_602013(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CopyWorkspaceImage_602012(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_602023: Call_CopyWorkspaceImage_602011; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Copies the specified image from the specified Region to the current Region.
  ## 
...
proc call*(call_602024: Call_CopyWorkspaceImage_602011; body: JsonNode): Recallable =
  ## copyWorkspaceImage
  ## Copies the specified image from the specified Region to the current Region.
  ##   body: JObject (required)
...
var copyWorkspaceImage* = Call_CopyWorkspaceImage_602011(
    ...
    validator: validate_CopyWorkspaceImage_602012, base: "/",
    url: url_CopyWorkspaceImage_602013, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateIpGroup_602026 = ref object of OpenApiRestCall_601389
proc url_CreateIpGroup_602028(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateIpGroup_602027(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_602038: Call_CreateIpGroup_602026; path: JsonNode; query: JsonNode;
...
proc call*(call_602039: Call_CreateIpGroup_602026; body: JsonNode): Recallable =
  ## createIpGroup
  ## <p>Creates an IP access control group.</p> <p>An IP access control group provides you with the ability to control the IP addresses from which users are allowed to access their WorkSpaces. To specify the CIDR address ranges, add rules to your IP access control group and then associate the group with your directory. You can add rules when you create the group or at any time using <a>AuthorizeIpRules</a>.</p> <p>There is a default IP access control group associated with your directory. If you don't associate an IP access control group with your directory, the default group is used. The default group includes a default rule that allows users to access their WorkSpaces from anywhere. You cannot modify the default IP access control group for your directory.</p>
  ##   body: JObject (required)
...
var createIpGroup* = Call_CreateIpGroup_602026(name: "createIpGroup",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.CreateIpGroup",
    validator: validate_CreateIpGroup_602027, base: "/", url: url_CreateIpGroup_602028,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateTags_602041 = ref object of OpenApiRestCall_601389
proc url_CreateTags_602043(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateTags_602042(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602053: Call_CreateTags_602041; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates the specified tags for the specified WorkSpaces resource.
  ## 
...
proc call*(call_602054: Call_CreateTags_602041; body: JsonNode): Recallable =
  ## createTags
  ## Creates the specified tags for the specified WorkSpaces resource.
  ##   body: JObject (required)
...
var createTags* = Call_CreateTags_602041(name: "createTags",
                                      meth: HttpMethod.HttpPost,
                                      host: "workspaces.amazonaws.com", route: "/#X-Amz-Target=WorkspacesService.CreateTags",
                                      validator: validate_CreateTags_602042,
                                      base: "/", url: url_CreateTags_602043,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateWorkspaces_602056 = ref object of OpenApiRestCall_601389
proc url_CreateWorkspaces_602058(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateWorkspaces_602057(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602068: Call_CreateWorkspaces_602056; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates one or more WorkSpaces.</p> <p>This operation is asynchronous and returns before the WorkSpaces are created.</p>
  ## 
...
proc call*(call_602069: Call_CreateWorkspaces_602056; body: JsonNode): Recallable =
  ## createWorkspaces
  ## <p>Creates one or more WorkSpaces.</p> <p>This operation is asynchronous and returns before the WorkSpaces are created.</p>
  ##   body: JObject (required)
...
var createWorkspaces* = Call_CreateWorkspaces_602056(name: "createWorkspaces",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.CreateWorkspaces",
    validator: validate_CreateWorkspaces_602057, base: "/",
    url: url_CreateWorkspaces_602058, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIpGroup_602071 = ref object of OpenApiRestCall_601389
proc url_DeleteIpGroup_602073(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteIpGroup_602072(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602083: Call_DeleteIpGroup_602071; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the specified IP access control group.</p> <p>You cannot delete an IP access control group that is associated with a directory.</p>
  ## 
...
proc call*(call_602084: Call_DeleteIpGroup_602071; body: JsonNode): Recallable =
  ## deleteIpGroup
  ## <p>Deletes the specified IP access control group.</p> <p>You cannot delete an IP access control group that is associated with a directory.</p>
  ##   body: JObject (required)
...
var deleteIpGroup* = Call_DeleteIpGroup_602071(name: "deleteIpGroup",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DeleteIpGroup",
    validator: validate_DeleteIpGroup_602072, base: "/", url: url_DeleteIpGroup_602073,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTags_602086 = ref object of OpenApiRestCall_601389
proc url_DeleteTags_602088(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteTags_602087(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602098: Call_DeleteTags_602086; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified tags from the specified WorkSpaces resource.
  ## 
...
proc call*(call_602099: Call_DeleteTags_602086; body: JsonNode): Recallable =
  ## deleteTags
  ## Deletes the specified tags from the specified WorkSpaces resource.
  ##   body: JObject (required)
...
var deleteTags* = Call_DeleteTags_602086(name: "deleteTags",
                                      meth: HttpMethod.HttpPost,
                                      host: "workspaces.amazonaws.com", route: "/#X-Amz-Target=WorkspacesService.DeleteTags",
                                      validator: validate_DeleteTags_602087,
                                      base: "/", url: url_DeleteTags_602088,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteWorkspaceImage_602101 = ref object of OpenApiRestCall_601389
proc url_DeleteWorkspaceImage_602103(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteWorkspaceImage_602102(path: JsonNode; query: JsonNode;
...
proc call*(call_602113: Call_DeleteWorkspaceImage_602101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified image from your account. To delete an image, you must first delete any bundles that are associated with the image and un-share the image if it is shared with other accounts. 
  ## 
...
proc call*(call_602114: Call_DeleteWorkspaceImage_602101; body: JsonNode): Recallable =
...
var deleteWorkspaceImage* = Call_DeleteWorkspaceImage_602101(
    name: "deleteWorkspaceImage", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DeleteWorkspaceImage",
    validator: validate_DeleteWorkspaceImage_602102, base: "/",
    url: url_DeleteWorkspaceImage_602103, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterWorkspaceDirectory_602116 = ref object of OpenApiRestCall_601389
proc url_DeregisterWorkspaceDirectory_602118(protocol: Scheme; host: string;
...
proc validate_DeregisterWorkspaceDirectory_602117(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602128: Call_DeregisterWorkspaceDirectory_602116; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deregisters the specified directory. This operation is asynchronous and returns before the WorkSpace directory is deregistered. If any WorkSpaces are registered to this directory, you must remove them before you can deregister the directory.
  ## 
...
proc call*(call_602129: Call_DeregisterWorkspaceDirectory_602116; body: JsonNode): Recallable =
...
var deregisterWorkspaceDirectory* = Call_DeregisterWorkspaceDirectory_602116(
    ...
    validator: validate_DeregisterWorkspaceDirectory_602117, base: "/",
    url: url_DeregisterWorkspaceDirectory_602118,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccount_602131 = ref object of OpenApiRestCall_601389
proc url_DescribeAccount_602133(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccount_602132(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_602143: Call_DescribeAccount_602131; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list that describes the configuration of Bring Your Own License (BYOL) for the specified account.
  ## 
...
proc call*(call_602144: Call_DescribeAccount_602131; body: JsonNode): Recallable =
  ## describeAccount
  ## Retrieves a list that describes the configuration of Bring Your Own License (BYOL) for the specified account.
  ##   body: JObject (required)
...
var describeAccount* = Call_DescribeAccount_602131(name: "describeAccount",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeAccount",
    validator: validate_DescribeAccount_602132, base: "/", url: url_DescribeAccount_602133,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccountModifications_602146 = ref object of OpenApiRestCall_601389
proc url_DescribeAccountModifications_602148(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccountModifications_602147(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602158: Call_DescribeAccountModifications_602146; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list that describes modifications to the configuration of Bring Your Own License (BYOL) for the specified account.
  ## 
...
proc call*(call_602159: Call_DescribeAccountModifications_602146; body: JsonNode): Recallable =
...
var describeAccountModifications* = Call_DescribeAccountModifications_602146(
    ...
    validator: validate_DescribeAccountModifications_602147, base: "/",
    url: url_DescribeAccountModifications_602148,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeClientProperties_602161 = ref object of OpenApiRestCall_601389
proc url_DescribeClientProperties_602163(protocol: Scheme; host: string;
...
proc validate_DescribeClientProperties_602162(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602173: Call_DescribeClientProperties_602161; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list that describes one or more specified Amazon WorkSpaces clients.
  ## 
...
proc call*(call_602174: Call_DescribeClientProperties_602161; body: JsonNode): Recallable =
...
var describeClientProperties* = Call_DescribeClientProperties_602161(
    name: "describeClientProperties", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeClientProperties",
    validator: validate_DescribeClientProperties_602162, base: "/",
    url: url_DescribeClientProperties_602163, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIpGroups_602176 = ref object of OpenApiRestCall_601389
proc url_DescribeIpGroups_602178(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeIpGroups_602177(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602188: Call_DescribeIpGroups_602176; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes one or more of your IP access control groups.
  ## 
...
proc call*(call_602189: Call_DescribeIpGroups_602176; body: JsonNode): Recallable =
  ## describeIpGroups
  ## Describes one or more of your IP access control groups.
  ##   body: JObject (required)
...
var describeIpGroups* = Call_DescribeIpGroups_602176(name: "describeIpGroups",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeIpGroups",
    validator: validate_DescribeIpGroups_602177, base: "/",
    url: url_DescribeIpGroups_602178, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTags_602191 = ref object of OpenApiRestCall_601389
proc url_DescribeTags_602193(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeTags_602192(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602203: Call_DescribeTags_602191; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the specified tags for the specified WorkSpaces resource.
  ## 
...
proc call*(call_602204: Call_DescribeTags_602191; body: JsonNode): Recallable =
  ## describeTags
  ## Describes the specified tags for the specified WorkSpaces resource.
  ##   body: JObject (required)
...
var describeTags* = Call_DescribeTags_602191(name: "describeTags",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeTags",
    validator: validate_DescribeTags_602192, base: "/", url: url_DescribeTags_602193,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspaceBundles_602206 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspaceBundles_602208(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeWorkspaceBundles_602207(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602219: Call_DescribeWorkspaceBundles_602206; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves a list that describes the available WorkSpace bundles.</p> <p>You can filter the results using either bundle ID or owner, but not both.</p>
  ## 
...
proc call*(call_602220: Call_DescribeWorkspaceBundles_602206; body: JsonNode;
...
var describeWorkspaceBundles* = Call_DescribeWorkspaceBundles_602206(
    name: "describeWorkspaceBundles", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeWorkspaceBundles",
    validator: validate_DescribeWorkspaceBundles_602207, base: "/",
    url: url_DescribeWorkspaceBundles_602208, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspaceDirectories_602224 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspaceDirectories_602226(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeWorkspaceDirectories_602225(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602237: Call_DescribeWorkspaceDirectories_602224; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the available directories that are registered with Amazon WorkSpaces.
  ## 
...
proc call*(call_602238: Call_DescribeWorkspaceDirectories_602224; body: JsonNode;
          NextToken: string = ""): Recallable =
...
var describeWorkspaceDirectories* = Call_DescribeWorkspaceDirectories_602224(
    ...
    validator: validate_DescribeWorkspaceDirectories_602225, base: "/",
    url: url_DescribeWorkspaceDirectories_602226,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspaceImages_602241 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspaceImages_602243(protocol: Scheme; host: string; base: string;
...
proc validate_DescribeWorkspaceImages_602242(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602253: Call_DescribeWorkspaceImages_602241; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list that describes one or more specified images, if the image identifiers are provided. Otherwise, all images in the account are described. 
  ## 
...
proc call*(call_602254: Call_DescribeWorkspaceImages_602241; body: JsonNode): Recallable =
...
var describeWorkspaceImages* = Call_DescribeWorkspaceImages_602241(
    name: "describeWorkspaceImages", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeWorkspaceImages",
    validator: validate_DescribeWorkspaceImages_602242, base: "/",
    url: url_DescribeWorkspaceImages_602243, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspaceSnapshots_602256 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspaceSnapshots_602258(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeWorkspaceSnapshots_602257(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602268: Call_DescribeWorkspaceSnapshots_602256; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the snapshots for the specified WorkSpace.
  ## 
...
proc call*(call_602269: Call_DescribeWorkspaceSnapshots_602256; body: JsonNode): Recallable =
...
var describeWorkspaceSnapshots* = Call_DescribeWorkspaceSnapshots_602256(
    name: "describeWorkspaceSnapshots", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeWorkspaceSnapshots",
    validator: validate_DescribeWorkspaceSnapshots_602257, base: "/",
    url: url_DescribeWorkspaceSnapshots_602258,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspaces_602271 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspaces_602273(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeWorkspaces_602272(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##        : Pagination limit
  section = newJObject()
  var valid_602274 = query.getOrDefault("NextToken")
  valid_602274 = validateParameter(valid_602274, JString, required = false,
                                 default = nil)
  if valid_602274 != nil:
    section.add "NextToken", valid_602274
...
proc call*(call_602285: Call_DescribeWorkspaces_602271; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes the specified WorkSpaces.</p> <p>You can filter the results by using the bundle identifier, directory identifier, or owner, but you can specify only one filter at a time.</p>
  ## 
...
proc call*(call_602286: Call_DescribeWorkspaces_602271; body: JsonNode;
  ...
  add(query_602287, "NextToken", newJString(NextToken))
  add(query_602287, "Limit", newJString(Limit))
  if body != nil:
    body_602288 = body
  result = call_602286.call(nil, query_602287, nil, nil, body_602288)

var describeWorkspaces* = Call_DescribeWorkspaces_602271(
    name: "describeWorkspaces", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DescribeWorkspaces",
    validator: validate_DescribeWorkspaces_602272, base: "/",
    url: url_DescribeWorkspaces_602273, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeWorkspacesConnectionStatus_602289 = ref object of OpenApiRestCall_601389
proc url_DescribeWorkspacesConnectionStatus_602291(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeWorkspacesConnectionStatus_602290(path: JsonNode;
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602292 = header.getOrDefault("X-Amz-Target")
  valid_602292 = validateParameter(valid_602292, JString, required = true, default = newJString(
      "WorkspacesService.DescribeWorkspacesConnectionStatus"))
  if valid_602292 != nil:
    section.add "X-Amz-Target", valid_602292
...
proc call*(call_602301: Call_DescribeWorkspacesConnectionStatus_602289;
...
proc call*(call_602302: Call_DescribeWorkspacesConnectionStatus_602289;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602303 = body
  result = call_602302.call(nil, nil, nil, nil, body_602303)

var describeWorkspacesConnectionStatus* = Call_DescribeWorkspacesConnectionStatus_602289(
    ...
    validator: validate_DescribeWorkspacesConnectionStatus_602290, base: "/",
    url: url_DescribeWorkspacesConnectionStatus_602291,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateIpGroups_602304 = ref object of OpenApiRestCall_601389
proc url_DisassociateIpGroups_602306(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateIpGroups_602305(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602307 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_602307 != nil:
    section.add "X-Amz-Target", valid_602307
...
proc call*(call_602316: Call_DisassociateIpGroups_602304; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates the specified IP access control group from the specified directory.
  ## 
...
proc call*(call_602317: Call_DisassociateIpGroups_602304; body: JsonNode): Recallable =
...
var disassociateIpGroups* = Call_DisassociateIpGroups_602304(
    name: "disassociateIpGroups", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.DisassociateIpGroups",
    validator: validate_DisassociateIpGroups_602305, base: "/",
    url: url_DisassociateIpGroups_602306, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ImportWorkspaceImage_602319 = ref object of OpenApiRestCall_601389
proc url_ImportWorkspaceImage_602321(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ImportWorkspaceImage_602320(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602331: Call_ImportWorkspaceImage_602319; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Imports the specified Windows 7 or Windows 10 Bring Your Own License (BYOL) image into Amazon WorkSpaces. The image must be an already licensed EC2 image that is in your AWS account, and you must own the image. 
  ## 
...
proc call*(call_602332: Call_ImportWorkspaceImage_602319; body: JsonNode): Recallable =
...
var importWorkspaceImage* = Call_ImportWorkspaceImage_602319(
    name: "importWorkspaceImage", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.ImportWorkspaceImage",
    validator: validate_ImportWorkspaceImage_602320, base: "/",
    url: url_ImportWorkspaceImage_602321, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAvailableManagementCidrRanges_602334 = ref object of OpenApiRestCall_601389
proc url_ListAvailableManagementCidrRanges_602336(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAvailableManagementCidrRanges_602335(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602337 = header.getOrDefault("X-Amz-Target")
  valid_602337 = validateParameter(valid_602337, JString, required = true, default = newJString(
      "WorkspacesService.ListAvailableManagementCidrRanges"))
  if valid_602337 != nil:
    section.add "X-Amz-Target", valid_602337
...
proc call*(call_602346: Call_ListAvailableManagementCidrRanges_602334;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Retrieves a list of IP address ranges, specified as IPv4 CIDR blocks, that you can use for the network management interface when you enable Bring Your Own License (BYOL). </p> <p>The management network interface is connected to a secure Amazon WorkSpaces management network. It is used for interactive streaming of the WorkSpace desktop to Amazon WorkSpaces clients, and to allow Amazon WorkSpaces to manage the WorkSpace.</p>
  ## 
...
proc call*(call_602347: Call_ListAvailableManagementCidrRanges_602334;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602348 = body
  result = call_602347.call(nil, nil, nil, nil, body_602348)

var listAvailableManagementCidrRanges* = Call_ListAvailableManagementCidrRanges_602334(
    ...
    validator: validate_ListAvailableManagementCidrRanges_602335, base: "/",
    url: url_ListAvailableManagementCidrRanges_602336,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyAccount_602349 = ref object of OpenApiRestCall_601389
proc url_ModifyAccount_602351(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyAccount_602350(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602361: Call_ModifyAccount_602349; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the configuration of Bring Your Own License (BYOL) for the specified account.
  ## 
...
proc call*(call_602362: Call_ModifyAccount_602349; body: JsonNode): Recallable =
  ## modifyAccount
  ## Modifies the configuration of Bring Your Own License (BYOL) for the specified account.
  ##   body: JObject (required)
...
var modifyAccount* = Call_ModifyAccount_602349(name: "modifyAccount",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.ModifyAccount",
    validator: validate_ModifyAccount_602350, base: "/", url: url_ModifyAccount_602351,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyClientProperties_602364 = ref object of OpenApiRestCall_601389
proc url_ModifyClientProperties_602366(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyClientProperties_602365(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602367 = header.getOrDefault("X-Amz-Target")
  valid_602367 = validateParameter(valid_602367, JString, required = true, default = newJString(
      "WorkspacesService.ModifyClientProperties"))
  if valid_602367 != nil:
    section.add "X-Amz-Target", valid_602367
...
proc call*(call_602376: Call_ModifyClientProperties_602364; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the properties of the specified Amazon WorkSpaces clients.
  ## 
  ...
  let url = call_602376.url(scheme.get, call_602376.host, call_602376.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_602376, url, valid)

proc call*(call_602377: Call_ModifyClientProperties_602364; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602378 = body
  result = call_602377.call(nil, nil, nil, nil, body_602378)

var modifyClientProperties* = Call_ModifyClientProperties_602364(
    name: "modifyClientProperties", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.ModifyClientProperties",
    validator: validate_ModifyClientProperties_602365, base: "/",
    url: url_ModifyClientProperties_602366, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifySelfservicePermissions_602379 = ref object of OpenApiRestCall_601389
proc url_ModifySelfservicePermissions_602381(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifySelfservicePermissions_602380(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602382 = header.getOrDefault("X-Amz-Target")
  valid_602382 = validateParameter(valid_602382, JString, required = true, default = newJString(
      "WorkspacesService.ModifySelfservicePermissions"))
  if valid_602382 != nil:
    section.add "X-Amz-Target", valid_602382
...
proc call*(call_602391: Call_ModifySelfservicePermissions_602379; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the self-service WorkSpace management capabilities for your users. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/enable-user-self-service-workspace-management.html">Enable Self-Service WorkSpace Management Capabilities for Your Users</a>.
  ## 
...
proc call*(call_602392: Call_ModifySelfservicePermissions_602379; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602393 = body
  result = call_602392.call(nil, nil, nil, nil, body_602393)

var modifySelfservicePermissions* = Call_ModifySelfservicePermissions_602379(
    ...
    validator: validate_ModifySelfservicePermissions_602380, base: "/",
    url: url_ModifySelfservicePermissions_602381,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyWorkspaceAccessProperties_602394 = ref object of OpenApiRestCall_601389
proc url_ModifyWorkspaceAccessProperties_602396(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyWorkspaceAccessProperties_602395(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602397 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_602397 != nil:
    section.add "X-Amz-Target", valid_602397
...
proc call*(call_602406: Call_ModifyWorkspaceAccessProperties_602394;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Specifies which devices and operating systems users can use to access their Workspaces. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/update-directory-details.html#control-device-access"> Control Device Access</a>.
  ## 
...
proc call*(call_602407: Call_ModifyWorkspaceAccessProperties_602394; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602408 = body
  result = call_602407.call(nil, nil, nil, nil, body_602408)

var modifyWorkspaceAccessProperties* = Call_ModifyWorkspaceAccessProperties_602394(
    ...
    validator: validate_ModifyWorkspaceAccessProperties_602395, base: "/",
    url: url_ModifyWorkspaceAccessProperties_602396,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyWorkspaceCreationProperties_602409 = ref object of OpenApiRestCall_601389
proc url_ModifyWorkspaceCreationProperties_602411(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyWorkspaceCreationProperties_602410(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602412 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_602412 != nil:
    section.add "X-Amz-Target", valid_602412
...
proc call*(call_602421: Call_ModifyWorkspaceCreationProperties_602409;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Modify the default properties used to create WorkSpaces.
  ## 
...
proc call*(call_602422: Call_ModifyWorkspaceCreationProperties_602409;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602423 = body
  result = call_602422.call(nil, nil, nil, nil, body_602423)

var modifyWorkspaceCreationProperties* = Call_ModifyWorkspaceCreationProperties_602409(
    ...
    validator: validate_ModifyWorkspaceCreationProperties_602410, base: "/",
    url: url_ModifyWorkspaceCreationProperties_602411,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyWorkspaceProperties_602424 = ref object of OpenApiRestCall_601389
proc url_ModifyWorkspaceProperties_602426(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyWorkspaceProperties_602425(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602436: Call_ModifyWorkspaceProperties_602424; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the specified WorkSpace properties.
  ## 
...
proc call*(call_602437: Call_ModifyWorkspaceProperties_602424; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602438 = body
  result = call_602437.call(nil, nil, nil, nil, body_602438)

var modifyWorkspaceProperties* = Call_ModifyWorkspaceProperties_602424(
    name: "modifyWorkspaceProperties", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.ModifyWorkspaceProperties",
    validator: validate_ModifyWorkspaceProperties_602425, base: "/",
    url: url_ModifyWorkspaceProperties_602426,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyWorkspaceState_602439 = ref object of OpenApiRestCall_601389
proc url_ModifyWorkspaceState_602441(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyWorkspaceState_602440(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602442 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_602442 != nil:
    section.add "X-Amz-Target", valid_602442
...
proc call*(call_602451: Call_ModifyWorkspaceState_602439; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Sets the state of the specified WorkSpace.</p> <p>To maintain a WorkSpace without being interrupted, set the WorkSpace state to <code>ADMIN_MAINTENANCE</code>. WorkSpaces in this state do not respond to requests to reboot, stop, start, rebuild, or restore. An AutoStop WorkSpace in this state is not stopped. Users cannot log into a WorkSpace in the <code>ADMIN_MAINTENANCE</code> state.</p>
  ## 
...
proc call*(call_602452: Call_ModifyWorkspaceState_602439; body: JsonNode): Recallable =
...
var modifyWorkspaceState* = Call_ModifyWorkspaceState_602439(
    name: "modifyWorkspaceState", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.ModifyWorkspaceState",
    validator: validate_ModifyWorkspaceState_602440, base: "/",
    url: url_ModifyWorkspaceState_602441, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RebootWorkspaces_602454 = ref object of OpenApiRestCall_601389
proc url_RebootWorkspaces_602456(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RebootWorkspaces_602455(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602466: Call_RebootWorkspaces_602454; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Reboots the specified WorkSpaces.</p> <p>You cannot reboot a WorkSpace unless its state is <code>AVAILABLE</code> or <code>UNHEALTHY</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have rebooted.</p>
  ## 
...
proc call*(call_602467: Call_RebootWorkspaces_602454; body: JsonNode): Recallable =
  ## rebootWorkspaces
  ## <p>Reboots the specified WorkSpaces.</p> <p>You cannot reboot a WorkSpace unless its state is <code>AVAILABLE</code> or <code>UNHEALTHY</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have rebooted.</p>
  ##   body: JObject (required)
...
var rebootWorkspaces* = Call_RebootWorkspaces_602454(name: "rebootWorkspaces",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.RebootWorkspaces",
    validator: validate_RebootWorkspaces_602455, base: "/",
    url: url_RebootWorkspaces_602456, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RebuildWorkspaces_602469 = ref object of OpenApiRestCall_601389
proc url_RebuildWorkspaces_602471(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RebuildWorkspaces_602470(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_602481: Call_RebuildWorkspaces_602469; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Rebuilds the specified WorkSpace.</p> <p>You cannot rebuild a WorkSpace unless its state is <code>AVAILABLE</code>, <code>ERROR</code>, or <code>UNHEALTHY</code>.</p> <p>Rebuilding a WorkSpace is a potentially destructive action that can result in the loss of data. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/reset-workspace.html">Rebuild a WorkSpace</a>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely rebuilt.</p>
  ## 
...
proc call*(call_602482: Call_RebuildWorkspaces_602469; body: JsonNode): Recallable =
  ## rebuildWorkspaces
  ## <p>Rebuilds the specified WorkSpace.</p> <p>You cannot rebuild a WorkSpace unless its state is <code>AVAILABLE</code>, <code>ERROR</code>, or <code>UNHEALTHY</code>.</p> <p>Rebuilding a WorkSpace is a potentially destructive action that can result in the loss of data. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/reset-workspace.html">Rebuild a WorkSpace</a>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely rebuilt.</p>
  ##   body: JObject (required)
...
var rebuildWorkspaces* = Call_RebuildWorkspaces_602469(name: "rebuildWorkspaces",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.RebuildWorkspaces",
    validator: validate_RebuildWorkspaces_602470, base: "/",
    url: url_RebuildWorkspaces_602471, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterWorkspaceDirectory_602484 = ref object of OpenApiRestCall_601389
proc url_RegisterWorkspaceDirectory_602486(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterWorkspaceDirectory_602485(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602487 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_602487 != nil:
    section.add "X-Amz-Target", valid_602487
...
proc call*(call_602496: Call_RegisterWorkspaceDirectory_602484; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Registers the specified directory. This operation is asynchronous and returns before the WorkSpace directory is registered. If this is the first time you are registering a directory, you will need to create the workspaces_DefaultRole role before you can register a directory. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/workspaces-access-control.html#create-default-role"> Creating the workspaces_DefaultRole Role</a>.
  ## 
...
proc call*(call_602497: Call_RegisterWorkspaceDirectory_602484; body: JsonNode): Recallable =
...
var registerWorkspaceDirectory* = Call_RegisterWorkspaceDirectory_602484(
    name: "registerWorkspaceDirectory", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.RegisterWorkspaceDirectory",
    validator: validate_RegisterWorkspaceDirectory_602485, base: "/",
    url: url_RegisterWorkspaceDirectory_602486,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RestoreWorkspace_602499 = ref object of OpenApiRestCall_601389
proc url_RestoreWorkspace_602501(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RestoreWorkspace_602500(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602511: Call_RestoreWorkspace_602499; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Restores the specified WorkSpace to its last known healthy state.</p> <p>You cannot restore a WorkSpace unless its state is <code> AVAILABLE</code>, <code>ERROR</code>, or <code>UNHEALTHY</code>.</p> <p>Restoring a WorkSpace is a potentially destructive action that can result in the loss of data. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/restore-workspace.html">Restore a WorkSpace</a>.</p> <p>This operation is asynchronous and returns before the WorkSpace is completely restored.</p>
  ## 
...
proc call*(call_602512: Call_RestoreWorkspace_602499; body: JsonNode): Recallable =
  ## restoreWorkspace
  ## <p>Restores the specified WorkSpace to its last known healthy state.</p> <p>You cannot restore a WorkSpace unless its state is <code> AVAILABLE</code>, <code>ERROR</code>, or <code>UNHEALTHY</code>.</p> <p>Restoring a WorkSpace is a potentially destructive action that can result in the loss of data. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/restore-workspace.html">Restore a WorkSpace</a>.</p> <p>This operation is asynchronous and returns before the WorkSpace is completely restored.</p>
  ##   body: JObject (required)
...
var restoreWorkspace* = Call_RestoreWorkspace_602499(name: "restoreWorkspace",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.RestoreWorkspace",
    validator: validate_RestoreWorkspace_602500, base: "/",
    url: url_RestoreWorkspace_602501, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RevokeIpRules_602514 = ref object of OpenApiRestCall_601389
proc url_RevokeIpRules_602516(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RevokeIpRules_602515(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602517 = header.getOrDefault("X-Amz-Target")
  valid_602517 = validateParameter(valid_602517, JString, required = true, default = newJString(
      "WorkspacesService.RevokeIpRules"))
  if valid_602517 != nil:
    section.add "X-Amz-Target", valid_602517
...
proc call*(call_602526: Call_RevokeIpRules_602514; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes one or more rules from the specified IP access control group.
  ## 
...
proc call*(call_602527: Call_RevokeIpRules_602514; body: JsonNode): Recallable =
  ## revokeIpRules
  ## Removes one or more rules from the specified IP access control group.
  ##   body: JObject (required)
  var body_602528 = newJObject()
  if body != nil:
    body_602528 = body
  result = call_602527.call(nil, nil, nil, nil, body_602528)

var revokeIpRules* = Call_RevokeIpRules_602514(name: "revokeIpRules",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.RevokeIpRules",
    validator: validate_RevokeIpRules_602515, base: "/", url: url_RevokeIpRules_602516,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartWorkspaces_602529 = ref object of OpenApiRestCall_601389
proc url_StartWorkspaces_602531(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartWorkspaces_602530(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602532 = header.getOrDefault("X-Amz-Target")
  valid_602532 = validateParameter(valid_602532, JString, required = true, default = newJString(
      "WorkspacesService.StartWorkspaces"))
  if valid_602532 != nil:
    section.add "X-Amz-Target", valid_602532
...
proc call*(call_602541: Call_StartWorkspaces_602529; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Starts the specified WorkSpaces.</p> <p>You cannot start a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>STOPPED</code>.</p>
  ## 
...
proc call*(call_602542: Call_StartWorkspaces_602529; body: JsonNode): Recallable =
  ## startWorkspaces
  ## <p>Starts the specified WorkSpaces.</p> <p>You cannot start a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>STOPPED</code>.</p>
  ##   body: JObject (required)
...
var startWorkspaces* = Call_StartWorkspaces_602529(name: "startWorkspaces",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.StartWorkspaces",
    validator: validate_StartWorkspaces_602530, base: "/", url: url_StartWorkspaces_602531,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopWorkspaces_602544 = ref object of OpenApiRestCall_601389
proc url_StopWorkspaces_602546(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopWorkspaces_602545(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_602556: Call_StopWorkspaces_602544; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> Stops the specified WorkSpaces.</p> <p>You cannot stop a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>AVAILABLE</code>, <code>IMPAIRED</code>, <code>UNHEALTHY</code>, or <code>ERROR</code>.</p>
  ## 
...
proc call*(call_602557: Call_StopWorkspaces_602544; body: JsonNode): Recallable =
  ## stopWorkspaces
  ## <p> Stops the specified WorkSpaces.</p> <p>You cannot stop a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>AVAILABLE</code>, <code>IMPAIRED</code>, <code>UNHEALTHY</code>, or <code>ERROR</code>.</p>
  ##   body: JObject (required)
  var body_602558 = newJObject()
  if body != nil:
    body_602558 = body
  result = call_602557.call(nil, nil, nil, nil, body_602558)

var stopWorkspaces* = Call_StopWorkspaces_602544(name: "stopWorkspaces",
    meth: HttpMethod.HttpPost, host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.StopWorkspaces",
    validator: validate_StopWorkspaces_602545, base: "/", url: url_StopWorkspaces_602546,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TerminateWorkspaces_602559 = ref object of OpenApiRestCall_601389
proc url_TerminateWorkspaces_602561(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TerminateWorkspaces_602560(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602562 = header.getOrDefault("X-Amz-Target")
  valid_602562 = validateParameter(valid_602562, JString, required = true, default = newJString(
      "WorkspacesService.TerminateWorkspaces"))
  if valid_602562 != nil:
    section.add "X-Amz-Target", valid_602562
...
proc call*(call_602571: Call_TerminateWorkspaces_602559; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Terminates the specified WorkSpaces.</p> <p>Terminating a WorkSpace is a permanent action and cannot be undone. The user's data is destroyed. If you need to archive any user data, contact Amazon Web Services before terminating the WorkSpace.</p> <p>You can terminate a WorkSpace that is in any state except <code>SUSPENDED</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely terminated.</p>
  ## 
...
proc call*(call_602572: Call_TerminateWorkspaces_602559; body: JsonNode): Recallable =
  ## terminateWorkspaces
  ## <p>Terminates the specified WorkSpaces.</p> <p>Terminating a WorkSpace is a permanent action and cannot be undone. The user's data is destroyed. If you need to archive any user data, contact Amazon Web Services before terminating the WorkSpace.</p> <p>You can terminate a WorkSpace that is in any state except <code>SUSPENDED</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely terminated.</p>
  ##   body: JObject (required)
...
var terminateWorkspaces* = Call_TerminateWorkspaces_602559(
    name: "terminateWorkspaces", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.TerminateWorkspaces",
    validator: validate_TerminateWorkspaces_602560, base: "/",
    url: url_TerminateWorkspaces_602561, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateRulesOfIpGroup_602574 = ref object of OpenApiRestCall_601389
proc url_UpdateRulesOfIpGroup_602576(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateRulesOfIpGroup_602575(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_602577 = header.getOrDefault("X-Amz-Target")
  valid_602577 = validateParameter(valid_602577, JString, required = true, default = newJString(
      "WorkspacesService.UpdateRulesOfIpGroup"))
  if valid_602577 != nil:
    section.add "X-Amz-Target", valid_602577
...
proc call*(call_602586: Call_UpdateRulesOfIpGroup_602574; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Replaces the current rules of the specified IP access control group with the specified rules.
  ## 
...
proc call*(call_602587: Call_UpdateRulesOfIpGroup_602574; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_602588 = body
  result = call_602587.call(nil, nil, nil, nil, body_602588)

var updateRulesOfIpGroup* = Call_UpdateRulesOfIpGroup_602574(
    name: "updateRulesOfIpGroup", meth: HttpMethod.HttpPost,
    host: "workspaces.amazonaws.com",
    route: "/#X-Amz-Target=WorkspacesService.UpdateRulesOfIpGroup",
    validator: validate_UpdateRulesOfIpGroup_602575, base: "/",
    url: url_UpdateRulesOfIpGroup_602576, schemes: {Scheme.Https, Scheme.Http})
export
  rest
