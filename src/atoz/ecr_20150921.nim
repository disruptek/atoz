...
type
  Call_BatchCheckLayerAvailability_600774 = ref object of OpenApiRestCall_600437
proc url_BatchCheckLayerAvailability_600776(protocol: Scheme; host: string;
...
proc validate_BatchCheckLayerAvailability_600775(path: JsonNode; query: JsonNode;
...
proc call*(call_600932: Call_BatchCheckLayerAvailability_600774; path: JsonNode;
...
proc call*(call_601003: Call_BatchCheckLayerAvailability_600774; body: JsonNode): Recallable =
...
var batchCheckLayerAvailability* = Call_BatchCheckLayerAvailability_600774(
    ...
    validator: validate_BatchCheckLayerAvailability_600775, base: "/",
    url: url_BatchCheckLayerAvailability_600776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDeleteImage_601043 = ref object of OpenApiRestCall_600437
proc url_BatchDeleteImage_601045(protocol: Scheme; host: string; base: string;
...
proc validate_BatchDeleteImage_601044(path: JsonNode; query: JsonNode;
...
proc call*(call_601055: Call_BatchDeleteImage_601043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a list of specified images within a specified repository. Images are specified with either <code>imageTag</code> or <code>imageDigest</code>.</p> <p>You can remove a tag from an image by specifying the image's tag in your request. When you remove the last tag from an image, the image is deleted from your repository.</p> <p>You can completely delete an image (and all of its tags) by specifying the image's digest in your request.</p>
  ## 
...
proc call*(call_601056: Call_BatchDeleteImage_601043; body: JsonNode): Recallable =
  ## batchDeleteImage
  ## <p>Deletes a list of specified images within a specified repository. Images are specified with either <code>imageTag</code> or <code>imageDigest</code>.</p> <p>You can remove a tag from an image by specifying the image's tag in your request. When you remove the last tag from an image, the image is deleted from your repository.</p> <p>You can completely delete an image (and all of its tags) by specifying the image's digest in your request.</p>
  ##   body: JObject (required)
...
var batchDeleteImage* = Call_BatchDeleteImage_601043(name: "batchDeleteImage",
    ...
    validator: validate_BatchDeleteImage_601044, base: "/",
    url: url_BatchDeleteImage_601045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetImage_601058 = ref object of OpenApiRestCall_600437
proc url_BatchGetImage_601060(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetImage_601059(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601070: Call_BatchGetImage_601058; path: JsonNode; query: JsonNode;
...
proc call*(call_601071: Call_BatchGetImage_601058; body: JsonNode): Recallable =
  ## batchGetImage
  ## Gets detailed information for specified images within a specified repository. Images are specified with either <code>imageTag</code> or <code>imageDigest</code>.
  ##   body: JObject (required)
...
var batchGetImage* = Call_BatchGetImage_601058(name: "batchGetImage",
    meth: HttpMethod.HttpPost, host: "api.ecr.amazonaws.com",
    route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchGetImage",
    validator: validate_BatchGetImage_601059, base: "/", url: url_BatchGetImage_601060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CompleteLayerUpload_601073 = ref object of OpenApiRestCall_600437
proc url_CompleteLayerUpload_601075(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CompleteLayerUpload_601074(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601085: Call_CompleteLayerUpload_601073; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Informs Amazon ECR that the image layer upload has completed for a specified registry, repository name, and upload ID. You can optionally provide a <code>sha256</code> digest of the image layer for data validation purposes.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ## 
...
proc call*(call_601086: Call_CompleteLayerUpload_601073; body: JsonNode): Recallable =
  ## completeLayerUpload
  ## <p>Informs Amazon ECR that the image layer upload has completed for a specified registry, repository name, and upload ID. You can optionally provide a <code>sha256</code> digest of the image layer for data validation purposes.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   body: JObject (required)
...
var completeLayerUpload* = Call_CompleteLayerUpload_601073(
    ...
    validator: validate_CompleteLayerUpload_601074, base: "/",
    url: url_CompleteLayerUpload_601075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRepository_601088 = ref object of OpenApiRestCall_600437
proc url_CreateRepository_601090(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateRepository_601089(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601100: Call_CreateRepository_601088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates an image repository.
  ## 
...
proc call*(call_601101: Call_CreateRepository_601088; body: JsonNode): Recallable =
  ## createRepository
  ## Creates an image repository.
  ##   body: JObject (required)
...
var createRepository* = Call_CreateRepository_601088(name: "createRepository",
    ...
    validator: validate_CreateRepository_601089, base: "/",
    url: url_CreateRepository_601090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteLifecyclePolicy_601103 = ref object of OpenApiRestCall_600437
proc url_DeleteLifecyclePolicy_601105(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteLifecyclePolicy_601104(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601115: Call_DeleteLifecyclePolicy_601103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified lifecycle policy.
  ## 
...
proc call*(call_601116: Call_DeleteLifecyclePolicy_601103; body: JsonNode): Recallable =
...
var deleteLifecyclePolicy* = Call_DeleteLifecyclePolicy_601103(
    ...
    validator: validate_DeleteLifecyclePolicy_601104, base: "/",
    url: url_DeleteLifecyclePolicy_601105, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRepository_601118 = ref object of OpenApiRestCall_600437
proc url_DeleteRepository_601120(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRepository_601119(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601130: Call_DeleteRepository_601118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an existing image repository. If a repository contains images, you must use the <code>force</code> option to delete it.
  ## 
...
proc call*(call_601131: Call_DeleteRepository_601118; body: JsonNode): Recallable =
  ## deleteRepository
  ## Deletes an existing image repository. If a repository contains images, you must use the <code>force</code> option to delete it.
  ##   body: JObject (required)
...
var deleteRepository* = Call_DeleteRepository_601118(name: "deleteRepository",
    ...
    validator: validate_DeleteRepository_601119, base: "/",
    url: url_DeleteRepository_601120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRepositoryPolicy_601133 = ref object of OpenApiRestCall_600437
proc url_DeleteRepositoryPolicy_601135(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRepositoryPolicy_601134(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601145: Call_DeleteRepositoryPolicy_601133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the repository policy from a specified repository.
  ## 
...
proc call*(call_601146: Call_DeleteRepositoryPolicy_601133; body: JsonNode): Recallable =
...
var deleteRepositoryPolicy* = Call_DeleteRepositoryPolicy_601133(
    ...
    validator: validate_DeleteRepositoryPolicy_601134, base: "/",
    url: url_DeleteRepositoryPolicy_601135, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeImages_601148 = ref object of OpenApiRestCall_600437
proc url_DescribeImages_601150(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeImages_601149(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601162: Call_DescribeImages_601148; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns metadata about the images in a repository, including image size, image tags, and creation date.</p> <note> <p>Beginning with Docker version 1.9, the Docker client compresses image layers before pushing them to a V2 Docker registry. The output of the <code>docker images</code> command shows the uncompressed image size, so it may return a larger image size than the image sizes returned by <a>DescribeImages</a>.</p> </note>
  ## 
...
proc call*(call_601163: Call_DescribeImages_601148; body: JsonNode;
...
var describeImages* = Call_DescribeImages_601148(name: "describeImages",
    ...
    validator: validate_DescribeImages_601149, base: "/", url: url_DescribeImages_601150,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRepositories_601167 = ref object of OpenApiRestCall_600437
proc url_DescribeRepositories_601169(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeRepositories_601168(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601181: Call_DescribeRepositories_601167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes image repositories in a registry.
  ## 
...
proc call*(call_601182: Call_DescribeRepositories_601167; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
...
var describeRepositories* = Call_DescribeRepositories_601167(
    ...
    validator: validate_DescribeRepositories_601168, base: "/",
    url: url_DescribeRepositories_601169, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAuthorizationToken_601185 = ref object of OpenApiRestCall_600437
proc url_GetAuthorizationToken_601187(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAuthorizationToken_601186(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601190 = header.getOrDefault("X-Amz-Target")
  valid_601190 = validateParameter(valid_601190, JString, required = true, default = newJString(
      "AmazonEC2ContainerRegistry_V20150921.GetAuthorizationToken"))
  if valid_601190 != nil:
    section.add "X-Amz-Target", valid_601190
...
proc call*(call_601197: Call_GetAuthorizationToken_601185; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves a token that is valid for a specified registry for 12 hours. This command allows you to use the <code>docker</code> CLI to push and pull images with Amazon ECR. If you do not specify a registry, the default registry is assumed.</p> <p>The <code>authorizationToken</code> returned for each registry specified is a base64 encoded string that can be decoded and used in a <code>docker login</code> command to authenticate to a registry. The AWS CLI offers an <code>aws ecr get-login</code> command that simplifies the login process.</p>
  ## 
...
proc call*(call_601198: Call_GetAuthorizationToken_601185; body: JsonNode): Recallable =
...
var getAuthorizationToken* = Call_GetAuthorizationToken_601185(
    ...
    validator: validate_GetAuthorizationToken_601186, base: "/",
    url: url_GetAuthorizationToken_601187, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDownloadUrlForLayer_601200 = ref object of OpenApiRestCall_600437
proc url_GetDownloadUrlForLayer_601202(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDownloadUrlForLayer_601201(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601212: Call_GetDownloadUrlForLayer_601200; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the pre-signed Amazon S3 download URL corresponding to an image layer. You can only get URLs for image layers that are referenced in an image.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ## 
...
proc call*(call_601213: Call_GetDownloadUrlForLayer_601200; body: JsonNode): Recallable =
...
var getDownloadUrlForLayer* = Call_GetDownloadUrlForLayer_601200(
    ...
    validator: validate_GetDownloadUrlForLayer_601201, base: "/",
    url: url_GetDownloadUrlForLayer_601202, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicy_601215 = ref object of OpenApiRestCall_600437
proc url_GetLifecyclePolicy_601217(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetLifecyclePolicy_601216(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601227: Call_GetLifecyclePolicy_601215; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the specified lifecycle policy.
  ## 
...
proc call*(call_601228: Call_GetLifecyclePolicy_601215; body: JsonNode): Recallable =
  ## getLifecyclePolicy
  ## Retrieves the specified lifecycle policy.
  ##   body: JObject (required)
...
var getLifecyclePolicy* = Call_GetLifecyclePolicy_601215(
    ...
    validator: validate_GetLifecyclePolicy_601216, base: "/",
    url: url_GetLifecyclePolicy_601217, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicyPreview_601230 = ref object of OpenApiRestCall_600437
proc url_GetLifecyclePolicyPreview_601232(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetLifecyclePolicyPreview_601231(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601242: Call_GetLifecyclePolicyPreview_601230; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the results of the specified lifecycle policy preview request.
  ## 
...
proc call*(call_601243: Call_GetLifecyclePolicyPreview_601230; body: JsonNode): Recallable =
...
var getLifecyclePolicyPreview* = Call_GetLifecyclePolicyPreview_601230(
    ...
    validator: validate_GetLifecyclePolicyPreview_601231, base: "/",
    url: url_GetLifecyclePolicyPreview_601232,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRepositoryPolicy_601245 = ref object of OpenApiRestCall_600437
proc url_GetRepositoryPolicy_601247(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRepositoryPolicy_601246(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601257: Call_GetRepositoryPolicy_601245; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the repository policy for a specified repository.
  ## 
...
proc call*(call_601258: Call_GetRepositoryPolicy_601245; body: JsonNode): Recallable =
  ## getRepositoryPolicy
  ## Retrieves the repository policy for a specified repository.
  ##   body: JObject (required)
...
var getRepositoryPolicy* = Call_GetRepositoryPolicy_601245(
    ...
    validator: validate_GetRepositoryPolicy_601246, base: "/",
    url: url_GetRepositoryPolicy_601247, schemes: {Scheme.Https, Scheme.Http})
type
  Call_InitiateLayerUpload_601260 = ref object of OpenApiRestCall_600437
proc url_InitiateLayerUpload_601262(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InitiateLayerUpload_601261(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601272: Call_InitiateLayerUpload_601260; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Notify Amazon ECR that you intend to upload an image layer.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ## 
...
proc call*(call_601273: Call_InitiateLayerUpload_601260; body: JsonNode): Recallable =
  ## initiateLayerUpload
  ## <p>Notify Amazon ECR that you intend to upload an image layer.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   body: JObject (required)
...
var initiateLayerUpload* = Call_InitiateLayerUpload_601260(
    ...
    validator: validate_InitiateLayerUpload_601261, base: "/",
    url: url_InitiateLayerUpload_601262, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListImages_601275 = ref object of OpenApiRestCall_600437
proc url_ListImages_601277(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListImages_601276(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601289: Call_ListImages_601275; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all the image IDs for a given repository.</p> <p>You can filter images based on whether or not they are tagged by setting the <code>tagStatus</code> parameter to <code>TAGGED</code> or <code>UNTAGGED</code>. For example, you can filter your results to return only <code>UNTAGGED</code> images and then pipe that result to a <a>BatchDeleteImage</a> operation to delete them. Or, you can filter your results to return only <code>TAGGED</code> images to list all of the tags in your repository.</p>
  ## 
...
proc call*(call_601290: Call_ListImages_601275; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ## listImages
  ## <p>Lists all the image IDs for a given repository.</p> <p>You can filter images based on whether or not they are tagged by setting the <code>tagStatus</code> parameter to <code>TAGGED</code> or <code>UNTAGGED</code>. For example, you can filter your results to return only <code>UNTAGGED</code> images and then pipe that result to a <a>BatchDeleteImage</a> operation to delete them. Or, you can filter your results to return only <code>TAGGED</code> images to list all of the tags in your repository.</p>
  ##   maxResults: string
...
var listImages* = Call_ListImages_601275(name: "listImages",
                                      meth: HttpMethod.HttpPost,
                                      host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListImages",
                                      validator: validate_ListImages_601276,
                                      base: "/", url: url_ListImages_601277,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_601293 = ref object of OpenApiRestCall_600437
proc url_ListTagsForResource_601295(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_601294(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601305: Call_ListTagsForResource_601293; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the tags for an Amazon ECR resource.
  ## 
...
proc call*(call_601306: Call_ListTagsForResource_601293; body: JsonNode): Recallable =
  ## listTagsForResource
  ## List the tags for an Amazon ECR resource.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_601293(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListTagsForResource",
    validator: validate_ListTagsForResource_601294, base: "/",
    url: url_ListTagsForResource_601295, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutImage_601308 = ref object of OpenApiRestCall_600437
proc url_PutImage_601310(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutImage_601309(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601320: Call_PutImage_601308; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates or updates the image manifest and tags associated with an image.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ## 
...
proc call*(call_601321: Call_PutImage_601308; body: JsonNode): Recallable =
  ## putImage
  ## <p>Creates or updates the image manifest and tags associated with an image.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   body: JObject (required)
...
var putImage* = Call_PutImage_601308(name: "putImage", meth: HttpMethod.HttpPost,
                                  host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImage",
                                  validator: validate_PutImage_601309, base: "/",
                                  url: url_PutImage_601310,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutImageTagMutability_601323 = ref object of OpenApiRestCall_600437
proc url_PutImageTagMutability_601325(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutImageTagMutability_601324(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601335: Call_PutImageTagMutability_601323; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the image tag mutability settings for a repository.
  ## 
...
proc call*(call_601336: Call_PutImageTagMutability_601323; body: JsonNode): Recallable =
...
var putImageTagMutability* = Call_PutImageTagMutability_601323(
    ...
    validator: validate_PutImageTagMutability_601324, base: "/",
    url: url_PutImageTagMutability_601325, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutLifecyclePolicy_601338 = ref object of OpenApiRestCall_600437
proc url_PutLifecyclePolicy_601340(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutLifecyclePolicy_601339(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601350: Call_PutLifecyclePolicy_601338; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a lifecycle policy. For information about lifecycle policy syntax, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html">Lifecycle Policy Template</a>.
  ## 
...
proc call*(call_601351: Call_PutLifecyclePolicy_601338; body: JsonNode): Recallable =
  ## putLifecyclePolicy
  ## Creates or updates a lifecycle policy. For information about lifecycle policy syntax, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html">Lifecycle Policy Template</a>.
  ##   body: JObject (required)
...
var putLifecyclePolicy* = Call_PutLifecyclePolicy_601338(
    ...
    validator: validate_PutLifecyclePolicy_601339, base: "/",
    url: url_PutLifecyclePolicy_601340, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SetRepositoryPolicy_601353 = ref object of OpenApiRestCall_600437
proc url_SetRepositoryPolicy_601355(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SetRepositoryPolicy_601354(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601365: Call_SetRepositoryPolicy_601353; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Applies a repository policy on a specified repository to control access permissions. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicies.html">Amazon ECR Repository Policies</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
  ## 
...
proc call*(call_601366: Call_SetRepositoryPolicy_601353; body: JsonNode): Recallable =
  ## setRepositoryPolicy
  ## Applies a repository policy on a specified repository to control access permissions. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicies.html">Amazon ECR Repository Policies</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
  ##   body: JObject (required)
...
var setRepositoryPolicy* = Call_SetRepositoryPolicy_601353(
    ...
    validator: validate_SetRepositoryPolicy_601354, base: "/",
    url: url_SetRepositoryPolicy_601355, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartLifecyclePolicyPreview_601368 = ref object of OpenApiRestCall_600437
proc url_StartLifecyclePolicyPreview_601370(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartLifecyclePolicyPreview_601369(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601380: Call_StartLifecyclePolicyPreview_601368; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts a preview of the specified lifecycle policy. This allows you to see the results before creating the lifecycle policy.
  ## 
...
proc call*(call_601381: Call_StartLifecyclePolicyPreview_601368; body: JsonNode): Recallable =
...
var startLifecyclePolicyPreview* = Call_StartLifecyclePolicyPreview_601368(
    ...
    validator: validate_StartLifecyclePolicyPreview_601369, base: "/",
    url: url_StartLifecyclePolicyPreview_601370,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_601383 = ref object of OpenApiRestCall_600437
...
var tagResource* = Call_TagResource_601383(name: "tagResource",
                                        ...
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_601398 = ref object of OpenApiRestCall_600437
...
var untagResource* = Call_UntagResource_601398(name: "untagResource",
    ...
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UploadLayerPart_601413 = ref object of OpenApiRestCall_600437
proc url_UploadLayerPart_601415(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UploadLayerPart_601414(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_601425: Call_UploadLayerPart_601413; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Uploads an image layer part to Amazon ECR.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ## 
...
proc call*(call_601426: Call_UploadLayerPart_601413; body: JsonNode): Recallable =
  ## uploadLayerPart
  ## <p>Uploads an image layer part to Amazon ECR.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   body: JObject (required)
...
var uploadLayerPart* = Call_UploadLayerPart_601413(name: "uploadLayerPart",
    ...
    validator: validate_UploadLayerPart_601414, base: "/", url: url_UploadLayerPart_601415,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
