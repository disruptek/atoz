...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "api.ecr.ap-northeast-1.amazonaws.com", "ap-southeast-1": "api.ecr.ap-southeast-1.amazonaws.com",
                               ...
                               "us-east-1": "api.ecr.us-east-1.amazonaws.com", "cn-northwest-1": "api.ecr.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "api.ecr.ap-south-1.amazonaws.com", "eu-north-1": "api.ecr.eu-north-1.amazonaws.com", "ap-northeast-2": "api.ecr.ap-northeast-2.amazonaws.com",
                               "us-west-1": "api.ecr.us-west-1.amazonaws.com", "us-gov-east-1": "api.ecr.us-gov-east-1.amazonaws.com",
                               "eu-west-3": "api.ecr.eu-west-3.amazonaws.com", "cn-north-1": "api.ecr.cn-north-1.amazonaws.com.cn",
                               "sa-east-1": "api.ecr.sa-east-1.amazonaws.com",
                               "eu-west-1": "api.ecr.eu-west-1.amazonaws.com", "us-gov-west-1": "api.ecr.us-gov-west-1.amazonaws.com", "ap-southeast-2": "api.ecr.ap-southeast-2.amazonaws.com", "ca-central-1": "api.ecr.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_BatchCheckLayerAvailability_402656294 = ref object of OpenApiRestCall_402656044
proc url_BatchCheckLayerAvailability_402656296(protocol: Scheme; host: string;
...
proc validate_BatchCheckLayerAvailability_402656295(path: JsonNode;
...
proc call*(call_402656412: Call_BatchCheckLayerAvailability_402656294;
...
proc call*(call_402656461: Call_BatchCheckLayerAvailability_402656294;
...
var batchCheckLayerAvailability* = Call_BatchCheckLayerAvailability_402656294(
    ...
    validator: validate_BatchCheckLayerAvailability_402656295, base: "/",
    makeUrl: url_BatchCheckLayerAvailability_402656296,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDeleteImage_402656489 = ref object of OpenApiRestCall_402656044
proc url_BatchDeleteImage_402656491(protocol: Scheme; host: string;
...
proc validate_BatchDeleteImage_402656490(path: JsonNode; query: JsonNode;
...
proc call*(call_402656501: Call_BatchDeleteImage_402656489;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes a list of specified images within a repository. Images are specified with either an <code>imageTag</code> or <code>imageDigest</code>.</p> <p>You can remove a tag from an image by specifying the image's tag in your request. When you remove the last tag from an image, the image is deleted from your repository.</p> <p>You can completely delete an image (and all of its tags) by specifying the image's digest in your request.</p>
                                                                                         ## 
...
proc call*(call_402656502: Call_BatchDeleteImage_402656489; body: JsonNode): Recallable =
  ## batchDeleteImage
  ## <p>Deletes a list of specified images within a repository. Images are specified with either an <code>imageTag</code> or <code>imageDigest</code>.</p> <p>You can remove a tag from an image by specifying the image's tag in your request. When you remove the last tag from an image, the image is deleted from your repository.</p> <p>You can completely delete an image (and all of its tags) by specifying the image's digest in your request.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                            ## body: JObject (required)
...
var batchDeleteImage* = Call_BatchDeleteImage_402656489(
    name: "batchDeleteImage", meth: HttpMethod.HttpPost,
    host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchDeleteImage",
    validator: validate_BatchDeleteImage_402656490, base: "/",
    makeUrl: url_BatchDeleteImage_402656491,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetImage_402656504 = ref object of OpenApiRestCall_402656044
proc url_BatchGetImage_402656506(protocol: Scheme; host: string; base: string;
...
proc validate_BatchGetImage_402656505(path: JsonNode; query: JsonNode;
...
proc call*(call_402656516: Call_BatchGetImage_402656504; path: JsonNode = nil;
...
proc call*(call_402656517: Call_BatchGetImage_402656504; body: JsonNode): Recallable =
  ## batchGetImage
  ## <p>Gets detailed information for an image. Images are specified with either an <code>imageTag</code> or <code>imageDigest</code>.</p> <p>When an image is pulled, the BatchGetImage API is called once to retrieve the image manifest.</p>
  ##   
                                                                                                                                                                                                                                               ## body: JObject (required)
...
var batchGetImage* = Call_BatchGetImage_402656504(name: "batchGetImage",
    meth: HttpMethod.HttpPost, host: "api.ecr.amazonaws.com",
    route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchGetImage",
    validator: validate_BatchGetImage_402656505, base: "/",
    makeUrl: url_BatchGetImage_402656506, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CompleteLayerUpload_402656519 = ref object of OpenApiRestCall_402656044
proc url_CompleteLayerUpload_402656521(protocol: Scheme; host: string;
...
proc validate_CompleteLayerUpload_402656520(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656531: Call_CompleteLayerUpload_402656519;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Informs Amazon ECR that the image layer upload has completed for a specified registry, repository name, and upload ID. You can optionally provide a <code>sha256</code> digest of the image layer for data validation purposes.</p> <p>When an image is pushed, the CompleteLayerUpload API is called once per each new image layer to verify that the upload has completed.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
                                                                                         ## 
...
proc call*(call_402656532: Call_CompleteLayerUpload_402656519; body: JsonNode): Recallable =
  ## completeLayerUpload
  ## <p>Informs Amazon ECR that the image layer upload has completed for a specified registry, repository name, and upload ID. You can optionally provide a <code>sha256</code> digest of the image layer for data validation purposes.</p> <p>When an image is pushed, the CompleteLayerUpload API is called once per each new image layer to verify that the upload has completed.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ## body: JObject (required)
...
var completeLayerUpload* = Call_CompleteLayerUpload_402656519(
    ...
    validator: validate_CompleteLayerUpload_402656520, base: "/",
    makeUrl: url_CompleteLayerUpload_402656521,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRepository_402656534 = ref object of OpenApiRestCall_402656044
proc url_CreateRepository_402656536(protocol: Scheme; host: string;
                                    base: string; route: string; path: JsonNode;
                                    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_CreateRepository_402656535(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656546: Call_CreateRepository_402656534;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/Repositories.html">Amazon ECR Repositories</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
                                                                                         ## 
...
proc call*(call_402656547: Call_CreateRepository_402656534; body: JsonNode): Recallable =
  ## createRepository
  ## Creates a repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/Repositories.html">Amazon ECR Repositories</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
  ##   
                                                                                                                                                                                                                               ## body: JObject (required)
...
var createRepository* = Call_CreateRepository_402656534(
    name: "createRepository", meth: HttpMethod.HttpPost,
    host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CreateRepository",
    validator: validate_CreateRepository_402656535, base: "/",
    makeUrl: url_CreateRepository_402656536,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteLifecyclePolicy_402656549 = ref object of OpenApiRestCall_402656044
proc url_DeleteLifecyclePolicy_402656551(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteLifecyclePolicy_402656550(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656561: Call_DeleteLifecyclePolicy_402656549;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the lifecycle policy associated with the specified repository.
                                                                                         ## 
...
proc call*(call_402656562: Call_DeleteLifecyclePolicy_402656549; body: JsonNode): Recallable =
...
var deleteLifecyclePolicy* = Call_DeleteLifecyclePolicy_402656549(
    ...
    validator: validate_DeleteLifecyclePolicy_402656550, base: "/",
    makeUrl: url_DeleteLifecyclePolicy_402656551,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRepository_402656564 = ref object of OpenApiRestCall_402656044
proc url_DeleteRepository_402656566(protocol: Scheme; host: string;
                                    base: string; route: string; path: JsonNode;
                                    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteRepository_402656565(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656576: Call_DeleteRepository_402656564;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a repository. If the repository contains images, you must either delete all images in the repository or use the <code>force</code> option to delete the repository.
                                                                                         ## 
...
proc call*(call_402656577: Call_DeleteRepository_402656564; body: JsonNode): Recallable =
  ## deleteRepository
  ## Deletes a repository. If the repository contains images, you must either delete all images in the repository or use the <code>force</code> option to delete the repository.
  ##   
                                                                                                                                                                                ## body: JObject (required)
...
var deleteRepository* = Call_DeleteRepository_402656564(
    name: "deleteRepository", meth: HttpMethod.HttpPost,
    host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepository",
    validator: validate_DeleteRepository_402656565, base: "/",
    makeUrl: url_DeleteRepository_402656566,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRepositoryPolicy_402656579 = ref object of OpenApiRestCall_402656044
proc url_DeleteRepositoryPolicy_402656581(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRepositoryPolicy_402656580(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656591: Call_DeleteRepositoryPolicy_402656579;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the repository policy associated with the specified repository.
                                                                                         ## 
...
proc call*(call_402656592: Call_DeleteRepositoryPolicy_402656579; body: JsonNode): Recallable =
...
var deleteRepositoryPolicy* = Call_DeleteRepositoryPolicy_402656579(
    ...
    validator: validate_DeleteRepositoryPolicy_402656580, base: "/",
    makeUrl: url_DeleteRepositoryPolicy_402656581,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeImageScanFindings_402656594 = ref object of OpenApiRestCall_402656044
proc url_DescribeImageScanFindings_402656596(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeImageScanFindings_402656595(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656608: Call_DescribeImageScanFindings_402656594;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns the scan findings for the specified image.
                                                                                         ## 
...
proc call*(call_402656609: Call_DescribeImageScanFindings_402656594;
...
var describeImageScanFindings* = Call_DescribeImageScanFindings_402656594(
    ...
    validator: validate_DescribeImageScanFindings_402656595, base: "/",
    makeUrl: url_DescribeImageScanFindings_402656596,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeImages_402656612 = ref object of OpenApiRestCall_402656044
proc url_DescribeImages_402656614(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeImages_402656613(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656626: Call_DescribeImages_402656612; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns metadata about the images in a repository.</p> <note> <p>Beginning with Docker version 1.9, the Docker client compresses image layers before pushing them to a V2 Docker registry. The output of the <code>docker images</code> command shows the uncompressed image size, so it may return a larger image size than the image sizes returned by <a>DescribeImages</a>.</p> </note>
                                                                                         ## 
...
proc call*(call_402656627: Call_DescribeImages_402656612; body: JsonNode;
...
var describeImages* = Call_DescribeImages_402656612(name: "describeImages",
    ...
    validator: validate_DescribeImages_402656613, base: "/",
    makeUrl: url_DescribeImages_402656614, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRepositories_402656630 = ref object of OpenApiRestCall_402656044
proc url_DescribeRepositories_402656632(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeRepositories_402656631(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656644: Call_DescribeRepositories_402656630;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes image repositories in a registry.
                                                                                         ## 
...
proc call*(call_402656645: Call_DescribeRepositories_402656630; body: JsonNode;
           maxResults: string = ""; nextToken: string = ""): Recallable =
...
var describeRepositories* = Call_DescribeRepositories_402656630(
    ...
    validator: validate_DescribeRepositories_402656631, base: "/",
    makeUrl: url_DescribeRepositories_402656632,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAuthorizationToken_402656648 = ref object of OpenApiRestCall_402656044
proc url_GetAuthorizationToken_402656650(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAuthorizationToken_402656649(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656660: Call_GetAuthorizationToken_402656648;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves an authorization token. An authorization token represents your IAM authentication credentials and can be used to access any Amazon ECR registry that your IAM principal has access to. The authorization token is valid for 12 hours.</p> <p>The <code>authorizationToken</code> returned is a base64 encoded string that can be decoded and used in a <code>docker login</code> command to authenticate to a registry. The AWS CLI offers an <code>get-login-password</code> command that simplifies the login process. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/Registries.html#registry_auth">Registry Authentication</a> in the <i>Amazon Elastic Container Registry User Guide</i>.</p>
                                                                                         ## 
...
proc call*(call_402656661: Call_GetAuthorizationToken_402656648; body: JsonNode): Recallable =
...
var getAuthorizationToken* = Call_GetAuthorizationToken_402656648(
    ...
    validator: validate_GetAuthorizationToken_402656649, base: "/",
    makeUrl: url_GetAuthorizationToken_402656650,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDownloadUrlForLayer_402656663 = ref object of OpenApiRestCall_402656044
proc url_GetDownloadUrlForLayer_402656665(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDownloadUrlForLayer_402656664(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656675: Call_GetDownloadUrlForLayer_402656663;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves the pre-signed Amazon S3 download URL corresponding to an image layer. You can only get URLs for image layers that are referenced in an image.</p> <p>When an image is pulled, the GetDownloadUrlForLayer API is called once per image layer.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
                                                                                         ## 
...
proc call*(call_402656676: Call_GetDownloadUrlForLayer_402656663; body: JsonNode): Recallable =
...
var getDownloadUrlForLayer* = Call_GetDownloadUrlForLayer_402656663(
    ...
    validator: validate_GetDownloadUrlForLayer_402656664, base: "/",
    makeUrl: url_GetDownloadUrlForLayer_402656665,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicy_402656678 = ref object of OpenApiRestCall_402656044
proc url_GetLifecyclePolicy_402656680(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetLifecyclePolicy_402656679(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656690: Call_GetLifecyclePolicy_402656678;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieves the lifecycle policy for the specified repository.
                                                                                         ## 
...
proc call*(call_402656691: Call_GetLifecyclePolicy_402656678; body: JsonNode): Recallable =
  ## getLifecyclePolicy
  ## Retrieves the lifecycle policy for the specified repository.
  ##   body: JObject (required)
...
var getLifecyclePolicy* = Call_GetLifecyclePolicy_402656678(
    ...
    validator: validate_GetLifecyclePolicy_402656679, base: "/",
    makeUrl: url_GetLifecyclePolicy_402656680,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicyPreview_402656693 = ref object of OpenApiRestCall_402656044
proc url_GetLifecyclePolicyPreview_402656695(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetLifecyclePolicyPreview_402656694(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656707: Call_GetLifecyclePolicyPreview_402656693;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieves the results of the lifecycle policy preview request for the specified repository.
                                                                                         ## 
...
proc call*(call_402656708: Call_GetLifecyclePolicyPreview_402656693;
           body: JsonNode; maxResults: string = ""; nextToken: string = ""): Recallable =
...
var getLifecyclePolicyPreview* = Call_GetLifecyclePolicyPreview_402656693(
    ...
    validator: validate_GetLifecyclePolicyPreview_402656694, base: "/",
    makeUrl: url_GetLifecyclePolicyPreview_402656695,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRepositoryPolicy_402656711 = ref object of OpenApiRestCall_402656044
proc url_GetRepositoryPolicy_402656713(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetRepositoryPolicy_402656712(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656723: Call_GetRepositoryPolicy_402656711;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieves the repository policy for the specified repository.
                                                                                         ## 
...
proc call*(call_402656724: Call_GetRepositoryPolicy_402656711; body: JsonNode): Recallable =
  ## getRepositoryPolicy
  ## Retrieves the repository policy for the specified repository.
  ##   body: JObject (required)
...
var getRepositoryPolicy* = Call_GetRepositoryPolicy_402656711(
    ...
    validator: validate_GetRepositoryPolicy_402656712, base: "/",
    makeUrl: url_GetRepositoryPolicy_402656713,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_InitiateLayerUpload_402656726 = ref object of OpenApiRestCall_402656044
proc url_InitiateLayerUpload_402656728(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_InitiateLayerUpload_402656727(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656738: Call_InitiateLayerUpload_402656726;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Notifies Amazon ECR that you intend to upload an image layer.</p> <p>When an image is pushed, the InitiateLayerUpload API is called once per image layer that has not already been uploaded. Whether an image layer has been uploaded before is determined by the <a>BatchCheckLayerAvailability</a> API action.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
                                                                                         ## 
...
proc call*(call_402656739: Call_InitiateLayerUpload_402656726; body: JsonNode): Recallable =
  ## initiateLayerUpload
  ## <p>Notifies Amazon ECR that you intend to upload an image layer.</p> <p>When an image is pushed, the InitiateLayerUpload API is called once per image layer that has not already been uploaded. Whether an image layer has been uploaded before is determined by the <a>BatchCheckLayerAvailability</a> API action.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ## body: JObject (required)
...
var initiateLayerUpload* = Call_InitiateLayerUpload_402656726(
    ...
    validator: validate_InitiateLayerUpload_402656727, base: "/",
    makeUrl: url_InitiateLayerUpload_402656728,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListImages_402656741 = ref object of OpenApiRestCall_402656044
proc url_ListImages_402656743(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListImages_402656742(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   nextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402656744 = query.getOrDefault("maxResults")
  valid_402656744 = validateParameter(valid_402656744, JString,
                                      required = false, default = nil)
  if valid_402656744 != nil:
    section.add "maxResults", valid_402656744
  var valid_402656745 = query.getOrDefault("nextToken")
  valid_402656745 = validateParameter(valid_402656745, JString,
                                      required = false, default = nil)
  if valid_402656745 != nil:
    section.add "nextToken", valid_402656745
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Security-Token: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656746 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_402656746 != nil:
    section.add "X-Amz-Target", valid_402656746
...
proc call*(call_402656755: Call_ListImages_402656741; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists all the image IDs for the specified repository.</p> <p>You can filter images based on whether or not they are tagged by using the <code>tagStatus</code> filter and specifying either <code>TAGGED</code>, <code>UNTAGGED</code> or <code>ANY</code>. For example, you can filter your results to return only <code>UNTAGGED</code> images and then pipe that result to a <a>BatchDeleteImage</a> operation to delete them. Or, you can filter your results to return only <code>TAGGED</code> images to list all of the tags in your repository.</p>
                                                                                         ## 
...
proc call*(call_402656756: Call_ListImages_402656741; body: JsonNode;
           maxResults: string = ""; nextToken: string = ""): Recallable =
  ## listImages
  ## <p>Lists all the image IDs for the specified repository.</p> <p>You can filter images based on whether or not they are tagged by using the <code>tagStatus</code> filter and specifying either <code>TAGGED</code>, <code>UNTAGGED</code> or <code>ANY</code>. For example, you can filter your results to return only <code>UNTAGGED</code> images and then pipe that result to a <a>BatchDeleteImage</a> operation to delete them. Or, you can filter your results to return only <code>TAGGED</code> images to list all of the tags in your repository.</p>
  ##   
  ...
  if body != nil:
    body_402656758 = body
  result = call_402656756.call(nil, query_402656757, nil, nil, body_402656758)

var listImages* = Call_ListImages_402656741(name: "listImages",
    meth: HttpMethod.HttpPost, host: "api.ecr.amazonaws.com",
    route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListImages",
    validator: validate_ListImages_402656742, base: "/",
    makeUrl: url_ListImages_402656743, schemes: {Scheme.Https, Scheme.Http})
type
...
var listTagsForResource* = Call_ListTagsForResource_402656759(
    ...
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutImage_402656774 = ref object of OpenApiRestCall_402656044
proc url_PutImage_402656776(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutImage_402656775(path: JsonNode; query: JsonNode;
                                 header: JsonNode; formData: JsonNode;
                                 body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656786: Call_PutImage_402656774; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates or updates the image manifest and tags associated with an image.</p> <p>When an image is pushed and all new image layers have been uploaded, the PutImage API is called once to create or update the image manifest and tags associated with the image.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
                                                                                         ## 
...
proc call*(call_402656787: Call_PutImage_402656774; body: JsonNode): Recallable =
  ## putImage
  ## <p>Creates or updates the image manifest and tags associated with an image.</p> <p>When an image is pushed and all new image layers have been uploaded, the PutImage API is called once to create or update the image manifest and tags associated with the image.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ## body: JObject (required)
...
var putImage* = Call_PutImage_402656774(name: "putImage",
                                        meth: HttpMethod.HttpPost,
                                        host: "api.ecr.amazonaws.com", route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImage",
                                        validator: validate_PutImage_402656775,
                                        base: "/", makeUrl: url_PutImage_402656776,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutImageScanningConfiguration_402656789 = ref object of OpenApiRestCall_402656044
proc url_PutImageScanningConfiguration_402656791(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutImageScanningConfiguration_402656790(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656801: Call_PutImageScanningConfiguration_402656789;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates the image scanning configuration for the specified repository.
                                                                                         ## 
...
proc call*(call_402656802: Call_PutImageScanningConfiguration_402656789;
           body: JsonNode): Recallable =
...
var putImageScanningConfiguration* = Call_PutImageScanningConfiguration_402656789(
    ...
    validator: validate_PutImageScanningConfiguration_402656790, base: "/",
    makeUrl: url_PutImageScanningConfiguration_402656791,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutImageTagMutability_402656804 = ref object of OpenApiRestCall_402656044
proc url_PutImageTagMutability_402656806(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutImageTagMutability_402656805(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656816: Call_PutImageTagMutability_402656804;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates the image tag mutability settings for the specified repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-tag-mutability.html">Image Tag Mutability</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
                                                                                         ## 
...
proc call*(call_402656817: Call_PutImageTagMutability_402656804; body: JsonNode): Recallable =
...
var putImageTagMutability* = Call_PutImageTagMutability_402656804(
    ...
    validator: validate_PutImageTagMutability_402656805, base: "/",
    makeUrl: url_PutImageTagMutability_402656806,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutLifecyclePolicy_402656819 = ref object of OpenApiRestCall_402656044
proc url_PutLifecyclePolicy_402656821(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_PutLifecyclePolicy_402656820(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656831: Call_PutLifecyclePolicy_402656819;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates or updates the lifecycle policy for the specified repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html">Lifecycle Policy Template</a>.
                                                                                         ## 
...
proc call*(call_402656832: Call_PutLifecyclePolicy_402656819; body: JsonNode): Recallable =
  ## putLifecyclePolicy
  ## Creates or updates the lifecycle policy for the specified repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html">Lifecycle Policy Template</a>.
  ##   
                                                                                                                                                                                                                           ## body: JObject (required)
...
var putLifecyclePolicy* = Call_PutLifecyclePolicy_402656819(
    ...
    validator: validate_PutLifecyclePolicy_402656820, base: "/",
    makeUrl: url_PutLifecyclePolicy_402656821,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SetRepositoryPolicy_402656834 = ref object of OpenApiRestCall_402656044
proc url_SetRepositoryPolicy_402656836(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_SetRepositoryPolicy_402656835(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656846: Call_SetRepositoryPolicy_402656834;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Applies a repository policy to the specified repository to control access permissions. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicies.html">Amazon ECR Repository Policies</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
                                                                                         ## 
...
proc call*(call_402656847: Call_SetRepositoryPolicy_402656834; body: JsonNode): Recallable =
  ## setRepositoryPolicy
  ## Applies a repository policy to the specified repository to control access permissions. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicies.html">Amazon ECR Repository Policies</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
  ##   
                                                                                                                                                                                                                                                                                                             ## body: JObject (required)
...
var setRepositoryPolicy* = Call_SetRepositoryPolicy_402656834(
    ...
    validator: validate_SetRepositoryPolicy_402656835, base: "/",
    makeUrl: url_SetRepositoryPolicy_402656836,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartImageScan_402656849 = ref object of OpenApiRestCall_402656044
proc url_StartImageScan_402656851(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartImageScan_402656850(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656861: Call_StartImageScan_402656849; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Starts an image vulnerability scan. An image scan can only be started once per day on an individual image. This limit includes if an image was scanned on initial push. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html">Image Scanning</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
                                                                                         ## 
...
proc call*(call_402656862: Call_StartImageScan_402656849; body: JsonNode): Recallable =
  ## startImageScan
  ## Starts an image vulnerability scan. An image scan can only be started once per day on an individual image. This limit includes if an image was scanned on initial push. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html">Image Scanning</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
  ##   
                                                                                                                                                                                                                                                                                                                                                                          ## body: JObject (required)
...
var startImageScan* = Call_StartImageScan_402656849(name: "startImageScan",
    ...
    validator: validate_StartImageScan_402656850, base: "/",
    makeUrl: url_StartImageScan_402656851, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartLifecyclePolicyPreview_402656864 = ref object of OpenApiRestCall_402656044
proc url_StartLifecyclePolicyPreview_402656866(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartLifecyclePolicyPreview_402656865(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656876: Call_StartLifecyclePolicyPreview_402656864;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Starts a preview of a lifecycle policy for the specified repository. This allows you to see the results before associating the lifecycle policy with the repository.
                                                                                         ## 
...
proc call*(call_402656877: Call_StartLifecyclePolicyPreview_402656864;
           body: JsonNode): Recallable =
...
var startLifecyclePolicyPreview* = Call_StartLifecyclePolicyPreview_402656864(
    ...
    validator: validate_StartLifecyclePolicyPreview_402656865, base: "/",
    makeUrl: url_StartLifecyclePolicyPreview_402656866,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_402656879 = ref object of OpenApiRestCall_402656044
proc url_TagResource_402656881(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_402656880(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656891: Call_TagResource_402656879; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Adds specified tags to a resource with the specified ARN. Existing tags on a resource are not changed if they are not specified in the request parameters.
                                                                                         ## 
...
proc call*(call_402656892: Call_TagResource_402656879; body: JsonNode): Recallable =
  ## tagResource
  ## Adds specified tags to a resource with the specified ARN. Existing tags on a resource are not changed if they are not specified in the request parameters.
  ##   
                                                                                                                                                               ## body: JObject (required)
...
var tagResource* = Call_TagResource_402656879(name: "tagResource",
    meth: HttpMethod.HttpPost, host: "api.ecr.amazonaws.com",
    route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.TagResource",
    validator: validate_TagResource_402656880, base: "/",
    makeUrl: url_TagResource_402656881, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_402656894 = ref object of OpenApiRestCall_402656044
proc url_UntagResource_402656896(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_402656895(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656906: Call_UntagResource_402656894; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes specified tags from a resource.
                                                                                         ## 
...
proc call*(call_402656907: Call_UntagResource_402656894; body: JsonNode): Recallable =
  ## untagResource
  ## Deletes specified tags from a resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_402656894(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "api.ecr.amazonaws.com",
    route: "/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UntagResource",
    validator: validate_UntagResource_402656895, base: "/",
    makeUrl: url_UntagResource_402656896, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UploadLayerPart_402656909 = ref object of OpenApiRestCall_402656044
proc url_UploadLayerPart_402656911(protocol: Scheme; host: string; base: string;
...
proc validate_UploadLayerPart_402656910(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656921: Call_UploadLayerPart_402656909; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Uploads an image layer part to Amazon ECR.</p> <p>When an image is pushed, each new image layer is uploaded in parts. The maximum size of each image layer part can be 20971520 bytes (or about 20MB). The UploadLayerPart API is called once per each new image layer part.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
                                                                                         ## 
...
proc call*(call_402656922: Call_UploadLayerPart_402656909; body: JsonNode): Recallable =
  ## uploadLayerPart
  ## <p>Uploads an image layer part to Amazon ECR.</p> <p>When an image is pushed, each new image layer is uploaded in parts. The maximum size of each image layer part can be 20971520 bytes (or about 20MB). The UploadLayerPart API is called once per each new image layer part.</p> <note> <p>This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the <code>docker</code> CLI to pull, tag, and push images.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ## body: JObject (required)
...
var uploadLayerPart* = Call_UploadLayerPart_402656909(name: "uploadLayerPart",
    ...
    validator: validate_UploadLayerPart_402656910, base: "/",
    makeUrl: url_UploadLayerPart_402656911, schemes: {Scheme.Https, Scheme.Http})
export
  rest
