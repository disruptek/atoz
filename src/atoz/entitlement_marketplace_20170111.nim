...
type
  Call_GetEntitlements_612987 = ref object of OpenApiRestCall_612649
proc url_GetEntitlements_612989(protocol: Scheme; host: string; base: string;
...
proc validate_GetEntitlements_612988(path: JsonNode; query: JsonNode;
...
proc call*(call_613145: Call_GetEntitlements_612987; path: JsonNode; query: JsonNode;
...
proc call*(call_613216: Call_GetEntitlements_612987; body: JsonNode): Recallable =
  ## getEntitlements
  ## GetEntitlements retrieves entitlement values for a given product. The results can be filtered based on customer identifier or product dimensions.
  ##   body: JObject (required)
...
var getEntitlements* = Call_GetEntitlements_612987(name: "getEntitlements",
    ...
    validator: validate_GetEntitlements_612988, base: "/", url: url_GetEntitlements_612989,
