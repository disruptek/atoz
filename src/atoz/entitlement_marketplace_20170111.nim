...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_GetEntitlements_21625770 = ref object of OpenApiRestCall_21625426
proc url_GetEntitlements_21625772(protocol: Scheme; host: string; base: string;
...
proc validate_GetEntitlements_21625771(path: JsonNode; query: JsonNode;
...
proc call*(call_21625920: Call_GetEntitlements_21625770; path: JsonNode = nil;
...
proc call*(call_21625983: Call_GetEntitlements_21625770; body: JsonNode): Recallable =
  ## getEntitlements
  ## GetEntitlements retrieves entitlement values for a given product. The results can be filtered based on customer identifier or product dimensions.
  ##   body: JObject (required)
...
var getEntitlements* = Call_GetEntitlements_21625770(name: "getEntitlements",
    ...
    validator: validate_GetEntitlements_21625771, base: "/",
    makeUrl: url_GetEntitlements_21625772, schemes: {Scheme.Https, Scheme.Http})
export
  rest
