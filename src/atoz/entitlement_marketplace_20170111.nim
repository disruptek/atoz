...
type
  Call_GetEntitlements_599696 = ref object of OpenApiRestCall_599359
proc url_GetEntitlements_599698(protocol: Scheme; host: string; base: string;
...
proc validate_GetEntitlements_599697(path: JsonNode; query: JsonNode;
...
proc call*(call_599854: Call_GetEntitlements_599696; path: JsonNode; query: JsonNode;
...
proc call*(call_599925: Call_GetEntitlements_599696; body: JsonNode): Recallable =
  ## getEntitlements
  ## GetEntitlements retrieves entitlement values for a given product. The results can be filtered based on customer identifier or product dimensions.
  ##   body: JObject (required)
...
var getEntitlements* = Call_GetEntitlements_599696(name: "getEntitlements",
    ...
    validator: validate_GetEntitlements_599697, base: "/", url: url_GetEntitlements_599698,
