...
var batchPutMessage* = Call_BatchPutMessage_610996(name: "batchPutMessage",
    ...
    route: "/inputs/messages", validator: validate_BatchPutMessage_610997,
    base: "/", url: url_BatchPutMessage_610998, schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchUpdateDetector_611251 = ref object of OpenApiRestCall_610658
proc url_BatchUpdateDetector_611253(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchUpdateDetector_611252(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_611262: Call_BatchUpdateDetector_611251; path: JsonNode;
...
proc call*(call_611263: Call_BatchUpdateDetector_611251; body: JsonNode): Recallable =
  ## batchUpdateDetector
  ## Updates the state, variable values, and timer settings of one or more detectors (instances) of a specified detector model.
  ##   body: JObject (required)
...
var batchUpdateDetector* = Call_BatchUpdateDetector_611251(
    name: "batchUpdateDetector", meth: HttpMethod.HttpPost,
    host: "data.iotevents.amazonaws.com", route: "/detectors",
    validator: validate_BatchUpdateDetector_611252, base: "/",
    url: url_BatchUpdateDetector_611253, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDetector_611265 = ref object of OpenApiRestCall_610658
proc url_DescribeDetector_611267(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDetector_611266(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_611282 = path.getOrDefault("detectorModelName")
  valid_611282 = validateParameter(valid_611282, JString, required = true,
                                 default = nil)
  if valid_611282 != nil:
    section.add "detectorModelName", valid_611282
  result.add "path", section
  ## parameters in `query` object:
  ##   keyValue: JString
  ##           : A filter used to limit results to detectors (instances) created because of the given key ID.
  section = newJObject()
  var valid_611283 = query.getOrDefault("keyValue")
  valid_611283 = validateParameter(valid_611283, JString, required = false,
                                 default = nil)
  if valid_611283 != nil:
    section.add "keyValue", valid_611283
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_611291: Call_DescribeDetector_611265; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about the specified detector (instance).
  ## 
...
proc call*(call_611292: Call_DescribeDetector_611265; detectorModelName: string;
  ...
  add(path_611293, "detectorModelName", newJString(detectorModelName))
  add(query_611294, "keyValue", newJString(keyValue))
  result = call_611292.call(path_611293, query_611294, nil, nil, nil)

var describeDetector* = Call_DescribeDetector_611265(name: "describeDetector",
    meth: HttpMethod.HttpGet, host: "data.iotevents.amazonaws.com",
    route: "/detectors/{detectorModelName}/keyValues/",
    validator: validate_DescribeDetector_611266, base: "/",
    url: url_DescribeDetector_611267, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDetectors_611296 = ref object of OpenApiRestCall_610658
proc url_ListDetectors_611298(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDetectors_611297(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorModelName` field"
  var valid_611299 = path.getOrDefault("detectorModelName")
  valid_611299 = validateParameter(valid_611299, JString, required = true,
                                 default = nil)
  if valid_611299 != nil:
    section.add "detectorModelName", valid_611299
  result.add "path", section
  ## parameters in `query` object:
  ##   nextToken: JString
  ...
  var valid_611301 = query.getOrDefault("stateName")
  valid_611301 = validateParameter(valid_611301, JString, required = false,
                                 default = nil)
  if valid_611301 != nil:
    section.add "stateName", valid_611301
  var valid_611302 = query.getOrDefault("maxResults")
  valid_611302 = validateParameter(valid_611302, JInt, required = false, default = nil)
  if valid_611302 != nil:
...
proc call*(call_611310: Call_ListDetectors_611296; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists detectors (the instances of a detector model).
  ## 
...
proc call*(call_611311: Call_ListDetectors_611296; detectorModelName: string;
  ...
  add(query_611313, "nextToken", newJString(nextToken))
  add(path_611312, "detectorModelName", newJString(detectorModelName))
  add(query_611313, "stateName", newJString(stateName))
  add(query_611313, "maxResults", newJInt(maxResults))
  result = call_611311.call(path_611312, query_611313, nil, nil, nil)

var listDetectors* = Call_ListDetectors_611296(name: "listDetectors",
    meth: HttpMethod.HttpGet, host: "data.iotevents.amazonaws.com",
    route: "/detectors/{detectorModelName}", validator: validate_ListDetectors_611297,
    base: "/", url: url_ListDetectors_611298, schemes: {Scheme.Https, Scheme.Http})
export
  rest
