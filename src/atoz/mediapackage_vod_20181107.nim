...
type
  Call_CreateAsset_603030 = ref object of OpenApiRestCall_602433
proc url_CreateAsset_603032(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateAsset_603031(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603041: Call_CreateAsset_603030; path: JsonNode; query: JsonNode;
...
proc call*(call_603042: Call_CreateAsset_603030; body: JsonNode): Recallable =
  ## createAsset
  ## Creates a new MediaPackage VOD Asset resource.
  ##   body: JObject (required)
...
var createAsset* = Call_CreateAsset_603030(name: "createAsset",
                                        meth: HttpMethod.HttpPost,
                                        host: "mediapackage-vod.amazonaws.com",
                                        route: "/assets",
                                        validator: validate_CreateAsset_603031,
                                        base: "/", url: url_CreateAsset_603032,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAssets_602770 = ref object of OpenApiRestCall_602433
proc url_ListAssets_602772(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListAssets_602771(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_602884 = query.getOrDefault("packagingGroupId")
  valid_602884 = validateParameter(valid_602884, JString, required = false,
                                 default = nil)
  if valid_602884 != nil:
    section.add "packagingGroupId", valid_602884
...
proc call*(call_602918: Call_ListAssets_602770; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a collection of MediaPackage VOD Asset resources.
  ## 
...
proc call*(call_602989: Call_ListAssets_602770; packagingGroupId: string = "";
  ...
  add(query_602990, "packagingGroupId", newJString(packagingGroupId))
...
var listAssets* = Call_ListAssets_602770(name: "listAssets",
                                      meth: HttpMethod.HttpGet,
                                      host: "mediapackage-vod.amazonaws.com",
                                      route: "/assets",
                                      validator: validate_ListAssets_602771,
                                      base: "/", url: url_ListAssets_602772,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreatePackagingConfiguration_603062 = ref object of OpenApiRestCall_602433
proc url_CreatePackagingConfiguration_603064(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreatePackagingConfiguration_603063(path: JsonNode; query: JsonNode;
...
proc call*(call_603073: Call_CreatePackagingConfiguration_603062; path: JsonNode;
...
proc call*(call_603074: Call_CreatePackagingConfiguration_603062; body: JsonNode): Recallable =
...
var createPackagingConfiguration* = Call_CreatePackagingConfiguration_603062(
    ...
    validator: validate_CreatePackagingConfiguration_603063, base: "/",
    url: url_CreatePackagingConfiguration_603064,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPackagingConfigurations_603044 = ref object of OpenApiRestCall_602433
proc url_ListPackagingConfigurations_603046(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListPackagingConfigurations_603045(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603047 = query.getOrDefault("packagingGroupId")
  valid_603047 = validateParameter(valid_603047, JString, required = false,
                                 default = nil)
  if valid_603047 != nil:
    section.add "packagingGroupId", valid_603047
  var valid_603048 = query.getOrDefault("NextToken")
  valid_603048 = validateParameter(valid_603048, JString, required = false,
                                 default = nil)
  if valid_603048 != nil:
    section.add "NextToken", valid_603048
  var valid_603049 = query.getOrDefault("maxResults")
  valid_603049 = validateParameter(valid_603049, JInt, required = false, default = nil)
  if valid_603049 != nil:
    section.add "maxResults", valid_603049
  var valid_603050 = query.getOrDefault("nextToken")
  valid_603050 = validateParameter(valid_603050, JString, required = false,
                                 default = nil)
  if valid_603050 != nil:
    section.add "nextToken", valid_603050
  var valid_603051 = query.getOrDefault("MaxResults")
  valid_603051 = validateParameter(valid_603051, JString, required = false,
                                 default = nil)
  if valid_603051 != nil:
    section.add "MaxResults", valid_603051
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_603059: Call_ListPackagingConfigurations_603044; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a collection of MediaPackage VOD PackagingConfiguration resources.
  ## 
...
proc call*(call_603060: Call_ListPackagingConfigurations_603044;
  ...
  add(query_603061, "packagingGroupId", newJString(packagingGroupId))
  add(query_603061, "NextToken", newJString(NextToken))
  add(query_603061, "maxResults", newJInt(maxResults))
  add(query_603061, "nextToken", newJString(nextToken))
  add(query_603061, "MaxResults", newJString(MaxResults))
  result = call_603060.call(nil, query_603061, nil, nil, nil)

var listPackagingConfigurations* = Call_ListPackagingConfigurations_603044(
    name: "listPackagingConfigurations", meth: HttpMethod.HttpGet,
    host: "mediapackage-vod.amazonaws.com", route: "/packaging_configurations",
    validator: validate_ListPackagingConfigurations_603045, base: "/",
    url: url_ListPackagingConfigurations_603046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreatePackagingGroup_603093 = ref object of OpenApiRestCall_602433
proc url_CreatePackagingGroup_603095(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreatePackagingGroup_603094(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603104: Call_CreatePackagingGroup_603093; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new MediaPackage VOD PackagingGroup resource.
  ## 
...
proc call*(call_603105: Call_CreatePackagingGroup_603093; body: JsonNode): Recallable =
...
var createPackagingGroup* = Call_CreatePackagingGroup_603093(
    name: "createPackagingGroup", meth: HttpMethod.HttpPost,
    host: "mediapackage-vod.amazonaws.com", route: "/packaging_groups",
    validator: validate_CreatePackagingGroup_603094, base: "/",
    url: url_CreatePackagingGroup_603095, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPackagingGroups_603076 = ref object of OpenApiRestCall_602433
proc url_ListPackagingGroups_603078(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListPackagingGroups_603077(path: JsonNode; query: JsonNode;
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603079 = query.getOrDefault("NextToken")
  valid_603079 = validateParameter(valid_603079, JString, required = false,
                                 default = nil)
  if valid_603079 != nil:
    section.add "NextToken", valid_603079
  var valid_603080 = query.getOrDefault("maxResults")
  valid_603080 = validateParameter(valid_603080, JInt, required = false, default = nil)
  if valid_603080 != nil:
    section.add "maxResults", valid_603080
...
proc call*(call_603090: Call_ListPackagingGroups_603076; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a collection of MediaPackage VOD PackagingGroup resources.
  ## 
...
proc call*(call_603091: Call_ListPackagingGroups_603076; NextToken: string = "";
  ...
  add(query_603092, "nextToken", newJString(nextToken))
  add(query_603092, "MaxResults", newJString(MaxResults))
  result = call_603091.call(nil, query_603092, nil, nil, nil)

var listPackagingGroups* = Call_ListPackagingGroups_603076(
    name: "listPackagingGroups", meth: HttpMethod.HttpGet,
    host: "mediapackage-vod.amazonaws.com", route: "/packaging_groups",
    validator: validate_ListPackagingGroups_603077, base: "/",
    url: url_ListPackagingGroups_603078, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAsset_603107 = ref object of OpenApiRestCall_602433
proc url_DescribeAsset_603109(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
...
proc validate_DescribeAsset_603108(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603132: Call_DescribeAsset_603107; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a description of a MediaPackage VOD Asset resource.
  ## 
...
proc call*(call_603133: Call_DescribeAsset_603107; id: string): Recallable =
  ## describeAsset
  ## Returns a description of a MediaPackage VOD Asset resource.
  ##   id: string (required)
  ##     : The ID of an MediaPackage VOD Asset resource.
  var path_603134 = newJObject()
  add(path_603134, "id", newJString(id))
  result = call_603133.call(path_603134, nil, nil, nil, nil)

var describeAsset* = Call_DescribeAsset_603107(name: "describeAsset",
    meth: HttpMethod.HttpGet, host: "mediapackage-vod.amazonaws.com",
    route: "/assets/{id}", validator: validate_DescribeAsset_603108, base: "/",
    url: url_DescribeAsset_603109, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAsset_603135 = ref object of OpenApiRestCall_602433
proc url_DeleteAsset_603137(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "id" in path, "`id` is a required path parameter"
  const
...
proc validate_DeleteAsset_603136(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603146: Call_DeleteAsset_603135; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an existing MediaPackage VOD Asset resource.
  ## 
...
proc call*(call_603147: Call_DeleteAsset_603135; id: string): Recallable =
  ## deleteAsset
  ## Deletes an existing MediaPackage VOD Asset resource.
  ##   id: string (required)
  ##     : The ID of the MediaPackage VOD Asset resource to delete.
...
var deleteAsset* = Call_DeleteAsset_603135(name: "deleteAsset",
                                        meth: HttpMethod.HttpDelete,
                                        host: "mediapackage-vod.amazonaws.com",
                                        route: "/assets/{id}",
                                        validator: validate_DeleteAsset_603136,
                                        base: "/", url: url_DeleteAsset_603137,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePackagingConfiguration_603149 = ref object of OpenApiRestCall_602433
proc url_DescribePackagingConfiguration_603151(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "id" in path, "`id` is a required path parameter"
  const
...
proc validate_DescribePackagingConfiguration_603150(path: JsonNode;
...
proc call*(call_603160: Call_DescribePackagingConfiguration_603149; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a description of a MediaPackage VOD PackagingConfiguration resource.
  ## 
...
proc call*(call_603161: Call_DescribePackagingConfiguration_603149; id: string): Recallable =
...
var describePackagingConfiguration* = Call_DescribePackagingConfiguration_603149(
    name: "describePackagingConfiguration", meth: HttpMethod.HttpGet,
    host: "mediapackage-vod.amazonaws.com",
    route: "/packaging_configurations/{id}",
    validator: validate_DescribePackagingConfiguration_603150, base: "/",
    url: url_DescribePackagingConfiguration_603151,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePackagingConfiguration_603163 = ref object of OpenApiRestCall_602433
proc url_DeletePackagingConfiguration_603165(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "id" in path, "`id` is a required path parameter"
  const
...
proc validate_DeletePackagingConfiguration_603164(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603174: Call_DeletePackagingConfiguration_603163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a MediaPackage VOD PackagingConfiguration resource.
  ## 
...
proc call*(call_603175: Call_DeletePackagingConfiguration_603163; id: string): Recallable =
...
var deletePackagingConfiguration* = Call_DeletePackagingConfiguration_603163(
    name: "deletePackagingConfiguration", meth: HttpMethod.HttpDelete,
    host: "mediapackage-vod.amazonaws.com",
    route: "/packaging_configurations/{id}",
    validator: validate_DeletePackagingConfiguration_603164, base: "/",
    url: url_DeletePackagingConfiguration_603165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePackagingGroup_603177 = ref object of OpenApiRestCall_602433
proc url_DescribePackagingGroup_603179(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "id" in path, "`id` is a required path parameter"
  const
...
proc validate_DescribePackagingGroup_603178(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603188: Call_DescribePackagingGroup_603177; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a description of a MediaPackage VOD PackagingGroup resource.
  ## 
...
proc call*(call_603189: Call_DescribePackagingGroup_603177; id: string): Recallable =
  ## describePackagingGroup
  ## Returns a description of a MediaPackage VOD PackagingGroup resource.
  ##   id: string (required)
  ##     : The ID of a MediaPackage VOD PackagingGroup resource.
  var path_603190 = newJObject()
  add(path_603190, "id", newJString(id))
  result = call_603189.call(path_603190, nil, nil, nil, nil)

var describePackagingGroup* = Call_DescribePackagingGroup_603177(
    name: "describePackagingGroup", meth: HttpMethod.HttpGet,
    host: "mediapackage-vod.amazonaws.com", route: "/packaging_groups/{id}",
    validator: validate_DescribePackagingGroup_603178, base: "/",
    url: url_DescribePackagingGroup_603179, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePackagingGroup_603191 = ref object of OpenApiRestCall_602433
proc url_DeletePackagingGroup_603193(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "id" in path, "`id` is a required path parameter"
  const
...
proc validate_DeletePackagingGroup_603192(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603202: Call_DeletePackagingGroup_603191; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a MediaPackage VOD PackagingGroup resource.
  ## 
...
proc call*(call_603203: Call_DeletePackagingGroup_603191; id: string): Recallable =
  ## deletePackagingGroup
  ## Deletes a MediaPackage VOD PackagingGroup resource.
  ##   id: string (required)
  ##     : The ID of the MediaPackage VOD PackagingGroup resource to delete.
  var path_603204 = newJObject()
  add(path_603204, "id", newJString(id))
  result = call_603203.call(path_603204, nil, nil, nil, nil)

var deletePackagingGroup* = Call_DeletePackagingGroup_603191(
    name: "deletePackagingGroup", meth: HttpMethod.HttpDelete,
    host: "mediapackage-vod.amazonaws.com", route: "/packaging_groups/{id}",
    validator: validate_DeletePackagingGroup_603192, base: "/",
    url: url_DeletePackagingGroup_603193, schemes: {Scheme.Https, Scheme.Http})
export
  rest
