...
var listIndex* = Call_ListIndex_603693(name: "listIndex", meth: HttpMethod.HttpPost,
                                    ...
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListManagedSchemaArns_603712 = ref object of OpenApiRestCall_602466
proc url_ListManagedSchemaArns_603714(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListManagedSchemaArns_603713(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603725: Call_ListManagedSchemaArns_603712; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the major version families of each managed schema. If a major version ARN is provided as SchemaArn, the minor version revisions in that family are listed instead.
  ## 
...
proc call*(call_603726: Call_ListManagedSchemaArns_603712; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_603727, "NextToken", newJString(NextToken))
  if body != nil:
    body_603728 = body
  add(query_603727, "MaxResults", newJString(MaxResults))
  result = call_603726.call(nil, query_603727, nil, nil, body_603728)

var listManagedSchemaArns* = Call_ListManagedSchemaArns_603712(
    name: "listManagedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/managed",
    validator: validate_ListManagedSchemaArns_603713, base: "/",
    url: url_ListManagedSchemaArns_603714, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectAttributes_603729 = ref object of OpenApiRestCall_602466
proc url_ListObjectAttributes_603731(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectAttributes_603730(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603732 = query.getOrDefault("NextToken")
  valid_603732 = validateParameter(valid_603732, JString, required = false,
                                 default = nil)
  if valid_603732 != nil:
    section.add "NextToken", valid_603732
  var valid_603733 = query.getOrDefault("MaxResults")
  valid_603733 = validateParameter(valid_603733, JString, required = false,
                                 default = nil)
  if valid_603733 != nil:
    section.add "MaxResults", valid_603733
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_603740 = header.getOrDefault("x-amz-consistency-level")
  valid_603740 = validateParameter(valid_603740, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_603740 != nil:
    section.add "x-amz-consistency-level", valid_603740
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603742 = header.getOrDefault("x-amz-data-partition")
  valid_603742 = validateParameter(valid_603742, JString, required = true,
                                 default = nil)
  if valid_603742 != nil:
    section.add "x-amz-data-partition", valid_603742
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603744: Call_ListObjectAttributes_603729; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all attributes that are associated with an object. 
  ## 
...
proc call*(call_603745: Call_ListObjectAttributes_603729; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_603746, "NextToken", newJString(NextToken))
  if body != nil:
    body_603747 = body
  add(query_603746, "MaxResults", newJString(MaxResults))
  result = call_603745.call(nil, query_603746, nil, nil, body_603747)

var listObjectAttributes* = Call_ListObjectAttributes_603729(
    ...
    validator: validate_ListObjectAttributes_603730, base: "/",
    url: url_ListObjectAttributes_603731, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectChildren_603748 = ref object of OpenApiRestCall_602466
proc url_ListObjectChildren_603750(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectChildren_603749(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603751 = query.getOrDefault("NextToken")
  valid_603751 = validateParameter(valid_603751, JString, required = false,
                                 default = nil)
  if valid_603751 != nil:
    section.add "NextToken", valid_603751
  var valid_603752 = query.getOrDefault("MaxResults")
  valid_603752 = validateParameter(valid_603752, JString, required = false,
                                 default = nil)
  if valid_603752 != nil:
    section.add "MaxResults", valid_603752
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_603759 = header.getOrDefault("x-amz-consistency-level")
  valid_603759 = validateParameter(valid_603759, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_603759 != nil:
    section.add "x-amz-consistency-level", valid_603759
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603761 = header.getOrDefault("x-amz-data-partition")
  valid_603761 = validateParameter(valid_603761, JString, required = true,
                                 default = nil)
  if valid_603761 != nil:
    section.add "x-amz-data-partition", valid_603761
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603763: Call_ListObjectChildren_603748; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of child objects that are associated with a given object.
  ## 
...
proc call*(call_603764: Call_ListObjectChildren_603748; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectChildren
  ## Returns a paginated list of child objects that are associated with a given object.
  ##   NextToken: string
  ...
  add(query_603765, "NextToken", newJString(NextToken))
  if body != nil:
    body_603766 = body
  add(query_603765, "MaxResults", newJString(MaxResults))
  result = call_603764.call(nil, query_603765, nil, nil, body_603766)

var listObjectChildren* = Call_ListObjectChildren_603748(
    ...
    validator: validate_ListObjectChildren_603749, base: "/",
    url: url_ListObjectChildren_603750, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParentPaths_603767 = ref object of OpenApiRestCall_602466
proc url_ListObjectParentPaths_603769(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParentPaths_603768(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603770 = query.getOrDefault("NextToken")
  valid_603770 = validateParameter(valid_603770, JString, required = false,
                                 default = nil)
  if valid_603770 != nil:
    section.add "NextToken", valid_603770
  var valid_603771 = query.getOrDefault("MaxResults")
  valid_603771 = validateParameter(valid_603771, JString, required = false,
                                 default = nil)
  if valid_603771 != nil:
    section.add "MaxResults", valid_603771
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603779 = header.getOrDefault("x-amz-data-partition")
  valid_603779 = validateParameter(valid_603779, JString, required = true,
                                 default = nil)
  if valid_603779 != nil:
    section.add "x-amz-data-partition", valid_603779
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603781: Call_ListObjectParentPaths_603767; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves all available parent paths for any object type such as node, leaf node, policy node, and index node objects. For more information about objects, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directorystructure.html">Directory Structure</a>.</p> <p>Use this API to evaluate all parents for an object. The call returns all objects from the root of the directory up to the requested object. The API returns the number of paths based on user-defined <code>MaxResults</code>, in case there are multiple paths to the parent. The order of the paths and nodes returned is consistent among multiple API calls unless the objects are deleted or moved. Paths not leading to the directory root are ignored from the target object.</p>
  ## 
...
proc call*(call_603782: Call_ListObjectParentPaths_603767; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  if body != nil:
    body_603784 = body
  add(query_603783, "MaxResults", newJString(MaxResults))
  result = call_603782.call(nil, query_603783, nil, nil, body_603784)

var listObjectParentPaths* = Call_ListObjectParentPaths_603767(
    ...
    validator: validate_ListObjectParentPaths_603768, base: "/",
    url: url_ListObjectParentPaths_603769, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParents_603785 = ref object of OpenApiRestCall_602466
proc url_ListObjectParents_603787(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParents_603786(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_603789 = query.getOrDefault("MaxResults")
  valid_603789 = validateParameter(valid_603789, JString, required = false,
                                 default = nil)
  if valid_603789 != nil:
    section.add "MaxResults", valid_603789
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_603796 = header.getOrDefault("x-amz-consistency-level")
  valid_603796 = validateParameter(valid_603796, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_603796 != nil:
    section.add "x-amz-consistency-level", valid_603796
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603798 = header.getOrDefault("x-amz-data-partition")
  valid_603798 = validateParameter(valid_603798, JString, required = true,
                                 default = nil)
  if valid_603798 != nil:
    section.add "x-amz-data-partition", valid_603798
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603800: Call_ListObjectParents_603785; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ## 
...
proc call*(call_603801: Call_ListObjectParents_603785; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectParents
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ##   NextToken: string
  ...
  add(query_603802, "NextToken", newJString(NextToken))
  if body != nil:
    body_603803 = body
  add(query_603802, "MaxResults", newJString(MaxResults))
  result = call_603801.call(nil, query_603802, nil, nil, body_603803)

var listObjectParents* = Call_ListObjectParents_603785(name: "listObjectParents",
    ...
    validator: validate_ListObjectParents_603786, base: "/",
    url: url_ListObjectParents_603787, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectPolicies_603804 = ref object of OpenApiRestCall_602466
proc url_ListObjectPolicies_603806(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectPolicies_603805(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603807 = query.getOrDefault("NextToken")
  valid_603807 = validateParameter(valid_603807, JString, required = false,
                                 default = nil)
  if valid_603807 != nil:
    section.add "NextToken", valid_603807
  var valid_603808 = query.getOrDefault("MaxResults")
  valid_603808 = validateParameter(valid_603808, JString, required = false,
                                 default = nil)
  if valid_603808 != nil:
    section.add "MaxResults", valid_603808
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_603815 = header.getOrDefault("x-amz-consistency-level")
  valid_603815 = validateParameter(valid_603815, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_603815 != nil:
    section.add "x-amz-consistency-level", valid_603815
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603817 = header.getOrDefault("x-amz-data-partition")
  valid_603817 = validateParameter(valid_603817, JString, required = true,
                                 default = nil)
  if valid_603817 != nil:
    section.add "x-amz-data-partition", valid_603817
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603819: Call_ListObjectPolicies_603804; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns policies attached to an object in pagination fashion.
  ## 
...
proc call*(call_603820: Call_ListObjectPolicies_603804; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectPolicies
  ## Returns policies attached to an object in pagination fashion.
  ##   NextToken: string
  ...
  var body_603822 = newJObject()
  add(query_603821, "NextToken", newJString(NextToken))
  if body != nil:
    body_603822 = body
  add(query_603821, "MaxResults", newJString(MaxResults))
  result = call_603820.call(nil, query_603821, nil, nil, body_603822)

var listObjectPolicies* = Call_ListObjectPolicies_603804(
    ...
    validator: validate_ListObjectPolicies_603805, base: "/",
    url: url_ListObjectPolicies_603806, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOutgoingTypedLinks_603823 = ref object of OpenApiRestCall_602466
proc url_ListOutgoingTypedLinks_603825(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListOutgoingTypedLinks_603824(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603833 = header.getOrDefault("x-amz-data-partition")
  valid_603833 = validateParameter(valid_603833, JString, required = true,
                                 default = nil)
  if valid_603833 != nil:
    section.add "x-amz-data-partition", valid_603833
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603835: Call_ListOutgoingTypedLinks_603823; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_603836: Call_ListOutgoingTypedLinks_603823; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_603837 = body
  result = call_603836.call(nil, nil, nil, nil, body_603837)

var listOutgoingTypedLinks* = Call_ListOutgoingTypedLinks_603823(
    ...
    validator: validate_ListOutgoingTypedLinks_603824, base: "/",
    url: url_ListOutgoingTypedLinks_603825, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPolicyAttachments_603838 = ref object of OpenApiRestCall_602466
proc url_ListPolicyAttachments_603840(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPolicyAttachments_603839(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603841 = query.getOrDefault("NextToken")
  valid_603841 = validateParameter(valid_603841, JString, required = false,
                                 default = nil)
  if valid_603841 != nil:
    section.add "NextToken", valid_603841
  var valid_603842 = query.getOrDefault("MaxResults")
  valid_603842 = validateParameter(valid_603842, JString, required = false,
                                 default = nil)
  if valid_603842 != nil:
    section.add "MaxResults", valid_603842
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_603849 = header.getOrDefault("x-amz-consistency-level")
  valid_603849 = validateParameter(valid_603849, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_603849 != nil:
    section.add "x-amz-consistency-level", valid_603849
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603851 = header.getOrDefault("x-amz-data-partition")
  valid_603851 = validateParameter(valid_603851, JString, required = true,
                                 default = nil)
  if valid_603851 != nil:
    section.add "x-amz-data-partition", valid_603851
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603853: Call_ListPolicyAttachments_603838; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns all of the <code>ObjectIdentifiers</code> to which a given policy is attached.
  ## 
...
proc call*(call_603854: Call_ListPolicyAttachments_603838; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listPolicyAttachments* = Call_ListPolicyAttachments_603838(
    ...
    validator: validate_ListPolicyAttachments_603839, base: "/",
    url: url_ListPolicyAttachments_603840, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPublishedSchemaArns_603857 = ref object of OpenApiRestCall_602466
proc url_ListPublishedSchemaArns_603859(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListPublishedSchemaArns_603858(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603870: Call_ListPublishedSchemaArns_603857; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the major version families of each published schema. If a major version ARN is provided as <code>SchemaArn</code>, the minor version revisions in that family are listed instead.
  ## 
...
proc call*(call_603871: Call_ListPublishedSchemaArns_603857; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listPublishedSchemaArns* = Call_ListPublishedSchemaArns_603857(
    name: "listPublishedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/published",
    validator: validate_ListPublishedSchemaArns_603858, base: "/",
    url: url_ListPublishedSchemaArns_603859, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_603874 = ref object of OpenApiRestCall_602466
proc url_ListTagsForResource_603876(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_603875(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603887: Call_ListTagsForResource_603874; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ## 
...
proc call*(call_603888: Call_ListTagsForResource_603874; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listTagsForResource
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ##   NextToken: string
  ...
  var body_603890 = newJObject()
  add(query_603889, "NextToken", newJString(NextToken))
  if body != nil:
    body_603890 = body
  add(query_603889, "MaxResults", newJString(MaxResults))
  result = call_603888.call(nil, query_603889, nil, nil, body_603890)

var listTagsForResource* = Call_ListTagsForResource_603874(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags",
    validator: validate_ListTagsForResource_603875, base: "/",
    url: url_ListTagsForResource_603876, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetAttributes_603891 = ref object of OpenApiRestCall_602466
proc url_ListTypedLinkFacetAttributes_603893(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetAttributes_603892(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603894 = query.getOrDefault("NextToken")
  valid_603894 = validateParameter(valid_603894, JString, required = false,
                                 default = nil)
  if valid_603894 != nil:
    section.add "NextToken", valid_603894
  var valid_603895 = query.getOrDefault("MaxResults")
  valid_603895 = validateParameter(valid_603895, JString, required = false,
                                 default = nil)
  if valid_603895 != nil:
    section.add "MaxResults", valid_603895
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603903 = header.getOrDefault("x-amz-data-partition")
  valid_603903 = validateParameter(valid_603903, JString, required = true,
                                 default = nil)
  if valid_603903 != nil:
    section.add "x-amz-data-partition", valid_603903
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603905: Call_ListTypedLinkFacetAttributes_603891; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of all attribute definitions for a particular <a>TypedLinkFacet</a>. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_603906: Call_ListTypedLinkFacetAttributes_603891; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_603907, "NextToken", newJString(NextToken))
  if body != nil:
    body_603908 = body
  add(query_603907, "MaxResults", newJString(MaxResults))
  result = call_603906.call(nil, query_603907, nil, nil, body_603908)

var listTypedLinkFacetAttributes* = Call_ListTypedLinkFacetAttributes_603891(
    ...
    validator: validate_ListTypedLinkFacetAttributes_603892, base: "/",
    url: url_ListTypedLinkFacetAttributes_603893,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetNames_603909 = ref object of OpenApiRestCall_602466
proc url_ListTypedLinkFacetNames_603911(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTypedLinkFacetNames_603910(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603912 = query.getOrDefault("NextToken")
  valid_603912 = validateParameter(valid_603912, JString, required = false,
                                 default = nil)
  if valid_603912 != nil:
    section.add "NextToken", valid_603912
  var valid_603913 = query.getOrDefault("MaxResults")
  valid_603913 = validateParameter(valid_603913, JString, required = false,
                                 default = nil)
  if valid_603913 != nil:
    section.add "MaxResults", valid_603913
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603921 = header.getOrDefault("x-amz-data-partition")
  valid_603921 = validateParameter(valid_603921, JString, required = true,
                                 default = nil)
  if valid_603921 != nil:
    section.add "x-amz-data-partition", valid_603921
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603923: Call_ListTypedLinkFacetNames_603909; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of <code>TypedLink</code> facet names for a particular schema. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_603924: Call_ListTypedLinkFacetNames_603909; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_603925, "NextToken", newJString(NextToken))
  if body != nil:
    body_603926 = body
  add(query_603925, "MaxResults", newJString(MaxResults))
  result = call_603924.call(nil, query_603925, nil, nil, body_603926)

var listTypedLinkFacetNames* = Call_ListTypedLinkFacetNames_603909(
    ...
    validator: validate_ListTypedLinkFacetNames_603910, base: "/",
    url: url_ListTypedLinkFacetNames_603911, schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupPolicy_603927 = ref object of OpenApiRestCall_602466
proc url_LookupPolicy_603929(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LookupPolicy_603928(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_603930 = query.getOrDefault("NextToken")
  valid_603930 = validateParameter(valid_603930, JString, required = false,
                                 default = nil)
  if valid_603930 != nil:
    section.add "NextToken", valid_603930
  var valid_603931 = query.getOrDefault("MaxResults")
  valid_603931 = validateParameter(valid_603931, JString, required = false,
                                 default = nil)
  if valid_603931 != nil:
    section.add "MaxResults", valid_603931
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603939 = header.getOrDefault("x-amz-data-partition")
  valid_603939 = validateParameter(valid_603939, JString, required = true,
                                 default = nil)
  if valid_603939 != nil:
    section.add "x-amz-data-partition", valid_603939
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603941: Call_LookupPolicy_603927; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies">Policies</a>.
  ## 
...
proc call*(call_603942: Call_LookupPolicy_603927; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## lookupPolicy
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies">Policies</a>.
  ##   NextToken: string
  ...
  add(query_603943, "NextToken", newJString(NextToken))
  if body != nil:
    body_603944 = body
  add(query_603943, "MaxResults", newJString(MaxResults))
  result = call_603942.call(nil, query_603943, nil, nil, body_603944)

var lookupPolicy* = Call_LookupPolicy_603927(name: "lookupPolicy",
    ...
    validator: validate_LookupPolicy_603928, base: "/", url: url_LookupPolicy_603929,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishSchema_603945 = ref object of OpenApiRestCall_602466
proc url_PublishSchema_603947(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishSchema_603946(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603955 = header.getOrDefault("x-amz-data-partition")
  valid_603955 = validateParameter(valid_603955, JString, required = true,
                                 default = nil)
  if valid_603955 != nil:
    section.add "x-amz-data-partition", valid_603955
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603957: Call_PublishSchema_603945; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Publishes a development schema with a major version and a recommended minor version.
  ## 
...
proc call*(call_603958: Call_PublishSchema_603945; body: JsonNode): Recallable =
  ## publishSchema
  ## Publishes a development schema with a major version and a recommended minor version.
  ##   body: JObject (required)
  var body_603959 = newJObject()
  if body != nil:
    body_603959 = body
  result = call_603958.call(nil, nil, nil, nil, body_603959)

var publishSchema* = Call_PublishSchema_603945(name: "publishSchema",
    ...
    validator: validate_PublishSchema_603946, base: "/", url: url_PublishSchema_603947,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveFacetFromObject_603960 = ref object of OpenApiRestCall_602466
proc url_RemoveFacetFromObject_603962(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveFacetFromObject_603961(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_603970 = header.getOrDefault("x-amz-data-partition")
  valid_603970 = validateParameter(valid_603970, JString, required = true,
                                 default = nil)
  if valid_603970 != nil:
    section.add "x-amz-data-partition", valid_603970
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_603972: Call_RemoveFacetFromObject_603960; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the specified facet from the specified object.
  ## 
...
proc call*(call_603973: Call_RemoveFacetFromObject_603960; body: JsonNode): Recallable =
  ## removeFacetFromObject
  ## Removes the specified facet from the specified object.
  ##   body: JObject (required)
  var body_603974 = newJObject()
  if body != nil:
    body_603974 = body
  result = call_603973.call(nil, nil, nil, nil, body_603974)

var removeFacetFromObject* = Call_RemoveFacetFromObject_603960(
    ...
    validator: validate_RemoveFacetFromObject_603961, base: "/",
    url: url_RemoveFacetFromObject_603962, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_603975 = ref object of OpenApiRestCall_602466
proc url_TagResource_603977(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_603976(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603986: Call_TagResource_603975; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## An API operation for adding tags to a resource.
  ## 
  ...
  let url = call_603986.url(scheme.get, call_603986.host, call_603986.base,
                         ...
                         valid.getOrDefault("query"))
  result = hook(call_603986, url, valid)

proc call*(call_603987: Call_TagResource_603975; body: JsonNode): Recallable =
  ## tagResource
  ## An API operation for adding tags to a resource.
  ##   body: JObject (required)
  var body_603988 = newJObject()
  if body != nil:
    body_603988 = body
  result = call_603987.call(nil, nil, nil, nil, body_603988)

var tagResource* = Call_TagResource_603975(name: "tagResource",
                                        meth: HttpMethod.HttpPut,
                                        host: "clouddirectory.amazonaws.com", route: "/amazonclouddirectory/2017-01-11/tags/add",
                                        validator: validate_TagResource_603976,
                                        base: "/", url: url_TagResource_603977,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_603989 = ref object of OpenApiRestCall_602466
proc url_UntagResource_603991(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_603990(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_604000: Call_UntagResource_603989; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## An API operation for removing tags from a resource.
  ## 
...
proc call*(call_604001: Call_UntagResource_603989; body: JsonNode): Recallable =
  ## untagResource
  ## An API operation for removing tags from a resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_603989(name: "untagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/remove",
    validator: validate_UntagResource_603990, base: "/", url: url_UntagResource_603991,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateLinkAttributes_604003 = ref object of OpenApiRestCall_602466
proc url_UpdateLinkAttributes_604005(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateLinkAttributes_604004(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_604013 = header.getOrDefault("x-amz-data-partition")
  valid_604013 = validateParameter(valid_604013, JString, required = true,
                                 default = nil)
  if valid_604013 != nil:
    section.add "x-amz-data-partition", valid_604013
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_604015: Call_UpdateLinkAttributes_604003; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a given typed link’s attributes. Attributes to be updated must not contribute to the typed link’s identity, as defined by its <code>IdentityAttributeOrder</code>.
  ## 
...
proc call*(call_604016: Call_UpdateLinkAttributes_604003; body: JsonNode): Recallable =
...
var updateLinkAttributes* = Call_UpdateLinkAttributes_604003(
    ...
    validator: validate_UpdateLinkAttributes_604004, base: "/",
    url: url_UpdateLinkAttributes_604005, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateObjectAttributes_604018 = ref object of OpenApiRestCall_602466
proc url_UpdateObjectAttributes_604020(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateObjectAttributes_604019(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_604028 = header.getOrDefault("x-amz-data-partition")
  valid_604028 = validateParameter(valid_604028, JString, required = true,
                                 default = nil)
  if valid_604028 != nil:
    section.add "x-amz-data-partition", valid_604028
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_604030: Call_UpdateObjectAttributes_604018; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a given object's attributes.
  ## 
...
proc call*(call_604031: Call_UpdateObjectAttributes_604018; body: JsonNode): Recallable =
...
var updateObjectAttributes* = Call_UpdateObjectAttributes_604018(
    ...
    validator: validate_UpdateObjectAttributes_604019, base: "/",
    url: url_UpdateObjectAttributes_604020, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSchema_604033 = ref object of OpenApiRestCall_602466
proc url_UpdateSchema_604035(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSchema_604034(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_604043 = header.getOrDefault("x-amz-data-partition")
  valid_604043 = validateParameter(valid_604043, JString, required = true,
                                 default = nil)
  if valid_604043 != nil:
    section.add "x-amz-data-partition", valid_604043
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_604045: Call_UpdateSchema_604033; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ## 
...
proc call*(call_604046: Call_UpdateSchema_604033; body: JsonNode): Recallable =
  ## updateSchema
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ##   body: JObject (required)
...
var updateSchema* = Call_UpdateSchema_604033(name: "updateSchema",
    ...
    validator: validate_UpdateSchema_604034, base: "/", url: url_UpdateSchema_604035,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTypedLinkFacet_604048 = ref object of OpenApiRestCall_602466
proc url_UpdateTypedLinkFacet_604050(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTypedLinkFacet_604049(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_604058 = header.getOrDefault("x-amz-data-partition")
  valid_604058 = validateParameter(valid_604058, JString, required = true,
                                 default = nil)
  if valid_604058 != nil:
    section.add "x-amz-data-partition", valid_604058
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_604060: Call_UpdateTypedLinkFacet_604048; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_604061: Call_UpdateTypedLinkFacet_604048; body: JsonNode): Recallable =
...
var updateTypedLinkFacet* = Call_UpdateTypedLinkFacet_604048(
    ...
    validator: validate_UpdateTypedLinkFacet_604049, base: "/",
    url: url_UpdateTypedLinkFacet_604050, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradeAppliedSchema_604063 = ref object of OpenApiRestCall_602466
proc url_UpgradeAppliedSchema_604065(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradeAppliedSchema_604064(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_604074: Call_UpgradeAppliedSchema_604063; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Upgrades a single directory in-place using the <code>PublishedSchemaArn</code> with schema updates found in <code>MinorVersion</code>. Backwards-compatible minor version upgrades are instantaneously available for readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one schema on a given directory per call. To upgrade multiple directories from one schema, you would need to call this API on each directory.
  ## 
...
proc call*(call_604075: Call_UpgradeAppliedSchema_604063; body: JsonNode): Recallable =
...
var upgradeAppliedSchema* = Call_UpgradeAppliedSchema_604063(
    name: "upgradeAppliedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradeapplied",
    validator: validate_UpgradeAppliedSchema_604064, base: "/",
    url: url_UpgradeAppliedSchema_604065, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradePublishedSchema_604077 = ref object of OpenApiRestCall_602466
proc url_UpgradePublishedSchema_604079(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradePublishedSchema_604078(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_604088: Call_UpgradePublishedSchema_604077; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.
  ## 
...
proc call*(call_604089: Call_UpgradePublishedSchema_604077; body: JsonNode): Recallable =
...
var upgradePublishedSchema* = Call_UpgradePublishedSchema_604077(
    name: "upgradePublishedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradepublished",
    validator: validate_UpgradePublishedSchema_604078, base: "/",
    url: url_UpgradePublishedSchema_604079, schemes: {Scheme.Https, Scheme.Http})
export
  rest
