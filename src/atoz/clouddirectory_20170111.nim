...
var listIndex* = Call_ListIndex_593593(name: "listIndex", meth: HttpMethod.HttpPost,
                                    ...
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListManagedSchemaArns_593612 = ref object of OpenApiRestCall_592364
proc url_ListManagedSchemaArns_593614(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListManagedSchemaArns_593613(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593625: Call_ListManagedSchemaArns_593612; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the major version families of each managed schema. If a major version ARN is provided as SchemaArn, the minor version revisions in that family are listed instead.
  ## 
...
proc call*(call_593626: Call_ListManagedSchemaArns_593612; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  var body_593628 = newJObject()
  add(query_593627, "MaxResults", newJString(MaxResults))
  add(query_593627, "NextToken", newJString(NextToken))
  if body != nil:
    body_593628 = body
  result = call_593626.call(nil, query_593627, nil, nil, body_593628)

var listManagedSchemaArns* = Call_ListManagedSchemaArns_593612(
    name: "listManagedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/managed",
    validator: validate_ListManagedSchemaArns_593613, base: "/",
    url: url_ListManagedSchemaArns_593614, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectAttributes_593629 = ref object of OpenApiRestCall_592364
proc url_ListObjectAttributes_593631(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectAttributes_593630(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593632 = query.getOrDefault("MaxResults")
  valid_593632 = validateParameter(valid_593632, JString, required = false,
                                 default = nil)
  if valid_593632 != nil:
    section.add "MaxResults", valid_593632
  var valid_593633 = query.getOrDefault("NextToken")
  valid_593633 = validateParameter(valid_593633, JString, required = false,
                                 default = nil)
  if valid_593633 != nil:
    section.add "NextToken", valid_593633
  result.add "query", section
  ## parameters in `header` object:
  ##   x-amz-consistency-level: JString
  ##                          : Represents the manner and timing in which the successful write or update of an object is reflected in a subsequent read operation of that same object.
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593634 = header.getOrDefault("x-amz-consistency-level")
  valid_593634 = validateParameter(valid_593634, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_593634 != nil:
    section.add "x-amz-consistency-level", valid_593634
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593640 = header.getOrDefault("x-amz-data-partition")
  valid_593640 = validateParameter(valid_593640, JString, required = true,
                                 default = nil)
  if valid_593640 != nil:
    section.add "x-amz-data-partition", valid_593640
...
proc call*(call_593644: Call_ListObjectAttributes_593629; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all attributes that are associated with an object. 
  ## 
...
proc call*(call_593645: Call_ListObjectAttributes_593629; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  add(query_593646, "MaxResults", newJString(MaxResults))
  add(query_593646, "NextToken", newJString(NextToken))
  if body != nil:
    body_593647 = body
  result = call_593645.call(nil, query_593646, nil, nil, body_593647)

var listObjectAttributes* = Call_ListObjectAttributes_593629(
    ...
    validator: validate_ListObjectAttributes_593630, base: "/",
    url: url_ListObjectAttributes_593631, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectChildren_593648 = ref object of OpenApiRestCall_592364
proc url_ListObjectChildren_593650(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectChildren_593649(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593651 = query.getOrDefault("MaxResults")
  valid_593651 = validateParameter(valid_593651, JString, required = false,
                                 default = nil)
  if valid_593651 != nil:
    section.add "MaxResults", valid_593651
  var valid_593652 = query.getOrDefault("NextToken")
  valid_593652 = validateParameter(valid_593652, JString, required = false,
                                 default = nil)
  if valid_593652 != nil:
    section.add "NextToken", valid_593652
  result.add "query", section
  ## parameters in `header` object:
  ##   x-amz-consistency-level: JString
  ##                          : Represents the manner and timing in which the successful write or update of an object is reflected in a subsequent read operation of that same object.
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593653 = header.getOrDefault("x-amz-consistency-level")
  valid_593653 = validateParameter(valid_593653, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_593653 != nil:
    section.add "x-amz-consistency-level", valid_593653
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593659 = header.getOrDefault("x-amz-data-partition")
  valid_593659 = validateParameter(valid_593659, JString, required = true,
                                 default = nil)
  if valid_593659 != nil:
    section.add "x-amz-data-partition", valid_593659
...
proc call*(call_593663: Call_ListObjectChildren_593648; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of child objects that are associated with a given object.
  ## 
...
proc call*(call_593664: Call_ListObjectChildren_593648; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectChildren
  ## Returns a paginated list of child objects that are associated with a given object.
  ##   MaxResults: string
  ...
  ##            : Pagination token
  ##   body: JObject (required)
  var query_593665 = newJObject()
  var body_593666 = newJObject()
  add(query_593665, "MaxResults", newJString(MaxResults))
  add(query_593665, "NextToken", newJString(NextToken))
  if body != nil:
    body_593666 = body
  result = call_593664.call(nil, query_593665, nil, nil, body_593666)

var listObjectChildren* = Call_ListObjectChildren_593648(
    ...
    validator: validate_ListObjectChildren_593649, base: "/",
    url: url_ListObjectChildren_593650, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParentPaths_593667 = ref object of OpenApiRestCall_592364
proc url_ListObjectParentPaths_593669(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParentPaths_593668(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593670 = query.getOrDefault("MaxResults")
  valid_593670 = validateParameter(valid_593670, JString, required = false,
                                 default = nil)
  if valid_593670 != nil:
    section.add "MaxResults", valid_593670
  var valid_593671 = query.getOrDefault("NextToken")
  valid_593671 = validateParameter(valid_593671, JString, required = false,
                                 default = nil)
  if valid_593671 != nil:
    section.add "NextToken", valid_593671
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593677 = header.getOrDefault("x-amz-data-partition")
  valid_593677 = validateParameter(valid_593677, JString, required = true,
                                 default = nil)
  if valid_593677 != nil:
    section.add "x-amz-data-partition", valid_593677
...
proc call*(call_593681: Call_ListObjectParentPaths_593667; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves all available parent paths for any object type such as node, leaf node, policy node, and index node objects. For more information about objects, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directorystructure.html">Directory Structure</a>.</p> <p>Use this API to evaluate all parents for an object. The call returns all objects from the root of the directory up to the requested object. The API returns the number of paths based on user-defined <code>MaxResults</code>, in case there are multiple paths to the parent. The order of the paths and nodes returned is consistent among multiple API calls unless the objects are deleted or moved. Paths not leading to the directory root are ignored from the target object.</p>
  ## 
...
proc call*(call_593682: Call_ListObjectParentPaths_593667; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  add(query_593683, "MaxResults", newJString(MaxResults))
  add(query_593683, "NextToken", newJString(NextToken))
  if body != nil:
    body_593684 = body
  result = call_593682.call(nil, query_593683, nil, nil, body_593684)

var listObjectParentPaths* = Call_ListObjectParentPaths_593667(
    ...
    validator: validate_ListObjectParentPaths_593668, base: "/",
    url: url_ListObjectParentPaths_593669, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParents_593685 = ref object of OpenApiRestCall_592364
proc url_ListObjectParents_593687(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParents_593686(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593688 = query.getOrDefault("MaxResults")
  valid_593688 = validateParameter(valid_593688, JString, required = false,
                                 default = nil)
  if valid_593688 != nil:
    section.add "MaxResults", valid_593688
  var valid_593689 = query.getOrDefault("NextToken")
  valid_593689 = validateParameter(valid_593689, JString, required = false,
                                 default = nil)
  if valid_593689 != nil:
    section.add "NextToken", valid_593689
  result.add "query", section
  ## parameters in `header` object:
  ##   x-amz-consistency-level: JString
  ##                          : Represents the manner and timing in which the successful write or update of an object is reflected in a subsequent read operation of that same object.
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593690 = header.getOrDefault("x-amz-consistency-level")
  valid_593690 = validateParameter(valid_593690, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_593690 != nil:
    section.add "x-amz-consistency-level", valid_593690
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593696 = header.getOrDefault("x-amz-data-partition")
  valid_593696 = validateParameter(valid_593696, JString, required = true,
                                 default = nil)
  if valid_593696 != nil:
    section.add "x-amz-data-partition", valid_593696
...
proc call*(call_593700: Call_ListObjectParents_593685; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ## 
...
proc call*(call_593701: Call_ListObjectParents_593685; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectParents
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ##   MaxResults: string
  ...
  ##            : Pagination token
  ##   body: JObject (required)
  var query_593702 = newJObject()
  var body_593703 = newJObject()
  add(query_593702, "MaxResults", newJString(MaxResults))
  add(query_593702, "NextToken", newJString(NextToken))
  if body != nil:
    body_593703 = body
  result = call_593701.call(nil, query_593702, nil, nil, body_593703)

var listObjectParents* = Call_ListObjectParents_593685(name: "listObjectParents",
    ...
    validator: validate_ListObjectParents_593686, base: "/",
    url: url_ListObjectParents_593687, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectPolicies_593704 = ref object of OpenApiRestCall_592364
proc url_ListObjectPolicies_593706(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectPolicies_593705(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593707 = query.getOrDefault("MaxResults")
  valid_593707 = validateParameter(valid_593707, JString, required = false,
                                 default = nil)
  if valid_593707 != nil:
    section.add "MaxResults", valid_593707
  var valid_593708 = query.getOrDefault("NextToken")
  valid_593708 = validateParameter(valid_593708, JString, required = false,
                                 default = nil)
  if valid_593708 != nil:
    section.add "NextToken", valid_593708
  result.add "query", section
  ## parameters in `header` object:
  ##   x-amz-consistency-level: JString
  ##                          : Represents the manner and timing in which the successful write or update of an object is reflected in a subsequent read operation of that same object.
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593709 = header.getOrDefault("x-amz-consistency-level")
  valid_593709 = validateParameter(valid_593709, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_593709 != nil:
    section.add "x-amz-consistency-level", valid_593709
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593715 = header.getOrDefault("x-amz-data-partition")
  valid_593715 = validateParameter(valid_593715, JString, required = true,
                                 default = nil)
  if valid_593715 != nil:
    section.add "x-amz-data-partition", valid_593715
...
proc call*(call_593719: Call_ListObjectPolicies_593704; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns policies attached to an object in pagination fashion.
  ## 
...
proc call*(call_593720: Call_ListObjectPolicies_593704; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectPolicies
  ## Returns policies attached to an object in pagination fashion.
  ##   MaxResults: string
  ...
  ##            : Pagination token
  ##   body: JObject (required)
  var query_593721 = newJObject()
  var body_593722 = newJObject()
  add(query_593721, "MaxResults", newJString(MaxResults))
  add(query_593721, "NextToken", newJString(NextToken))
  if body != nil:
    body_593722 = body
  result = call_593720.call(nil, query_593721, nil, nil, body_593722)

var listObjectPolicies* = Call_ListObjectPolicies_593704(
    ...
    validator: validate_ListObjectPolicies_593705, base: "/",
    url: url_ListObjectPolicies_593706, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOutgoingTypedLinks_593723 = ref object of OpenApiRestCall_592364
proc url_ListOutgoingTypedLinks_593725(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListOutgoingTypedLinks_593724(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593731 = header.getOrDefault("x-amz-data-partition")
  valid_593731 = validateParameter(valid_593731, JString, required = true,
                                 default = nil)
  if valid_593731 != nil:
    section.add "x-amz-data-partition", valid_593731
...
proc call*(call_593735: Call_ListOutgoingTypedLinks_593723; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_593736: Call_ListOutgoingTypedLinks_593723; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_593737 = body
  result = call_593736.call(nil, nil, nil, nil, body_593737)

var listOutgoingTypedLinks* = Call_ListOutgoingTypedLinks_593723(
    ...
    validator: validate_ListOutgoingTypedLinks_593724, base: "/",
    url: url_ListOutgoingTypedLinks_593725, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPolicyAttachments_593738 = ref object of OpenApiRestCall_592364
proc url_ListPolicyAttachments_593740(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPolicyAttachments_593739(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593741 = query.getOrDefault("MaxResults")
  valid_593741 = validateParameter(valid_593741, JString, required = false,
                                 default = nil)
  if valid_593741 != nil:
    section.add "MaxResults", valid_593741
  var valid_593742 = query.getOrDefault("NextToken")
  valid_593742 = validateParameter(valid_593742, JString, required = false,
                                 default = nil)
  if valid_593742 != nil:
    section.add "NextToken", valid_593742
  result.add "query", section
  ## parameters in `header` object:
  ##   x-amz-consistency-level: JString
  ##                          : Represents the manner and timing in which the successful write or update of an object is reflected in a subsequent read operation of that same object.
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593743 = header.getOrDefault("x-amz-consistency-level")
  valid_593743 = validateParameter(valid_593743, JString, required = false,
                                 default = newJString("SERIALIZABLE"))
  if valid_593743 != nil:
    section.add "x-amz-consistency-level", valid_593743
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593749 = header.getOrDefault("x-amz-data-partition")
  valid_593749 = validateParameter(valid_593749, JString, required = true,
                                 default = nil)
  if valid_593749 != nil:
    section.add "x-amz-data-partition", valid_593749
...
proc call*(call_593753: Call_ListPolicyAttachments_593738; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns all of the <code>ObjectIdentifiers</code> to which a given policy is attached.
  ## 
...
proc call*(call_593754: Call_ListPolicyAttachments_593738; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
...
var listPolicyAttachments* = Call_ListPolicyAttachments_593738(
    ...
    validator: validate_ListPolicyAttachments_593739, base: "/",
    url: url_ListPolicyAttachments_593740, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPublishedSchemaArns_593757 = ref object of OpenApiRestCall_592364
proc url_ListPublishedSchemaArns_593759(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListPublishedSchemaArns_593758(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593770: Call_ListPublishedSchemaArns_593757; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the major version families of each published schema. If a major version ARN is provided as <code>SchemaArn</code>, the minor version revisions in that family are listed instead.
  ## 
...
proc call*(call_593771: Call_ListPublishedSchemaArns_593757; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
...
var listPublishedSchemaArns* = Call_ListPublishedSchemaArns_593757(
    name: "listPublishedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/published",
    validator: validate_ListPublishedSchemaArns_593758, base: "/",
    url: url_ListPublishedSchemaArns_593759, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_593774 = ref object of OpenApiRestCall_592364
proc url_ListTagsForResource_593776(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_593775(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593787: Call_ListTagsForResource_593774; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ## 
...
proc call*(call_593788: Call_ListTagsForResource_593774; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listTagsForResource
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ##   MaxResults: string
  ...
  ##            : Pagination token
  ##   body: JObject (required)
  var query_593789 = newJObject()
  var body_593790 = newJObject()
  add(query_593789, "MaxResults", newJString(MaxResults))
  add(query_593789, "NextToken", newJString(NextToken))
  if body != nil:
    body_593790 = body
  result = call_593788.call(nil, query_593789, nil, nil, body_593790)

var listTagsForResource* = Call_ListTagsForResource_593774(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags",
    validator: validate_ListTagsForResource_593775, base: "/",
    url: url_ListTagsForResource_593776, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetAttributes_593791 = ref object of OpenApiRestCall_592364
proc url_ListTypedLinkFacetAttributes_593793(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetAttributes_593792(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593794 = query.getOrDefault("MaxResults")
  valid_593794 = validateParameter(valid_593794, JString, required = false,
                                 default = nil)
  if valid_593794 != nil:
    section.add "MaxResults", valid_593794
  var valid_593795 = query.getOrDefault("NextToken")
  valid_593795 = validateParameter(valid_593795, JString, required = false,
                                 default = nil)
  if valid_593795 != nil:
    section.add "NextToken", valid_593795
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593801 = header.getOrDefault("x-amz-data-partition")
  valid_593801 = validateParameter(valid_593801, JString, required = true,
                                 default = nil)
  if valid_593801 != nil:
    section.add "x-amz-data-partition", valid_593801
...
proc call*(call_593805: Call_ListTypedLinkFacetAttributes_593791; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of all attribute definitions for a particular <a>TypedLinkFacet</a>. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_593806: Call_ListTypedLinkFacetAttributes_593791; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  var body_593808 = newJObject()
  add(query_593807, "MaxResults", newJString(MaxResults))
  add(query_593807, "NextToken", newJString(NextToken))
  if body != nil:
    body_593808 = body
  result = call_593806.call(nil, query_593807, nil, nil, body_593808)

var listTypedLinkFacetAttributes* = Call_ListTypedLinkFacetAttributes_593791(
    ...
    validator: validate_ListTypedLinkFacetAttributes_593792, base: "/",
    url: url_ListTypedLinkFacetAttributes_593793,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetNames_593809 = ref object of OpenApiRestCall_592364
proc url_ListTypedLinkFacetNames_593811(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTypedLinkFacetNames_593810(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593812 = query.getOrDefault("MaxResults")
  valid_593812 = validateParameter(valid_593812, JString, required = false,
                                 default = nil)
  if valid_593812 != nil:
    section.add "MaxResults", valid_593812
  var valid_593813 = query.getOrDefault("NextToken")
  valid_593813 = validateParameter(valid_593813, JString, required = false,
                                 default = nil)
  if valid_593813 != nil:
    section.add "NextToken", valid_593813
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593814 = header.getOrDefault("X-Amz-Signature")
  valid_593814 = validateParameter(valid_593814, JString, required = false,
                                 default = nil)
  if valid_593814 != nil:
    section.add "X-Amz-Signature", valid_593814
  var valid_593815 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_593815 = validateParameter(valid_593815, JString, required = false,
                                 default = nil)
  if valid_593815 != nil:
    section.add "X-Amz-Content-Sha256", valid_593815
  var valid_593816 = header.getOrDefault("X-Amz-Date")
  valid_593816 = validateParameter(valid_593816, JString, required = false,
                                 default = nil)
  if valid_593816 != nil:
    section.add "X-Amz-Date", valid_593816
  var valid_593817 = header.getOrDefault("X-Amz-Credential")
  valid_593817 = validateParameter(valid_593817, JString, required = false,
                                 default = nil)
  if valid_593817 != nil:
    section.add "X-Amz-Credential", valid_593817
  var valid_593818 = header.getOrDefault("X-Amz-Security-Token")
  valid_593818 = validateParameter(valid_593818, JString, required = false,
                                 default = nil)
  if valid_593818 != nil:
    section.add "X-Amz-Security-Token", valid_593818
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593819 = header.getOrDefault("x-amz-data-partition")
  valid_593819 = validateParameter(valid_593819, JString, required = true,
                                 default = nil)
  if valid_593819 != nil:
    section.add "x-amz-data-partition", valid_593819
...
proc call*(call_593823: Call_ListTypedLinkFacetNames_593809; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of <code>TypedLink</code> facet names for a particular schema. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_593824: Call_ListTypedLinkFacetNames_593809; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  add(query_593825, "MaxResults", newJString(MaxResults))
  add(query_593825, "NextToken", newJString(NextToken))
  if body != nil:
    body_593826 = body
  result = call_593824.call(nil, query_593825, nil, nil, body_593826)

var listTypedLinkFacetNames* = Call_ListTypedLinkFacetNames_593809(
    ...
    validator: validate_ListTypedLinkFacetNames_593810, base: "/",
    url: url_ListTypedLinkFacetNames_593811, schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupPolicy_593827 = ref object of OpenApiRestCall_592364
proc url_LookupPolicy_593829(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LookupPolicy_593828(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_593830 = query.getOrDefault("MaxResults")
  valid_593830 = validateParameter(valid_593830, JString, required = false,
                                 default = nil)
  if valid_593830 != nil:
    section.add "MaxResults", valid_593830
  var valid_593831 = query.getOrDefault("NextToken")
  valid_593831 = validateParameter(valid_593831, JString, required = false,
                                 default = nil)
  if valid_593831 != nil:
    section.add "NextToken", valid_593831
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593837 = header.getOrDefault("x-amz-data-partition")
  valid_593837 = validateParameter(valid_593837, JString, required = true,
                                 default = nil)
  if valid_593837 != nil:
    section.add "x-amz-data-partition", valid_593837
...
proc call*(call_593841: Call_LookupPolicy_593827; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies">Policies</a>.
  ## 
...
proc call*(call_593842: Call_LookupPolicy_593827; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## lookupPolicy
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies">Policies</a>.
  ##   MaxResults: string
  ...
  var body_593844 = newJObject()
  add(query_593843, "MaxResults", newJString(MaxResults))
  add(query_593843, "NextToken", newJString(NextToken))
  if body != nil:
    body_593844 = body
  result = call_593842.call(nil, query_593843, nil, nil, body_593844)

var lookupPolicy* = Call_LookupPolicy_593827(name: "lookupPolicy",
    ...
    validator: validate_LookupPolicy_593828, base: "/", url: url_LookupPolicy_593829,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishSchema_593845 = ref object of OpenApiRestCall_592364
proc url_PublishSchema_593847(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishSchema_593846(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593853 = header.getOrDefault("x-amz-data-partition")
  valid_593853 = validateParameter(valid_593853, JString, required = true,
                                 default = nil)
  if valid_593853 != nil:
    section.add "x-amz-data-partition", valid_593853
...
proc call*(call_593857: Call_PublishSchema_593845; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Publishes a development schema with a major version and a recommended minor version.
  ## 
...
proc call*(call_593858: Call_PublishSchema_593845; body: JsonNode): Recallable =
  ## publishSchema
  ## Publishes a development schema with a major version and a recommended minor version.
  ##   body: JObject (required)
  var body_593859 = newJObject()
  if body != nil:
    body_593859 = body
  result = call_593858.call(nil, nil, nil, nil, body_593859)

var publishSchema* = Call_PublishSchema_593845(name: "publishSchema",
    ...
    validator: validate_PublishSchema_593846, base: "/", url: url_PublishSchema_593847,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveFacetFromObject_593860 = ref object of OpenApiRestCall_592364
proc url_RemoveFacetFromObject_593862(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveFacetFromObject_593861(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593868 = header.getOrDefault("x-amz-data-partition")
  valid_593868 = validateParameter(valid_593868, JString, required = true,
                                 default = nil)
  if valid_593868 != nil:
    section.add "x-amz-data-partition", valid_593868
  var valid_593869 = header.getOrDefault("X-Amz-Algorithm")
  valid_593869 = validateParameter(valid_593869, JString, required = false,
                                 default = nil)
  if valid_593869 != nil:
    section.add "X-Amz-Algorithm", valid_593869
  var valid_593870 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_593870 = validateParameter(valid_593870, JString, required = false,
                                 default = nil)
  if valid_593870 != nil:
    section.add "X-Amz-SignedHeaders", valid_593870
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_593872: Call_RemoveFacetFromObject_593860; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the specified facet from the specified object.
  ## 
...
proc call*(call_593873: Call_RemoveFacetFromObject_593860; body: JsonNode): Recallable =
  ## removeFacetFromObject
  ## Removes the specified facet from the specified object.
  ##   body: JObject (required)
  var body_593874 = newJObject()
  if body != nil:
    body_593874 = body
  result = call_593873.call(nil, nil, nil, nil, body_593874)

var removeFacetFromObject* = Call_RemoveFacetFromObject_593860(
    ...
    validator: validate_RemoveFacetFromObject_593861, base: "/",
    url: url_RemoveFacetFromObject_593862, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_593875 = ref object of OpenApiRestCall_592364
proc url_TagResource_593877(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_593876(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593880 = header.getOrDefault("X-Amz-Date")
  valid_593880 = validateParameter(valid_593880, JString, required = false,
                                 default = nil)
  if valid_593880 != nil:
    section.add "X-Amz-Date", valid_593880
  ...
  var valid_593882 = header.getOrDefault("X-Amz-Security-Token")
  valid_593882 = validateParameter(valid_593882, JString, required = false,
                                 default = nil)
  if valid_593882 != nil:
    section.add "X-Amz-Security-Token", valid_593882
  var valid_593883 = header.getOrDefault("X-Amz-Algorithm")
  valid_593883 = validateParameter(valid_593883, JString, required = false,
                                 default = nil)
  if valid_593883 != nil:
    section.add "X-Amz-Algorithm", valid_593883
...
proc call*(call_593886: Call_TagResource_593875; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## An API operation for adding tags to a resource.
  ## 
...
proc call*(call_593887: Call_TagResource_593875; body: JsonNode): Recallable =
  ## tagResource
  ## An API operation for adding tags to a resource.
  ##   body: JObject (required)
  var body_593888 = newJObject()
  if body != nil:
    body_593888 = body
  result = call_593887.call(nil, nil, nil, nil, body_593888)

var tagResource* = Call_TagResource_593875(name: "tagResource",
                                        meth: HttpMethod.HttpPut,
                                        host: "clouddirectory.amazonaws.com", route: "/amazonclouddirectory/2017-01-11/tags/add",
                                        validator: validate_TagResource_593876,
                                        base: "/", url: url_TagResource_593877,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_593889 = ref object of OpenApiRestCall_592364
proc url_UntagResource_593891(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_593890(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593900: Call_UntagResource_593889; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## An API operation for removing tags from a resource.
  ## 
...
proc call*(call_593901: Call_UntagResource_593889; body: JsonNode): Recallable =
  ## untagResource
  ## An API operation for removing tags from a resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_593889(name: "untagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/remove",
    validator: validate_UntagResource_593890, base: "/", url: url_UntagResource_593891,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateLinkAttributes_593903 = ref object of OpenApiRestCall_592364
proc url_UpdateLinkAttributes_593905(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateLinkAttributes_593904(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593911 = header.getOrDefault("x-amz-data-partition")
  valid_593911 = validateParameter(valid_593911, JString, required = true,
                                 default = nil)
  if valid_593911 != nil:
    section.add "x-amz-data-partition", valid_593911
...
proc call*(call_593915: Call_UpdateLinkAttributes_593903; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a given typed link’s attributes. Attributes to be updated must not contribute to the typed link’s identity, as defined by its <code>IdentityAttributeOrder</code>.
  ## 
...
proc call*(call_593916: Call_UpdateLinkAttributes_593903; body: JsonNode): Recallable =
...
var updateLinkAttributes* = Call_UpdateLinkAttributes_593903(
    ...
    validator: validate_UpdateLinkAttributes_593904, base: "/",
    url: url_UpdateLinkAttributes_593905, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateObjectAttributes_593918 = ref object of OpenApiRestCall_592364
proc url_UpdateObjectAttributes_593920(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateObjectAttributes_593919(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593926 = header.getOrDefault("x-amz-data-partition")
  valid_593926 = validateParameter(valid_593926, JString, required = true,
                                 default = nil)
  if valid_593926 != nil:
    section.add "x-amz-data-partition", valid_593926
...
proc call*(call_593930: Call_UpdateObjectAttributes_593918; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a given object's attributes.
  ## 
...
proc call*(call_593931: Call_UpdateObjectAttributes_593918; body: JsonNode): Recallable =
...
var updateObjectAttributes* = Call_UpdateObjectAttributes_593918(
    ...
    validator: validate_UpdateObjectAttributes_593919, base: "/",
    url: url_UpdateObjectAttributes_593920, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSchema_593933 = ref object of OpenApiRestCall_592364
proc url_UpdateSchema_593935(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSchema_593934(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593941 = header.getOrDefault("x-amz-data-partition")
  valid_593941 = validateParameter(valid_593941, JString, required = true,
                                 default = nil)
  if valid_593941 != nil:
    section.add "x-amz-data-partition", valid_593941
...
proc call*(call_593945: Call_UpdateSchema_593933; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ## 
...
proc call*(call_593946: Call_UpdateSchema_593933; body: JsonNode): Recallable =
  ## updateSchema
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ##   body: JObject (required)
...
var updateSchema* = Call_UpdateSchema_593933(name: "updateSchema",
    ...
    validator: validate_UpdateSchema_593934, base: "/", url: url_UpdateSchema_593935,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTypedLinkFacet_593948 = ref object of OpenApiRestCall_592364
proc url_UpdateTypedLinkFacet_593950(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTypedLinkFacet_593949(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_593956 = header.getOrDefault("x-amz-data-partition")
  valid_593956 = validateParameter(valid_593956, JString, required = true,
                                 default = nil)
  if valid_593956 != nil:
    section.add "x-amz-data-partition", valid_593956
...
proc call*(call_593960: Call_UpdateTypedLinkFacet_593948; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.
  ## 
...
proc call*(call_593961: Call_UpdateTypedLinkFacet_593948; body: JsonNode): Recallable =
...
var updateTypedLinkFacet* = Call_UpdateTypedLinkFacet_593948(
    ...
    validator: validate_UpdateTypedLinkFacet_593949, base: "/",
    url: url_UpdateTypedLinkFacet_593950, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradeAppliedSchema_593963 = ref object of OpenApiRestCall_592364
proc url_UpgradeAppliedSchema_593965(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradeAppliedSchema_593964(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593974: Call_UpgradeAppliedSchema_593963; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Upgrades a single directory in-place using the <code>PublishedSchemaArn</code> with schema updates found in <code>MinorVersion</code>. Backwards-compatible minor version upgrades are instantaneously available for readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one schema on a given directory per call. To upgrade multiple directories from one schema, you would need to call this API on each directory.
  ## 
...
proc call*(call_593975: Call_UpgradeAppliedSchema_593963; body: JsonNode): Recallable =
...
var upgradeAppliedSchema* = Call_UpgradeAppliedSchema_593963(
    name: "upgradeAppliedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradeapplied",
    validator: validate_UpgradeAppliedSchema_593964, base: "/",
    url: url_UpgradeAppliedSchema_593965, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradePublishedSchema_593977 = ref object of OpenApiRestCall_592364
proc url_UpgradePublishedSchema_593979(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradePublishedSchema_593978(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593988: Call_UpgradePublishedSchema_593977; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.
  ## 
...
proc call*(call_593989: Call_UpgradePublishedSchema_593977; body: JsonNode): Recallable =
...
var upgradePublishedSchema* = Call_UpgradePublishedSchema_593977(
    name: "upgradePublishedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradepublished",
    validator: validate_UpgradePublishedSchema_593978, base: "/",
    url: url_UpgradePublishedSchema_593979, schemes: {Scheme.Https, Scheme.Http})
export
  rest
