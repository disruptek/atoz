...
type
  Call_CreateApplication_593774 = ref object of OpenApiRestCall_593437
proc url_CreateApplication_593776(protocol: Scheme; host: string; base: string;
...
proc validate_CreateApplication_593775(path: JsonNode; query: JsonNode;
...
proc call*(call_593932: Call_CreateApplication_593774; path: JsonNode;
...
proc call*(call_594003: Call_CreateApplication_593774; body: JsonNode): Recallable =
  ## createApplication
  ## Adds an application that is created from a resource group.
  ##   body: JObject (required)
...
var createApplication* = Call_CreateApplication_593774(name: "createApplication",
    ...
    validator: validate_CreateApplication_593775, base: "/",
    url: url_CreateApplication_593776, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateComponent_594043 = ref object of OpenApiRestCall_593437
proc url_CreateComponent_594045(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateComponent_594044(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594055: Call_CreateComponent_594043; path: JsonNode; query: JsonNode;
...
proc call*(call_594056: Call_CreateComponent_594043; body: JsonNode): Recallable =
  ## createComponent
  ## Creates a custom component by grouping similar standalone instances to monitor.
  ##   body: JObject (required)
...
var createComponent* = Call_CreateComponent_594043(name: "createComponent",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.CreateComponent",
    validator: validate_CreateComponent_594044, base: "/", url: url_CreateComponent_594045,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplication_594058 = ref object of OpenApiRestCall_593437
proc url_DeleteApplication_594060(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplication_594059(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594070: Call_DeleteApplication_594058; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the specified application from monitoring. Does not delete the application.
  ## 
...
proc call*(call_594071: Call_DeleteApplication_594058; body: JsonNode): Recallable =
  ## deleteApplication
  ## Removes the specified application from monitoring. Does not delete the application.
  ##   body: JObject (required)
...
var deleteApplication* = Call_DeleteApplication_594058(name: "deleteApplication",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.DeleteApplication",
    validator: validate_DeleteApplication_594059, base: "/",
    url: url_DeleteApplication_594060, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteComponent_594073 = ref object of OpenApiRestCall_593437
proc url_DeleteComponent_594075(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteComponent_594074(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594085: Call_DeleteComponent_594073; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Ungroups a custom component. When you ungroup custom components, all applicable monitors that are set up for the component are removed and the instances revert to their standalone status.
  ## 
...
proc call*(call_594086: Call_DeleteComponent_594073; body: JsonNode): Recallable =
  ## deleteComponent
  ## Ungroups a custom component. When you ungroup custom components, all applicable monitors that are set up for the component are removed and the instances revert to their standalone status.
  ##   body: JObject (required)
...
var deleteComponent* = Call_DeleteComponent_594073(name: "deleteComponent",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.DeleteComponent",
    validator: validate_DeleteComponent_594074, base: "/", url: url_DeleteComponent_594075,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeApplication_594088 = ref object of OpenApiRestCall_593437
proc url_DescribeApplication_594090(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeApplication_594089(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594100: Call_DescribeApplication_594088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the application.
  ## 
...
proc call*(call_594101: Call_DescribeApplication_594088; body: JsonNode): Recallable =
  ## describeApplication
  ## Describes the application.
  ##   body: JObject (required)
...
var describeApplication* = Call_DescribeApplication_594088(
    ...
    validator: validate_DescribeApplication_594089, base: "/",
    url: url_DescribeApplication_594090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeComponent_594103 = ref object of OpenApiRestCall_593437
proc url_DescribeComponent_594105(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeComponent_594104(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594115: Call_DescribeComponent_594103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a component and lists the resources that are grouped together in a component.
  ## 
...
proc call*(call_594116: Call_DescribeComponent_594103; body: JsonNode): Recallable =
  ## describeComponent
  ## Describes a component and lists the resources that are grouped together in a component.
  ##   body: JObject (required)
...
var describeComponent* = Call_DescribeComponent_594103(name: "describeComponent",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.DescribeComponent",
    validator: validate_DescribeComponent_594104, base: "/",
    url: url_DescribeComponent_594105, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeComponentConfiguration_594118 = ref object of OpenApiRestCall_593437
proc url_DescribeComponentConfiguration_594120(protocol: Scheme; host: string;
...
proc validate_DescribeComponentConfiguration_594119(path: JsonNode;
...
proc call*(call_594130: Call_DescribeComponentConfiguration_594118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the monitoring configuration of the component.
  ## 
...
proc call*(call_594131: Call_DescribeComponentConfiguration_594118; body: JsonNode): Recallable =
...
var describeComponentConfiguration* = Call_DescribeComponentConfiguration_594118(
    ...
    validator: validate_DescribeComponentConfiguration_594119, base: "/",
    url: url_DescribeComponentConfiguration_594120,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeComponentConfigurationRecommendation_594133 = ref object of OpenApiRestCall_593437
proc url_DescribeComponentConfigurationRecommendation_594135(protocol: Scheme;
...
proc validate_DescribeComponentConfigurationRecommendation_594134(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594145: Call_DescribeComponentConfigurationRecommendation_594133;
...
proc call*(call_594146: Call_DescribeComponentConfigurationRecommendation_594133;
          body: JsonNode): Recallable =
...
var describeComponentConfigurationRecommendation* = Call_DescribeComponentConfigurationRecommendation_594133(
    ...
    validator: validate_DescribeComponentConfigurationRecommendation_594134,
    base: "/", url: url_DescribeComponentConfigurationRecommendation_594135,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeObservation_594148 = ref object of OpenApiRestCall_593437
proc url_DescribeObservation_594150(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeObservation_594149(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594160: Call_DescribeObservation_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes an anomaly or error with the application.
  ## 
...
proc call*(call_594161: Call_DescribeObservation_594148; body: JsonNode): Recallable =
  ## describeObservation
  ## Describes an anomaly or error with the application.
  ##   body: JObject (required)
...
var describeObservation* = Call_DescribeObservation_594148(
    name: "describeObservation", meth: HttpMethod.HttpPost,
    host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.DescribeObservation",
    validator: validate_DescribeObservation_594149, base: "/",
    url: url_DescribeObservation_594150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProblem_594163 = ref object of OpenApiRestCall_593437
proc url_DescribeProblem_594165(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProblem_594164(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594175: Call_DescribeProblem_594163; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes an application problem.
  ## 
...
proc call*(call_594176: Call_DescribeProblem_594163; body: JsonNode): Recallable =
  ## describeProblem
  ## Describes an application problem.
  ##   body: JObject (required)
...
var describeProblem* = Call_DescribeProblem_594163(name: "describeProblem",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.DescribeProblem",
    validator: validate_DescribeProblem_594164, base: "/", url: url_DescribeProblem_594165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProblemObservations_594178 = ref object of OpenApiRestCall_593437
proc url_DescribeProblemObservations_594180(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProblemObservations_594179(path: JsonNode; query: JsonNode;
...
proc call*(call_594190: Call_DescribeProblemObservations_594178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the anomalies or errors associated with the problem.
  ## 
...
proc call*(call_594191: Call_DescribeProblemObservations_594178; body: JsonNode): Recallable =
...
var describeProblemObservations* = Call_DescribeProblemObservations_594178(
    ...
    validator: validate_DescribeProblemObservations_594179, base: "/",
    url: url_DescribeProblemObservations_594180,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListApplications_594193 = ref object of OpenApiRestCall_593437
proc url_ListApplications_594195(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListApplications_594194(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_594197 = query.getOrDefault("MaxResults")
  valid_594197 = validateParameter(valid_594197, JString, required = false,
                                 default = nil)
  if valid_594197 != nil:
    section.add "MaxResults", valid_594197
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594207: Call_ListApplications_594193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the IDs of the applications that you are monitoring. 
  ## 
...
proc call*(call_594208: Call_ListApplications_594193; body: JsonNode;
  ...
  add(query_594209, "NextToken", newJString(NextToken))
  if body != nil:
    body_594210 = body
  add(query_594209, "MaxResults", newJString(MaxResults))
  result = call_594208.call(nil, query_594209, nil, nil, body_594210)

var listApplications* = Call_ListApplications_594193(name: "listApplications",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.ListApplications",
    validator: validate_ListApplications_594194, base: "/",
    url: url_ListApplications_594195, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListComponents_594212 = ref object of OpenApiRestCall_593437
proc url_ListComponents_594214(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListComponents_594213(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594215 = query.getOrDefault("NextToken")
  valid_594215 = validateParameter(valid_594215, JString, required = false,
                                 default = nil)
  if valid_594215 != nil:
    section.add "NextToken", valid_594215
...
proc call*(call_594226: Call_ListComponents_594212; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the auto-grouped, standalone, and custom components of the application.
  ## 
...
proc call*(call_594227: Call_ListComponents_594212; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listComponents
  ## Lists the auto-grouped, standalone, and custom components of the application.
  ##   NextToken: string
  ...
  add(query_594228, "NextToken", newJString(NextToken))
  if body != nil:
    body_594229 = body
  add(query_594228, "MaxResults", newJString(MaxResults))
  result = call_594227.call(nil, query_594228, nil, nil, body_594229)

var listComponents* = Call_ListComponents_594212(name: "listComponents",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.ListComponents",
    validator: validate_ListComponents_594213, base: "/", url: url_ListComponents_594214,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProblems_594230 = ref object of OpenApiRestCall_593437
proc url_ListProblems_594232(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProblems_594231(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_594244: Call_ListProblems_594230; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the problems with your application.
  ## 
...
proc call*(call_594245: Call_ListProblems_594230; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listProblems
  ## Lists the problems with your application.
  ##   NextToken: string
  ...
  add(query_594246, "NextToken", newJString(NextToken))
  if body != nil:
    body_594247 = body
  add(query_594246, "MaxResults", newJString(MaxResults))
  result = call_594245.call(nil, query_594246, nil, nil, body_594247)

var listProblems* = Call_ListProblems_594230(name: "listProblems",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.ListProblems",
    validator: validate_ListProblems_594231, base: "/", url: url_ListProblems_594232,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateApplication_594248 = ref object of OpenApiRestCall_593437
proc url_UpdateApplication_594250(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateApplication_594249(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594260: Call_UpdateApplication_594248; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the application.
  ## 
...
proc call*(call_594261: Call_UpdateApplication_594248; body: JsonNode): Recallable =
  ## updateApplication
  ## Updates the application.
  ##   body: JObject (required)
...
var updateApplication* = Call_UpdateApplication_594248(name: "updateApplication",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.UpdateApplication",
    validator: validate_UpdateApplication_594249, base: "/",
    url: url_UpdateApplication_594250, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateComponent_594263 = ref object of OpenApiRestCall_593437
proc url_UpdateComponent_594265(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateComponent_594264(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594275: Call_UpdateComponent_594263; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the custom component name and/or the list of resources that make up the component.
  ## 
...
proc call*(call_594276: Call_UpdateComponent_594263; body: JsonNode): Recallable =
  ## updateComponent
  ## Updates the custom component name and/or the list of resources that make up the component.
  ##   body: JObject (required)
...
var updateComponent* = Call_UpdateComponent_594263(name: "updateComponent",
    meth: HttpMethod.HttpPost, host: "applicationinsights.amazonaws.com",
    route: "/#X-Amz-Target=EC2WindowsBarleyService.UpdateComponent",
    validator: validate_UpdateComponent_594264, base: "/", url: url_UpdateComponent_594265,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateComponentConfiguration_594278 = ref object of OpenApiRestCall_593437
proc url_UpdateComponentConfiguration_594280(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateComponentConfiguration_594279(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594290: Call_UpdateComponentConfiguration_594278; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the monitoring configurations for the component. The configuration input parameter is an escaped JSON of the configuration and should match the schema of what is returned by <code>DescribeComponentConfigurationRecommendation</code>.
  ## 
...
proc call*(call_594291: Call_UpdateComponentConfiguration_594278; body: JsonNode): Recallable =
...
var updateComponentConfiguration* = Call_UpdateComponentConfiguration_594278(
    ...
    validator: validate_UpdateComponentConfiguration_594279, base: "/",
    url: url_UpdateComponentConfiguration_594280,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
