...
type
  Call_InvokeEndpoint_772924 = ref object of OpenApiRestCall_772588
proc url_InvokeEndpoint_772926(protocol: Scheme; host: string; base: string;
...
proc validate_InvokeEndpoint_772925(path: JsonNode; query: JsonNode;
  ...
  var valid_773052 = path.getOrDefault("EndpointName")
  valid_773052 = validateParameter(valid_773052, JString, required = true,
                                 default = nil)
  if valid_773052 != nil:
    section.add "EndpointName", valid_773052
  ...
  var valid_773056 = header.getOrDefault("Content-Type")
  valid_773056 = validateParameter(valid_773056, JString, required = false,
                                 default = nil)
  if valid_773056 != nil:
    section.add "Content-Type", valid_773056
  ...
  var valid_773060 = header.getOrDefault("Accept")
  valid_773060 = validateParameter(valid_773060, JString, required = false,
                                 default = nil)
  if valid_773060 != nil:
    section.add "Accept", valid_773060
  var valid_773061 = header.getOrDefault("X-Amzn-SageMaker-Custom-Attributes")
  valid_773061 = validateParameter(valid_773061, JString, required = false,
                                 default = nil)
  if valid_773061 != nil:
    section.add "X-Amzn-SageMaker-Custom-Attributes", valid_773061
...
proc call*(call_773086: Call_InvokeEndpoint_772924; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>After you deploy a model into production using Amazon SageMaker hosting services, your client applications use this API to get inferences from the model hosted at the specified endpoint. </p> <p>For an overview of Amazon SageMaker, see <a href="http://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works.html">How It Works</a>. </p> <p>Amazon SageMaker strips all POST headers except those supported by the API. Amazon SageMaker might add additional headers. You should not rely on the behavior of headers outside those enumerated in the request syntax. </p> <p>Cals to <code>InvokeEndpoint</code> are authenticated by using AWS Signature Version 4. For information, see <a href="http://docs.aws.amazon.com/AmazonS3/latest/API/sig-v4-authenticating-requests.html">Authenticating Requests (AWS Signature Version 4)</a> in the <i>Amazon S3 API Reference</i>.</p> <note> <p>Endpoints are scoped to an individual account, and are not public. The URL does not contain the account ID, but Amazon SageMaker determines the account ID from the authentication token that is supplied by the caller.</p> </note>
  ## 
  let valid = call_773086.validator(path, query, header, formData, body)
  let scheme = call_773086.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_773086.url(scheme.get, call_773086.host, call_773086.base,
                         call_773086.route, valid.getOrDefault("path"))
  result = hook(call_773086, url, valid)

proc call*(call_773157: Call_InvokeEndpoint_772924; EndpointName: string;
  ...
  ## href="http://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpoint.html">CreateEndpoint</a> API. 
  ##   body: JObject (required)
  var path_773158 = newJObject()
  var body_773160 = newJObject()
  add(path_773158, "EndpointName", newJString(EndpointName))
  if body != nil:
    body_773160 = body
  result = call_773157.call(path_773158, nil, nil, nil, body_773160)

var invokeEndpoint* = Call_InvokeEndpoint_772924(name: "invokeEndpoint",
    meth: HttpMethod.HttpPost, host: "runtime.sagemaker.amazonaws.com",
    route: "/endpoints/{EndpointName}/invocations",
    validator: validate_InvokeEndpoint_772925, base: "/", url: url_InvokeEndpoint_772926,
