...
type
  Call_AcceptInvitation_594044 = ref object of OpenApiRestCall_593437
proc url_AcceptInvitation_594046(protocol: Scheme; host: string; base: string;
...
proc validate_AcceptInvitation_594045(path: JsonNode; query: JsonNode;
  ...
  var valid_594047 = path.getOrDefault("detectorId")
  valid_594047 = validateParameter(valid_594047, JString, required = true,
                                 default = nil)
  if valid_594047 != nil:
    section.add "detectorId", valid_594047
...
proc call*(call_594056: Call_AcceptInvitation_594044; path: JsonNode;
...
proc call*(call_594057: Call_AcceptInvitation_594044; detectorId: string;
  ...
  add(path_594058, "detectorId", newJString(detectorId))
  if body != nil:
    body_594059 = body
  result = call_594057.call(path_594058, nil, nil, nil, body_594059)

var acceptInvitation* = Call_AcceptInvitation_594044(name: "acceptInvitation",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/master", validator: validate_AcceptInvitation_594045,
    base: "/", url: url_AcceptInvitation_594046,
...
proc validate_GetMasterAccount_593775(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_593902 = path.getOrDefault("detectorId")
  valid_593902 = validateParameter(valid_593902, JString, required = true,
                                 default = nil)
  if valid_593902 != nil:
    section.add "detectorId", valid_593902
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593932: Call_GetMasterAccount_593774; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides the details for the GuardDuty master account associated with the current GuardDuty member account.
  ## 
...
proc call*(call_594003: Call_GetMasterAccount_593774; detectorId: string): Recallable =
  ## getMasterAccount
  ## Provides the details for the GuardDuty master account associated with the current GuardDuty member account.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty member account.
  var path_594004 = newJObject()
  add(path_594004, "detectorId", newJString(detectorId))
...
var getMasterAccount* = Call_GetMasterAccount_593774(name: "getMasterAccount",
    ...
    route: "/detector/{detectorId}/master", validator: validate_GetMasterAccount_593775,
    base: "/", url: url_GetMasterAccount_593776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ArchiveFindings_594060 = ref object of OpenApiRestCall_593437
proc url_ArchiveFindings_594062(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ArchiveFindings_594061(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594063 = path.getOrDefault("detectorId")
  valid_594063 = validateParameter(valid_594063, JString, required = true,
                                 default = nil)
  if valid_594063 != nil:
    section.add "detectorId", valid_594063
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594072: Call_ArchiveFindings_594060; path: JsonNode; query: JsonNode;
...
proc call*(call_594073: Call_ArchiveFindings_594060; detectorId: string;
          body: JsonNode): Recallable =
  ## archiveFindings
  ## <p>Archives GuardDuty findings specified by the list of finding IDs.</p> <note> <p>Only the master account can archive findings. Member accounts do not have permission to archive findings from their accounts.</p> </note>
  ##   detectorId: string (required)
  ...
  add(path_594074, "detectorId", newJString(detectorId))
  if body != nil:
    body_594075 = body
  result = call_594073.call(path_594074, nil, nil, nil, body_594075)

var archiveFindings* = Call_ArchiveFindings_594060(name: "archiveFindings",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings/archive",
    validator: validate_ArchiveFindings_594061, base: "/", url: url_ArchiveFindings_594062,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDetector_594093 = ref object of OpenApiRestCall_593437
proc url_CreateDetector_594095(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDetector_594094(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594104: Call_CreateDetector_594093; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a single Amazon GuardDuty detector. A detector is a resource that represents the GuardDuty service. To start using GuardDuty, you must create a detector in each region that you enable the service. You can have only one detector per account per region.
  ## 
...
proc call*(call_594105: Call_CreateDetector_594093; body: JsonNode): Recallable =
  ## createDetector
  ## Creates a single Amazon GuardDuty detector. A detector is a resource that represents the GuardDuty service. To start using GuardDuty, you must create a detector in each region that you enable the service. You can have only one detector per account per region.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_594106 = body
  result = call_594105.call(nil, nil, nil, nil, body_594106)

var createDetector* = Call_CreateDetector_594093(name: "createDetector",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com", route: "/detector",
    validator: validate_CreateDetector_594094, base: "/", url: url_CreateDetector_594095,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDetectors_594076 = ref object of OpenApiRestCall_593437
proc url_ListDetectors_594078(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDetectors_594077(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_594080 = query.getOrDefault("maxResults")
  valid_594080 = validateParameter(valid_594080, JInt, required = false, default = nil)
  if valid_594080 != nil:
    section.add "maxResults", valid_594080
  var valid_594081 = query.getOrDefault("nextToken")
  valid_594081 = validateParameter(valid_594081, JString, required = false,
                                 default = nil)
  if valid_594081 != nil:
    section.add "nextToken", valid_594081
...
proc call*(call_594090: Call_ListDetectors_594076; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists detectorIds of all the existing Amazon GuardDuty detector resources.
  ## 
...
proc call*(call_594091: Call_ListDetectors_594076; NextToken: string = "";
  ...
  add(query_594092, "NextToken", newJString(NextToken))
  add(query_594092, "maxResults", newJInt(maxResults))
  add(query_594092, "nextToken", newJString(nextToken))
  add(query_594092, "MaxResults", newJString(MaxResults))
  result = call_594091.call(nil, query_594092, nil, nil, nil)

var listDetectors* = Call_ListDetectors_594076(name: "listDetectors",
    meth: HttpMethod.HttpGet, host: "guardduty.amazonaws.com", route: "/detector",
    validator: validate_ListDetectors_594077, base: "/", url: url_ListDetectors_594078,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateFilter_594126 = ref object of OpenApiRestCall_593437
proc url_CreateFilter_594128(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateFilter_594127(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594129 = path.getOrDefault("detectorId")
  valid_594129 = validateParameter(valid_594129, JString, required = true,
                                 default = nil)
  if valid_594129 != nil:
    section.add "detectorId", valid_594129
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594138: Call_CreateFilter_594126; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a filter using the specified finding criteria.
  ## 
...
proc call*(call_594139: Call_CreateFilter_594126; detectorId: string; body: JsonNode): Recallable =
  ## createFilter
  ## Creates a filter using the specified finding criteria.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account for which you want to create a filter.
  ...
  add(path_594140, "detectorId", newJString(detectorId))
  if body != nil:
    body_594141 = body
  result = call_594139.call(path_594140, nil, nil, nil, body_594141)

var createFilter* = Call_CreateFilter_594126(name: "createFilter",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/filter", validator: validate_CreateFilter_594127,
    base: "/", url: url_CreateFilter_594128, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListFilters_594107 = ref object of OpenApiRestCall_593437
proc url_ListFilters_594109(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListFilters_594108(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594110 = path.getOrDefault("detectorId")
  valid_594110 = validateParameter(valid_594110, JString, required = true,
                                 default = nil)
  if valid_594110 != nil:
    section.add "detectorId", valid_594110
  result.add "path", section
  ## parameters in `query` object:
  ##   NextToken: JString
  ##            : Pagination token
...
proc call*(call_594122: Call_ListFilters_594107; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a paginated list of the current filters.
  ## 
...
proc call*(call_594123: Call_ListFilters_594107; detectorId: string;
  ...
  add(query_594125, "nextToken", newJString(nextToken))
  add(path_594124, "detectorId", newJString(detectorId))
  add(query_594125, "MaxResults", newJString(MaxResults))
  result = call_594123.call(path_594124, query_594125, nil, nil, nil)

var listFilters* = Call_ListFilters_594107(name: "listFilters",
                                        meth: HttpMethod.HttpGet,
                                        host: "guardduty.amazonaws.com",
                                        route: "/detector/{detectorId}/filter",
                                        validator: validate_ListFilters_594108,
                                        base: "/", url: url_ListFilters_594109,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateIPSet_594161 = ref object of OpenApiRestCall_593437
proc url_CreateIPSet_594163(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateIPSet_594162(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594164 = path.getOrDefault("detectorId")
  valid_594164 = validateParameter(valid_594164, JString, required = true,
                                 default = nil)
  if valid_594164 != nil:
    section.add "detectorId", valid_594164
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594173: Call_CreateIPSet_594161; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new IPSet - a list of trusted IP addresses that have been whitelisted for secure communication with AWS infrastructure and applications.
  ## 
...
proc call*(call_594174: Call_CreateIPSet_594161; detectorId: string; body: JsonNode): Recallable =
  ## createIPSet
  ## Creates a new IPSet - a list of trusted IP addresses that have been whitelisted for secure communication with AWS infrastructure and applications.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account for which you want to create an IPSet.
  ...
  add(path_594175, "detectorId", newJString(detectorId))
  if body != nil:
    body_594176 = body
  result = call_594174.call(path_594175, nil, nil, nil, body_594176)

var createIPSet* = Call_CreateIPSet_594161(name: "createIPSet",
                                        meth: HttpMethod.HttpPost,
                                        host: "guardduty.amazonaws.com",
                                        route: "/detector/{detectorId}/ipset",
                                        validator: validate_CreateIPSet_594162,
                                        base: "/", url: url_CreateIPSet_594163,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIPSets_594142 = ref object of OpenApiRestCall_593437
proc url_ListIPSets_594144(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListIPSets_594143(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594145 = path.getOrDefault("detectorId")
  valid_594145 = validateParameter(valid_594145, JString, required = true,
                                 default = nil)
  if valid_594145 != nil:
    section.add "detectorId", valid_594145
  result.add "path", section
  ## parameters in `query` object:
  ##   NextToken: JString
  ##            : Pagination token
  ...
  var valid_594148 = query.getOrDefault("nextToken")
  valid_594148 = validateParameter(valid_594148, JString, required = false,
                                 default = nil)
  if valid_594148 != nil:
    section.add "nextToken", valid_594148
  var valid_594149 = query.getOrDefault("MaxResults")
  valid_594149 = validateParameter(valid_594149, JString, required = false,
                                 default = nil)
  if valid_594149 != nil:
    section.add "MaxResults", valid_594149
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594157: Call_ListIPSets_594142; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the IPSets of the GuardDuty service specified by the detector ID.
  ## 
...
proc call*(call_594158: Call_ListIPSets_594142; detectorId: string;
          NextToken: string = ""; maxResults: int = 0; nextToken: string = "";
          MaxResults: string = ""): Recallable =
  ## listIPSets
  ## Lists the IPSets of the GuardDuty service specified by the detector ID.
  ...
  add(query_594160, "maxResults", newJInt(maxResults))
  add(query_594160, "nextToken", newJString(nextToken))
  add(path_594159, "detectorId", newJString(detectorId))
  add(query_594160, "MaxResults", newJString(MaxResults))
  result = call_594158.call(path_594159, query_594160, nil, nil, nil)

var listIPSets* = Call_ListIPSets_594142(name: "listIPSets",
                                      meth: HttpMethod.HttpGet,
                                      host: "guardduty.amazonaws.com",
                                      route: "/detector/{detectorId}/ipset",
                                      validator: validate_ListIPSets_594143,
                                      base: "/", url: url_ListIPSets_594144,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateMembers_594197 = ref object of OpenApiRestCall_593437
proc url_CreateMembers_594199(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateMembers_594198(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594200 = path.getOrDefault("detectorId")
  valid_594200 = validateParameter(valid_594200, JString, required = true,
                                 default = nil)
  if valid_594200 != nil:
    section.add "detectorId", valid_594200
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594209: Call_CreateMembers_594197; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates member accounts of the current AWS account by specifying a list of AWS account IDs. The current AWS account can then invite these members to manage GuardDuty in their accounts.
  ## 
...
proc call*(call_594210: Call_CreateMembers_594197; detectorId: string; body: JsonNode): Recallable =
  ## createMembers
  ## Creates member accounts of the current AWS account by specifying a list of AWS account IDs. The current AWS account can then invite these members to manage GuardDuty in their accounts.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account with which you want to associate member accounts.
  ...
  add(path_594211, "detectorId", newJString(detectorId))
  if body != nil:
    body_594212 = body
  result = call_594210.call(path_594211, nil, nil, nil, body_594212)

var createMembers* = Call_CreateMembers_594197(name: "createMembers",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/member", validator: validate_CreateMembers_594198,
    base: "/", url: url_CreateMembers_594199, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListMembers_594177 = ref object of OpenApiRestCall_593437
proc url_ListMembers_594179(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListMembers_594178(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594180 = path.getOrDefault("detectorId")
  valid_594180 = validateParameter(valid_594180, JString, required = true,
                                 default = nil)
  if valid_594180 != nil:
    section.add "detectorId", valid_594180
  result.add "path", section
  ## parameters in `query` object:
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594181 = query.getOrDefault("onlyAssociated")
  valid_594181 = validateParameter(valid_594181, JString, required = false,
                                 default = nil)
  if valid_594181 != nil:
    section.add "onlyAssociated", valid_594181
  var valid_594182 = query.getOrDefault("NextToken")
  valid_594182 = validateParameter(valid_594182, JString, required = false,
                                 default = nil)
  if valid_594182 != nil:
    section.add "NextToken", valid_594182
...
proc call*(call_594193: Call_ListMembers_594177; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists details about all member accounts for the current GuardDuty master account.
  ## 
...
proc call*(call_594194: Call_ListMembers_594177; detectorId: string;
  ...
  add(query_594196, "onlyAssociated", newJString(onlyAssociated))
  add(query_594196, "NextToken", newJString(NextToken))
  add(query_594196, "maxResults", newJInt(maxResults))
  add(query_594196, "nextToken", newJString(nextToken))
  add(path_594195, "detectorId", newJString(detectorId))
  add(query_594196, "MaxResults", newJString(MaxResults))
  result = call_594194.call(path_594195, query_594196, nil, nil, nil)

var listMembers* = Call_ListMembers_594177(name: "listMembers",
                                        meth: HttpMethod.HttpGet,
                                        host: "guardduty.amazonaws.com",
                                        route: "/detector/{detectorId}/member",
                                        validator: validate_ListMembers_594178,
                                        base: "/", url: url_ListMembers_594179,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSampleFindings_594213 = ref object of OpenApiRestCall_593437
proc url_CreateSampleFindings_594215(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSampleFindings_594214(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594216 = path.getOrDefault("detectorId")
  valid_594216 = validateParameter(valid_594216, JString, required = true,
                                 default = nil)
  if valid_594216 != nil:
    section.add "detectorId", valid_594216
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594225: Call_CreateSampleFindings_594213; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Generates example findings of types specified by the list of finding types. If 'NULL' is specified for findingTypes, the API generates example findings of all supported finding types.
  ## 
...
proc call*(call_594226: Call_CreateSampleFindings_594213; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594227, "detectorId", newJString(detectorId))
  if body != nil:
    body_594228 = body
  result = call_594226.call(path_594227, nil, nil, nil, body_594228)

var createSampleFindings* = Call_CreateSampleFindings_594213(
    name: "createSampleFindings", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings/create",
    validator: validate_CreateSampleFindings_594214, base: "/",
    url: url_CreateSampleFindings_594215, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateThreatIntelSet_594248 = ref object of OpenApiRestCall_593437
proc url_CreateThreatIntelSet_594250(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateThreatIntelSet_594249(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594251 = path.getOrDefault("detectorId")
  valid_594251 = validateParameter(valid_594251, JString, required = true,
                                 default = nil)
  if valid_594251 != nil:
    section.add "detectorId", valid_594251
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594260: Call_CreateThreatIntelSet_594248; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create a new ThreatIntelSet. ThreatIntelSets consist of known malicious IP addresses. GuardDuty generates findings based on ThreatIntelSets.
  ## 
...
proc call*(call_594261: Call_CreateThreatIntelSet_594248; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594262, "detectorId", newJString(detectorId))
  if body != nil:
    body_594263 = body
  result = call_594261.call(path_594262, nil, nil, nil, body_594263)

var createThreatIntelSet* = Call_CreateThreatIntelSet_594248(
    name: "createThreatIntelSet", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/threatintelset",
    validator: validate_CreateThreatIntelSet_594249, base: "/",
    url: url_CreateThreatIntelSet_594250, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListThreatIntelSets_594229 = ref object of OpenApiRestCall_593437
proc url_ListThreatIntelSets_594231(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListThreatIntelSets_594230(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594232 = path.getOrDefault("detectorId")
  valid_594232 = validateParameter(valid_594232, JString, required = true,
                                 default = nil)
  if valid_594232 != nil:
    section.add "detectorId", valid_594232
  result.add "path", section
  ## parameters in `query` object:
  ##   NextToken: JString
  ##            : Pagination token
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594233 = query.getOrDefault("NextToken")
  valid_594233 = validateParameter(valid_594233, JString, required = false,
                                 default = nil)
  if valid_594233 != nil:
    section.add "NextToken", valid_594233
  var valid_594234 = query.getOrDefault("maxResults")
  valid_594234 = validateParameter(valid_594234, JInt, required = false, default = nil)
  if valid_594234 != nil:
    section.add "maxResults", valid_594234
  var valid_594235 = query.getOrDefault("nextToken")
  valid_594235 = validateParameter(valid_594235, JString, required = false,
                                 default = nil)
  if valid_594235 != nil:
    section.add "nextToken", valid_594235
  var valid_594236 = query.getOrDefault("MaxResults")
  valid_594236 = validateParameter(valid_594236, JString, required = false,
                                 default = nil)
  if valid_594236 != nil:
    section.add "MaxResults", valid_594236
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594244: Call_ListThreatIntelSets_594229; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the ThreatIntelSets of the GuardDuty service specified by the detector ID.
  ## 
...
proc call*(call_594245: Call_ListThreatIntelSets_594229; detectorId: string;
          NextToken: string = ""; maxResults: int = 0; nextToken: string = "";
          MaxResults: string = ""): Recallable =
  ## listThreatIntelSets
  ## Lists the ThreatIntelSets of the GuardDuty service specified by the detector ID.
  ...
  add(query_594247, "NextToken", newJString(NextToken))
  add(query_594247, "maxResults", newJInt(maxResults))
  add(query_594247, "nextToken", newJString(nextToken))
  add(path_594246, "detectorId", newJString(detectorId))
  add(query_594247, "MaxResults", newJString(MaxResults))
  result = call_594245.call(path_594246, query_594247, nil, nil, nil)

var listThreatIntelSets* = Call_ListThreatIntelSets_594229(
    name: "listThreatIntelSets", meth: HttpMethod.HttpGet,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/threatintelset",
    validator: validate_ListThreatIntelSets_594230, base: "/",
    url: url_ListThreatIntelSets_594231, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeclineInvitations_594264 = ref object of OpenApiRestCall_593437
proc url_DeclineInvitations_594266(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeclineInvitations_594265(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594275: Call_DeclineInvitations_594264; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Declines invitations sent to the current member account by AWS account specified by their account IDs.
  ## 
...
proc call*(call_594276: Call_DeclineInvitations_594264; body: JsonNode): Recallable =
  ## declineInvitations
  ## Declines invitations sent to the current member account by AWS account specified by their account IDs.
  ##   body: JObject (required)
...
var declineInvitations* = Call_DeclineInvitations_594264(
    name: "declineInvitations", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com", route: "/invitation/decline",
    validator: validate_DeclineInvitations_594265, base: "/",
    url: url_DeclineInvitations_594266, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDetector_594292 = ref object of OpenApiRestCall_593437
proc url_UpdateDetector_594294(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDetector_594293(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594295 = path.getOrDefault("detectorId")
  valid_594295 = validateParameter(valid_594295, JString, required = true,
                                 default = nil)
  if valid_594295 != nil:
    section.add "detectorId", valid_594295
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594304: Call_UpdateDetector_594292; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an Amazon GuardDuty detector specified by the detectorId.
  ## 
...
proc call*(call_594305: Call_UpdateDetector_594292; detectorId: string;
          body: JsonNode): Recallable =
  ## updateDetector
  ## Updates an Amazon GuardDuty detector specified by the detectorId.
  ##   detectorId: string (required)
  ...
  add(path_594306, "detectorId", newJString(detectorId))
  if body != nil:
    body_594307 = body
  result = call_594305.call(path_594306, nil, nil, nil, body_594307)

var updateDetector* = Call_UpdateDetector_594292(name: "updateDetector",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}", validator: validate_UpdateDetector_594293,
    base: "/", url: url_UpdateDetector_594294, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDetector_594278 = ref object of OpenApiRestCall_593437
proc url_GetDetector_594280(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDetector_594279(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594281 = path.getOrDefault("detectorId")
  valid_594281 = validateParameter(valid_594281, JString, required = true,
                                 default = nil)
  if valid_594281 != nil:
    section.add "detectorId", valid_594281
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594289: Call_GetDetector_594278; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves an Amazon GuardDuty detector specified by the detectorId.
  ## 
...
proc call*(call_594290: Call_GetDetector_594278; detectorId: string): Recallable =
  ## getDetector
  ## Retrieves an Amazon GuardDuty detector specified by the detectorId.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector that you want to get.
  var path_594291 = newJObject()
  add(path_594291, "detectorId", newJString(detectorId))
  result = call_594290.call(path_594291, nil, nil, nil, nil)

var getDetector* = Call_GetDetector_594278(name: "getDetector",
                                        meth: HttpMethod.HttpGet,
                                        host: "guardduty.amazonaws.com",
                                        route: "/detector/{detectorId}",
                                        validator: validate_GetDetector_594279,
                                        base: "/", url: url_GetDetector_594280,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDetector_594308 = ref object of OpenApiRestCall_593437
proc url_DeleteDetector_594310(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDetector_594309(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594311 = path.getOrDefault("detectorId")
  valid_594311 = validateParameter(valid_594311, JString, required = true,
                                 default = nil)
  if valid_594311 != nil:
    section.add "detectorId", valid_594311
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594319: Call_DeleteDetector_594308; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a Amazon GuardDuty detector specified by the detector ID.
  ## 
...
proc call*(call_594320: Call_DeleteDetector_594308; detectorId: string): Recallable =
  ## deleteDetector
  ## Deletes a Amazon GuardDuty detector specified by the detector ID.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector that you want to delete.
  var path_594321 = newJObject()
  add(path_594321, "detectorId", newJString(detectorId))
  result = call_594320.call(path_594321, nil, nil, nil, nil)

var deleteDetector* = Call_DeleteDetector_594308(name: "deleteDetector",
    meth: HttpMethod.HttpDelete, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}", validator: validate_DeleteDetector_594309,
    base: "/", url: url_DeleteDetector_594310, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateFilter_594337 = ref object of OpenApiRestCall_593437
proc url_UpdateFilter_594339(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateFilter_594338(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594340 = path.getOrDefault("filterName")
  valid_594340 = validateParameter(valid_594340, JString, required = true,
                                 default = nil)
  if valid_594340 != nil:
    section.add "filterName", valid_594340
  var valid_594341 = path.getOrDefault("detectorId")
  valid_594341 = validateParameter(valid_594341, JString, required = true,
                                 default = nil)
  if valid_594341 != nil:
    section.add "detectorId", valid_594341
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594350: Call_UpdateFilter_594337; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the filter specified by the filter name.
  ## 
...
proc call*(call_594351: Call_UpdateFilter_594337; filterName: string;
  ...
  add(path_594352, "filterName", newJString(filterName))
  add(path_594352, "detectorId", newJString(detectorId))
  if body != nil:
    body_594353 = body
  result = call_594351.call(path_594352, nil, nil, nil, body_594353)

var updateFilter* = Call_UpdateFilter_594337(name: "updateFilter",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/filter/{filterName}",
    validator: validate_UpdateFilter_594338, base: "/", url: url_UpdateFilter_594339,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFilter_594322 = ref object of OpenApiRestCall_593437
proc url_GetFilter_594324(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetFilter_594323(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `filterName` field"
  var valid_594325 = path.getOrDefault("filterName")
  valid_594325 = validateParameter(valid_594325, JString, required = true,
                                 default = nil)
  if valid_594325 != nil:
    section.add "filterName", valid_594325
  var valid_594326 = path.getOrDefault("detectorId")
  valid_594326 = validateParameter(valid_594326, JString, required = true,
                                 default = nil)
  if valid_594326 != nil:
    section.add "detectorId", valid_594326
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594334: Call_GetFilter_594322; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the details of the filter specified by the filter name.
  ## 
...
proc call*(call_594335: Call_GetFilter_594322; filterName: string; detectorId: string): Recallable =
  ## getFilter
  ## Returns the details of the filter specified by the filter name.
  ##   filterName: string (required)
  ##             : The name of the filter you want to get.
  ...
  add(path_594336, "filterName", newJString(filterName))
  add(path_594336, "detectorId", newJString(detectorId))
  result = call_594335.call(path_594336, nil, nil, nil, nil)

var getFilter* = Call_GetFilter_594322(name: "getFilter", meth: HttpMethod.HttpGet,
                                    host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/filter/{filterName}",
                                    validator: validate_GetFilter_594323,
                                    base: "/", url: url_GetFilter_594324,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteFilter_594354 = ref object of OpenApiRestCall_593437
proc url_DeleteFilter_594356(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteFilter_594355(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `filterName` field"
  var valid_594357 = path.getOrDefault("filterName")
  valid_594357 = validateParameter(valid_594357, JString, required = true,
                                 default = nil)
  if valid_594357 != nil:
    section.add "filterName", valid_594357
  var valid_594358 = path.getOrDefault("detectorId")
  valid_594358 = validateParameter(valid_594358, JString, required = true,
                                 default = nil)
  if valid_594358 != nil:
    section.add "detectorId", valid_594358
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594366: Call_DeleteFilter_594354; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the filter specified by the filter name.
  ## 
...
proc call*(call_594367: Call_DeleteFilter_594354; filterName: string;
  ...
  add(path_594368, "filterName", newJString(filterName))
  add(path_594368, "detectorId", newJString(detectorId))
  result = call_594367.call(path_594368, nil, nil, nil, nil)

var deleteFilter* = Call_DeleteFilter_594354(name: "deleteFilter",
    meth: HttpMethod.HttpDelete, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/filter/{filterName}",
    validator: validate_DeleteFilter_594355, base: "/", url: url_DeleteFilter_594356,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateIPSet_594384 = ref object of OpenApiRestCall_593437
proc url_UpdateIPSet_594386(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateIPSet_594385(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594387 = path.getOrDefault("ipSetId")
  valid_594387 = validateParameter(valid_594387, JString, required = true,
                                 default = nil)
  if valid_594387 != nil:
    section.add "ipSetId", valid_594387
  var valid_594388 = path.getOrDefault("detectorId")
  valid_594388 = validateParameter(valid_594388, JString, required = true,
                                 default = nil)
  if valid_594388 != nil:
    section.add "detectorId", valid_594388
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594397: Call_UpdateIPSet_594384; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the IPSet specified by the IPSet ID.
  ## 
...
proc call*(call_594398: Call_UpdateIPSet_594384; ipSetId: string; detectorId: string;
          body: JsonNode): Recallable =
  ## updateIPSet
  ## Updates the IPSet specified by the IPSet ID.
  ...
  add(path_594399, "ipSetId", newJString(ipSetId))
  add(path_594399, "detectorId", newJString(detectorId))
  if body != nil:
    body_594400 = body
  result = call_594398.call(path_594399, nil, nil, nil, body_594400)

var updateIPSet* = Call_UpdateIPSet_594384(name: "updateIPSet",
                                        meth: HttpMethod.HttpPost,
                                        host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/ipset/{ipSetId}",
                                        validator: validate_UpdateIPSet_594385,
                                        base: "/", url: url_UpdateIPSet_594386,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetIPSet_594369 = ref object of OpenApiRestCall_593437
proc url_GetIPSet_594371(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetIPSet_594370(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `ipSetId` field"
  var valid_594372 = path.getOrDefault("ipSetId")
  valid_594372 = validateParameter(valid_594372, JString, required = true,
                                 default = nil)
  if valid_594372 != nil:
    section.add "ipSetId", valid_594372
  var valid_594373 = path.getOrDefault("detectorId")
  valid_594373 = validateParameter(valid_594373, JString, required = true,
                                 default = nil)
  if valid_594373 != nil:
    section.add "detectorId", valid_594373
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594381: Call_GetIPSet_594369; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the IPSet specified by the IPSet ID.
  ## 
...
proc call*(call_594382: Call_GetIPSet_594369; ipSetId: string; detectorId: string): Recallable =
  ## getIPSet
  ## Retrieves the IPSet specified by the IPSet ID.
  ##   ipSetId: string (required)
  ##          : The unique ID of the ipSet you want to get.
  ...
  add(path_594383, "ipSetId", newJString(ipSetId))
  add(path_594383, "detectorId", newJString(detectorId))
  result = call_594382.call(path_594383, nil, nil, nil, nil)

var getIPSet* = Call_GetIPSet_594369(name: "getIPSet", meth: HttpMethod.HttpGet,
                                  host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/ipset/{ipSetId}",
                                  validator: validate_GetIPSet_594370, base: "/",
                                  url: url_GetIPSet_594371,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIPSet_594401 = ref object of OpenApiRestCall_593437
proc url_DeleteIPSet_594403(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteIPSet_594402(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `ipSetId` field"
  var valid_594404 = path.getOrDefault("ipSetId")
  valid_594404 = validateParameter(valid_594404, JString, required = true,
                                 default = nil)
  if valid_594404 != nil:
    section.add "ipSetId", valid_594404
  var valid_594405 = path.getOrDefault("detectorId")
  valid_594405 = validateParameter(valid_594405, JString, required = true,
                                 default = nil)
  if valid_594405 != nil:
    section.add "detectorId", valid_594405
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594413: Call_DeleteIPSet_594401; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the IPSet specified by the IPSet ID.
  ## 
...
proc call*(call_594414: Call_DeleteIPSet_594401; ipSetId: string; detectorId: string): Recallable =
  ## deleteIPSet
  ## Deletes the IPSet specified by the IPSet ID.
  ##   ipSetId: string (required)
  ##          : The unique ID of the ipSet you want to delete.
  ...
  add(path_594415, "ipSetId", newJString(ipSetId))
  add(path_594415, "detectorId", newJString(detectorId))
  result = call_594414.call(path_594415, nil, nil, nil, nil)

var deleteIPSet* = Call_DeleteIPSet_594401(name: "deleteIPSet",
                                        meth: HttpMethod.HttpDelete,
                                        host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/ipset/{ipSetId}",
                                        validator: validate_DeleteIPSet_594402,
                                        base: "/", url: url_DeleteIPSet_594403,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteInvitations_594416 = ref object of OpenApiRestCall_593437
proc url_DeleteInvitations_594418(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteInvitations_594417(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594427: Call_DeleteInvitations_594416; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes invitations sent to the current member account by AWS accounts specified by their account IDs.
  ## 
...
proc call*(call_594428: Call_DeleteInvitations_594416; body: JsonNode): Recallable =
  ## deleteInvitations
  ## Deletes invitations sent to the current member account by AWS accounts specified by their account IDs.
  ##   body: JObject (required)
...
var deleteInvitations* = Call_DeleteInvitations_594416(name: "deleteInvitations",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/invitation/delete", validator: validate_DeleteInvitations_594417,
    base: "/", url: url_DeleteInvitations_594418,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteMembers_594430 = ref object of OpenApiRestCall_593437
proc url_DeleteMembers_594432(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteMembers_594431(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594433 = path.getOrDefault("detectorId")
  valid_594433 = validateParameter(valid_594433, JString, required = true,
                                 default = nil)
  if valid_594433 != nil:
    section.add "detectorId", valid_594433
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594442: Call_DeleteMembers_594430; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ## 
...
proc call*(call_594443: Call_DeleteMembers_594430; detectorId: string; body: JsonNode): Recallable =
  ## deleteMembers
  ## Deletes GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account whose members you want to delete.
  ...
  add(path_594444, "detectorId", newJString(detectorId))
  if body != nil:
    body_594445 = body
  result = call_594443.call(path_594444, nil, nil, nil, body_594445)

var deleteMembers* = Call_DeleteMembers_594430(name: "deleteMembers",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/member/delete",
    validator: validate_DeleteMembers_594431, base: "/", url: url_DeleteMembers_594432,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateThreatIntelSet_594461 = ref object of OpenApiRestCall_593437
proc url_UpdateThreatIntelSet_594463(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateThreatIntelSet_594462(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594464 = path.getOrDefault("detectorId")
  valid_594464 = validateParameter(valid_594464, JString, required = true,
                                 default = nil)
  if valid_594464 != nil:
    section.add "detectorId", valid_594464
  var valid_594465 = path.getOrDefault("threatIntelSetId")
  valid_594465 = validateParameter(valid_594465, JString, required = true,
                                 default = nil)
  if valid_594465 != nil:
    section.add "threatIntelSetId", valid_594465
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594474: Call_UpdateThreatIntelSet_594461; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the ThreatIntelSet specified by ThreatIntelSet ID.
  ## 
...
proc call*(call_594475: Call_UpdateThreatIntelSet_594461; detectorId: string;
  ...
  add(path_594476, "detectorId", newJString(detectorId))
  add(path_594476, "threatIntelSetId", newJString(threatIntelSetId))
  if body != nil:
    body_594477 = body
  result = call_594475.call(path_594476, nil, nil, nil, body_594477)

var updateThreatIntelSet* = Call_UpdateThreatIntelSet_594461(
    name: "updateThreatIntelSet", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/threatintelset/{threatIntelSetId}",
    validator: validate_UpdateThreatIntelSet_594462, base: "/",
    url: url_UpdateThreatIntelSet_594463, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetThreatIntelSet_594446 = ref object of OpenApiRestCall_593437
proc url_GetThreatIntelSet_594448(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetThreatIntelSet_594447(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594449 = path.getOrDefault("detectorId")
  valid_594449 = validateParameter(valid_594449, JString, required = true,
                                 default = nil)
  if valid_594449 != nil:
    section.add "detectorId", valid_594449
  var valid_594450 = path.getOrDefault("threatIntelSetId")
  valid_594450 = validateParameter(valid_594450, JString, required = true,
                                 default = nil)
  if valid_594450 != nil:
    section.add "threatIntelSetId", valid_594450
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594458: Call_GetThreatIntelSet_594446; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the ThreatIntelSet that is specified by the ThreatIntelSet ID.
  ## 
...
proc call*(call_594459: Call_GetThreatIntelSet_594446; detectorId: string;
  ...
  add(path_594460, "detectorId", newJString(detectorId))
  add(path_594460, "threatIntelSetId", newJString(threatIntelSetId))
  result = call_594459.call(path_594460, nil, nil, nil, nil)

var getThreatIntelSet* = Call_GetThreatIntelSet_594446(name: "getThreatIntelSet",
    meth: HttpMethod.HttpGet, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/threatintelset/{threatIntelSetId}",
    validator: validate_GetThreatIntelSet_594447, base: "/",
    url: url_GetThreatIntelSet_594448, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteThreatIntelSet_594478 = ref object of OpenApiRestCall_593437
proc url_DeleteThreatIntelSet_594480(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteThreatIntelSet_594479(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594481 = path.getOrDefault("detectorId")
  valid_594481 = validateParameter(valid_594481, JString, required = true,
                                 default = nil)
  if valid_594481 != nil:
    section.add "detectorId", valid_594481
  var valid_594482 = path.getOrDefault("threatIntelSetId")
  valid_594482 = validateParameter(valid_594482, JString, required = true,
                                 default = nil)
  if valid_594482 != nil:
    section.add "threatIntelSetId", valid_594482
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594490: Call_DeleteThreatIntelSet_594478; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes ThreatIntelSet specified by the ThreatIntelSet ID.
  ## 
...
proc call*(call_594491: Call_DeleteThreatIntelSet_594478; detectorId: string;
          threatIntelSetId: string): Recallable =
  ...
  add(path_594492, "detectorId", newJString(detectorId))
  add(path_594492, "threatIntelSetId", newJString(threatIntelSetId))
  result = call_594491.call(path_594492, nil, nil, nil, nil)

var deleteThreatIntelSet* = Call_DeleteThreatIntelSet_594478(
    name: "deleteThreatIntelSet", meth: HttpMethod.HttpDelete,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/threatintelset/{threatIntelSetId}",
    validator: validate_DeleteThreatIntelSet_594479, base: "/",
    url: url_DeleteThreatIntelSet_594480, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateFromMasterAccount_594493 = ref object of OpenApiRestCall_593437
proc url_DisassociateFromMasterAccount_594495(protocol: Scheme; host: string;
...
proc validate_DisassociateFromMasterAccount_594494(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594496 = path.getOrDefault("detectorId")
  valid_594496 = validateParameter(valid_594496, JString, required = true,
                                 default = nil)
  if valid_594496 != nil:
    section.add "detectorId", valid_594496
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594504: Call_DisassociateFromMasterAccount_594493; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates the current GuardDuty member account from its master account.
  ## 
...
proc call*(call_594505: Call_DisassociateFromMasterAccount_594493;
          detectorId: string): Recallable =
  ...
  add(path_594506, "detectorId", newJString(detectorId))
  result = call_594505.call(path_594506, nil, nil, nil, nil)

var disassociateFromMasterAccount* = Call_DisassociateFromMasterAccount_594493(
    name: "disassociateFromMasterAccount", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/master/disassociate",
    validator: validate_DisassociateFromMasterAccount_594494, base: "/",
    url: url_DisassociateFromMasterAccount_594495,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateMembers_594507 = ref object of OpenApiRestCall_593437
proc url_DisassociateMembers_594509(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateMembers_594508(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594510 = path.getOrDefault("detectorId")
  valid_594510 = validateParameter(valid_594510, JString, required = true,
                                 default = nil)
  if valid_594510 != nil:
    section.add "detectorId", valid_594510
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
  ...
  var valid_594514 = header.getOrDefault("X-Amz-Algorithm")
  valid_594514 = validateParameter(valid_594514, JString, required = false,
                                 default = nil)
  if valid_594514 != nil:
    section.add "X-Amz-Algorithm", valid_594514
  var valid_594515 = header.getOrDefault("X-Amz-Signature")
  valid_594515 = validateParameter(valid_594515, JString, required = false,
                                 default = nil)
  if valid_594515 != nil:
    section.add "X-Amz-Signature", valid_594515
...
proc call*(call_594519: Call_DisassociateMembers_594507; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disassociates GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ## 
...
proc call*(call_594520: Call_DisassociateMembers_594507; detectorId: string;
          body: JsonNode): Recallable =
  ## disassociateMembers
  ## Disassociates GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ##   detectorId: string (required)
  ...
  add(path_594521, "detectorId", newJString(detectorId))
  if body != nil:
    body_594522 = body
  result = call_594520.call(path_594521, nil, nil, nil, body_594522)

var disassociateMembers* = Call_DisassociateMembers_594507(
    name: "disassociateMembers", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/member/disassociate",
    validator: validate_DisassociateMembers_594508, base: "/",
    url: url_DisassociateMembers_594509, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFindings_594523 = ref object of OpenApiRestCall_593437
proc url_GetFindings_594525(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetFindings_594524(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594526 = path.getOrDefault("detectorId")
  valid_594526 = validateParameter(valid_594526, JString, required = true,
                                 default = nil)
  if valid_594526 != nil:
    section.add "detectorId", valid_594526
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594535: Call_GetFindings_594523; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes Amazon GuardDuty findings specified by finding IDs.
  ## 
...
proc call*(call_594536: Call_GetFindings_594523; detectorId: string; body: JsonNode): Recallable =
  ## getFindings
  ## Describes Amazon GuardDuty findings specified by finding IDs.
  ##   detectorId: string (required)
  ##             : The ID of the detector that specifies the GuardDuty service whose findings you want to retrieve.
  ...
  add(path_594537, "detectorId", newJString(detectorId))
  if body != nil:
    body_594538 = body
  result = call_594536.call(path_594537, nil, nil, nil, body_594538)

var getFindings* = Call_GetFindings_594523(name: "getFindings",
                                        meth: HttpMethod.HttpPost,
                                        host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/findings/get",
                                        validator: validate_GetFindings_594524,
                                        base: "/", url: url_GetFindings_594525,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFindingsStatistics_594539 = ref object of OpenApiRestCall_593437
proc url_GetFindingsStatistics_594541(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetFindingsStatistics_594540(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594542 = path.getOrDefault("detectorId")
  valid_594542 = validateParameter(valid_594542, JString, required = true,
                                 default = nil)
  if valid_594542 != nil:
    section.add "detectorId", valid_594542
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594551: Call_GetFindingsStatistics_594539; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists Amazon GuardDuty findings' statistics for the specified detector ID.
  ## 
...
proc call*(call_594552: Call_GetFindingsStatistics_594539; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594553, "detectorId", newJString(detectorId))
  if body != nil:
    body_594554 = body
  result = call_594552.call(path_594553, nil, nil, nil, body_594554)

var getFindingsStatistics* = Call_GetFindingsStatistics_594539(
    name: "getFindingsStatistics", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings/statistics",
    validator: validate_GetFindingsStatistics_594540, base: "/",
    url: url_GetFindingsStatistics_594541, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInvitationsCount_594555 = ref object of OpenApiRestCall_593437
proc url_GetInvitationsCount_594557(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetInvitationsCount_594556(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594565: Call_GetInvitationsCount_594555; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the count of all GuardDuty membership invitations that were sent to the current member account except the currently accepted invitation.
  ## 
...
proc call*(call_594566: Call_GetInvitationsCount_594555): Recallable =
  ## getInvitationsCount
  ## Returns the count of all GuardDuty membership invitations that were sent to the current member account except the currently accepted invitation.
  result = call_594566.call(nil, nil, nil, nil, nil)

var getInvitationsCount* = Call_GetInvitationsCount_594555(
    name: "getInvitationsCount", meth: HttpMethod.HttpGet,
    host: "guardduty.amazonaws.com", route: "/invitation/count",
    validator: validate_GetInvitationsCount_594556, base: "/",
    url: url_GetInvitationsCount_594557, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMembers_594567 = ref object of OpenApiRestCall_593437
proc url_GetMembers_594569(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMembers_594568(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594570 = path.getOrDefault("detectorId")
  valid_594570 = validateParameter(valid_594570, JString, required = true,
                                 default = nil)
  if valid_594570 != nil:
    section.add "detectorId", valid_594570
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594579: Call_GetMembers_594567; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ## 
...
proc call*(call_594580: Call_GetMembers_594567; detectorId: string; body: JsonNode): Recallable =
  ## getMembers
  ## Retrieves GuardDuty member accounts (to the current GuardDuty master account) specified by the account IDs.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account whose members you want to retrieve.
  ...
  add(path_594581, "detectorId", newJString(detectorId))
  if body != nil:
    body_594582 = body
  result = call_594580.call(path_594581, nil, nil, nil, body_594582)

var getMembers* = Call_GetMembers_594567(name: "getMembers",
                                      meth: HttpMethod.HttpPost,
                                      host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/member/get",
                                      validator: validate_GetMembers_594568,
                                      base: "/", url: url_GetMembers_594569,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_InviteMembers_594583 = ref object of OpenApiRestCall_593437
proc url_InviteMembers_594585(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InviteMembers_594584(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594586 = path.getOrDefault("detectorId")
  valid_594586 = validateParameter(valid_594586, JString, required = true,
                                 default = nil)
  if valid_594586 != nil:
    section.add "detectorId", valid_594586
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594595: Call_InviteMembers_594583; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Invites other AWS accounts (created as members of the current AWS account by CreateMembers) to enable GuardDuty and allow the current AWS account to view and manage these accounts' GuardDuty findings on their behalf as the master account.
  ## 
...
proc call*(call_594596: Call_InviteMembers_594583; detectorId: string; body: JsonNode): Recallable =
  ## inviteMembers
  ## Invites other AWS accounts (created as members of the current AWS account by CreateMembers) to enable GuardDuty and allow the current AWS account to view and manage these accounts' GuardDuty findings on their behalf as the master account.
  ##   detectorId: string (required)
  ##             : The unique ID of the detector of the GuardDuty account with which you want to invite members.
  ...
  add(path_594597, "detectorId", newJString(detectorId))
  if body != nil:
    body_594598 = body
  result = call_594596.call(path_594597, nil, nil, nil, body_594598)

var inviteMembers* = Call_InviteMembers_594583(name: "inviteMembers",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/member/invite",
    validator: validate_InviteMembers_594584, base: "/", url: url_InviteMembers_594585,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListFindings_594599 = ref object of OpenApiRestCall_593437
proc url_ListFindings_594601(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListFindings_594600(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594602 = path.getOrDefault("detectorId")
  valid_594602 = validateParameter(valid_594602, JString, required = true,
                                 default = nil)
  if valid_594602 != nil:
    section.add "detectorId", valid_594602
  result.add "path", section
  ## parameters in `query` object:
  ##   NextToken: JString
  ##            : Pagination token
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594603 = query.getOrDefault("NextToken")
  valid_594603 = validateParameter(valid_594603, JString, required = false,
                                 default = nil)
  if valid_594603 != nil:
    section.add "NextToken", valid_594603
  var valid_594604 = query.getOrDefault("MaxResults")
  valid_594604 = validateParameter(valid_594604, JString, required = false,
                                 default = nil)
  if valid_594604 != nil:
    section.add "MaxResults", valid_594604
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594613: Call_ListFindings_594599; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists Amazon GuardDuty findings for the specified detector ID.
  ## 
...
proc call*(call_594614: Call_ListFindings_594599; detectorId: string; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listFindings
  ## Lists Amazon GuardDuty findings for the specified detector ID.
  ##   NextToken: string
  ...
  add(query_594616, "NextToken", newJString(NextToken))
  add(path_594615, "detectorId", newJString(detectorId))
  if body != nil:
    body_594617 = body
  add(query_594616, "MaxResults", newJString(MaxResults))
  result = call_594614.call(path_594615, query_594616, nil, nil, body_594617)

var listFindings* = Call_ListFindings_594599(name: "listFindings",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings", validator: validate_ListFindings_594600,
    base: "/", url: url_ListFindings_594601, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListInvitations_594618 = ref object of OpenApiRestCall_593437
proc url_ListInvitations_594620(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListInvitations_594619(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_594621 = query.getOrDefault("NextToken")
  valid_594621 = validateParameter(valid_594621, JString, required = false,
                                 default = nil)
  if valid_594621 != nil:
    section.add "NextToken", valid_594621
  var valid_594622 = query.getOrDefault("maxResults")
  valid_594622 = validateParameter(valid_594622, JInt, required = false, default = nil)
  if valid_594622 != nil:
    section.add "maxResults", valid_594622
  var valid_594623 = query.getOrDefault("nextToken")
  valid_594623 = validateParameter(valid_594623, JString, required = false,
                                 default = nil)
  if valid_594623 != nil:
    section.add "nextToken", valid_594623
  var valid_594624 = query.getOrDefault("MaxResults")
  valid_594624 = validateParameter(valid_594624, JString, required = false,
                                 default = nil)
  if valid_594624 != nil:
    section.add "MaxResults", valid_594624
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_594632: Call_ListInvitations_594618; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all GuardDuty membership invitations that were sent to the current AWS account.
  ## 
...
proc call*(call_594633: Call_ListInvitations_594618; NextToken: string = "";
          maxResults: int = 0; nextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listInvitations
  ## Lists all GuardDuty membership invitations that were sent to the current AWS account.
  ##   NextToken: string
  ...
  add(query_594634, "NextToken", newJString(NextToken))
  add(query_594634, "maxResults", newJInt(maxResults))
  add(query_594634, "nextToken", newJString(nextToken))
  add(query_594634, "MaxResults", newJString(MaxResults))
  result = call_594633.call(nil, query_594634, nil, nil, nil)

var listInvitations* = Call_ListInvitations_594618(name: "listInvitations",
    meth: HttpMethod.HttpGet, host: "guardduty.amazonaws.com", route: "/invitation",
    validator: validate_ListInvitations_594619, base: "/", url: url_ListInvitations_594620,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_594649 = ref object of OpenApiRestCall_593437
proc url_TagResource_594651(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_594650(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594652 = path.getOrDefault("resourceArn")
  valid_594652 = validateParameter(valid_594652, JString, required = true,
                                 default = nil)
  if valid_594652 != nil:
    section.add "resourceArn", valid_594652
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594661: Call_TagResource_594649; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds tags to a resource.
  ## 
...
proc call*(call_594662: Call_TagResource_594649; body: JsonNode; resourceArn: string): Recallable =
  ## tagResource
  ## Adds tags to a resource.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_594664 = body
  add(path_594663, "resourceArn", newJString(resourceArn))
  result = call_594662.call(path_594663, nil, nil, nil, body_594664)

var tagResource* = Call_TagResource_594649(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "guardduty.amazonaws.com",
                                        route: "/tags/{resourceArn}",
                                        validator: validate_TagResource_594650,
                                        base: "/", url: url_TagResource_594651,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_594635 = ref object of OpenApiRestCall_593437
proc url_ListTagsForResource_594637(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_594636(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceArn` field"
  var valid_594638 = path.getOrDefault("resourceArn")
  valid_594638 = validateParameter(valid_594638, JString, required = true,
                                 default = nil)
  if valid_594638 != nil:
    section.add "resourceArn", valid_594638
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594646: Call_ListTagsForResource_594635; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists tags for a resource. Tagging is currently supported for detectors, finding filters, IP sets, and Threat Intel sets, with a limit of 50 tags per resource. When invoked, this operation returns all assigned tags for a given resource..
  ## 
...
proc call*(call_594647: Call_ListTagsForResource_594635; resourceArn: string): Recallable =
  ## listTagsForResource
  ## Lists tags for a resource. Tagging is currently supported for detectors, finding filters, IP sets, and Threat Intel sets, with a limit of 50 tags per resource. When invoked, this operation returns all assigned tags for a given resource..
  ##   resourceArn: string (required)
  ##              : The Amazon Resource Name (ARN) for the given GuardDuty resource 
  var path_594648 = newJObject()
  add(path_594648, "resourceArn", newJString(resourceArn))
  result = call_594647.call(path_594648, nil, nil, nil, nil)

var listTagsForResource* = Call_ListTagsForResource_594635(
    name: "listTagsForResource", meth: HttpMethod.HttpGet,
    host: "guardduty.amazonaws.com", route: "/tags/{resourceArn}",
    validator: validate_ListTagsForResource_594636, base: "/",
    url: url_ListTagsForResource_594637, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartMonitoringMembers_594665 = ref object of OpenApiRestCall_593437
proc url_StartMonitoringMembers_594667(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartMonitoringMembers_594666(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594668 = path.getOrDefault("detectorId")
  valid_594668 = validateParameter(valid_594668, JString, required = true,
                                 default = nil)
  if valid_594668 != nil:
    section.add "detectorId", valid_594668
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594677: Call_StartMonitoringMembers_594665; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Re-enables GuardDuty to monitor findings of the member accounts specified by the account IDs. A master GuardDuty account can run this command after disabling GuardDuty from monitoring these members' findings by running StopMonitoringMembers.
  ## 
...
proc call*(call_594678: Call_StartMonitoringMembers_594665; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594679, "detectorId", newJString(detectorId))
  if body != nil:
    body_594680 = body
  result = call_594678.call(path_594679, nil, nil, nil, body_594680)

var startMonitoringMembers* = Call_StartMonitoringMembers_594665(
    name: "startMonitoringMembers", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/member/start",
    validator: validate_StartMonitoringMembers_594666, base: "/",
    url: url_StartMonitoringMembers_594667, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopMonitoringMembers_594681 = ref object of OpenApiRestCall_593437
proc url_StopMonitoringMembers_594683(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopMonitoringMembers_594682(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594684 = path.getOrDefault("detectorId")
  valid_594684 = validateParameter(valid_594684, JString, required = true,
                                 default = nil)
  if valid_594684 != nil:
    section.add "detectorId", valid_594684
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594693: Call_StopMonitoringMembers_594681; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disables GuardDuty from monitoring findings of the member accounts specified by the account IDs. After running this command, a master GuardDuty account can run StartMonitoringMembers to re-enable GuardDuty to monitor these members’ findings.
  ## 
...
proc call*(call_594694: Call_StopMonitoringMembers_594681; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594695, "detectorId", newJString(detectorId))
  if body != nil:
    body_594696 = body
  result = call_594694.call(path_594695, nil, nil, nil, body_594696)

var stopMonitoringMembers* = Call_StopMonitoringMembers_594681(
    name: "stopMonitoringMembers", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com", route: "/detector/{detectorId}/member/stop",
    validator: validate_StopMonitoringMembers_594682, base: "/",
    url: url_StopMonitoringMembers_594683, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnarchiveFindings_594697 = ref object of OpenApiRestCall_593437
proc url_UnarchiveFindings_594699(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UnarchiveFindings_594698(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594700 = path.getOrDefault("detectorId")
  valid_594700 = validateParameter(valid_594700, JString, required = true,
                                 default = nil)
  if valid_594700 != nil:
    section.add "detectorId", valid_594700
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594709: Call_UnarchiveFindings_594697; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Unarchives Amazon GuardDuty findings specified by the list of finding IDs.
  ## 
...
proc call*(call_594710: Call_UnarchiveFindings_594697; detectorId: string;
          body: JsonNode): Recallable =
  ## unarchiveFindings
  ## Unarchives Amazon GuardDuty findings specified by the list of finding IDs.
  ##   detectorId: string (required)
  ...
  add(path_594711, "detectorId", newJString(detectorId))
  if body != nil:
    body_594712 = body
  result = call_594710.call(path_594711, nil, nil, nil, body_594712)

var unarchiveFindings* = Call_UnarchiveFindings_594697(name: "unarchiveFindings",
    meth: HttpMethod.HttpPost, host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings/unarchive",
    validator: validate_UnarchiveFindings_594698, base: "/",
    url: url_UnarchiveFindings_594699, schemes: {Scheme.Https, Scheme.Http})
type
...
proc validate_UntagResource_594714(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceArn` field"
  var valid_594716 = path.getOrDefault("resourceArn")
  valid_594716 = validateParameter(valid_594716, JString, required = true,
                                 default = nil)
  if valid_594716 != nil:
    section.add "resourceArn", valid_594716
  result.add "path", section
  ## parameters in `query` object:
  ...
  var valid_594719 = header.getOrDefault("X-Amz-Security-Token")
  valid_594719 = validateParameter(valid_594719, JString, required = false,
                                 default = nil)
  if valid_594719 != nil:
    section.add "X-Amz-Security-Token", valid_594719
...
proc call*(call_594726: Call_UntagResource_594713; tagKeys: JsonNode;
  ...
  if tagKeys != nil:
    query_594728.add "tagKeys", tagKeys
  add(path_594727, "resourceArn", newJString(resourceArn))
...
var untagResource* = Call_UntagResource_594713(name: "untagResource",
    meth: HttpMethod.HttpDelete, host: "guardduty.amazonaws.com",
    route: "/tags/{resourceArn}#tagKeys", validator: validate_UntagResource_594714,
    base: "/", url: url_UntagResource_594715, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateFindingsFeedback_594729 = ref object of OpenApiRestCall_593437
proc url_UpdateFindingsFeedback_594731(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateFindingsFeedback_594730(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorId` field"
  var valid_594732 = path.getOrDefault("detectorId")
  valid_594732 = validateParameter(valid_594732, JString, required = true,
                                 default = nil)
  if valid_594732 != nil:
    section.add "detectorId", valid_594732
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_594741: Call_UpdateFindingsFeedback_594729; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Marks specified Amazon GuardDuty findings as useful or not useful.
  ## 
...
proc call*(call_594742: Call_UpdateFindingsFeedback_594729; detectorId: string;
          body: JsonNode): Recallable =
  ...
  add(path_594743, "detectorId", newJString(detectorId))
  if body != nil:
    body_594744 = body
  result = call_594742.call(path_594743, nil, nil, nil, body_594744)

var updateFindingsFeedback* = Call_UpdateFindingsFeedback_594729(
    name: "updateFindingsFeedback", meth: HttpMethod.HttpPost,
    host: "guardduty.amazonaws.com",
    route: "/detector/{detectorId}/findings/feedback",
    validator: validate_UpdateFindingsFeedback_594730, base: "/",
    url: url_UpdateFindingsFeedback_594731, schemes: {Scheme.Https, Scheme.Http})
export
  rest
