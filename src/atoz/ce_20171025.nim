...
type
  Call_GetCostAndUsage_593727 = ref object of OpenApiRestCall_593389
proc url_GetCostAndUsage_593729(protocol: Scheme; host: string; base: string;
...
proc validate_GetCostAndUsage_593728(path: JsonNode; query: JsonNode;
...
proc call*(call_593885: Call_GetCostAndUsage_593727; path: JsonNode; query: JsonNode;
...
proc call*(call_593956: Call_GetCostAndUsage_593727; body: JsonNode): Recallable =
  ## getCostAndUsage
  ## Retrieves cost and usage metrics for your account. You can specify which cost and usage-related metric, such as <code>BlendedCosts</code> or <code>UsageQuantity</code>, that you want the request to return. You can also filter and group your data by various dimensions, such as <code>SERVICE</code> or <code>AZ</code>, in a specific time range. For a complete list of valid dimensions, see the <a href="http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_GetDimensionValues.html">GetDimensionValues</a> operation. Master accounts in an organization in AWS Organizations have access to all member accounts.
  ##   body: JObject (required)
...
var getCostAndUsage* = Call_GetCostAndUsage_593727(name: "getCostAndUsage",
    meth: HttpMethod.HttpPost, host: "ce.amazonaws.com",
    route: "/#X-Amz-Target=AWSInsightsIndexService.GetCostAndUsage",
    validator: validate_GetCostAndUsage_593728, base: "/", url: url_GetCostAndUsage_593729,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCostAndUsageWithResources_593996 = ref object of OpenApiRestCall_593389
proc url_GetCostAndUsageWithResources_593998(protocol: Scheme; host: string;
...
proc validate_GetCostAndUsageWithResources_593997(path: JsonNode; query: JsonNode;
...
proc call*(call_594008: Call_GetCostAndUsageWithResources_593996; path: JsonNode;
...
proc call*(call_594009: Call_GetCostAndUsageWithResources_593996; body: JsonNode): Recallable =
...
var getCostAndUsageWithResources* = Call_GetCostAndUsageWithResources_593996(
    ...
    validator: validate_GetCostAndUsageWithResources_593997, base: "/",
    url: url_GetCostAndUsageWithResources_593998,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCostForecast_594011 = ref object of OpenApiRestCall_593389
proc url_GetCostForecast_594013(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCostForecast_594012(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_594023: Call_GetCostForecast_594011; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a forecast for how much Amazon Web Services predicts that you will spend over the forecast time period that you select, based on your past costs. 
  ## 
...
proc call*(call_594024: Call_GetCostForecast_594011; body: JsonNode): Recallable =
  ## getCostForecast
  ## Retrieves a forecast for how much Amazon Web Services predicts that you will spend over the forecast time period that you select, based on your past costs. 
  ##   body: JObject (required)
...
var getCostForecast* = Call_GetCostForecast_594011(name: "getCostForecast",
    meth: HttpMethod.HttpPost, host: "ce.amazonaws.com",
    route: "/#X-Amz-Target=AWSInsightsIndexService.GetCostForecast",
    validator: validate_GetCostForecast_594012, base: "/", url: url_GetCostForecast_594013,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDimensionValues_594026 = ref object of OpenApiRestCall_593389
proc url_GetDimensionValues_594028(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDimensionValues_594027(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594038: Call_GetDimensionValues_594026; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves all available filter values for a specified filter over a period of time. You can search the dimension values for an arbitrary string. 
  ## 
...
proc call*(call_594039: Call_GetDimensionValues_594026; body: JsonNode): Recallable =
  ## getDimensionValues
  ## Retrieves all available filter values for a specified filter over a period of time. You can search the dimension values for an arbitrary string. 
  ##   body: JObject (required)
...
var getDimensionValues* = Call_GetDimensionValues_594026(
    ...
    validator: validate_GetDimensionValues_594027, base: "/",
    url: url_GetDimensionValues_594028, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetReservationCoverage_594041 = ref object of OpenApiRestCall_593389
proc url_GetReservationCoverage_594043(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetReservationCoverage_594042(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594053: Call_GetReservationCoverage_594041; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the reservation coverage for your account. This enables you to see how much of your Amazon Elastic Compute Cloud, Amazon ElastiCache, Amazon Relational Database Service, or Amazon Redshift usage is covered by a reservation. An organization's master account can see the coverage of the associated member accounts. For any time period, you can filter data about reservation usage by the following dimensions:</p> <ul> <li> <p>AZ</p> </li> <li> <p>CACHE_ENGINE</p> </li> <li> <p>DATABASE_ENGINE</p> </li> <li> <p>DEPLOYMENT_OPTION</p> </li> <li> <p>INSTANCE_TYPE</p> </li> <li> <p>LINKED_ACCOUNT</p> </li> <li> <p>OPERATING_SYSTEM</p> </li> <li> <p>PLATFORM</p> </li> <li> <p>REGION</p> </li> <li> <p>SERVICE</p> </li> <li> <p>TAG</p> </li> <li> <p>TENANCY</p> </li> </ul> <p>To determine valid values for a dimension, use the <code>GetDimensionValues</code> operation. </p>
  ## 
...
proc call*(call_594054: Call_GetReservationCoverage_594041; body: JsonNode): Recallable =
...
var getReservationCoverage* = Call_GetReservationCoverage_594041(
    ...
    validator: validate_GetReservationCoverage_594042, base: "/",
    url: url_GetReservationCoverage_594043, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetReservationPurchaseRecommendation_594056 = ref object of OpenApiRestCall_593389
proc url_GetReservationPurchaseRecommendation_594058(protocol: Scheme;
...
proc validate_GetReservationPurchaseRecommendation_594057(path: JsonNode;
...
proc call*(call_594068: Call_GetReservationPurchaseRecommendation_594056;
...
proc call*(call_594069: Call_GetReservationPurchaseRecommendation_594056;
          body: JsonNode): Recallable =
...
var getReservationPurchaseRecommendation* = Call_GetReservationPurchaseRecommendation_594056(
    ...
    validator: validate_GetReservationPurchaseRecommendation_594057, base: "/",
    url: url_GetReservationPurchaseRecommendation_594058,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetReservationUtilization_594071 = ref object of OpenApiRestCall_593389
proc url_GetReservationUtilization_594073(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetReservationUtilization_594072(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594083: Call_GetReservationUtilization_594071; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the reservation utilization for your account. Master accounts in an organization have access to member accounts. You can filter data by dimensions in a time period. You can use <code>GetDimensionValues</code> to determine the possible dimension values. Currently, you can group only by <code>SUBSCRIPTION_ID</code>. 
  ## 
...
proc call*(call_594084: Call_GetReservationUtilization_594071; body: JsonNode): Recallable =
...
var getReservationUtilization* = Call_GetReservationUtilization_594071(
    ...
    validator: validate_GetReservationUtilization_594072, base: "/",
    url: url_GetReservationUtilization_594073,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRightsizingRecommendation_594086 = ref object of OpenApiRestCall_593389
proc url_GetRightsizingRecommendation_594088(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRightsizingRecommendation_594087(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594098: Call_GetRightsizingRecommendation_594086; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates recommendations that helps you save cost by identifying idle and underutilized Amazon EC2 instances.</p> <p>Recommendations are generated to either downsize or terminate instances, along with providing savings detail and metrics. For details on calculation and function, see <a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-what-is.html">Optimizing Your Cost with Rightsizing Recommendations</a>.</p>
  ## 
...
proc call*(call_594099: Call_GetRightsizingRecommendation_594086; body: JsonNode): Recallable =
...
var getRightsizingRecommendation* = Call_GetRightsizingRecommendation_594086(
    ...
    validator: validate_GetRightsizingRecommendation_594087, base: "/",
    url: url_GetRightsizingRecommendation_594088,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSavingsPlansCoverage_594101 = ref object of OpenApiRestCall_593389
proc url_GetSavingsPlansCoverage_594103(protocol: Scheme; host: string; base: string;
...
proc validate_GetSavingsPlansCoverage_594102(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594105 = query.getOrDefault("NextToken")
  valid_594105 = validateParameter(valid_594105, JString, required = false,
                                 default = nil)
  if valid_594105 != nil:
    section.add "NextToken", valid_594105
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_594115: Call_GetSavingsPlansCoverage_594101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the Savings Plans covered for your account. This enables you to see how much of your cost is covered by a Savings Plan. An organization’s master account can see the coverage of the associated member accounts. For any time period, you can filter data for Savings Plans usage with the following dimensions:</p> <ul> <li> <p> <code>LINKED_ACCOUNT</code> </p> </li> <li> <p> <code>REGION</code> </p> </li> <li> <p> <code>SERVICE</code> </p> </li> <li> <p> <code>INSTANCE_FAMILY</code> </p> </li> </ul> <p>To determine valid values for a dimension, use the <code>GetDimensionValues</code> operation.</p>
  ## 
...
proc call*(call_594116: Call_GetSavingsPlansCoverage_594101; body: JsonNode;
...
var getSavingsPlansCoverage* = Call_GetSavingsPlansCoverage_594101(
    name: "getSavingsPlansCoverage", meth: HttpMethod.HttpPost,
    host: "ce.amazonaws.com",
    route: "/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansCoverage",
    validator: validate_GetSavingsPlansCoverage_594102, base: "/",
    url: url_GetSavingsPlansCoverage_594103, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSavingsPlansPurchaseRecommendation_594120 = ref object of OpenApiRestCall_593389
proc url_GetSavingsPlansPurchaseRecommendation_594122(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetSavingsPlansPurchaseRecommendation_594121(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594132: Call_GetSavingsPlansPurchaseRecommendation_594120;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves your request parameters, Savings Plan Recommendations Summary and Details.
  ## 
...
proc call*(call_594133: Call_GetSavingsPlansPurchaseRecommendation_594120;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_594134 = body
  result = call_594133.call(nil, nil, nil, nil, body_594134)

var getSavingsPlansPurchaseRecommendation* = Call_GetSavingsPlansPurchaseRecommendation_594120(
    ...
    validator: validate_GetSavingsPlansPurchaseRecommendation_594121, base: "/",
    url: url_GetSavingsPlansPurchaseRecommendation_594122,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSavingsPlansUtilization_594135 = ref object of OpenApiRestCall_593389
proc url_GetSavingsPlansUtilization_594137(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetSavingsPlansUtilization_594136(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594147: Call_GetSavingsPlansUtilization_594135; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the Savings Plans utilization for your account across date ranges with daily or monthly granularity. Master accounts in an organization have access to member accounts. You can use <code>GetDimensionValues</code> in <code>SAVINGS_PLANS</code> to determine the possible dimension values.</p> <note> <p>You cannot group by any dimension values for <code>GetSavingsPlansUtilization</code>.</p> </note>
  ## 
...
proc call*(call_594148: Call_GetSavingsPlansUtilization_594135; body: JsonNode): Recallable =
...
var getSavingsPlansUtilization* = Call_GetSavingsPlansUtilization_594135(
    ...
    validator: validate_GetSavingsPlansUtilization_594136, base: "/",
    url: url_GetSavingsPlansUtilization_594137,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSavingsPlansUtilizationDetails_594150 = ref object of OpenApiRestCall_593389
proc url_GetSavingsPlansUtilizationDetails_594152(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetSavingsPlansUtilizationDetails_594151(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594164: Call_GetSavingsPlansUtilizationDetails_594150;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Retrieves attribute data along with aggregate utilization and savings data for a given time period. This doesn't support granular or grouped data (daily/monthly) in response. You can't retrieve data by dates in a single response similar to <code>GetSavingsPlanUtilization</code>, but you have the option to make multiple calls to <code>GetSavingsPlanUtilizationDetails</code> by providing individual dates. You can use <code>GetDimensionValues</code> in <code>SAVINGS_PLANS</code> to determine the possible dimension values.</p> <note> <p> <code>GetSavingsPlanUtilizationDetails</code> internally groups data by <code>SavingsPlansArn</code>.</p> </note>
  ## 
...
proc call*(call_594165: Call_GetSavingsPlansUtilizationDetails_594150;
  ...
  add(query_594166, "MaxResults", newJString(MaxResults))
  add(query_594166, "NextToken", newJString(NextToken))
  if body != nil:
    body_594167 = body
  result = call_594165.call(nil, query_594166, nil, nil, body_594167)

var getSavingsPlansUtilizationDetails* = Call_GetSavingsPlansUtilizationDetails_594150(
    ...
    validator: validate_GetSavingsPlansUtilizationDetails_594151, base: "/",
    url: url_GetSavingsPlansUtilizationDetails_594152,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetTags_594168 = ref object of OpenApiRestCall_593389
proc url_GetTags_594170(protocol: Scheme; host: string; base: string; route: string;
                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetTags_594169(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_594180: Call_GetTags_594168; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Queries for available tag keys and tag values for a specified period. You can search the tag values for an arbitrary string. 
  ## 
...
proc call*(call_594181: Call_GetTags_594168; body: JsonNode): Recallable =
  ## getTags
  ## Queries for available tag keys and tag values for a specified period. You can search the tag values for an arbitrary string. 
  ##   body: JObject (required)
...
var getTags* = Call_GetTags_594168(name: "getTags", meth: HttpMethod.HttpPost,
                                host: "ce.amazonaws.com", route: "/#X-Amz-Target=AWSInsightsIndexService.GetTags",
                                validator: validate_GetTags_594169, base: "/",
                                url: url_GetTags_594170,
                                schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetUsageForecast_594183 = ref object of OpenApiRestCall_593389
proc url_GetUsageForecast_594185(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetUsageForecast_594184(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594195: Call_GetUsageForecast_594183; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a forecast for how much Amazon Web Services predicts that you will use over the forecast time period that you select, based on your past usage. 
  ## 
...
proc call*(call_594196: Call_GetUsageForecast_594183; body: JsonNode): Recallable =
  ## getUsageForecast
  ## Retrieves a forecast for how much Amazon Web Services predicts that you will use over the forecast time period that you select, based on your past usage. 
  ##   body: JObject (required)
...
var getUsageForecast* = Call_GetUsageForecast_594183(name: "getUsageForecast",
    meth: HttpMethod.HttpPost, host: "ce.amazonaws.com",
    route: "/#X-Amz-Target=AWSInsightsIndexService.GetUsageForecast",
    validator: validate_GetUsageForecast_594184, base: "/",
    url: url_GetUsageForecast_594185, schemes: {Scheme.Https, Scheme.Http})
export
  rest
