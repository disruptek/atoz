...
type
  Call_CreateDetectorModel_601031 = ref object of OpenApiRestCall_600437
proc url_CreateDetectorModel_601033(protocol: Scheme; host: string; base: string;
...
proc validate_CreateDetectorModel_601032(path: JsonNode; query: JsonNode;
...
proc call*(call_601042: Call_CreateDetectorModel_601031; path: JsonNode;
...
proc call*(call_601043: Call_CreateDetectorModel_601031; body: JsonNode): Recallable =
  ## createDetectorModel
  ## Creates a detector model.
  ##   body: JObject (required)
...
var createDetectorModel* = Call_CreateDetectorModel_601031(
    name: "createDetectorModel", meth: HttpMethod.HttpPost,
    host: "iotevents.amazonaws.com", route: "/detector-models",
    validator: validate_CreateDetectorModel_601032, base: "/",
    url: url_CreateDetectorModel_601033, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDetectorModels_600774 = ref object of OpenApiRestCall_600437
proc url_ListDetectorModels_600776(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDetectorModels_600775(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_600919: Call_ListDetectorModels_600774; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the detector models you have created. Only the metadata associated with each detector model is returned.
  ## 
...
proc call*(call_600990: Call_ListDetectorModels_600774; maxResults: int = 0;
...
var listDetectorModels* = Call_ListDetectorModels_600774(
    name: "listDetectorModels", meth: HttpMethod.HttpGet,
    host: "iotevents.amazonaws.com", route: "/detector-models",
    validator: validate_ListDetectorModels_600775, base: "/",
    url: url_ListDetectorModels_600776, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateInput_601060 = ref object of OpenApiRestCall_600437
proc url_CreateInput_601062(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateInput_601061(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601071: Call_CreateInput_601060; path: JsonNode; query: JsonNode;
...
proc call*(call_601072: Call_CreateInput_601060; body: JsonNode): Recallable =
  ## createInput
  ## Creates an input.
  ##   body: JObject (required)
...
var createInput* = Call_CreateInput_601060(name: "createInput",
                                        meth: HttpMethod.HttpPost,
                                        host: "iotevents.amazonaws.com",
                                        route: "/inputs",
                                        validator: validate_CreateInput_601061,
                                        base: "/", url: url_CreateInput_601062,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListInputs_601045 = ref object of OpenApiRestCall_600437
proc url_ListInputs_601047(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListInputs_601046(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601057: Call_ListInputs_601045; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the inputs you have created.
  ## 
...
proc call*(call_601058: Call_ListInputs_601045; maxResults: int = 0;
          nextToken: string = ""): Recallable =
  ## listInputs
  ## Lists the inputs you have created.
  ##   maxResults: int
...
var listInputs* = Call_ListInputs_601045(name: "listInputs",
                                      meth: HttpMethod.HttpGet,
                                      host: "iotevents.amazonaws.com",
                                      route: "/inputs",
                                      validator: validate_ListInputs_601046,
                                      base: "/", url: url_ListInputs_601047,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDetectorModel_601104 = ref object of OpenApiRestCall_600437
proc url_UpdateDetectorModel_601106(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDetectorModel_601105(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_601107 = path.getOrDefault("detectorModelName")
  valid_601107 = validateParameter(valid_601107, JString, required = true,
                                 default = nil)
  if valid_601107 != nil:
    section.add "detectorModelName", valid_601107
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601116: Call_UpdateDetectorModel_601104; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a detector model. Detectors (instances) spawned by the previous version are deleted and then re-created as new inputs arrive.
  ## 
...
proc call*(call_601117: Call_UpdateDetectorModel_601104; detectorModelName: string;
  ...
  add(path_601118, "detectorModelName", newJString(detectorModelName))
  if body != nil:
    body_601119 = body
  result = call_601117.call(path_601118, nil, nil, nil, body_601119)

var updateDetectorModel* = Call_UpdateDetectorModel_601104(
    name: "updateDetectorModel", meth: HttpMethod.HttpPost,
    host: "iotevents.amazonaws.com",
    route: "/detector-models/{detectorModelName}",
    validator: validate_UpdateDetectorModel_601105, base: "/",
    url: url_UpdateDetectorModel_601106, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDetectorModel_601074 = ref object of OpenApiRestCall_600437
proc url_DescribeDetectorModel_601076(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDetectorModel_601075(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorModelName` field"
  var valid_601091 = path.getOrDefault("detectorModelName")
  valid_601091 = validateParameter(valid_601091, JString, required = true,
                                 default = nil)
  if valid_601091 != nil:
    section.add "detectorModelName", valid_601091
  result.add "path", section
  ## parameters in `query` object:
  ##   version: JString
...
proc call*(call_601100: Call_DescribeDetectorModel_601074; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a detector model. If the <code>"version"</code> parameter is not specified, information about the latest version is returned.
  ## 
...
proc call*(call_601101: Call_DescribeDetectorModel_601074;
  ...
  add(path_601102, "detectorModelName", newJString(detectorModelName))
  add(query_601103, "version", newJString(version))
  result = call_601101.call(path_601102, query_601103, nil, nil, nil)

var describeDetectorModel* = Call_DescribeDetectorModel_601074(
    name: "describeDetectorModel", meth: HttpMethod.HttpGet,
    host: "iotevents.amazonaws.com",
    route: "/detector-models/{detectorModelName}",
    validator: validate_DescribeDetectorModel_601075, base: "/",
    url: url_DescribeDetectorModel_601076, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDetectorModel_601120 = ref object of OpenApiRestCall_600437
proc url_DeleteDetectorModel_601122(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDetectorModel_601121(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorModelName` field"
  var valid_601123 = path.getOrDefault("detectorModelName")
  valid_601123 = validateParameter(valid_601123, JString, required = true,
                                 default = nil)
  if valid_601123 != nil:
    section.add "detectorModelName", valid_601123
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601131: Call_DeleteDetectorModel_601120; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a detector model. Any active instances of the detector model are also deleted.
  ## 
...
proc call*(call_601132: Call_DeleteDetectorModel_601120; detectorModelName: string): Recallable =
  ## deleteDetectorModel
  ## Deletes a detector model. Any active instances of the detector model are also deleted.
  ##   detectorModelName: string (required)
  ##                    : The name of the detector model to be deleted.
  var path_601133 = newJObject()
  add(path_601133, "detectorModelName", newJString(detectorModelName))
  result = call_601132.call(path_601133, nil, nil, nil, nil)

var deleteDetectorModel* = Call_DeleteDetectorModel_601120(
    name: "deleteDetectorModel", meth: HttpMethod.HttpDelete,
    host: "iotevents.amazonaws.com",
    route: "/detector-models/{detectorModelName}",
    validator: validate_DeleteDetectorModel_601121, base: "/",
    url: url_DeleteDetectorModel_601122, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateInput_601148 = ref object of OpenApiRestCall_600437
proc url_UpdateInput_601150(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateInput_601149(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ## Updates an input.
  ## 
  var section: JsonNode
  ...
  var valid_601151 = path.getOrDefault("inputName")
  valid_601151 = validateParameter(valid_601151, JString, required = true,
                                 default = nil)
  if valid_601151 != nil:
    section.add "inputName", valid_601151
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601160: Call_UpdateInput_601148; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an input.
  ## 
...
proc call*(call_601161: Call_UpdateInput_601148; inputName: string; body: JsonNode): Recallable =
  ## updateInput
  ## Updates an input.
  ...
  add(path_601162, "inputName", newJString(inputName))
  if body != nil:
    body_601163 = body
  result = call_601161.call(path_601162, nil, nil, nil, body_601163)

var updateInput* = Call_UpdateInput_601148(name: "updateInput",
                                        meth: HttpMethod.HttpPut,
                                        host: "iotevents.amazonaws.com",
                                        route: "/inputs/{inputName}",
                                        validator: validate_UpdateInput_601149,
                                        base: "/", url: url_UpdateInput_601150,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInput_601134 = ref object of OpenApiRestCall_600437
proc url_DescribeInput_601136(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInput_601135(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ## Describes an input.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `inputName` field"
  var valid_601137 = path.getOrDefault("inputName")
  valid_601137 = validateParameter(valid_601137, JString, required = true,
                                 default = nil)
  if valid_601137 != nil:
    section.add "inputName", valid_601137
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601145: Call_DescribeInput_601134; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes an input.
  ## 
...
proc call*(call_601146: Call_DescribeInput_601134; inputName: string): Recallable =
  ## describeInput
  ## Describes an input.
  ##   inputName: string (required)
  ##            : The name of the input.
  var path_601147 = newJObject()
  add(path_601147, "inputName", newJString(inputName))
  result = call_601146.call(path_601147, nil, nil, nil, nil)

var describeInput* = Call_DescribeInput_601134(name: "describeInput",
    meth: HttpMethod.HttpGet, host: "iotevents.amazonaws.com",
    route: "/inputs/{inputName}", validator: validate_DescribeInput_601135,
    base: "/", url: url_DescribeInput_601136, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteInput_601164 = ref object of OpenApiRestCall_600437
proc url_DeleteInput_601166(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteInput_601165(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes an input.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `inputName` field"
  var valid_601167 = path.getOrDefault("inputName")
  valid_601167 = validateParameter(valid_601167, JString, required = true,
                                 default = nil)
  if valid_601167 != nil:
    section.add "inputName", valid_601167
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601175: Call_DeleteInput_601164; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an input.
  ## 
...
proc call*(call_601176: Call_DeleteInput_601164; inputName: string): Recallable =
  ## deleteInput
  ## Deletes an input.
  ##   inputName: string (required)
  ##            : The name of the input to delete.
  var path_601177 = newJObject()
  add(path_601177, "inputName", newJString(inputName))
  result = call_601176.call(path_601177, nil, nil, nil, nil)

var deleteInput* = Call_DeleteInput_601164(name: "deleteInput",
                                        meth: HttpMethod.HttpDelete,
                                        host: "iotevents.amazonaws.com",
                                        route: "/inputs/{inputName}",
                                        validator: validate_DeleteInput_601165,
                                        base: "/", url: url_DeleteInput_601166,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutLoggingOptions_601190 = ref object of OpenApiRestCall_600437
proc url_PutLoggingOptions_601192(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutLoggingOptions_601191(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601201: Call_PutLoggingOptions_601190; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Sets or updates the AWS IoT Events logging options.</p> <p>If you update the value of any <code>"loggingOptions"</code> field, it takes up to one minute for the change to take effect. Also, if you change the policy attached to the role you specified in the <code>"roleArn"</code> field (for example, to correct an invalid policy) it takes up to five minutes for that change to take effect.</p>
  ## 
...
proc call*(call_601202: Call_PutLoggingOptions_601190; body: JsonNode): Recallable =
  ## putLoggingOptions
  ## <p>Sets or updates the AWS IoT Events logging options.</p> <p>If you update the value of any <code>"loggingOptions"</code> field, it takes up to one minute for the change to take effect. Also, if you change the policy attached to the role you specified in the <code>"roleArn"</code> field (for example, to correct an invalid policy) it takes up to five minutes for that change to take effect.</p>
  ##   body: JObject (required)
...
var putLoggingOptions* = Call_PutLoggingOptions_601190(name: "putLoggingOptions",
    meth: HttpMethod.HttpPut, host: "iotevents.amazonaws.com", route: "/logging",
    validator: validate_PutLoggingOptions_601191, base: "/",
    url: url_PutLoggingOptions_601192, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeLoggingOptions_601178 = ref object of OpenApiRestCall_600437
proc url_DescribeLoggingOptions_601180(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeLoggingOptions_601179(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601188: Call_DescribeLoggingOptions_601178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the current settings of the AWS IoT Events logging options.
  ## 
...
proc call*(call_601189: Call_DescribeLoggingOptions_601178): Recallable =
  ## describeLoggingOptions
  ## Retrieves the current settings of the AWS IoT Events logging options.
  result = call_601189.call(nil, nil, nil, nil, nil)

var describeLoggingOptions* = Call_DescribeLoggingOptions_601178(
    name: "describeLoggingOptions", meth: HttpMethod.HttpGet,
    host: "iotevents.amazonaws.com", route: "/logging",
    validator: validate_DescribeLoggingOptions_601179, base: "/",
    url: url_DescribeLoggingOptions_601180, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDetectorModelVersions_601204 = ref object of OpenApiRestCall_600437
proc url_ListDetectorModelVersions_601206(protocol: Scheme; host: string;
...
proc validate_ListDetectorModelVersions_601205(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `detectorModelName` field"
  var valid_601207 = path.getOrDefault("detectorModelName")
  valid_601207 = validateParameter(valid_601207, JString, required = true,
                                 default = nil)
  if valid_601207 != nil:
    section.add "detectorModelName", valid_601207
  result.add "path", section
  ## parameters in `query` object:
  ##   maxResults: JInt
  ##             : The maximum number of results to return at one time.
  ...
  var valid_601209 = query.getOrDefault("nextToken")
  valid_601209 = validateParameter(valid_601209, JString, required = false,
                                 default = nil)
  if valid_601209 != nil:
    section.add "nextToken", valid_601209
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601217: Call_ListDetectorModelVersions_601204; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the versions of a detector model. Only the metadata associated with each detector model version is returned.
  ## 
...
proc call*(call_601218: Call_ListDetectorModelVersions_601204;
  ...
  add(query_601220, "maxResults", newJInt(maxResults))
  add(query_601220, "nextToken", newJString(nextToken))
  add(path_601219, "detectorModelName", newJString(detectorModelName))
  result = call_601218.call(path_601219, query_601220, nil, nil, nil)

var listDetectorModelVersions* = Call_ListDetectorModelVersions_601204(
    name: "listDetectorModelVersions", meth: HttpMethod.HttpGet,
    host: "iotevents.amazonaws.com",
    route: "/detector-models/{detectorModelName}/versions",
    validator: validate_ListDetectorModelVersions_601205, base: "/",
    url: url_ListDetectorModelVersions_601206,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_601235 = ref object of OpenApiRestCall_600437
proc url_TagResource_601237(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_601236(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_601238 = query.getOrDefault("resourceArn")
  valid_601238 = validateParameter(valid_601238, JString, required = true,
                                 default = nil)
  if valid_601238 != nil:
    section.add "resourceArn", valid_601238
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601247: Call_TagResource_601235; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds to or modifies the tags of the given resource. Tags are metadata that can be used to manage a resource.
  ## 
...
proc call*(call_601248: Call_TagResource_601235; resourceArn: string; body: JsonNode): Recallable =
  ## tagResource
  ## Adds to or modifies the tags of the given resource. Tags are metadata that can be used to manage a resource.
  ...
  add(query_601249, "resourceArn", newJString(resourceArn))
  if body != nil:
    body_601250 = body
  result = call_601248.call(nil, query_601249, nil, nil, body_601250)

var tagResource* = Call_TagResource_601235(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "iotevents.amazonaws.com",
                                        route: "/tags#resourceArn",
                                        validator: validate_TagResource_601236,
                                        base: "/", url: url_TagResource_601237,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_601221 = ref object of OpenApiRestCall_600437
proc url_ListTagsForResource_601223(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_601222(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert query != nil,
        "query argument is necessary due to required `resourceArn` field"
  var valid_601224 = query.getOrDefault("resourceArn")
  valid_601224 = validateParameter(valid_601224, JString, required = true,
                                 default = nil)
  if valid_601224 != nil:
    section.add "resourceArn", valid_601224
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601232: Call_ListTagsForResource_601221; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the tags (metadata) you have assigned to the resource.
  ## 
...
proc call*(call_601233: Call_ListTagsForResource_601221; resourceArn: string): Recallable =
  ## listTagsForResource
  ## Lists the tags (metadata) you have assigned to the resource.
  ##   resourceArn: string (required)
  ##              : The ARN of the resource.
  var query_601234 = newJObject()
  add(query_601234, "resourceArn", newJString(resourceArn))
  result = call_601233.call(nil, query_601234, nil, nil, nil)

var listTagsForResource* = Call_ListTagsForResource_601221(
    name: "listTagsForResource", meth: HttpMethod.HttpGet,
    host: "iotevents.amazonaws.com", route: "/tags#resourceArn",
    validator: validate_ListTagsForResource_601222, base: "/",
    url: url_ListTagsForResource_601223, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_601251 = ref object of OpenApiRestCall_600437
proc url_UntagResource_601253(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_601252(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601263: Call_UntagResource_601251; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the given tags (metadata) from the resource.
  ## 
...
proc call*(call_601264: Call_UntagResource_601251; resourceArn: string;
  ...
  add(query_601265, "resourceArn", newJString(resourceArn))
  if tagKeys != nil:
    query_601265.add "tagKeys", tagKeys
  result = call_601264.call(nil, query_601265, nil, nil, nil)

var untagResource* = Call_UntagResource_601251(name: "untagResource",
    meth: HttpMethod.HttpDelete, host: "iotevents.amazonaws.com",
    route: "/tags#resourceArn&tagKeys", validator: validate_UntagResource_601252,
    base: "/", url: url_UntagResource_601253, schemes: {Scheme.Https, Scheme.Http})
export
  rest
