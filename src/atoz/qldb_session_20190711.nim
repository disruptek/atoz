...
type
  Call_SendCommand_593761 = ref object of OpenApiRestCall_593424
proc url_SendCommand_593763(protocol: Scheme; host: string; base: string;
...
proc validate_SendCommand_593762(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593919: Call_SendCommand_593761; path: JsonNode; query: JsonNode;
...
proc call*(call_593990: Call_SendCommand_593761; body: JsonNode): Recallable =
  ## sendCommand
  ## Sends a command to an Amazon QLDB ledger.
  ##   body: JObject (required)
...
var sendCommand* = Call_SendCommand_593761(name: "sendCommand",
                                        meth: HttpMethod.HttpPost,
                                        host: "session.qldb.amazonaws.com", route: "/#X-Amz-Target=QLDBSession.SendCommand",
                                        validator: validate_SendCommand_593762,
                                        base: "/", url: url_SendCommand_593763,
