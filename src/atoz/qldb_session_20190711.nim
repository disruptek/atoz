...
type
  Call_SendCommand_772924 = ref object of OpenApiRestCall_772588
proc url_SendCommand_772926(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_SendCommand_772925(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_773082: Call_SendCommand_772924; path: JsonNode; query: JsonNode;
...
proc call*(call_773153: Call_SendCommand_772924; body: JsonNode): Recallable =
  ## sendCommand
  ## Sends a command to an Amazon QLDB ledger.
  ##   body: JObject (required)
...
var sendCommand* = Call_SendCommand_772924(name: "sendCommand",
                                        meth: HttpMethod.HttpPost,
                                        host: "session.qldb.amazonaws.com", route: "/#X-Amz-Target=QLDBSession.SendCommand",
                                        validator: validate_SendCommand_772925,
                                        base: "/", url: url_SendCommand_772926,
