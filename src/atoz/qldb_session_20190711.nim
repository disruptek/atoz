...
type
  Call_SendCommand_610987 = ref object of OpenApiRestCall_610649
proc url_SendCommand_610989(protocol: Scheme; host: string; base: string;
...
proc validate_SendCommand_610988(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_611145: Call_SendCommand_610987; path: JsonNode; query: JsonNode;
...
proc call*(call_611216: Call_SendCommand_610987; body: JsonNode): Recallable =
  ## sendCommand
  ## Sends a command to an Amazon QLDB ledger.
  ##   body: JObject (required)
...
var sendCommand* = Call_SendCommand_610987(name: "sendCommand",
                                        meth: HttpMethod.HttpPost,
                                        host: "session.qldb.amazonaws.com", route: "/#X-Amz-Target=QLDBSession.SendCommand",
                                        validator: validate_SendCommand_610988,
                                        base: "/", url: url_SendCommand_610989,
