...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_GenerateDataSet_21625770 = ref object of OpenApiRestCall_21625426
proc url_GenerateDataSet_21625772(protocol: Scheme; host: string; base: string;
...
proc validate_GenerateDataSet_21625771(path: JsonNode; query: JsonNode;
...
proc call*(call_21625920: Call_GenerateDataSet_21625770; path: JsonNode = nil;
...
proc call*(call_21625983: Call_GenerateDataSet_21625770; body: JsonNode): Recallable =
  ## generateDataSet
  ## Given a data set type and data set publication date, asynchronously publishes the requested data set to the specified S3 bucket and notifies the specified SNS topic once the data is available. Returns a unique request identifier that can be used to correlate requests with notifications from the SNS topic. Data sets will be published in comma-separated values (CSV) format with the file name {data_set_type}_YYYY-MM-DD.csv. If a file with the same name already exists (e.g. if the same data set is requested twice), the original file will be overwritten by the new file. Requires a Role with an attached permissions policy providing Allow permissions for the following actions: s3:PutObject, s3:GetBucketLocation, sns:GetTopicAttributes, sns:Publish, iam:GetRolePolicy.
  ##   body: JObject (required)
...
var generateDataSet* = Call_GenerateDataSet_21625770(name: "generateDataSet",
    ...
    validator: validate_GenerateDataSet_21625771, base: "/",
    makeUrl: url_GenerateDataSet_21625772, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSupportDataExport_21626020 = ref object of OpenApiRestCall_21625426
proc url_StartSupportDataExport_21626022(protocol: Scheme; host: string;
...
proc validate_StartSupportDataExport_21626021(path: JsonNode; query: JsonNode;
...
proc call*(call_21626032: Call_StartSupportDataExport_21626020;
...
proc call*(call_21626033: Call_StartSupportDataExport_21626020; body: JsonNode): Recallable =
...
var startSupportDataExport* = Call_StartSupportDataExport_21626020(
    ...
    validator: validate_StartSupportDataExport_21626021, base: "/",
    makeUrl: url_StartSupportDataExport_21626022,
