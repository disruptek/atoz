...
type
  Call_CreateBatchPrediction_21626029 = ref object of OpenApiRestCall_21625435
proc url_CreateBatchPrediction_21626031(protocol: Scheme; host: string; base: string;
...
proc validate_CreateBatchPrediction_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_CreateBatchPrediction_21626029;
...
proc call*(call_21626042: Call_CreateBatchPrediction_21626029; body: JsonNode): Recallable =
...
var createBatchPrediction* = Call_CreateBatchPrediction_21626029(
    ...
    validator: validate_CreateBatchPrediction_21626030, base: "/",
    makeUrl: url_CreateBatchPrediction_21626031,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDataSourceFromRDS_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateDataSourceFromRDS_21626046(protocol: Scheme; host: string;
...
proc validate_CreateDataSourceFromRDS_21626045(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626056: Call_CreateDataSourceFromRDS_21626044;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a <code>DataSource</code> object from an <a href="http://aws.amazon.com/rds/"> Amazon Relational Database Service</a> (Amazon RDS). A <code>DataSource</code> references data that can be used to perform <code>CreateMLModel</code>, <code>CreateEvaluation</code>, or <code>CreateBatchPrediction</code> operations.</p> <p><code>CreateDataSourceFromRDS</code> is an asynchronous operation. In response to <code>CreateDataSourceFromRDS</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the <code>DataSource</code> status to <code>PENDING</code>. After the <code>DataSource</code> is created and ready for use, Amazon ML sets the <code>Status</code> parameter to <code>COMPLETED</code>. <code>DataSource</code> in the <code>COMPLETED</code> or <code>PENDING</code> state can be used only to perform <code>&gt;CreateMLModel</code>&gt;, <code>CreateEvaluation</code>, or <code>CreateBatchPrediction</code> operations. </p> <p> If Amazon ML cannot accept the input source, it sets the <code>Status</code> parameter to <code>FAILED</code> and includes an error message in the <code>Message</code> attribute of the <code>GetDataSource</code> operation response. </p>
  ## 
...
proc call*(call_21626057: Call_CreateDataSourceFromRDS_21626044; body: JsonNode): Recallable =
...
var createDataSourceFromRDS* = Call_CreateDataSourceFromRDS_21626044(
    name: "createDataSourceFromRDS", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.CreateDataSourceFromRDS",
    validator: validate_CreateDataSourceFromRDS_21626045, base: "/",
    makeUrl: url_CreateDataSourceFromRDS_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDataSourceFromRedshift_21626059 = ref object of OpenApiRestCall_21625435
proc url_CreateDataSourceFromRedshift_21626061(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDataSourceFromRedshift_21626060(path: JsonNode;
...
proc call*(call_21626071: Call_CreateDataSourceFromRedshift_21626059;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a <code>DataSource</code> from a database hosted on an Amazon Redshift cluster. A <code>DataSource</code> references data that can be used to perform either <code>CreateMLModel</code>, <code>CreateEvaluation</code>, or <code>CreateBatchPrediction</code> operations.</p> <p><code>CreateDataSourceFromRedshift</code> is an asynchronous operation. In response to <code>CreateDataSourceFromRedshift</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the <code>DataSource</code> status to <code>PENDING</code>. After the <code>DataSource</code> is created and ready for use, Amazon ML sets the <code>Status</code> parameter to <code>COMPLETED</code>. <code>DataSource</code> in <code>COMPLETED</code> or <code>PENDING</code> states can be used to perform only <code>CreateMLModel</code>, <code>CreateEvaluation</code>, or <code>CreateBatchPrediction</code> operations. </p> <p> If Amazon ML can't accept the input source, it sets the <code>Status</code> parameter to <code>FAILED</code> and includes an error message in the <code>Message</code> attribute of the <code>GetDataSource</code> operation response. </p> <p>The observations should be contained in the database hosted on an Amazon Redshift cluster and should be specified by a <code>SelectSqlQuery</code> query. Amazon ML executes an <code>Unload</code> command in Amazon Redshift to transfer the result set of the <code>SelectSqlQuery</code> query to <code>S3StagingLocation</code>.</p> <p>After the <code>DataSource</code> has been created, it's ready for use in evaluations and batch predictions. If you plan to use the <code>DataSource</code> to train an <code>MLModel</code>, the <code>DataSource</code> also requires a recipe. A recipe describes how each input variable will be used in training an <code>MLModel</code>. Will the variable be included or excluded from training? Will the variable be manipulated; for example, will it be combined with another variable or will it be split apart into word combinations? The recipe provides answers to these questions.</p> <?oxy_insert_start author="laurama" timestamp="20160406T153842-0700"><p>You can't change an existing datasource, but you can copy and modify the settings from an existing Amazon Redshift datasource to create a new datasource. To do so, call <code>GetDataSource</code> for an existing datasource and copy the values to a <code>CreateDataSource</code> call. Change the settings that you want to change and make sure that all required fields have the appropriate values.</p> <?oxy_insert_end>
  ## 
...
proc call*(call_21626072: Call_CreateDataSourceFromRedshift_21626059;
...
var createDataSourceFromRedshift* = Call_CreateDataSourceFromRedshift_21626059(
    ...
    validator: validate_CreateDataSourceFromRedshift_21626060, base: "/",
    makeUrl: url_CreateDataSourceFromRedshift_21626061,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDataSourceFromS3_21626074 = ref object of OpenApiRestCall_21625435
proc url_CreateDataSourceFromS3_21626076(protocol: Scheme; host: string;
...
proc validate_CreateDataSourceFromS3_21626075(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_CreateDataSourceFromS3_21626074;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a <code>DataSource</code> object. A <code>DataSource</code> references data that can be used to perform <code>CreateMLModel</code>, <code>CreateEvaluation</code>, or <code>CreateBatchPrediction</code> operations.</p> <p><code>CreateDataSourceFromS3</code> is an asynchronous operation. In response to <code>CreateDataSourceFromS3</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the <code>DataSource</code> status to <code>PENDING</code>. After the <code>DataSource</code> has been created and is ready for use, Amazon ML sets the <code>Status</code> parameter to <code>COMPLETED</code>. <code>DataSource</code> in the <code>COMPLETED</code> or <code>PENDING</code> state can be used to perform only <code>CreateMLModel</code>, <code>CreateEvaluation</code> or <code>CreateBatchPrediction</code> operations. </p> <p> If Amazon ML can't accept the input source, it sets the <code>Status</code> parameter to <code>FAILED</code> and includes an error message in the <code>Message</code> attribute of the <code>GetDataSource</code> operation response. </p> <p>The observation data used in a <code>DataSource</code> should be ready to use; that is, it should have a consistent structure, and missing data values should be kept to a minimum. The observation data must reside in one or more .csv files in an Amazon Simple Storage Service (Amazon S3) location, along with a schema that describes the data items by name and type. The same schema must be used for all of the data files referenced by the <code>DataSource</code>. </p> <p>After the <code>DataSource</code> has been created, it's ready to use in evaluations and batch predictions. If you plan to use the <code>DataSource</code> to train an <code>MLModel</code>, the <code>DataSource</code> also needs a recipe. A recipe describes how each input variable will be used in training an <code>MLModel</code>. Will the variable be included or excluded from training? Will the variable be manipulated; for example, will it be combined with another variable or will it be split apart into word combinations? The recipe provides answers to these questions.</p>
  ## 
...
proc call*(call_21626087: Call_CreateDataSourceFromS3_21626074; body: JsonNode): Recallable =
...
var createDataSourceFromS3* = Call_CreateDataSourceFromS3_21626074(
    name: "createDataSourceFromS3", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.CreateDataSourceFromS3",
    validator: validate_CreateDataSourceFromS3_21626075, base: "/",
    makeUrl: url_CreateDataSourceFromS3_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEvaluation_21626089 = ref object of OpenApiRestCall_21625435
proc url_CreateEvaluation_21626091(protocol: Scheme; host: string; base: string;
...
proc validate_CreateEvaluation_21626090(path: JsonNode; query: JsonNode;
...
proc call*(call_21626101: Call_CreateEvaluation_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a new <code>Evaluation</code> of an <code>MLModel</code>. An <code>MLModel</code> is evaluated on a set of observations associated to a <code>DataSource</code>. Like a <code>DataSource</code> for an <code>MLModel</code>, the <code>DataSource</code> for an <code>Evaluation</code> contains values for the <code>Target Variable</code>. The <code>Evaluation</code> compares the predicted result for each observation to the actual outcome and provides a summary so that you know how effective the <code>MLModel</code> functions on the test data. Evaluation generates a relevant performance metric, such as BinaryAUC, RegressionRMSE or MulticlassAvgFScore based on the corresponding <code>MLModelType</code>: <code>BINARY</code>, <code>REGRESSION</code> or <code>MULTICLASS</code>. </p> <p><code>CreateEvaluation</code> is an asynchronous operation. In response to <code>CreateEvaluation</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the evaluation status to <code>PENDING</code>. After the <code>Evaluation</code> is created and ready for use, Amazon ML sets the status to <code>COMPLETED</code>. </p> <p>You can use the <code>GetEvaluation</code> operation to check progress of the evaluation during the creation operation.</p>
  ## 
...
proc call*(call_21626102: Call_CreateEvaluation_21626089; body: JsonNode): Recallable =
  ## createEvaluation
  ## <p>Creates a new <code>Evaluation</code> of an <code>MLModel</code>. An <code>MLModel</code> is evaluated on a set of observations associated to a <code>DataSource</code>. Like a <code>DataSource</code> for an <code>MLModel</code>, the <code>DataSource</code> for an <code>Evaluation</code> contains values for the <code>Target Variable</code>. The <code>Evaluation</code> compares the predicted result for each observation to the actual outcome and provides a summary so that you know how effective the <code>MLModel</code> functions on the test data. Evaluation generates a relevant performance metric, such as BinaryAUC, RegressionRMSE or MulticlassAvgFScore based on the corresponding <code>MLModelType</code>: <code>BINARY</code>, <code>REGRESSION</code> or <code>MULTICLASS</code>. </p> <p><code>CreateEvaluation</code> is an asynchronous operation. In response to <code>CreateEvaluation</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the evaluation status to <code>PENDING</code>. After the <code>Evaluation</code> is created and ready for use, Amazon ML sets the status to <code>COMPLETED</code>. </p> <p>You can use the <code>GetEvaluation</code> operation to check progress of the evaluation during the creation operation.</p>
  ##   body: JObject (required)
...
var createEvaluation* = Call_CreateEvaluation_21626089(name: "createEvaluation",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.CreateEvaluation",
    validator: validate_CreateEvaluation_21626090, base: "/",
    makeUrl: url_CreateEvaluation_21626091, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateMLModel_21626104 = ref object of OpenApiRestCall_21625435
proc url_CreateMLModel_21626106(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateMLModel_21626105(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626116: Call_CreateMLModel_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a new <code>MLModel</code> using the <code>DataSource</code> and the recipe as information sources. </p> <p>An <code>MLModel</code> is nearly immutable. Users can update only the <code>MLModelName</code> and the <code>ScoreThreshold</code> in an <code>MLModel</code> without creating a new <code>MLModel</code>. </p> <p><code>CreateMLModel</code> is an asynchronous operation. In response to <code>CreateMLModel</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the <code>MLModel</code> status to <code>PENDING</code>. After the <code>MLModel</code> has been created and ready is for use, Amazon ML sets the status to <code>COMPLETED</code>. </p> <p>You can use the <code>GetMLModel</code> operation to check the progress of the <code>MLModel</code> during the creation operation.</p> <p> <code>CreateMLModel</code> requires a <code>DataSource</code> with computed statistics, which can be created by setting <code>ComputeStatistics</code> to <code>true</code> in <code>CreateDataSourceFromRDS</code>, <code>CreateDataSourceFromS3</code>, or <code>CreateDataSourceFromRedshift</code> operations. </p>
  ## 
...
proc call*(call_21626117: Call_CreateMLModel_21626104; body: JsonNode): Recallable =
  ## createMLModel
  ## <p>Creates a new <code>MLModel</code> using the <code>DataSource</code> and the recipe as information sources. </p> <p>An <code>MLModel</code> is nearly immutable. Users can update only the <code>MLModelName</code> and the <code>ScoreThreshold</code> in an <code>MLModel</code> without creating a new <code>MLModel</code>. </p> <p><code>CreateMLModel</code> is an asynchronous operation. In response to <code>CreateMLModel</code>, Amazon Machine Learning (Amazon ML) immediately returns and sets the <code>MLModel</code> status to <code>PENDING</code>. After the <code>MLModel</code> has been created and ready is for use, Amazon ML sets the status to <code>COMPLETED</code>. </p> <p>You can use the <code>GetMLModel</code> operation to check the progress of the <code>MLModel</code> during the creation operation.</p> <p> <code>CreateMLModel</code> requires a <code>DataSource</code> with computed statistics, which can be created by setting <code>ComputeStatistics</code> to <code>true</code> in <code>CreateDataSourceFromRDS</code>, <code>CreateDataSourceFromS3</code>, or <code>CreateDataSourceFromRedshift</code> operations. </p>
  ##   body: JObject (required)
...
var createMLModel* = Call_CreateMLModel_21626104(name: "createMLModel",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.CreateMLModel",
    validator: validate_CreateMLModel_21626105, base: "/",
    makeUrl: url_CreateMLModel_21626106, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRealtimeEndpoint_21626119 = ref object of OpenApiRestCall_21625435
proc url_CreateRealtimeEndpoint_21626121(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_CreateRealtimeEndpoint_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_CreateRealtimeEndpoint_21626119;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a real-time endpoint for the <code>MLModel</code>. The endpoint contains the URI of the <code>MLModel</code>; that is, the location to send real-time prediction requests for the specified <code>MLModel</code>.
  ## 
...
proc call*(call_21626132: Call_CreateRealtimeEndpoint_21626119; body: JsonNode): Recallable =
...
var createRealtimeEndpoint* = Call_CreateRealtimeEndpoint_21626119(
    name: "createRealtimeEndpoint", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.CreateRealtimeEndpoint",
    validator: validate_CreateRealtimeEndpoint_21626120, base: "/",
    makeUrl: url_CreateRealtimeEndpoint_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBatchPrediction_21626134 = ref object of OpenApiRestCall_21625435
proc url_DeleteBatchPrediction_21626136(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteBatchPrediction_21626135(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_DeleteBatchPrediction_21626134;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Assigns the DELETED status to a <code>BatchPrediction</code>, rendering it unusable.</p> <p>After using the <code>DeleteBatchPrediction</code> operation, you can use the <a>GetBatchPrediction</a> operation to verify that the status of the <code>BatchPrediction</code> changed to DELETED.</p> <p><b>Caution:</b> The result of the <code>DeleteBatchPrediction</code> operation is irreversible.</p>
  ## 
...
proc call*(call_21626147: Call_DeleteBatchPrediction_21626134; body: JsonNode): Recallable =
...
var deleteBatchPrediction* = Call_DeleteBatchPrediction_21626134(
    name: "deleteBatchPrediction", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DeleteBatchPrediction",
    validator: validate_DeleteBatchPrediction_21626135, base: "/",
    makeUrl: url_DeleteBatchPrediction_21626136,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDataSource_21626149 = ref object of OpenApiRestCall_21625435
proc url_DeleteDataSource_21626151(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDataSource_21626150(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626161: Call_DeleteDataSource_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Assigns the DELETED status to a <code>DataSource</code>, rendering it unusable.</p> <p>After using the <code>DeleteDataSource</code> operation, you can use the <a>GetDataSource</a> operation to verify that the status of the <code>DataSource</code> changed to DELETED.</p> <p><b>Caution:</b> The results of the <code>DeleteDataSource</code> operation are irreversible.</p>
  ## 
...
proc call*(call_21626162: Call_DeleteDataSource_21626149; body: JsonNode): Recallable =
  ## deleteDataSource
  ## <p>Assigns the DELETED status to a <code>DataSource</code>, rendering it unusable.</p> <p>After using the <code>DeleteDataSource</code> operation, you can use the <a>GetDataSource</a> operation to verify that the status of the <code>DataSource</code> changed to DELETED.</p> <p><b>Caution:</b> The results of the <code>DeleteDataSource</code> operation are irreversible.</p>
  ##   body: JObject (required)
...
var deleteDataSource* = Call_DeleteDataSource_21626149(name: "deleteDataSource",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DeleteDataSource",
    validator: validate_DeleteDataSource_21626150, base: "/",
    makeUrl: url_DeleteDataSource_21626151, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEvaluation_21626164 = ref object of OpenApiRestCall_21625435
proc url_DeleteEvaluation_21626166(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEvaluation_21626165(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_DeleteEvaluation_21626164; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Assigns the <code>DELETED</code> status to an <code>Evaluation</code>, rendering it unusable.</p> <p>After invoking the <code>DeleteEvaluation</code> operation, you can use the <code>GetEvaluation</code> operation to verify that the status of the <code>Evaluation</code> changed to <code>DELETED</code>.</p> <caution><title>Caution</title> <p>The results of the <code>DeleteEvaluation</code> operation are irreversible.</p></caution>
  ## 
...
proc call*(call_21626177: Call_DeleteEvaluation_21626164; body: JsonNode): Recallable =
  ## deleteEvaluation
  ## <p>Assigns the <code>DELETED</code> status to an <code>Evaluation</code>, rendering it unusable.</p> <p>After invoking the <code>DeleteEvaluation</code> operation, you can use the <code>GetEvaluation</code> operation to verify that the status of the <code>Evaluation</code> changed to <code>DELETED</code>.</p> <caution><title>Caution</title> <p>The results of the <code>DeleteEvaluation</code> operation are irreversible.</p></caution>
  ##   body: JObject (required)
...
var deleteEvaluation* = Call_DeleteEvaluation_21626164(name: "deleteEvaluation",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DeleteEvaluation",
    validator: validate_DeleteEvaluation_21626165, base: "/",
    makeUrl: url_DeleteEvaluation_21626166, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteMLModel_21626179 = ref object of OpenApiRestCall_21625435
proc url_DeleteMLModel_21626181(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteMLModel_21626180(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626191: Call_DeleteMLModel_21626179; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Assigns the <code>DELETED</code> status to an <code>MLModel</code>, rendering it unusable.</p> <p>After using the <code>DeleteMLModel</code> operation, you can use the <code>GetMLModel</code> operation to verify that the status of the <code>MLModel</code> changed to DELETED.</p> <p><b>Caution:</b> The result of the <code>DeleteMLModel</code> operation is irreversible.</p>
  ## 
...
proc call*(call_21626192: Call_DeleteMLModel_21626179; body: JsonNode): Recallable =
  ## deleteMLModel
  ## <p>Assigns the <code>DELETED</code> status to an <code>MLModel</code>, rendering it unusable.</p> <p>After using the <code>DeleteMLModel</code> operation, you can use the <code>GetMLModel</code> operation to verify that the status of the <code>MLModel</code> changed to DELETED.</p> <p><b>Caution:</b> The result of the <code>DeleteMLModel</code> operation is irreversible.</p>
  ##   body: JObject (required)
...
var deleteMLModel* = Call_DeleteMLModel_21626179(name: "deleteMLModel",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DeleteMLModel",
    validator: validate_DeleteMLModel_21626180, base: "/",
    makeUrl: url_DeleteMLModel_21626181, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRealtimeEndpoint_21626194 = ref object of OpenApiRestCall_21625435
proc url_DeleteRealtimeEndpoint_21626196(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteRealtimeEndpoint_21626195(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626206: Call_DeleteRealtimeEndpoint_21626194;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a real time endpoint of an <code>MLModel</code>.
  ## 
...
proc call*(call_21626207: Call_DeleteRealtimeEndpoint_21626194; body: JsonNode): Recallable =
...
var deleteRealtimeEndpoint* = Call_DeleteRealtimeEndpoint_21626194(
    name: "deleteRealtimeEndpoint", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DeleteRealtimeEndpoint",
    validator: validate_DeleteRealtimeEndpoint_21626195, base: "/",
    makeUrl: url_DeleteRealtimeEndpoint_21626196,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTags_21626209 = ref object of OpenApiRestCall_21625435
proc url_DeleteTags_21626211(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteTags_21626210(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626221: Call_DeleteTags_21626209; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes the specified tags associated with an ML object. After this operation is complete, you can't recover deleted tags.</p> <p>If you specify a tag that doesn't exist, Amazon ML ignores it.</p>
  ## 
...
proc call*(call_21626222: Call_DeleteTags_21626209; body: JsonNode): Recallable =
  ## deleteTags
  ## <p>Deletes the specified tags associated with an ML object. After this operation is complete, you can't recover deleted tags.</p> <p>If you specify a tag that doesn't exist, Amazon ML ignores it.</p>
  ##   body: JObject (required)
...
var deleteTags* = Call_DeleteTags_21626209(name: "deleteTags",
                                        meth: HttpMethod.HttpPost,
                                        host: "machinelearning.amazonaws.com", route: "/#X-Amz-Target=AmazonML_20141212.DeleteTags",
                                        validator: validate_DeleteTags_21626210,
                                        base: "/", makeUrl: url_DeleteTags_21626211,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBatchPredictions_21626224 = ref object of OpenApiRestCall_21625435
proc url_DescribeBatchPredictions_21626226(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBatchPredictions_21626225(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_21626227 = query.getOrDefault("Limit")
  valid_21626227 = validateParameter(valid_21626227, JString, required = false,
                                   default = nil)
  if valid_21626227 != nil:
    section.add "Limit", valid_21626227
...
proc call*(call_21626238: Call_DescribeBatchPredictions_21626224;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a list of <code>BatchPrediction</code> operations that match the search criteria in the request.
  ## 
...
proc call*(call_21626239: Call_DescribeBatchPredictions_21626224; body: JsonNode;
  ...
  add(query_21626241, "Limit", newJString(Limit))
  add(query_21626241, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626242 = body
  result = call_21626239.call(nil, query_21626241, nil, nil, body_21626242)

var describeBatchPredictions* = Call_DescribeBatchPredictions_21626224(
    name: "describeBatchPredictions", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DescribeBatchPredictions",
    validator: validate_DescribeBatchPredictions_21626225, base: "/",
    makeUrl: url_DescribeBatchPredictions_21626226,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDataSources_21626246 = ref object of OpenApiRestCall_21625435
proc url_DescribeDataSources_21626248(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDataSources_21626247(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_21626249 = query.getOrDefault("Limit")
  valid_21626249 = validateParameter(valid_21626249, JString, required = false,
                                   default = nil)
  if valid_21626249 != nil:
    section.add "Limit", valid_21626249
...
proc call*(call_21626260: Call_DescribeDataSources_21626246; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a list of <code>DataSource</code> that match the search criteria in the request.
  ## 
...
proc call*(call_21626261: Call_DescribeDataSources_21626246; body: JsonNode;
          Limit: string = ""; NextToken: string = ""): Recallable =
  ## describeDataSources
  ## Returns a list of <code>DataSource</code> that match the search criteria in the request.
  ##   Limit: string
  ...
  add(query_21626262, "Limit", newJString(Limit))
  add(query_21626262, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626263 = body
  result = call_21626261.call(nil, query_21626262, nil, nil, body_21626263)

var describeDataSources* = Call_DescribeDataSources_21626246(
    name: "describeDataSources", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DescribeDataSources",
    validator: validate_DescribeDataSources_21626247, base: "/",
    makeUrl: url_DescribeDataSources_21626248,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEvaluations_21626264 = ref object of OpenApiRestCall_21625435
proc url_DescribeEvaluations_21626266(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEvaluations_21626265(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626278: Call_DescribeEvaluations_21626264; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a list of <code>DescribeEvaluations</code> that match the search criteria in the request.
  ## 
...
proc call*(call_21626279: Call_DescribeEvaluations_21626264; body: JsonNode;
          Limit: string = ""; NextToken: string = ""): Recallable =
  ## describeEvaluations
  ## Returns a list of <code>DescribeEvaluations</code> that match the search criteria in the request.
  ##   Limit: string
...
var describeEvaluations* = Call_DescribeEvaluations_21626264(
    name: "describeEvaluations", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DescribeEvaluations",
    validator: validate_DescribeEvaluations_21626265, base: "/",
    makeUrl: url_DescribeEvaluations_21626266,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMLModels_21626282 = ref object of OpenApiRestCall_21625435
proc url_DescribeMLModels_21626284(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMLModels_21626283(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626296: Call_DescribeMLModels_21626282; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a list of <code>MLModel</code> that match the search criteria in the request.
  ## 
...
proc call*(call_21626297: Call_DescribeMLModels_21626282; body: JsonNode;
          Limit: string = ""; NextToken: string = ""): Recallable =
  ## describeMLModels
  ## Returns a list of <code>MLModel</code> that match the search criteria in the request.
  ##   Limit: string
  ...
  add(query_21626298, "Limit", newJString(Limit))
  add(query_21626298, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626299 = body
  result = call_21626297.call(nil, query_21626298, nil, nil, body_21626299)

var describeMLModels* = Call_DescribeMLModels_21626282(name: "describeMLModels",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DescribeMLModels",
    validator: validate_DescribeMLModels_21626283, base: "/",
    makeUrl: url_DescribeMLModels_21626284, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTags_21626300 = ref object of OpenApiRestCall_21625435
proc url_DescribeTags_21626302(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeTags_21626301(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626312: Call_DescribeTags_21626300; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes one or more of the tags for your Amazon ML object.
  ## 
...
proc call*(call_21626313: Call_DescribeTags_21626300; body: JsonNode): Recallable =
  ## describeTags
  ## Describes one or more of the tags for your Amazon ML object.
  ##   body: JObject (required)
...
var describeTags* = Call_DescribeTags_21626300(name: "describeTags",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.DescribeTags",
    validator: validate_DescribeTags_21626301, base: "/", makeUrl: url_DescribeTags_21626302,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetBatchPrediction_21626315 = ref object of OpenApiRestCall_21625435
proc url_GetBatchPrediction_21626317(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetBatchPrediction_21626316(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626327: Call_GetBatchPrediction_21626315; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a <code>BatchPrediction</code> that includes detailed metadata, status, and data file information for a <code>Batch Prediction</code> request.
  ## 
...
proc call*(call_21626328: Call_GetBatchPrediction_21626315; body: JsonNode): Recallable =
  ## getBatchPrediction
  ## Returns a <code>BatchPrediction</code> that includes detailed metadata, status, and data file information for a <code>Batch Prediction</code> request.
  ##   body: JObject (required)
...
var getBatchPrediction* = Call_GetBatchPrediction_21626315(
    name: "getBatchPrediction", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.GetBatchPrediction",
    validator: validate_GetBatchPrediction_21626316, base: "/",
    makeUrl: url_GetBatchPrediction_21626317, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDataSource_21626330 = ref object of OpenApiRestCall_21625435
proc url_GetDataSource_21626332(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDataSource_21626331(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626342: Call_GetDataSource_21626330; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns a <code>DataSource</code> that includes metadata and data file information, as well as the current status of the <code>DataSource</code>.</p> <p><code>GetDataSource</code> provides results in normal or verbose format. The verbose format adds the schema description and the list of files pointed to by the DataSource to the normal format.</p>
  ## 
...
proc call*(call_21626343: Call_GetDataSource_21626330; body: JsonNode): Recallable =
  ## getDataSource
  ## <p>Returns a <code>DataSource</code> that includes metadata and data file information, as well as the current status of the <code>DataSource</code>.</p> <p><code>GetDataSource</code> provides results in normal or verbose format. The verbose format adds the schema description and the list of files pointed to by the DataSource to the normal format.</p>
  ##   body: JObject (required)
...
var getDataSource* = Call_GetDataSource_21626330(name: "getDataSource",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.GetDataSource",
    validator: validate_GetDataSource_21626331, base: "/",
    makeUrl: url_GetDataSource_21626332, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEvaluation_21626345 = ref object of OpenApiRestCall_21625435
proc url_GetEvaluation_21626347(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetEvaluation_21626346(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626357: Call_GetEvaluation_21626345; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns an <code>Evaluation</code> that includes metadata as well as the current status of the <code>Evaluation</code>.
  ## 
...
proc call*(call_21626358: Call_GetEvaluation_21626345; body: JsonNode): Recallable =
  ## getEvaluation
  ## Returns an <code>Evaluation</code> that includes metadata as well as the current status of the <code>Evaluation</code>.
  ##   body: JObject (required)
...
var getEvaluation* = Call_GetEvaluation_21626345(name: "getEvaluation",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.GetEvaluation",
    validator: validate_GetEvaluation_21626346, base: "/",
    makeUrl: url_GetEvaluation_21626347, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMLModel_21626360 = ref object of OpenApiRestCall_21625435
proc url_GetMLModel_21626362(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMLModel_21626361(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626372: Call_GetMLModel_21626360; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns an <code>MLModel</code> that includes detailed metadata, data source information, and the current status of the <code>MLModel</code>.</p> <p><code>GetMLModel</code> provides results in normal or verbose format. </p>
  ## 
...
proc call*(call_21626373: Call_GetMLModel_21626360; body: JsonNode): Recallable =
  ## getMLModel
  ## <p>Returns an <code>MLModel</code> that includes detailed metadata, data source information, and the current status of the <code>MLModel</code>.</p> <p><code>GetMLModel</code> provides results in normal or verbose format. </p>
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626374 = body
  result = call_21626373.call(nil, nil, nil, nil, body_21626374)

var getMLModel* = Call_GetMLModel_21626360(name: "getMLModel",
                                        meth: HttpMethod.HttpPost,
                                        host: "machinelearning.amazonaws.com", route: "/#X-Amz-Target=AmazonML_20141212.GetMLModel",
                                        validator: validate_GetMLModel_21626361,
                                        base: "/", makeUrl: url_GetMLModel_21626362,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_Predict_21626375 = ref object of OpenApiRestCall_21625435
proc url_Predict_21626377(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_Predict_21626376(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626380 = header.getOrDefault("X-Amz-Target")
  valid_21626380 = validateParameter(valid_21626380, JString, required = true, default = newJString(
      "AmazonML_20141212.Predict"))
  if valid_21626380 != nil:
    section.add "X-Amz-Target", valid_21626380
...
proc call*(call_21626387: Call_Predict_21626375; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Generates a prediction for the observation using the specified <code>ML Model</code>.</p> <note><title>Note</title> <p>Not all response parameters will be populated. Whether a response parameter is populated depends on the type of model requested.</p></note>
  ## 
...
proc call*(call_21626388: Call_Predict_21626375; body: JsonNode): Recallable =
  ## predict
  ## <p>Generates a prediction for the observation using the specified <code>ML Model</code>.</p> <note><title>Note</title> <p>Not all response parameters will be populated. Whether a response parameter is populated depends on the type of model requested.</p></note>
  ##   body: JObject (required)
  var body_21626389 = newJObject()
  if body != nil:
    body_21626389 = body
  result = call_21626388.call(nil, nil, nil, nil, body_21626389)

var predict* = Call_Predict_21626375(name: "predict", meth: HttpMethod.HttpPost,
                                  host: "machinelearning.amazonaws.com", route: "/#X-Amz-Target=AmazonML_20141212.Predict",
                                  validator: validate_Predict_21626376, base: "/",
                                  makeUrl: url_Predict_21626377,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBatchPrediction_21626390 = ref object of OpenApiRestCall_21625435
proc url_UpdateBatchPrediction_21626392(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateBatchPrediction_21626391(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626395 = header.getOrDefault("X-Amz-Target")
  valid_21626395 = validateParameter(valid_21626395, JString, required = true, default = newJString(
      "AmazonML_20141212.UpdateBatchPrediction"))
  if valid_21626395 != nil:
    section.add "X-Amz-Target", valid_21626395
...
proc call*(call_21626402: Call_UpdateBatchPrediction_21626390;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the <code>BatchPredictionName</code> of a <code>BatchPrediction</code>.</p> <p>You can use the <code>GetBatchPrediction</code> operation to view the contents of the updated data element.</p>
  ## 
...
proc call*(call_21626403: Call_UpdateBatchPrediction_21626390; body: JsonNode): Recallable =
  ## updateBatchPrediction
  ## <p>Updates the <code>BatchPredictionName</code> of a <code>BatchPrediction</code>.</p> <p>You can use the <code>GetBatchPrediction</code> operation to view the contents of the updated data element.</p>
  ##   body: JObject (required)
  var body_21626404 = newJObject()
  if body != nil:
    body_21626404 = body
  result = call_21626403.call(nil, nil, nil, nil, body_21626404)

var updateBatchPrediction* = Call_UpdateBatchPrediction_21626390(
    name: "updateBatchPrediction", meth: HttpMethod.HttpPost,
    host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.UpdateBatchPrediction",
    validator: validate_UpdateBatchPrediction_21626391, base: "/",
    makeUrl: url_UpdateBatchPrediction_21626392,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDataSource_21626405 = ref object of OpenApiRestCall_21625435
proc url_UpdateDataSource_21626407(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDataSource_21626406(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626417: Call_UpdateDataSource_21626405; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the <code>DataSourceName</code> of a <code>DataSource</code>.</p> <p>You can use the <code>GetDataSource</code> operation to view the contents of the updated data element.</p>
  ## 
...
proc call*(call_21626418: Call_UpdateDataSource_21626405; body: JsonNode): Recallable =
  ## updateDataSource
  ## <p>Updates the <code>DataSourceName</code> of a <code>DataSource</code>.</p> <p>You can use the <code>GetDataSource</code> operation to view the contents of the updated data element.</p>
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626419 = body
  result = call_21626418.call(nil, nil, nil, nil, body_21626419)

var updateDataSource* = Call_UpdateDataSource_21626405(name: "updateDataSource",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.UpdateDataSource",
    validator: validate_UpdateDataSource_21626406, base: "/",
    makeUrl: url_UpdateDataSource_21626407, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEvaluation_21626420 = ref object of OpenApiRestCall_21625435
proc url_UpdateEvaluation_21626422(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEvaluation_21626421(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626425 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626425 != nil:
    section.add "X-Amz-Target", valid_21626425
...
proc call*(call_21626432: Call_UpdateEvaluation_21626420; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the <code>EvaluationName</code> of an <code>Evaluation</code>.</p> <p>You can use the <code>GetEvaluation</code> operation to view the contents of the updated data element.</p>
  ## 
...
proc call*(call_21626433: Call_UpdateEvaluation_21626420; body: JsonNode): Recallable =
  ## updateEvaluation
  ## <p>Updates the <code>EvaluationName</code> of an <code>Evaluation</code>.</p> <p>You can use the <code>GetEvaluation</code> operation to view the contents of the updated data element.</p>
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626434 = body
  result = call_21626433.call(nil, nil, nil, nil, body_21626434)

var updateEvaluation* = Call_UpdateEvaluation_21626420(name: "updateEvaluation",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.UpdateEvaluation",
    validator: validate_UpdateEvaluation_21626421, base: "/",
    makeUrl: url_UpdateEvaluation_21626422, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateMLModel_21626435 = ref object of OpenApiRestCall_21625435
proc url_UpdateMLModel_21626437(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateMLModel_21626436(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626440 = header.getOrDefault("X-Amz-Target")
  valid_21626440 = validateParameter(valid_21626440, JString, required = true, default = newJString(
      "AmazonML_20141212.UpdateMLModel"))
  if valid_21626440 != nil:
    section.add "X-Amz-Target", valid_21626440
...
proc call*(call_21626447: Call_UpdateMLModel_21626435; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the <code>MLModelName</code> and the <code>ScoreThreshold</code> of an <code>MLModel</code>.</p> <p>You can use the <code>GetMLModel</code> operation to view the contents of the updated data element.</p>
  ## 
...
proc call*(call_21626448: Call_UpdateMLModel_21626435; body: JsonNode): Recallable =
  ## updateMLModel
  ## <p>Updates the <code>MLModelName</code> and the <code>ScoreThreshold</code> of an <code>MLModel</code>.</p> <p>You can use the <code>GetMLModel</code> operation to view the contents of the updated data element.</p>
  ##   body: JObject (required)
  var body_21626449 = newJObject()
  if body != nil:
    body_21626449 = body
  result = call_21626448.call(nil, nil, nil, nil, body_21626449)

var updateMLModel* = Call_UpdateMLModel_21626435(name: "updateMLModel",
    meth: HttpMethod.HttpPost, host: "machinelearning.amazonaws.com",
    route: "/#X-Amz-Target=AmazonML_20141212.UpdateMLModel",
    validator: validate_UpdateMLModel_21626436, base: "/",
    makeUrl: url_UpdateMLModel_21626437, schemes: {Scheme.Https, Scheme.Http})
export
  rest
