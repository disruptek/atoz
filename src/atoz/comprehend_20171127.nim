...
type
  Call_BatchDetectDominantLanguage_600774 = ref object of OpenApiRestCall_600437
proc url_BatchDetectDominantLanguage_600776(protocol: Scheme; host: string;
...
proc validate_BatchDetectDominantLanguage_600775(path: JsonNode; query: JsonNode;
...
proc call*(call_600932: Call_BatchDetectDominantLanguage_600774; path: JsonNode;
...
proc call*(call_601003: Call_BatchDetectDominantLanguage_600774; body: JsonNode): Recallable =
...
var batchDetectDominantLanguage* = Call_BatchDetectDominantLanguage_600774(
    ...
    validator: validate_BatchDetectDominantLanguage_600775, base: "/",
    url: url_BatchDetectDominantLanguage_600776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDetectEntities_601043 = ref object of OpenApiRestCall_600437
proc url_BatchDetectEntities_601045(protocol: Scheme; host: string; base: string;
...
proc validate_BatchDetectEntities_601044(path: JsonNode; query: JsonNode;
...
proc call*(call_601055: Call_BatchDetectEntities_601043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Inspects the text of a batch of documents for named entities and returns information about them. For more information about named entities, see <a>how-entities</a> 
  ## 
...
proc call*(call_601056: Call_BatchDetectEntities_601043; body: JsonNode): Recallable =
  ## batchDetectEntities
  ## Inspects the text of a batch of documents for named entities and returns information about them. For more information about named entities, see <a>how-entities</a> 
  ##   body: JObject (required)
...
var batchDetectEntities* = Call_BatchDetectEntities_601043(
    name: "batchDetectEntities", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.BatchDetectEntities",
    validator: validate_BatchDetectEntities_601044, base: "/",
    url: url_BatchDetectEntities_601045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDetectKeyPhrases_601058 = ref object of OpenApiRestCall_600437
proc url_BatchDetectKeyPhrases_601060(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchDetectKeyPhrases_601059(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601070: Call_BatchDetectKeyPhrases_601058; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Detects the key noun phrases found in a batch of documents.
  ## 
...
proc call*(call_601071: Call_BatchDetectKeyPhrases_601058; body: JsonNode): Recallable =
...
var batchDetectKeyPhrases* = Call_BatchDetectKeyPhrases_601058(
    name: "batchDetectKeyPhrases", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.BatchDetectKeyPhrases",
    validator: validate_BatchDetectKeyPhrases_601059, base: "/",
    url: url_BatchDetectKeyPhrases_601060, schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDetectSentiment_601073 = ref object of OpenApiRestCall_600437
proc url_BatchDetectSentiment_601075(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchDetectSentiment_601074(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601085: Call_BatchDetectSentiment_601073; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Inspects a batch of documents and returns an inference of the prevailing sentiment, <code>POSITIVE</code>, <code>NEUTRAL</code>, <code>MIXED</code>, or <code>NEGATIVE</code>, in each one.
  ## 
...
proc call*(call_601086: Call_BatchDetectSentiment_601073; body: JsonNode): Recallable =
...
var batchDetectSentiment* = Call_BatchDetectSentiment_601073(
    name: "batchDetectSentiment", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.BatchDetectSentiment",
    validator: validate_BatchDetectSentiment_601074, base: "/",
    url: url_BatchDetectSentiment_601075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDetectSyntax_601088 = ref object of OpenApiRestCall_600437
proc url_BatchDetectSyntax_601090(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchDetectSyntax_601089(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601100: Call_BatchDetectSyntax_601088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Inspects the text of a batch of documents for the syntax and part of speech of the words in the document and returns information about them. For more information, see <a>how-syntax</a>.
  ## 
...
proc call*(call_601101: Call_BatchDetectSyntax_601088; body: JsonNode): Recallable =
  ## batchDetectSyntax
  ## Inspects the text of a batch of documents for the syntax and part of speech of the words in the document and returns information about them. For more information, see <a>how-syntax</a>.
  ##   body: JObject (required)
...
var batchDetectSyntax* = Call_BatchDetectSyntax_601088(name: "batchDetectSyntax",
    meth: HttpMethod.HttpPost, host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.BatchDetectSyntax",
    validator: validate_BatchDetectSyntax_601089, base: "/",
    url: url_BatchDetectSyntax_601090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDocumentClassifier_601103 = ref object of OpenApiRestCall_600437
proc url_CreateDocumentClassifier_601105(protocol: Scheme; host: string;
...
proc validate_CreateDocumentClassifier_601104(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601115: Call_CreateDocumentClassifier_601103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new document classifier that you can use to categorize documents. To create a classifier you provide a set of training documents that labeled with the categories that you want to use. After the classifier is trained you can use it to categorize a set of labeled documents into the categories. For more information, see <a>how-document-classification</a>.
  ## 
...
proc call*(call_601116: Call_CreateDocumentClassifier_601103; body: JsonNode): Recallable =
...
var createDocumentClassifier* = Call_CreateDocumentClassifier_601103(
    name: "createDocumentClassifier", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.CreateDocumentClassifier",
    validator: validate_CreateDocumentClassifier_601104, base: "/",
    url: url_CreateDocumentClassifier_601105, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEntityRecognizer_601118 = ref object of OpenApiRestCall_600437
proc url_CreateEntityRecognizer_601120(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEntityRecognizer_601119(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601130: Call_CreateEntityRecognizer_601118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates an entity recognizer using submitted files. After your <code>CreateEntityRecognizer</code> request is submitted, you can check job status using the API. 
  ## 
...
proc call*(call_601131: Call_CreateEntityRecognizer_601118; body: JsonNode): Recallable =
...
var createEntityRecognizer* = Call_CreateEntityRecognizer_601118(
    name: "createEntityRecognizer", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.CreateEntityRecognizer",
    validator: validate_CreateEntityRecognizer_601119, base: "/",
    url: url_CreateEntityRecognizer_601120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDocumentClassifier_601133 = ref object of OpenApiRestCall_600437
proc url_DeleteDocumentClassifier_601135(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteDocumentClassifier_601134(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601145: Call_DeleteDocumentClassifier_601133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a previously created document classifier</p> <p>Only those classifiers that are in terminated states (IN_ERROR, TRAINED) will be deleted. If an active inference job is using the model, a <code>ResourceInUseException</code> will be returned.</p> <p>This is an asynchronous action that puts the classifier into a DELETING state, and it is then removed by a background job. Once removed, the classifier disappears from your account and is no longer available for use. </p>
  ## 
...
proc call*(call_601146: Call_DeleteDocumentClassifier_601133; body: JsonNode): Recallable =
...
var deleteDocumentClassifier* = Call_DeleteDocumentClassifier_601133(
    name: "deleteDocumentClassifier", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DeleteDocumentClassifier",
    validator: validate_DeleteDocumentClassifier_601134, base: "/",
    url: url_DeleteDocumentClassifier_601135, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEntityRecognizer_601148 = ref object of OpenApiRestCall_600437
proc url_DeleteEntityRecognizer_601150(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEntityRecognizer_601149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601160: Call_DeleteEntityRecognizer_601148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes an entity recognizer.</p> <p>Only those recognizers that are in terminated states (IN_ERROR, TRAINED) will be deleted. If an active inference job is using the model, a <code>ResourceInUseException</code> will be returned.</p> <p>This is an asynchronous action that puts the recognizer into a DELETING state, and it is then removed by a background job. Once removed, the recognizer disappears from your account and is no longer available for use. </p>
  ## 
...
proc call*(call_601161: Call_DeleteEntityRecognizer_601148; body: JsonNode): Recallable =
...
var deleteEntityRecognizer* = Call_DeleteEntityRecognizer_601148(
    name: "deleteEntityRecognizer", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DeleteEntityRecognizer",
    validator: validate_DeleteEntityRecognizer_601149, base: "/",
    url: url_DeleteEntityRecognizer_601150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDocumentClassificationJob_601163 = ref object of OpenApiRestCall_600437
proc url_DescribeDocumentClassificationJob_601165(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDocumentClassificationJob_601164(path: JsonNode;
...
proc call*(call_601175: Call_DescribeDocumentClassificationJob_601163;
...
proc call*(call_601176: Call_DescribeDocumentClassificationJob_601163;
          body: JsonNode): Recallable =
...
var describeDocumentClassificationJob* = Call_DescribeDocumentClassificationJob_601163(
    ...
    validator: validate_DescribeDocumentClassificationJob_601164, base: "/",
    url: url_DescribeDocumentClassificationJob_601165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDocumentClassifier_601178 = ref object of OpenApiRestCall_600437
proc url_DescribeDocumentClassifier_601180(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDocumentClassifier_601179(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601190: Call_DescribeDocumentClassifier_601178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a document classifier.
  ## 
...
proc call*(call_601191: Call_DescribeDocumentClassifier_601178; body: JsonNode): Recallable =
...
var describeDocumentClassifier* = Call_DescribeDocumentClassifier_601178(
    ...
    validator: validate_DescribeDocumentClassifier_601179, base: "/",
    url: url_DescribeDocumentClassifier_601180,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDominantLanguageDetectionJob_601193 = ref object of OpenApiRestCall_600437
proc url_DescribeDominantLanguageDetectionJob_601195(protocol: Scheme;
...
proc validate_DescribeDominantLanguageDetectionJob_601194(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601205: Call_DescribeDominantLanguageDetectionJob_601193;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the properties associated with a dominant language detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_601206: Call_DescribeDominantLanguageDetectionJob_601193;
          body: JsonNode): Recallable =
...
var describeDominantLanguageDetectionJob* = Call_DescribeDominantLanguageDetectionJob_601193(
    ...
    validator: validate_DescribeDominantLanguageDetectionJob_601194, base: "/",
    url: url_DescribeDominantLanguageDetectionJob_601195,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEntitiesDetectionJob_601208 = ref object of OpenApiRestCall_600437
proc url_DescribeEntitiesDetectionJob_601210(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEntitiesDetectionJob_601209(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601220: Call_DescribeEntitiesDetectionJob_601208; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with an entities detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_601221: Call_DescribeEntitiesDetectionJob_601208; body: JsonNode): Recallable =
...
var describeEntitiesDetectionJob* = Call_DescribeEntitiesDetectionJob_601208(
    ...
    validator: validate_DescribeEntitiesDetectionJob_601209, base: "/",
    url: url_DescribeEntitiesDetectionJob_601210,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEntityRecognizer_601223 = ref object of OpenApiRestCall_600437
proc url_DescribeEntityRecognizer_601225(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeEntityRecognizer_601224(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601235: Call_DescribeEntityRecognizer_601223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides details about an entity recognizer including status, S3 buckets containing training data, recognizer metadata, metrics, and so on.
  ## 
...
proc call*(call_601236: Call_DescribeEntityRecognizer_601223; body: JsonNode): Recallable =
...
var describeEntityRecognizer* = Call_DescribeEntityRecognizer_601223(
    name: "describeEntityRecognizer", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DescribeEntityRecognizer",
    validator: validate_DescribeEntityRecognizer_601224, base: "/",
    url: url_DescribeEntityRecognizer_601225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeKeyPhrasesDetectionJob_601238 = ref object of OpenApiRestCall_600437
proc url_DescribeKeyPhrasesDetectionJob_601240(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeKeyPhrasesDetectionJob_601239(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601250: Call_DescribeKeyPhrasesDetectionJob_601238; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a key phrases detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_601251: Call_DescribeKeyPhrasesDetectionJob_601238; body: JsonNode): Recallable =
...
var describeKeyPhrasesDetectionJob* = Call_DescribeKeyPhrasesDetectionJob_601238(
    ...
    validator: validate_DescribeKeyPhrasesDetectionJob_601239, base: "/",
    url: url_DescribeKeyPhrasesDetectionJob_601240,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSentimentDetectionJob_601253 = ref object of OpenApiRestCall_600437
proc url_DescribeSentimentDetectionJob_601255(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSentimentDetectionJob_601254(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601265: Call_DescribeSentimentDetectionJob_601253; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a sentiment detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_601266: Call_DescribeSentimentDetectionJob_601253; body: JsonNode): Recallable =
...
var describeSentimentDetectionJob* = Call_DescribeSentimentDetectionJob_601253(
    ...
    validator: validate_DescribeSentimentDetectionJob_601254, base: "/",
    url: url_DescribeSentimentDetectionJob_601255,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTopicsDetectionJob_601268 = ref object of OpenApiRestCall_600437
proc url_DescribeTopicsDetectionJob_601270(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeTopicsDetectionJob_601269(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601280: Call_DescribeTopicsDetectionJob_601268; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a topic detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_601281: Call_DescribeTopicsDetectionJob_601268; body: JsonNode): Recallable =
...
var describeTopicsDetectionJob* = Call_DescribeTopicsDetectionJob_601268(
    ...
    validator: validate_DescribeTopicsDetectionJob_601269, base: "/",
    url: url_DescribeTopicsDetectionJob_601270,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectDominantLanguage_601283 = ref object of OpenApiRestCall_600437
proc url_DetectDominantLanguage_601285(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectDominantLanguage_601284(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601295: Call_DetectDominantLanguage_601283; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Determines the dominant language of the input text. For a list of languages that Amazon Comprehend can detect, see <a href="https://docs.aws.amazon.com/comprehend/latest/dg/how-languages.html">Amazon Comprehend Supported Languages</a>. 
  ## 
...
proc call*(call_601296: Call_DetectDominantLanguage_601283; body: JsonNode): Recallable =
...
var detectDominantLanguage* = Call_DetectDominantLanguage_601283(
    name: "detectDominantLanguage", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DetectDominantLanguage",
    validator: validate_DetectDominantLanguage_601284, base: "/",
    url: url_DetectDominantLanguage_601285, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectEntities_601298 = ref object of OpenApiRestCall_600437
proc url_DetectEntities_601300(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectEntities_601299(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601310: Call_DetectEntities_601298; path: JsonNode; query: JsonNode;
...
proc call*(call_601311: Call_DetectEntities_601298; body: JsonNode): Recallable =
  ## detectEntities
  ## Inspects text for named entities, and returns information about them. For more information, about named entities, see <a>how-entities</a>. 
  ##   body: JObject (required)
...
var detectEntities* = Call_DetectEntities_601298(name: "detectEntities",
    meth: HttpMethod.HttpPost, host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DetectEntities",
    validator: validate_DetectEntities_601299, base: "/", url: url_DetectEntities_601300,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectKeyPhrases_601313 = ref object of OpenApiRestCall_600437
proc url_DetectKeyPhrases_601315(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectKeyPhrases_601314(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601325: Call_DetectKeyPhrases_601313; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Detects the key noun phrases found in the text. 
  ## 
...
proc call*(call_601326: Call_DetectKeyPhrases_601313; body: JsonNode): Recallable =
  ## detectKeyPhrases
  ## Detects the key noun phrases found in the text. 
  ##   body: JObject (required)
...
var detectKeyPhrases* = Call_DetectKeyPhrases_601313(name: "detectKeyPhrases",
    meth: HttpMethod.HttpPost, host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DetectKeyPhrases",
    validator: validate_DetectKeyPhrases_601314, base: "/",
    url: url_DetectKeyPhrases_601315, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectSentiment_601328 = ref object of OpenApiRestCall_600437
proc url_DetectSentiment_601330(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectSentiment_601329(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_601340: Call_DetectSentiment_601328; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Inspects text and returns an inference of the prevailing sentiment (<code>POSITIVE</code>, <code>NEUTRAL</code>, <code>MIXED</code>, or <code>NEGATIVE</code>). 
  ## 
...
proc call*(call_601341: Call_DetectSentiment_601328; body: JsonNode): Recallable =
  ## detectSentiment
  ## Inspects text and returns an inference of the prevailing sentiment (<code>POSITIVE</code>, <code>NEUTRAL</code>, <code>MIXED</code>, or <code>NEGATIVE</code>). 
  ##   body: JObject (required)
...
var detectSentiment* = Call_DetectSentiment_601328(name: "detectSentiment",
    meth: HttpMethod.HttpPost, host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DetectSentiment",
    validator: validate_DetectSentiment_601329, base: "/", url: url_DetectSentiment_601330,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectSyntax_601343 = ref object of OpenApiRestCall_600437
proc url_DetectSyntax_601345(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectSyntax_601344(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601355: Call_DetectSyntax_601343; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Inspects text for syntax and the part of speech of words in the document. For more information, <a>how-syntax</a>.
  ## 
...
proc call*(call_601356: Call_DetectSyntax_601343; body: JsonNode): Recallable =
  ## detectSyntax
  ## Inspects text for syntax and the part of speech of words in the document. For more information, <a>how-syntax</a>.
  ##   body: JObject (required)
...
var detectSyntax* = Call_DetectSyntax_601343(name: "detectSyntax",
    meth: HttpMethod.HttpPost, host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.DetectSyntax",
    validator: validate_DetectSyntax_601344, base: "/", url: url_DetectSyntax_601345,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDocumentClassificationJobs_601358 = ref object of OpenApiRestCall_600437
proc url_ListDocumentClassificationJobs_601360(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDocumentClassificationJobs_601359(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_601362 = query.getOrDefault("MaxResults")
  valid_601362 = validateParameter(valid_601362, JString, required = false,
                                 default = nil)
  if valid_601362 != nil:
    section.add "MaxResults", valid_601362
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601372: Call_ListDocumentClassificationJobs_601358; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of the documentation classification jobs that you have submitted.
  ## 
...
proc call*(call_601373: Call_ListDocumentClassificationJobs_601358; body: JsonNode;
  ...
  var body_601375 = newJObject()
  add(query_601374, "NextToken", newJString(NextToken))
  if body != nil:
    body_601375 = body
  add(query_601374, "MaxResults", newJString(MaxResults))
  result = call_601373.call(nil, query_601374, nil, nil, body_601375)

var listDocumentClassificationJobs* = Call_ListDocumentClassificationJobs_601358(
    ...
    validator: validate_ListDocumentClassificationJobs_601359, base: "/",
    url: url_ListDocumentClassificationJobs_601360,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDocumentClassifiers_601377 = ref object of OpenApiRestCall_600437
proc url_ListDocumentClassifiers_601379(protocol: Scheme; host: string; base: string;
...
proc validate_ListDocumentClassifiers_601378(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_601381 = query.getOrDefault("MaxResults")
  valid_601381 = validateParameter(valid_601381, JString, required = false,
                                 default = nil)
  if valid_601381 != nil:
    section.add "MaxResults", valid_601381
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601391: Call_ListDocumentClassifiers_601377; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of the document classifiers that you have created.
  ## 
...
proc call*(call_601392: Call_ListDocumentClassifiers_601377; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  if body != nil:
    body_601394 = body
  add(query_601393, "MaxResults", newJString(MaxResults))
  result = call_601392.call(nil, query_601393, nil, nil, body_601394)

var listDocumentClassifiers* = Call_ListDocumentClassifiers_601377(
    name: "listDocumentClassifiers", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.ListDocumentClassifiers",
    validator: validate_ListDocumentClassifiers_601378, base: "/",
    url: url_ListDocumentClassifiers_601379, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDominantLanguageDetectionJobs_601395 = ref object of OpenApiRestCall_600437
proc url_ListDominantLanguageDetectionJobs_601397(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDominantLanguageDetectionJobs_601396(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_601398 = query.getOrDefault("NextToken")
  valid_601398 = validateParameter(valid_601398, JString, required = false,
                                 default = nil)
  if valid_601398 != nil:
    section.add "NextToken", valid_601398
  var valid_601399 = query.getOrDefault("MaxResults")
  valid_601399 = validateParameter(valid_601399, JString, required = false,
                                 default = nil)
  if valid_601399 != nil:
    section.add "MaxResults", valid_601399
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601409: Call_ListDominantLanguageDetectionJobs_601395;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a list of the dominant language detection jobs that you have submitted.
  ## 
...
proc call*(call_601410: Call_ListDominantLanguageDetectionJobs_601395;
  ...
  add(query_601411, "NextToken", newJString(NextToken))
  if body != nil:
    body_601412 = body
  add(query_601411, "MaxResults", newJString(MaxResults))
  result = call_601410.call(nil, query_601411, nil, nil, body_601412)

var listDominantLanguageDetectionJobs* = Call_ListDominantLanguageDetectionJobs_601395(
    ...
    validator: validate_ListDominantLanguageDetectionJobs_601396, base: "/",
    url: url_ListDominantLanguageDetectionJobs_601397,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEntitiesDetectionJobs_601413 = ref object of OpenApiRestCall_600437
proc url_ListEntitiesDetectionJobs_601415(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEntitiesDetectionJobs_601414(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601427: Call_ListEntitiesDetectionJobs_601413; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of the entity detection jobs that you have submitted.
  ## 
...
proc call*(call_601428: Call_ListEntitiesDetectionJobs_601413; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listEntitiesDetectionJobs* = Call_ListEntitiesDetectionJobs_601413(
    name: "listEntitiesDetectionJobs", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.ListEntitiesDetectionJobs",
    validator: validate_ListEntitiesDetectionJobs_601414, base: "/",
    url: url_ListEntitiesDetectionJobs_601415,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEntityRecognizers_601431 = ref object of OpenApiRestCall_600437
proc url_ListEntityRecognizers_601433(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEntityRecognizers_601432(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_601435 = query.getOrDefault("MaxResults")
...
proc call*(call_601445: Call_ListEntityRecognizers_601431; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Gets a list of the properties of all entity recognizers that you created, including recognizers currently in training. Allows you to filter the list of recognizers based on criteria such as status and submission time. This call returns up to 500 entity recognizers in the list, with a default number of 100 recognizers in the list.</p> <p>The results of this list are not in any particular order. Please get the list and sort locally if needed.</p>
  ## 
...
proc call*(call_601446: Call_ListEntityRecognizers_601431; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listEntityRecognizers* = Call_ListEntityRecognizers_601431(
    name: "listEntityRecognizers", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.ListEntityRecognizers",
    validator: validate_ListEntityRecognizers_601432, base: "/",
    url: url_ListEntityRecognizers_601433, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListKeyPhrasesDetectionJobs_601449 = ref object of OpenApiRestCall_600437
proc url_ListKeyPhrasesDetectionJobs_601451(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListKeyPhrasesDetectionJobs_601450(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_601452 = query.getOrDefault("NextToken")
  valid_601452 = validateParameter(valid_601452, JString, required = false,
                                 default = nil)
  if valid_601452 != nil:
    section.add "NextToken", valid_601452
  var valid_601453 = query.getOrDefault("MaxResults")
  valid_601453 = validateParameter(valid_601453, JString, required = false,
                                 default = nil)
  if valid_601453 != nil:
    section.add "MaxResults", valid_601453
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601463: Call_ListKeyPhrasesDetectionJobs_601449; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get a list of key phrase detection jobs that you have submitted.
  ## 
...
proc call*(call_601464: Call_ListKeyPhrasesDetectionJobs_601449; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listKeyPhrasesDetectionJobs* = Call_ListKeyPhrasesDetectionJobs_601449(
    ...
    validator: validate_ListKeyPhrasesDetectionJobs_601450, base: "/",
    url: url_ListKeyPhrasesDetectionJobs_601451,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSentimentDetectionJobs_601467 = ref object of OpenApiRestCall_600437
proc url_ListSentimentDetectionJobs_601469(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSentimentDetectionJobs_601468(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_601470 = query.getOrDefault("NextToken")
  valid_601470 = validateParameter(valid_601470, JString, required = false,
                                 default = nil)
  if valid_601470 != nil:
    section.add "NextToken", valid_601470
...
proc call*(call_601481: Call_ListSentimentDetectionJobs_601467; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of sentiment detection jobs that you have submitted.
  ## 
...
proc call*(call_601482: Call_ListSentimentDetectionJobs_601467; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listSentimentDetectionJobs* = Call_ListSentimentDetectionJobs_601467(
    ...
    validator: validate_ListSentimentDetectionJobs_601468, base: "/",
    url: url_ListSentimentDetectionJobs_601469,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_601485 = ref object of OpenApiRestCall_600437
proc url_ListTagsForResource_601487(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_601486(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601497: Call_ListTagsForResource_601485; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all tags associated with a given Amazon Comprehend resource. 
  ## 
...
proc call*(call_601498: Call_ListTagsForResource_601485; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists all tags associated with a given Amazon Comprehend resource. 
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_601485(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.ListTagsForResource",
    validator: validate_ListTagsForResource_601486, base: "/",
    url: url_ListTagsForResource_601487, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTopicsDetectionJobs_601500 = ref object of OpenApiRestCall_600437
proc url_ListTopicsDetectionJobs_601502(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTopicsDetectionJobs_601501(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601514: Call_ListTopicsDetectionJobs_601500; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of the topic detection jobs that you have submitted.
  ## 
...
proc call*(call_601515: Call_ListTopicsDetectionJobs_601500; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  if body != nil:
    body_601517 = body
  add(query_601516, "MaxResults", newJString(MaxResults))
  result = call_601515.call(nil, query_601516, nil, nil, body_601517)

var listTopicsDetectionJobs* = Call_ListTopicsDetectionJobs_601500(
    name: "listTopicsDetectionJobs", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.ListTopicsDetectionJobs",
    validator: validate_ListTopicsDetectionJobs_601501, base: "/",
    url: url_ListTopicsDetectionJobs_601502, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartDocumentClassificationJob_601518 = ref object of OpenApiRestCall_600437
proc url_StartDocumentClassificationJob_601520(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartDocumentClassificationJob_601519(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601530: Call_StartDocumentClassificationJob_601518; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous document classification job. Use the operation to track the progress of the job.
  ## 
...
proc call*(call_601531: Call_StartDocumentClassificationJob_601518; body: JsonNode): Recallable =
...
var startDocumentClassificationJob* = Call_StartDocumentClassificationJob_601518(
    ...
    validator: validate_StartDocumentClassificationJob_601519, base: "/",
    url: url_StartDocumentClassificationJob_601520,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartDominantLanguageDetectionJob_601533 = ref object of OpenApiRestCall_600437
proc url_StartDominantLanguageDetectionJob_601535(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartDominantLanguageDetectionJob_601534(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601545: Call_StartDominantLanguageDetectionJob_601533;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Starts an asynchronous dominant language detection job for a collection of documents. Use the operation to track the status of a job.
  ## 
...
proc call*(call_601546: Call_StartDominantLanguageDetectionJob_601533;
          body: JsonNode): Recallable =
...
var startDominantLanguageDetectionJob* = Call_StartDominantLanguageDetectionJob_601533(
    ...
    validator: validate_StartDominantLanguageDetectionJob_601534, base: "/",
    url: url_StartDominantLanguageDetectionJob_601535,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartEntitiesDetectionJob_601548 = ref object of OpenApiRestCall_600437
proc url_StartEntitiesDetectionJob_601550(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartEntitiesDetectionJob_601549(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601560: Call_StartEntitiesDetectionJob_601548; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Starts an asynchronous entity detection job for a collection of documents. Use the operation to track the status of a job.</p> <p>This API can be used for either standard entity detection or custom entity recognition. In order to be used for custom entity recognition, the optional <code>EntityRecognizerArn</code> must be used in order to provide access to the recognizer being used to detect the custom entity.</p>
  ## 
...
proc call*(call_601561: Call_StartEntitiesDetectionJob_601548; body: JsonNode): Recallable =
...
var startEntitiesDetectionJob* = Call_StartEntitiesDetectionJob_601548(
    name: "startEntitiesDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.StartEntitiesDetectionJob",
    validator: validate_StartEntitiesDetectionJob_601549, base: "/",
    url: url_StartEntitiesDetectionJob_601550,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartKeyPhrasesDetectionJob_601563 = ref object of OpenApiRestCall_600437
proc url_StartKeyPhrasesDetectionJob_601565(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartKeyPhrasesDetectionJob_601564(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601575: Call_StartKeyPhrasesDetectionJob_601563; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous key phrase detection job for a collection of documents. Use the operation to track the status of a job.
  ## 
...
proc call*(call_601576: Call_StartKeyPhrasesDetectionJob_601563; body: JsonNode): Recallable =
...
var startKeyPhrasesDetectionJob* = Call_StartKeyPhrasesDetectionJob_601563(
    ...
    validator: validate_StartKeyPhrasesDetectionJob_601564, base: "/",
    url: url_StartKeyPhrasesDetectionJob_601565,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSentimentDetectionJob_601578 = ref object of OpenApiRestCall_600437
proc url_StartSentimentDetectionJob_601580(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartSentimentDetectionJob_601579(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601590: Call_StartSentimentDetectionJob_601578; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous sentiment detection job for a collection of documents. use the operation to track the status of a job.
  ## 
...
proc call*(call_601591: Call_StartSentimentDetectionJob_601578; body: JsonNode): Recallable =
...
var startSentimentDetectionJob* = Call_StartSentimentDetectionJob_601578(
    ...
    validator: validate_StartSentimentDetectionJob_601579, base: "/",
    url: url_StartSentimentDetectionJob_601580,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartTopicsDetectionJob_601593 = ref object of OpenApiRestCall_600437
proc url_StartTopicsDetectionJob_601595(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StartTopicsDetectionJob_601594(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601605: Call_StartTopicsDetectionJob_601593; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous topic detection job. Use the <code>DescribeTopicDetectionJob</code> operation to track the status of a job.
  ## 
...
proc call*(call_601606: Call_StartTopicsDetectionJob_601593; body: JsonNode): Recallable =
...
var startTopicsDetectionJob* = Call_StartTopicsDetectionJob_601593(
    name: "startTopicsDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.StartTopicsDetectionJob",
    validator: validate_StartTopicsDetectionJob_601594, base: "/",
    url: url_StartTopicsDetectionJob_601595, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopDominantLanguageDetectionJob_601608 = ref object of OpenApiRestCall_600437
proc url_StopDominantLanguageDetectionJob_601610(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopDominantLanguageDetectionJob_601609(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601620: Call_StopDominantLanguageDetectionJob_601608;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Stops a dominant language detection job in progress.</p> <p>If the job state is <code>IN_PROGRESS</code> the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the job completes before it can be stopped, it is put into the <code>COMPLETED</code> state; otherwise the job is stopped and put into the <code>STOPPED</code> state.</p> <p>If the job is in the <code>COMPLETED</code> or <code>FAILED</code> state when you call the <code>StopDominantLanguageDetectionJob</code> operation, the operation returns a 400 Internal Request Exception. </p> <p>When a job is stopped, any documents already processed are written to the output location.</p>
  ## 
...
proc call*(call_601621: Call_StopDominantLanguageDetectionJob_601608;
          body: JsonNode): Recallable =
...
var stopDominantLanguageDetectionJob* = Call_StopDominantLanguageDetectionJob_601608(
    ...
    validator: validate_StopDominantLanguageDetectionJob_601609, base: "/",
    url: url_StopDominantLanguageDetectionJob_601610,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopEntitiesDetectionJob_601623 = ref object of OpenApiRestCall_600437
proc url_StopEntitiesDetectionJob_601625(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StopEntitiesDetectionJob_601624(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601635: Call_StopEntitiesDetectionJob_601623; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops an entities detection job in progress.</p> <p>If the job state is <code>IN_PROGRESS</code> the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the job completes before it can be stopped, it is put into the <code>COMPLETED</code> state; otherwise the job is stopped and put into the <code>STOPPED</code> state.</p> <p>If the job is in the <code>COMPLETED</code> or <code>FAILED</code> state when you call the <code>StopDominantLanguageDetectionJob</code> operation, the operation returns a 400 Internal Request Exception. </p> <p>When a job is stopped, any documents already processed are written to the output location.</p>
  ## 
...
proc call*(call_601636: Call_StopEntitiesDetectionJob_601623; body: JsonNode): Recallable =
...
var stopEntitiesDetectionJob* = Call_StopEntitiesDetectionJob_601623(
    name: "stopEntitiesDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.StopEntitiesDetectionJob",
    validator: validate_StopEntitiesDetectionJob_601624, base: "/",
    url: url_StopEntitiesDetectionJob_601625, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopKeyPhrasesDetectionJob_601638 = ref object of OpenApiRestCall_600437
proc url_StopKeyPhrasesDetectionJob_601640(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopKeyPhrasesDetectionJob_601639(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601650: Call_StopKeyPhrasesDetectionJob_601638; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops a key phrases detection job in progress.</p> <p>If the job state is <code>IN_PROGRESS</code> the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the job completes before it can be stopped, it is put into the <code>COMPLETED</code> state; otherwise the job is stopped and put into the <code>STOPPED</code> state.</p> <p>If the job is in the <code>COMPLETED</code> or <code>FAILED</code> state when you call the <code>StopDominantLanguageDetectionJob</code> operation, the operation returns a 400 Internal Request Exception. </p> <p>When a job is stopped, any documents already processed are written to the output location.</p>
  ## 
...
proc call*(call_601651: Call_StopKeyPhrasesDetectionJob_601638; body: JsonNode): Recallable =
...
var stopKeyPhrasesDetectionJob* = Call_StopKeyPhrasesDetectionJob_601638(
    ...
    validator: validate_StopKeyPhrasesDetectionJob_601639, base: "/",
    url: url_StopKeyPhrasesDetectionJob_601640,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopSentimentDetectionJob_601653 = ref object of OpenApiRestCall_600437
proc url_StopSentimentDetectionJob_601655(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopSentimentDetectionJob_601654(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601665: Call_StopSentimentDetectionJob_601653; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops a sentiment detection job in progress.</p> <p>If the job state is <code>IN_PROGRESS</code> the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the job completes before it can be stopped, it is put into the <code>COMPLETED</code> state; otherwise the job is be stopped and put into the <code>STOPPED</code> state.</p> <p>If the job is in the <code>COMPLETED</code> or <code>FAILED</code> state when you call the <code>StopDominantLanguageDetectionJob</code> operation, the operation returns a 400 Internal Request Exception. </p> <p>When a job is stopped, any documents already processed are written to the output location.</p>
  ## 
...
proc call*(call_601666: Call_StopSentimentDetectionJob_601653; body: JsonNode): Recallable =
...
var stopSentimentDetectionJob* = Call_StopSentimentDetectionJob_601653(
    name: "stopSentimentDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehend.amazonaws.com",
    route: "/#X-Amz-Target=Comprehend_20171127.StopSentimentDetectionJob",
    validator: validate_StopSentimentDetectionJob_601654, base: "/",
    url: url_StopSentimentDetectionJob_601655,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopTrainingDocumentClassifier_601668 = ref object of OpenApiRestCall_600437
proc url_StopTrainingDocumentClassifier_601670(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopTrainingDocumentClassifier_601669(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601680: Call_StopTrainingDocumentClassifier_601668; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops a document classifier training job while in progress.</p> <p>If the training job state is <code>TRAINING</code>, the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the training job completes before it can be stopped, it is put into the <code>TRAINED</code>; otherwise the training job is stopped and put into the <code>STOPPED</code> state and the service sends back an HTTP 200 response with an empty HTTP body. </p>
  ## 
...
proc call*(call_601681: Call_StopTrainingDocumentClassifier_601668; body: JsonNode): Recallable =
...
var stopTrainingDocumentClassifier* = Call_StopTrainingDocumentClassifier_601668(
    ...
    validator: validate_StopTrainingDocumentClassifier_601669, base: "/",
    url: url_StopTrainingDocumentClassifier_601670,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopTrainingEntityRecognizer_601683 = ref object of OpenApiRestCall_600437
proc url_StopTrainingEntityRecognizer_601685(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopTrainingEntityRecognizer_601684(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601695: Call_StopTrainingEntityRecognizer_601683; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops an entity recognizer training job while in progress.</p> <p>If the training job state is <code>TRAINING</code>, the job is marked for termination and put into the <code>STOP_REQUESTED</code> state. If the training job completes before it can be stopped, it is put into the <code>TRAINED</code>; otherwise the training job is stopped and putted into the <code>STOPPED</code> state and the service sends back an HTTP 200 response with an empty HTTP body.</p>
  ## 
...
proc call*(call_601696: Call_StopTrainingEntityRecognizer_601683; body: JsonNode): Recallable =
...
var stopTrainingEntityRecognizer* = Call_StopTrainingEntityRecognizer_601683(
    ...
    validator: validate_StopTrainingEntityRecognizer_601684, base: "/",
    url: url_StopTrainingEntityRecognizer_601685,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_601698 = ref object of OpenApiRestCall_600437
proc url_TagResource_601700(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_601699(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601710: Call_TagResource_601698; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a specific tag with an Amazon Comprehend resource. A tag is a key-value pair that adds as a metadata to a resource used by Amazon Comprehend. For example, a tag with "Sales" as the key might be added to a resource to indicate its use by the sales department. 
  ## 
...
proc call*(call_601711: Call_TagResource_601698; body: JsonNode): Recallable =
  ## tagResource
  ## Associates a specific tag with an Amazon Comprehend resource. A tag is a key-value pair that adds as a metadata to a resource used by Amazon Comprehend. For example, a tag with "Sales" as the key might be added to a resource to indicate its use by the sales department. 
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_601698(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "comprehend.amazonaws.com", route: "/#X-Amz-Target=Comprehend_20171127.TagResource",
                                        validator: validate_TagResource_601699,
                                        base: "/", url: url_TagResource_601700,
                                        schemes: {Scheme.Https, Scheme.Http})
type
...
proc call*(call_601726: Call_UntagResource_601713; body: JsonNode): Recallable =
  ## untagResource
  ## Removes a specific tag associated with an Amazon Comprehend resource. 
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_601713(name: "untagResource",
    ...
    validator: validate_UntagResource_601714, base: "/", url: url_UntagResource_601715,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
