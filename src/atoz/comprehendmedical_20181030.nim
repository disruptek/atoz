...
type
  Call_DescribeEntitiesDetectionV2Job_593774 = ref object of OpenApiRestCall_593437
proc url_DescribeEntitiesDetectionV2Job_593776(protocol: Scheme; host: string;
...
proc validate_DescribeEntitiesDetectionV2Job_593775(path: JsonNode;
...
proc call*(call_593932: Call_DescribeEntitiesDetectionV2Job_593774; path: JsonNode;
...
proc call*(call_594003: Call_DescribeEntitiesDetectionV2Job_593774; body: JsonNode): Recallable =
...
var describeEntitiesDetectionV2Job* = Call_DescribeEntitiesDetectionV2Job_593774(
    ...
    validator: validate_DescribeEntitiesDetectionV2Job_593775, base: "/",
    url: url_DescribeEntitiesDetectionV2Job_593776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePHIDetectionJob_594043 = ref object of OpenApiRestCall_593437
proc url_DescribePHIDetectionJob_594045(protocol: Scheme; host: string; base: string;
...
proc validate_DescribePHIDetectionJob_594044(path: JsonNode; query: JsonNode;
...
proc call*(call_594055: Call_DescribePHIDetectionJob_594043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a protected health information (PHI) detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_594056: Call_DescribePHIDetectionJob_594043; body: JsonNode): Recallable =
...
var describePHIDetectionJob* = Call_DescribePHIDetectionJob_594043(
    ...
    validator: validate_DescribePHIDetectionJob_594044, base: "/",
    url: url_DescribePHIDetectionJob_594045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectEntities_594058 = ref object of OpenApiRestCall_593437
proc url_DetectEntities_594060(protocol: Scheme; host: string; base: string;
...
proc validate_DetectEntities_594059(path: JsonNode; query: JsonNode;
...
proc call*(call_594070: Call_DetectEntities_594058; path: JsonNode; query: JsonNode;
...
proc call*(call_594071: Call_DetectEntities_594058; body: JsonNode): Recallable =
  ## detectEntities
  ## <p>The <code>DetectEntities</code> operation is deprecated. You should use the <a>DetectEntitiesV2</a> operation instead.</p> <p> Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information .</p>
  ##   body: JObject (required)
...
var detectEntities* = Call_DetectEntities_594058(name: "detectEntities",
    ...
    validator: validate_DetectEntities_594059, base: "/", url: url_DetectEntities_594060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectEntitiesV2_594073 = ref object of OpenApiRestCall_593437
proc url_DetectEntitiesV2_594075(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectEntitiesV2_594074(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594085: Call_DetectEntitiesV2_594073; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information.</p> <p>The <code>DetectEntitiesV2</code> operation replaces the <a>DetectEntities</a> operation. This new action uses a different model for determining the entities in your medical text and changes the way that some entities are returned in the output. You should use the <code>DetectEntitiesV2</code> operation in all new applications.</p> <p>The <code>DetectEntitiesV2</code> operation returns the <code>Acuity</code> and <code>Direction</code> entities as attributes instead of types. It does not return the <code>Quality</code> or <code>Quantity</code> entities.</p>
  ## 
...
proc call*(call_594086: Call_DetectEntitiesV2_594073; body: JsonNode): Recallable =
  ## detectEntitiesV2
  ## <p>Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information.</p> <p>The <code>DetectEntitiesV2</code> operation replaces the <a>DetectEntities</a> operation. This new action uses a different model for determining the entities in your medical text and changes the way that some entities are returned in the output. You should use the <code>DetectEntitiesV2</code> operation in all new applications.</p> <p>The <code>DetectEntitiesV2</code> operation returns the <code>Acuity</code> and <code>Direction</code> entities as attributes instead of types. It does not return the <code>Quality</code> or <code>Quantity</code> entities.</p>
  ##   body: JObject (required)
...
var detectEntitiesV2* = Call_DetectEntitiesV2_594073(name: "detectEntitiesV2",
    meth: HttpMethod.HttpPost, host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2",
    validator: validate_DetectEntitiesV2_594074, base: "/",
    url: url_DetectEntitiesV2_594075, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectPHI_594088 = ref object of OpenApiRestCall_593437
proc url_DetectPHI_594090(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectPHI_594089(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_594100: Call_DetectPHI_594088; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Inspects the clinical text for protected health information (PHI) entities and entity category, location, and confidence score on that information.
  ## 
...
proc call*(call_594101: Call_DetectPHI_594088; body: JsonNode): Recallable =
  ## detectPHI
  ##  Inspects the clinical text for protected health information (PHI) entities and entity category, location, and confidence score on that information.
  ##   body: JObject (required)
...
var detectPHI* = Call_DetectPHI_594088(name: "detectPHI", meth: HttpMethod.HttpPost,
                                    host: "comprehendmedical.amazonaws.com", route: "/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI",
                                    validator: validate_DetectPHI_594089,
                                    base: "/", url: url_DetectPHI_594090,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEntitiesDetectionV2Jobs_594103 = ref object of OpenApiRestCall_593437
proc url_ListEntitiesDetectionV2Jobs_594105(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEntitiesDetectionV2Jobs_594104(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594115: Call_ListEntitiesDetectionV2Jobs_594103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of medical entity detection jobs that you have submitted.
  ## 
...
proc call*(call_594116: Call_ListEntitiesDetectionV2Jobs_594103; body: JsonNode): Recallable =
...
var listEntitiesDetectionV2Jobs* = Call_ListEntitiesDetectionV2Jobs_594103(
    ...
    validator: validate_ListEntitiesDetectionV2Jobs_594104, base: "/",
    url: url_ListEntitiesDetectionV2Jobs_594105,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPHIDetectionJobs_594118 = ref object of OpenApiRestCall_593437
proc url_ListPHIDetectionJobs_594120(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPHIDetectionJobs_594119(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594130: Call_ListPHIDetectionJobs_594118; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of protected health information (PHI) detection jobs that you have submitted.
  ## 
...
proc call*(call_594131: Call_ListPHIDetectionJobs_594118; body: JsonNode): Recallable =
...
var listPHIDetectionJobs* = Call_ListPHIDetectionJobs_594118(
    name: "listPHIDetectionJobs", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.ListPHIDetectionJobs",
    validator: validate_ListPHIDetectionJobs_594119, base: "/",
    url: url_ListPHIDetectionJobs_594120, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartEntitiesDetectionV2Job_594133 = ref object of OpenApiRestCall_593437
proc url_StartEntitiesDetectionV2Job_594135(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartEntitiesDetectionV2Job_594134(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594145: Call_StartEntitiesDetectionV2Job_594133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous medical entity detection job for a collection of documents. Use the <code>DescribeEntitiesDetectionV2Job</code> operation to track the status of a job.
  ## 
...
proc call*(call_594146: Call_StartEntitiesDetectionV2Job_594133; body: JsonNode): Recallable =
...
var startEntitiesDetectionV2Job* = Call_StartEntitiesDetectionV2Job_594133(
    ...
    validator: validate_StartEntitiesDetectionV2Job_594134, base: "/",
    url: url_StartEntitiesDetectionV2Job_594135,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartPHIDetectionJob_594148 = ref object of OpenApiRestCall_593437
proc url_StartPHIDetectionJob_594150(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartPHIDetectionJob_594149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594160: Call_StartPHIDetectionJob_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous job to detect protected health information (PHI). Use the <code>DescribePHIDetectionJob</code> operation to track the status of a job.
  ## 
...
proc call*(call_594161: Call_StartPHIDetectionJob_594148; body: JsonNode): Recallable =
...
var startPHIDetectionJob* = Call_StartPHIDetectionJob_594148(
    name: "startPHIDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob",
    validator: validate_StartPHIDetectionJob_594149, base: "/",
    url: url_StartPHIDetectionJob_594150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopEntitiesDetectionV2Job_594163 = ref object of OpenApiRestCall_593437
proc url_StopEntitiesDetectionV2Job_594165(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopEntitiesDetectionV2Job_594164(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594175: Call_StopEntitiesDetectionV2Job_594163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops a medical entities detection job in progress.
  ## 
...
proc call*(call_594176: Call_StopEntitiesDetectionV2Job_594163; body: JsonNode): Recallable =
...
var stopEntitiesDetectionV2Job* = Call_StopEntitiesDetectionV2Job_594163(
    ...
    validator: validate_StopEntitiesDetectionV2Job_594164, base: "/",
    url: url_StopEntitiesDetectionV2Job_594165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopPHIDetectionJob_594178 = ref object of OpenApiRestCall_593437
proc url_StopPHIDetectionJob_594180(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopPHIDetectionJob_594179(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_594190: Call_StopPHIDetectionJob_594178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops a protected health information (PHI) detection job in progress.
  ## 
...
proc call*(call_594191: Call_StopPHIDetectionJob_594178; body: JsonNode): Recallable =
  ## stopPHIDetectionJob
  ## Stops a protected health information (PHI) detection job in progress.
  ##   body: JObject (required)
...
var stopPHIDetectionJob* = Call_StopPHIDetectionJob_594178(
    name: "stopPHIDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob",
    validator: validate_StopPHIDetectionJob_594179, base: "/",
    url: url_StopPHIDetectionJob_594180, schemes: {Scheme.Https, Scheme.Http})
export
  rest
