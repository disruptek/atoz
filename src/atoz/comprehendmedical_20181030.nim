...
type
  Call_DetectEntities_772924 = ref object of OpenApiRestCall_772588
proc url_DetectEntities_772926(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DetectEntities_772925(path: JsonNode; query: JsonNode;
...
proc call*(call_773082: Call_DetectEntities_772924; path: JsonNode; query: JsonNode;
...
proc call*(call_773153: Call_DetectEntities_772924; body: JsonNode): Recallable =
  ## detectEntities
  ##  Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information .
  ##   body: JObject (required)
...
var detectEntities* = Call_DetectEntities_772924(name: "detectEntities",
    ...
    validator: validate_DetectEntities_772925, base: "/", url: url_DetectEntities_772926,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectPHI_773193 = ref object of OpenApiRestCall_772588
proc url_DetectPHI_773195(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DetectPHI_773194(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_773205: Call_DetectPHI_773193; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Inspects the clinical text for personal health information (PHI) entities and entity category, location, and confidence score on that information.
  ## 
...
proc call*(call_773206: Call_DetectPHI_773193; body: JsonNode): Recallable =
  ## detectPHI
  ##  Inspects the clinical text for personal health information (PHI) entities and entity category, location, and confidence score on that information.
  ##   body: JObject (required)
...
var detectPHI* = Call_DetectPHI_773193(name: "detectPHI", meth: HttpMethod.HttpPost,
                                    host: "comprehendmedical.amazonaws.com", route: "/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI",
                                    validator: validate_DetectPHI_773194,
                                    base: "/", url: url_DetectPHI_773195,
                                    schemes: {Scheme.Https, Scheme.Http})
