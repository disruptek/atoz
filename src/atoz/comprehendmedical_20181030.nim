...
type
  Call_DescribeEntitiesDetectionV2Job_612996 = ref object of OpenApiRestCall_612658
proc url_DescribeEntitiesDetectionV2Job_612998(protocol: Scheme; host: string;
...
proc validate_DescribeEntitiesDetectionV2Job_612997(path: JsonNode;
...
proc call*(call_613154: Call_DescribeEntitiesDetectionV2Job_612996; path: JsonNode;
...
proc call*(call_613225: Call_DescribeEntitiesDetectionV2Job_612996; body: JsonNode): Recallable =
...
var describeEntitiesDetectionV2Job* = Call_DescribeEntitiesDetectionV2Job_612996(
    ...
    validator: validate_DescribeEntitiesDetectionV2Job_612997, base: "/",
    url: url_DescribeEntitiesDetectionV2Job_612998,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePHIDetectionJob_613265 = ref object of OpenApiRestCall_612658
proc url_DescribePHIDetectionJob_613267(protocol: Scheme; host: string; base: string;
...
proc validate_DescribePHIDetectionJob_613266(path: JsonNode; query: JsonNode;
...
proc call*(call_613277: Call_DescribePHIDetectionJob_613265; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties associated with a protected health information (PHI) detection job. Use this operation to get the status of a detection job.
  ## 
...
proc call*(call_613278: Call_DescribePHIDetectionJob_613265; body: JsonNode): Recallable =
...
var describePHIDetectionJob* = Call_DescribePHIDetectionJob_613265(
    ...
    validator: validate_DescribePHIDetectionJob_613266, base: "/",
    url: url_DescribePHIDetectionJob_613267, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectEntities_613280 = ref object of OpenApiRestCall_612658
proc url_DetectEntities_613282(protocol: Scheme; host: string; base: string;
...
proc validate_DetectEntities_613281(path: JsonNode; query: JsonNode;
...
proc call*(call_613292: Call_DetectEntities_613280; path: JsonNode; query: JsonNode;
...
proc call*(call_613293: Call_DetectEntities_613280; body: JsonNode): Recallable =
  ## detectEntities
  ## <p>The <code>DetectEntities</code> operation is deprecated. You should use the <a>DetectEntitiesV2</a> operation instead.</p> <p> Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information .</p>
  ##   body: JObject (required)
...
var detectEntities* = Call_DetectEntities_613280(name: "detectEntities",
    ...
    validator: validate_DetectEntities_613281, base: "/", url: url_DetectEntities_613282,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectEntitiesV2_613295 = ref object of OpenApiRestCall_612658
proc url_DetectEntitiesV2_613297(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectEntitiesV2_613296(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_613307: Call_DetectEntitiesV2_613295; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information.</p> <p>The <code>DetectEntitiesV2</code> operation replaces the <a>DetectEntities</a> operation. This new action uses a different model for determining the entities in your medical text and changes the way that some entities are returned in the output. You should use the <code>DetectEntitiesV2</code> operation in all new applications.</p> <p>The <code>DetectEntitiesV2</code> operation returns the <code>Acuity</code> and <code>Direction</code> entities as attributes instead of types. </p>
  ## 
...
proc call*(call_613308: Call_DetectEntitiesV2_613295; body: JsonNode): Recallable =
  ## detectEntitiesV2
  ## <p>Inspects the clinical text for a variety of medical entities and returns specific information about them such as entity category, location, and confidence score on that information.</p> <p>The <code>DetectEntitiesV2</code> operation replaces the <a>DetectEntities</a> operation. This new action uses a different model for determining the entities in your medical text and changes the way that some entities are returned in the output. You should use the <code>DetectEntitiesV2</code> operation in all new applications.</p> <p>The <code>DetectEntitiesV2</code> operation returns the <code>Acuity</code> and <code>Direction</code> entities as attributes instead of types. </p>
  ##   body: JObject (required)
...
var detectEntitiesV2* = Call_DetectEntitiesV2_613295(name: "detectEntitiesV2",
    meth: HttpMethod.HttpPost, host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2",
    validator: validate_DetectEntitiesV2_613296, base: "/",
    url: url_DetectEntitiesV2_613297, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DetectPHI_613310 = ref object of OpenApiRestCall_612658
proc url_DetectPHI_613312(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DetectPHI_613311(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_613322: Call_DetectPHI_613310; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Inspects the clinical text for protected health information (PHI) entities and entity category, location, and confidence score on that information.
  ## 
...
proc call*(call_613323: Call_DetectPHI_613310; body: JsonNode): Recallable =
  ## detectPHI
  ##  Inspects the clinical text for protected health information (PHI) entities and entity category, location, and confidence score on that information.
  ##   body: JObject (required)
...
var detectPHI* = Call_DetectPHI_613310(name: "detectPHI", meth: HttpMethod.HttpPost,
                                    host: "comprehendmedical.amazonaws.com", route: "/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI",
                                    validator: validate_DetectPHI_613311,
                                    base: "/", url: url_DetectPHI_613312,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_InferICD10CM_613325 = ref object of OpenApiRestCall_612658
proc url_InferICD10CM_613327(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InferICD10CM_613326(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613337: Call_InferICD10CM_613325; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## InferICD10CM detects medical conditions as entities listed in a patient record and links those entities to normalized concept identifiers in the ICD-10-CM knowledge base from the Centers for Disease Control.
  ## 
...
proc call*(call_613338: Call_InferICD10CM_613325; body: JsonNode): Recallable =
  ## inferICD10CM
  ## InferICD10CM detects medical conditions as entities listed in a patient record and links those entities to normalized concept identifiers in the ICD-10-CM knowledge base from the Centers for Disease Control.
  ##   body: JObject (required)
...
var inferICD10CM* = Call_InferICD10CM_613325(name: "inferICD10CM",
    meth: HttpMethod.HttpPost, host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.InferICD10CM",
    validator: validate_InferICD10CM_613326, base: "/", url: url_InferICD10CM_613327,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_InferRxNorm_613340 = ref object of OpenApiRestCall_612658
proc url_InferRxNorm_613342(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InferRxNorm_613341(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613352: Call_InferRxNorm_613340; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## InferRxNorm detects medications as entities listed in a patient record and links to the normalized concept identifiers in the RxNorm database from the National Library of Medicine.
  ## 
...
proc call*(call_613353: Call_InferRxNorm_613340; body: JsonNode): Recallable =
  ## inferRxNorm
  ## InferRxNorm detects medications as entities listed in a patient record and links to the normalized concept identifiers in the RxNorm database from the National Library of Medicine.
  ##   body: JObject (required)
...
var inferRxNorm* = Call_InferRxNorm_613340(name: "inferRxNorm",
                                        meth: HttpMethod.HttpPost, host: "comprehendmedical.amazonaws.com", route: "/#X-Amz-Target=ComprehendMedical_20181030.InferRxNorm",
                                        validator: validate_InferRxNorm_613341,
                                        base: "/", url: url_InferRxNorm_613342,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEntitiesDetectionV2Jobs_613355 = ref object of OpenApiRestCall_612658
proc url_ListEntitiesDetectionV2Jobs_613357(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListEntitiesDetectionV2Jobs_613356(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613367: Call_ListEntitiesDetectionV2Jobs_613355; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of medical entity detection jobs that you have submitted.
  ## 
...
proc call*(call_613368: Call_ListEntitiesDetectionV2Jobs_613355; body: JsonNode): Recallable =
...
var listEntitiesDetectionV2Jobs* = Call_ListEntitiesDetectionV2Jobs_613355(
    ...
    validator: validate_ListEntitiesDetectionV2Jobs_613356, base: "/",
    url: url_ListEntitiesDetectionV2Jobs_613357,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPHIDetectionJobs_613370 = ref object of OpenApiRestCall_612658
proc url_ListPHIDetectionJobs_613372(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPHIDetectionJobs_613371(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613382: Call_ListPHIDetectionJobs_613370; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of protected health information (PHI) detection jobs that you have submitted.
  ## 
...
proc call*(call_613383: Call_ListPHIDetectionJobs_613370; body: JsonNode): Recallable =
...
var listPHIDetectionJobs* = Call_ListPHIDetectionJobs_613370(
    name: "listPHIDetectionJobs", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.ListPHIDetectionJobs",
    validator: validate_ListPHIDetectionJobs_613371, base: "/",
    url: url_ListPHIDetectionJobs_613372, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartEntitiesDetectionV2Job_613385 = ref object of OpenApiRestCall_612658
proc url_StartEntitiesDetectionV2Job_613387(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartEntitiesDetectionV2Job_613386(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613397: Call_StartEntitiesDetectionV2Job_613385; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous medical entity detection job for a collection of documents. Use the <code>DescribeEntitiesDetectionV2Job</code> operation to track the status of a job.
  ## 
...
proc call*(call_613398: Call_StartEntitiesDetectionV2Job_613385; body: JsonNode): Recallable =
...
var startEntitiesDetectionV2Job* = Call_StartEntitiesDetectionV2Job_613385(
    ...
    validator: validate_StartEntitiesDetectionV2Job_613386, base: "/",
    url: url_StartEntitiesDetectionV2Job_613387,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartPHIDetectionJob_613400 = ref object of OpenApiRestCall_612658
proc url_StartPHIDetectionJob_613402(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartPHIDetectionJob_613401(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613412: Call_StartPHIDetectionJob_613400; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous job to detect protected health information (PHI). Use the <code>DescribePHIDetectionJob</code> operation to track the status of a job.
  ## 
...
proc call*(call_613413: Call_StartPHIDetectionJob_613400; body: JsonNode): Recallable =
...
var startPHIDetectionJob* = Call_StartPHIDetectionJob_613400(
    name: "startPHIDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob",
    validator: validate_StartPHIDetectionJob_613401, base: "/",
    url: url_StartPHIDetectionJob_613402, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopEntitiesDetectionV2Job_613415 = ref object of OpenApiRestCall_612658
proc url_StopEntitiesDetectionV2Job_613417(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopEntitiesDetectionV2Job_613416(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613427: Call_StopEntitiesDetectionV2Job_613415; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops a medical entities detection job in progress.
  ## 
...
proc call*(call_613428: Call_StopEntitiesDetectionV2Job_613415; body: JsonNode): Recallable =
...
var stopEntitiesDetectionV2Job* = Call_StopEntitiesDetectionV2Job_613415(
    ...
    validator: validate_StopEntitiesDetectionV2Job_613416, base: "/",
    url: url_StopEntitiesDetectionV2Job_613417,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopPHIDetectionJob_613430 = ref object of OpenApiRestCall_612658
proc url_StopPHIDetectionJob_613432(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopPHIDetectionJob_613431(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_613442: Call_StopPHIDetectionJob_613430; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops a protected health information (PHI) detection job in progress.
  ## 
...
proc call*(call_613443: Call_StopPHIDetectionJob_613430; body: JsonNode): Recallable =
  ## stopPHIDetectionJob
  ## Stops a protected health information (PHI) detection job in progress.
  ##   body: JObject (required)
...
var stopPHIDetectionJob* = Call_StopPHIDetectionJob_613430(
    name: "stopPHIDetectionJob", meth: HttpMethod.HttpPost,
    host: "comprehendmedical.amazonaws.com",
    route: "/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob",
    validator: validate_StopPHIDetectionJob_613431, base: "/",
    url: url_StopPHIDetectionJob_613432, schemes: {Scheme.Https, Scheme.Http})
export
  rest
