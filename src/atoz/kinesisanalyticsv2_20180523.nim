...
type
  Call_CreateApplicationSnapshot_593047 = ref object of OpenApiRestCall_592364
proc url_CreateApplicationSnapshot_593049(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateApplicationSnapshot_593048(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593059: Call_CreateApplicationSnapshot_593047; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a snapshot of the application's state data.
  ## 
...
proc call*(call_593060: Call_CreateApplicationSnapshot_593047; body: JsonNode): Recallable =
...
var createApplicationSnapshot* = Call_CreateApplicationSnapshot_593047(
    ...
    validator: validate_CreateApplicationSnapshot_593048, base: "/",
    url: url_CreateApplicationSnapshot_593049,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplication_593062 = ref object of OpenApiRestCall_592364
proc url_DeleteApplication_593064(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplication_593063(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_593074: Call_DeleteApplication_593062; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified application. Kinesis Data Analytics halts application execution and deletes the application.
  ## 
...
proc call*(call_593075: Call_DeleteApplication_593062; body: JsonNode): Recallable =
  ## deleteApplication
  ## Deletes the specified application. Kinesis Data Analytics halts application execution and deletes the application.
  ##   body: JObject (required)
...
var deleteApplication* = Call_DeleteApplication_593062(name: "deleteApplication",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.DeleteApplication",
    validator: validate_DeleteApplication_593063, base: "/",
    url: url_DeleteApplication_593064, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplicationCloudWatchLoggingOption_593077 = ref object of OpenApiRestCall_592364
proc url_DeleteApplicationCloudWatchLoggingOption_593079(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplicationCloudWatchLoggingOption_593078(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593089: Call_DeleteApplicationCloudWatchLoggingOption_593077;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes an Amazon CloudWatch log stream from an Amazon Kinesis Data Analytics application. 
  ## 
...
proc call*(call_593090: Call_DeleteApplicationCloudWatchLoggingOption_593077;
          body: JsonNode): Recallable =
...
var deleteApplicationCloudWatchLoggingOption* = Call_DeleteApplicationCloudWatchLoggingOption_593077(
    ...
    validator: validate_DeleteApplicationCloudWatchLoggingOption_593078,
    base: "/", url: url_DeleteApplicationCloudWatchLoggingOption_593079,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplicationInputProcessingConfiguration_593092 = ref object of OpenApiRestCall_592364
proc url_DeleteApplicationInputProcessingConfiguration_593094(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplicationInputProcessingConfiguration_593093(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_593104: Call_DeleteApplicationInputProcessingConfiguration_593092;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes an <a>InputProcessingConfiguration</a> from an input.
  ## 
...
proc call*(call_593105: Call_DeleteApplicationInputProcessingConfiguration_593092;
          body: JsonNode): Recallable =
...
var deleteApplicationInputProcessingConfiguration* = Call_DeleteApplicationInputProcessingConfiguration_593092(
    ...
    validator: validate_DeleteApplicationInputProcessingConfiguration_593093,
    base: "/", url: url_DeleteApplicationInputProcessingConfiguration_593094,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplicationOutput_593107 = ref object of OpenApiRestCall_592364
proc url_DeleteApplicationOutput_593109(protocol: Scheme; host: string; base: string;
...
proc validate_DeleteApplicationOutput_593108(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593119: Call_DeleteApplicationOutput_593107; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the output destination configuration from your SQL-based Amazon Kinesis Data Analytics application's configuration. Kinesis Data Analytics will no longer write data from the corresponding in-application stream to the external output destination.
  ## 
...
proc call*(call_593120: Call_DeleteApplicationOutput_593107; body: JsonNode): Recallable =
...
var deleteApplicationOutput* = Call_DeleteApplicationOutput_593107(
    ...
    validator: validate_DeleteApplicationOutput_593108, base: "/",
    url: url_DeleteApplicationOutput_593109, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplicationReferenceDataSource_593122 = ref object of OpenApiRestCall_592364
proc url_DeleteApplicationReferenceDataSource_593124(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplicationReferenceDataSource_593123(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593134: Call_DeleteApplicationReferenceDataSource_593122;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Deletes a reference data source configuration from the specified SQL-based Amazon Kinesis Data Analytics application's configuration.</p> <p>If the application is running, Kinesis Data Analytics immediately removes the in-application table that you created using the <a>AddApplicationReferenceDataSource</a> operation. </p>
  ## 
...
proc call*(call_593135: Call_DeleteApplicationReferenceDataSource_593122;
          body: JsonNode): Recallable =
...
var deleteApplicationReferenceDataSource* = Call_DeleteApplicationReferenceDataSource_593122(
    ...
    validator: validate_DeleteApplicationReferenceDataSource_593123, base: "/",
    url: url_DeleteApplicationReferenceDataSource_593124,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplicationSnapshot_593137 = ref object of OpenApiRestCall_592364
proc url_DeleteApplicationSnapshot_593139(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplicationSnapshot_593138(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593149: Call_DeleteApplicationSnapshot_593137; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a snapshot of application state.
  ## 
...
proc call*(call_593150: Call_DeleteApplicationSnapshot_593137; body: JsonNode): Recallable =
...
var deleteApplicationSnapshot* = Call_DeleteApplicationSnapshot_593137(
    ...
    validator: validate_DeleteApplicationSnapshot_593138, base: "/",
    url: url_DeleteApplicationSnapshot_593139,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeApplication_593152 = ref object of OpenApiRestCall_592364
proc url_DescribeApplication_593154(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeApplication_593153(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593164: Call_DescribeApplication_593152; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns information about a specific Amazon Kinesis Data Analytics application.</p> <p>If you want to retrieve a list of all applications in your account, use the <a>ListApplications</a> operation.</p>
  ## 
...
proc call*(call_593165: Call_DescribeApplication_593152; body: JsonNode): Recallable =
  ## describeApplication
  ## <p>Returns information about a specific Amazon Kinesis Data Analytics application.</p> <p>If you want to retrieve a list of all applications in your account, use the <a>ListApplications</a> operation.</p>
  ##   body: JObject (required)
...
var describeApplication* = Call_DescribeApplication_593152(
    name: "describeApplication", meth: HttpMethod.HttpPost,
    host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.DescribeApplication",
    validator: validate_DescribeApplication_593153, base: "/",
    url: url_DescribeApplication_593154, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeApplicationSnapshot_593167 = ref object of OpenApiRestCall_592364
proc url_DescribeApplicationSnapshot_593169(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeApplicationSnapshot_593168(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593179: Call_DescribeApplicationSnapshot_593167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about a snapshot of application state data.
  ## 
...
proc call*(call_593180: Call_DescribeApplicationSnapshot_593167; body: JsonNode): Recallable =
...
var describeApplicationSnapshot* = Call_DescribeApplicationSnapshot_593167(
    ...
    validator: validate_DescribeApplicationSnapshot_593168, base: "/",
    url: url_DescribeApplicationSnapshot_593169,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DiscoverInputSchema_593182 = ref object of OpenApiRestCall_592364
proc url_DiscoverInputSchema_593184(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DiscoverInputSchema_593183(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593194: Call_DiscoverInputSchema_593182; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Infers a schema for an SQL-based Amazon Kinesis Data Analytics application by evaluating sample records on the specified streaming source (Kinesis data stream or Kinesis Data Firehose delivery stream) or Amazon S3 object. In the response, the operation returns the inferred schema and also the sample records that the operation used to infer the schema.</p> <p> You can use the inferred schema when configuring a streaming source for your application. When you create an application using the Kinesis Data Analytics console, the console uses this operation to infer a schema and show it in the console user interface. </p>
  ## 
...
proc call*(call_593195: Call_DiscoverInputSchema_593182; body: JsonNode): Recallable =
  ## discoverInputSchema
  ## <p>Infers a schema for an SQL-based Amazon Kinesis Data Analytics application by evaluating sample records on the specified streaming source (Kinesis data stream or Kinesis Data Firehose delivery stream) or Amazon S3 object. In the response, the operation returns the inferred schema and also the sample records that the operation used to infer the schema.</p> <p> You can use the inferred schema when configuring a streaming source for your application. When you create an application using the Kinesis Data Analytics console, the console uses this operation to infer a schema and show it in the console user interface. </p>
  ##   body: JObject (required)
...
var discoverInputSchema* = Call_DiscoverInputSchema_593182(
    name: "discoverInputSchema", meth: HttpMethod.HttpPost,
    host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.DiscoverInputSchema",
    validator: validate_DiscoverInputSchema_593183, base: "/",
    url: url_DiscoverInputSchema_593184, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListApplicationSnapshots_593197 = ref object of OpenApiRestCall_592364
proc url_ListApplicationSnapshots_593199(protocol: Scheme; host: string;
...
proc validate_ListApplicationSnapshots_593198(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593209: Call_ListApplicationSnapshots_593197; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists information about the current application snapshots.
  ## 
...
proc call*(call_593210: Call_ListApplicationSnapshots_593197; body: JsonNode): Recallable =
...
var listApplicationSnapshots* = Call_ListApplicationSnapshots_593197(
    ...
    validator: validate_ListApplicationSnapshots_593198, base: "/",
    url: url_ListApplicationSnapshots_593199, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListApplications_593212 = ref object of OpenApiRestCall_592364
proc url_ListApplications_593214(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListApplications_593213(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_593224: Call_ListApplications_593212; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns a list of Amazon Kinesis Data Analytics applications in your account. For each application, the response includes the application name, Amazon Resource Name (ARN), and status. </p> <p>If you want detailed information about a specific application, use <a>DescribeApplication</a>.</p>
  ## 
...
proc call*(call_593225: Call_ListApplications_593212; body: JsonNode): Recallable =
  ## listApplications
  ## <p>Returns a list of Amazon Kinesis Data Analytics applications in your account. For each application, the response includes the application name, Amazon Resource Name (ARN), and status. </p> <p>If you want detailed information about a specific application, use <a>DescribeApplication</a>.</p>
  ##   body: JObject (required)
...
var listApplications* = Call_ListApplications_593212(name: "listApplications",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.ListApplications",
    validator: validate_ListApplications_593213, base: "/",
    url: url_ListApplications_593214, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_593227 = ref object of OpenApiRestCall_592364
proc url_ListTagsForResource_593229(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_593228(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593239: Call_ListTagsForResource_593227; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the list of key-value tags assigned to the application.
  ## 
...
proc call*(call_593240: Call_ListTagsForResource_593227; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Retrieves the list of key-value tags assigned to the application.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_593227(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.ListTagsForResource",
    validator: validate_ListTagsForResource_593228, base: "/",
    url: url_ListTagsForResource_593229, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartApplication_593242 = ref object of OpenApiRestCall_592364
proc url_StartApplication_593244(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartApplication_593243(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_593254: Call_StartApplication_593242; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts the specified Amazon Kinesis Data Analytics application. After creating an application, you must exclusively call this operation to start your application.
  ## 
...
proc call*(call_593255: Call_StartApplication_593242; body: JsonNode): Recallable =
  ## startApplication
  ## Starts the specified Amazon Kinesis Data Analytics application. After creating an application, you must exclusively call this operation to start your application.
  ##   body: JObject (required)
...
var startApplication* = Call_StartApplication_593242(name: "startApplication",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.StartApplication",
    validator: validate_StartApplication_593243, base: "/",
    url: url_StartApplication_593244, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopApplication_593257 = ref object of OpenApiRestCall_592364
proc url_StopApplication_593259(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopApplication_593258(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_593269: Call_StopApplication_593257; path: JsonNode; query: JsonNode;
...
proc call*(call_593270: Call_StopApplication_593257; body: JsonNode): Recallable =
  ## stopApplication
  ## Stops the application from processing data. You can stop an application only if it is in the running state. You can use the <a>DescribeApplication</a> operation to find the application state. 
  ##   body: JObject (required)
...
var stopApplication* = Call_StopApplication_593257(name: "stopApplication",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.StopApplication",
    validator: validate_StopApplication_593258, base: "/", url: url_StopApplication_593259,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_593272 = ref object of OpenApiRestCall_592364
proc url_TagResource_593274(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_593273(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593284: Call_TagResource_593272; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds one or more key-value tags to a Kinesis Analytics application. Note that the maximum number of application tags includes system tags. The maximum number of user-defined application tags is 50.
  ## 
...
proc call*(call_593285: Call_TagResource_593272; body: JsonNode): Recallable =
  ## tagResource
  ## Adds one or more key-value tags to a Kinesis Analytics application. Note that the maximum number of application tags includes system tags. The maximum number of user-defined application tags is 50.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_593272(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "kinesisanalytics.amazonaws.com", route: "/#X-Amz-Target=KinesisAnalytics_20180523.TagResource",
                                        validator: validate_TagResource_593273,
                                        base: "/", url: url_TagResource_593274,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_593287 = ref object of OpenApiRestCall_592364
proc url_UntagResource_593289(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_593288(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593299: Call_UntagResource_593287; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes one or more tags from a Kinesis Analytics application.
  ## 
...
proc call*(call_593300: Call_UntagResource_593287; body: JsonNode): Recallable =
  ## untagResource
  ## Removes one or more tags from a Kinesis Analytics application.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_593287(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.UntagResource",
    validator: validate_UntagResource_593288, base: "/", url: url_UntagResource_593289,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateApplication_593302 = ref object of OpenApiRestCall_592364
proc url_UpdateApplication_593304(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateApplication_593303(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_593314: Call_UpdateApplication_593302; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates an existing Amazon Kinesis Data Analytics application. Using this operation, you can update application code, input configuration, and output configuration. </p> <p>Kinesis Data Analytics updates the <code>ApplicationVersionId</code> each time you update your application. </p>
  ## 
...
proc call*(call_593315: Call_UpdateApplication_593302; body: JsonNode): Recallable =
  ## updateApplication
  ## <p>Updates an existing Amazon Kinesis Data Analytics application. Using this operation, you can update application code, input configuration, and output configuration. </p> <p>Kinesis Data Analytics updates the <code>ApplicationVersionId</code> each time you update your application. </p>
  ##   body: JObject (required)
...
var updateApplication* = Call_UpdateApplication_593302(name: "updateApplication",
    meth: HttpMethod.HttpPost, host: "kinesisanalytics.amazonaws.com",
    route: "/#X-Amz-Target=KinesisAnalytics_20180523.UpdateApplication",
    validator: validate_UpdateApplication_593303, base: "/",
    url: url_UpdateApplication_593304, schemes: {Scheme.Https, Scheme.Http})
export
  rest
