...
type
  Call_AcceptQualificationRequest_600768 = ref object of OpenApiRestCall_600426
proc url_AcceptQualificationRequest_600770(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AcceptQualificationRequest_600769(path: JsonNode; query: JsonNode;
...
proc call*(call_600926: Call_AcceptQualificationRequest_600768; path: JsonNode;
...
proc call*(call_600997: Call_AcceptQualificationRequest_600768; body: JsonNode): Recallable =
...
var acceptQualificationRequest* = Call_AcceptQualificationRequest_600768(
    ...
    validator: validate_AcceptQualificationRequest_600769, base: "/",
    url: url_AcceptQualificationRequest_600770,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ApproveAssignment_601037 = ref object of OpenApiRestCall_600426
proc url_ApproveAssignment_601039(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ApproveAssignment_601038(path: JsonNode; query: JsonNode;
...
proc call*(call_601049: Call_ApproveAssignment_601037; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>ApproveAssignment</code> operation approves the results of a completed assignment. </p> <p> Approving an assignment initiates two payments from the Requester's Amazon.com account </p> <ul> <li> <p> The Worker who submitted the results is paid the reward specified in the HIT. </p> </li> <li> <p> Amazon Mechanical Turk fees are debited. </p> </li> </ul> <p> If the Requester's account does not have adequate funds for these payments, the call to ApproveAssignment returns an exception, and the approval is not processed. You can include an optional feedback message with the approval, which the Worker can see in the Status section of the web site. </p> <p> You can also call this operation for assignments that were previous rejected and approve them by explicitly overriding the previous rejection. This only works on rejected assignments that were submitted within the previous 30 days and only if the assignment's related HIT has not been deleted. </p>
  ## 
...
proc call*(call_601050: Call_ApproveAssignment_601037; body: JsonNode): Recallable =
  ## approveAssignment
  ## <p> The <code>ApproveAssignment</code> operation approves the results of a completed assignment. </p> <p> Approving an assignment initiates two payments from the Requester's Amazon.com account </p> <ul> <li> <p> The Worker who submitted the results is paid the reward specified in the HIT. </p> </li> <li> <p> Amazon Mechanical Turk fees are debited. </p> </li> </ul> <p> If the Requester's account does not have adequate funds for these payments, the call to ApproveAssignment returns an exception, and the approval is not processed. You can include an optional feedback message with the approval, which the Worker can see in the Status section of the web site. </p> <p> You can also call this operation for assignments that were previous rejected and approve them by explicitly overriding the previous rejection. This only works on rejected assignments that were submitted within the previous 30 days and only if the assignment's related HIT has not been deleted. </p>
  ##   body: JObject (required)
...
var approveAssignment* = Call_ApproveAssignment_601037(name: "approveAssignment",
    ...
    validator: validate_ApproveAssignment_601038, base: "/",
    url: url_ApproveAssignment_601039, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateQualificationWithWorker_601052 = ref object of OpenApiRestCall_600426
proc url_AssociateQualificationWithWorker_601054(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateQualificationWithWorker_601053(path: JsonNode;
...
proc call*(call_601064: Call_AssociateQualificationWithWorker_601052;
...
proc call*(call_601065: Call_AssociateQualificationWithWorker_601052;
          body: JsonNode): Recallable =
...
var associateQualificationWithWorker* = Call_AssociateQualificationWithWorker_601052(
    ...
    validator: validate_AssociateQualificationWithWorker_601053, base: "/",
    url: url_AssociateQualificationWithWorker_601054,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAdditionalAssignmentsForHIT_601067 = ref object of OpenApiRestCall_600426
proc url_CreateAdditionalAssignmentsForHIT_601069(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateAdditionalAssignmentsForHIT_601068(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601079: Call_CreateAdditionalAssignmentsForHIT_601067;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p> The <code>CreateAdditionalAssignmentsForHIT</code> operation increases the maximum number of assignments of an existing HIT. </p> <p> To extend the maximum number of assignments, specify the number of additional assignments.</p> <note> <ul> <li> <p>HITs created with fewer than 10 assignments cannot be extended to have 10 or more assignments. Attempting to add assignments in a way that brings the total number of assignments for a HIT from fewer than 10 assignments to 10 or more assignments will result in an <code>AWS.MechanicalTurk.InvalidMaximumAssignmentsIncrease</code> exception.</p> </li> <li> <p>HITs that were created before July 22, 2015 cannot be extended. Attempting to extend HITs that were created before July 22, 2015 will result in an <code>AWS.MechanicalTurk.HITTooOldForExtension</code> exception. </p> </li> </ul> </note>
  ## 
...
proc call*(call_601080: Call_CreateAdditionalAssignmentsForHIT_601067;
          body: JsonNode): Recallable =
...
var createAdditionalAssignmentsForHIT* = Call_CreateAdditionalAssignmentsForHIT_601067(
    ...
    validator: validate_CreateAdditionalAssignmentsForHIT_601068, base: "/",
    url: url_CreateAdditionalAssignmentsForHIT_601069,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHIT_601082 = ref object of OpenApiRestCall_600426
proc url_CreateHIT_601084(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateHIT_601083(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601094: Call_CreateHIT_601082; path: JsonNode; query: JsonNode;
...
proc call*(call_601095: Call_CreateHIT_601082; body: JsonNode): Recallable =
  ## createHIT
  ## <p>The <code>CreateHIT</code> operation creates a new Human Intelligence Task (HIT). The new HIT is made available for Workers to find and accept on the Amazon Mechanical Turk website. </p> <p> This operation allows you to specify a new HIT by passing in values for the properties of the HIT, such as its title, reward amount and number of assignments. When you pass these values to <code>CreateHIT</code>, a new HIT is created for you, with a new <code>HITTypeID</code>. The HITTypeID can be used to create additional HITs in the future without needing to specify common parameters such as the title, description and reward amount each time.</p> <p> An alternative way to create HITs is to first generate a HITTypeID using the <code>CreateHITType</code> operation and then call the <code>CreateHITWithHITType</code> operation. This is the recommended best practice for Requesters who are creating large numbers of HITs. </p> <p>CreateHIT also supports several ways to provide question data: by providing a value for the <code>Question</code> parameter that fully specifies the contents of the HIT, or by providing a <code>HitLayoutId</code> and associated <code>HitLayoutParameters</code>. </p> <note> <p> If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see <a href="https://requester.mturk.com/pricing">Amazon Mechanical Turk Pricing</a>.</p> </note>
  ##   body: JObject (required)
...
var createHIT* = Call_CreateHIT_601082(name: "createHIT", meth: HttpMethod.HttpPost,
                                    host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT",
                                    validator: validate_CreateHIT_601083,
                                    base: "/", url: url_CreateHIT_601084,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHITType_601097 = ref object of OpenApiRestCall_600426
proc url_CreateHITType_601099(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateHITType_601098(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601109: Call_CreateHITType_601097; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>CreateHITType</code> operation creates a new HIT type. This operation allows you to define a standard set of HIT properties to use when creating HITs. If you register a HIT type with values that match an existing HIT type, the HIT type ID of the existing type will be returned. 
  ## 
...
proc call*(call_601110: Call_CreateHITType_601097; body: JsonNode): Recallable =
  ## createHITType
  ##  The <code>CreateHITType</code> operation creates a new HIT type. This operation allows you to define a standard set of HIT properties to use when creating HITs. If you register a HIT type with values that match an existing HIT type, the HIT type ID of the existing type will be returned. 
  ##   body: JObject (required)
...
var createHITType* = Call_CreateHITType_601097(name: "createHITType",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType",
    validator: validate_CreateHITType_601098, base: "/", url: url_CreateHITType_601099,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHITWithHITType_601112 = ref object of OpenApiRestCall_600426
proc url_CreateHITWithHITType_601114(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateHITWithHITType_601113(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601124: Call_CreateHITWithHITType_601112; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>CreateHITWithHITType</code> operation creates a new Human Intelligence Task (HIT) using an existing HITTypeID generated by the <code>CreateHITType</code> operation. </p> <p> This is an alternative way to create HITs from the <code>CreateHIT</code> operation. This is the recommended best practice for Requesters who are creating large numbers of HITs. </p> <p>CreateHITWithHITType also supports several ways to provide question data: by providing a value for the <code>Question</code> parameter that fully specifies the contents of the HIT, or by providing a <code>HitLayoutId</code> and associated <code>HitLayoutParameters</code>. </p> <note> <p> If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see <a href="https://requester.mturk.com/pricing">Amazon Mechanical Turk Pricing</a>. </p> </note>
  ## 
...
proc call*(call_601125: Call_CreateHITWithHITType_601112; body: JsonNode): Recallable =
...
var createHITWithHITType* = Call_CreateHITWithHITType_601112(
    ...
    validator: validate_CreateHITWithHITType_601113, base: "/",
    url: url_CreateHITWithHITType_601114, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateQualificationType_601127 = ref object of OpenApiRestCall_600426
proc url_CreateQualificationType_601129(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateQualificationType_601128(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601139: Call_CreateQualificationType_601127; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>CreateQualificationType</code> operation creates a new Qualification type, which is represented by a <code>QualificationType</code> data structure. 
  ## 
...
proc call*(call_601140: Call_CreateQualificationType_601127; body: JsonNode): Recallable =
...
var createQualificationType* = Call_CreateQualificationType_601127(
    ...
    validator: validate_CreateQualificationType_601128, base: "/",
    url: url_CreateQualificationType_601129, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateWorkerBlock_601142 = ref object of OpenApiRestCall_600426
proc url_CreateWorkerBlock_601144(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateWorkerBlock_601143(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601154: Call_CreateWorkerBlock_601142; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The <code>CreateWorkerBlock</code> operation allows you to prevent a Worker from working on your HITs. For example, you can block a Worker who is producing poor quality work. You can block up to 100,000 Workers.
  ## 
...
proc call*(call_601155: Call_CreateWorkerBlock_601142; body: JsonNode): Recallable =
  ## createWorkerBlock
  ## The <code>CreateWorkerBlock</code> operation allows you to prevent a Worker from working on your HITs. For example, you can block a Worker who is producing poor quality work. You can block up to 100,000 Workers.
  ##   body: JObject (required)
...
var createWorkerBlock* = Call_CreateWorkerBlock_601142(name: "createWorkerBlock",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock",
    validator: validate_CreateWorkerBlock_601143, base: "/",
    url: url_CreateWorkerBlock_601144, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteHIT_601157 = ref object of OpenApiRestCall_600426
proc url_DeleteHIT_601159(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteHIT_601158(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601169: Call_DeleteHIT_601157; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>DeleteHIT</code> operation is used to delete HIT that is no longer needed. Only the Requester who created the HIT can delete it. </p> <p> You can only dispose of HITs that are in the <code>Reviewable</code> state, with all of their submitted assignments already either approved or rejected. If you call the DeleteHIT operation on a HIT that is not in the <code>Reviewable</code> state (for example, that has not expired, or still has active assignments), or on a HIT that is Reviewable but without all of its submitted assignments already approved or rejected, the service will return an error. </p> <note> <ul> <li> <p> HITs are automatically disposed of after 120 days. </p> </li> <li> <p> After you dispose of a HIT, you can no longer approve the HIT's rejected assignments. </p> </li> <li> <p> Disposed HITs are not returned in results for the ListHITs operation. </p> </li> <li> <p> Disposing HITs can improve the performance of operations such as ListReviewableHITs and ListHITs. </p> </li> </ul> </note>
  ## 
...
proc call*(call_601170: Call_DeleteHIT_601157; body: JsonNode): Recallable =
  ## deleteHIT
  ## <p> The <code>DeleteHIT</code> operation is used to delete HIT that is no longer needed. Only the Requester who created the HIT can delete it. </p> <p> You can only dispose of HITs that are in the <code>Reviewable</code> state, with all of their submitted assignments already either approved or rejected. If you call the DeleteHIT operation on a HIT that is not in the <code>Reviewable</code> state (for example, that has not expired, or still has active assignments), or on a HIT that is Reviewable but without all of its submitted assignments already approved or rejected, the service will return an error. </p> <note> <ul> <li> <p> HITs are automatically disposed of after 120 days. </p> </li> <li> <p> After you dispose of a HIT, you can no longer approve the HIT's rejected assignments. </p> </li> <li> <p> Disposed HITs are not returned in results for the ListHITs operation. </p> </li> <li> <p> Disposing HITs can improve the performance of operations such as ListReviewableHITs and ListHITs. </p> </li> </ul> </note>
  ##   body: JObject (required)
...
var deleteHIT* = Call_DeleteHIT_601157(name: "deleteHIT", meth: HttpMethod.HttpPost,
                                    host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT",
                                    validator: validate_DeleteHIT_601158,
                                    base: "/", url: url_DeleteHIT_601159,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteQualificationType_601172 = ref object of OpenApiRestCall_600426
proc url_DeleteQualificationType_601174(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteQualificationType_601173(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601184: Call_DeleteQualificationType_601172; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>DeleteQualificationType</code> deletes a Qualification type and deletes any HIT types that are associated with the Qualification type. </p> <p>This operation does not revoke Qualifications already assigned to Workers because the Qualifications might be needed for active HITs. If there are any pending requests for the Qualification type, Amazon Mechanical Turk rejects those requests. After you delete a Qualification type, you can no longer use it to create HITs or HIT types.</p> <note> <p>DeleteQualificationType must wait for all the HITs that use the deleted Qualification type to be deleted before completing. It may take up to 48 hours before DeleteQualificationType completes and the unique name of the Qualification type is available for reuse with CreateQualificationType.</p> </note>
  ## 
...
proc call*(call_601185: Call_DeleteQualificationType_601172; body: JsonNode): Recallable =
...
var deleteQualificationType* = Call_DeleteQualificationType_601172(
    ...
    validator: validate_DeleteQualificationType_601173, base: "/",
    url: url_DeleteQualificationType_601174, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteWorkerBlock_601187 = ref object of OpenApiRestCall_600426
proc url_DeleteWorkerBlock_601189(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteWorkerBlock_601188(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601199: Call_DeleteWorkerBlock_601187; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The <code>DeleteWorkerBlock</code> operation allows you to reinstate a blocked Worker to work on your HITs. This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to use this operation. If the Worker ID is missing or invalid, this operation fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns successfully.
  ## 
...
proc call*(call_601200: Call_DeleteWorkerBlock_601187; body: JsonNode): Recallable =
  ## deleteWorkerBlock
  ## The <code>DeleteWorkerBlock</code> operation allows you to reinstate a blocked Worker to work on your HITs. This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to use this operation. If the Worker ID is missing or invalid, this operation fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns successfully.
  ##   body: JObject (required)
...
var deleteWorkerBlock* = Call_DeleteWorkerBlock_601187(name: "deleteWorkerBlock",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock",
    validator: validate_DeleteWorkerBlock_601188, base: "/",
    url: url_DeleteWorkerBlock_601189, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateQualificationFromWorker_601202 = ref object of OpenApiRestCall_600426
proc url_DisassociateQualificationFromWorker_601204(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateQualificationFromWorker_601203(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601214: Call_DisassociateQualificationFromWorker_601202;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p> The <code>DisassociateQualificationFromWorker</code> revokes a previously granted Qualification from a user. </p> <p> You can provide a text message explaining why the Qualification was revoked. The user who had the Qualification can see this message. </p>
  ## 
...
proc call*(call_601215: Call_DisassociateQualificationFromWorker_601202;
          body: JsonNode): Recallable =
...
var disassociateQualificationFromWorker* = Call_DisassociateQualificationFromWorker_601202(
    ...
    validator: validate_DisassociateQualificationFromWorker_601203, base: "/",
    url: url_DisassociateQualificationFromWorker_601204,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAccountBalance_601217 = ref object of OpenApiRestCall_600426
proc url_GetAccountBalance_601219(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAccountBalance_601218(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601229: Call_GetAccountBalance_601217; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The <code>GetAccountBalance</code> operation retrieves the amount of money in your Amazon Mechanical Turk account.
  ## 
...
proc call*(call_601230: Call_GetAccountBalance_601217; body: JsonNode): Recallable =
  ## getAccountBalance
  ## The <code>GetAccountBalance</code> operation retrieves the amount of money in your Amazon Mechanical Turk account.
  ##   body: JObject (required)
...
var getAccountBalance* = Call_GetAccountBalance_601217(name: "getAccountBalance",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance",
    validator: validate_GetAccountBalance_601218, base: "/",
    url: url_GetAccountBalance_601219, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAssignment_601232 = ref object of OpenApiRestCall_600426
proc url_GetAssignment_601234(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAssignment_601233(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601244: Call_GetAssignment_601232; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>GetAssignment</code> operation retrieves the details of the specified Assignment. 
  ## 
...
proc call*(call_601245: Call_GetAssignment_601232; body: JsonNode): Recallable =
  ## getAssignment
  ##  The <code>GetAssignment</code> operation retrieves the details of the specified Assignment. 
  ##   body: JObject (required)
...
var getAssignment* = Call_GetAssignment_601232(name: "getAssignment",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment",
    validator: validate_GetAssignment_601233, base: "/", url: url_GetAssignment_601234,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFileUploadURL_601247 = ref object of OpenApiRestCall_600426
proc url_GetFileUploadURL_601249(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetFileUploadURL_601248(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601259: Call_GetFileUploadURL_601247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>GetFileUploadURL</code> operation generates and returns a temporary URL. You use the temporary URL to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The temporary URL is generated the instant the GetFileUploadURL operation is called, and is valid for 60 seconds. You can get a temporary file upload URL any time until the HIT is disposed. After the HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on December 12, 2017. The Answer Specification structure will no longer support the <code>FileUploadAnswer</code> element to be used for the QuestionForm data structure. Instead, we recommend that Requesters who want to create HITs asking Workers to upload files to use Amazon S3. 
  ## 
...
proc call*(call_601260: Call_GetFileUploadURL_601247; body: JsonNode): Recallable =
  ## getFileUploadURL
  ##  The <code>GetFileUploadURL</code> operation generates and returns a temporary URL. You use the temporary URL to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The temporary URL is generated the instant the GetFileUploadURL operation is called, and is valid for 60 seconds. You can get a temporary file upload URL any time until the HIT is disposed. After the HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on December 12, 2017. The Answer Specification structure will no longer support the <code>FileUploadAnswer</code> element to be used for the QuestionForm data structure. Instead, we recommend that Requesters who want to create HITs asking Workers to upload files to use Amazon S3. 
  ##   body: JObject (required)
...
var getFileUploadURL* = Call_GetFileUploadURL_601247(name: "getFileUploadURL",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL",
    validator: validate_GetFileUploadURL_601248, base: "/",
    url: url_GetFileUploadURL_601249, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetHIT_601262 = ref object of OpenApiRestCall_600426
proc url_GetHIT_601264(protocol: Scheme; host: string; base: string; route: string;
                      path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetHIT_601263(path: JsonNode; query: JsonNode; header: JsonNode;
                           formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601274: Call_GetHIT_601262; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>GetHIT</code> operation retrieves the details of the specified HIT. 
  ## 
...
proc call*(call_601275: Call_GetHIT_601262; body: JsonNode): Recallable =
  ## getHIT
  ##  The <code>GetHIT</code> operation retrieves the details of the specified HIT. 
  ##   body: JObject (required)
...
var getHIT* = Call_GetHIT_601262(name: "getHIT", meth: HttpMethod.HttpPost,
                              host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT",
                              validator: validate_GetHIT_601263, base: "/",
                              url: url_GetHIT_601264,
                              schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetQualificationScore_601277 = ref object of OpenApiRestCall_600426
proc url_GetQualificationScore_601279(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetQualificationScore_601278(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601289: Call_GetQualificationScore_601277; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>GetQualificationScore</code> operation returns the value of a Worker's Qualification for a given Qualification type. </p> <p> To get a Worker's Qualification, you must know the Worker's ID. The Worker's ID is included in the assignment data returned by the <code>ListAssignmentsForHIT</code> operation. </p> <p>Only the owner of a Qualification type can query the value of a Worker's Qualification of that type.</p>
  ## 
...
proc call*(call_601290: Call_GetQualificationScore_601277; body: JsonNode): Recallable =
...
var getQualificationScore* = Call_GetQualificationScore_601277(
    ...
    validator: validate_GetQualificationScore_601278, base: "/",
    url: url_GetQualificationScore_601279, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetQualificationType_601292 = ref object of OpenApiRestCall_600426
proc url_GetQualificationType_601294(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetQualificationType_601293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601304: Call_GetQualificationType_601292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>GetQualificationType</code>operation retrieves information about a Qualification type using its ID. 
  ## 
...
proc call*(call_601305: Call_GetQualificationType_601292; body: JsonNode): Recallable =
...
var getQualificationType* = Call_GetQualificationType_601292(
    ...
    validator: validate_GetQualificationType_601293, base: "/",
    url: url_GetQualificationType_601294, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAssignmentsForHIT_601307 = ref object of OpenApiRestCall_600426
proc url_ListAssignmentsForHIT_601309(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListAssignmentsForHIT_601308(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601321: Call_ListAssignmentsForHIT_601307; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>ListAssignmentsForHIT</code> operation retrieves completed assignments for a HIT. You can use this operation to retrieve the results for a HIT. </p> <p> You can get assignments for a HIT at any time, even if the HIT is not yet Reviewable. If a HIT requested multiple assignments, and has received some results but has not yet become Reviewable, you can still retrieve the partial results with this operation. </p> <p> Use the AssignmentStatus parameter to control which set of assignments for a HIT are returned. The ListAssignmentsForHIT operation can return submitted assignments awaiting approval, or it can return assignments that have already been approved or rejected. You can set AssignmentStatus=Approved,Rejected to get assignments that have already been approved and rejected together in one result set. </p> <p> Only the Requester who created the HIT can retrieve the assignments for that HIT. </p> <p> Results are sorted and divided into numbered pages and the operation returns a single page of results. You can use the parameters of the operation to control sorting and pagination. </p>
  ## 
...
proc call*(call_601322: Call_ListAssignmentsForHIT_601307; body: JsonNode;
...
var listAssignmentsForHIT* = Call_ListAssignmentsForHIT_601307(
    ...
    validator: validate_ListAssignmentsForHIT_601308, base: "/",
    url: url_ListAssignmentsForHIT_601309, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListBonusPayments_601326 = ref object of OpenApiRestCall_600426
proc url_ListBonusPayments_601328(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListBonusPayments_601327(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601340: Call_ListBonusPayments_601326; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListBonusPayments</code> operation retrieves the amounts of bonuses you have paid to Workers for a given HIT or assignment. 
  ## 
...
proc call*(call_601341: Call_ListBonusPayments_601326; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listBonusPayments
  ##  The <code>ListBonusPayments</code> operation retrieves the amounts of bonuses you have paid to Workers for a given HIT or assignment. 
  ##   NextToken: string
...
var listBonusPayments* = Call_ListBonusPayments_601326(name: "listBonusPayments",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments",
    validator: validate_ListBonusPayments_601327, base: "/",
    url: url_ListBonusPayments_601328, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListHITs_601344 = ref object of OpenApiRestCall_600426
proc url_ListHITs_601346(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListHITs_601345(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601358: Call_ListHITs_601344; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListHITs</code> operation returns all of a Requester's HITs. The operation returns HITs of any status, except for HITs that have been deleted of with the DeleteHIT operation or that have been auto-deleted. 
  ## 
...
proc call*(call_601359: Call_ListHITs_601344; body: JsonNode; NextToken: string = "";
...
var listHITs* = Call_ListHITs_601344(name: "listHITs", meth: HttpMethod.HttpPost,
                                  host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITs",
                                  validator: validate_ListHITs_601345, base: "/",
                                  url: url_ListHITs_601346,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListHITsForQualificationType_601362 = ref object of OpenApiRestCall_600426
proc url_ListHITsForQualificationType_601364(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListHITsForQualificationType_601363(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601376: Call_ListHITsForQualificationType_601362; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListHITsForQualificationType</code> operation returns the HITs that use the given Qualification type for a Qualification requirement. The operation returns HITs of any status, except for HITs that have been deleted with the <code>DeleteHIT</code> operation or that have been auto-deleted. 
  ## 
...
proc call*(call_601377: Call_ListHITsForQualificationType_601362; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listHITsForQualificationType* = Call_ListHITsForQualificationType_601362(
    ...
    validator: validate_ListHITsForQualificationType_601363, base: "/",
    url: url_ListHITsForQualificationType_601364,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListQualificationRequests_601380 = ref object of OpenApiRestCall_600426
proc url_ListQualificationRequests_601382(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListQualificationRequests_601381(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601394: Call_ListQualificationRequests_601380; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListQualificationRequests</code> operation retrieves requests for Qualifications of a particular Qualification type. The owner of the Qualification type calls this operation to poll for pending requests, and accepts them using the AcceptQualification operation. 
  ## 
...
proc call*(call_601395: Call_ListQualificationRequests_601380; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listQualificationRequests* = Call_ListQualificationRequests_601380(
    ...
    validator: validate_ListQualificationRequests_601381, base: "/",
    url: url_ListQualificationRequests_601382,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListQualificationTypes_601398 = ref object of OpenApiRestCall_600426
proc url_ListQualificationTypes_601400(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListQualificationTypes_601399(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601412: Call_ListQualificationTypes_601398; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListQualificationTypes</code> operation returns a list of Qualification types, filtered by an optional search term. 
  ## 
...
proc call*(call_601413: Call_ListQualificationTypes_601398; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listQualificationTypes* = Call_ListQualificationTypes_601398(
    ...
    validator: validate_ListQualificationTypes_601399, base: "/",
    url: url_ListQualificationTypes_601400, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListReviewPolicyResultsForHIT_601416 = ref object of OpenApiRestCall_600426
proc url_ListReviewPolicyResultsForHIT_601418(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListReviewPolicyResultsForHIT_601417(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_601419 = query.getOrDefault("NextToken")
  valid_601419 = validateParameter(valid_601419, JString, required = false,
                                 default = nil)
  if valid_601419 != nil:
    section.add "NextToken", valid_601419
...
proc call*(call_601430: Call_ListReviewPolicyResultsForHIT_601416; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListReviewPolicyResultsForHIT</code> operation retrieves the computed results and the actions taken in the course of executing your Review Policies for a given HIT. For information about how to specify Review Policies when you call CreateHIT, see Review Policies. The ListReviewPolicyResultsForHIT operation can return results for both Assignment-level and HIT-level review results. 
  ## 
...
proc call*(call_601431: Call_ListReviewPolicyResultsForHIT_601416; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listReviewPolicyResultsForHIT* = Call_ListReviewPolicyResultsForHIT_601416(
    ...
    validator: validate_ListReviewPolicyResultsForHIT_601417, base: "/",
    url: url_ListReviewPolicyResultsForHIT_601418,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListReviewableHITs_601434 = ref object of OpenApiRestCall_600426
proc url_ListReviewableHITs_601436(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListReviewableHITs_601435(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601448: Call_ListReviewableHITs_601434; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>ListReviewableHITs</code> operation retrieves the HITs with Status equal to Reviewable or Status equal to Reviewing that belong to the Requester calling the operation. 
  ## 
...
proc call*(call_601449: Call_ListReviewableHITs_601434; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listReviewableHITs
  ##  The <code>ListReviewableHITs</code> operation retrieves the HITs with Status equal to Reviewable or Status equal to Reviewing that belong to the Requester calling the operation. 
  ##   NextToken: string
...
var listReviewableHITs* = Call_ListReviewableHITs_601434(
    ...
    validator: validate_ListReviewableHITs_601435, base: "/",
    url: url_ListReviewableHITs_601436, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListWorkerBlocks_601452 = ref object of OpenApiRestCall_600426
proc url_ListWorkerBlocks_601454(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListWorkerBlocks_601453(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601466: Call_ListWorkerBlocks_601452; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.
  ## 
...
proc call*(call_601467: Call_ListWorkerBlocks_601452; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listWorkerBlocks
  ## The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.
  ##   NextToken: string
...
var listWorkerBlocks* = Call_ListWorkerBlocks_601452(name: "listWorkerBlocks",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks",
    validator: validate_ListWorkerBlocks_601453, base: "/",
    url: url_ListWorkerBlocks_601454, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListWorkersWithQualificationType_601470 = ref object of OpenApiRestCall_600426
proc url_ListWorkersWithQualificationType_601472(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListWorkersWithQualificationType_601471(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_601474 = query.getOrDefault("MaxResults")
  valid_601474 = validateParameter(valid_601474, JString, required = false,
                                 default = nil)
  if valid_601474 != nil:
    section.add "MaxResults", valid_601474
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601484: Call_ListWorkersWithQualificationType_601470;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ##  The <code>ListWorkersWithQualificationType</code> operation returns all of the Workers that have been associated with a given Qualification type. 
  ## 
...
proc call*(call_601485: Call_ListWorkersWithQualificationType_601470;
...
var listWorkersWithQualificationType* = Call_ListWorkersWithQualificationType_601470(
    ...
    validator: validate_ListWorkersWithQualificationType_601471, base: "/",
    url: url_ListWorkersWithQualificationType_601472,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyWorkers_601488 = ref object of OpenApiRestCall_600426
proc url_NotifyWorkers_601490(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_NotifyWorkers_601489(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601500: Call_NotifyWorkers_601488; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>NotifyWorkers</code> operation sends an email to one or more Workers that you specify with the Worker ID. You can specify up to 100 Worker IDs to send the same message with a single call to the NotifyWorkers operation. The NotifyWorkers operation will send a notification email to a Worker only if you have previously approved or rejected work from the Worker. 
  ## 
...
proc call*(call_601501: Call_NotifyWorkers_601488; body: JsonNode): Recallable =
  ## notifyWorkers
  ##  The <code>NotifyWorkers</code> operation sends an email to one or more Workers that you specify with the Worker ID. You can specify up to 100 Worker IDs to send the same message with a single call to the NotifyWorkers operation. The NotifyWorkers operation will send a notification email to a Worker only if you have previously approved or rejected work from the Worker. 
  ##   body: JObject (required)
...
var notifyWorkers* = Call_NotifyWorkers_601488(name: "notifyWorkers",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers",
    validator: validate_NotifyWorkers_601489, base: "/", url: url_NotifyWorkers_601490,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectAssignment_601503 = ref object of OpenApiRestCall_600426
proc url_RejectAssignment_601505(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RejectAssignment_601504(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601515: Call_RejectAssignment_601503; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>RejectAssignment</code> operation rejects the results of a completed assignment. </p> <p> You can include an optional feedback message with the rejection, which the Worker can see in the Status section of the web site. When you include a feedback message with the rejection, it helps the Worker understand why the assignment was rejected, and can improve the quality of the results the Worker submits in the future. </p> <p> Only the Requester who created the HIT can reject an assignment for the HIT. </p>
  ## 
...
proc call*(call_601516: Call_RejectAssignment_601503; body: JsonNode): Recallable =
  ## rejectAssignment
  ## <p> The <code>RejectAssignment</code> operation rejects the results of a completed assignment. </p> <p> You can include an optional feedback message with the rejection, which the Worker can see in the Status section of the web site. When you include a feedback message with the rejection, it helps the Worker understand why the assignment was rejected, and can improve the quality of the results the Worker submits in the future. </p> <p> Only the Requester who created the HIT can reject an assignment for the HIT. </p>
  ##   body: JObject (required)
...
var rejectAssignment* = Call_RejectAssignment_601503(name: "rejectAssignment",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment",
    validator: validate_RejectAssignment_601504, base: "/",
    url: url_RejectAssignment_601505, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectQualificationRequest_601518 = ref object of OpenApiRestCall_600426
proc url_RejectQualificationRequest_601520(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RejectQualificationRequest_601519(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601530: Call_RejectQualificationRequest_601518; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>RejectQualificationRequest</code> operation rejects a user's request for a Qualification. </p> <p> You can provide a text message explaining why the request was rejected. The Worker who made the request can see this message.</p>
  ## 
...
proc call*(call_601531: Call_RejectQualificationRequest_601518; body: JsonNode): Recallable =
...
var rejectQualificationRequest* = Call_RejectQualificationRequest_601518(
    ...
    validator: validate_RejectQualificationRequest_601519, base: "/",
    url: url_RejectQualificationRequest_601520,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendBonus_601533 = ref object of OpenApiRestCall_600426
proc url_SendBonus_601535(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_SendBonus_601534(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601545: Call_SendBonus_601533; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>SendBonus</code> operation issues a payment of money from your account to a Worker. This payment happens separately from the reward you pay to the Worker when you approve the Worker's assignment. The SendBonus operation requires the Worker's ID and the assignment ID as parameters to initiate payment of the bonus. You must include a message that explains the reason for the bonus payment, as the Worker may not be expecting the payment. Amazon Mechanical Turk collects a fee for bonus payments, similar to the HIT listing fee. This operation fails if your account does not have enough funds to pay for both the bonus and the fees. 
  ## 
...
proc call*(call_601546: Call_SendBonus_601533; body: JsonNode): Recallable =
  ## sendBonus
  ##  The <code>SendBonus</code> operation issues a payment of money from your account to a Worker. This payment happens separately from the reward you pay to the Worker when you approve the Worker's assignment. The SendBonus operation requires the Worker's ID and the assignment ID as parameters to initiate payment of the bonus. You must include a message that explains the reason for the bonus payment, as the Worker may not be expecting the payment. Amazon Mechanical Turk collects a fee for bonus payments, similar to the HIT listing fee. This operation fails if your account does not have enough funds to pay for both the bonus and the fees. 
  ##   body: JObject (required)
...
var sendBonus* = Call_SendBonus_601533(name: "sendBonus", meth: HttpMethod.HttpPost,
                                    host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus",
                                    validator: validate_SendBonus_601534,
                                    base: "/", url: url_SendBonus_601535,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendTestEventNotification_601548 = ref object of OpenApiRestCall_600426
proc url_SendTestEventNotification_601550(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_SendTestEventNotification_601549(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601560: Call_SendTestEventNotification_601548; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>SendTestEventNotification</code> operation causes Amazon Mechanical Turk to send a notification message as if a HIT event occurred, according to the provided notification specification. This allows you to test notifications without setting up notifications for a real HIT type and trying to trigger them using the website. When you call this operation, the service attempts to send the test notification immediately. 
  ## 
...
proc call*(call_601561: Call_SendTestEventNotification_601548; body: JsonNode): Recallable =
...
var sendTestEventNotification* = Call_SendTestEventNotification_601548(
    ...
    validator: validate_SendTestEventNotification_601549, base: "/",
    url: url_SendTestEventNotification_601550,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateExpirationForHIT_601563 = ref object of OpenApiRestCall_600426
proc url_UpdateExpirationForHIT_601565(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateExpirationForHIT_601564(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601575: Call_UpdateExpirationForHIT_601563; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>UpdateExpirationForHIT</code> operation allows you update the expiration time of a HIT. If you update it to a time in the past, the HIT will be immediately expired. 
  ## 
...
proc call*(call_601576: Call_UpdateExpirationForHIT_601563; body: JsonNode): Recallable =
...
var updateExpirationForHIT* = Call_UpdateExpirationForHIT_601563(
    ...
    validator: validate_UpdateExpirationForHIT_601564, base: "/",
    url: url_UpdateExpirationForHIT_601565, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateHITReviewStatus_601578 = ref object of OpenApiRestCall_600426
proc url_UpdateHITReviewStatus_601580(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateHITReviewStatus_601579(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601590: Call_UpdateHITReviewStatus_601578; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>UpdateHITReviewStatus</code> operation updates the status of a HIT. If the status is Reviewable, this operation can update the status to Reviewing, or it can revert a Reviewing HIT back to the Reviewable status. 
  ## 
...
proc call*(call_601591: Call_UpdateHITReviewStatus_601578; body: JsonNode): Recallable =
...
var updateHITReviewStatus* = Call_UpdateHITReviewStatus_601578(
    ...
    validator: validate_UpdateHITReviewStatus_601579, base: "/",
    url: url_UpdateHITReviewStatus_601580, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateHITTypeOfHIT_601593 = ref object of OpenApiRestCall_600426
proc url_UpdateHITTypeOfHIT_601595(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateHITTypeOfHIT_601594(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601605: Call_UpdateHITTypeOfHIT_601593; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>UpdateHITTypeOfHIT</code> operation allows you to change the HITType properties of a HIT. This operation disassociates the HIT from its old HITType properties and associates it with the new HITType properties. The HIT takes on the properties of the new HITType in place of the old ones. 
  ## 
...
proc call*(call_601606: Call_UpdateHITTypeOfHIT_601593; body: JsonNode): Recallable =
  ## updateHITTypeOfHIT
  ##  The <code>UpdateHITTypeOfHIT</code> operation allows you to change the HITType properties of a HIT. This operation disassociates the HIT from its old HITType properties and associates it with the new HITType properties. The HIT takes on the properties of the new HITType in place of the old ones. 
  ##   body: JObject (required)
...
var updateHITTypeOfHIT* = Call_UpdateHITTypeOfHIT_601593(
    name: "updateHITTypeOfHIT", meth: HttpMethod.HttpPost,
    host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT",
    validator: validate_UpdateHITTypeOfHIT_601594, base: "/",
    url: url_UpdateHITTypeOfHIT_601595, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotificationSettings_601608 = ref object of OpenApiRestCall_600426
proc url_UpdateNotificationSettings_601610(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateNotificationSettings_601609(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601620: Call_UpdateNotificationSettings_601608; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  The <code>UpdateNotificationSettings</code> operation creates, updates, disables or re-enables notifications for a HIT type. If you call the UpdateNotificationSettings operation for a HIT type that already has a notification specification, the operation replaces the old specification with a new one. You can call the UpdateNotificationSettings operation to enable or disable notifications for the HIT type, without having to modify the notification specification itself by providing updates to the Active status without specifying a new notification specification. To change the Active status of a HIT type's notifications, the HIT type must already have a notification specification, or one must be provided in the same call to <code>UpdateNotificationSettings</code>. 
  ## 
...
proc call*(call_601621: Call_UpdateNotificationSettings_601608; body: JsonNode): Recallable =
...
var updateNotificationSettings* = Call_UpdateNotificationSettings_601608(
    ...
    validator: validate_UpdateNotificationSettings_601609, base: "/",
    url: url_UpdateNotificationSettings_601610,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateQualificationType_601623 = ref object of OpenApiRestCall_600426
proc url_UpdateQualificationType_601625(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateQualificationType_601624(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601635: Call_UpdateQualificationType_601623; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> The <code>UpdateQualificationType</code> operation modifies the attributes of an existing Qualification type, which is represented by a QualificationType data structure. Only the owner of a Qualification type can modify its attributes. </p> <p> Most attributes of a Qualification type can be changed after the type has been created. However, the Name and Keywords fields cannot be modified. The RetryDelayInSeconds parameter can be modified or added to change the delay or to enable retries, but RetryDelayInSeconds cannot be used to disable retries. </p> <p> You can use this operation to update the test for a Qualification type. The test is updated based on the values specified for the Test, TestDurationInSeconds and AnswerKey parameters. All three parameters specify the updated test. If you are updating the test for a type, you must specify the Test and TestDurationInSeconds parameters. The AnswerKey parameter is optional; omitting it specifies that the updated test does not have an answer key. </p> <p> If you omit the Test parameter, the test for the Qualification type is unchanged. There is no way to remove a test from a Qualification type that has one. If the type already has a test, you cannot update it to be AutoGranted. If the Qualification type does not have a test and one is provided by an update, the type will henceforth have a test. </p> <p> If you want to update the test duration or answer key for an existing test without changing the questions, you must specify a Test parameter with the original questions, along with the updated values. </p> <p> If you provide an updated Test but no AnswerKey, the new test will not have an answer key. Requests for such Qualifications must be granted manually. </p> <p> You can also update the AutoGranted and AutoGrantedValue attributes of the Qualification type.</p>
  ## 
...
proc call*(call_601636: Call_UpdateQualificationType_601623; body: JsonNode): Recallable =
...
var updateQualificationType* = Call_UpdateQualificationType_601623(
    ...
    validator: validate_UpdateQualificationType_601624, base: "/",
    url: url_UpdateQualificationType_601625, schemes: {Scheme.Https, Scheme.Http})
export
  rest
