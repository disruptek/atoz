...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_AcceptQualificationRequest_21625779 = ref object of OpenApiRestCall_21625435
proc url_AcceptQualificationRequest_21625781(protocol: Scheme; host: string;
...
proc validate_AcceptQualificationRequest_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_AcceptQualificationRequest_21625779;
...
proc call*(call_21625992: Call_AcceptQualificationRequest_21625779; body: JsonNode): Recallable =
...
var acceptQualificationRequest* = Call_AcceptQualificationRequest_21625779(
    ...
    validator: validate_AcceptQualificationRequest_21625780, base: "/",
    makeUrl: url_AcceptQualificationRequest_21625781,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ApproveAssignment_21626029 = ref object of OpenApiRestCall_21625435
proc url_ApproveAssignment_21626031(protocol: Scheme; host: string; base: string;
...
proc validate_ApproveAssignment_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_ApproveAssignment_21626029; path: JsonNode = nil;
...
proc call*(call_21626042: Call_ApproveAssignment_21626029; body: JsonNode): Recallable =
  ## approveAssignment
  ## <p> The <code>ApproveAssignment</code> operation approves the results of a completed assignment. </p> <p> Approving an assignment initiates two payments from the Requester's Amazon.com account </p> <ul> <li> <p> The Worker who submitted the results is paid the reward specified in the HIT. </p> </li> <li> <p> Amazon Mechanical Turk fees are debited. </p> </li> </ul> <p> If the Requester's account does not have adequate funds for these payments, the call to ApproveAssignment returns an exception, and the approval is not processed. You can include an optional feedback message with the approval, which the Worker can see in the Status section of the web site. </p> <p> You can also call this operation for assignments that were previous rejected and approve them by explicitly overriding the previous rejection. This only works on rejected assignments that were submitted within the previous 30 days and only if the assignment's related HIT has not been deleted. </p>
  ##   body: JObject (required)
...
var approveAssignment* = Call_ApproveAssignment_21626029(name: "approveAssignment",
    ...
    validator: validate_ApproveAssignment_21626030, base: "/",
    makeUrl: url_ApproveAssignment_21626031, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateQualificationWithWorker_21626044 = ref object of OpenApiRestCall_21625435
proc url_AssociateQualificationWithWorker_21626046(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AssociateQualificationWithWorker_21626045(path: JsonNode;
...
proc call*(call_21626056: Call_AssociateQualificationWithWorker_21626044;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>AssociateQualificationWithWorker</code> operation gives a Worker a Qualification. <code>AssociateQualificationWithWorker</code> does not require that the Worker submit a Qualification request. It gives the Qualification directly to the Worker. </p> <p> You can only assign a Qualification of a Qualification type that you created (using the <code>CreateQualificationType</code> operation). </p> <note> <p> Note: <code>AssociateQualificationWithWorker</code> does not affect any pending Qualification requests for the Qualification by the Worker. If you assign a Qualification to a Worker, then later grant a Qualification request made by the Worker, the granting of the request may modify the Qualification score. To resolve a pending Qualification request without affecting the Qualification the Worker already has, reject the request with the <code>RejectQualificationRequest</code> operation. </p> </note>
  ## 
...
proc call*(call_21626057: Call_AssociateQualificationWithWorker_21626044;
...
var associateQualificationWithWorker* = Call_AssociateQualificationWithWorker_21626044(
    ...
    validator: validate_AssociateQualificationWithWorker_21626045, base: "/",
    makeUrl: url_AssociateQualificationWithWorker_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAdditionalAssignmentsForHIT_21626059 = ref object of OpenApiRestCall_21625435
proc url_CreateAdditionalAssignmentsForHIT_21626061(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAdditionalAssignmentsForHIT_21626060(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626071: Call_CreateAdditionalAssignmentsForHIT_21626059;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>CreateAdditionalAssignmentsForHIT</code> operation increases the maximum number of assignments of an existing HIT. </p> <p> To extend the maximum number of assignments, specify the number of additional assignments.</p> <note> <ul> <li> <p>HITs created with fewer than 10 assignments cannot be extended to have 10 or more assignments. Attempting to add assignments in a way that brings the total number of assignments for a HIT from fewer than 10 assignments to 10 or more assignments will result in an <code>AWS.MechanicalTurk.InvalidMaximumAssignmentsIncrease</code> exception.</p> </li> <li> <p>HITs that were created before July 22, 2015 cannot be extended. Attempting to extend HITs that were created before July 22, 2015 will result in an <code>AWS.MechanicalTurk.HITTooOldForExtension</code> exception. </p> </li> </ul> </note>
  ## 
...
proc call*(call_21626072: Call_CreateAdditionalAssignmentsForHIT_21626059;
          body: JsonNode): Recallable =
...
var createAdditionalAssignmentsForHIT* = Call_CreateAdditionalAssignmentsForHIT_21626059(
    ...
    validator: validate_CreateAdditionalAssignmentsForHIT_21626060, base: "/",
    makeUrl: url_CreateAdditionalAssignmentsForHIT_21626061,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHIT_21626074 = ref object of OpenApiRestCall_21625435
proc url_CreateHIT_21626076(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateHIT_21626075(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21626086: Call_CreateHIT_21626074; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The <code>CreateHIT</code> operation creates a new Human Intelligence Task (HIT). The new HIT is made available for Workers to find and accept on the Amazon Mechanical Turk website. </p> <p> This operation allows you to specify a new HIT by passing in values for the properties of the HIT, such as its title, reward amount and number of assignments. When you pass these values to <code>CreateHIT</code>, a new HIT is created for you, with a new <code>HITTypeID</code>. The HITTypeID can be used to create additional HITs in the future without needing to specify common parameters such as the title, description and reward amount each time.</p> <p> An alternative way to create HITs is to first generate a HITTypeID using the <code>CreateHITType</code> operation and then call the <code>CreateHITWithHITType</code> operation. This is the recommended best practice for Requesters who are creating large numbers of HITs. </p> <p>CreateHIT also supports several ways to provide question data: by providing a value for the <code>Question</code> parameter that fully specifies the contents of the HIT, or by providing a <code>HitLayoutId</code> and associated <code>HitLayoutParameters</code>. </p> <note> <p> If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see <a href="https://requester.mturk.com/pricing">Amazon Mechanical Turk Pricing</a>.</p> </note>
  ## 
...
proc call*(call_21626087: Call_CreateHIT_21626074; body: JsonNode): Recallable =
  ## createHIT
  ## <p>The <code>CreateHIT</code> operation creates a new Human Intelligence Task (HIT). The new HIT is made available for Workers to find and accept on the Amazon Mechanical Turk website. </p> <p> This operation allows you to specify a new HIT by passing in values for the properties of the HIT, such as its title, reward amount and number of assignments. When you pass these values to <code>CreateHIT</code>, a new HIT is created for you, with a new <code>HITTypeID</code>. The HITTypeID can be used to create additional HITs in the future without needing to specify common parameters such as the title, description and reward amount each time.</p> <p> An alternative way to create HITs is to first generate a HITTypeID using the <code>CreateHITType</code> operation and then call the <code>CreateHITWithHITType</code> operation. This is the recommended best practice for Requesters who are creating large numbers of HITs. </p> <p>CreateHIT also supports several ways to provide question data: by providing a value for the <code>Question</code> parameter that fully specifies the contents of the HIT, or by providing a <code>HitLayoutId</code> and associated <code>HitLayoutParameters</code>. </p> <note> <p> If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see <a href="https://requester.mturk.com/pricing">Amazon Mechanical Turk Pricing</a>.</p> </note>
  ##   body: JObject (required)
...
var createHIT* = Call_CreateHIT_21626074(name: "createHIT",
                                      meth: HttpMethod.HttpPost,
                                      host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT",
                                      validator: validate_CreateHIT_21626075,
                                      base: "/", makeUrl: url_CreateHIT_21626076,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHITType_21626089 = ref object of OpenApiRestCall_21625435
proc url_CreateHITType_21626091(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateHITType_21626090(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626101: Call_CreateHITType_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>CreateHITType</code> operation creates a new HIT type. This operation allows you to define a standard set of HIT properties to use when creating HITs. If you register a HIT type with values that match an existing HIT type, the HIT type ID of the existing type will be returned. 
  ## 
...
proc call*(call_21626102: Call_CreateHITType_21626089; body: JsonNode): Recallable =
  ## createHITType
  ##  The <code>CreateHITType</code> operation creates a new HIT type. This operation allows you to define a standard set of HIT properties to use when creating HITs. If you register a HIT type with values that match an existing HIT type, the HIT type ID of the existing type will be returned. 
  ##   body: JObject (required)
...
var createHITType* = Call_CreateHITType_21626089(name: "createHITType",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType",
    validator: validate_CreateHITType_21626090, base: "/",
    makeUrl: url_CreateHITType_21626091, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateHITWithHITType_21626104 = ref object of OpenApiRestCall_21625435
proc url_CreateHITWithHITType_21626106(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateHITWithHITType_21626105(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_CreateHITWithHITType_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>CreateHITWithHITType</code> operation creates a new Human Intelligence Task (HIT) using an existing HITTypeID generated by the <code>CreateHITType</code> operation. </p> <p> This is an alternative way to create HITs from the <code>CreateHIT</code> operation. This is the recommended best practice for Requesters who are creating large numbers of HITs. </p> <p>CreateHITWithHITType also supports several ways to provide question data: by providing a value for the <code>Question</code> parameter that fully specifies the contents of the HIT, or by providing a <code>HitLayoutId</code> and associated <code>HitLayoutParameters</code>. </p> <note> <p> If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more information, see <a href="https://requester.mturk.com/pricing">Amazon Mechanical Turk Pricing</a>. </p> </note>
  ## 
...
proc call*(call_21626117: Call_CreateHITWithHITType_21626104; body: JsonNode): Recallable =
...
var createHITWithHITType* = Call_CreateHITWithHITType_21626104(
    ...
    validator: validate_CreateHITWithHITType_21626105, base: "/",
    makeUrl: url_CreateHITWithHITType_21626106,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateQualificationType_21626119 = ref object of OpenApiRestCall_21625435
proc url_CreateQualificationType_21626121(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateQualificationType_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_CreateQualificationType_21626119;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>CreateQualificationType</code> operation creates a new Qualification type, which is represented by a <code>QualificationType</code> data structure. 
  ## 
...
proc call*(call_21626132: Call_CreateQualificationType_21626119; body: JsonNode): Recallable =
...
var createQualificationType* = Call_CreateQualificationType_21626119(
    ...
    validator: validate_CreateQualificationType_21626120, base: "/",
    makeUrl: url_CreateQualificationType_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateWorkerBlock_21626134 = ref object of OpenApiRestCall_21625435
proc url_CreateWorkerBlock_21626136(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateWorkerBlock_21626135(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_CreateWorkerBlock_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The <code>CreateWorkerBlock</code> operation allows you to prevent a Worker from working on your HITs. For example, you can block a Worker who is producing poor quality work. You can block up to 100,000 Workers.
  ## 
...
proc call*(call_21626147: Call_CreateWorkerBlock_21626134; body: JsonNode): Recallable =
  ## createWorkerBlock
  ## The <code>CreateWorkerBlock</code> operation allows you to prevent a Worker from working on your HITs. For example, you can block a Worker who is producing poor quality work. You can block up to 100,000 Workers.
  ##   body: JObject (required)
...
var createWorkerBlock* = Call_CreateWorkerBlock_21626134(name: "createWorkerBlock",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock",
    validator: validate_CreateWorkerBlock_21626135, base: "/",
    makeUrl: url_CreateWorkerBlock_21626136, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteHIT_21626149 = ref object of OpenApiRestCall_21625435
proc url_DeleteHIT_21626151(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteHIT_21626150(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626161: Call_DeleteHIT_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>DeleteHIT</code> operation is used to delete HIT that is no longer needed. Only the Requester who created the HIT can delete it. </p> <p> You can only dispose of HITs that are in the <code>Reviewable</code> state, with all of their submitted assignments already either approved or rejected. If you call the DeleteHIT operation on a HIT that is not in the <code>Reviewable</code> state (for example, that has not expired, or still has active assignments), or on a HIT that is Reviewable but without all of its submitted assignments already approved or rejected, the service will return an error. </p> <note> <ul> <li> <p> HITs are automatically disposed of after 120 days. </p> </li> <li> <p> After you dispose of a HIT, you can no longer approve the HIT's rejected assignments. </p> </li> <li> <p> Disposed HITs are not returned in results for the ListHITs operation. </p> </li> <li> <p> Disposing HITs can improve the performance of operations such as ListReviewableHITs and ListHITs. </p> </li> </ul> </note>
  ## 
...
proc call*(call_21626162: Call_DeleteHIT_21626149; body: JsonNode): Recallable =
  ## deleteHIT
  ## <p> The <code>DeleteHIT</code> operation is used to delete HIT that is no longer needed. Only the Requester who created the HIT can delete it. </p> <p> You can only dispose of HITs that are in the <code>Reviewable</code> state, with all of their submitted assignments already either approved or rejected. If you call the DeleteHIT operation on a HIT that is not in the <code>Reviewable</code> state (for example, that has not expired, or still has active assignments), or on a HIT that is Reviewable but without all of its submitted assignments already approved or rejected, the service will return an error. </p> <note> <ul> <li> <p> HITs are automatically disposed of after 120 days. </p> </li> <li> <p> After you dispose of a HIT, you can no longer approve the HIT's rejected assignments. </p> </li> <li> <p> Disposed HITs are not returned in results for the ListHITs operation. </p> </li> <li> <p> Disposing HITs can improve the performance of operations such as ListReviewableHITs and ListHITs. </p> </li> </ul> </note>
  ##   body: JObject (required)
...
var deleteHIT* = Call_DeleteHIT_21626149(name: "deleteHIT",
                                      meth: HttpMethod.HttpPost,
                                      host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT",
                                      validator: validate_DeleteHIT_21626150,
                                      base: "/", makeUrl: url_DeleteHIT_21626151,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteQualificationType_21626164 = ref object of OpenApiRestCall_21625435
proc url_DeleteQualificationType_21626166(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteQualificationType_21626165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_DeleteQualificationType_21626164;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>DeleteQualificationType</code> deletes a Qualification type and deletes any HIT types that are associated with the Qualification type. </p> <p>This operation does not revoke Qualifications already assigned to Workers because the Qualifications might be needed for active HITs. If there are any pending requests for the Qualification type, Amazon Mechanical Turk rejects those requests. After you delete a Qualification type, you can no longer use it to create HITs or HIT types.</p> <note> <p>DeleteQualificationType must wait for all the HITs that use the deleted Qualification type to be deleted before completing. It may take up to 48 hours before DeleteQualificationType completes and the unique name of the Qualification type is available for reuse with CreateQualificationType.</p> </note>
  ## 
...
proc call*(call_21626177: Call_DeleteQualificationType_21626164; body: JsonNode): Recallable =
...
var deleteQualificationType* = Call_DeleteQualificationType_21626164(
    ...
    validator: validate_DeleteQualificationType_21626165, base: "/",
    makeUrl: url_DeleteQualificationType_21626166,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteWorkerBlock_21626179 = ref object of OpenApiRestCall_21625435
proc url_DeleteWorkerBlock_21626181(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteWorkerBlock_21626180(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626191: Call_DeleteWorkerBlock_21626179; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The <code>DeleteWorkerBlock</code> operation allows you to reinstate a blocked Worker to work on your HITs. This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to use this operation. If the Worker ID is missing or invalid, this operation fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns successfully.
  ## 
...
proc call*(call_21626192: Call_DeleteWorkerBlock_21626179; body: JsonNode): Recallable =
  ## deleteWorkerBlock
  ## The <code>DeleteWorkerBlock</code> operation allows you to reinstate a blocked Worker to work on your HITs. This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to use this operation. If the Worker ID is missing or invalid, this operation fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns successfully.
  ##   body: JObject (required)
...
var deleteWorkerBlock* = Call_DeleteWorkerBlock_21626179(name: "deleteWorkerBlock",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock",
    validator: validate_DeleteWorkerBlock_21626180, base: "/",
    makeUrl: url_DeleteWorkerBlock_21626181, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateQualificationFromWorker_21626194 = ref object of OpenApiRestCall_21625435
proc url_DisassociateQualificationFromWorker_21626196(protocol: Scheme;
...
proc validate_DisassociateQualificationFromWorker_21626195(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626206: Call_DisassociateQualificationFromWorker_21626194;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>DisassociateQualificationFromWorker</code> revokes a previously granted Qualification from a user. </p> <p> You can provide a text message explaining why the Qualification was revoked. The user who had the Qualification can see this message. </p>
  ## 
...
proc call*(call_21626207: Call_DisassociateQualificationFromWorker_21626194;
          body: JsonNode): Recallable =
...
var disassociateQualificationFromWorker* = Call_DisassociateQualificationFromWorker_21626194(
    ...
    validator: validate_DisassociateQualificationFromWorker_21626195, base: "/",
    makeUrl: url_DisassociateQualificationFromWorker_21626196,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAccountBalance_21626209 = ref object of OpenApiRestCall_21625435
proc url_GetAccountBalance_21626211(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAccountBalance_21626210(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626221: Call_GetAccountBalance_21626209; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The <code>GetAccountBalance</code> operation retrieves the amount of money in your Amazon Mechanical Turk account.
  ## 
...
proc call*(call_21626222: Call_GetAccountBalance_21626209; body: JsonNode): Recallable =
  ## getAccountBalance
  ## The <code>GetAccountBalance</code> operation retrieves the amount of money in your Amazon Mechanical Turk account.
  ##   body: JObject (required)
...
var getAccountBalance* = Call_GetAccountBalance_21626209(name: "getAccountBalance",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance",
    validator: validate_GetAccountBalance_21626210, base: "/",
    makeUrl: url_GetAccountBalance_21626211, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAssignment_21626224 = ref object of OpenApiRestCall_21625435
proc url_GetAssignment_21626226(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAssignment_21626225(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626236: Call_GetAssignment_21626224; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>GetAssignment</code> operation retrieves the details of the specified Assignment. 
  ## 
...
proc call*(call_21626237: Call_GetAssignment_21626224; body: JsonNode): Recallable =
  ## getAssignment
  ##  The <code>GetAssignment</code> operation retrieves the details of the specified Assignment. 
  ##   body: JObject (required)
...
var getAssignment* = Call_GetAssignment_21626224(name: "getAssignment",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment",
    validator: validate_GetAssignment_21626225, base: "/",
    makeUrl: url_GetAssignment_21626226, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFileUploadURL_21626239 = ref object of OpenApiRestCall_21625435
proc url_GetFileUploadURL_21626241(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetFileUploadURL_21626240(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626251: Call_GetFileUploadURL_21626239; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>GetFileUploadURL</code> operation generates and returns a temporary URL. You use the temporary URL to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The temporary URL is generated the instant the GetFileUploadURL operation is called, and is valid for 60 seconds. You can get a temporary file upload URL any time until the HIT is disposed. After the HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on December 12, 2017. The Answer Specification structure will no longer support the <code>FileUploadAnswer</code> element to be used for the QuestionForm data structure. Instead, we recommend that Requesters who want to create HITs asking Workers to upload files to use Amazon S3. 
  ## 
...
proc call*(call_21626252: Call_GetFileUploadURL_21626239; body: JsonNode): Recallable =
  ## getFileUploadURL
  ##  The <code>GetFileUploadURL</code> operation generates and returns a temporary URL. You use the temporary URL to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The temporary URL is generated the instant the GetFileUploadURL operation is called, and is valid for 60 seconds. You can get a temporary file upload URL any time until the HIT is disposed. After the HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on December 12, 2017. The Answer Specification structure will no longer support the <code>FileUploadAnswer</code> element to be used for the QuestionForm data structure. Instead, we recommend that Requesters who want to create HITs asking Workers to upload files to use Amazon S3. 
  ##   body: JObject (required)
...
var getFileUploadURL* = Call_GetFileUploadURL_21626239(name: "getFileUploadURL",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL",
    validator: validate_GetFileUploadURL_21626240, base: "/",
    makeUrl: url_GetFileUploadURL_21626241, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetHIT_21626254 = ref object of OpenApiRestCall_21625435
proc url_GetHIT_21626256(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetHIT_21626255(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626266: Call_GetHIT_21626254; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>GetHIT</code> operation retrieves the details of the specified HIT. 
  ## 
...
proc call*(call_21626267: Call_GetHIT_21626254; body: JsonNode): Recallable =
  ## getHIT
  ##  The <code>GetHIT</code> operation retrieves the details of the specified HIT. 
  ##   body: JObject (required)
...
var getHIT* = Call_GetHIT_21626254(name: "getHIT", meth: HttpMethod.HttpPost,
                                host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT",
                                validator: validate_GetHIT_21626255, base: "/",
                                makeUrl: url_GetHIT_21626256,
                                schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetQualificationScore_21626269 = ref object of OpenApiRestCall_21625435
proc url_GetQualificationScore_21626271(protocol: Scheme; host: string; base: string;
...
proc validate_GetQualificationScore_21626270(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626281: Call_GetQualificationScore_21626269;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>GetQualificationScore</code> operation returns the value of a Worker's Qualification for a given Qualification type. </p> <p> To get a Worker's Qualification, you must know the Worker's ID. The Worker's ID is included in the assignment data returned by the <code>ListAssignmentsForHIT</code> operation. </p> <p>Only the owner of a Qualification type can query the value of a Worker's Qualification of that type.</p>
  ## 
...
proc call*(call_21626282: Call_GetQualificationScore_21626269; body: JsonNode): Recallable =
...
var getQualificationScore* = Call_GetQualificationScore_21626269(
    ...
    validator: validate_GetQualificationScore_21626270, base: "/",
    makeUrl: url_GetQualificationScore_21626271,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetQualificationType_21626284 = ref object of OpenApiRestCall_21625435
proc url_GetQualificationType_21626286(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetQualificationType_21626285(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626296: Call_GetQualificationType_21626284; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>GetQualificationType</code>operation retrieves information about a Qualification type using its ID. 
  ## 
...
proc call*(call_21626297: Call_GetQualificationType_21626284; body: JsonNode): Recallable =
...
var getQualificationType* = Call_GetQualificationType_21626284(
    ...
    validator: validate_GetQualificationType_21626285, base: "/",
    makeUrl: url_GetQualificationType_21626286,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAssignmentsForHIT_21626299 = ref object of OpenApiRestCall_21625435
proc url_ListAssignmentsForHIT_21626301(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListAssignmentsForHIT_21626300(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626313: Call_ListAssignmentsForHIT_21626299;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>ListAssignmentsForHIT</code> operation retrieves completed assignments for a HIT. You can use this operation to retrieve the results for a HIT. </p> <p> You can get assignments for a HIT at any time, even if the HIT is not yet Reviewable. If a HIT requested multiple assignments, and has received some results but has not yet become Reviewable, you can still retrieve the partial results with this operation. </p> <p> Use the AssignmentStatus parameter to control which set of assignments for a HIT are returned. The ListAssignmentsForHIT operation can return submitted assignments awaiting approval, or it can return assignments that have already been approved or rejected. You can set AssignmentStatus=Approved,Rejected to get assignments that have already been approved and rejected together in one result set. </p> <p> Only the Requester who created the HIT can retrieve the assignments for that HIT. </p> <p> Results are sorted and divided into numbered pages and the operation returns a single page of results. You can use the parameters of the operation to control sorting and pagination. </p>
  ## 
...
proc call*(call_21626314: Call_ListAssignmentsForHIT_21626299; body: JsonNode;
...
var listAssignmentsForHIT* = Call_ListAssignmentsForHIT_21626299(
    ...
    validator: validate_ListAssignmentsForHIT_21626300, base: "/",
    makeUrl: url_ListAssignmentsForHIT_21626301,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListBonusPayments_21626321 = ref object of OpenApiRestCall_21625435
proc url_ListBonusPayments_21626323(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListBonusPayments_21626322(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626335: Call_ListBonusPayments_21626321; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListBonusPayments</code> operation retrieves the amounts of bonuses you have paid to Workers for a given HIT or assignment. 
  ## 
...
proc call*(call_21626336: Call_ListBonusPayments_21626321; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listBonusPayments
  ##  The <code>ListBonusPayments</code> operation retrieves the amounts of bonuses you have paid to Workers for a given HIT or assignment. 
  ##   NextToken: string
...
var listBonusPayments* = Call_ListBonusPayments_21626321(name: "listBonusPayments",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments",
    validator: validate_ListBonusPayments_21626322, base: "/",
    makeUrl: url_ListBonusPayments_21626323, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListHITs_21626339 = ref object of OpenApiRestCall_21625435
proc url_ListHITs_21626341(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListHITs_21626340(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626353: Call_ListHITs_21626339; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListHITs</code> operation returns all of a Requester's HITs. The operation returns HITs of any status, except for HITs that have been deleted of with the DeleteHIT operation or that have been auto-deleted. 
  ## 
...
proc call*(call_21626354: Call_ListHITs_21626339; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listHITs
  ##  The <code>ListHITs</code> operation returns all of a Requester's HITs. The operation returns HITs of any status, except for HITs that have been deleted of with the DeleteHIT operation or that have been auto-deleted. 
  ##   NextToken: string
...
var listHITs* = Call_ListHITs_21626339(name: "listHITs", meth: HttpMethod.HttpPost,
                                    host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITs",
                                    validator: validate_ListHITs_21626340,
                                    base: "/", makeUrl: url_ListHITs_21626341,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListHITsForQualificationType_21626357 = ref object of OpenApiRestCall_21625435
proc url_ListHITsForQualificationType_21626359(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListHITsForQualificationType_21626358(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626371: Call_ListHITsForQualificationType_21626357;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListHITsForQualificationType</code> operation returns the HITs that use the given Qualification type for a Qualification requirement. The operation returns HITs of any status, except for HITs that have been deleted with the <code>DeleteHIT</code> operation or that have been auto-deleted. 
  ## 
...
proc call*(call_21626372: Call_ListHITsForQualificationType_21626357;
...
var listHITsForQualificationType* = Call_ListHITsForQualificationType_21626357(
    ...
    validator: validate_ListHITsForQualificationType_21626358, base: "/",
    makeUrl: url_ListHITsForQualificationType_21626359,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListQualificationRequests_21626375 = ref object of OpenApiRestCall_21625435
proc url_ListQualificationRequests_21626377(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListQualificationRequests_21626376(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626389: Call_ListQualificationRequests_21626375;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListQualificationRequests</code> operation retrieves requests for Qualifications of a particular Qualification type. The owner of the Qualification type calls this operation to poll for pending requests, and accepts them using the AcceptQualification operation. 
  ## 
...
proc call*(call_21626390: Call_ListQualificationRequests_21626375; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listQualificationRequests* = Call_ListQualificationRequests_21626375(
    ...
    validator: validate_ListQualificationRequests_21626376, base: "/",
    makeUrl: url_ListQualificationRequests_21626377,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListQualificationTypes_21626393 = ref object of OpenApiRestCall_21625435
proc url_ListQualificationTypes_21626395(protocol: Scheme; host: string;
...
proc validate_ListQualificationTypes_21626394(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626407: Call_ListQualificationTypes_21626393;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListQualificationTypes</code> operation returns a list of Qualification types, filtered by an optional search term. 
  ## 
...
proc call*(call_21626408: Call_ListQualificationTypes_21626393; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listQualificationTypes* = Call_ListQualificationTypes_21626393(
    ...
    validator: validate_ListQualificationTypes_21626394, base: "/",
    makeUrl: url_ListQualificationTypes_21626395,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListReviewPolicyResultsForHIT_21626411 = ref object of OpenApiRestCall_21625435
proc url_ListReviewPolicyResultsForHIT_21626413(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListReviewPolicyResultsForHIT_21626412(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626418 = header.getOrDefault("X-Amz-Target")
  valid_21626418 = validateParameter(valid_21626418, JString, required = true, default = newJString(
      "MTurkRequesterServiceV20170117.ListReviewPolicyResultsForHIT"))
  if valid_21626418 != nil:
    section.add "X-Amz-Target", valid_21626418
...
proc call*(call_21626425: Call_ListReviewPolicyResultsForHIT_21626411;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListReviewPolicyResultsForHIT</code> operation retrieves the computed results and the actions taken in the course of executing your Review Policies for a given HIT. For information about how to specify Review Policies when you call CreateHIT, see Review Policies. The ListReviewPolicyResultsForHIT operation can return results for both Assignment-level and HIT-level review results. 
  ## 
...
proc call*(call_21626426: Call_ListReviewPolicyResultsForHIT_21626411;
          body: JsonNode; NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_21626427, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626428 = body
  add(query_21626427, "MaxResults", newJString(MaxResults))
  result = call_21626426.call(nil, query_21626427, nil, nil, body_21626428)

var listReviewPolicyResultsForHIT* = Call_ListReviewPolicyResultsForHIT_21626411(
    ...
    validator: validate_ListReviewPolicyResultsForHIT_21626412, base: "/",
    makeUrl: url_ListReviewPolicyResultsForHIT_21626413,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListReviewableHITs_21626429 = ref object of OpenApiRestCall_21625435
proc url_ListReviewableHITs_21626431(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListReviewableHITs_21626430(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626443: Call_ListReviewableHITs_21626429; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListReviewableHITs</code> operation retrieves the HITs with Status equal to Reviewable or Status equal to Reviewing that belong to the Requester calling the operation. 
  ## 
...
proc call*(call_21626444: Call_ListReviewableHITs_21626429; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listReviewableHITs
  ##  The <code>ListReviewableHITs</code> operation retrieves the HITs with Status equal to Reviewable or Status equal to Reviewing that belong to the Requester calling the operation. 
  ##   NextToken: string
...
var listReviewableHITs* = Call_ListReviewableHITs_21626429(
    ...
    validator: validate_ListReviewableHITs_21626430, base: "/",
    makeUrl: url_ListReviewableHITs_21626431, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListWorkerBlocks_21626447 = ref object of OpenApiRestCall_21625435
proc url_ListWorkerBlocks_21626449(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListWorkerBlocks_21626448(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626461: Call_ListWorkerBlocks_21626447; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.
  ## 
...
proc call*(call_21626462: Call_ListWorkerBlocks_21626447; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listWorkerBlocks
  ## The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.
  ##   NextToken: string
...
var listWorkerBlocks* = Call_ListWorkerBlocks_21626447(name: "listWorkerBlocks",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks",
    validator: validate_ListWorkerBlocks_21626448, base: "/",
    makeUrl: url_ListWorkerBlocks_21626449, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListWorkersWithQualificationType_21626465 = ref object of OpenApiRestCall_21625435
proc url_ListWorkersWithQualificationType_21626467(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListWorkersWithQualificationType_21626466(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626479: Call_ListWorkersWithQualificationType_21626465;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>ListWorkersWithQualificationType</code> operation returns all of the Workers that have been associated with a given Qualification type. 
  ## 
...
proc call*(call_21626480: Call_ListWorkersWithQualificationType_21626465;
          body: JsonNode; NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  var body_21626482 = newJObject()
  add(query_21626481, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626482 = body
  add(query_21626481, "MaxResults", newJString(MaxResults))
  result = call_21626480.call(nil, query_21626481, nil, nil, body_21626482)

var listWorkersWithQualificationType* = Call_ListWorkersWithQualificationType_21626465(
    ...
    validator: validate_ListWorkersWithQualificationType_21626466, base: "/",
    makeUrl: url_ListWorkersWithQualificationType_21626467,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_NotifyWorkers_21626483 = ref object of OpenApiRestCall_21625435
proc url_NotifyWorkers_21626485(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NotifyWorkers_21626484(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626488 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626488 != nil:
    section.add "X-Amz-Target", valid_21626488
...
proc call*(call_21626495: Call_NotifyWorkers_21626483; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>NotifyWorkers</code> operation sends an email to one or more Workers that you specify with the Worker ID. You can specify up to 100 Worker IDs to send the same message with a single call to the NotifyWorkers operation. The NotifyWorkers operation will send a notification email to a Worker only if you have previously approved or rejected work from the Worker. 
  ## 
...
proc call*(call_21626496: Call_NotifyWorkers_21626483; body: JsonNode): Recallable =
  ## notifyWorkers
  ##  The <code>NotifyWorkers</code> operation sends an email to one or more Workers that you specify with the Worker ID. You can specify up to 100 Worker IDs to send the same message with a single call to the NotifyWorkers operation. The NotifyWorkers operation will send a notification email to a Worker only if you have previously approved or rejected work from the Worker. 
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626497 = body
  result = call_21626496.call(nil, nil, nil, nil, body_21626497)

var notifyWorkers* = Call_NotifyWorkers_21626483(name: "notifyWorkers",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers",
    validator: validate_NotifyWorkers_21626484, base: "/",
    makeUrl: url_NotifyWorkers_21626485, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectAssignment_21626498 = ref object of OpenApiRestCall_21625435
proc url_RejectAssignment_21626500(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RejectAssignment_21626499(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626510: Call_RejectAssignment_21626498; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>RejectAssignment</code> operation rejects the results of a completed assignment. </p> <p> You can include an optional feedback message with the rejection, which the Worker can see in the Status section of the web site. When you include a feedback message with the rejection, it helps the Worker understand why the assignment was rejected, and can improve the quality of the results the Worker submits in the future. </p> <p> Only the Requester who created the HIT can reject an assignment for the HIT. </p>
  ## 
...
proc call*(call_21626511: Call_RejectAssignment_21626498; body: JsonNode): Recallable =
  ## rejectAssignment
  ## <p> The <code>RejectAssignment</code> operation rejects the results of a completed assignment. </p> <p> You can include an optional feedback message with the rejection, which the Worker can see in the Status section of the web site. When you include a feedback message with the rejection, it helps the Worker understand why the assignment was rejected, and can improve the quality of the results the Worker submits in the future. </p> <p> Only the Requester who created the HIT can reject an assignment for the HIT. </p>
  ##   body: JObject (required)
...
var rejectAssignment* = Call_RejectAssignment_21626498(name: "rejectAssignment",
    meth: HttpMethod.HttpPost, host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment",
    validator: validate_RejectAssignment_21626499, base: "/",
    makeUrl: url_RejectAssignment_21626500, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectQualificationRequest_21626513 = ref object of OpenApiRestCall_21625435
proc url_RejectQualificationRequest_21626515(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RejectQualificationRequest_21626514(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626525: Call_RejectQualificationRequest_21626513;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>RejectQualificationRequest</code> operation rejects a user's request for a Qualification. </p> <p> You can provide a text message explaining why the request was rejected. The Worker who made the request can see this message.</p>
  ## 
...
proc call*(call_21626526: Call_RejectQualificationRequest_21626513; body: JsonNode): Recallable =
...
var rejectQualificationRequest* = Call_RejectQualificationRequest_21626513(
    ...
    validator: validate_RejectQualificationRequest_21626514, base: "/",
    makeUrl: url_RejectQualificationRequest_21626515,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendBonus_21626528 = ref object of OpenApiRestCall_21625435
proc url_SendBonus_21626530(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendBonus_21626529(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626540: Call_SendBonus_21626528; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>SendBonus</code> operation issues a payment of money from your account to a Worker. This payment happens separately from the reward you pay to the Worker when you approve the Worker's assignment. The SendBonus operation requires the Worker's ID and the assignment ID as parameters to initiate payment of the bonus. You must include a message that explains the reason for the bonus payment, as the Worker may not be expecting the payment. Amazon Mechanical Turk collects a fee for bonus payments, similar to the HIT listing fee. This operation fails if your account does not have enough funds to pay for both the bonus and the fees. 
  ## 
...
proc call*(call_21626541: Call_SendBonus_21626528; body: JsonNode): Recallable =
  ## sendBonus
  ##  The <code>SendBonus</code> operation issues a payment of money from your account to a Worker. This payment happens separately from the reward you pay to the Worker when you approve the Worker's assignment. The SendBonus operation requires the Worker's ID and the assignment ID as parameters to initiate payment of the bonus. You must include a message that explains the reason for the bonus payment, as the Worker may not be expecting the payment. Amazon Mechanical Turk collects a fee for bonus payments, similar to the HIT listing fee. This operation fails if your account does not have enough funds to pay for both the bonus and the fees. 
  ##   body: JObject (required)
...
var sendBonus* = Call_SendBonus_21626528(name: "sendBonus",
                                      meth: HttpMethod.HttpPost,
                                      host: "mturk-requester.amazonaws.com", route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus",
                                      validator: validate_SendBonus_21626529,
                                      base: "/", makeUrl: url_SendBonus_21626530,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendTestEventNotification_21626543 = ref object of OpenApiRestCall_21625435
proc url_SendTestEventNotification_21626545(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendTestEventNotification_21626544(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626555: Call_SendTestEventNotification_21626543;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>SendTestEventNotification</code> operation causes Amazon Mechanical Turk to send a notification message as if a HIT event occurred, according to the provided notification specification. This allows you to test notifications without setting up notifications for a real HIT type and trying to trigger them using the website. When you call this operation, the service attempts to send the test notification immediately. 
  ## 
...
proc call*(call_21626556: Call_SendTestEventNotification_21626543; body: JsonNode): Recallable =
...
var sendTestEventNotification* = Call_SendTestEventNotification_21626543(
    ...
    validator: validate_SendTestEventNotification_21626544, base: "/",
    makeUrl: url_SendTestEventNotification_21626545,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateExpirationForHIT_21626558 = ref object of OpenApiRestCall_21625435
proc url_UpdateExpirationForHIT_21626560(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateExpirationForHIT_21626559(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626570: Call_UpdateExpirationForHIT_21626558;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>UpdateExpirationForHIT</code> operation allows you update the expiration time of a HIT. If you update it to a time in the past, the HIT will be immediately expired. 
  ## 
...
proc call*(call_21626571: Call_UpdateExpirationForHIT_21626558; body: JsonNode): Recallable =
...
var updateExpirationForHIT* = Call_UpdateExpirationForHIT_21626558(
    ...
    validator: validate_UpdateExpirationForHIT_21626559, base: "/",
    makeUrl: url_UpdateExpirationForHIT_21626560,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateHITReviewStatus_21626573 = ref object of OpenApiRestCall_21625435
proc url_UpdateHITReviewStatus_21626575(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateHITReviewStatus_21626574(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626585: Call_UpdateHITReviewStatus_21626573;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>UpdateHITReviewStatus</code> operation updates the status of a HIT. If the status is Reviewable, this operation can update the status to Reviewing, or it can revert a Reviewing HIT back to the Reviewable status. 
  ## 
...
proc call*(call_21626586: Call_UpdateHITReviewStatus_21626573; body: JsonNode): Recallable =
...
var updateHITReviewStatus* = Call_UpdateHITReviewStatus_21626573(
    ...
    validator: validate_UpdateHITReviewStatus_21626574, base: "/",
    makeUrl: url_UpdateHITReviewStatus_21626575,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateHITTypeOfHIT_21626588 = ref object of OpenApiRestCall_21625435
proc url_UpdateHITTypeOfHIT_21626590(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateHITTypeOfHIT_21626589(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626600: Call_UpdateHITTypeOfHIT_21626588; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>UpdateHITTypeOfHIT</code> operation allows you to change the HITType properties of a HIT. This operation disassociates the HIT from its old HITType properties and associates it with the new HITType properties. The HIT takes on the properties of the new HITType in place of the old ones. 
  ## 
...
proc call*(call_21626601: Call_UpdateHITTypeOfHIT_21626588; body: JsonNode): Recallable =
  ## updateHITTypeOfHIT
  ##  The <code>UpdateHITTypeOfHIT</code> operation allows you to change the HITType properties of a HIT. This operation disassociates the HIT from its old HITType properties and associates it with the new HITType properties. The HIT takes on the properties of the new HITType in place of the old ones. 
  ##   body: JObject (required)
...
var updateHITTypeOfHIT* = Call_UpdateHITTypeOfHIT_21626588(
    name: "updateHITTypeOfHIT", meth: HttpMethod.HttpPost,
    host: "mturk-requester.amazonaws.com",
    route: "/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT",
    validator: validate_UpdateHITTypeOfHIT_21626589, base: "/",
    makeUrl: url_UpdateHITTypeOfHIT_21626590, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotificationSettings_21626603 = ref object of OpenApiRestCall_21625435
proc url_UpdateNotificationSettings_21626605(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateNotificationSettings_21626604(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626615: Call_UpdateNotificationSettings_21626603;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  The <code>UpdateNotificationSettings</code> operation creates, updates, disables or re-enables notifications for a HIT type. If you call the UpdateNotificationSettings operation for a HIT type that already has a notification specification, the operation replaces the old specification with a new one. You can call the UpdateNotificationSettings operation to enable or disable notifications for the HIT type, without having to modify the notification specification itself by providing updates to the Active status without specifying a new notification specification. To change the Active status of a HIT type's notifications, the HIT type must already have a notification specification, or one must be provided in the same call to <code>UpdateNotificationSettings</code>. 
  ## 
...
proc call*(call_21626616: Call_UpdateNotificationSettings_21626603; body: JsonNode): Recallable =
...
var updateNotificationSettings* = Call_UpdateNotificationSettings_21626603(
    ...
    validator: validate_UpdateNotificationSettings_21626604, base: "/",
    makeUrl: url_UpdateNotificationSettings_21626605,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateQualificationType_21626618 = ref object of OpenApiRestCall_21625435
proc url_UpdateQualificationType_21626620(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateQualificationType_21626619(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626630: Call_UpdateQualificationType_21626618;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> The <code>UpdateQualificationType</code> operation modifies the attributes of an existing Qualification type, which is represented by a QualificationType data structure. Only the owner of a Qualification type can modify its attributes. </p> <p> Most attributes of a Qualification type can be changed after the type has been created. However, the Name and Keywords fields cannot be modified. The RetryDelayInSeconds parameter can be modified or added to change the delay or to enable retries, but RetryDelayInSeconds cannot be used to disable retries. </p> <p> You can use this operation to update the test for a Qualification type. The test is updated based on the values specified for the Test, TestDurationInSeconds and AnswerKey parameters. All three parameters specify the updated test. If you are updating the test for a type, you must specify the Test and TestDurationInSeconds parameters. The AnswerKey parameter is optional; omitting it specifies that the updated test does not have an answer key. </p> <p> If you omit the Test parameter, the test for the Qualification type is unchanged. There is no way to remove a test from a Qualification type that has one. If the type already has a test, you cannot update it to be AutoGranted. If the Qualification type does not have a test and one is provided by an update, the type will henceforth have a test. </p> <p> If you want to update the test duration or answer key for an existing test without changing the questions, you must specify a Test parameter with the original questions, along with the updated values. </p> <p> If you provide an updated Test but no AnswerKey, the new test will not have an answer key. Requests for such Qualifications must be granted manually. </p> <p> You can also update the AutoGranted and AutoGrantedValue attributes of the Qualification type.</p>
  ## 
...
proc call*(call_21626631: Call_UpdateQualificationType_21626618; body: JsonNode): Recallable =
...
var updateQualificationType* = Call_UpdateQualificationType_21626618(
    ...
    validator: validate_UpdateQualificationType_21626619, base: "/",
    makeUrl: url_UpdateQualificationType_21626620,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
