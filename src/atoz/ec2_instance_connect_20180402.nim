...
type
  Call_SendSSHPublicKey_602794 = ref object of OpenApiRestCall_602457
proc url_SendSSHPublicKey_602796(protocol: Scheme; host: string; base: string;
...
proc validate_SendSSHPublicKey_602795(path: JsonNode; query: JsonNode;
...
proc call*(call_602952: Call_SendSSHPublicKey_602794; path: JsonNode;
...
proc call*(call_603023: Call_SendSSHPublicKey_602794; body: JsonNode): Recallable =
  ## sendSSHPublicKey
  ## Pushes an SSH public key to a particular OS user on a given EC2 instance for 60 seconds.
  ##   body: JObject (required)
...
var sendSSHPublicKey* = Call_SendSSHPublicKey_602794(name: "sendSSHPublicKey",
    ...
    validator: validate_SendSSHPublicKey_602795, base: "/",
    url: url_SendSSHPublicKey_602796, schemes: {Scheme.Https, Scheme.Http})
export
  rest
