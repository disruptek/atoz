...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_SendSSHPublicKey_21625770 = ref object of OpenApiRestCall_21625426
proc url_SendSSHPublicKey_21625772(protocol: Scheme; host: string; base: string;
...
proc validate_SendSSHPublicKey_21625771(path: JsonNode; query: JsonNode;
...
proc call*(call_21625920: Call_SendSSHPublicKey_21625770; path: JsonNode = nil;
...
proc call*(call_21625983: Call_SendSSHPublicKey_21625770; body: JsonNode): Recallable =
  ## sendSSHPublicKey
  ## Pushes an SSH public key to a particular OS user on a given EC2 instance for 60 seconds.
  ##   body: JObject (required)
...
var sendSSHPublicKey* = Call_SendSSHPublicKey_21625770(name: "sendSSHPublicKey",
    ...
    validator: validate_SendSSHPublicKey_21625771, base: "/",
    makeUrl: url_SendSSHPublicKey_21625772, schemes: {Scheme.Https, Scheme.Http})
export
  rest
