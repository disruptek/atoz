...
type
  Call_SendSSHPublicKey_600761 = ref object of OpenApiRestCall_600424
proc url_SendSSHPublicKey_600763(protocol: Scheme; host: string; base: string;
...
proc validate_SendSSHPublicKey_600762(path: JsonNode; query: JsonNode;
...
proc call*(call_600919: Call_SendSSHPublicKey_600761; path: JsonNode;
...
proc call*(call_600990: Call_SendSSHPublicKey_600761; body: JsonNode): Recallable =
  ## sendSSHPublicKey
  ## Pushes an SSH public key to a particular OS user on a given EC2 instance for 60 seconds.
  ##   body: JObject (required)
...
var sendSSHPublicKey* = Call_SendSSHPublicKey_600761(name: "sendSSHPublicKey",
    ...
    validator: validate_SendSSHPublicKey_600762, base: "/",
    url: url_SendSSHPublicKey_600763, schemes: {Scheme.Https, Scheme.Http})
export
  rest
