...
type
  Call_SendSSHPublicKey_592694 = ref object of OpenApiRestCall_592355
proc url_SendSSHPublicKey_592696(protocol: Scheme; host: string; base: string;
...
proc validate_SendSSHPublicKey_592695(path: JsonNode; query: JsonNode;
...
proc call*(call_592852: Call_SendSSHPublicKey_592694; path: JsonNode;
...
proc call*(call_592923: Call_SendSSHPublicKey_592694; body: JsonNode): Recallable =
  ## sendSSHPublicKey
  ## Pushes an SSH public key to a particular OS user on a given EC2 instance for 60 seconds.
  ##   body: JObject (required)
...
var sendSSHPublicKey* = Call_SendSSHPublicKey_592694(name: "sendSSHPublicKey",
    ...
    validator: validate_SendSSHPublicKey_592695, base: "/",
    url: url_SendSSHPublicKey_592696, schemes: {Scheme.Https, Scheme.Http})
export
  rest
