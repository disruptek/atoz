...
type
  Call_SendSSHPublicKey_610987 = ref object of OpenApiRestCall_610649
proc url_SendSSHPublicKey_610989(protocol: Scheme; host: string; base: string;
...
proc validate_SendSSHPublicKey_610988(path: JsonNode; query: JsonNode;
...
proc call*(call_611145: Call_SendSSHPublicKey_610987; path: JsonNode;
...
proc call*(call_611216: Call_SendSSHPublicKey_610987; body: JsonNode): Recallable =
  ## sendSSHPublicKey
  ## Pushes an SSH public key to a particular OS user on a given EC2 instance for 60 seconds.
  ##   body: JObject (required)
...
var sendSSHPublicKey* = Call_SendSSHPublicKey_610987(name: "sendSSHPublicKey",
    ...
    validator: validate_SendSSHPublicKey_610988, base: "/",
    url: url_SendSSHPublicKey_610989, schemes: {Scheme.Https, Scheme.Http})
export
  rest
