...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_BatchDeleteDocument_21625779 = ref object of OpenApiRestCall_21625435
proc url_BatchDeleteDocument_21625781(protocol: Scheme; host: string; base: string;
...
proc validate_BatchDeleteDocument_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_BatchDeleteDocument_21625779; path: JsonNode = nil;
...
proc call*(call_21625992: Call_BatchDeleteDocument_21625779; body: JsonNode): Recallable =
  ## batchDeleteDocument
  ## <p>Removes one or more documents from an index. The documents must have been added with the <a>BatchPutDocument</a> operation.</p> <p>The documents are deleted asynchronously. You can see the progress of the deletion by using AWS CloudWatch. Any error messages releated to the processing of the batch are sent to you CloudWatch log.</p>
  ##   body: JObject (required)
...
var batchDeleteDocument* = Call_BatchDeleteDocument_21625779(
    ...
    validator: validate_BatchDeleteDocument_21625780, base: "/",
    makeUrl: url_BatchDeleteDocument_21625781,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchPutDocument_21626029 = ref object of OpenApiRestCall_21625435
proc url_BatchPutDocument_21626031(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchPutDocument_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_BatchPutDocument_21626029; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Adds one or more documents to an index.</p> <p>The <code>BatchPutDocument</code> operation enables you to ingest inline documents or a set of documents stored in an Amazon S3 bucket. Use this operation to ingest your text and unstructured text into an index, add custom attributes to the documents, and to attach an access control list to the documents added to the index.</p> <p>The documents are indexed asynchronously. You can see the progress of the batch using AWS CloudWatch. Any error messages related to processing the batch are sent to your AWS CloudWatch log.</p>
  ## 
...
proc call*(call_21626042: Call_BatchPutDocument_21626029; body: JsonNode): Recallable =
  ## batchPutDocument
  ## <p>Adds one or more documents to an index.</p> <p>The <code>BatchPutDocument</code> operation enables you to ingest inline documents or a set of documents stored in an Amazon S3 bucket. Use this operation to ingest your text and unstructured text into an index, add custom attributes to the documents, and to attach an access control list to the documents added to the index.</p> <p>The documents are indexed asynchronously. You can see the progress of the batch using AWS CloudWatch. Any error messages related to processing the batch are sent to your AWS CloudWatch log.</p>
  ##   body: JObject (required)
...
var batchPutDocument* = Call_BatchPutDocument_21626029(name: "batchPutDocument",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.BatchPutDocument",
    validator: validate_BatchPutDocument_21626030, base: "/",
    makeUrl: url_BatchPutDocument_21626031, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDataSource_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateDataSource_21626046(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDataSource_21626045(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626056: Call_CreateDataSource_21626044; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a data source that you use to with an Amazon Kendra index. </p> <p>You specify a name, connector type and description for your data source. You can choose between an S3 connector, a SharePoint Online connector, and a database connector.</p> <p>You also specify configuration information such as document metadata (author, source URI, and so on) and user context information.</p> <p> <code>CreateDataSource</code> is a synchronous operation. The operation returns 200 if the data source was successfully created. Otherwise, an exception is raised.</p>
  ## 
...
proc call*(call_21626057: Call_CreateDataSource_21626044; body: JsonNode): Recallable =
  ## createDataSource
  ## <p>Creates a data source that you use to with an Amazon Kendra index. </p> <p>You specify a name, connector type and description for your data source. You can choose between an S3 connector, a SharePoint Online connector, and a database connector.</p> <p>You also specify configuration information such as document metadata (author, source URI, and so on) and user context information.</p> <p> <code>CreateDataSource</code> is a synchronous operation. The operation returns 200 if the data source was successfully created. Otherwise, an exception is raised.</p>
  ##   body: JObject (required)
...
var createDataSource* = Call_CreateDataSource_21626044(name: "createDataSource",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.CreateDataSource",
    validator: validate_CreateDataSource_21626045, base: "/",
    makeUrl: url_CreateDataSource_21626046, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateFaq_21626059 = ref object of OpenApiRestCall_21625435
proc url_CreateFaq_21626061(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateFaq_21626060(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21626071: Call_CreateFaq_21626059; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates an new set of frequently asked question (FAQ) questions and answers.
  ## 
...
proc call*(call_21626072: Call_CreateFaq_21626059; body: JsonNode): Recallable =
  ## createFaq
  ## Creates an new set of frequently asked question (FAQ) questions and answers.
  ##   body: JObject (required)
...
var createFaq* = Call_CreateFaq_21626059(name: "createFaq",
                                      meth: HttpMethod.HttpPost,
                                      host: "kendra.amazonaws.com", route: "/#X-Amz-Target=AWSKendraFrontendService.CreateFaq",
                                      validator: validate_CreateFaq_21626060,
                                      base: "/", makeUrl: url_CreateFaq_21626061,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateIndex_21626074 = ref object of OpenApiRestCall_21625435
proc url_CreateIndex_21626076(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateIndex_21626075(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_CreateIndex_21626074; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates a new Amazon Kendra index. Index creation is an asynchronous operation. To determine if index creation has completed, check the <code>Status</code> field returned from a call to . The <code>Status</code> field is set to <code>ACTIVE</code> when the index is ready to use.</p> <p>Once the index is active you can index your documents using the operation or using one of the supported data sources. </p>
  ## 
...
proc call*(call_21626087: Call_CreateIndex_21626074; body: JsonNode): Recallable =
  ## createIndex
  ## <p>Creates a new Amazon Kendra index. Index creation is an asynchronous operation. To determine if index creation has completed, check the <code>Status</code> field returned from a call to . The <code>Status</code> field is set to <code>ACTIVE</code> when the index is ready to use.</p> <p>Once the index is active you can index your documents using the operation or using one of the supported data sources. </p>
  ##   body: JObject (required)
...
var createIndex* = Call_CreateIndex_21626074(name: "createIndex",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.CreateIndex",
    validator: validate_CreateIndex_21626075, base: "/", makeUrl: url_CreateIndex_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteFaq_21626089 = ref object of OpenApiRestCall_21625435
proc url_DeleteFaq_21626091(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteFaq_21626090(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_DeleteFaq_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes an FAQ from an index.
  ## 
...
proc call*(call_21626102: Call_DeleteFaq_21626089; body: JsonNode): Recallable =
  ## deleteFaq
  ## Removes an FAQ from an index.
  ##   body: JObject (required)
...
var deleteFaq* = Call_DeleteFaq_21626089(name: "deleteFaq",
                                      meth: HttpMethod.HttpPost,
                                      host: "kendra.amazonaws.com", route: "/#X-Amz-Target=AWSKendraFrontendService.DeleteFaq",
                                      validator: validate_DeleteFaq_21626090,
                                      base: "/", makeUrl: url_DeleteFaq_21626091,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIndex_21626104 = ref object of OpenApiRestCall_21625435
proc url_DeleteIndex_21626106(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteIndex_21626105(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_DeleteIndex_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes an existing Amazon Kendra index. An exception is not thrown if the index is already being deleted. While the index is being deleted, the <code>Status</code> field returned by a call to the <a>DescribeIndex</a> operation is set to <code>DELETING</code>.
  ## 
...
proc call*(call_21626117: Call_DeleteIndex_21626104; body: JsonNode): Recallable =
  ## deleteIndex
  ## Deletes an existing Amazon Kendra index. An exception is not thrown if the index is already being deleted. While the index is being deleted, the <code>Status</code> field returned by a call to the <a>DescribeIndex</a> operation is set to <code>DELETING</code>.
  ##   body: JObject (required)
...
var deleteIndex* = Call_DeleteIndex_21626104(name: "deleteIndex",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.DeleteIndex",
    validator: validate_DeleteIndex_21626105, base: "/", makeUrl: url_DeleteIndex_21626106,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDataSource_21626119 = ref object of OpenApiRestCall_21625435
proc url_DescribeDataSource_21626121(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDataSource_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_DescribeDataSource_21626119; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about a Amazon Kendra data source.
  ## 
...
proc call*(call_21626132: Call_DescribeDataSource_21626119; body: JsonNode): Recallable =
  ## describeDataSource
  ## Gets information about a Amazon Kendra data source.
  ##   body: JObject (required)
...
var describeDataSource* = Call_DescribeDataSource_21626119(
    name: "describeDataSource", meth: HttpMethod.HttpPost,
    host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.DescribeDataSource",
    validator: validate_DescribeDataSource_21626120, base: "/",
    makeUrl: url_DescribeDataSource_21626121, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeFaq_21626134 = ref object of OpenApiRestCall_21625435
proc url_DescribeFaq_21626136(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeFaq_21626135(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_DescribeFaq_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about an FAQ list.
  ## 
...
proc call*(call_21626147: Call_DescribeFaq_21626134; body: JsonNode): Recallable =
  ## describeFaq
  ## Gets information about an FAQ list.
  ##   body: JObject (required)
...
var describeFaq* = Call_DescribeFaq_21626134(name: "describeFaq",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.DescribeFaq",
    validator: validate_DescribeFaq_21626135, base: "/", makeUrl: url_DescribeFaq_21626136,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIndex_21626149 = ref object of OpenApiRestCall_21625435
proc url_DescribeIndex_21626151(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeIndex_21626150(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626161: Call_DescribeIndex_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes an existing Amazon Kendra index
  ## 
...
proc call*(call_21626162: Call_DescribeIndex_21626149; body: JsonNode): Recallable =
  ## describeIndex
  ## Describes an existing Amazon Kendra index
  ##   body: JObject (required)
...
var describeIndex* = Call_DescribeIndex_21626149(name: "describeIndex",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.DescribeIndex",
    validator: validate_DescribeIndex_21626150, base: "/",
    makeUrl: url_DescribeIndex_21626151, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDataSourceSyncJobs_21626164 = ref object of OpenApiRestCall_21625435
proc url_ListDataSourceSyncJobs_21626166(protocol: Scheme; host: string;
...
proc validate_ListDataSourceSyncJobs_21626165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626178: Call_ListDataSourceSyncJobs_21626164;
...
proc call*(call_21626179: Call_ListDataSourceSyncJobs_21626164; body: JsonNode;
  ...
  var body_21626182 = newJObject()
  add(query_21626181, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626182 = body
  add(query_21626181, "MaxResults", newJString(MaxResults))
  result = call_21626179.call(nil, query_21626181, nil, nil, body_21626182)

var listDataSourceSyncJobs* = Call_ListDataSourceSyncJobs_21626164(
    name: "listDataSourceSyncJobs", meth: HttpMethod.HttpPost,
    host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.ListDataSourceSyncJobs",
    validator: validate_ListDataSourceSyncJobs_21626165, base: "/",
    makeUrl: url_ListDataSourceSyncJobs_21626166,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDataSources_21626186 = ref object of OpenApiRestCall_21625435
proc url_ListDataSources_21626188(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDataSources_21626187(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_21626189 = query.getOrDefault("NextToken")
  valid_21626189 = validateParameter(valid_21626189, JString, required = false,
                                   default = nil)
  if valid_21626189 != nil:
    section.add "NextToken", valid_21626189
  var valid_21626190 = query.getOrDefault("MaxResults")
  valid_21626190 = validateParameter(valid_21626190, JString, required = false,
                                   default = nil)
  if valid_21626190 != nil:
    section.add "MaxResults", valid_21626190
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626200: Call_ListDataSources_21626186; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the data sources that you have created.
  ## 
...
proc call*(call_21626201: Call_ListDataSources_21626186; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listDataSources
  ## Lists the data sources that you have created.
  ##   NextToken: string
...
var listDataSources* = Call_ListDataSources_21626186(name: "listDataSources",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.ListDataSources",
    validator: validate_ListDataSources_21626187, base: "/",
    makeUrl: url_ListDataSources_21626188, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListFaqs_21626204 = ref object of OpenApiRestCall_21625435
proc url_ListFaqs_21626206(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListFaqs_21626205(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626216: Call_ListFaqs_21626204; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets a list of FAQ lists associated with an index.
  ## 
...
proc call*(call_21626217: Call_ListFaqs_21626204; body: JsonNode): Recallable =
  ## listFaqs
  ## Gets a list of FAQ lists associated with an index.
  ##   body: JObject (required)
...
var listFaqs* = Call_ListFaqs_21626204(name: "listFaqs", meth: HttpMethod.HttpPost,
                                    host: "kendra.amazonaws.com", route: "/#X-Amz-Target=AWSKendraFrontendService.ListFaqs",
                                    validator: validate_ListFaqs_21626205,
                                    base: "/", makeUrl: url_ListFaqs_21626206,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIndices_21626219 = ref object of OpenApiRestCall_21625435
proc url_ListIndices_21626221(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListIndices_21626220(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626233: Call_ListIndices_21626219; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the Amazon Kendra indexes that you have created.
  ## 
...
proc call*(call_21626234: Call_ListIndices_21626219; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listIndices
  ## Lists the Amazon Kendra indexes that you have created.
  ##   NextToken: string
  ...
  add(query_21626235, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626236 = body
  add(query_21626235, "MaxResults", newJString(MaxResults))
  result = call_21626234.call(nil, query_21626235, nil, nil, body_21626236)

var listIndices* = Call_ListIndices_21626219(name: "listIndices",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.ListIndices",
    validator: validate_ListIndices_21626220, base: "/", makeUrl: url_ListIndices_21626221,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_Query_21626237 = ref object of OpenApiRestCall_21625435
proc url_Query_21626239(protocol: Scheme; host: string; base: string; route: string;
                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_Query_21626238(path: JsonNode; query: JsonNode; header: JsonNode;
                            formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626249: Call_Query_21626237; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Searches an active index. Use this API to search your documents using query. The <code>Query</code> operation enables to do faceted search and to filter results based on document attributes.</p> <p>It also enables you to provide user context that Amazon Kendra uses to enforce document access control in the search results. </p> <p>Amazon Kendra searches your index for text content and question and answer (FAQ) content. By default the response contains three types of results.</p> <ul> <li> <p>Relevant passages</p> </li> <li> <p>Matching FAQs</p> </li> <li> <p>Relevant documents</p> </li> </ul> <p>You can specify that the query return only one type of result using the <code>QueryResultTypeConfig</code> parameter.</p>
  ## 
...
proc call*(call_21626250: Call_Query_21626237; body: JsonNode): Recallable =
  ## query
  ## <p>Searches an active index. Use this API to search your documents using query. The <code>Query</code> operation enables to do faceted search and to filter results based on document attributes.</p> <p>It also enables you to provide user context that Amazon Kendra uses to enforce document access control in the search results. </p> <p>Amazon Kendra searches your index for text content and question and answer (FAQ) content. By default the response contains three types of results.</p> <ul> <li> <p>Relevant passages</p> </li> <li> <p>Matching FAQs</p> </li> <li> <p>Relevant documents</p> </li> </ul> <p>You can specify that the query return only one type of result using the <code>QueryResultTypeConfig</code> parameter.</p>
  ##   body: JObject (required)
...
var query* = Call_Query_21626237(name: "query", meth: HttpMethod.HttpPost,
                              host: "kendra.amazonaws.com", route: "/#X-Amz-Target=AWSKendraFrontendService.Query",
                              validator: validate_Query_21626238, base: "/",
                              makeUrl: url_Query_21626239,
                              schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartDataSourceSyncJob_21626252 = ref object of OpenApiRestCall_21625435
proc url_StartDataSourceSyncJob_21626254(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StartDataSourceSyncJob_21626253(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626264: Call_StartDataSourceSyncJob_21626252;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Starts a synchronization job for a data source. If a synchronization job is already in progress, Amazon Kendra returns a <code>ResourceInUseException</code> exception.
  ## 
...
proc call*(call_21626265: Call_StartDataSourceSyncJob_21626252; body: JsonNode): Recallable =
...
var startDataSourceSyncJob* = Call_StartDataSourceSyncJob_21626252(
    name: "startDataSourceSyncJob", meth: HttpMethod.HttpPost,
    host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.StartDataSourceSyncJob",
    validator: validate_StartDataSourceSyncJob_21626253, base: "/",
    makeUrl: url_StartDataSourceSyncJob_21626254,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopDataSourceSyncJob_21626267 = ref object of OpenApiRestCall_21625435
proc url_StopDataSourceSyncJob_21626269(protocol: Scheme; host: string; base: string;
...
proc validate_StopDataSourceSyncJob_21626268(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626279: Call_StopDataSourceSyncJob_21626267;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Stops a running synchronization job. You can't stop a scheduled synchronization job.
  ## 
...
proc call*(call_21626280: Call_StopDataSourceSyncJob_21626267; body: JsonNode): Recallable =
...
var stopDataSourceSyncJob* = Call_StopDataSourceSyncJob_21626267(
    name: "stopDataSourceSyncJob", meth: HttpMethod.HttpPost,
    host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.StopDataSourceSyncJob",
    validator: validate_StopDataSourceSyncJob_21626268, base: "/",
    makeUrl: url_StopDataSourceSyncJob_21626269,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SubmitFeedback_21626282 = ref object of OpenApiRestCall_21625435
proc url_SubmitFeedback_21626284(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubmitFeedback_21626283(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626294: Call_SubmitFeedback_21626282; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Enables you to provide feedback to Amazon Kendra to improve the performance of the service. 
  ## 
...
proc call*(call_21626295: Call_SubmitFeedback_21626282; body: JsonNode): Recallable =
  ## submitFeedback
  ## Enables you to provide feedback to Amazon Kendra to improve the performance of the service. 
  ##   body: JObject (required)
...
var submitFeedback* = Call_SubmitFeedback_21626282(name: "submitFeedback",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.SubmitFeedback",
    validator: validate_SubmitFeedback_21626283, base: "/",
    makeUrl: url_SubmitFeedback_21626284, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDataSource_21626297 = ref object of OpenApiRestCall_21625435
proc url_UpdateDataSource_21626299(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDataSource_21626298(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626309: Call_UpdateDataSource_21626297; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates an existing Amazon Kendra data source.
  ## 
...
proc call*(call_21626310: Call_UpdateDataSource_21626297; body: JsonNode): Recallable =
  ## updateDataSource
  ## Updates an existing Amazon Kendra data source.
  ##   body: JObject (required)
...
var updateDataSource* = Call_UpdateDataSource_21626297(name: "updateDataSource",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.UpdateDataSource",
    validator: validate_UpdateDataSource_21626298, base: "/",
    makeUrl: url_UpdateDataSource_21626299, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateIndex_21626312 = ref object of OpenApiRestCall_21625435
proc url_UpdateIndex_21626314(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateIndex_21626313(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626324: Call_UpdateIndex_21626312; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates an existing Amazon Kendra index.
  ## 
...
proc call*(call_21626325: Call_UpdateIndex_21626312; body: JsonNode): Recallable =
  ## updateIndex
  ## Updates an existing Amazon Kendra index.
  ##   body: JObject (required)
...
var updateIndex* = Call_UpdateIndex_21626312(name: "updateIndex",
    meth: HttpMethod.HttpPost, host: "kendra.amazonaws.com",
    route: "/#X-Amz-Target=AWSKendraFrontendService.UpdateIndex",
    validator: validate_UpdateIndex_21626313, base: "/", makeUrl: url_UpdateIndex_21626314,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
