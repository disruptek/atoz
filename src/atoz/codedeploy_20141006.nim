...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_AddTagsToOnPremisesInstances_21625779 = ref object of OpenApiRestCall_21625435
proc url_AddTagsToOnPremisesInstances_21625781(protocol: Scheme; host: string;
...
proc validate_AddTagsToOnPremisesInstances_21625780(path: JsonNode;
...
proc call*(call_21625929: Call_AddTagsToOnPremisesInstances_21625779;
...
proc call*(call_21625992: Call_AddTagsToOnPremisesInstances_21625779;
...
var addTagsToOnPremisesInstances* = Call_AddTagsToOnPremisesInstances_21625779(
    ...
    validator: validate_AddTagsToOnPremisesInstances_21625780, base: "/",
    makeUrl: url_AddTagsToOnPremisesInstances_21625781,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetApplicationRevisions_21626029 = ref object of OpenApiRestCall_21625435
proc url_BatchGetApplicationRevisions_21626031(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetApplicationRevisions_21626030(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626041: Call_BatchGetApplicationRevisions_21626029;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about one or more application revisions. The maximum number of application revisions that can be returned is 25.
  ## 
...
proc call*(call_21626042: Call_BatchGetApplicationRevisions_21626029;
          body: JsonNode): Recallable =
...
var batchGetApplicationRevisions* = Call_BatchGetApplicationRevisions_21626029(
    ...
    validator: validate_BatchGetApplicationRevisions_21626030, base: "/",
    makeUrl: url_BatchGetApplicationRevisions_21626031,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetApplications_21626044 = ref object of OpenApiRestCall_21625435
proc url_BatchGetApplications_21626046(protocol: Scheme; host: string; base: string;
...
proc validate_BatchGetApplications_21626045(path: JsonNode; query: JsonNode;
...
proc call*(call_21626056: Call_BatchGetApplications_21626044; path: JsonNode = nil;
...
proc call*(call_21626057: Call_BatchGetApplications_21626044; body: JsonNode): Recallable =
...
var batchGetApplications* = Call_BatchGetApplications_21626044(
    name: "batchGetApplications", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplications",
    validator: validate_BatchGetApplications_21626045, base: "/",
    makeUrl: url_BatchGetApplications_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetDeploymentGroups_21626059 = ref object of OpenApiRestCall_21625435
proc url_BatchGetDeploymentGroups_21626061(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetDeploymentGroups_21626060(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626071: Call_BatchGetDeploymentGroups_21626059;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about one or more deployment groups.
  ## 
...
proc call*(call_21626072: Call_BatchGetDeploymentGroups_21626059; body: JsonNode): Recallable =
...
var batchGetDeploymentGroups* = Call_BatchGetDeploymentGroups_21626059(
    name: "batchGetDeploymentGroups", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentGroups",
    validator: validate_BatchGetDeploymentGroups_21626060, base: "/",
    makeUrl: url_BatchGetDeploymentGroups_21626061,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetDeploymentInstances_21626074 = ref object of OpenApiRestCall_21625435
proc url_BatchGetDeploymentInstances_21626076(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetDeploymentInstances_21626075(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_BatchGetDeploymentInstances_21626074;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <note> <p> This method works, but is deprecated. Use <code>BatchGetDeploymentTargets</code> instead. </p> </note> <p> Returns an array of one or more instances associated with a deployment. This method works with EC2/On-premises and AWS Lambda compute platforms. The newer <code>BatchGetDeploymentTargets</code> works with all compute platforms. The maximum number of instances that can be returned is 25.</p>
  ## 
...
proc call*(call_21626087: Call_BatchGetDeploymentInstances_21626074; body: JsonNode): Recallable =
...
var batchGetDeploymentInstances* = Call_BatchGetDeploymentInstances_21626074(
    ...
    validator: validate_BatchGetDeploymentInstances_21626075, base: "/",
    makeUrl: url_BatchGetDeploymentInstances_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetDeploymentTargets_21626089 = ref object of OpenApiRestCall_21625435
proc url_BatchGetDeploymentTargets_21626091(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetDeploymentTargets_21626090(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_BatchGetDeploymentTargets_21626089;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> Returns an array of one or more targets associated with a deployment. This method works with all compute types and should be used instead of the deprecated <code>BatchGetDeploymentInstances</code>. The maximum number of targets that can be returned is 25.</p> <p> The type of targets returned depends on the deployment's compute platform: </p> <ul> <li> <p> <b>EC2/On-premises</b>: Information about EC2 instance targets. </p> </li> <li> <p> <b>AWS Lambda</b>: Information about Lambda functions targets. </p> </li> <li> <p> <b>Amazon ECS</b>: Information about Amazon ECS service targets. </p> </li> </ul>
  ## 
...
proc call*(call_21626102: Call_BatchGetDeploymentTargets_21626089; body: JsonNode): Recallable =
...
var batchGetDeploymentTargets* = Call_BatchGetDeploymentTargets_21626089(
    name: "batchGetDeploymentTargets", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentTargets",
    validator: validate_BatchGetDeploymentTargets_21626090, base: "/",
    makeUrl: url_BatchGetDeploymentTargets_21626091,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetDeployments_21626104 = ref object of OpenApiRestCall_21625435
proc url_BatchGetDeployments_21626106(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetDeployments_21626105(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_BatchGetDeployments_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about one or more deployments. The maximum number of deployments that can be returned is 25.
  ## 
...
proc call*(call_21626117: Call_BatchGetDeployments_21626104; body: JsonNode): Recallable =
  ## batchGetDeployments
  ## Gets information about one or more deployments. The maximum number of deployments that can be returned is 25.
  ##   body: JObject (required)
...
var batchGetDeployments* = Call_BatchGetDeployments_21626104(
    name: "batchGetDeployments", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeployments",
    validator: validate_BatchGetDeployments_21626105, base: "/",
    makeUrl: url_BatchGetDeployments_21626106,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetOnPremisesInstances_21626119 = ref object of OpenApiRestCall_21625435
proc url_BatchGetOnPremisesInstances_21626121(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BatchGetOnPremisesInstances_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_BatchGetOnPremisesInstances_21626119;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about one or more on-premises instances. The maximum number of on-premises instances that can be returned is 25.
  ## 
...
proc call*(call_21626132: Call_BatchGetOnPremisesInstances_21626119; body: JsonNode): Recallable =
...
var batchGetOnPremisesInstances* = Call_BatchGetOnPremisesInstances_21626119(
    ...
    validator: validate_BatchGetOnPremisesInstances_21626120, base: "/",
    makeUrl: url_BatchGetOnPremisesInstances_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ContinueDeployment_21626134 = ref object of OpenApiRestCall_21625435
proc url_ContinueDeployment_21626136(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContinueDeployment_21626135(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_ContinueDeployment_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## For a blue/green deployment, starts the process of rerouting traffic from instances in the original environment to instances in the replacement environment without waiting for a specified wait time to elapse. (Traffic rerouting, which is achieved by registering instances in the replacement environment with the load balancer, can start as soon as all instances have a status of Ready.) 
  ## 
...
proc call*(call_21626147: Call_ContinueDeployment_21626134; body: JsonNode): Recallable =
  ## continueDeployment
  ## For a blue/green deployment, starts the process of rerouting traffic from instances in the original environment to instances in the replacement environment without waiting for a specified wait time to elapse. (Traffic rerouting, which is achieved by registering instances in the replacement environment with the load balancer, can start as soon as all instances have a status of Ready.) 
  ##   body: JObject (required)
...
var continueDeployment* = Call_ContinueDeployment_21626134(
    name: "continueDeployment", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ContinueDeployment",
    validator: validate_ContinueDeployment_21626135, base: "/",
    makeUrl: url_ContinueDeployment_21626136, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateApplication_21626149 = ref object of OpenApiRestCall_21625435
proc url_CreateApplication_21626151(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateApplication_21626150(path: JsonNode; query: JsonNode;
...
proc call*(call_21626161: Call_CreateApplication_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates an application.
  ## 
...
proc call*(call_21626162: Call_CreateApplication_21626149; body: JsonNode): Recallable =
  ## createApplication
  ## Creates an application.
  ##   body: JObject (required)
...
var createApplication* = Call_CreateApplication_21626149(name: "createApplication",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.CreateApplication",
    validator: validate_CreateApplication_21626150, base: "/",
    makeUrl: url_CreateApplication_21626151, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDeployment_21626164 = ref object of OpenApiRestCall_21625435
proc url_CreateDeployment_21626166(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDeployment_21626165(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_CreateDeployment_21626164; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deploys an application revision through the specified deployment group.
  ## 
...
proc call*(call_21626177: Call_CreateDeployment_21626164; body: JsonNode): Recallable =
  ## createDeployment
  ## Deploys an application revision through the specified deployment group.
  ##   body: JObject (required)
...
var createDeployment* = Call_CreateDeployment_21626164(name: "createDeployment",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.CreateDeployment",
    validator: validate_CreateDeployment_21626165, base: "/",
    makeUrl: url_CreateDeployment_21626166, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDeploymentConfig_21626179 = ref object of OpenApiRestCall_21625435
proc url_CreateDeploymentConfig_21626181(protocol: Scheme; host: string;
...
proc validate_CreateDeploymentConfig_21626180(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626191: Call_CreateDeploymentConfig_21626179;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Creates a deployment configuration. 
  ## 
...
proc call*(call_21626192: Call_CreateDeploymentConfig_21626179; body: JsonNode): Recallable =
...
var createDeploymentConfig* = Call_CreateDeploymentConfig_21626179(
    name: "createDeploymentConfig", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentConfig",
    validator: validate_CreateDeploymentConfig_21626180, base: "/",
    makeUrl: url_CreateDeploymentConfig_21626181,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDeploymentGroup_21626194 = ref object of OpenApiRestCall_21625435
proc url_CreateDeploymentGroup_21626196(protocol: Scheme; host: string; base: string;
...
proc validate_CreateDeploymentGroup_21626195(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626206: Call_CreateDeploymentGroup_21626194;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a deployment group to which application revisions are deployed.
  ## 
...
proc call*(call_21626207: Call_CreateDeploymentGroup_21626194; body: JsonNode): Recallable =
...
var createDeploymentGroup* = Call_CreateDeploymentGroup_21626194(
    name: "createDeploymentGroup", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentGroup",
    validator: validate_CreateDeploymentGroup_21626195, base: "/",
    makeUrl: url_CreateDeploymentGroup_21626196,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplication_21626209 = ref object of OpenApiRestCall_21625435
proc url_DeleteApplication_21626211(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteApplication_21626210(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626221: Call_DeleteApplication_21626209; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes an application.
  ## 
...
proc call*(call_21626222: Call_DeleteApplication_21626209; body: JsonNode): Recallable =
  ## deleteApplication
  ## Deletes an application.
  ##   body: JObject (required)
...
var deleteApplication* = Call_DeleteApplication_21626209(name: "deleteApplication",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.DeleteApplication",
    validator: validate_DeleteApplication_21626210, base: "/",
    makeUrl: url_DeleteApplication_21626211, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDeploymentConfig_21626224 = ref object of OpenApiRestCall_21625435
proc url_DeleteDeploymentConfig_21626226(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteDeploymentConfig_21626225(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626236: Call_DeleteDeploymentConfig_21626224;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes a deployment configuration.</p> <note> <p>A deployment configuration cannot be deleted if it is currently in use. Predefined configurations cannot be deleted.</p> </note>
  ## 
...
proc call*(call_21626237: Call_DeleteDeploymentConfig_21626224; body: JsonNode): Recallable =
...
var deleteDeploymentConfig* = Call_DeleteDeploymentConfig_21626224(
    name: "deleteDeploymentConfig", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentConfig",
    validator: validate_DeleteDeploymentConfig_21626225, base: "/",
    makeUrl: url_DeleteDeploymentConfig_21626226,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDeploymentGroup_21626239 = ref object of OpenApiRestCall_21625435
proc url_DeleteDeploymentGroup_21626241(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteDeploymentGroup_21626240(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626251: Call_DeleteDeploymentGroup_21626239;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a deployment group.
  ## 
...
proc call*(call_21626252: Call_DeleteDeploymentGroup_21626239; body: JsonNode): Recallable =
...
var deleteDeploymentGroup* = Call_DeleteDeploymentGroup_21626239(
    name: "deleteDeploymentGroup", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentGroup",
    validator: validate_DeleteDeploymentGroup_21626240, base: "/",
    makeUrl: url_DeleteDeploymentGroup_21626241,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteGitHubAccountToken_21626254 = ref object of OpenApiRestCall_21625435
proc url_DeleteGitHubAccountToken_21626256(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteGitHubAccountToken_21626255(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626266: Call_DeleteGitHubAccountToken_21626254;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a GitHub account connection.
  ## 
...
proc call*(call_21626267: Call_DeleteGitHubAccountToken_21626254; body: JsonNode): Recallable =
...
var deleteGitHubAccountToken* = Call_DeleteGitHubAccountToken_21626254(
    name: "deleteGitHubAccountToken", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.DeleteGitHubAccountToken",
    validator: validate_DeleteGitHubAccountToken_21626255, base: "/",
    makeUrl: url_DeleteGitHubAccountToken_21626256,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterOnPremisesInstance_21626269 = ref object of OpenApiRestCall_21625435
proc url_DeregisterOnPremisesInstance_21626271(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterOnPremisesInstance_21626270(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626281: Call_DeregisterOnPremisesInstance_21626269;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deregisters an on-premises instance.
  ## 
...
proc call*(call_21626282: Call_DeregisterOnPremisesInstance_21626269;
          body: JsonNode): Recallable =
...
var deregisterOnPremisesInstance* = Call_DeregisterOnPremisesInstance_21626269(
    ...
    validator: validate_DeregisterOnPremisesInstance_21626270, base: "/",
    makeUrl: url_DeregisterOnPremisesInstance_21626271,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetApplication_21626284 = ref object of OpenApiRestCall_21625435
proc url_GetApplication_21626286(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetApplication_21626285(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626296: Call_GetApplication_21626284; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about an application.
  ## 
...
proc call*(call_21626297: Call_GetApplication_21626284; body: JsonNode): Recallable =
  ## getApplication
  ## Gets information about an application.
  ##   body: JObject (required)
...
var getApplication* = Call_GetApplication_21626284(name: "getApplication",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetApplication",
    validator: validate_GetApplication_21626285, base: "/",
    makeUrl: url_GetApplication_21626286, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetApplicationRevision_21626299 = ref object of OpenApiRestCall_21625435
proc url_GetApplicationRevision_21626301(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetApplicationRevision_21626300(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626311: Call_GetApplicationRevision_21626299;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about an application revision.
  ## 
...
proc call*(call_21626312: Call_GetApplicationRevision_21626299; body: JsonNode): Recallable =
...
var getApplicationRevision* = Call_GetApplicationRevision_21626299(
    name: "getApplicationRevision", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetApplicationRevision",
    validator: validate_GetApplicationRevision_21626300, base: "/",
    makeUrl: url_GetApplicationRevision_21626301,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeployment_21626314 = ref object of OpenApiRestCall_21625435
proc url_GetDeployment_21626316(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDeployment_21626315(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626326: Call_GetDeployment_21626314; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Gets information about a deployment.</p> <note> <p> The <code>content</code> property of the <code>appSpecContent</code> object in the returned revision is always null. Use <code>GetApplicationRevision</code> and the <code>sha256</code> property of the returned <code>appSpecContent</code> object to get the content of the deployment’s AppSpec file. </p> </note>
  ## 
...
proc call*(call_21626327: Call_GetDeployment_21626314; body: JsonNode): Recallable =
  ## getDeployment
  ## <p>Gets information about a deployment.</p> <note> <p> The <code>content</code> property of the <code>appSpecContent</code> object in the returned revision is always null. Use <code>GetApplicationRevision</code> and the <code>sha256</code> property of the returned <code>appSpecContent</code> object to get the content of the deployment’s AppSpec file. </p> </note>
  ##   body: JObject (required)
...
var getDeployment* = Call_GetDeployment_21626314(name: "getDeployment",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetDeployment",
    validator: validate_GetDeployment_21626315, base: "/",
    makeUrl: url_GetDeployment_21626316, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeploymentConfig_21626329 = ref object of OpenApiRestCall_21625435
proc url_GetDeploymentConfig_21626331(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDeploymentConfig_21626330(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626341: Call_GetDeploymentConfig_21626329; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about a deployment configuration.
  ## 
...
proc call*(call_21626342: Call_GetDeploymentConfig_21626329; body: JsonNode): Recallable =
  ## getDeploymentConfig
  ## Gets information about a deployment configuration.
  ##   body: JObject (required)
...
var getDeploymentConfig* = Call_GetDeploymentConfig_21626329(
    name: "getDeploymentConfig", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentConfig",
    validator: validate_GetDeploymentConfig_21626330, base: "/",
    makeUrl: url_GetDeploymentConfig_21626331,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeploymentGroup_21626344 = ref object of OpenApiRestCall_21625435
proc url_GetDeploymentGroup_21626346(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDeploymentGroup_21626345(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626356: Call_GetDeploymentGroup_21626344; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about a deployment group.
  ## 
...
proc call*(call_21626357: Call_GetDeploymentGroup_21626344; body: JsonNode): Recallable =
  ## getDeploymentGroup
  ## Gets information about a deployment group.
  ##   body: JObject (required)
...
var getDeploymentGroup* = Call_GetDeploymentGroup_21626344(
    name: "getDeploymentGroup", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentGroup",
    validator: validate_GetDeploymentGroup_21626345, base: "/",
    makeUrl: url_GetDeploymentGroup_21626346, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeploymentInstance_21626359 = ref object of OpenApiRestCall_21625435
proc url_GetDeploymentInstance_21626361(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetDeploymentInstance_21626360(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626371: Call_GetDeploymentInstance_21626359;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about an instance as part of a deployment.
  ## 
...
proc call*(call_21626372: Call_GetDeploymentInstance_21626359; body: JsonNode): Recallable =
...
var getDeploymentInstance* = Call_GetDeploymentInstance_21626359(
    name: "getDeploymentInstance", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentInstance",
    validator: validate_GetDeploymentInstance_21626360, base: "/",
    makeUrl: url_GetDeploymentInstance_21626361,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeploymentTarget_21626374 = ref object of OpenApiRestCall_21625435
proc url_GetDeploymentTarget_21626376(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDeploymentTarget_21626375(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626386: Call_GetDeploymentTarget_21626374; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  Returns information about a deployment target. 
  ## 
...
proc call*(call_21626387: Call_GetDeploymentTarget_21626374; body: JsonNode): Recallable =
  ## getDeploymentTarget
  ##  Returns information about a deployment target. 
  ##   body: JObject (required)
...
var getDeploymentTarget* = Call_GetDeploymentTarget_21626374(
    name: "getDeploymentTarget", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentTarget",
    validator: validate_GetDeploymentTarget_21626375, base: "/",
    makeUrl: url_GetDeploymentTarget_21626376,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOnPremisesInstance_21626389 = ref object of OpenApiRestCall_21625435
proc url_GetOnPremisesInstance_21626391(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetOnPremisesInstance_21626390(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626401: Call_GetOnPremisesInstance_21626389;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Gets information about an on-premises instance. 
  ## 
...
proc call*(call_21626402: Call_GetOnPremisesInstance_21626389; body: JsonNode): Recallable =
...
var getOnPremisesInstance* = Call_GetOnPremisesInstance_21626389(
    name: "getOnPremisesInstance", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.GetOnPremisesInstance",
    validator: validate_GetOnPremisesInstance_21626390, base: "/",
    makeUrl: url_GetOnPremisesInstance_21626391,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListApplicationRevisions_21626404 = ref object of OpenApiRestCall_21625435
proc url_ListApplicationRevisions_21626406(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListApplicationRevisions_21626405(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626410 = header.getOrDefault("X-Amz-Target")
  valid_21626410 = validateParameter(valid_21626410, JString, required = true, default = newJString(
      "CodeDeploy_20141006.ListApplicationRevisions"))
  if valid_21626410 != nil:
    section.add "X-Amz-Target", valid_21626410
...
proc call*(call_21626417: Call_ListApplicationRevisions_21626404;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists information about revisions for an application.
  ## 
...
proc call*(call_21626418: Call_ListApplicationRevisions_21626404; body: JsonNode;
  ...
  if body != nil:
    body_21626421 = body
  result = call_21626418.call(nil, query_21626420, nil, nil, body_21626421)

var listApplicationRevisions* = Call_ListApplicationRevisions_21626404(
    name: "listApplicationRevisions", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListApplicationRevisions",
    validator: validate_ListApplicationRevisions_21626405, base: "/",
    makeUrl: url_ListApplicationRevisions_21626406,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListApplications_21626425 = ref object of OpenApiRestCall_21625435
proc url_ListApplications_21626427(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListApplications_21626426(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626438: Call_ListApplications_21626425; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the applications registered with the IAM user or AWS account.
  ## 
...
proc call*(call_21626439: Call_ListApplications_21626425; body: JsonNode;
          nextToken: string = ""): Recallable =
  ## listApplications
  ## Lists the applications registered with the IAM user or AWS account.
  ##   nextToken: string
  ...
  add(query_21626440, "nextToken", newJString(nextToken))
  if body != nil:
    body_21626441 = body
  result = call_21626439.call(nil, query_21626440, nil, nil, body_21626441)

var listApplications* = Call_ListApplications_21626425(name: "listApplications",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListApplications",
    validator: validate_ListApplications_21626426, base: "/",
    makeUrl: url_ListApplications_21626427, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeploymentConfigs_21626442 = ref object of OpenApiRestCall_21625435
proc url_ListDeploymentConfigs_21626444(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListDeploymentConfigs_21626443(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626448 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626448 != nil:
    section.add "X-Amz-Target", valid_21626448
...
proc call*(call_21626455: Call_ListDeploymentConfigs_21626442;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the deployment configurations with the IAM user or AWS account.
  ## 
...
proc call*(call_21626456: Call_ListDeploymentConfigs_21626442; body: JsonNode;
          nextToken: string = ""): Recallable =
  ...
  add(query_21626457, "nextToken", newJString(nextToken))
  if body != nil:
    body_21626458 = body
  result = call_21626456.call(nil, query_21626457, nil, nil, body_21626458)

var listDeploymentConfigs* = Call_ListDeploymentConfigs_21626442(
    name: "listDeploymentConfigs", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentConfigs",
    validator: validate_ListDeploymentConfigs_21626443, base: "/",
    makeUrl: url_ListDeploymentConfigs_21626444,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeploymentGroups_21626459 = ref object of OpenApiRestCall_21625435
proc url_ListDeploymentGroups_21626461(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDeploymentGroups_21626460(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626472: Call_ListDeploymentGroups_21626459; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the deployment groups for an application registered with the IAM user or AWS account.
  ## 
...
proc call*(call_21626473: Call_ListDeploymentGroups_21626459; body: JsonNode;
          nextToken: string = ""): Recallable =
  ...
  var body_21626475 = newJObject()
  add(query_21626474, "nextToken", newJString(nextToken))
  if body != nil:
    body_21626475 = body
  result = call_21626473.call(nil, query_21626474, nil, nil, body_21626475)

var listDeploymentGroups* = Call_ListDeploymentGroups_21626459(
    name: "listDeploymentGroups", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentGroups",
    validator: validate_ListDeploymentGroups_21626460, base: "/",
    makeUrl: url_ListDeploymentGroups_21626461,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeploymentInstances_21626476 = ref object of OpenApiRestCall_21625435
proc url_ListDeploymentInstances_21626478(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDeploymentInstances_21626477(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626489: Call_ListDeploymentInstances_21626476;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <note> <p> The newer BatchGetDeploymentTargets should be used instead because it works with all compute types. <code>ListDeploymentInstances</code> throws an exception if it is used with a compute platform other than EC2/On-premises or AWS Lambda. </p> </note> <p> Lists the instance for a deployment associated with the IAM user or AWS account. </p>
  ## 
...
proc call*(call_21626490: Call_ListDeploymentInstances_21626476; body: JsonNode;
          nextToken: string = ""): Recallable =
  ...
  ##            : Pagination token
  ##   body: JObject (required)
  var query_21626491 = newJObject()
  var body_21626492 = newJObject()
  add(query_21626491, "nextToken", newJString(nextToken))
  if body != nil:
    body_21626492 = body
  result = call_21626490.call(nil, query_21626491, nil, nil, body_21626492)

var listDeploymentInstances* = Call_ListDeploymentInstances_21626476(
    name: "listDeploymentInstances", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentInstances",
    validator: validate_ListDeploymentInstances_21626477, base: "/",
    makeUrl: url_ListDeploymentInstances_21626478,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeploymentTargets_21626493 = ref object of OpenApiRestCall_21625435
proc url_ListDeploymentTargets_21626495(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListDeploymentTargets_21626494(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626505: Call_ListDeploymentTargets_21626493;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Returns an array of target IDs that are associated a deployment. 
  ## 
...
proc call*(call_21626506: Call_ListDeploymentTargets_21626493; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_21626507 = body
  result = call_21626506.call(nil, nil, nil, nil, body_21626507)

var listDeploymentTargets* = Call_ListDeploymentTargets_21626493(
    name: "listDeploymentTargets", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentTargets",
    validator: validate_ListDeploymentTargets_21626494, base: "/",
    makeUrl: url_ListDeploymentTargets_21626495,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeployments_21626508 = ref object of OpenApiRestCall_21625435
proc url_ListDeployments_21626510(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDeployments_21626509(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626521: Call_ListDeployments_21626508; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the deployments in a deployment group for an application registered with the IAM user or AWS account.
  ## 
...
proc call*(call_21626522: Call_ListDeployments_21626508; body: JsonNode;
          nextToken: string = ""): Recallable =
  ## listDeployments
  ## Lists the deployments in a deployment group for an application registered with the IAM user or AWS account.
  ##   nextToken: string
  ...
  add(query_21626523, "nextToken", newJString(nextToken))
  if body != nil:
    body_21626524 = body
  result = call_21626522.call(nil, query_21626523, nil, nil, body_21626524)

var listDeployments* = Call_ListDeployments_21626508(name: "listDeployments",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListDeployments",
    validator: validate_ListDeployments_21626509, base: "/",
    makeUrl: url_ListDeployments_21626510, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListGitHubAccountTokenNames_21626525 = ref object of OpenApiRestCall_21625435
proc url_ListGitHubAccountTokenNames_21626527(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListGitHubAccountTokenNames_21626526(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626537: Call_ListGitHubAccountTokenNames_21626525;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the names of stored connections to GitHub accounts.
  ## 
...
proc call*(call_21626538: Call_ListGitHubAccountTokenNames_21626525; body: JsonNode): Recallable =
...
var listGitHubAccountTokenNames* = Call_ListGitHubAccountTokenNames_21626525(
    ...
    validator: validate_ListGitHubAccountTokenNames_21626526, base: "/",
    makeUrl: url_ListGitHubAccountTokenNames_21626527,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOnPremisesInstances_21626540 = ref object of OpenApiRestCall_21625435
proc url_ListOnPremisesInstances_21626542(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListOnPremisesInstances_21626541(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626552: Call_ListOnPremisesInstances_21626540;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Gets a list of names for one or more on-premises instances.</p> <p>Unless otherwise specified, both registered and deregistered on-premises instance names are listed. To list only registered or deregistered on-premises instance names, use the registration status parameter.</p>
  ## 
...
proc call*(call_21626553: Call_ListOnPremisesInstances_21626540; body: JsonNode): Recallable =
...
var listOnPremisesInstances* = Call_ListOnPremisesInstances_21626540(
    name: "listOnPremisesInstances", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListOnPremisesInstances",
    validator: validate_ListOnPremisesInstances_21626541, base: "/",
    makeUrl: url_ListOnPremisesInstances_21626542,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_21626555 = ref object of OpenApiRestCall_21625435
proc url_ListTagsForResource_21626557(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_21626556(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626567: Call_ListTagsForResource_21626555; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  Returns a list of tags for the resource identified by a specified ARN. Tags are used to organize and categorize your CodeDeploy resources. 
  ## 
...
proc call*(call_21626568: Call_ListTagsForResource_21626555; body: JsonNode): Recallable =
  ## listTagsForResource
  ##  Returns a list of tags for the resource identified by a specified ARN. Tags are used to organize and categorize your CodeDeploy resources. 
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_21626555(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.ListTagsForResource",
    validator: validate_ListTagsForResource_21626556, base: "/",
    makeUrl: url_ListTagsForResource_21626557,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutLifecycleEventHookExecutionStatus_21626570 = ref object of OpenApiRestCall_21625435
proc url_PutLifecycleEventHookExecutionStatus_21626572(protocol: Scheme;
...
proc validate_PutLifecycleEventHookExecutionStatus_21626571(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626582: Call_PutLifecycleEventHookExecutionStatus_21626570;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Sets the result of a Lambda validation function. The function validates one or both lifecycle events (<code>BeforeAllowTraffic</code> and <code>AfterAllowTraffic</code>) and returns <code>Succeeded</code> or <code>Failed</code>. 
  ## 
...
proc call*(call_21626583: Call_PutLifecycleEventHookExecutionStatus_21626570;
          body: JsonNode): Recallable =
...
var putLifecycleEventHookExecutionStatus* = Call_PutLifecycleEventHookExecutionStatus_21626570(
    ...
    validator: validate_PutLifecycleEventHookExecutionStatus_21626571, base: "/",
    makeUrl: url_PutLifecycleEventHookExecutionStatus_21626572,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterApplicationRevision_21626585 = ref object of OpenApiRestCall_21625435
proc url_RegisterApplicationRevision_21626587(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterApplicationRevision_21626586(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626597: Call_RegisterApplicationRevision_21626585;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Registers with AWS CodeDeploy a revision for the specified application.
  ## 
...
proc call*(call_21626598: Call_RegisterApplicationRevision_21626585; body: JsonNode): Recallable =
...
var registerApplicationRevision* = Call_RegisterApplicationRevision_21626585(
    ...
    validator: validate_RegisterApplicationRevision_21626586, base: "/",
    makeUrl: url_RegisterApplicationRevision_21626587,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterOnPremisesInstance_21626600 = ref object of OpenApiRestCall_21625435
proc url_RegisterOnPremisesInstance_21626602(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterOnPremisesInstance_21626601(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626612: Call_RegisterOnPremisesInstance_21626600;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Registers an on-premises instance.</p> <note> <p>Only one IAM ARN (an IAM session ARN or IAM user ARN) is supported in the request. You cannot use both.</p> </note>
  ## 
...
proc call*(call_21626613: Call_RegisterOnPremisesInstance_21626600; body: JsonNode): Recallable =
...
var registerOnPremisesInstance* = Call_RegisterOnPremisesInstance_21626600(
    ...
    validator: validate_RegisterOnPremisesInstance_21626601, base: "/",
    makeUrl: url_RegisterOnPremisesInstance_21626602,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveTagsFromOnPremisesInstances_21626615 = ref object of OpenApiRestCall_21625435
proc url_RemoveTagsFromOnPremisesInstances_21626617(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveTagsFromOnPremisesInstances_21626616(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  valid_21626620 = validateParameter(valid_21626620, JString, required = true, default = newJString(
...
proc call*(call_21626627: Call_RemoveTagsFromOnPremisesInstances_21626615;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes one or more tags from one or more on-premises instances.
  ## 
...
proc call*(call_21626628: Call_RemoveTagsFromOnPremisesInstances_21626615;
          body: JsonNode): Recallable =
...
var removeTagsFromOnPremisesInstances* = Call_RemoveTagsFromOnPremisesInstances_21626615(
    ...
    validator: validate_RemoveTagsFromOnPremisesInstances_21626616, base: "/",
    makeUrl: url_RemoveTagsFromOnPremisesInstances_21626617,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SkipWaitTimeForInstanceTermination_21626630 = ref object of OpenApiRestCall_21625435
proc url_SkipWaitTimeForInstanceTermination_21626632(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SkipWaitTimeForInstanceTermination_21626631(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626642: Call_SkipWaitTimeForInstanceTermination_21626630;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## In a blue/green deployment, overrides any specified wait time and starts terminating instances immediately after the traffic routing is complete.
  ## 
...
proc call*(call_21626643: Call_SkipWaitTimeForInstanceTermination_21626630;
          body: JsonNode): Recallable =
...
var skipWaitTimeForInstanceTermination* = Call_SkipWaitTimeForInstanceTermination_21626630(
    ...
    validator: validate_SkipWaitTimeForInstanceTermination_21626631, base: "/",
    makeUrl: url_SkipWaitTimeForInstanceTermination_21626632,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopDeployment_21626645 = ref object of OpenApiRestCall_21625435
proc url_StopDeployment_21626647(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopDeployment_21626646(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626657: Call_StopDeployment_21626645; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Attempts to stop an ongoing deployment.
  ## 
...
proc call*(call_21626658: Call_StopDeployment_21626645; body: JsonNode): Recallable =
  ## stopDeployment
  ## Attempts to stop an ongoing deployment.
  ##   body: JObject (required)
...
var stopDeployment* = Call_StopDeployment_21626645(name: "stopDeployment",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.StopDeployment",
    validator: validate_StopDeployment_21626646, base: "/",
    makeUrl: url_StopDeployment_21626647, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_21626660 = ref object of OpenApiRestCall_21625435
proc url_TagResource_21626662(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_21626661(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21626672: Call_TagResource_21626660; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  Associates the list of tags in the input <code>Tags</code> parameter with the resource identified by the <code>ResourceArn</code> input parameter. 
  ## 
...
proc call*(call_21626673: Call_TagResource_21626660; body: JsonNode): Recallable =
  ## tagResource
  ##  Associates the list of tags in the input <code>Tags</code> parameter with the resource identified by the <code>ResourceArn</code> input parameter. 
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_21626660(name: "tagResource",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.TagResource",
    validator: validate_TagResource_21626661, base: "/", makeUrl: url_TagResource_21626662,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_21626675 = ref object of OpenApiRestCall_21625435
proc url_UntagResource_21626677(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_21626676(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626687: Call_UntagResource_21626675; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  Disassociates a resource from a list of tags. The resource is identified by the <code>ResourceArn</code> input parameter. The tags are identfied by the list of keys in the <code>TagKeys</code> input parameter. 
  ## 
...
proc call*(call_21626688: Call_UntagResource_21626675; body: JsonNode): Recallable =
  ## untagResource
  ##  Disassociates a resource from a list of tags. The resource is identified by the <code>ResourceArn</code> input parameter. The tags are identfied by the list of keys in the <code>TagKeys</code> input parameter. 
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_21626675(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.UntagResource",
    validator: validate_UntagResource_21626676, base: "/",
    makeUrl: url_UntagResource_21626677, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateApplication_21626690 = ref object of OpenApiRestCall_21625435
proc url_UpdateApplication_21626692(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateApplication_21626691(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626702: Call_UpdateApplication_21626690; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Changes the name of an application.
  ## 
...
proc call*(call_21626703: Call_UpdateApplication_21626690; body: JsonNode): Recallable =
  ## updateApplication
  ## Changes the name of an application.
  ##   body: JObject (required)
...
var updateApplication* = Call_UpdateApplication_21626690(name: "updateApplication",
    meth: HttpMethod.HttpPost, host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.UpdateApplication",
    validator: validate_UpdateApplication_21626691, base: "/",
    makeUrl: url_UpdateApplication_21626692, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDeploymentGroup_21626705 = ref object of OpenApiRestCall_21625435
proc url_UpdateDeploymentGroup_21626707(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateDeploymentGroup_21626706(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626717: Call_UpdateDeploymentGroup_21626705;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Changes information about a deployment group.
  ## 
...
proc call*(call_21626718: Call_UpdateDeploymentGroup_21626705; body: JsonNode): Recallable =
...
var updateDeploymentGroup* = Call_UpdateDeploymentGroup_21626705(
    name: "updateDeploymentGroup", meth: HttpMethod.HttpPost,
    host: "codedeploy.amazonaws.com",
    route: "/#X-Amz-Target=CodeDeploy_20141006.UpdateDeploymentGroup",
    validator: validate_UpdateDeploymentGroup_21626706, base: "/",
    makeUrl: url_UpdateDeploymentGroup_21626707,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
