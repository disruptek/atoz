...
type
  Call_AddLayerVersionPermission_592974 = ref object of OpenApiRestCall_592364
proc url_AddLayerVersionPermission_592976(protocol: Scheme; host: string;
...
proc validate_AddLayerVersionPermission_592975(path: JsonNode; query: JsonNode;
  ...
  var valid_592977 = path.getOrDefault("VersionNumber")
  valid_592977 = validateParameter(valid_592977, JInt, required = true, default = nil)
  if valid_592977 != nil:
    section.add "VersionNumber", valid_592977
  var valid_592978 = path.getOrDefault("LayerName")
  valid_592978 = validateParameter(valid_592978, JString, required = true,
                                 default = nil)
  if valid_592978 != nil:
    section.add "LayerName", valid_592978
  result.add "path", section
  ## parameters in `query` object:
  ##   RevisionId: JString
  ##             : Only update the policy if the revision ID matches the ID specified. Use this option to avoid modifying a policy that has changed since you last read it.
  section = newJObject()
  var valid_592979 = query.getOrDefault("RevisionId")
  valid_592979 = validateParameter(valid_592979, JString, required = false,
                                 default = nil)
  if valid_592979 != nil:
    section.add "RevisionId", valid_592979
...
proc call*(call_592988: Call_AddLayerVersionPermission_592974; path: JsonNode;
...
proc call*(call_592989: Call_AddLayerVersionPermission_592974; VersionNumber: int;
  ...
  add(query_592991, "RevisionId", newJString(RevisionId))
  add(path_592990, "VersionNumber", newJInt(VersionNumber))
  add(path_592990, "LayerName", newJString(LayerName))
  if body != nil:
    body_592992 = body
  result = call_592989.call(path_592990, query_592991, nil, nil, body_592992)

var addLayerVersionPermission* = Call_AddLayerVersionPermission_592974(
    ...
    validator: validate_AddLayerVersionPermission_592975, base: "/",
    url: url_AddLayerVersionPermission_592976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLayerVersionPolicy_592703 = ref object of OpenApiRestCall_592364
proc url_GetLayerVersionPolicy_592705(protocol: Scheme; host: string; base: string;
...
proc validate_GetLayerVersionPolicy_592704(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `VersionNumber` field"
  var valid_592831 = path.getOrDefault("VersionNumber")
  valid_592831 = validateParameter(valid_592831, JInt, required = true, default = nil)
  if valid_592831 != nil:
    section.add "VersionNumber", valid_592831
  var valid_592832 = path.getOrDefault("LayerName")
  valid_592832 = validateParameter(valid_592832, JString, required = true,
                                 default = nil)
  if valid_592832 != nil:
    section.add "LayerName", valid_592832
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_592862: Call_GetLayerVersionPolicy_592703; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the permission policy for a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>. For more information, see <a>AddLayerVersionPermission</a>.
  ## 
...
proc call*(call_592933: Call_GetLayerVersionPolicy_592703; VersionNumber: int;
  ...
  add(path_592934, "VersionNumber", newJInt(VersionNumber))
  add(path_592934, "LayerName", newJString(LayerName))
  result = call_592933.call(path_592934, nil, nil, nil, nil)

var getLayerVersionPolicy* = Call_GetLayerVersionPolicy_592703(
    name: "getLayerVersionPolicy", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers/{LayerName}/versions/{VersionNumber}/policy",
    validator: validate_GetLayerVersionPolicy_592704, base: "/",
    url: url_GetLayerVersionPolicy_592705, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AddPermission_593009 = ref object of OpenApiRestCall_592364
proc url_AddPermission_593011(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AddPermission_593010(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_593012 = path.getOrDefault("FunctionName")
  valid_593012 = validateParameter(valid_593012, JString, required = true,
                                 default = nil)
  if valid_593012 != nil:
    section.add "FunctionName", valid_593012
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version or alias to add permissions to a published version of the function.
  section = newJObject()
  var valid_593013 = query.getOrDefault("Qualifier")
  valid_593013 = validateParameter(valid_593013, JString, required = false,
                                 default = nil)
  if valid_593013 != nil:
    section.add "Qualifier", valid_593013
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593022: Call_AddPermission_593009; path: JsonNode; query: JsonNode;
...
proc call*(call_593023: Call_AddPermission_593009; FunctionName: string;
  ...
  var body_593026 = newJObject()
  add(path_593024, "FunctionName", newJString(FunctionName))
  add(query_593025, "Qualifier", newJString(Qualifier))
  if body != nil:
    body_593026 = body
  result = call_593023.call(path_593024, query_593025, nil, nil, body_593026)

var addPermission* = Call_AddPermission_593009(name: "addPermission",
    meth: HttpMethod.HttpPost, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/policy",
    validator: validate_AddPermission_593010, base: "/", url: url_AddPermission_593011,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetPolicy_592993 = ref object of OpenApiRestCall_592364
proc url_GetPolicy_592995(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetPolicy_592994(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_592996 = path.getOrDefault("FunctionName")
  valid_592996 = validateParameter(valid_592996, JString, required = true,
                                 default = nil)
  if valid_592996 != nil:
    section.add "FunctionName", valid_592996
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version or alias to get the policy for that resource.
  section = newJObject()
  var valid_592997 = query.getOrDefault("Qualifier")
  valid_592997 = validateParameter(valid_592997, JString, required = false,
                                 default = nil)
  if valid_592997 != nil:
    section.add "Qualifier", valid_592997
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593005: Call_GetPolicy_592993; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the <a href="https://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html">resource-based IAM policy</a> for a function, version, or alias.
  ## 
...
proc call*(call_593006: Call_GetPolicy_592993; FunctionName: string;
  ...
  add(path_593007, "FunctionName", newJString(FunctionName))
  add(query_593008, "Qualifier", newJString(Qualifier))
  result = call_593006.call(path_593007, query_593008, nil, nil, nil)

var getPolicy* = Call_GetPolicy_592993(name: "getPolicy", meth: HttpMethod.HttpGet,
                                    host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/policy",
                                    validator: validate_GetPolicy_592994,
                                    base: "/", url: url_GetPolicy_592995,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAlias_593045 = ref object of OpenApiRestCall_592364
proc url_CreateAlias_593047(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAlias_593046(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593048 = path.getOrDefault("FunctionName")
  valid_593048 = validateParameter(valid_593048, JString, required = true,
                                 default = nil)
  if valid_593048 != nil:
    section.add "FunctionName", valid_593048
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593057: Call_CreateAlias_593045; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a> for a Lambda function version. Use aliases to provide clients with a function identifier that you can update to invoke a different version.</p> <p>You can also map an alias to split invocation requests between two versions. Use the <code>RoutingConfig</code> parameter to specify a second version and the percentage of invocation requests that it receives.</p>
  ## 
...
proc call*(call_593058: Call_CreateAlias_593045; FunctionName: string; body: JsonNode): Recallable =
  ## createAlias
  ## <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a> for a Lambda function version. Use aliases to provide clients with a function identifier that you can update to invoke a different version.</p> <p>You can also map an alias to split invocation requests between two versions. Use the <code>RoutingConfig</code> parameter to specify a second version and the percentage of invocation requests that it receives.</p>
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>MyFunction</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:MyFunction</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:MyFunction</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  ...
  add(path_593059, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593060 = body
  result = call_593058.call(path_593059, nil, nil, nil, body_593060)

var createAlias* = Call_CreateAlias_593045(name: "createAlias",
                                        meth: HttpMethod.HttpPost,
                                        host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/aliases",
                                        validator: validate_CreateAlias_593046,
                                        base: "/", url: url_CreateAlias_593047,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAliases_593027 = ref object of OpenApiRestCall_592364
proc url_ListAliases_593029(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAliases_593028(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593030 = path.getOrDefault("FunctionName")
  valid_593030 = validateParameter(valid_593030, JString, required = true,
                                 default = nil)
  if valid_593030 != nil:
    section.add "FunctionName", valid_593030
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ...
  section = newJObject()
  var valid_593031 = query.getOrDefault("Marker")
  valid_593031 = validateParameter(valid_593031, JString, required = false,
                                 default = nil)
  if valid_593031 != nil:
    section.add "Marker", valid_593031
  var valid_593032 = query.getOrDefault("FunctionVersion")
  valid_593032 = validateParameter(valid_593032, JString, required = false,
                                 default = nil)
  if valid_593032 != nil:
    section.add "FunctionVersion", valid_593032
  var valid_593033 = query.getOrDefault("MaxItems")
  valid_593033 = validateParameter(valid_593033, JInt, required = false, default = nil)
  if valid_593033 != nil:
    section.add "MaxItems", valid_593033
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593041: Call_ListAliases_593027; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">aliases</a> for a Lambda function.
  ## 
...
proc call*(call_593042: Call_ListAliases_593027; FunctionName: string;
  ...
  add(query_593044, "Marker", newJString(Marker))
  add(query_593044, "FunctionVersion", newJString(FunctionVersion))
  add(path_593043, "FunctionName", newJString(FunctionName))
  add(query_593044, "MaxItems", newJInt(MaxItems))
  result = call_593042.call(path_593043, query_593044, nil, nil, nil)

var listAliases* = Call_ListAliases_593027(name: "listAliases",
                                        meth: HttpMethod.HttpGet,
                                        host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/aliases",
                                        validator: validate_ListAliases_593028,
                                        base: "/", url: url_ListAliases_593029,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEventSourceMapping_593078 = ref object of OpenApiRestCall_592364
proc url_CreateEventSourceMapping_593080(protocol: Scheme; host: string;
...
proc validate_CreateEventSourceMapping_593079(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593089: Call_CreateEventSourceMapping_593078; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a mapping between an event source and an AWS Lambda function. Lambda reads items from the event source and triggers the function.</p> <p>For details about each event source type, see the following topics.</p> <ul> <li> <p> <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-kinesis.html">Using AWS Lambda with Amazon Kinesis</a> </p> </li> <li> <p> <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-sqs.html">Using AWS Lambda with Amazon SQS</a> </p> </li> <li> <p> <a href="https://docs.aws.amazon.com/lambda/latest/dg/with-ddb.html">Using AWS Lambda with Amazon DynamoDB</a> </p> </li> </ul>
  ## 
...
proc call*(call_593090: Call_CreateEventSourceMapping_593078; body: JsonNode): Recallable =
...
var createEventSourceMapping* = Call_CreateEventSourceMapping_593078(
    name: "createEventSourceMapping", meth: HttpMethod.HttpPost,
    host: "lambda.amazonaws.com", route: "/2015-03-31/event-source-mappings/",
    validator: validate_CreateEventSourceMapping_593079, base: "/",
    url: url_CreateEventSourceMapping_593080, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListEventSourceMappings_593061 = ref object of OpenApiRestCall_592364
proc url_ListEventSourceMappings_593063(protocol: Scheme; host: string; base: string;
...
proc validate_ListEventSourceMappings_593062(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_593064 = query.getOrDefault("Marker")
  valid_593064 = validateParameter(valid_593064, JString, required = false,
                                 default = nil)
  if valid_593064 != nil:
    section.add "Marker", valid_593064
  var valid_593065 = query.getOrDefault("FunctionName")
  valid_593065 = validateParameter(valid_593065, JString, required = false,
                                 default = nil)
  if valid_593065 != nil:
    section.add "FunctionName", valid_593065
  var valid_593066 = query.getOrDefault("MaxItems")
  valid_593066 = validateParameter(valid_593066, JInt, required = false, default = nil)
  if valid_593066 != nil:
    section.add "MaxItems", valid_593066
  var valid_593067 = query.getOrDefault("EventSourceArn")
  valid_593067 = validateParameter(valid_593067, JString, required = false,
                                 default = nil)
  if valid_593067 != nil:
    section.add "EventSourceArn", valid_593067
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593075: Call_ListEventSourceMappings_593061; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists event source mappings. Specify an <code>EventSourceArn</code> to only show event source mappings for a single event source.
  ## 
...
proc call*(call_593076: Call_ListEventSourceMappings_593061; Marker: string = "";
  ...
  add(query_593077, "Marker", newJString(Marker))
  add(query_593077, "FunctionName", newJString(FunctionName))
  add(query_593077, "MaxItems", newJInt(MaxItems))
  add(query_593077, "EventSourceArn", newJString(EventSourceArn))
  result = call_593076.call(nil, query_593077, nil, nil, nil)

var listEventSourceMappings* = Call_ListEventSourceMappings_593061(
    name: "listEventSourceMappings", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com", route: "/2015-03-31/event-source-mappings/",
    validator: validate_ListEventSourceMappings_593062, base: "/",
    url: url_ListEventSourceMappings_593063, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateFunction_593092 = ref object of OpenApiRestCall_592364
proc url_CreateFunction_593094(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateFunction_593093(path: JsonNode; query: JsonNode;
...
proc call*(call_593103: Call_CreateFunction_593092; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a Lambda function. To create a function, you need a <a href="https://docs.aws.amazon.com/lambda/latest/dg/deployment-package-v2.html">deployment package</a> and an <a href="https://docs.aws.amazon.com/lambda/latest/dg/intro-permission-model.html#lambda-intro-execution-role">execution role</a>. The deployment package contains your function code. The execution role grants the function permission to use AWS services, such as Amazon CloudWatch Logs for log streaming and AWS X-Ray for request tracing.</p> <p>A function has an unpublished version, and can have published versions and aliases. The unpublished version changes when you update your function's code and configuration. A published version is a snapshot of your function code and configuration that can't be changed. An alias is a named resource that maps to a version, and can be changed to map to a different version. Use the <code>Publish</code> parameter to create version <code>1</code> of your function from its initial configuration.</p> <p>The other parameters let you configure version-specific and function-level settings. You can modify version-specific settings later with <a>UpdateFunctionConfiguration</a>. Function-level settings apply to both the unpublished and published versions of the function, and include tags (<a>TagResource</a>) and per-function concurrency limits (<a>PutFunctionConcurrency</a>).</p> <p>If another account or an AWS service invokes your function, use <a>AddPermission</a> to grant permission by creating a resource-based IAM policy. You can grant permissions at the function level, on a version, or on an alias.</p> <p>To invoke your function directly, use <a>Invoke</a>. To invoke your function in response to events in other AWS services, create an event source mapping (<a>CreateEventSourceMapping</a>), or configure a function trigger in the other service. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invoking-lambda-functions.html">Invoking Functions</a>.</p>
  ## 
...
proc call*(call_593104: Call_CreateFunction_593092; body: JsonNode): Recallable =
  ## createFunction
  ## <p>Creates a Lambda function. To create a function, you need a <a href="https://docs.aws.amazon.com/lambda/latest/dg/deployment-package-v2.html">deployment package</a> and an <a href="https://docs.aws.amazon.com/lambda/latest/dg/intro-permission-model.html#lambda-intro-execution-role">execution role</a>. The deployment package contains your function code. The execution role grants the function permission to use AWS services, such as Amazon CloudWatch Logs for log streaming and AWS X-Ray for request tracing.</p> <p>A function has an unpublished version, and can have published versions and aliases. The unpublished version changes when you update your function's code and configuration. A published version is a snapshot of your function code and configuration that can't be changed. An alias is a named resource that maps to a version, and can be changed to map to a different version. Use the <code>Publish</code> parameter to create version <code>1</code> of your function from its initial configuration.</p> <p>The other parameters let you configure version-specific and function-level settings. You can modify version-specific settings later with <a>UpdateFunctionConfiguration</a>. Function-level settings apply to both the unpublished and published versions of the function, and include tags (<a>TagResource</a>) and per-function concurrency limits (<a>PutFunctionConcurrency</a>).</p> <p>If another account or an AWS service invokes your function, use <a>AddPermission</a> to grant permission by creating a resource-based IAM policy. You can grant permissions at the function level, on a version, or on an alias.</p> <p>To invoke your function directly, use <a>Invoke</a>. To invoke your function in response to events in other AWS services, create an event source mapping (<a>CreateEventSourceMapping</a>), or configure a function trigger in the other service. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/invoking-lambda-functions.html">Invoking Functions</a>.</p>
  ##   body: JObject (required)
...
var createFunction* = Call_CreateFunction_593092(name: "createFunction",
    meth: HttpMethod.HttpPost, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions", validator: validate_CreateFunction_593093,
    base: "/", url: url_CreateFunction_593094, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAlias_593121 = ref object of OpenApiRestCall_592364
proc url_UpdateAlias_593123(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAlias_593122(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593124 = path.getOrDefault("FunctionName")
  valid_593124 = validateParameter(valid_593124, JString, required = true,
                                 default = nil)
  if valid_593124 != nil:
    section.add "FunctionName", valid_593124
  var valid_593125 = path.getOrDefault("Name")
  valid_593125 = validateParameter(valid_593125, JString, required = true,
                                 default = nil)
  if valid_593125 != nil:
    section.add "Name", valid_593125
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593134: Call_UpdateAlias_593121; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the configuration of a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.
  ## 
...
proc call*(call_593135: Call_UpdateAlias_593121; FunctionName: string; Name: string;
  ...
  add(path_593136, "Name", newJString(Name))
  if body != nil:
    body_593137 = body
  result = call_593135.call(path_593136, nil, nil, nil, body_593137)

var updateAlias* = Call_UpdateAlias_593121(name: "updateAlias",
                                        meth: HttpMethod.HttpPut,
                                        host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/aliases/{Name}",
                                        validator: validate_UpdateAlias_593122,
                                        base: "/", url: url_UpdateAlias_593123,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAlias_593106 = ref object of OpenApiRestCall_592364
proc url_GetAlias_593108(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAlias_593107(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593109 = path.getOrDefault("FunctionName")
  valid_593109 = validateParameter(valid_593109, JString, required = true,
                                 default = nil)
  if valid_593109 != nil:
    section.add "FunctionName", valid_593109
  var valid_593110 = path.getOrDefault("Name")
  valid_593110 = validateParameter(valid_593110, JString, required = true,
                                 default = nil)
  if valid_593110 != nil:
    section.add "Name", valid_593110
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593118: Call_GetAlias_593106; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns details about a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.
  ## 
...
proc call*(call_593119: Call_GetAlias_593106; FunctionName: string; Name: string): Recallable =
  ## getAlias
  ## Returns details about a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>MyFunction</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:MyFunction</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:MyFunction</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  ...
  add(path_593120, "FunctionName", newJString(FunctionName))
  add(path_593120, "Name", newJString(Name))
  result = call_593119.call(path_593120, nil, nil, nil, nil)

var getAlias* = Call_GetAlias_593106(name: "getAlias", meth: HttpMethod.HttpGet,
                                  host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/aliases/{Name}",
                                  validator: validate_GetAlias_593107, base: "/",
                                  url: url_GetAlias_593108,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAlias_593138 = ref object of OpenApiRestCall_592364
proc url_DeleteAlias_593140(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAlias_593139(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593141 = path.getOrDefault("FunctionName")
  valid_593141 = validateParameter(valid_593141, JString, required = true,
                                 default = nil)
  if valid_593141 != nil:
    section.add "FunctionName", valid_593141
  var valid_593142 = path.getOrDefault("Name")
  valid_593142 = validateParameter(valid_593142, JString, required = true,
                                 default = nil)
  if valid_593142 != nil:
    section.add "Name", valid_593142
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593150: Call_DeleteAlias_593138; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.
  ## 
...
proc call*(call_593151: Call_DeleteAlias_593138; FunctionName: string; Name: string): Recallable =
  ## deleteAlias
  ## Deletes a Lambda function <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">alias</a>.
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>MyFunction</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:MyFunction</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:MyFunction</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  ##   Name: string (required)
  ##       : The name of the alias.
  var path_593152 = newJObject()
  add(path_593152, "FunctionName", newJString(FunctionName))
  add(path_593152, "Name", newJString(Name))
  result = call_593151.call(path_593152, nil, nil, nil, nil)

var deleteAlias* = Call_DeleteAlias_593138(name: "deleteAlias",
                                        meth: HttpMethod.HttpDelete,
                                        host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/aliases/{Name}",
                                        validator: validate_DeleteAlias_593139,
                                        base: "/", url: url_DeleteAlias_593140,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEventSourceMapping_593167 = ref object of OpenApiRestCall_592364
proc url_UpdateEventSourceMapping_593169(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateEventSourceMapping_593168(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593170 = path.getOrDefault("UUID")
  valid_593170 = validateParameter(valid_593170, JString, required = true,
                                 default = nil)
  if valid_593170 != nil:
    section.add "UUID", valid_593170
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593179: Call_UpdateEventSourceMapping_593167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an event source mapping. You can change the function that AWS Lambda invokes, or pause invocation and resume later from the same location.
  ## 
...
proc call*(call_593180: Call_UpdateEventSourceMapping_593167; UUID: string;
          body: JsonNode): Recallable =
  ...
  add(path_593181, "UUID", newJString(UUID))
  if body != nil:
    body_593182 = body
  result = call_593180.call(path_593181, nil, nil, nil, body_593182)

var updateEventSourceMapping* = Call_UpdateEventSourceMapping_593167(
    name: "updateEventSourceMapping", meth: HttpMethod.HttpPut,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/event-source-mappings/{UUID}",
    validator: validate_UpdateEventSourceMapping_593168, base: "/",
    url: url_UpdateEventSourceMapping_593169, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEventSourceMapping_593153 = ref object of OpenApiRestCall_592364
proc url_GetEventSourceMapping_593155(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetEventSourceMapping_593154(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `UUID` field"
  var valid_593156 = path.getOrDefault("UUID")
  valid_593156 = validateParameter(valid_593156, JString, required = true,
                                 default = nil)
  if valid_593156 != nil:
    section.add "UUID", valid_593156
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593164: Call_GetEventSourceMapping_593153; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns details about an event source mapping. You can get the identifier of a mapping from the output of <a>ListEventSourceMappings</a>.
  ## 
...
proc call*(call_593165: Call_GetEventSourceMapping_593153; UUID: string): Recallable =
  ## getEventSourceMapping
  ## Returns details about an event source mapping. You can get the identifier of a mapping from the output of <a>ListEventSourceMappings</a>.
  ##   UUID: string (required)
  ##       : The identifier of the event source mapping.
  var path_593166 = newJObject()
  add(path_593166, "UUID", newJString(UUID))
  result = call_593165.call(path_593166, nil, nil, nil, nil)

var getEventSourceMapping* = Call_GetEventSourceMapping_593153(
    name: "getEventSourceMapping", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/event-source-mappings/{UUID}",
    validator: validate_GetEventSourceMapping_593154, base: "/",
    url: url_GetEventSourceMapping_593155, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEventSourceMapping_593183 = ref object of OpenApiRestCall_592364
proc url_DeleteEventSourceMapping_593185(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteEventSourceMapping_593184(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `UUID` field"
  var valid_593186 = path.getOrDefault("UUID")
  valid_593186 = validateParameter(valid_593186, JString, required = true,
                                 default = nil)
  if valid_593186 != nil:
    section.add "UUID", valid_593186
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593194: Call_DeleteEventSourceMapping_593183; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an <a href="https://docs.aws.amazon.com/lambda/latest/dg/intro-invocation-modes.html">event source mapping</a>. You can get the identifier of a mapping from the output of <a>ListEventSourceMappings</a>.
  ## 
...
proc call*(call_593195: Call_DeleteEventSourceMapping_593183; UUID: string): Recallable =
  ## deleteEventSourceMapping
  ## Deletes an <a href="https://docs.aws.amazon.com/lambda/latest/dg/intro-invocation-modes.html">event source mapping</a>. You can get the identifier of a mapping from the output of <a>ListEventSourceMappings</a>.
  ##   UUID: string (required)
  ##       : The identifier of the event source mapping.
  var path_593196 = newJObject()
  add(path_593196, "UUID", newJString(UUID))
  result = call_593195.call(path_593196, nil, nil, nil, nil)

var deleteEventSourceMapping* = Call_DeleteEventSourceMapping_593183(
    name: "deleteEventSourceMapping", meth: HttpMethod.HttpDelete,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/event-source-mappings/{UUID}",
    validator: validate_DeleteEventSourceMapping_593184, base: "/",
    url: url_DeleteEventSourceMapping_593185, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFunction_593197 = ref object of OpenApiRestCall_592364
proc url_GetFunction_593199(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetFunction_593198(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593200 = path.getOrDefault("FunctionName")
  valid_593200 = validateParameter(valid_593200, JString, required = true,
                                 default = nil)
  if valid_593200 != nil:
    section.add "FunctionName", valid_593200
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version or alias to get details about a published version of the function.
  section = newJObject()
  var valid_593201 = query.getOrDefault("Qualifier")
  valid_593201 = validateParameter(valid_593201, JString, required = false,
                                 default = nil)
  if valid_593201 != nil:
    section.add "Qualifier", valid_593201
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593209: Call_GetFunction_593197; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about the function or function version, with a link to download the deployment package that's valid for 10 minutes. If you specify a function version, only details that are specific to that version are returned.
  ## 
...
proc call*(call_593210: Call_GetFunction_593197; FunctionName: string;
          Qualifier: string = ""): Recallable =
  ## getFunction
  ## Returns information about the function or function version, with a link to download the deployment package that's valid for 10 minutes. If you specify a function version, only details that are specific to that version are returned.
  ##   FunctionName: string (required)
  ...
  add(path_593211, "FunctionName", newJString(FunctionName))
  add(query_593212, "Qualifier", newJString(Qualifier))
  result = call_593210.call(path_593211, query_593212, nil, nil, nil)

var getFunction* = Call_GetFunction_593197(name: "getFunction",
                                        meth: HttpMethod.HttpGet,
                                        host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}",
                                        validator: validate_GetFunction_593198,
                                        base: "/", url: url_GetFunction_593199,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteFunction_593213 = ref object of OpenApiRestCall_592364
proc url_DeleteFunction_593215(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteFunction_593214(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593216 = path.getOrDefault("FunctionName")
  valid_593216 = validateParameter(valid_593216, JString, required = true,
                                 default = nil)
  if valid_593216 != nil:
    section.add "FunctionName", valid_593216
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version to delete. You can't delete a version that's referenced by an alias.
  section = newJObject()
  var valid_593217 = query.getOrDefault("Qualifier")
  valid_593217 = validateParameter(valid_593217, JString, required = false,
                                 default = nil)
  if valid_593217 != nil:
    section.add "Qualifier", valid_593217
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593225: Call_DeleteFunction_593213; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a Lambda function. To delete a specific function version, use the <code>Qualifier</code> parameter. Otherwise, all versions and aliases are deleted.</p> <p>To delete Lambda event source mappings that invoke a function, use <a>DeleteEventSourceMapping</a>. For AWS services and resources that invoke your function directly, delete the trigger in the service where you originally configured it.</p>
  ## 
...
proc call*(call_593226: Call_DeleteFunction_593213; FunctionName: string;
          Qualifier: string = ""): Recallable =
  ## deleteFunction
  ## <p>Deletes a Lambda function. To delete a specific function version, use the <code>Qualifier</code> parameter. Otherwise, all versions and aliases are deleted.</p> <p>To delete Lambda event source mappings that invoke a function, use <a>DeleteEventSourceMapping</a>. For AWS services and resources that invoke your function directly, delete the trigger in the service where you originally configured it.</p>
  ##   FunctionName: string (required)
  ...
  var query_593228 = newJObject()
  add(path_593227, "FunctionName", newJString(FunctionName))
  add(query_593228, "Qualifier", newJString(Qualifier))
  result = call_593226.call(path_593227, query_593228, nil, nil, nil)

var deleteFunction* = Call_DeleteFunction_593213(name: "deleteFunction",
    meth: HttpMethod.HttpDelete, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}",
    validator: validate_DeleteFunction_593214, base: "/", url: url_DeleteFunction_593215,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutFunctionConcurrency_593229 = ref object of OpenApiRestCall_592364
proc url_PutFunctionConcurrency_593231(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutFunctionConcurrency_593230(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593232 = path.getOrDefault("FunctionName")
  valid_593232 = validateParameter(valid_593232, JString, required = true,
                                 default = nil)
  if valid_593232 != nil:
    section.add "FunctionName", valid_593232
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593241: Call_PutFunctionConcurrency_593229; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Sets the maximum number of simultaneous executions for a function, and reserves capacity for that concurrency level.</p> <p>Concurrency settings apply to the function as a whole, including all published versions and the unpublished version. Reserving concurrency both ensures that your function has capacity to process the specified number of events simultaneously, and prevents it from scaling beyond that level. Use <a>GetFunction</a> to see the current setting for a function.</p> <p>Use <a>GetAccountSettings</a> to see your regional concurrency limit. You can reserve concurrency for as many functions as you like, as long as you leave at least 100 simultaneous executions unreserved for functions that aren't configured with a per-function limit. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/concurrent-executions.html">Managing Concurrency</a>.</p>
  ## 
...
proc call*(call_593242: Call_PutFunctionConcurrency_593229; FunctionName: string;
          body: JsonNode): Recallable =
  ...
  add(path_593243, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593244 = body
  result = call_593242.call(path_593243, nil, nil, nil, body_593244)

var putFunctionConcurrency* = Call_PutFunctionConcurrency_593229(
    name: "putFunctionConcurrency", meth: HttpMethod.HttpPut,
    host: "lambda.amazonaws.com",
    route: "/2017-10-31/functions/{FunctionName}/concurrency",
    validator: validate_PutFunctionConcurrency_593230, base: "/",
    url: url_PutFunctionConcurrency_593231, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteFunctionConcurrency_593245 = ref object of OpenApiRestCall_592364
proc url_DeleteFunctionConcurrency_593247(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteFunctionConcurrency_593246(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593248 = path.getOrDefault("FunctionName")
  valid_593248 = validateParameter(valid_593248, JString, required = true,
                                 default = nil)
  if valid_593248 != nil:
    section.add "FunctionName", valid_593248
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593256: Call_DeleteFunctionConcurrency_593245; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a concurrent execution limit from a function.
  ## 
...
proc call*(call_593257: Call_DeleteFunctionConcurrency_593245; FunctionName: string): Recallable =
  ## deleteFunctionConcurrency
  ## Removes a concurrent execution limit from a function.
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>my-function</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:my-function</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:my-function</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  var path_593258 = newJObject()
  add(path_593258, "FunctionName", newJString(FunctionName))
  result = call_593257.call(path_593258, nil, nil, nil, nil)

var deleteFunctionConcurrency* = Call_DeleteFunctionConcurrency_593245(
    name: "deleteFunctionConcurrency", meth: HttpMethod.HttpDelete,
    host: "lambda.amazonaws.com",
    route: "/2017-10-31/functions/{FunctionName}/concurrency",
    validator: validate_DeleteFunctionConcurrency_593246, base: "/",
    url: url_DeleteFunctionConcurrency_593247,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLayerVersion_593259 = ref object of OpenApiRestCall_592364
proc url_GetLayerVersion_593261(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetLayerVersion_593260(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `VersionNumber` field"
  var valid_593262 = path.getOrDefault("VersionNumber")
  valid_593262 = validateParameter(valid_593262, JInt, required = true, default = nil)
  if valid_593262 != nil:
    section.add "VersionNumber", valid_593262
  var valid_593263 = path.getOrDefault("LayerName")
  valid_593263 = validateParameter(valid_593263, JString, required = true,
                                 default = nil)
  if valid_593263 != nil:
    section.add "LayerName", valid_593263
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593271: Call_GetLayerVersion_593259; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>, with a link to download the layer archive that's valid for 10 minutes.
  ## 
...
proc call*(call_593272: Call_GetLayerVersion_593259; VersionNumber: int;
          LayerName: string): Recallable =
  ## getLayerVersion
  ## Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>, with a link to download the layer archive that's valid for 10 minutes.
  ##   VersionNumber: int (required)
  ...
  add(path_593273, "VersionNumber", newJInt(VersionNumber))
  add(path_593273, "LayerName", newJString(LayerName))
  result = call_593272.call(path_593273, nil, nil, nil, nil)

var getLayerVersion* = Call_GetLayerVersion_593259(name: "getLayerVersion",
    meth: HttpMethod.HttpGet, host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers/{LayerName}/versions/{VersionNumber}",
    validator: validate_GetLayerVersion_593260, base: "/", url: url_GetLayerVersion_593261,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteLayerVersion_593274 = ref object of OpenApiRestCall_592364
proc url_DeleteLayerVersion_593276(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteLayerVersion_593275(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `VersionNumber` field"
  var valid_593277 = path.getOrDefault("VersionNumber")
  valid_593277 = validateParameter(valid_593277, JInt, required = true, default = nil)
  if valid_593277 != nil:
    section.add "VersionNumber", valid_593277
  var valid_593278 = path.getOrDefault("LayerName")
  valid_593278 = validateParameter(valid_593278, JString, required = true,
                                 default = nil)
  if valid_593278 != nil:
    section.add "LayerName", valid_593278
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593286: Call_DeleteLayerVersion_593274; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>. Deleted versions can no longer be viewed or added to functions. To avoid breaking functions, a copy of the version remains in Lambda until no functions refer to it.
  ## 
...
proc call*(call_593287: Call_DeleteLayerVersion_593274; VersionNumber: int;
          LayerName: string): Recallable =
  ## deleteLayerVersion
  ## Deletes a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>. Deleted versions can no longer be viewed or added to functions. To avoid breaking functions, a copy of the version remains in Lambda until no functions refer to it.
  ##   VersionNumber: int (required)
  ...
  add(path_593288, "VersionNumber", newJInt(VersionNumber))
  add(path_593288, "LayerName", newJString(LayerName))
  result = call_593287.call(path_593288, nil, nil, nil, nil)

var deleteLayerVersion* = Call_DeleteLayerVersion_593274(
    name: "deleteLayerVersion", meth: HttpMethod.HttpDelete,
    host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers/{LayerName}/versions/{VersionNumber}",
    validator: validate_DeleteLayerVersion_593275, base: "/",
    url: url_DeleteLayerVersion_593276, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAccountSettings_593289 = ref object of OpenApiRestCall_592364
proc url_GetAccountSettings_593291(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAccountSettings_593290(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_593299: Call_GetAccountSettings_593289; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves details about your account's <a href="https://docs.aws.amazon.com/lambda/latest/dg/limits.html">limits</a> and usage in an AWS Region.
  ## 
...
proc call*(call_593300: Call_GetAccountSettings_593289): Recallable =
  ## getAccountSettings
  ## Retrieves details about your account's <a href="https://docs.aws.amazon.com/lambda/latest/dg/limits.html">limits</a> and usage in an AWS Region.
  result = call_593300.call(nil, nil, nil, nil, nil)

var getAccountSettings* = Call_GetAccountSettings_593289(
    name: "getAccountSettings", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com", route: "/2016-08-19/account-settings/",
    validator: validate_GetAccountSettings_593290, base: "/",
    url: url_GetAccountSettings_593291, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateFunctionConfiguration_593317 = ref object of OpenApiRestCall_592364
proc url_UpdateFunctionConfiguration_593319(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateFunctionConfiguration_593318(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593320 = path.getOrDefault("FunctionName")
  valid_593320 = validateParameter(valid_593320, JString, required = true,
                                 default = nil)
  if valid_593320 != nil:
    section.add "FunctionName", valid_593320
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593329: Call_UpdateFunctionConfiguration_593317; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modify the version-specific settings of a Lambda function.</p> <p>These settings can vary between versions of a function and are locked when you publish a version. You can't modify the configuration of a published version, only the unpublished version.</p> <p>To configure function concurrency, use <a>PutFunctionConcurrency</a>. To grant invoke permissions to an account or AWS service, use <a>AddPermission</a>.</p>
  ## 
...
proc call*(call_593330: Call_UpdateFunctionConfiguration_593317;
  ...
  add(path_593331, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593332 = body
  result = call_593330.call(path_593331, nil, nil, nil, body_593332)

var updateFunctionConfiguration* = Call_UpdateFunctionConfiguration_593317(
    name: "updateFunctionConfiguration", meth: HttpMethod.HttpPut,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/configuration",
    validator: validate_UpdateFunctionConfiguration_593318, base: "/",
    url: url_UpdateFunctionConfiguration_593319,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetFunctionConfiguration_593301 = ref object of OpenApiRestCall_592364
proc url_GetFunctionConfiguration_593303(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetFunctionConfiguration_593302(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593304 = path.getOrDefault("FunctionName")
  valid_593304 = validateParameter(valid_593304, JString, required = true,
                                 default = nil)
  if valid_593304 != nil:
    section.add "FunctionName", valid_593304
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version or alias to get details about a published version of the function.
  section = newJObject()
  var valid_593305 = query.getOrDefault("Qualifier")
  valid_593305 = validateParameter(valid_593305, JString, required = false,
                                 default = nil)
  if valid_593305 != nil:
    section.add "Qualifier", valid_593305
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593313: Call_GetFunctionConfiguration_593301; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the version-specific settings of a Lambda function or version. The output includes only options that can vary between versions of a function. To modify these settings, use <a>UpdateFunctionConfiguration</a>.</p> <p>To get all of a function's details, including function-level settings, use <a>GetFunction</a>.</p>
  ## 
...
proc call*(call_593314: Call_GetFunctionConfiguration_593301; FunctionName: string;
          Qualifier: string = ""): Recallable =
  ...
  add(path_593315, "FunctionName", newJString(FunctionName))
  add(query_593316, "Qualifier", newJString(Qualifier))
  result = call_593314.call(path_593315, query_593316, nil, nil, nil)

var getFunctionConfiguration* = Call_GetFunctionConfiguration_593301(
    name: "getFunctionConfiguration", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/configuration",
    validator: validate_GetFunctionConfiguration_593302, base: "/",
    url: url_GetFunctionConfiguration_593303, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLayerVersionByArn_593333 = ref object of OpenApiRestCall_592364
proc url_GetLayerVersionByArn_593335(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetLayerVersionByArn_593334(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>, with a link to download the layer archive that's valid for 10 minutes.
  ## 
  var section: JsonNode
...
proc call*(call_593358: Call_GetLayerVersionByArn_593333; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>, with a link to download the layer archive that's valid for 10 minutes.
  ## 
...
proc call*(call_593359: Call_GetLayerVersionByArn_593333; Arn: string;
  ...
  add(query_593360, "find", newJString(find))
  add(query_593360, "Arn", newJString(Arn))
  result = call_593359.call(nil, query_593360, nil, nil, nil)

var getLayerVersionByArn* = Call_GetLayerVersionByArn_593333(
    name: "getLayerVersionByArn", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers#find=LayerVersion&Arn",
    validator: validate_GetLayerVersionByArn_593334, base: "/",
    url: url_GetLayerVersionByArn_593335, schemes: {Scheme.Https, Scheme.Http})
type
  Call_Invoke_593361 = ref object of OpenApiRestCall_592364
proc url_Invoke_593363(protocol: Scheme; host: string; base: string; route: string;
                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_Invoke_593362(path: JsonNode; query: JsonNode; header: JsonNode;
                           formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593364 = path.getOrDefault("FunctionName")
  valid_593364 = validateParameter(valid_593364, JString, required = true,
                                 default = nil)
  if valid_593364 != nil:
    section.add "FunctionName", valid_593364
  result.add "path", section
  ## parameters in `query` object:
  ##   Qualifier: JString
  ##            : Specify a version or alias to invoke a published version of the function.
  section = newJObject()
  var valid_593365 = query.getOrDefault("Qualifier")
  valid_593365 = validateParameter(valid_593365, JString, required = false,
                                 default = nil)
  if valid_593365 != nil:
    section.add "Qualifier", valid_593365
  result.add "query", section
  ## parameters in `header` object:
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593366 = header.getOrDefault("X-Amz-Invocation-Type")
  valid_593366 = validateParameter(valid_593366, JString, required = false,
                                 default = newJString("Event"))
  if valid_593366 != nil:
    section.add "X-Amz-Invocation-Type", valid_593366
  ...
  var valid_593368 = header.getOrDefault("X-Amz-Client-Context")
  valid_593368 = validateParameter(valid_593368, JString, required = false,
                                 default = nil)
  if valid_593368 != nil:
    section.add "X-Amz-Client-Context", valid_593368
  ...
  var valid_593373 = header.getOrDefault("X-Amz-Log-Type")
  valid_593373 = validateParameter(valid_593373, JString, required = false,
                                 default = newJString("None"))
  if valid_593373 != nil:
    section.add "X-Amz-Log-Type", valid_593373
...
proc call*(call_593377: Call_Invoke_593361; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Invokes a Lambda function. You can invoke a function synchronously (and wait for the response), or asynchronously. To invoke a function asynchronously, set <code>InvocationType</code> to <code>Event</code>.</p> <p>For synchronous invocation, details about the function response, including errors, are included in the response body and headers. For either invocation type, you can find more information in the <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-functions.html">execution log</a> and <a href="https://docs.aws.amazon.com/lambda/latest/dg/dlq.html">trace</a>. To record function errors for asynchronous invocations, configure your function with a <a href="https://docs.aws.amazon.com/lambda/latest/dg/dlq.html">dead letter queue</a>.</p> <p>When an error occurs, your function may be invoked multiple times. Retry behavior varies by error type, client, event source, and invocation type. For example, if you invoke a function asynchronously and it returns an error, Lambda executes the function up to two more times. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/retries-on-errors.html">Retry Behavior</a>.</p> <p>The status code in the API response doesn't reflect function errors. Error codes are reserved for errors that prevent your function from executing, such as permissions errors, <a href="https://docs.aws.amazon.com/lambda/latest/dg/limits.html">limit errors</a>, or issues with your function's code and configuration. For example, Lambda returns <code>TooManyRequestsException</code> if executing the function would cause you to exceed a concurrency limit at either the account level (<code>ConcurrentInvocationLimitExceeded</code>) or function level (<code>ReservedFunctionConcurrentInvocationLimitExceeded</code>).</p> <p>For functions with a long timeout, your client might be disconnected during synchronous invocation while it waits for a response. Configure your HTTP client, SDK, firewall, proxy, or operating system to allow for long connections with timeout or keep-alive settings.</p> <p>This operation requires permission for the <code>lambda:InvokeFunction</code> action.</p>
  ## 
...
proc call*(call_593378: Call_Invoke_593361; FunctionName: string; body: JsonNode;
          Qualifier: string = ""): Recallable =
  ## invoke
  ## <p>Invokes a Lambda function. You can invoke a function synchronously (and wait for the response), or asynchronously. To invoke a function asynchronously, set <code>InvocationType</code> to <code>Event</code>.</p> <p>For synchronous invocation, details about the function response, including errors, are included in the response body and headers. For either invocation type, you can find more information in the <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-functions.html">execution log</a> and <a href="https://docs.aws.amazon.com/lambda/latest/dg/dlq.html">trace</a>. To record function errors for asynchronous invocations, configure your function with a <a href="https://docs.aws.amazon.com/lambda/latest/dg/dlq.html">dead letter queue</a>.</p> <p>When an error occurs, your function may be invoked multiple times. Retry behavior varies by error type, client, event source, and invocation type. For example, if you invoke a function asynchronously and it returns an error, Lambda executes the function up to two more times. For more information, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/retries-on-errors.html">Retry Behavior</a>.</p> <p>The status code in the API response doesn't reflect function errors. Error codes are reserved for errors that prevent your function from executing, such as permissions errors, <a href="https://docs.aws.amazon.com/lambda/latest/dg/limits.html">limit errors</a>, or issues with your function's code and configuration. For example, Lambda returns <code>TooManyRequestsException</code> if executing the function would cause you to exceed a concurrency limit at either the account level (<code>ConcurrentInvocationLimitExceeded</code>) or function level (<code>ReservedFunctionConcurrentInvocationLimitExceeded</code>).</p> <p>For functions with a long timeout, your client might be disconnected during synchronous invocation while it waits for a response. Configure your HTTP client, SDK, firewall, proxy, or operating system to allow for long connections with timeout or keep-alive settings.</p> <p>This operation requires permission for the <code>lambda:InvokeFunction</code> action.</p>
  ##   FunctionName: string (required)
  ...
  ##            : Specify a version or alias to invoke a published version of the function.
  ##   body: JObject (required)
  var path_593379 = newJObject()
  var query_593380 = newJObject()
  var body_593381 = newJObject()
  add(path_593379, "FunctionName", newJString(FunctionName))
  add(query_593380, "Qualifier", newJString(Qualifier))
  if body != nil:
    body_593381 = body
  result = call_593378.call(path_593379, query_593380, nil, nil, body_593381)

var invoke* = Call_Invoke_593361(name: "invoke", meth: HttpMethod.HttpPost,
                              host: "lambda.amazonaws.com", route: "/2015-03-31/functions/{FunctionName}/invocations",
                              validator: validate_Invoke_593362, base: "/",
                              url: url_Invoke_593363,
                              schemes: {Scheme.Https, Scheme.Http})
type
  Call_InvokeAsync_593382 = ref object of OpenApiRestCall_592364
proc url_InvokeAsync_593384(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InvokeAsync_593383(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593385 = path.getOrDefault("FunctionName")
  valid_593385 = validateParameter(valid_593385, JString, required = true,
                                 default = nil)
  if valid_593385 != nil:
    section.add "FunctionName", valid_593385
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593394: Call_InvokeAsync_593382; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <important> <p>For asynchronous function invocation, use <a>Invoke</a>.</p> </important> <p>Invokes a function asynchronously.</p>
  ## 
...
proc call*(call_593395: Call_InvokeAsync_593382; FunctionName: string; body: JsonNode): Recallable =
  ## invokeAsync
  ## <important> <p>For asynchronous function invocation, use <a>Invoke</a>.</p> </important> <p>Invokes a function asynchronously.</p>
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>my-function</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:my-function</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:my-function</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  ...
  var body_593397 = newJObject()
  add(path_593396, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593397 = body
  result = call_593395.call(path_593396, nil, nil, nil, body_593397)

var invokeAsync* = Call_InvokeAsync_593382(name: "invokeAsync",
                                        meth: HttpMethod.HttpPost,
                                        host: "lambda.amazonaws.com", route: "/2014-11-13/functions/{FunctionName}/invoke-async/",
                                        validator: validate_InvokeAsync_593383,
                                        base: "/", url: url_InvokeAsync_593384,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListFunctions_593398 = ref object of OpenApiRestCall_592364
proc url_ListFunctions_593400(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListFunctions_593399(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_593401 = query.getOrDefault("Marker")
  valid_593401 = validateParameter(valid_593401, JString, required = false,
                                 default = nil)
  if valid_593401 != nil:
    section.add "Marker", valid_593401
  var valid_593402 = query.getOrDefault("FunctionVersion")
  valid_593402 = validateParameter(valid_593402, JString, required = false,
                                 default = newJString("ALL"))
  if valid_593402 != nil:
    section.add "FunctionVersion", valid_593402
  var valid_593403 = query.getOrDefault("MaxItems")
  valid_593403 = validateParameter(valid_593403, JInt, required = false, default = nil)
  if valid_593403 != nil:
    section.add "MaxItems", valid_593403
  var valid_593404 = query.getOrDefault("MasterRegion")
  valid_593404 = validateParameter(valid_593404, JString, required = false,
                                 default = nil)
  if valid_593404 != nil:
    section.add "MasterRegion", valid_593404
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593412: Call_ListFunctions_593398; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns a list of Lambda functions, with the version-specific configuration of each.</p> <p>Set <code>FunctionVersion</code> to <code>ALL</code> to include all published versions of each function in addition to the unpublished version. To get more information about a function or version, use <a>GetFunction</a>.</p>
  ## 
...
proc call*(call_593413: Call_ListFunctions_593398; Marker: string = "";
  ...
  ##   MasterRegion: string
  ##               : For Lambda@Edge functions, the AWS Region of the master function. For example, <code>us-east-2</code> or <code>ALL</code>. If specified, you must set <code>FunctionVersion</code> to <code>ALL</code>.
  var query_593414 = newJObject()
  add(query_593414, "Marker", newJString(Marker))
  add(query_593414, "FunctionVersion", newJString(FunctionVersion))
  add(query_593414, "MaxItems", newJInt(MaxItems))
  add(query_593414, "MasterRegion", newJString(MasterRegion))
  result = call_593413.call(nil, query_593414, nil, nil, nil)

var listFunctions* = Call_ListFunctions_593398(name: "listFunctions",
    meth: HttpMethod.HttpGet, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/", validator: validate_ListFunctions_593399,
    base: "/", url: url_ListFunctions_593400, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishLayerVersion_593433 = ref object of OpenApiRestCall_592364
proc url_PublishLayerVersion_593435(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishLayerVersion_593434(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_593436 = path.getOrDefault("LayerName")
  valid_593436 = validateParameter(valid_593436, JString, required = true,
                                 default = nil)
  if valid_593436 != nil:
    section.add "LayerName", valid_593436
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593445: Call_PublishLayerVersion_593433; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a> from a ZIP archive. Each time you call <code>PublishLayerVersion</code> with the same version name, a new version is created.</p> <p>Add layers to your function with <a>CreateFunction</a> or <a>UpdateFunctionConfiguration</a>.</p>
  ## 
...
proc call*(call_593446: Call_PublishLayerVersion_593433; LayerName: string;
          body: JsonNode): Recallable =
  ## publishLayerVersion
  ## <p>Creates an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a> from a ZIP archive. Each time you call <code>PublishLayerVersion</code> with the same version name, a new version is created.</p> <p>Add layers to your function with <a>CreateFunction</a> or <a>UpdateFunctionConfiguration</a>.</p>
  ##   LayerName: string (required)
  ...
  add(path_593447, "LayerName", newJString(LayerName))
  if body != nil:
    body_593448 = body
  result = call_593446.call(path_593447, nil, nil, nil, body_593448)

var publishLayerVersion* = Call_PublishLayerVersion_593433(
    name: "publishLayerVersion", meth: HttpMethod.HttpPost,
    host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers/{LayerName}/versions",
    validator: validate_PublishLayerVersion_593434, base: "/",
    url: url_PublishLayerVersion_593435, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListLayerVersions_593415 = ref object of OpenApiRestCall_592364
proc url_ListLayerVersions_593417(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListLayerVersions_593416(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `LayerName` field"
  var valid_593418 = path.getOrDefault("LayerName")
  valid_593418 = validateParameter(valid_593418, JString, required = true,
                                 default = nil)
  if valid_593418 != nil:
    section.add "LayerName", valid_593418
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ##         : A pagination token returned by a previous call.
  ...
  section = newJObject()
  var valid_593419 = query.getOrDefault("Marker")
  valid_593419 = validateParameter(valid_593419, JString, required = false,
                                 default = nil)
  if valid_593419 != nil:
    section.add "Marker", valid_593419
  var valid_593420 = query.getOrDefault("CompatibleRuntime")
  valid_593420 = validateParameter(valid_593420, JString, required = false,
                                 default = newJString("nodejs"))
  if valid_593420 != nil:
    section.add "CompatibleRuntime", valid_593420
  var valid_593421 = query.getOrDefault("MaxItems")
  valid_593421 = validateParameter(valid_593421, JInt, required = false, default = nil)
  if valid_593421 != nil:
    section.add "MaxItems", valid_593421
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593429: Call_ListLayerVersions_593415; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the versions of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>. Versions that have been deleted aren't listed. Specify a <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html">runtime identifier</a> to list only versions that indicate that they're compatible with that runtime.
  ## 
...
proc call*(call_593430: Call_ListLayerVersions_593415; LayerName: string;
  ...
  add(query_593432, "Marker", newJString(Marker))
  add(query_593432, "CompatibleRuntime", newJString(CompatibleRuntime))
  add(query_593432, "MaxItems", newJInt(MaxItems))
  add(path_593431, "LayerName", newJString(LayerName))
  result = call_593430.call(path_593431, query_593432, nil, nil, nil)

var listLayerVersions* = Call_ListLayerVersions_593415(name: "listLayerVersions",
    meth: HttpMethod.HttpGet, host: "lambda.amazonaws.com",
    route: "/2018-10-31/layers/{LayerName}/versions",
    validator: validate_ListLayerVersions_593416, base: "/",
    url: url_ListLayerVersions_593417, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListLayers_593449 = ref object of OpenApiRestCall_592364
proc url_ListLayers_593451(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListLayers_593450(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_593452 = query.getOrDefault("Marker")
  valid_593452 = validateParameter(valid_593452, JString, required = false,
                                 default = nil)
  if valid_593452 != nil:
    section.add "Marker", valid_593452
  var valid_593453 = query.getOrDefault("CompatibleRuntime")
  valid_593453 = validateParameter(valid_593453, JString, required = false,
                                 default = newJString("nodejs"))
  if valid_593453 != nil:
    section.add "CompatibleRuntime", valid_593453
  var valid_593454 = query.getOrDefault("MaxItems")
  valid_593454 = validateParameter(valid_593454, JInt, required = false, default = nil)
  if valid_593454 != nil:
    section.add "MaxItems", valid_593454
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593462: Call_ListLayers_593449; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layers</a> and shows information about the latest version of each. Specify a <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html">runtime identifier</a> to list only layers that indicate that they're compatible with that runtime.
  ## 
...
proc call*(call_593463: Call_ListLayers_593449; Marker: string = "";
  ...
  add(query_593464, "Marker", newJString(Marker))
  add(query_593464, "CompatibleRuntime", newJString(CompatibleRuntime))
  add(query_593464, "MaxItems", newJInt(MaxItems))
  result = call_593463.call(nil, query_593464, nil, nil, nil)

var listLayers* = Call_ListLayers_593449(name: "listLayers",
                                      meth: HttpMethod.HttpGet,
                                      host: "lambda.amazonaws.com",
                                      route: "/2018-10-31/layers",
                                      validator: validate_ListLayers_593450,
                                      base: "/", url: url_ListLayers_593451,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_593479 = ref object of OpenApiRestCall_592364
proc url_TagResource_593481(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_593480(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593482 = path.getOrDefault("ARN")
  valid_593482 = validateParameter(valid_593482, JString, required = true,
                                 default = nil)
  if valid_593482 != nil:
    section.add "ARN", valid_593482
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593491: Call_TagResource_593479; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> to a function.
  ## 
...
proc call*(call_593492: Call_TagResource_593479; ARN: string; body: JsonNode): Recallable =
  ## tagResource
  ## Adds <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> to a function.
  ##   ARN: string (required)
  ##      : The function's Amazon Resource Name (ARN).
  ##   body: JObject (required)
  var path_593493 = newJObject()
  var body_593494 = newJObject()
  add(path_593493, "ARN", newJString(ARN))
  if body != nil:
    body_593494 = body
  result = call_593492.call(path_593493, nil, nil, nil, body_593494)

var tagResource* = Call_TagResource_593479(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "lambda.amazonaws.com",
                                        route: "/2017-03-31/tags/{ARN}",
                                        validator: validate_TagResource_593480,
                                        base: "/", url: url_TagResource_593481,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTags_593465 = ref object of OpenApiRestCall_592364
proc url_ListTags_593467(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTags_593466(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `ARN` field"
  var valid_593468 = path.getOrDefault("ARN")
  valid_593468 = validateParameter(valid_593468, JString, required = true,
                                 default = nil)
  if valid_593468 != nil:
    section.add "ARN", valid_593468
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593476: Call_ListTags_593465; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a>. You can also view tags with <a>GetFunction</a>.
  ## 
...
proc call*(call_593477: Call_ListTags_593465; ARN: string): Recallable =
  ## listTags
  ## Returns a function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a>. You can also view tags with <a>GetFunction</a>.
  ##   ARN: string (required)
  ##      : The function's Amazon Resource Name (ARN).
  var path_593478 = newJObject()
  add(path_593478, "ARN", newJString(ARN))
  result = call_593477.call(path_593478, nil, nil, nil, nil)

var listTags* = Call_ListTags_593465(name: "listTags", meth: HttpMethod.HttpGet,
                                  host: "lambda.amazonaws.com",
                                  route: "/2017-03-31/tags/{ARN}",
                                  validator: validate_ListTags_593466, base: "/",
                                  url: url_ListTags_593467,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishVersion_593512 = ref object of OpenApiRestCall_592364
proc url_PublishVersion_593514(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishVersion_593513(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593515 = path.getOrDefault("FunctionName")
  valid_593515 = validateParameter(valid_593515, JString, required = true,
                                 default = nil)
  if valid_593515 != nil:
    section.add "FunctionName", valid_593515
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593524: Call_PublishVersion_593512; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">version</a> from the current code and configuration of a function. Use versions to create a snapshot of your function code and configuration that doesn't change.</p> <p>AWS Lambda doesn't publish a version if the function's configuration and code haven't changed since the last version. Use <a>UpdateFunctionCode</a> or <a>UpdateFunctionConfiguration</a> to update the function before publishing a version.</p> <p>Clients can invoke versions directly or with an alias. To create an alias, use <a>CreateAlias</a>.</p>
  ## 
...
proc call*(call_593525: Call_PublishVersion_593512; FunctionName: string;
          body: JsonNode): Recallable =
  ## publishVersion
  ## <p>Creates a <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">version</a> from the current code and configuration of a function. Use versions to create a snapshot of your function code and configuration that doesn't change.</p> <p>AWS Lambda doesn't publish a version if the function's configuration and code haven't changed since the last version. Use <a>UpdateFunctionCode</a> or <a>UpdateFunctionConfiguration</a> to update the function before publishing a version.</p> <p>Clients can invoke versions directly or with an alias. To create an alias, use <a>CreateAlias</a>.</p>
  ##   FunctionName: string (required)
  ...
  add(path_593526, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593527 = body
  result = call_593525.call(path_593526, nil, nil, nil, body_593527)

var publishVersion* = Call_PublishVersion_593512(name: "publishVersion",
    meth: HttpMethod.HttpPost, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/versions",
    validator: validate_PublishVersion_593513, base: "/", url: url_PublishVersion_593514,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListVersionsByFunction_593495 = ref object of OpenApiRestCall_592364
proc url_ListVersionsByFunction_593497(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListVersionsByFunction_593496(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593498 = path.getOrDefault("FunctionName")
  valid_593498 = validateParameter(valid_593498, JString, required = true,
                                 default = nil)
  if valid_593498 != nil:
    section.add "FunctionName", valid_593498
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ##         : Specify the pagination token that's returned by a previous request to retrieve the next page of results.
  ...
  var valid_593500 = query.getOrDefault("MaxItems")
  valid_593500 = validateParameter(valid_593500, JInt, required = false, default = nil)
  if valid_593500 != nil:
    section.add "MaxItems", valid_593500
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593508: Call_ListVersionsByFunction_593495; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of <a href="https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">versions</a>, with the version-specific configuration of each. 
  ## 
...
proc call*(call_593509: Call_ListVersionsByFunction_593495; FunctionName: string;
  ...
  add(query_593511, "Marker", newJString(Marker))
  add(path_593510, "FunctionName", newJString(FunctionName))
  add(query_593511, "MaxItems", newJInt(MaxItems))
  result = call_593509.call(path_593510, query_593511, nil, nil, nil)

var listVersionsByFunction* = Call_ListVersionsByFunction_593495(
    name: "listVersionsByFunction", meth: HttpMethod.HttpGet,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/versions",
    validator: validate_ListVersionsByFunction_593496, base: "/",
    url: url_ListVersionsByFunction_593497, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveLayerVersionPermission_593528 = ref object of OpenApiRestCall_592364
proc url_RemoveLayerVersionPermission_593530(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveLayerVersionPermission_593529(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `VersionNumber` field"
  var valid_593531 = path.getOrDefault("VersionNumber")
  valid_593531 = validateParameter(valid_593531, JInt, required = true, default = nil)
  if valid_593531 != nil:
    section.add "VersionNumber", valid_593531
  var valid_593532 = path.getOrDefault("StatementId")
  valid_593532 = validateParameter(valid_593532, JString, required = true,
                                 default = nil)
  if valid_593532 != nil:
    section.add "StatementId", valid_593532
  var valid_593533 = path.getOrDefault("LayerName")
  valid_593533 = validateParameter(valid_593533, JString, required = true,
                                 default = nil)
  if valid_593533 != nil:
    section.add "LayerName", valid_593533
  result.add "path", section
  ## parameters in `query` object:
  ##   RevisionId: JString
  ##             : Only update the policy if the revision ID matches the ID specified. Use this option to avoid modifying a policy that has changed since you last read it.
  section = newJObject()
  var valid_593534 = query.getOrDefault("RevisionId")
  valid_593534 = validateParameter(valid_593534, JString, required = false,
                                 default = nil)
  if valid_593534 != nil:
    section.add "RevisionId", valid_593534
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593542: Call_RemoveLayerVersionPermission_593528; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a statement from the permissions policy for a version of an <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html">AWS Lambda layer</a>. For more information, see <a>AddLayerVersionPermission</a>.
  ## 
...
proc call*(call_593543: Call_RemoveLayerVersionPermission_593528;
  ...
  add(query_593545, "RevisionId", newJString(RevisionId))
  add(path_593544, "VersionNumber", newJInt(VersionNumber))
  add(path_593544, "StatementId", newJString(StatementId))
  add(path_593544, "LayerName", newJString(LayerName))
  result = call_593543.call(path_593544, query_593545, nil, nil, nil)

var removeLayerVersionPermission* = Call_RemoveLayerVersionPermission_593528(
    ...
    validator: validate_RemoveLayerVersionPermission_593529, base: "/",
    url: url_RemoveLayerVersionPermission_593530,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemovePermission_593546 = ref object of OpenApiRestCall_592364
proc url_RemovePermission_593548(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemovePermission_593547(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593549 = path.getOrDefault("FunctionName")
  valid_593549 = validateParameter(valid_593549, JString, required = true,
                                 default = nil)
  if valid_593549 != nil:
    section.add "FunctionName", valid_593549
  var valid_593550 = path.getOrDefault("StatementId")
  valid_593550 = validateParameter(valid_593550, JString, required = true,
                                 default = nil)
  if valid_593550 != nil:
    section.add "StatementId", valid_593550
  result.add "path", section
  ## parameters in `query` object:
  ##   RevisionId: JString
  ...
  section = newJObject()
  var valid_593551 = query.getOrDefault("RevisionId")
  valid_593551 = validateParameter(valid_593551, JString, required = false,
                                 default = nil)
  if valid_593551 != nil:
    section.add "RevisionId", valid_593551
  var valid_593552 = query.getOrDefault("Qualifier")
  valid_593552 = validateParameter(valid_593552, JString, required = false,
                                 default = nil)
  if valid_593552 != nil:
    section.add "Qualifier", valid_593552
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593560: Call_RemovePermission_593546; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Revokes function-use permission from an AWS service or another account. You can get the ID of the statement from the output of <a>GetPolicy</a>.
  ## 
...
proc call*(call_593561: Call_RemovePermission_593546; FunctionName: string;
  ...
  add(query_593563, "RevisionId", newJString(RevisionId))
  add(path_593562, "FunctionName", newJString(FunctionName))
  add(path_593562, "StatementId", newJString(StatementId))
  add(query_593563, "Qualifier", newJString(Qualifier))
  result = call_593561.call(path_593562, query_593563, nil, nil, nil)

var removePermission* = Call_RemovePermission_593546(name: "removePermission",
    meth: HttpMethod.HttpDelete, host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/policy/{StatementId}",
    validator: validate_RemovePermission_593547, base: "/",
    url: url_RemovePermission_593548, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_593564 = ref object of OpenApiRestCall_592364
proc url_UntagResource_593566(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_593565(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `ARN` field"
  var valid_593567 = path.getOrDefault("ARN")
  valid_593567 = validateParameter(valid_593567, JString, required = true,
                                 default = nil)
  if valid_593567 != nil:
    section.add "ARN", valid_593567
  result.add "path", section
  ## parameters in `query` object:
  ...
  var valid_593568 = query.getOrDefault("tagKeys")
  valid_593568 = validateParameter(valid_593568, JArray, required = true, default = nil)
  if valid_593568 != nil:
    section.add "tagKeys", valid_593568
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593576: Call_UntagResource_593564; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> from a function.
  ## 
...
proc call*(call_593577: Call_UntagResource_593564; ARN: string; tagKeys: JsonNode): Recallable =
  ## untagResource
  ## Removes <a href="https://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> from a function.
  ##   ARN: string (required)
  ##      : The function's Amazon Resource Name (ARN).
  ##   tagKeys: JArray (required)
  ##          : A list of tag keys to remove from the function.
  var path_593578 = newJObject()
  var query_593579 = newJObject()
  add(path_593578, "ARN", newJString(ARN))
  if tagKeys != nil:
    query_593579.add "tagKeys", tagKeys
  result = call_593577.call(path_593578, query_593579, nil, nil, nil)

var untagResource* = Call_UntagResource_593564(name: "untagResource",
    meth: HttpMethod.HttpDelete, host: "lambda.amazonaws.com",
    route: "/2017-03-31/tags/{ARN}#tagKeys", validator: validate_UntagResource_593565,
    base: "/", url: url_UntagResource_593566, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateFunctionCode_593580 = ref object of OpenApiRestCall_592364
proc url_UpdateFunctionCode_593582(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateFunctionCode_593581(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `FunctionName` field"
  var valid_593583 = path.getOrDefault("FunctionName")
  valid_593583 = validateParameter(valid_593583, JString, required = true,
                                 default = nil)
  if valid_593583 != nil:
    section.add "FunctionName", valid_593583
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593592: Call_UpdateFunctionCode_593580; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates a Lambda function's code.</p> <p>The function's code is locked when you publish a version. You can't modify the code of a published version, only the unpublished version.</p>
  ## 
  let valid = call_593592.validator(path, query, header, formData, body)
  let scheme = call_593592.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_593592.url(scheme.get, call_593592.host, call_593592.base,
                         call_593592.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_593592, url, valid)

proc call*(call_593593: Call_UpdateFunctionCode_593580; FunctionName: string;
          body: JsonNode): Recallable =
  ## updateFunctionCode
  ## <p>Updates a Lambda function's code.</p> <p>The function's code is locked when you publish a version. You can't modify the code of a published version, only the unpublished version.</p>
  ##   FunctionName: string (required)
  ##               : <p>The name of the Lambda function.</p> <p class="title"> <b>Name formats</b> </p> <ul> <li> <p> <b>Function name</b> - <code>my-function</code>.</p> </li> <li> <p> <b>Function ARN</b> - <code>arn:aws:lambda:us-west-2:123456789012:function:my-function</code>.</p> </li> <li> <p> <b>Partial ARN</b> - <code>123456789012:function:my-function</code>.</p> </li> </ul> <p>The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.</p>
  ##   body: JObject (required)
  var path_593594 = newJObject()
  var body_593595 = newJObject()
  add(path_593594, "FunctionName", newJString(FunctionName))
  if body != nil:
    body_593595 = body
  result = call_593593.call(path_593594, nil, nil, nil, body_593595)

var updateFunctionCode* = Call_UpdateFunctionCode_593580(
    name: "updateFunctionCode", meth: HttpMethod.HttpPut,
    host: "lambda.amazonaws.com",
    route: "/2015-03-31/functions/{FunctionName}/code",
    validator: validate_UpdateFunctionCode_593581, base: "/",
    url: url_UpdateFunctionCode_593582, schemes: {Scheme.Https, Scheme.Http})
export
  rest
