...
type
  Call_CreateIdentityPool_610996 = ref object of OpenApiRestCall_610658
proc url_CreateIdentityPool_610998(protocol: Scheme; host: string; base: string;
...
proc validate_CreateIdentityPool_610997(path: JsonNode; query: JsonNode;
...
proc call*(call_611154: Call_CreateIdentityPool_610996; path: JsonNode;
...
proc call*(call_611225: Call_CreateIdentityPool_610996; body: JsonNode): Recallable =
  ## createIdentityPool
  ## <p>Creates a new identity pool. The identity pool is a store of user identity information that is specific to your AWS account. The keys for <code>SupportedLoginProviders</code> are as follows:</p> <ul> <li> <p>Facebook: <code>graph.facebook.com</code> </p> </li> <li> <p>Google: <code>accounts.google.com</code> </p> </li> <li> <p>Amazon: <code>www.amazon.com</code> </p> </li> <li> <p>Twitter: <code>api.twitter.com</code> </p> </li> <li> <p>Digits: <code>www.digits.com</code> </p> </li> </ul> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var createIdentityPool* = Call_CreateIdentityPool_610996(
    ...
    validator: validate_CreateIdentityPool_610997, base: "/",
    url: url_CreateIdentityPool_610998, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIdentities_611265 = ref object of OpenApiRestCall_610658
proc url_DeleteIdentities_611267(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteIdentities_611266(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_611277: Call_DeleteIdentities_611265; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes identities from an identity pool. You can specify a list of 1-60 identities that you want to delete.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611278: Call_DeleteIdentities_611265; body: JsonNode): Recallable =
  ## deleteIdentities
  ## <p>Deletes identities from an identity pool. You can specify a list of 1-60 identities that you want to delete.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var deleteIdentities* = Call_DeleteIdentities_611265(name: "deleteIdentities",
    ...
    validator: validate_DeleteIdentities_611266, base: "/",
    url: url_DeleteIdentities_611267, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIdentityPool_611280 = ref object of OpenApiRestCall_610658
proc url_DeleteIdentityPool_611282(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteIdentityPool_611281(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_611292: Call_DeleteIdentityPool_611280; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes an identity pool. Once a pool is deleted, users will not be able to authenticate with the pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611293: Call_DeleteIdentityPool_611280; body: JsonNode): Recallable =
  ## deleteIdentityPool
  ## <p>Deletes an identity pool. Once a pool is deleted, users will not be able to authenticate with the pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var deleteIdentityPool* = Call_DeleteIdentityPool_611280(
    name: "deleteIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentityPool",
    validator: validate_DeleteIdentityPool_611281, base: "/",
    url: url_DeleteIdentityPool_611282, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIdentity_611295 = ref object of OpenApiRestCall_610658
proc url_DescribeIdentity_611297(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeIdentity_611296(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_611307: Call_DescribeIdentity_611295; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns metadata related to the given identity, including when the identity was created and any associated linked logins.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611308: Call_DescribeIdentity_611295; body: JsonNode): Recallable =
  ## describeIdentity
  ## <p>Returns metadata related to the given identity, including when the identity was created and any associated linked logins.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var describeIdentity* = Call_DescribeIdentity_611295(name: "describeIdentity",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentity",
    validator: validate_DescribeIdentity_611296, base: "/",
    url: url_DescribeIdentity_611297, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIdentityPool_611310 = ref object of OpenApiRestCall_610658
proc url_DescribeIdentityPool_611312(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeIdentityPool_611311(path: JsonNode; query: JsonNode;
...
proc call*(call_611322: Call_DescribeIdentityPool_611310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Gets details about a particular identity pool, including the pool name, ID description, creation date, and current number of users.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611323: Call_DescribeIdentityPool_611310; body: JsonNode): Recallable =
...
var describeIdentityPool* = Call_DescribeIdentityPool_611310(
    name: "describeIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentityPool",
    validator: validate_DescribeIdentityPool_611311, base: "/",
    url: url_DescribeIdentityPool_611312, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCredentialsForIdentity_611325 = ref object of OpenApiRestCall_610658
proc url_GetCredentialsForIdentity_611327(protocol: Scheme; host: string;
...
proc validate_GetCredentialsForIdentity_611326(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611337: Call_GetCredentialsForIdentity_611325; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns credentials for the provided identity ID. Any provided logins will be validated against supported login providers. If the token is for cognito-identity.amazonaws.com, it will be passed through to AWS Security Token Service with the appropriate role for the token.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ## 
...
proc call*(call_611338: Call_GetCredentialsForIdentity_611325; body: JsonNode): Recallable =
...
var getCredentialsForIdentity* = Call_GetCredentialsForIdentity_611325(
    ...
    validator: validate_GetCredentialsForIdentity_611326, base: "/",
    url: url_GetCredentialsForIdentity_611327,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetId_611340 = ref object of OpenApiRestCall_610658
proc url_GetId_611342(protocol: Scheme; host: string; base: string; route: string;
                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetId_611341(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_611352: Call_GetId_611340; path: JsonNode; query: JsonNode;
...
proc call*(call_611353: Call_GetId_611340; body: JsonNode): Recallable =
  ## getId
  ## <p>Generates (or retrieves) a Cognito ID. Supplying multiple logins will create an implicit linked account.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   body: JObject (required)
...
var getId* = Call_GetId_611340(name: "getId", meth: HttpMethod.HttpPost,
                            host: "cognito-identity.amazonaws.com", route: "/#X-Amz-Target=AWSCognitoIdentityService.GetId",
                            validator: validate_GetId_611341, base: "/",
                            url: url_GetId_611342,
                            schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetIdentityPoolRoles_611355 = ref object of OpenApiRestCall_610658
proc url_GetIdentityPoolRoles_611357(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetIdentityPoolRoles_611356(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611367: Call_GetIdentityPoolRoles_611355; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Gets the roles for an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611368: Call_GetIdentityPoolRoles_611355; body: JsonNode): Recallable =
...
var getIdentityPoolRoles* = Call_GetIdentityPoolRoles_611355(
    name: "getIdentityPoolRoles", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.GetIdentityPoolRoles",
    validator: validate_GetIdentityPoolRoles_611356, base: "/",
    url: url_GetIdentityPoolRoles_611357, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpenIdToken_611370 = ref object of OpenApiRestCall_610658
proc url_GetOpenIdToken_611372(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetOpenIdToken_611371(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611382: Call_GetOpenIdToken_611370; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Gets an OpenID token, using a known Cognito ID. This known Cognito ID is returned by <a>GetId</a>. You can optionally add additional logins for the identity. Supplying multiple logins creates an implicit link.</p> <p>The OpenId token is valid for 10 minutes.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ## 
...
proc call*(call_611383: Call_GetOpenIdToken_611370; body: JsonNode): Recallable =
  ## getOpenIdToken
  ## <p>Gets an OpenID token, using a known Cognito ID. This known Cognito ID is returned by <a>GetId</a>. You can optionally add additional logins for the identity. Supplying multiple logins creates an implicit link.</p> <p>The OpenId token is valid for 10 minutes.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   body: JObject (required)
...
var getOpenIdToken* = Call_GetOpenIdToken_611370(name: "getOpenIdToken",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdToken",
    validator: validate_GetOpenIdToken_611371, base: "/", url: url_GetOpenIdToken_611372,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpenIdTokenForDeveloperIdentity_611385 = ref object of OpenApiRestCall_610658
proc url_GetOpenIdTokenForDeveloperIdentity_611387(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetOpenIdTokenForDeveloperIdentity_611386(path: JsonNode;
...
proc call*(call_611397: Call_GetOpenIdTokenForDeveloperIdentity_611385;
...
proc call*(call_611398: Call_GetOpenIdTokenForDeveloperIdentity_611385;
          body: JsonNode): Recallable =
...
var getOpenIdTokenForDeveloperIdentity* = Call_GetOpenIdTokenForDeveloperIdentity_611385(
    ...
    validator: validate_GetOpenIdTokenForDeveloperIdentity_611386, base: "/",
    url: url_GetOpenIdTokenForDeveloperIdentity_611387,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIdentities_611400 = ref object of OpenApiRestCall_610658
proc url_ListIdentities_611402(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListIdentities_611401(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611412: Call_ListIdentities_611400; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the identities in an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611413: Call_ListIdentities_611400; body: JsonNode): Recallable =
  ## listIdentities
  ## <p>Lists the identities in an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var listIdentities* = Call_ListIdentities_611400(name: "listIdentities",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListIdentities",
    validator: validate_ListIdentities_611401, base: "/", url: url_ListIdentities_611402,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIdentityPools_611415 = ref object of OpenApiRestCall_610658
proc url_ListIdentityPools_611417(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListIdentityPools_611416(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_611427: Call_ListIdentityPools_611415; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all of the Cognito identity pools registered for your account.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611428: Call_ListIdentityPools_611415; body: JsonNode): Recallable =
  ## listIdentityPools
  ## <p>Lists all of the Cognito identity pools registered for your account.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var listIdentityPools* = Call_ListIdentityPools_611415(name: "listIdentityPools",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListIdentityPools",
    validator: validate_ListIdentityPools_611416, base: "/",
    url: url_ListIdentityPools_611417, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_611430 = ref object of OpenApiRestCall_610658
proc url_ListTagsForResource_611432(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_611431(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_611442: Call_ListTagsForResource_611430; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the tags that are assigned to an Amazon Cognito identity pool.</p> <p>A tag is a label that you can apply to identity pools to categorize and manage them in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>You can use this action up to 10 times per second, per account.</p>
  ## 
...
proc call*(call_611443: Call_ListTagsForResource_611430; body: JsonNode): Recallable =
  ## listTagsForResource
  ## <p>Lists the tags that are assigned to an Amazon Cognito identity pool.</p> <p>A tag is a label that you can apply to identity pools to categorize and manage them in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>You can use this action up to 10 times per second, per account.</p>
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_611430(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListTagsForResource",
    validator: validate_ListTagsForResource_611431, base: "/",
    url: url_ListTagsForResource_611432, schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupDeveloperIdentity_611445 = ref object of OpenApiRestCall_610658
proc url_LookupDeveloperIdentity_611447(protocol: Scheme; host: string; base: string;
...
proc validate_LookupDeveloperIdentity_611446(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611457: Call_LookupDeveloperIdentity_611445; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the <code>IdentityID</code> associated with a <code>DeveloperUserIdentifier</code> or the list of <code>DeveloperUserIdentifier</code> values associated with an <code>IdentityId</code> for an existing identity. Either <code>IdentityID</code> or <code>DeveloperUserIdentifier</code> must not be null. If you supply only one of these values, the other value will be searched in the database and returned as a part of the response. If you supply both, <code>DeveloperUserIdentifier</code> will be matched against <code>IdentityID</code>. If the values are verified against the database, the response returns both values and is the same as the request. Otherwise a <code>ResourceConflictException</code> is thrown.</p> <p> <code>LookupDeveloperIdentity</code> is intended for low-throughput control plane operations: for example, to enable customer service to locate an identity ID by username. If you are using it for higher-volume operations such as user authentication, your requests are likely to be throttled. <a>GetOpenIdTokenForDeveloperIdentity</a> is a better option for higher-volume operations for user authentication.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611458: Call_LookupDeveloperIdentity_611445; body: JsonNode): Recallable =
...
var lookupDeveloperIdentity* = Call_LookupDeveloperIdentity_611445(
    ...
    validator: validate_LookupDeveloperIdentity_611446, base: "/",
    url: url_LookupDeveloperIdentity_611447, schemes: {Scheme.Https, Scheme.Http})
type
  Call_MergeDeveloperIdentities_611460 = ref object of OpenApiRestCall_610658
proc url_MergeDeveloperIdentities_611462(protocol: Scheme; host: string;
...
proc validate_MergeDeveloperIdentities_611461(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611472: Call_MergeDeveloperIdentities_611460; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Merges two users having different <code>IdentityId</code>s, existing in the same identity pool, and identified by the same developer provider. You can use this action to request that discrete users be merged and identified as a single user in the Cognito environment. Cognito associates the given source user (<code>SourceUserIdentifier</code>) with the <code>IdentityId</code> of the <code>DestinationUserIdentifier</code>. Only developer-authenticated users can be merged. If the users to be merged are associated with the same public provider, but as two different users, an exception will be thrown.</p> <p>The number of linked logins is limited to 20. So, the number of linked logins for the source user, <code>SourceUserIdentifier</code>, and the destination user, <code>DestinationUserIdentifier</code>, together should not be larger than 20. Otherwise, an exception will be thrown.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611473: Call_MergeDeveloperIdentities_611460; body: JsonNode): Recallable =
...
var mergeDeveloperIdentities* = Call_MergeDeveloperIdentities_611460(
    ...
    validator: validate_MergeDeveloperIdentities_611461, base: "/",
    url: url_MergeDeveloperIdentities_611462, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SetIdentityPoolRoles_611475 = ref object of OpenApiRestCall_610658
proc url_SetIdentityPoolRoles_611477(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SetIdentityPoolRoles_611476(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611487: Call_SetIdentityPoolRoles_611475; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Sets the roles for an identity pool. These roles are used when making calls to <a>GetCredentialsForIdentity</a> action.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611488: Call_SetIdentityPoolRoles_611475; body: JsonNode): Recallable =
...
var setIdentityPoolRoles* = Call_SetIdentityPoolRoles_611475(
    name: "setIdentityPoolRoles", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.SetIdentityPoolRoles",
    validator: validate_SetIdentityPoolRoles_611476, base: "/",
    url: url_SetIdentityPoolRoles_611477, schemes: {Scheme.Https, Scheme.Http})
type
...
proc call*(call_611503: Call_TagResource_611490; body: JsonNode): Recallable =
  ## tagResource
  ## <p>Assigns a set of tags to an Amazon Cognito identity pool. A tag is a label that you can use to categorize and manage identity pools in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>Each tag consists of a key and value, both of which you define. A key is a general category for more specific values. For example, if you have two versions of an identity pool, one for testing and another for production, you might assign an <code>Environment</code> tag key to both identity pools. The value of this key might be <code>Test</code> for one identity pool and <code>Production</code> for the other.</p> <p>Tags are useful for cost tracking and access control. You can activate your tags so that they appear on the Billing and Cost Management console, where you can track the costs associated with your identity pools. In an IAM policy, you can constrain permissions for identity pools based on specific tags or tag values.</p> <p>You can use this action up to 5 times per second, per account. An identity pool can have as many as 50 tags.</p>
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_611490(name: "tagResource",
                                        ...
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnlinkDeveloperIdentity_611505 = ref object of OpenApiRestCall_610658
proc url_UnlinkDeveloperIdentity_611507(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UnlinkDeveloperIdentity_611506(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611517: Call_UnlinkDeveloperIdentity_611505; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Unlinks a <code>DeveloperUserIdentifier</code> from an existing identity. Unlinked developer users will be considered new identities next time they are seen. If, for a given Cognito identity, you remove all federated identities as well as the developer user identifier, the Cognito identity becomes inaccessible.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611518: Call_UnlinkDeveloperIdentity_611505; body: JsonNode): Recallable =
...
var unlinkDeveloperIdentity* = Call_UnlinkDeveloperIdentity_611505(
    ...
    validator: validate_UnlinkDeveloperIdentity_611506, base: "/",
    url: url_UnlinkDeveloperIdentity_611507, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnlinkIdentity_611520 = ref object of OpenApiRestCall_610658
proc url_UnlinkIdentity_611522(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UnlinkIdentity_611521(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611532: Call_UnlinkIdentity_611520; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Unlinks a federated identity from an existing account. Unlinked logins will be considered new identities next time they are seen. Removing the last linked login will make this identity inaccessible.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ## 
...
proc call*(call_611533: Call_UnlinkIdentity_611520; body: JsonNode): Recallable =
  ## unlinkIdentity
  ## <p>Unlinks a federated identity from an existing account. Unlinked logins will be considered new identities next time they are seen. Removing the last linked login will make this identity inaccessible.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   body: JObject (required)
...
var unlinkIdentity* = Call_UnlinkIdentity_611520(name: "unlinkIdentity",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.UnlinkIdentity",
    validator: validate_UnlinkIdentity_611521, base: "/", url: url_UnlinkIdentity_611522,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_611535 = ref object of OpenApiRestCall_610658
proc url_UntagResource_611537(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_611536(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611547: Call_UntagResource_611535; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the specified tags from an Amazon Cognito identity pool. You can use this action up to 5 times per second, per account
  ## 
...
proc call*(call_611548: Call_UntagResource_611535; body: JsonNode): Recallable =
  ## untagResource
  ## Removes the specified tags from an Amazon Cognito identity pool. You can use this action up to 5 times per second, per account
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_611535(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.UntagResource",
    validator: validate_UntagResource_611536, base: "/", url: url_UntagResource_611537,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateIdentityPool_611550 = ref object of OpenApiRestCall_610658
proc url_UpdateIdentityPool_611552(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateIdentityPool_611551(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_611562: Call_UpdateIdentityPool_611550; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ## 
...
proc call*(call_611563: Call_UpdateIdentityPool_611550; body: JsonNode): Recallable =
  ## updateIdentityPool
  ## <p>Updates an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   body: JObject (required)
...
var updateIdentityPool* = Call_UpdateIdentityPool_611550(
    name: "updateIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.UpdateIdentityPool",
    validator: validate_UpdateIdentityPool_611551, base: "/",
    url: url_UpdateIdentityPool_611552, schemes: {Scheme.Https, Scheme.Http})
export
  rest
