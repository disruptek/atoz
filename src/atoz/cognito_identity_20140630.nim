...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "cognito-identity.ap-northeast-1.amazonaws.com", "ap-southeast-1": "cognito-identity.ap-southeast-1.amazonaws.com", "us-west-2": "cognito-identity.us-west-2.amazonaws.com", "eu-west-2": "cognito-identity.eu-west-2.amazonaws.com", "ap-northeast-3": "cognito-identity.ap-northeast-3.amazonaws.com", "eu-central-1": "cognito-identity.eu-central-1.amazonaws.com", "us-east-2": "cognito-identity.us-east-2.amazonaws.com", "us-east-1": "cognito-identity.us-east-1.amazonaws.com", "cn-northwest-1": "cognito-identity.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "cognito-identity.ap-south-1.amazonaws.com", "eu-north-1": "cognito-identity.eu-north-1.amazonaws.com", "ap-northeast-2": "cognito-identity.ap-northeast-2.amazonaws.com", "us-west-1": "cognito-identity.us-west-1.amazonaws.com", "us-gov-east-1": "cognito-identity.us-gov-east-1.amazonaws.com", "eu-west-3": "cognito-identity.eu-west-3.amazonaws.com", "cn-north-1": "cognito-identity.cn-north-1.amazonaws.com.cn", "sa-east-1": "cognito-identity.sa-east-1.amazonaws.com", "eu-west-1": "cognito-identity.eu-west-1.amazonaws.com", "us-gov-west-1": "cognito-identity.us-gov-west-1.amazonaws.com", "ap-southeast-2": "cognito-identity.ap-southeast-2.amazonaws.com", "ca-central-1": "cognito-identity.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_CreateIdentityPool_402656294 = ref object of OpenApiRestCall_402656044
proc url_CreateIdentityPool_402656296(protocol: Scheme; host: string;
...
proc validate_CreateIdentityPool_402656295(path: JsonNode; query: JsonNode;
...
proc call*(call_402656412: Call_CreateIdentityPool_402656294;
...
proc call*(call_402656461: Call_CreateIdentityPool_402656294; body: JsonNode): Recallable =
  ## createIdentityPool
  ## <p>Creates a new identity pool. The identity pool is a store of user identity information that is specific to your AWS account. The keys for <code>SupportedLoginProviders</code> are as follows:</p> <ul> <li> <p>Facebook: <code>graph.facebook.com</code> </p> </li> <li> <p>Google: <code>accounts.google.com</code> </p> </li> <li> <p>Amazon: <code>www.amazon.com</code> </p> </li> <li> <p>Twitter: <code>api.twitter.com</code> </p> </li> <li> <p>Digits: <code>www.digits.com</code> </p> </li> </ul> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ## body: JObject (required)
...
var createIdentityPool* = Call_CreateIdentityPool_402656294(
    ...
    validator: validate_CreateIdentityPool_402656295, base: "/",
    makeUrl: url_CreateIdentityPool_402656296,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIdentities_402656489 = ref object of OpenApiRestCall_402656044
proc url_DeleteIdentities_402656491(protocol: Scheme; host: string;
...
proc validate_DeleteIdentities_402656490(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656501: Call_DeleteIdentities_402656489;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes identities from an identity pool. You can specify a list of 1-60 identities that you want to delete.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656502: Call_DeleteIdentities_402656489; body: JsonNode): Recallable =
  ## deleteIdentities
  ## <p>Deletes identities from an identity pool. You can specify a list of 1-60 identities that you want to delete.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                                                                                        ## body: JObject (required)
...
var deleteIdentities* = Call_DeleteIdentities_402656489(
    name: "deleteIdentities", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentities",
    validator: validate_DeleteIdentities_402656490, base: "/",
    makeUrl: url_DeleteIdentities_402656491,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteIdentityPool_402656504 = ref object of OpenApiRestCall_402656044
proc url_DeleteIdentityPool_402656506(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteIdentityPool_402656505(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656516: Call_DeleteIdentityPool_402656504;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes an identity pool. Once a pool is deleted, users will not be able to authenticate with the pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656517: Call_DeleteIdentityPool_402656504; body: JsonNode): Recallable =
  ## deleteIdentityPool
  ## <p>Deletes an identity pool. Once a pool is deleted, users will not be able to authenticate with the pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                                                                                   ## body: JObject (required)
...
var deleteIdentityPool* = Call_DeleteIdentityPool_402656504(
    name: "deleteIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentityPool",
    validator: validate_DeleteIdentityPool_402656505, base: "/",
    makeUrl: url_DeleteIdentityPool_402656506,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIdentity_402656519 = ref object of OpenApiRestCall_402656044
proc url_DescribeIdentity_402656521(protocol: Scheme; host: string;
                                    base: string; route: string; path: JsonNode;
                                    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeIdentity_402656520(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656531: Call_DescribeIdentity_402656519;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns metadata related to the given identity, including when the identity was created and any associated linked logins.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656532: Call_DescribeIdentity_402656519; body: JsonNode): Recallable =
  ## describeIdentity
  ## <p>Returns metadata related to the given identity, including when the identity was created and any associated linked logins.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                                                                                                     ## body: JObject (required)
...
var describeIdentity* = Call_DescribeIdentity_402656519(
    name: "describeIdentity", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentity",
    validator: validate_DescribeIdentity_402656520, base: "/",
    makeUrl: url_DescribeIdentity_402656521,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeIdentityPool_402656534 = ref object of OpenApiRestCall_402656044
proc url_DescribeIdentityPool_402656536(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeIdentityPool_402656535(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656546: Call_DescribeIdentityPool_402656534;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Gets details about a particular identity pool, including the pool name, ID description, creation date, and current number of users.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656547: Call_DescribeIdentityPool_402656534; body: JsonNode): Recallable =
...
var describeIdentityPool* = Call_DescribeIdentityPool_402656534(
    name: "describeIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentityPool",
    validator: validate_DescribeIdentityPool_402656535, base: "/",
    makeUrl: url_DescribeIdentityPool_402656536,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCredentialsForIdentity_402656549 = ref object of OpenApiRestCall_402656044
proc url_GetCredentialsForIdentity_402656551(protocol: Scheme; host: string;
...
proc validate_GetCredentialsForIdentity_402656550(path: JsonNode;
...
proc call*(call_402656561: Call_GetCredentialsForIdentity_402656549;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns credentials for the provided identity ID. Any provided logins will be validated against supported login providers. If the token is for cognito-identity.amazonaws.com, it will be passed through to AWS Security Token Service with the appropriate role for the token.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656562: Call_GetCredentialsForIdentity_402656549;
...
var getCredentialsForIdentity* = Call_GetCredentialsForIdentity_402656549(
    ...
    validator: validate_GetCredentialsForIdentity_402656550, base: "/",
    makeUrl: url_GetCredentialsForIdentity_402656551,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetId_402656564 = ref object of OpenApiRestCall_402656044
proc url_GetId_402656566(protocol: Scheme; host: string; base: string;
...
proc validate_GetId_402656565(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_402656576: Call_GetId_402656564; path: JsonNode = nil;
...
proc call*(call_402656577: Call_GetId_402656564; body: JsonNode): Recallable =
  ## getId
  ## <p>Generates (or retrieves) a Cognito ID. Supplying multiple logins will create an implicit linked account.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   
                                                                                                                                                                                                   ## body: JObject (required)
...
var getId* = Call_GetId_402656564(name: "getId", meth: HttpMethod.HttpPost,
                                  host: "cognito-identity.amazonaws.com", route: "/#X-Amz-Target=AWSCognitoIdentityService.GetId",
                                  validator: validate_GetId_402656565,
                                  base: "/", makeUrl: url_GetId_402656566,
                                  schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetIdentityPoolRoles_402656579 = ref object of OpenApiRestCall_402656044
proc url_GetIdentityPoolRoles_402656581(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetIdentityPoolRoles_402656580(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656591: Call_GetIdentityPoolRoles_402656579;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Gets the roles for an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656592: Call_GetIdentityPoolRoles_402656579; body: JsonNode): Recallable =
...
var getIdentityPoolRoles* = Call_GetIdentityPoolRoles_402656579(
    name: "getIdentityPoolRoles", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.GetIdentityPoolRoles",
    validator: validate_GetIdentityPoolRoles_402656580, base: "/",
    makeUrl: url_GetIdentityPoolRoles_402656581,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpenIdToken_402656594 = ref object of OpenApiRestCall_402656044
proc url_GetOpenIdToken_402656596(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetOpenIdToken_402656595(path: JsonNode; query: JsonNode;
...
proc call*(call_402656606: Call_GetOpenIdToken_402656594; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Gets an OpenID token, using a known Cognito ID. This known Cognito ID is returned by <a>GetId</a>. You can optionally add additional logins for the identity. Supplying multiple logins creates an implicit link.</p> <p>The OpenId token is valid for 10 minutes.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656607: Call_GetOpenIdToken_402656594; body: JsonNode): Recallable =
  ## getOpenIdToken
  ## <p>Gets an OpenID token, using a known Cognito ID. This known Cognito ID is returned by <a>GetId</a>. You can optionally add additional logins for the identity. Supplying multiple logins creates an implicit link.</p> <p>The OpenId token is valid for 10 minutes.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                                             ## body: JObject (required)
...
var getOpenIdToken* = Call_GetOpenIdToken_402656594(name: "getOpenIdToken",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdToken",
    validator: validate_GetOpenIdToken_402656595, base: "/",
    makeUrl: url_GetOpenIdToken_402656596, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpenIdTokenForDeveloperIdentity_402656609 = ref object of OpenApiRestCall_402656044
proc url_GetOpenIdTokenForDeveloperIdentity_402656611(protocol: Scheme;
...
proc validate_GetOpenIdTokenForDeveloperIdentity_402656610(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656621: Call_GetOpenIdTokenForDeveloperIdentity_402656609;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Registers (or retrieves) a Cognito <code>IdentityId</code> and an OpenID Connect token for a user authenticated by your backend authentication process. Supplying multiple logins will create an implicit linked account. You can only specify one developer provider as part of the <code>Logins</code> map, which is linked to the identity pool. The developer provider is the "domain" by which Cognito will refer to your users.</p> <p>You can use <code>GetOpenIdTokenForDeveloperIdentity</code> to create a new identity and to link new logins (that is, user credentials issued by a public provider or developer provider) to an existing identity. When you want to create a new identity, the <code>IdentityId</code> should be null. When you want to associate a new login with an existing authenticated/unauthenticated identity, you can do so by providing the existing <code>IdentityId</code>. This API will create the identity in the specified <code>IdentityPoolId</code>.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656622: Call_GetOpenIdTokenForDeveloperIdentity_402656609;
           body: JsonNode): Recallable =
...
var getOpenIdTokenForDeveloperIdentity* = Call_GetOpenIdTokenForDeveloperIdentity_402656609(
    ...
    validator: validate_GetOpenIdTokenForDeveloperIdentity_402656610, base: "/",
    makeUrl: url_GetOpenIdTokenForDeveloperIdentity_402656611,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIdentities_402656624 = ref object of OpenApiRestCall_402656044
proc url_ListIdentities_402656626(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListIdentities_402656625(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656636: Call_ListIdentities_402656624; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists the identities in an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656637: Call_ListIdentities_402656624; body: JsonNode): Recallable =
  ## listIdentities
  ## <p>Lists the identities in an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                     ## body: JObject (required)
...
var listIdentities* = Call_ListIdentities_402656624(name: "listIdentities",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListIdentities",
    validator: validate_ListIdentities_402656625, base: "/",
    makeUrl: url_ListIdentities_402656626, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIdentityPools_402656639 = ref object of OpenApiRestCall_402656044
proc url_ListIdentityPools_402656641(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListIdentityPools_402656640(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656651: Call_ListIdentityPools_402656639;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists all of the Cognito identity pools registered for your account.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656652: Call_ListIdentityPools_402656639; body: JsonNode): Recallable =
  ## listIdentityPools
  ## <p>Lists all of the Cognito identity pools registered for your account.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                                                                ## body: JObject (required)
...
var listIdentityPools* = Call_ListIdentityPools_402656639(
    name: "listIdentityPools", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListIdentityPools",
    validator: validate_ListIdentityPools_402656640, base: "/",
    makeUrl: url_ListIdentityPools_402656641,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_402656654 = ref object of OpenApiRestCall_402656044
proc url_ListTagsForResource_402656656(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTagsForResource_402656655(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656666: Call_ListTagsForResource_402656654;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists the tags that are assigned to an Amazon Cognito identity pool.</p> <p>A tag is a label that you can apply to identity pools to categorize and manage them in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>You can use this action up to 10 times per second, per account.</p>
                                                                                         ## 
...
proc call*(call_402656667: Call_ListTagsForResource_402656654; body: JsonNode): Recallable =
  ## listTagsForResource
  ## <p>Lists the tags that are assigned to an Amazon Cognito identity pool.</p> <p>A tag is a label that you can apply to identity pools to categorize and manage them in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>You can use this action up to 10 times per second, per account.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                ## body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_402656654(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.ListTagsForResource",
    validator: validate_ListTagsForResource_402656655, base: "/",
    makeUrl: url_ListTagsForResource_402656656,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupDeveloperIdentity_402656669 = ref object of OpenApiRestCall_402656044
proc url_LookupDeveloperIdentity_402656671(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LookupDeveloperIdentity_402656670(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656681: Call_LookupDeveloperIdentity_402656669;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves the <code>IdentityID</code> associated with a <code>DeveloperUserIdentifier</code> or the list of <code>DeveloperUserIdentifier</code> values associated with an <code>IdentityId</code> for an existing identity. Either <code>IdentityID</code> or <code>DeveloperUserIdentifier</code> must not be null. If you supply only one of these values, the other value will be searched in the database and returned as a part of the response. If you supply both, <code>DeveloperUserIdentifier</code> will be matched against <code>IdentityID</code>. If the values are verified against the database, the response returns both values and is the same as the request. Otherwise a <code>ResourceConflictException</code> is thrown.</p> <p> <code>LookupDeveloperIdentity</code> is intended for low-throughput control plane operations: for example, to enable customer service to locate an identity ID by username. If you are using it for higher-volume operations such as user authentication, your requests are likely to be throttled. <a>GetOpenIdTokenForDeveloperIdentity</a> is a better option for higher-volume operations for user authentication.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656682: Call_LookupDeveloperIdentity_402656669;
           body: JsonNode): Recallable =
...
var lookupDeveloperIdentity* = Call_LookupDeveloperIdentity_402656669(
    ...
    validator: validate_LookupDeveloperIdentity_402656670, base: "/",
    makeUrl: url_LookupDeveloperIdentity_402656671,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_MergeDeveloperIdentities_402656684 = ref object of OpenApiRestCall_402656044
proc url_MergeDeveloperIdentities_402656686(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_MergeDeveloperIdentities_402656685(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656696: Call_MergeDeveloperIdentities_402656684;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Merges two users having different <code>IdentityId</code>s, existing in the same identity pool, and identified by the same developer provider. You can use this action to request that discrete users be merged and identified as a single user in the Cognito environment. Cognito associates the given source user (<code>SourceUserIdentifier</code>) with the <code>IdentityId</code> of the <code>DestinationUserIdentifier</code>. Only developer-authenticated users can be merged. If the users to be merged are associated with the same public provider, but as two different users, an exception will be thrown.</p> <p>The number of linked logins is limited to 20. So, the number of linked logins for the source user, <code>SourceUserIdentifier</code>, and the destination user, <code>DestinationUserIdentifier</code>, together should not be larger than 20. Otherwise, an exception will be thrown.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656697: Call_MergeDeveloperIdentities_402656684;
           body: JsonNode): Recallable =
...
var mergeDeveloperIdentities* = Call_MergeDeveloperIdentities_402656684(
    ...
    validator: validate_MergeDeveloperIdentities_402656685, base: "/",
    makeUrl: url_MergeDeveloperIdentities_402656686,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SetIdentityPoolRoles_402656699 = ref object of OpenApiRestCall_402656044
proc url_SetIdentityPoolRoles_402656701(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_SetIdentityPoolRoles_402656700(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656711: Call_SetIdentityPoolRoles_402656699;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Sets the roles for an identity pool. These roles are used when making calls to <a>GetCredentialsForIdentity</a> action.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656712: Call_SetIdentityPoolRoles_402656699; body: JsonNode): Recallable =
...
var setIdentityPoolRoles* = Call_SetIdentityPoolRoles_402656699(
    name: "setIdentityPoolRoles", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.SetIdentityPoolRoles",
    validator: validate_SetIdentityPoolRoles_402656700, base: "/",
    makeUrl: url_SetIdentityPoolRoles_402656701,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_402656714 = ref object of OpenApiRestCall_402656044
...
proc call*(call_402656727: Call_TagResource_402656714; body: JsonNode): Recallable =
  ## tagResource
  ## <p>Assigns a set of tags to an Amazon Cognito identity pool. A tag is a label that you can use to categorize and manage identity pools in different ways, such as by purpose, owner, environment, or other criteria.</p> <p>Each tag consists of a key and value, both of which you define. A key is a general category for more specific values. For example, if you have two versions of an identity pool, one for testing and another for production, you might assign an <code>Environment</code> tag key to both identity pools. The value of this key might be <code>Test</code> for one identity pool and <code>Production</code> for the other.</p> <p>Tags are useful for cost tracking and access control. You can activate your tags so that they appear on the Billing and Cost Management console, where you can track the costs associated with your identity pools. In an IAM policy, you can constrain permissions for identity pools based on specific tags or tag values.</p> <p>You can use this action up to 5 times per second, per account. An identity pool can have as many as 50 tags.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ## body: JObject (required)
...
var tagResource* = Call_TagResource_402656714(name: "tagResource",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.TagResource",
    validator: validate_TagResource_402656715, base: "/",
    makeUrl: url_TagResource_402656716, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnlinkDeveloperIdentity_402656729 = ref object of OpenApiRestCall_402656044
proc url_UnlinkDeveloperIdentity_402656731(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UnlinkDeveloperIdentity_402656730(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656741: Call_UnlinkDeveloperIdentity_402656729;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Unlinks a <code>DeveloperUserIdentifier</code> from an existing identity. Unlinked developer users will be considered new identities next time they are seen. If, for a given Cognito identity, you remove all federated identities as well as the developer user identifier, the Cognito identity becomes inaccessible.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656742: Call_UnlinkDeveloperIdentity_402656729;
           body: JsonNode): Recallable =
...
var unlinkDeveloperIdentity* = Call_UnlinkDeveloperIdentity_402656729(
    ...
    validator: validate_UnlinkDeveloperIdentity_402656730, base: "/",
    makeUrl: url_UnlinkDeveloperIdentity_402656731,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnlinkIdentity_402656744 = ref object of OpenApiRestCall_402656044
proc url_UnlinkIdentity_402656746(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UnlinkIdentity_402656745(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656756: Call_UnlinkIdentity_402656744; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Unlinks a federated identity from an existing account. Unlinked logins will be considered new identities next time they are seen. Removing the last linked login will make this identity inaccessible.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656757: Call_UnlinkIdentity_402656744; body: JsonNode): Recallable =
  ## unlinkIdentity
  ## <p>Unlinks a federated identity from an existing account. Unlinked logins will be considered new identities next time they are seen. Removing the last linked login will make this identity inaccessible.</p> <p>This is a public API. You do not need any credentials to call this API.</p>
  ##   
                                                                                                                                                                                                                                                                                                 ## body: JObject (required)
...
var unlinkIdentity* = Call_UnlinkIdentity_402656744(name: "unlinkIdentity",
    meth: HttpMethod.HttpPost, host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.UnlinkIdentity",
    validator: validate_UnlinkIdentity_402656745, base: "/",
    makeUrl: url_UnlinkIdentity_402656746, schemes: {Scheme.Https, Scheme.Http})
type
...
type
  Call_UpdateIdentityPool_402656774 = ref object of OpenApiRestCall_402656044
proc url_UpdateIdentityPool_402656776(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateIdentityPool_402656775(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656786: Call_UpdateIdentityPool_402656774;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
                                                                                         ## 
...
proc call*(call_402656787: Call_UpdateIdentityPool_402656774; body: JsonNode): Recallable =
  ## updateIdentityPool
  ## <p>Updates an identity pool.</p> <p>You must use AWS Developer credentials to call this API.</p>
  ##   
                                                                                                     ## body: JObject (required)
...
var updateIdentityPool* = Call_UpdateIdentityPool_402656774(
    name: "updateIdentityPool", meth: HttpMethod.HttpPost,
    host: "cognito-identity.amazonaws.com",
    route: "/#X-Amz-Target=AWSCognitoIdentityService.UpdateIdentityPool",
    validator: validate_UpdateIdentityPool_402656775, base: "/",
    makeUrl: url_UpdateIdentityPool_402656776,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
