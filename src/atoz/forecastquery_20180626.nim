...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "forecastquery.ap-northeast-1.amazonaws.com", "ap-southeast-1": "forecastquery.ap-southeast-1.amazonaws.com", "us-west-2": "forecastquery.us-west-2.amazonaws.com", "eu-west-2": "forecastquery.eu-west-2.amazonaws.com", "ap-northeast-3": "forecastquery.ap-northeast-3.amazonaws.com", "eu-central-1": "forecastquery.eu-central-1.amazonaws.com", "us-east-2": "forecastquery.us-east-2.amazonaws.com", "us-east-1": "forecastquery.us-east-1.amazonaws.com", "cn-northwest-1": "forecastquery.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "forecastquery.ap-south-1.amazonaws.com", "eu-north-1": "forecastquery.eu-north-1.amazonaws.com", "ap-northeast-2": "forecastquery.ap-northeast-2.amazonaws.com", "us-west-1": "forecastquery.us-west-1.amazonaws.com", "us-gov-east-1": "forecastquery.us-gov-east-1.amazonaws.com", "eu-west-3": "forecastquery.eu-west-3.amazonaws.com", "cn-north-1": "forecastquery.cn-north-1.amazonaws.com.cn", "sa-east-1": "forecastquery.sa-east-1.amazonaws.com", "eu-west-1": "forecastquery.eu-west-1.amazonaws.com", "us-gov-west-1": "forecastquery.us-gov-west-1.amazonaws.com", "ap-southeast-2": "forecastquery.ap-southeast-2.amazonaws.com", "ca-central-1": "forecastquery.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_QueryForecast_402656288 = ref object of OpenApiRestCall_402656038
proc url_QueryForecast_402656290(protocol: Scheme; host: string; base: string;
...
proc validate_QueryForecast_402656289(path: JsonNode; query: JsonNode;
...
proc call*(call_402656406: Call_QueryForecast_402656288; path: JsonNode = nil;
...
proc call*(call_402656455: Call_QueryForecast_402656288; body: JsonNode): Recallable =
  ## queryForecast
  ## <p>Retrieves a forecast for a single item, filtered by the supplied criteria.</p> <p>The criteria is a key-value pair. The key is either <code>item_id</code> (or the equivalent non-timestamp, non-target field) from the <code>TARGET_TIME_SERIES</code> dataset, or one of the forecast dimensions specified as part of the <code>FeaturizationConfig</code> object.</p> <p>By default, <code>QueryForecast</code> returns the complete date range for the filtered forecast. You can request a specific date range.</p> <p>To get the full forecast, use the <a href="https://docs.aws.amazon.com/en_us/forecast/latest/dg/API_CreateForecastExportJob.html">CreateForecastExportJob</a> operation.</p> <note> <p>The forecasts generated by Amazon Forecast are in the same timezone as the dataset that was used to create the predictor.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ## body: JObject (required)
...
var queryForecast* = Call_QueryForecast_402656288(name: "queryForecast",
    meth: HttpMethod.HttpPost, host: "forecastquery.amazonaws.com",
    route: "/#X-Amz-Target=AmazonForecastRuntime.QueryForecast",
    validator: validate_QueryForecast_402656289, base: "/",
    makeUrl: url_QueryForecast_402656290, schemes: {Scheme.Https, Scheme.Http})
export
  rest
