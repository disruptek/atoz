...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_ReadJob_21625779 = ref object of OpenApiRestCall_21625435
proc url_ReadJob_21625781(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
...
proc validate_ReadJob_21625780(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21625927: Call_ReadJob_21625779; path: JsonNode = nil;
...
proc call*(call_21625990: Call_ReadJob_21625779; Id: string): Recallable =
  ## readJob
  ## The ReadJob operation returns detailed information about a job.
  ##   Id: string (required)
  ##     : The identifier of the job for which you want to get detailed information.
  var path_21625992 = newJObject()
  add(path_21625992, "Id", newJString(Id))
  result = call_21625990.call(path_21625992, nil, nil, nil, nil)

var readJob* = Call_ReadJob_21625779(name: "readJob", meth: HttpMethod.HttpGet,
                                  host: "elastictranscoder.amazonaws.com",
                                  route: "/2012-09-25/jobs/{Id}",
                                  validator: validate_ReadJob_21625780, base: "/",
                                  makeUrl: url_ReadJob_21625781,
...
proc call*(call_21626042: Call_CancelJob_21626030; Id: string): Recallable =
  ## cancelJob
  ## <p>The CancelJob operation cancels an unfinished job.</p> <note> <p>You can only cancel a job that has a status of <code>Submitted</code>. To prevent a pipeline from starting to process a job while you're getting the job identifier, use <a>UpdatePipelineStatus</a> to temporarily pause the pipeline.</p> </note>
  ##   Id: string (required)
  ##     : <p>The identifier of the job that you want to cancel.</p> <p>To get a list of the jobs (including their <code>jobId</code>) that have a status of <code>Submitted</code>, use the <a>ListJobsByStatus</a> API action.</p>
  var path_21626043 = newJObject()
  add(path_21626043, "Id", newJString(Id))
...
var cancelJob* = Call_CancelJob_21626030(name: "cancelJob",
                                      ...
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateJob_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateJob_21626046(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateJob_21626045(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626055: Call_CreateJob_21626044; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>When you create a job, Elastic Transcoder returns JSON data that includes the values that you specified plus information about the job that is created.</p> <p>If you have specified more than one output for your jobs (for example, one output for the Kindle Fire and another output for the Apple iPhone 4s), you currently must use the Elastic Transcoder API to list the jobs (as opposed to the AWS Console).</p>
  ## 
...
proc call*(call_21626056: Call_CreateJob_21626044; body: JsonNode): Recallable =
  ## createJob
  ## <p>When you create a job, Elastic Transcoder returns JSON data that includes the values that you specified plus information about the job that is created.</p> <p>If you have specified more than one output for your jobs (for example, one output for the Kindle Fire and another output for the Apple iPhone 4s), you currently must use the Elastic Transcoder API to list the jobs (as opposed to the AWS Console).</p>
  ##   body: JObject (required)
...
var createJob* = Call_CreateJob_21626044(name: "createJob",
                                      meth: HttpMethod.HttpPost,
                                      host: "elastictranscoder.amazonaws.com",
                                      route: "/2012-09-25/jobs",
                                      validator: validate_CreateJob_21626045,
                                      base: "/", makeUrl: url_CreateJob_21626046,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreatePipeline_21626074 = ref object of OpenApiRestCall_21625435
proc url_CreatePipeline_21626076(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreatePipeline_21626075(path: JsonNode; query: JsonNode;
  ...
  var valid_21626080 = header.getOrDefault("X-Amz-Algorithm")
  valid_21626080 = validateParameter(valid_21626080, JString, required = false,
                                   default = nil)
  if valid_21626080 != nil:
    section.add "X-Amz-Algorithm", valid_21626080
  var valid_21626081 = header.getOrDefault("X-Amz-Signature")
  valid_21626081 = validateParameter(valid_21626081, JString, required = false,
                                   default = nil)
  if valid_21626081 != nil:
    section.add "X-Amz-Signature", valid_21626081
  var valid_21626082 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_21626082 = validateParameter(valid_21626082, JString, required = false,
                                   default = nil)
  if valid_21626082 != nil:
    section.add "X-Amz-SignedHeaders", valid_21626082
  var valid_21626083 = header.getOrDefault("X-Amz-Credential")
  valid_21626083 = validateParameter(valid_21626083, JString, required = false,
                                   default = nil)
  if valid_21626083 != nil:
    section.add "X-Amz-Credential", valid_21626083
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626085: Call_CreatePipeline_21626074; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The CreatePipeline operation creates a pipeline with settings that you specify.
  ## 
...
proc call*(call_21626086: Call_CreatePipeline_21626074; body: JsonNode): Recallable =
  ## createPipeline
  ## The CreatePipeline operation creates a pipeline with settings that you specify.
  ##   body: JObject (required)
  var body_21626087 = newJObject()
  if body != nil:
    body_21626087 = body
  result = call_21626086.call(nil, nil, nil, nil, body_21626087)

var createPipeline* = Call_CreatePipeline_21626074(name: "createPipeline",
    meth: HttpMethod.HttpPost, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines", validator: validate_CreatePipeline_21626075,
    base: "/", makeUrl: url_CreatePipeline_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPipelines_21626058 = ref object of OpenApiRestCall_21625435
proc url_ListPipelines_21626060(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPipelines_21626059(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
  ...
  section = newJObject()
  var valid_21626061 = query.getOrDefault("PageToken")
  valid_21626061 = validateParameter(valid_21626061, JString, required = false,
                                   default = nil)
  if valid_21626061 != nil:
    section.add "PageToken", valid_21626061
  var valid_21626062 = query.getOrDefault("Ascending")
  valid_21626062 = validateParameter(valid_21626062, JString, required = false,
                                   default = nil)
  if valid_21626062 != nil:
    section.add "Ascending", valid_21626062
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626070: Call_ListPipelines_21626058; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The ListPipelines operation gets a list of the pipelines associated with the current AWS account.
  ## 
...
proc call*(call_21626071: Call_ListPipelines_21626058; PageToken: string = "";
  ...
  add(query_21626072, "PageToken", newJString(PageToken))
  add(query_21626072, "Ascending", newJString(Ascending))
  result = call_21626071.call(nil, query_21626072, nil, nil, nil)

var listPipelines* = Call_ListPipelines_21626058(name: "listPipelines",
    meth: HttpMethod.HttpGet, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines", validator: validate_ListPipelines_21626059,
    base: "/", makeUrl: url_ListPipelines_21626060,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreatePreset_21626103 = ref object of OpenApiRestCall_21625435
proc url_CreatePreset_21626105(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreatePreset_21626104(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626114: Call_CreatePreset_21626103; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The CreatePreset operation creates a preset with settings that you specify.</p> <important> <p>Elastic Transcoder checks the CreatePreset settings to ensure that they meet Elastic Transcoder requirements and to determine whether they comply with H.264 standards. If your settings are not valid for Elastic Transcoder, Elastic Transcoder returns an HTTP 400 response (<code>ValidationException</code>) and does not create the preset. If the settings are valid for Elastic Transcoder but aren't strictly compliant with the H.264 standard, Elastic Transcoder creates the preset and returns a warning message in the response. This helps you determine whether your settings comply with the H.264 standard while giving you greater flexibility with respect to the video that Elastic Transcoder produces.</p> </important> <p>Elastic Transcoder uses the H.264 video-compression format. For more information, see the International Telecommunication Union publication <i>Recommendation ITU-T H.264: Advanced video coding for generic audiovisual services</i>.</p>
  ## 
...
proc call*(call_21626115: Call_CreatePreset_21626103; body: JsonNode): Recallable =
  ## createPreset
  ## <p>The CreatePreset operation creates a preset with settings that you specify.</p> <important> <p>Elastic Transcoder checks the CreatePreset settings to ensure that they meet Elastic Transcoder requirements and to determine whether they comply with H.264 standards. If your settings are not valid for Elastic Transcoder, Elastic Transcoder returns an HTTP 400 response (<code>ValidationException</code>) and does not create the preset. If the settings are valid for Elastic Transcoder but aren't strictly compliant with the H.264 standard, Elastic Transcoder creates the preset and returns a warning message in the response. This helps you determine whether your settings comply with the H.264 standard while giving you greater flexibility with respect to the video that Elastic Transcoder produces.</p> </important> <p>Elastic Transcoder uses the H.264 video-compression format. For more information, see the International Telecommunication Union publication <i>Recommendation ITU-T H.264: Advanced video coding for generic audiovisual services</i>.</p>
  ##   body: JObject (required)
...
var createPreset* = Call_CreatePreset_21626103(name: "createPreset",
    meth: HttpMethod.HttpPost, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/presets", validator: validate_CreatePreset_21626104,
    base: "/", makeUrl: url_CreatePreset_21626105,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPresets_21626088 = ref object of OpenApiRestCall_21625435
proc url_ListPresets_21626090(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPresets_21626089(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  section = newJObject()
  var valid_21626091 = query.getOrDefault("PageToken")
  valid_21626091 = validateParameter(valid_21626091, JString, required = false,
                                   default = nil)
  if valid_21626091 != nil:
    section.add "PageToken", valid_21626091
  var valid_21626092 = query.getOrDefault("Ascending")
  valid_21626092 = validateParameter(valid_21626092, JString, required = false,
                                   default = nil)
  if valid_21626092 != nil:
    section.add "Ascending", valid_21626092
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626100: Call_ListPresets_21626088; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The ListPresets operation gets a list of the default presets included with Elastic Transcoder and the presets that you've added in an AWS region.
  ## 
...
proc call*(call_21626101: Call_ListPresets_21626088; PageToken: string = "";
          Ascending: string = ""): Recallable =
  ## listPresets
  ## The ListPresets operation gets a list of the default presets included with Elastic Transcoder and the presets that you've added in an AWS region.
  ##   PageToken: string
  ...
  add(query_21626102, "PageToken", newJString(PageToken))
  add(query_21626102, "Ascending", newJString(Ascending))
  result = call_21626101.call(nil, query_21626102, nil, nil, nil)

var listPresets* = Call_ListPresets_21626088(name: "listPresets",
    meth: HttpMethod.HttpGet, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/presets", validator: validate_ListPresets_21626089,
    base: "/", makeUrl: url_ListPresets_21626090,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdatePipeline_21626131 = ref object of OpenApiRestCall_21625435
proc url_UpdatePipeline_21626133(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdatePipeline_21626132(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626143: Call_UpdatePipeline_21626131; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> Use the <code>UpdatePipeline</code> operation to update settings for a pipeline.</p> <important> <p>When you change pipeline settings, your changes take effect immediately. Jobs that you have already submitted and that Elastic Transcoder has not started to process are affected in addition to jobs that you submit after you change settings. </p> </important>
  ## 
...
proc call*(call_21626144: Call_UpdatePipeline_21626131; Id: string; body: JsonNode): Recallable =
  ## updatePipeline
  ## <p> Use the <code>UpdatePipeline</code> operation to update settings for a pipeline.</p> <important> <p>When you change pipeline settings, your changes take effect immediately. Jobs that you have already submitted and that Elastic Transcoder has not started to process are affected in addition to jobs that you submit after you change settings. </p> </important>
  ##   Id: string (required)
  ##     : The ID of the pipeline that you want to update.
  ...
  add(path_21626145, "Id", newJString(Id))
  if body != nil:
    body_21626146 = body
  result = call_21626144.call(path_21626145, nil, nil, nil, body_21626146)

var updatePipeline* = Call_UpdatePipeline_21626131(name: "updatePipeline",
    meth: HttpMethod.HttpPut, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines/{Id}", validator: validate_UpdatePipeline_21626132,
    base: "/", makeUrl: url_UpdatePipeline_21626133,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ReadPipeline_21626117 = ref object of OpenApiRestCall_21625435
proc url_ReadPipeline_21626119(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ReadPipeline_21626118(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626128: Call_ReadPipeline_21626117; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The ReadPipeline operation gets detailed information about a pipeline.
  ## 
...
proc call*(call_21626129: Call_ReadPipeline_21626117; Id: string): Recallable =
  ## readPipeline
  ## The ReadPipeline operation gets detailed information about a pipeline.
  ##   Id: string (required)
  ##     : The identifier of the pipeline to read.
  var path_21626130 = newJObject()
  add(path_21626130, "Id", newJString(Id))
  result = call_21626129.call(path_21626130, nil, nil, nil, nil)

var readPipeline* = Call_ReadPipeline_21626117(name: "readPipeline",
    meth: HttpMethod.HttpGet, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines/{Id}", validator: validate_ReadPipeline_21626118,
    base: "/", makeUrl: url_ReadPipeline_21626119,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePipeline_21626147 = ref object of OpenApiRestCall_21625435
proc url_DeletePipeline_21626149(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeletePipeline_21626148(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626158: Call_DeletePipeline_21626147; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The DeletePipeline operation removes a pipeline.</p> <p> You can only delete a pipeline that has never been used or that is not currently in use (doesn't contain any active jobs). If the pipeline is currently in use, <code>DeletePipeline</code> returns an error. </p>
  ## 
...
proc call*(call_21626159: Call_DeletePipeline_21626147; Id: string): Recallable =
  ## deletePipeline
  ## <p>The DeletePipeline operation removes a pipeline.</p> <p> You can only delete a pipeline that has never been used or that is not currently in use (doesn't contain any active jobs). If the pipeline is currently in use, <code>DeletePipeline</code> returns an error. </p>
  ##   Id: string (required)
  ##     : The identifier of the pipeline that you want to delete.
  var path_21626160 = newJObject()
  add(path_21626160, "Id", newJString(Id))
  result = call_21626159.call(path_21626160, nil, nil, nil, nil)

var deletePipeline* = Call_DeletePipeline_21626147(name: "deletePipeline",
    meth: HttpMethod.HttpDelete, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines/{Id}", validator: validate_DeletePipeline_21626148,
    base: "/", makeUrl: url_DeletePipeline_21626149,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ReadPreset_21626161 = ref object of OpenApiRestCall_21625435
proc url_ReadPreset_21626163(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ReadPreset_21626162(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626172: Call_ReadPreset_21626161; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The ReadPreset operation gets detailed information about a preset.
  ## 
...
proc call*(call_21626173: Call_ReadPreset_21626161; Id: string): Recallable =
  ## readPreset
  ## The ReadPreset operation gets detailed information about a preset.
  ##   Id: string (required)
  ##     : The identifier of the preset for which you want to get detailed information.
  var path_21626174 = newJObject()
  add(path_21626174, "Id", newJString(Id))
  result = call_21626173.call(path_21626174, nil, nil, nil, nil)

var readPreset* = Call_ReadPreset_21626161(name: "readPreset",
                                        meth: HttpMethod.HttpGet, host: "elastictranscoder.amazonaws.com",
                                        route: "/2012-09-25/presets/{Id}",
                                        validator: validate_ReadPreset_21626162,
                                        base: "/", makeUrl: url_ReadPreset_21626163,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePreset_21626175 = ref object of OpenApiRestCall_21625435
proc url_DeletePreset_21626177(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeletePreset_21626176(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626186: Call_DeletePreset_21626175; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The DeletePreset operation removes a preset that you've added in an AWS region.</p> <note> <p>You can't delete the default presets that are included with Elastic Transcoder.</p> </note>
  ## 
...
proc call*(call_21626187: Call_DeletePreset_21626175; Id: string): Recallable =
  ## deletePreset
  ## <p>The DeletePreset operation removes a preset that you've added in an AWS region.</p> <note> <p>You can't delete the default presets that are included with Elastic Transcoder.</p> </note>
  ##   Id: string (required)
  ##     : The identifier of the preset for which you want to get detailed information.
  var path_21626188 = newJObject()
  add(path_21626188, "Id", newJString(Id))
  result = call_21626187.call(path_21626188, nil, nil, nil, nil)

var deletePreset* = Call_DeletePreset_21626175(name: "deletePreset",
    meth: HttpMethod.HttpDelete, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/presets/{Id}", validator: validate_DeletePreset_21626176,
    base: "/", makeUrl: url_DeletePreset_21626177,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListJobsByPipeline_21626189 = ref object of OpenApiRestCall_21625435
proc url_ListJobsByPipeline_21626191(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListJobsByPipeline_21626190(path: JsonNode; query: JsonNode;
  ...
  var valid_21626192 = path.getOrDefault("PipelineId")
  valid_21626192 = validateParameter(valid_21626192, JString, required = true,
                                   default = nil)
  if valid_21626192 != nil:
    section.add "PipelineId", valid_21626192
  result.add "path", section
  ## parameters in `query` object:
  ##   PageToken: JString
  ##            :  When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. 
  ...
  section = newJObject()
  var valid_21626193 = query.getOrDefault("PageToken")
  valid_21626193 = validateParameter(valid_21626193, JString, required = false,
                                   default = nil)
  if valid_21626193 != nil:
    section.add "PageToken", valid_21626193
  var valid_21626194 = query.getOrDefault("Ascending")
  valid_21626194 = validateParameter(valid_21626194, JString, required = false,
                                   default = nil)
  if valid_21626194 != nil:
    section.add "Ascending", valid_21626194
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626202: Call_ListJobsByPipeline_21626189; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The ListJobsByPipeline operation gets a list of the jobs currently in a pipeline.</p> <p>Elastic Transcoder returns all of the jobs currently in the specified pipeline. The response body contains one element for each job that satisfies the search criteria.</p>
  ## 
...
proc call*(call_21626203: Call_ListJobsByPipeline_21626189; PipelineId: string;
  ...
  add(query_21626205, "PageToken", newJString(PageToken))
  add(path_21626204, "PipelineId", newJString(PipelineId))
  add(query_21626205, "Ascending", newJString(Ascending))
  result = call_21626203.call(path_21626204, query_21626205, nil, nil, nil)

var listJobsByPipeline* = Call_ListJobsByPipeline_21626189(
    name: "listJobsByPipeline", meth: HttpMethod.HttpGet,
    host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/jobsByPipeline/{PipelineId}",
    validator: validate_ListJobsByPipeline_21626190, base: "/",
    makeUrl: url_ListJobsByPipeline_21626191, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListJobsByStatus_21626206 = ref object of OpenApiRestCall_21625435
proc url_ListJobsByStatus_21626208(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListJobsByStatus_21626207(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626209 = path.getOrDefault("Status")
  valid_21626209 = validateParameter(valid_21626209, JString, required = true,
                                   default = nil)
  if valid_21626209 != nil:
    section.add "Status", valid_21626209
  result.add "path", section
  ## parameters in `query` object:
  ##   PageToken: JString
  ##            :  When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. 
  ...
  ##            :  To list jobs in chronological order by the date and time that they were submitted, enter <code>true</code>. To list jobs in reverse chronological order, enter <code>false</code>. 
  section = newJObject()
  var valid_21626210 = query.getOrDefault("PageToken")
  valid_21626210 = validateParameter(valid_21626210, JString, required = false,
                                   default = nil)
  if valid_21626210 != nil:
    section.add "PageToken", valid_21626210
  var valid_21626211 = query.getOrDefault("Ascending")
  valid_21626211 = validateParameter(valid_21626211, JString, required = false,
                                   default = nil)
  if valid_21626211 != nil:
    section.add "Ascending", valid_21626211
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626219: Call_ListJobsByStatus_21626206; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## The ListJobsByStatus operation gets a list of jobs that have a specified status. The response body contains one element for each job that satisfies the search criteria.
  ## 
...
proc call*(call_21626220: Call_ListJobsByStatus_21626206; Status: string;
          PageToken: string = ""; Ascending: string = ""): Recallable =
  ## listJobsByStatus
  ## The ListJobsByStatus operation gets a list of jobs that have a specified status. The response body contains one element for each job that satisfies the search criteria.
  ...
  add(path_21626221, "Status", newJString(Status))
  add(query_21626222, "PageToken", newJString(PageToken))
  add(query_21626222, "Ascending", newJString(Ascending))
  result = call_21626220.call(path_21626221, query_21626222, nil, nil, nil)

var listJobsByStatus* = Call_ListJobsByStatus_21626206(name: "listJobsByStatus",
    meth: HttpMethod.HttpGet, host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/jobsByStatus/{Status}",
    validator: validate_ListJobsByStatus_21626207, base: "/",
    makeUrl: url_ListJobsByStatus_21626208, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TestRole_21626223 = ref object of OpenApiRestCall_21625435
proc url_TestRole_21626225(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TestRole_21626224(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626234: Call_TestRole_21626223; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The TestRole operation tests the IAM role used to create the pipeline.</p> <p>The <code>TestRole</code> action lets you determine whether the IAM role you are using has sufficient permissions to let Elastic Transcoder perform tasks associated with the transcoding process. The action attempts to assume the specified IAM role, checks read access to the input and output buckets, and tries to send a test notification to Amazon SNS topics that you specify.</p>
  ## 
...
proc call*(call_21626235: Call_TestRole_21626223; body: JsonNode): Recallable =
  ## testRole
  ## <p>The TestRole operation tests the IAM role used to create the pipeline.</p> <p>The <code>TestRole</code> action lets you determine whether the IAM role you are using has sufficient permissions to let Elastic Transcoder perform tasks associated with the transcoding process. The action attempts to assume the specified IAM role, checks read access to the input and output buckets, and tries to send a test notification to Amazon SNS topics that you specify.</p>
  ##   body: JObject (required)
...
var testRole* = Call_TestRole_21626223(name: "testRole", meth: HttpMethod.HttpPost,
                                    host: "elastictranscoder.amazonaws.com",
                                    route: "/2012-09-25/roleTests",
                                    validator: validate_TestRole_21626224,
                                    base: "/", makeUrl: url_TestRole_21626225,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdatePipelineNotifications_21626237 = ref object of OpenApiRestCall_21625435
proc url_UpdatePipelineNotifications_21626239(protocol: Scheme; host: string;
...
proc validate_UpdatePipelineNotifications_21626238(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626249: Call_UpdatePipelineNotifications_21626237;
...
proc call*(call_21626250: Call_UpdatePipelineNotifications_21626237; Id: string;
  ...
  add(path_21626251, "Id", newJString(Id))
  if body != nil:
    body_21626252 = body
  result = call_21626250.call(path_21626251, nil, nil, nil, body_21626252)

var updatePipelineNotifications* = Call_UpdatePipelineNotifications_21626237(
    name: "updatePipelineNotifications", meth: HttpMethod.HttpPost,
    host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines/{Id}/notifications",
    validator: validate_UpdatePipelineNotifications_21626238, base: "/",
    makeUrl: url_UpdatePipelineNotifications_21626239,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdatePipelineStatus_21626253 = ref object of OpenApiRestCall_21625435
proc url_UpdatePipelineStatus_21626255(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdatePipelineStatus_21626254(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626265: Call_UpdatePipelineStatus_21626253; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>The UpdatePipelineStatus operation pauses or reactivates a pipeline, so that the pipeline stops or restarts the processing of jobs.</p> <p>Changing the pipeline status is useful if you want to cancel one or more jobs. You can't cancel jobs after Elastic Transcoder has started processing them; if you pause the pipeline to which you submitted the jobs, you have more time to get the job IDs for the jobs that you want to cancel, and to send a <a>CancelJob</a> request. </p>
  ## 
...
proc call*(call_21626266: Call_UpdatePipelineStatus_21626253; Id: string;
          body: JsonNode): Recallable =
  ...
  add(path_21626267, "Id", newJString(Id))
  if body != nil:
    body_21626268 = body
  result = call_21626266.call(path_21626267, nil, nil, nil, body_21626268)

var updatePipelineStatus* = Call_UpdatePipelineStatus_21626253(
    name: "updatePipelineStatus", meth: HttpMethod.HttpPost,
    host: "elastictranscoder.amazonaws.com",
    route: "/2012-09-25/pipelines/{Id}/status",
    validator: validate_UpdatePipelineStatus_21626254, base: "/",
    makeUrl: url_UpdatePipelineStatus_21626255,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
