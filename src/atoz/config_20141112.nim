...
type
  Call_BatchGetAggregateResourceConfig_772933 = ref object of OpenApiRestCall_772597
proc url_BatchGetAggregateResourceConfig_772935(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_BatchGetAggregateResourceConfig_772934(path: JsonNode;
...
proc call*(call_773091: Call_BatchGetAggregateResourceConfig_772933;
...
proc call*(call_773162: Call_BatchGetAggregateResourceConfig_772933; body: JsonNode): Recallable =
...
var batchGetAggregateResourceConfig* = Call_BatchGetAggregateResourceConfig_772933(
    ...
    validator: validate_BatchGetAggregateResourceConfig_772934, base: "/",
    url: url_BatchGetAggregateResourceConfig_772935,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchGetResourceConfig_773202 = ref object of OpenApiRestCall_772597
proc url_BatchGetResourceConfig_773204(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_BatchGetResourceConfig_773203(path: JsonNode; query: JsonNode;
...
proc call*(call_773214: Call_BatchGetResourceConfig_773202; path: JsonNode;
...
proc call*(call_773215: Call_BatchGetResourceConfig_773202; body: JsonNode): Recallable =
...
var batchGetResourceConfig* = Call_BatchGetResourceConfig_773202(
    ...
    validator: validate_BatchGetResourceConfig_773203, base: "/",
    url: url_BatchGetResourceConfig_773204, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAggregationAuthorization_773217 = ref object of OpenApiRestCall_772597
proc url_DeleteAggregationAuthorization_773219(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteAggregationAuthorization_773218(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773229: Call_DeleteAggregationAuthorization_773217; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the authorization granted to the specified configuration aggregator account in a specified region.
  ## 
...
proc call*(call_773230: Call_DeleteAggregationAuthorization_773217; body: JsonNode): Recallable =
...
var deleteAggregationAuthorization* = Call_DeleteAggregationAuthorization_773217(
    ...
    validator: validate_DeleteAggregationAuthorization_773218, base: "/",
    url: url_DeleteAggregationAuthorization_773219,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConfigRule_773232 = ref object of OpenApiRestCall_772597
proc url_DeleteConfigRule_773234(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteConfigRule_773233(path: JsonNode; query: JsonNode;
...
proc call*(call_773244: Call_DeleteConfigRule_773232; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the specified AWS Config rule and all of its evaluation results.</p> <p>AWS Config sets the state of a rule to <code>DELETING</code> until the deletion is complete. You cannot update a rule while it is in this state. If you make a <code>PutConfigRule</code> or <code>DeleteConfigRule</code> request for the rule, you will receive a <code>ResourceInUseException</code>.</p> <p>You can check the state of a rule by using the <code>DescribeConfigRules</code> request.</p>
  ## 
...
proc call*(call_773245: Call_DeleteConfigRule_773232; body: JsonNode): Recallable =
  ## deleteConfigRule
  ## <p>Deletes the specified AWS Config rule and all of its evaluation results.</p> <p>AWS Config sets the state of a rule to <code>DELETING</code> until the deletion is complete. You cannot update a rule while it is in this state. If you make a <code>PutConfigRule</code> or <code>DeleteConfigRule</code> request for the rule, you will receive a <code>ResourceInUseException</code>.</p> <p>You can check the state of a rule by using the <code>DescribeConfigRules</code> request.</p>
  ##   body: JObject (required)
...
var deleteConfigRule* = Call_DeleteConfigRule_773232(name: "deleteConfigRule",
    meth: HttpMethod.HttpPost, host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DeleteConfigRule",
    validator: validate_DeleteConfigRule_773233, base: "/",
    url: url_DeleteConfigRule_773234, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConfigurationAggregator_773247 = ref object of OpenApiRestCall_772597
proc url_DeleteConfigurationAggregator_773249(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteConfigurationAggregator_773248(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773259: Call_DeleteConfigurationAggregator_773247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified configuration aggregator and the aggregated data associated with the aggregator.
  ## 
...
proc call*(call_773260: Call_DeleteConfigurationAggregator_773247; body: JsonNode): Recallable =
...
var deleteConfigurationAggregator* = Call_DeleteConfigurationAggregator_773247(
    ...
    validator: validate_DeleteConfigurationAggregator_773248, base: "/",
    url: url_DeleteConfigurationAggregator_773249,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConfigurationRecorder_773262 = ref object of OpenApiRestCall_772597
proc url_DeleteConfigurationRecorder_773264(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteConfigurationRecorder_773263(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773274: Call_DeleteConfigurationRecorder_773262; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the configuration recorder.</p> <p>After the configuration recorder is deleted, AWS Config will not record resource configuration changes until you create a new configuration recorder.</p> <p>This action does not delete the configuration information that was previously recorded. You will be able to access the previously recorded information by using the <code>GetResourceConfigHistory</code> action, but you will not be able to access this information in the AWS Config console until you create a new configuration recorder.</p>
  ## 
...
proc call*(call_773275: Call_DeleteConfigurationRecorder_773262; body: JsonNode): Recallable =
...
var deleteConfigurationRecorder* = Call_DeleteConfigurationRecorder_773262(
    ...
    validator: validate_DeleteConfigurationRecorder_773263, base: "/",
    url: url_DeleteConfigurationRecorder_773264,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDeliveryChannel_773277 = ref object of OpenApiRestCall_772597
proc url_DeleteDeliveryChannel_773279(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteDeliveryChannel_773278(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773289: Call_DeleteDeliveryChannel_773277; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the delivery channel.</p> <p>Before you can delete the delivery channel, you must stop the configuration recorder by using the <a>StopConfigurationRecorder</a> action.</p>
  ## 
...
proc call*(call_773290: Call_DeleteDeliveryChannel_773277; body: JsonNode): Recallable =
...
var deleteDeliveryChannel* = Call_DeleteDeliveryChannel_773277(
    name: "deleteDeliveryChannel", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DeleteDeliveryChannel",
    validator: validate_DeleteDeliveryChannel_773278, base: "/",
    url: url_DeleteDeliveryChannel_773279, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEvaluationResults_773292 = ref object of OpenApiRestCall_772597
proc url_DeleteEvaluationResults_773294(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteEvaluationResults_773293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773304: Call_DeleteEvaluationResults_773292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the evaluation results for the specified AWS Config rule. You can specify one AWS Config rule per request. After you delete the evaluation results, you can call the <a>StartConfigRulesEvaluation</a> API to start evaluating your AWS resources against the rule.
  ## 
...
proc call*(call_773305: Call_DeleteEvaluationResults_773292; body: JsonNode): Recallable =
...
var deleteEvaluationResults* = Call_DeleteEvaluationResults_773292(
    name: "deleteEvaluationResults", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DeleteEvaluationResults",
    validator: validate_DeleteEvaluationResults_773293, base: "/",
    url: url_DeleteEvaluationResults_773294, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteOrganizationConfigRule_773307 = ref object of OpenApiRestCall_772597
proc url_DeleteOrganizationConfigRule_773309(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteOrganizationConfigRule_773308(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773319: Call_DeleteOrganizationConfigRule_773307; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the specified organization config rule and all of its evaluation results from all member accounts in that organization. Only a master account can delete an organization config rule.</p> <p>AWS Config sets the state of a rule to DELETE_IN_PROGRESS until the deletion is complete. You cannot update a rule while it is in this state.</p>
  ## 
...
proc call*(call_773320: Call_DeleteOrganizationConfigRule_773307; body: JsonNode): Recallable =
...
var deleteOrganizationConfigRule* = Call_DeleteOrganizationConfigRule_773307(
    ...
    validator: validate_DeleteOrganizationConfigRule_773308, base: "/",
    url: url_DeleteOrganizationConfigRule_773309,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePendingAggregationRequest_773322 = ref object of OpenApiRestCall_772597
proc url_DeletePendingAggregationRequest_773324(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeletePendingAggregationRequest_773323(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773334: Call_DeletePendingAggregationRequest_773322;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes pending authorization requests for a specified aggregator account in a specified region.
  ## 
...
proc call*(call_773335: Call_DeletePendingAggregationRequest_773322; body: JsonNode): Recallable =
...
var deletePendingAggregationRequest* = Call_DeletePendingAggregationRequest_773322(
    ...
    validator: validate_DeletePendingAggregationRequest_773323, base: "/",
    url: url_DeletePendingAggregationRequest_773324,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRemediationConfiguration_773337 = ref object of OpenApiRestCall_772597
proc url_DeleteRemediationConfiguration_773339(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteRemediationConfiguration_773338(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773349: Call_DeleteRemediationConfiguration_773337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the remediation configuration.
  ## 
...
proc call*(call_773350: Call_DeleteRemediationConfiguration_773337; body: JsonNode): Recallable =
...
var deleteRemediationConfiguration* = Call_DeleteRemediationConfiguration_773337(
    ...
    validator: validate_DeleteRemediationConfiguration_773338, base: "/",
    url: url_DeleteRemediationConfiguration_773339,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRemediationExceptions_773352 = ref object of OpenApiRestCall_772597
proc url_DeleteRemediationExceptions_773354(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteRemediationExceptions_773353(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773364: Call_DeleteRemediationExceptions_773352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes one or more remediation exceptions mentioned in the resource keys.
  ## 
...
proc call*(call_773365: Call_DeleteRemediationExceptions_773352; body: JsonNode): Recallable =
...
var deleteRemediationExceptions* = Call_DeleteRemediationExceptions_773352(
    ...
    validator: validate_DeleteRemediationExceptions_773353, base: "/",
    url: url_DeleteRemediationExceptions_773354,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRetentionConfiguration_773367 = ref object of OpenApiRestCall_772597
proc url_DeleteRetentionConfiguration_773369(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteRetentionConfiguration_773368(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773379: Call_DeleteRetentionConfiguration_773367; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the retention configuration.
  ## 
...
proc call*(call_773380: Call_DeleteRetentionConfiguration_773367; body: JsonNode): Recallable =
...
var deleteRetentionConfiguration* = Call_DeleteRetentionConfiguration_773367(
    ...
    validator: validate_DeleteRetentionConfiguration_773368, base: "/",
    url: url_DeleteRetentionConfiguration_773369,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeliverConfigSnapshot_773382 = ref object of OpenApiRestCall_772597
proc url_DeliverConfigSnapshot_773384(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeliverConfigSnapshot_773383(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773394: Call_DeliverConfigSnapshot_773382; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Schedules delivery of a configuration snapshot to the Amazon S3 bucket in the specified delivery channel. After the delivery has started, AWS Config sends the following notifications using an Amazon SNS topic that you have specified.</p> <ul> <li> <p>Notification of the start of the delivery.</p> </li> <li> <p>Notification of the completion of the delivery, if the delivery was successfully completed.</p> </li> <li> <p>Notification of delivery failure, if the delivery failed.</p> </li> </ul>
  ## 
...
proc call*(call_773395: Call_DeliverConfigSnapshot_773382; body: JsonNode): Recallable =
...
var deliverConfigSnapshot* = Call_DeliverConfigSnapshot_773382(
    name: "deliverConfigSnapshot", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DeliverConfigSnapshot",
    validator: validate_DeliverConfigSnapshot_773383, base: "/",
    url: url_DeliverConfigSnapshot_773384, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAggregateComplianceByConfigRules_773397 = ref object of OpenApiRestCall_772597
proc url_DescribeAggregateComplianceByConfigRules_773399(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeAggregateComplianceByConfigRules_773398(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773409: Call_DescribeAggregateComplianceByConfigRules_773397;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns a list of compliant and noncompliant rules with the number of resources for compliant and noncompliant rules. </p> <note> <p>The results can return an empty result page, but if you have a <code>nextToken</code>, the results are displayed on the next page.</p> </note>
  ## 
...
proc call*(call_773410: Call_DescribeAggregateComplianceByConfigRules_773397;
          body: JsonNode): Recallable =
...
var describeAggregateComplianceByConfigRules* = Call_DescribeAggregateComplianceByConfigRules_773397(
    ...
    validator: validate_DescribeAggregateComplianceByConfigRules_773398,
    base: "/", url: url_DescribeAggregateComplianceByConfigRules_773399,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAggregationAuthorizations_773412 = ref object of OpenApiRestCall_772597
proc url_DescribeAggregationAuthorizations_773414(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeAggregationAuthorizations_773413(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773424: Call_DescribeAggregationAuthorizations_773412;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns a list of authorizations granted to various aggregator accounts and regions.
  ## 
...
proc call*(call_773425: Call_DescribeAggregationAuthorizations_773412;
          body: JsonNode): Recallable =
...
var describeAggregationAuthorizations* = Call_DescribeAggregationAuthorizations_773412(
    ...
    validator: validate_DescribeAggregationAuthorizations_773413, base: "/",
    url: url_DescribeAggregationAuthorizations_773414,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeComplianceByConfigRule_773427 = ref object of OpenApiRestCall_772597
proc url_DescribeComplianceByConfigRule_773429(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeComplianceByConfigRule_773428(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773439: Call_DescribeComplianceByConfigRule_773427; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Indicates whether the specified AWS Config rules are compliant. If a rule is noncompliant, this action returns the number of AWS resources that do not comply with the rule.</p> <p>A rule is compliant if all of the evaluated resources comply with it. It is noncompliant if any of these resources do not comply.</p> <p>If AWS Config has no current evaluation results for the rule, it returns <code>INSUFFICIENT_DATA</code>. This result might indicate one of the following conditions:</p> <ul> <li> <p>AWS Config has never invoked an evaluation for the rule. To check whether it has, use the <code>DescribeConfigRuleEvaluationStatus</code> action to get the <code>LastSuccessfulInvocationTime</code> and <code>LastFailedInvocationTime</code>.</p> </li> <li> <p>The rule's AWS Lambda function is failing to send evaluation results to AWS Config. Verify that the role you assigned to your configuration recorder includes the <code>config:PutEvaluations</code> permission. If the rule is a custom rule, verify that the AWS Lambda execution role includes the <code>config:PutEvaluations</code> permission.</p> </li> <li> <p>The rule's AWS Lambda function has returned <code>NOT_APPLICABLE</code> for all evaluation results. This can occur if the resources were deleted or removed from the rule's scope.</p> </li> </ul>
  ## 
...
proc call*(call_773440: Call_DescribeComplianceByConfigRule_773427; body: JsonNode): Recallable =
...
var describeComplianceByConfigRule* = Call_DescribeComplianceByConfigRule_773427(
    ...
    validator: validate_DescribeComplianceByConfigRule_773428, base: "/",
    url: url_DescribeComplianceByConfigRule_773429,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeComplianceByResource_773442 = ref object of OpenApiRestCall_772597
proc url_DescribeComplianceByResource_773444(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeComplianceByResource_773443(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773454: Call_DescribeComplianceByResource_773442; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Indicates whether the specified AWS resources are compliant. If a resource is noncompliant, this action returns the number of AWS Config rules that the resource does not comply with.</p> <p>A resource is compliant if it complies with all the AWS Config rules that evaluate it. It is noncompliant if it does not comply with one or more of these rules.</p> <p>If AWS Config has no current evaluation results for the resource, it returns <code>INSUFFICIENT_DATA</code>. This result might indicate one of the following conditions about the rules that evaluate the resource:</p> <ul> <li> <p>AWS Config has never invoked an evaluation for the rule. To check whether it has, use the <code>DescribeConfigRuleEvaluationStatus</code> action to get the <code>LastSuccessfulInvocationTime</code> and <code>LastFailedInvocationTime</code>.</p> </li> <li> <p>The rule's AWS Lambda function is failing to send evaluation results to AWS Config. Verify that the role that you assigned to your configuration recorder includes the <code>config:PutEvaluations</code> permission. If the rule is a custom rule, verify that the AWS Lambda execution role includes the <code>config:PutEvaluations</code> permission.</p> </li> <li> <p>The rule's AWS Lambda function has returned <code>NOT_APPLICABLE</code> for all evaluation results. This can occur if the resources were deleted or removed from the rule's scope.</p> </li> </ul>
  ## 
...
proc call*(call_773455: Call_DescribeComplianceByResource_773442; body: JsonNode): Recallable =
...
var describeComplianceByResource* = Call_DescribeComplianceByResource_773442(
    ...
    validator: validate_DescribeComplianceByResource_773443, base: "/",
    url: url_DescribeComplianceByResource_773444,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigRuleEvaluationStatus_773457 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigRuleEvaluationStatus_773459(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigRuleEvaluationStatus_773458(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773469: Call_DescribeConfigRuleEvaluationStatus_773457;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns status information for each of your AWS managed Config rules. The status includes information such as the last time AWS Config invoked the rule, the last time AWS Config failed to invoke the rule, and the related error for the last failure.
  ## 
...
proc call*(call_773470: Call_DescribeConfigRuleEvaluationStatus_773457;
          body: JsonNode): Recallable =
...
var describeConfigRuleEvaluationStatus* = Call_DescribeConfigRuleEvaluationStatus_773457(
    ...
    validator: validate_DescribeConfigRuleEvaluationStatus_773458, base: "/",
    url: url_DescribeConfigRuleEvaluationStatus_773459,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigRules_773472 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigRules_773474(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigRules_773473(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_773484: Call_DescribeConfigRules_773472; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns details about your AWS Config rules.
  ## 
...
proc call*(call_773485: Call_DescribeConfigRules_773472; body: JsonNode): Recallable =
  ## describeConfigRules
  ## Returns details about your AWS Config rules.
  ##   body: JObject (required)
...
var describeConfigRules* = Call_DescribeConfigRules_773472(
    name: "describeConfigRules", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DescribeConfigRules",
    validator: validate_DescribeConfigRules_773473, base: "/",
    url: url_DescribeConfigRules_773474, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigurationAggregatorSourcesStatus_773487 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigurationAggregatorSourcesStatus_773489(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigurationAggregatorSourcesStatus_773488(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773499: Call_DescribeConfigurationAggregatorSourcesStatus_773487;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns status information for sources within an aggregator. The status includes information about the last time AWS Config verified authorization between the source account and an aggregator account. In case of a failure, the status contains the related error code or message. 
  ## 
...
proc call*(call_773500: Call_DescribeConfigurationAggregatorSourcesStatus_773487;
          body: JsonNode): Recallable =
...
var describeConfigurationAggregatorSourcesStatus* = Call_DescribeConfigurationAggregatorSourcesStatus_773487(
    ...
    validator: validate_DescribeConfigurationAggregatorSourcesStatus_773488,
    base: "/", url: url_DescribeConfigurationAggregatorSourcesStatus_773489,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigurationAggregators_773502 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigurationAggregators_773504(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigurationAggregators_773503(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773514: Call_DescribeConfigurationAggregators_773502;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the details of one or more configuration aggregators. If the configuration aggregator is not specified, this action returns the details for all the configuration aggregators associated with the account. 
  ## 
...
proc call*(call_773515: Call_DescribeConfigurationAggregators_773502;
          body: JsonNode): Recallable =
...
var describeConfigurationAggregators* = Call_DescribeConfigurationAggregators_773502(
    ...
    validator: validate_DescribeConfigurationAggregators_773503, base: "/",
    url: url_DescribeConfigurationAggregators_773504,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigurationRecorderStatus_773517 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigurationRecorderStatus_773519(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigurationRecorderStatus_773518(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773529: Call_DescribeConfigurationRecorderStatus_773517;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns the current status of the specified configuration recorder. If a configuration recorder is not specified, this action returns the status of all configuration recorders associated with the account.</p> <note> <p>Currently, you can specify only one configuration recorder per region in your account.</p> </note>
  ## 
...
proc call*(call_773530: Call_DescribeConfigurationRecorderStatus_773517;
          body: JsonNode): Recallable =
...
var describeConfigurationRecorderStatus* = Call_DescribeConfigurationRecorderStatus_773517(
    ...
    validator: validate_DescribeConfigurationRecorderStatus_773518, base: "/",
    url: url_DescribeConfigurationRecorderStatus_773519,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigurationRecorders_773532 = ref object of OpenApiRestCall_772597
proc url_DescribeConfigurationRecorders_773534(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConfigurationRecorders_773533(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773544: Call_DescribeConfigurationRecorders_773532; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the details for the specified configuration recorders. If the configuration recorder is not specified, this action returns the details for all configuration recorders associated with the account.</p> <note> <p>Currently, you can specify only one configuration recorder per region in your account.</p> </note>
  ## 
...
proc call*(call_773545: Call_DescribeConfigurationRecorders_773532; body: JsonNode): Recallable =
...
var describeConfigurationRecorders* = Call_DescribeConfigurationRecorders_773532(
    ...
    validator: validate_DescribeConfigurationRecorders_773533, base: "/",
    url: url_DescribeConfigurationRecorders_773534,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDeliveryChannelStatus_773547 = ref object of OpenApiRestCall_772597
proc url_DescribeDeliveryChannelStatus_773549(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeDeliveryChannelStatus_773548(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773559: Call_DescribeDeliveryChannelStatus_773547; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the current status of the specified delivery channel. If a delivery channel is not specified, this action returns the current status of all delivery channels associated with the account.</p> <note> <p>Currently, you can specify only one delivery channel per region in your account.</p> </note>
  ## 
...
proc call*(call_773560: Call_DescribeDeliveryChannelStatus_773547; body: JsonNode): Recallable =
...
var describeDeliveryChannelStatus* = Call_DescribeDeliveryChannelStatus_773547(
    ...
    validator: validate_DescribeDeliveryChannelStatus_773548, base: "/",
    url: url_DescribeDeliveryChannelStatus_773549,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDeliveryChannels_773562 = ref object of OpenApiRestCall_772597
proc url_DescribeDeliveryChannels_773564(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeDeliveryChannels_773563(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773574: Call_DescribeDeliveryChannels_773562; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns details about the specified delivery channel. If a delivery channel is not specified, this action returns the details of all delivery channels associated with the account.</p> <note> <p>Currently, you can specify only one delivery channel per region in your account.</p> </note>
  ## 
...
proc call*(call_773575: Call_DescribeDeliveryChannels_773562; body: JsonNode): Recallable =
...
var describeDeliveryChannels* = Call_DescribeDeliveryChannels_773562(
    name: "describeDeliveryChannels", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.DescribeDeliveryChannels",
    validator: validate_DescribeDeliveryChannels_773563, base: "/",
    url: url_DescribeDeliveryChannels_773564, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOrganizationConfigRuleStatuses_773577 = ref object of OpenApiRestCall_772597
proc url_DescribeOrganizationConfigRuleStatuses_773579(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeOrganizationConfigRuleStatuses_773578(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773589: Call_DescribeOrganizationConfigRuleStatuses_773577;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Provides organization config rule deployment status for an organization.</p> <note> <p>The status is not considered successful until organization config rule is successfully deployed in all the member accounts with an exception of excluded accounts.</p> <p>When you specify the limit and the next token, you receive a paginated response. Limit and next token are not applicable if you specify organization config rule names. It is only applicable, when you request all the organization config rules.</p> <p>Only a master account can call this API.</p> </note>
  ## 
...
proc call*(call_773590: Call_DescribeOrganizationConfigRuleStatuses_773577;
          body: JsonNode): Recallable =
...
var describeOrganizationConfigRuleStatuses* = Call_DescribeOrganizationConfigRuleStatuses_773577(
    ...
    validator: validate_DescribeOrganizationConfigRuleStatuses_773578, base: "/",
    url: url_DescribeOrganizationConfigRuleStatuses_773579,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOrganizationConfigRules_773592 = ref object of OpenApiRestCall_772597
proc url_DescribeOrganizationConfigRules_773594(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeOrganizationConfigRules_773593(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773604: Call_DescribeOrganizationConfigRules_773592;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns a list of organization config rules.</p> <note> <p>When you specify the limit and the next token, you receive a paginated response. Limit and next token are not applicable if you specify organization config rule names. It is only applicable, when you request all the organization config rules.</p> <p>Only a master account can call this API.</p> </note>
  ## 
...
proc call*(call_773605: Call_DescribeOrganizationConfigRules_773592; body: JsonNode): Recallable =
...
var describeOrganizationConfigRules* = Call_DescribeOrganizationConfigRules_773592(
    ...
    validator: validate_DescribeOrganizationConfigRules_773593, base: "/",
    url: url_DescribeOrganizationConfigRules_773594,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePendingAggregationRequests_773607 = ref object of OpenApiRestCall_772597
proc url_DescribePendingAggregationRequests_773609(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribePendingAggregationRequests_773608(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773619: Call_DescribePendingAggregationRequests_773607;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns a list of all pending aggregation requests.
  ## 
...
proc call*(call_773620: Call_DescribePendingAggregationRequests_773607;
          body: JsonNode): Recallable =
...
var describePendingAggregationRequests* = Call_DescribePendingAggregationRequests_773607(
    ...
    validator: validate_DescribePendingAggregationRequests_773608, base: "/",
    url: url_DescribePendingAggregationRequests_773609,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRemediationConfigurations_773622 = ref object of OpenApiRestCall_772597
proc url_DescribeRemediationConfigurations_773624(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeRemediationConfigurations_773623(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773634: Call_DescribeRemediationConfigurations_773622;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the details of one or more remediation configurations.
  ## 
...
proc call*(call_773635: Call_DescribeRemediationConfigurations_773622;
          body: JsonNode): Recallable =
...
var describeRemediationConfigurations* = Call_DescribeRemediationConfigurations_773622(
    ...
    validator: validate_DescribeRemediationConfigurations_773623, base: "/",
    url: url_DescribeRemediationConfigurations_773624,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRemediationExceptions_773637 = ref object of OpenApiRestCall_772597
proc url_DescribeRemediationExceptions_773639(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeRemediationExceptions_773638(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_773640 = query.getOrDefault("Limit")
  valid_773640 = validateParameter(valid_773640, JString, required = false,
                                 default = nil)
  if valid_773640 != nil:
    section.add "Limit", valid_773640
...
proc call*(call_773651: Call_DescribeRemediationExceptions_773637; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the details of one or more remediation exceptions. A detailed view of a remediation exception for a set of resources that includes an explanation of an exception and the time when the exception will be deleted. When you specify the limit and the next token, you receive a paginated response. </p> <note> <p>When you specify the limit and the next token, you receive a paginated response. </p> <p>Limit and next token are not applicable if you request resources in batch. It is only applicable, when you request all resources.</p> </note>
  ## 
...
proc call*(call_773652: Call_DescribeRemediationExceptions_773637; body: JsonNode;
  ...
  var body_773654 = newJObject()
  add(query_773653, "Limit", newJString(Limit))
  add(query_773653, "NextToken", newJString(NextToken))
  if body != nil:
    body_773654 = body
  result = call_773652.call(nil, query_773653, nil, nil, body_773654)

var describeRemediationExceptions* = Call_DescribeRemediationExceptions_773637(
    ...
    validator: validate_DescribeRemediationExceptions_773638, base: "/",
    url: url_DescribeRemediationExceptions_773639,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRemediationExecutionStatus_773656 = ref object of OpenApiRestCall_772597
proc url_DescribeRemediationExecutionStatus_773658(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeRemediationExecutionStatus_773657(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_773659 = query.getOrDefault("Limit")
  valid_773659 = validateParameter(valid_773659, JString, required = false,
                                 default = nil)
  if valid_773659 != nil:
    section.add "Limit", valid_773659
  var valid_773660 = query.getOrDefault("NextToken")
  valid_773660 = validateParameter(valid_773660, JString, required = false,
                                 default = nil)
  if valid_773660 != nil:
    section.add "NextToken", valid_773660
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773663 = header.getOrDefault("X-Amz-Target")
  valid_773663 = validateParameter(valid_773663, JString, required = true, default = newJString(
      "StarlingDoveService.DescribeRemediationExecutionStatus"))
  if valid_773663 != nil:
    section.add "X-Amz-Target", valid_773663
...
proc call*(call_773670: Call_DescribeRemediationExecutionStatus_773656;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Provides a detailed view of a Remediation Execution for a set of resources including state, timestamps for when steps for the remediation execution occur, and any error messages for steps that have failed. When you specify the limit and the next token, you receive a paginated response.
  ## 
...
proc call*(call_773671: Call_DescribeRemediationExecutionStatus_773656;
  ...
  add(query_773672, "Limit", newJString(Limit))
  add(query_773672, "NextToken", newJString(NextToken))
  if body != nil:
    body_773673 = body
  result = call_773671.call(nil, query_773672, nil, nil, body_773673)

var describeRemediationExecutionStatus* = Call_DescribeRemediationExecutionStatus_773656(
    ...
    validator: validate_DescribeRemediationExecutionStatus_773657, base: "/",
    url: url_DescribeRemediationExecutionStatus_773658,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRetentionConfigurations_773674 = ref object of OpenApiRestCall_772597
proc url_DescribeRetentionConfigurations_773676(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeRetentionConfigurations_773675(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773686: Call_DescribeRetentionConfigurations_773674;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns the details of one or more retention configurations. If the retention configuration name is not specified, this action returns the details for all the retention configurations for that account.</p> <note> <p>Currently, AWS Config supports only one retention configuration per region in your account.</p> </note>
  ## 
...
proc call*(call_773687: Call_DescribeRetentionConfigurations_773674; body: JsonNode): Recallable =
...
var describeRetentionConfigurations* = Call_DescribeRetentionConfigurations_773674(
    ...
    validator: validate_DescribeRetentionConfigurations_773675, base: "/",
    url: url_DescribeRetentionConfigurations_773676,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAggregateComplianceDetailsByConfigRule_773689 = ref object of OpenApiRestCall_772597
proc url_GetAggregateComplianceDetailsByConfigRule_773691(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAggregateComplianceDetailsByConfigRule_773690(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773701: Call_GetAggregateComplianceDetailsByConfigRule_773689;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns the evaluation results for the specified AWS Config rule for a specific resource in a rule. The results indicate which AWS resources were evaluated by the rule, when each resource was last evaluated, and whether each resource complies with the rule. </p> <note> <p>The results can return an empty result page. But if you have a <code>nextToken</code>, the results are displayed on the next page.</p> </note>
  ## 
...
proc call*(call_773702: Call_GetAggregateComplianceDetailsByConfigRule_773689;
          body: JsonNode): Recallable =
...
var getAggregateComplianceDetailsByConfigRule* = Call_GetAggregateComplianceDetailsByConfigRule_773689(
    ...
    validator: validate_GetAggregateComplianceDetailsByConfigRule_773690,
    base: "/", url: url_GetAggregateComplianceDetailsByConfigRule_773691,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAggregateConfigRuleComplianceSummary_773704 = ref object of OpenApiRestCall_772597
proc url_GetAggregateConfigRuleComplianceSummary_773706(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAggregateConfigRuleComplianceSummary_773705(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773716: Call_GetAggregateConfigRuleComplianceSummary_773704;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns the number of compliant and noncompliant rules for one or more accounts and regions in an aggregator.</p> <note> <p>The results can return an empty result page, but if you have a nextToken, the results are displayed on the next page.</p> </note>
  ## 
...
proc call*(call_773717: Call_GetAggregateConfigRuleComplianceSummary_773704;
          body: JsonNode): Recallable =
...
var getAggregateConfigRuleComplianceSummary* = Call_GetAggregateConfigRuleComplianceSummary_773704(
    ...
    validator: validate_GetAggregateConfigRuleComplianceSummary_773705, base: "/",
    url: url_GetAggregateConfigRuleComplianceSummary_773706,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAggregateDiscoveredResourceCounts_773719 = ref object of OpenApiRestCall_772597
proc url_GetAggregateDiscoveredResourceCounts_773721(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAggregateDiscoveredResourceCounts_773720(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773731: Call_GetAggregateDiscoveredResourceCounts_773719;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns the resource counts across accounts and regions that are present in your AWS Config aggregator. You can request the resource counts by providing filters and GroupByKey.</p> <p>For example, if the input contains accountID 12345678910 and region us-east-1 in filters, the API returns the count of resources in account ID 12345678910 and region us-east-1. If the input contains ACCOUNT_ID as a GroupByKey, the API returns resource counts for all source accounts that are present in your aggregator.</p>
  ## 
...
proc call*(call_773732: Call_GetAggregateDiscoveredResourceCounts_773719;
          body: JsonNode): Recallable =
...
var getAggregateDiscoveredResourceCounts* = Call_GetAggregateDiscoveredResourceCounts_773719(
    ...
    validator: validate_GetAggregateDiscoveredResourceCounts_773720, base: "/",
    url: url_GetAggregateDiscoveredResourceCounts_773721,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAggregateResourceConfig_773734 = ref object of OpenApiRestCall_772597
proc url_GetAggregateResourceConfig_773736(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetAggregateResourceConfig_773735(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773746: Call_GetAggregateResourceConfig_773734; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns configuration item that is aggregated for your specific resource in a specific source account and region.
  ## 
...
proc call*(call_773747: Call_GetAggregateResourceConfig_773734; body: JsonNode): Recallable =
...
var getAggregateResourceConfig* = Call_GetAggregateResourceConfig_773734(
    ...
    validator: validate_GetAggregateResourceConfig_773735, base: "/",
    url: url_GetAggregateResourceConfig_773736,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetComplianceDetailsByConfigRule_773749 = ref object of OpenApiRestCall_772597
proc url_GetComplianceDetailsByConfigRule_773751(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetComplianceDetailsByConfigRule_773750(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773761: Call_GetComplianceDetailsByConfigRule_773749;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the evaluation results for the specified AWS Config rule. The results indicate which AWS resources were evaluated by the rule, when each resource was last evaluated, and whether each resource complies with the rule.
  ## 
...
proc call*(call_773762: Call_GetComplianceDetailsByConfigRule_773749;
          body: JsonNode): Recallable =
...
var getComplianceDetailsByConfigRule* = Call_GetComplianceDetailsByConfigRule_773749(
    ...
    validator: validate_GetComplianceDetailsByConfigRule_773750, base: "/",
    url: url_GetComplianceDetailsByConfigRule_773751,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetComplianceDetailsByResource_773764 = ref object of OpenApiRestCall_772597
proc url_GetComplianceDetailsByResource_773766(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetComplianceDetailsByResource_773765(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773776: Call_GetComplianceDetailsByResource_773764; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the evaluation results for the specified AWS resource. The results indicate which AWS Config rules were used to evaluate the resource, when each rule was last used, and whether the resource complies with each rule.
  ## 
...
proc call*(call_773777: Call_GetComplianceDetailsByResource_773764; body: JsonNode): Recallable =
...
var getComplianceDetailsByResource* = Call_GetComplianceDetailsByResource_773764(
    ...
    validator: validate_GetComplianceDetailsByResource_773765, base: "/",
    url: url_GetComplianceDetailsByResource_773766,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetComplianceSummaryByConfigRule_773779 = ref object of OpenApiRestCall_772597
proc url_GetComplianceSummaryByConfigRule_773781(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetComplianceSummaryByConfigRule_773780(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773790: Call_GetComplianceSummaryByConfigRule_773779;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the number of AWS Config rules that are compliant and noncompliant, up to a maximum of 25 for each.
  ## 
...
proc call*(call_773791: Call_GetComplianceSummaryByConfigRule_773779): Recallable =
  ## getComplianceSummaryByConfigRule
  ## Returns the number of AWS Config rules that are compliant and noncompliant, up to a maximum of 25 for each.
  result = call_773791.call(nil, nil, nil, nil, nil)

var getComplianceSummaryByConfigRule* = Call_GetComplianceSummaryByConfigRule_773779(
    ...
    validator: validate_GetComplianceSummaryByConfigRule_773780, base: "/",
    url: url_GetComplianceSummaryByConfigRule_773781,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetComplianceSummaryByResourceType_773792 = ref object of OpenApiRestCall_772597
proc url_GetComplianceSummaryByResourceType_773794(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetComplianceSummaryByResourceType_773793(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773797 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_773797 != nil:
    section.add "X-Amz-Target", valid_773797
...
proc call*(call_773804: Call_GetComplianceSummaryByResourceType_773792;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the number of resources that are compliant and the number that are noncompliant. You can specify one or more resource types to get these numbers for each resource type. The maximum number returned is 100.
  ## 
...
proc call*(call_773805: Call_GetComplianceSummaryByResourceType_773792;
          body: JsonNode): Recallable =
  ## getComplianceSummaryByResourceType
  ## Returns the number of resources that are compliant and the number that are noncompliant. You can specify one or more resource types to get these numbers for each resource type. The maximum number returned is 100.
  ##   body: JObject (required)
  var body_773806 = newJObject()
  if body != nil:
    body_773806 = body
  result = call_773805.call(nil, nil, nil, nil, body_773806)

var getComplianceSummaryByResourceType* = Call_GetComplianceSummaryByResourceType_773792(
    ...
    validator: validate_GetComplianceSummaryByResourceType_773793, base: "/",
    url: url_GetComplianceSummaryByResourceType_773794,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDiscoveredResourceCounts_773807 = ref object of OpenApiRestCall_772597
proc url_GetDiscoveredResourceCounts_773809(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetDiscoveredResourceCounts_773808(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773812 = header.getOrDefault("X-Amz-Target")
  valid_773812 = validateParameter(valid_773812, JString, required = true, default = newJString(
      "StarlingDoveService.GetDiscoveredResourceCounts"))
  if valid_773812 != nil:
    section.add "X-Amz-Target", valid_773812
...
proc call*(call_773819: Call_GetDiscoveredResourceCounts_773807; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the resource types, the number of each resource type, and the total number of resources that AWS Config is recording in this region for your AWS account. </p> <p class="title"> <b>Example</b> </p> <ol> <li> <p>AWS Config is recording three resource types in the US East (Ohio) Region for your account: 25 EC2 instances, 20 IAM users, and 15 S3 buckets.</p> </li> <li> <p>You make a call to the <code>GetDiscoveredResourceCounts</code> action and specify that you want all resource types. </p> </li> <li> <p>AWS Config returns the following:</p> <ul> <li> <p>The resource types (EC2 instances, IAM users, and S3 buckets).</p> </li> <li> <p>The number of each resource type (25, 20, and 15).</p> </li> <li> <p>The total number of all resources (60).</p> </li> </ul> </li> </ol> <p>The response is paginated. By default, AWS Config lists 100 <a>ResourceCount</a> objects on each page. You can customize this number with the <code>limit</code> parameter. The response includes a <code>nextToken</code> string. To get the next page of results, run the request again and specify the string for the <code>nextToken</code> parameter.</p> <note> <p>If you make a call to the <a>GetDiscoveredResourceCounts</a> action, you might not immediately receive resource counts in the following situations:</p> <ul> <li> <p>You are a new AWS Config customer.</p> </li> <li> <p>You just enabled resource recording.</p> </li> </ul> <p>It might take a few minutes for AWS Config to record and count your resources. Wait a few minutes and then retry the <a>GetDiscoveredResourceCounts</a> action. </p> </note>
  ## 
...
proc call*(call_773820: Call_GetDiscoveredResourceCounts_773807; body: JsonNode): Recallable =
  ## getDiscoveredResourceCounts
  ## <p>Returns the resource types, the number of each resource type, and the total number of resources that AWS Config is recording in this region for your AWS account. </p> <p class="title"> <b>Example</b> </p> <ol> <li> <p>AWS Config is recording three resource types in the US East (Ohio) Region for your account: 25 EC2 instances, 20 IAM users, and 15 S3 buckets.</p> </li> <li> <p>You make a call to the <code>GetDiscoveredResourceCounts</code> action and specify that you want all resource types. </p> </li> <li> <p>AWS Config returns the following:</p> <ul> <li> <p>The resource types (EC2 instances, IAM users, and S3 buckets).</p> </li> <li> <p>The number of each resource type (25, 20, and 15).</p> </li> <li> <p>The total number of all resources (60).</p> </li> </ul> </li> </ol> <p>The response is paginated. By default, AWS Config lists 100 <a>ResourceCount</a> objects on each page. You can customize this number with the <code>limit</code> parameter. The response includes a <code>nextToken</code> string. To get the next page of results, run the request again and specify the string for the <code>nextToken</code> parameter.</p> <note> <p>If you make a call to the <a>GetDiscoveredResourceCounts</a> action, you might not immediately receive resource counts in the following situations:</p> <ul> <li> <p>You are a new AWS Config customer.</p> </li> <li> <p>You just enabled resource recording.</p> </li> </ul> <p>It might take a few minutes for AWS Config to record and count your resources. Wait a few minutes and then retry the <a>GetDiscoveredResourceCounts</a> action. </p> </note>
  ##   body: JObject (required)
  var body_773821 = newJObject()
  if body != nil:
    body_773821 = body
  result = call_773820.call(nil, nil, nil, nil, body_773821)

var getDiscoveredResourceCounts* = Call_GetDiscoveredResourceCounts_773807(
    ...
    validator: validate_GetDiscoveredResourceCounts_773808, base: "/",
    url: url_GetDiscoveredResourceCounts_773809,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOrganizationConfigRuleDetailedStatus_773822 = ref object of OpenApiRestCall_772597
proc url_GetOrganizationConfigRuleDetailedStatus_773824(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetOrganizationConfigRuleDetailedStatus_773823(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-Credential: JString
  section = newJObject()
  var valid_773825 = header.getOrDefault("X-Amz-Date")
  valid_773825 = validateParameter(valid_773825, JString, required = false,
                                 default = nil)
  if valid_773825 != nil:
    section.add "X-Amz-Date", valid_773825
  var valid_773826 = header.getOrDefault("X-Amz-Security-Token")
  valid_773826 = validateParameter(valid_773826, JString, required = false,
                                 default = nil)
  if valid_773826 != nil:
    section.add "X-Amz-Security-Token", valid_773826
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773827 = header.getOrDefault("X-Amz-Target")
  valid_773827 = validateParameter(valid_773827, JString, required = true, default = newJString(
      "StarlingDoveService.GetOrganizationConfigRuleDetailedStatus"))
  if valid_773827 != nil:
    section.add "X-Amz-Target", valid_773827
...
proc call*(call_773834: Call_GetOrganizationConfigRuleDetailedStatus_773822;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Returns detailed status for each member account within an organization for a given organization config rule.</p> <note> <p>Only a master account can call this API.</p> </note>
  ## 
...
proc call*(call_773835: Call_GetOrganizationConfigRuleDetailedStatus_773822;
          body: JsonNode): Recallable =
  ## getOrganizationConfigRuleDetailedStatus
  ## <p>Returns detailed status for each member account within an organization for a given organization config rule.</p> <note> <p>Only a master account can call this API.</p> </note>
  ##   body: JObject (required)
  var body_773836 = newJObject()
  if body != nil:
    body_773836 = body
  result = call_773835.call(nil, nil, nil, nil, body_773836)

var getOrganizationConfigRuleDetailedStatus* = Call_GetOrganizationConfigRuleDetailedStatus_773822(
    ...
    validator: validate_GetOrganizationConfigRuleDetailedStatus_773823, base: "/",
    url: url_GetOrganizationConfigRuleDetailedStatus_773824,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResourceConfigHistory_773837 = ref object of OpenApiRestCall_772597
proc url_GetResourceConfigHistory_773839(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetResourceConfigHistory_773838(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##        : Pagination limit
  section = newJObject()
  var valid_773840 = query.getOrDefault("nextToken")
  valid_773840 = validateParameter(valid_773840, JString, required = false,
                                 default = nil)
  if valid_773840 != nil:
    section.add "nextToken", valid_773840
  var valid_773841 = query.getOrDefault("limit")
  valid_773841 = validateParameter(valid_773841, JString, required = false,
                                 default = nil)
  if valid_773841 != nil:
    section.add "limit", valid_773841
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_773851: Call_GetResourceConfigHistory_773837; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns a list of configuration items for the specified resource. The list contains details about each state of the resource during the specified time interval. If you specified a retention period to retain your <code>ConfigurationItems</code> between a minimum of 30 days and a maximum of 7 years (2557 days), AWS Config returns the <code>ConfigurationItems</code> for the specified retention period. </p> <p>The response is paginated. By default, AWS Config returns a limit of 10 configuration items per page. You can customize this number with the <code>limit</code> parameter. The response includes a <code>nextToken</code> string. To get the next page of results, run the request again and specify the string for the <code>nextToken</code> parameter.</p> <note> <p>Each call to the API is limited to span a duration of seven days. It is likely that the number of records returned is smaller than the specified <code>limit</code>. In such cases, you can make another call, using the <code>nextToken</code>.</p> </note>
  ## 
...
proc call*(call_773852: Call_GetResourceConfigHistory_773837; body: JsonNode;
  ...
  var body_773854 = newJObject()
  add(query_773853, "nextToken", newJString(nextToken))
  if body != nil:
    body_773854 = body
  add(query_773853, "limit", newJString(limit))
  result = call_773852.call(nil, query_773853, nil, nil, body_773854)

var getResourceConfigHistory* = Call_GetResourceConfigHistory_773837(
    name: "getResourceConfigHistory", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.GetResourceConfigHistory",
    validator: validate_GetResourceConfigHistory_773838, base: "/",
    url: url_GetResourceConfigHistory_773839, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAggregateDiscoveredResources_773855 = ref object of OpenApiRestCall_772597
proc url_ListAggregateDiscoveredResources_773857(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListAggregateDiscoveredResources_773856(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773860 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_773860 != nil:
    section.add "X-Amz-Target", valid_773860
...
proc call*(call_773867: Call_ListAggregateDiscoveredResources_773855;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Accepts a resource type and returns a list of resource identifiers that are aggregated for a specific resource type across accounts and regions. A resource identifier includes the resource type, ID, (if available) the custom resource name, source account, and source region. You can narrow the results to include only resources that have specific resource IDs, or a resource name, or source account ID, or source region.</p> <p>For example, if the input consists of accountID 12345678910 and the region is us-east-1 for resource type <code>AWS::EC2::Instance</code> then the API returns all the EC2 instance identifiers of accountID 12345678910 and region us-east-1.</p>
  ## 
...
proc call*(call_773868: Call_ListAggregateDiscoveredResources_773855;
          body: JsonNode): Recallable =
  ## listAggregateDiscoveredResources
  ## <p>Accepts a resource type and returns a list of resource identifiers that are aggregated for a specific resource type across accounts and regions. A resource identifier includes the resource type, ID, (if available) the custom resource name, source account, and source region. You can narrow the results to include only resources that have specific resource IDs, or a resource name, or source account ID, or source region.</p> <p>For example, if the input consists of accountID 12345678910 and the region is us-east-1 for resource type <code>AWS::EC2::Instance</code> then the API returns all the EC2 instance identifiers of accountID 12345678910 and region us-east-1.</p>
  ##   body: JObject (required)
  var body_773869 = newJObject()
  if body != nil:
    body_773869 = body
  result = call_773868.call(nil, nil, nil, nil, body_773869)

var listAggregateDiscoveredResources* = Call_ListAggregateDiscoveredResources_773855(
    ...
    validator: validate_ListAggregateDiscoveredResources_773856, base: "/",
    url: url_ListAggregateDiscoveredResources_773857,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDiscoveredResources_773870 = ref object of OpenApiRestCall_772597
proc url_ListDiscoveredResources_773872(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListDiscoveredResources_773871(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773875 = header.getOrDefault("X-Amz-Target")
  valid_773875 = validateParameter(valid_773875, JString, required = true, default = newJString(
      "StarlingDoveService.ListDiscoveredResources"))
  if valid_773875 != nil:
    section.add "X-Amz-Target", valid_773875
...
proc call*(call_773882: Call_ListDiscoveredResources_773870; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Accepts a resource type and returns a list of resource identifiers for the resources of that type. A resource identifier includes the resource type, ID, and (if available) the custom resource name. The results consist of resources that AWS Config has discovered, including those that AWS Config is not currently recording. You can narrow the results to include only resources that have specific resource IDs or a resource name.</p> <note> <p>You can specify either resource IDs or a resource name, but not both, in the same request.</p> </note> <p>The response is paginated. By default, AWS Config lists 100 resource identifiers on each page. You can customize this number with the <code>limit</code> parameter. The response includes a <code>nextToken</code> string. To get the next page of results, run the request again and specify the string for the <code>nextToken</code> parameter.</p>
  ## 
...
proc call*(call_773883: Call_ListDiscoveredResources_773870; body: JsonNode): Recallable =
  ## listDiscoveredResources
  ## <p>Accepts a resource type and returns a list of resource identifiers for the resources of that type. A resource identifier includes the resource type, ID, and (if available) the custom resource name. The results consist of resources that AWS Config has discovered, including those that AWS Config is not currently recording. You can narrow the results to include only resources that have specific resource IDs or a resource name.</p> <note> <p>You can specify either resource IDs or a resource name, but not both, in the same request.</p> </note> <p>The response is paginated. By default, AWS Config lists 100 resource identifiers on each page. You can customize this number with the <code>limit</code> parameter. The response includes a <code>nextToken</code> string. To get the next page of results, run the request again and specify the string for the <code>nextToken</code> parameter.</p>
  ##   body: JObject (required)
  var body_773884 = newJObject()
  if body != nil:
    body_773884 = body
  result = call_773883.call(nil, nil, nil, nil, body_773884)

var listDiscoveredResources* = Call_ListDiscoveredResources_773870(
    name: "listDiscoveredResources", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.ListDiscoveredResources",
    validator: validate_ListDiscoveredResources_773871, base: "/",
    url: url_ListDiscoveredResources_773872, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_773885 = ref object of OpenApiRestCall_772597
proc url_ListTagsForResource_773887(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListTagsForResource_773886(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  ##   X-Amz-Credential: JString
  section = newJObject()
  var valid_773888 = header.getOrDefault("X-Amz-Date")
  valid_773888 = validateParameter(valid_773888, JString, required = false,
                                 default = nil)
  if valid_773888 != nil:
    section.add "X-Amz-Date", valid_773888
  var valid_773889 = header.getOrDefault("X-Amz-Security-Token")
  valid_773889 = validateParameter(valid_773889, JString, required = false,
                                 default = nil)
  if valid_773889 != nil:
    section.add "X-Amz-Security-Token", valid_773889
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773890 = header.getOrDefault("X-Amz-Target")
  valid_773890 = validateParameter(valid_773890, JString, required = true, default = newJString(
      "StarlingDoveService.ListTagsForResource"))
  if valid_773890 != nil:
    section.add "X-Amz-Target", valid_773890
...
proc call*(call_773897: Call_ListTagsForResource_773885; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the tags for AWS Config resource.
  ## 
...
proc call*(call_773898: Call_ListTagsForResource_773885; body: JsonNode): Recallable =
  ## listTagsForResource
  ## List the tags for AWS Config resource.
  ##   body: JObject (required)
  var body_773899 = newJObject()
  if body != nil:
    body_773899 = body
  result = call_773898.call(nil, nil, nil, nil, body_773899)

var listTagsForResource* = Call_ListTagsForResource_773885(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.ListTagsForResource",
    validator: validate_ListTagsForResource_773886, base: "/",
    url: url_ListTagsForResource_773887, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutAggregationAuthorization_773900 = ref object of OpenApiRestCall_772597
proc url_PutAggregationAuthorization_773902(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutAggregationAuthorization_773901(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_773912: Call_PutAggregationAuthorization_773900; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Authorizes the aggregator account and region to collect data from the source account and region. 
  ## 
...
proc call*(call_773913: Call_PutAggregationAuthorization_773900; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_773914 = body
  result = call_773913.call(nil, nil, nil, nil, body_773914)

var putAggregationAuthorization* = Call_PutAggregationAuthorization_773900(
    ...
    validator: validate_PutAggregationAuthorization_773901, base: "/",
    url: url_PutAggregationAuthorization_773902,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutConfigRule_773915 = ref object of OpenApiRestCall_772597
proc url_PutConfigRule_773917(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutConfigRule_773916(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_773927: Call_PutConfigRule_773915; path: JsonNode; query: JsonNode;
...
proc call*(call_773928: Call_PutConfigRule_773915; body: JsonNode): Recallable =
  ## putConfigRule
  ## <p>Adds or updates an AWS Config rule for evaluating whether your AWS resources comply with your desired configurations.</p> <p>You can use this action for custom AWS Config rules and AWS managed Config rules. A custom AWS Config rule is a rule that you develop and maintain. An AWS managed Config rule is a customizable, predefined rule that AWS Config provides.</p> <p>If you are adding a new custom AWS Config rule, you must first create the AWS Lambda function that the rule invokes to evaluate your resources. When you use the <code>PutConfigRule</code> action to add the rule to AWS Config, you must specify the Amazon Resource Name (ARN) that AWS Lambda assigns to the function. Specify the ARN for the <code>SourceIdentifier</code> key. This key is part of the <code>Source</code> object, which is part of the <code>ConfigRule</code> object. </p> <p>If you are adding an AWS managed Config rule, specify the rule's identifier for the <code>SourceIdentifier</code> key. To reference AWS managed Config rule identifiers, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html">About AWS Managed Config Rules</a>.</p> <p>For any new rule that you add, specify the <code>ConfigRuleName</code> in the <code>ConfigRule</code> object. Do not specify the <code>ConfigRuleArn</code> or the <code>ConfigRuleId</code>. These values are generated by AWS Config for new rules.</p> <p>If you are updating a rule that you added previously, you can specify the rule by <code>ConfigRuleName</code>, <code>ConfigRuleId</code>, or <code>ConfigRuleArn</code> in the <code>ConfigRule</code> data type that you use in this request.</p> <p>The maximum number of rules that AWS Config supports is 150.</p> <p>For information about requesting a rule limit increase, see <a href="http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_config">AWS Config Limits</a> in the <i>AWS General Reference Guide</i>.</p> <p>For more information about developing and using AWS Config rules, see <a href="https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config.html">Evaluating AWS Resource Configurations with AWS Config</a> in the <i>AWS Config Developer Guide</i>.</p>
  ##   body: JObject (required)
  var body_773929 = newJObject()
  if body != nil:
    body_773929 = body
  result = call_773928.call(nil, nil, nil, nil, body_773929)

var putConfigRule* = Call_PutConfigRule_773915(name: "putConfigRule",
    meth: HttpMethod.HttpPost, host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutConfigRule",
    validator: validate_PutConfigRule_773916, base: "/", url: url_PutConfigRule_773917,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutConfigurationAggregator_773930 = ref object of OpenApiRestCall_772597
proc url_PutConfigurationAggregator_773932(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutConfigurationAggregator_773931(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773935 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_773935 != nil:
    section.add "X-Amz-Target", valid_773935
...
proc call*(call_773942: Call_PutConfigurationAggregator_773930; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates and updates the configuration aggregator with the selected source accounts and regions. The source account can be individual account(s) or an organization.</p> <note> <p>AWS Config should be enabled in source accounts and regions you want to aggregate.</p> <p>If your source type is an organization, you must be signed in to the master account and all features must be enabled in your organization. AWS Config calls <code>EnableAwsServiceAccess</code> API to enable integration between AWS Config and AWS Organizations. </p> </note>
  ## 
  let valid = call_773942.validator(path, query, header, formData, body)
  let scheme = call_773942.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_773942.url(scheme.get, call_773942.host, call_773942.base,
                         call_773942.route, valid.getOrDefault("path"))
  result = hook(call_773942, url, valid)

proc call*(call_773943: Call_PutConfigurationAggregator_773930; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_773944 = body
  result = call_773943.call(nil, nil, nil, nil, body_773944)

var putConfigurationAggregator* = Call_PutConfigurationAggregator_773930(
    ...
    validator: validate_PutConfigurationAggregator_773931, base: "/",
    url: url_PutConfigurationAggregator_773932,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutConfigurationRecorder_773945 = ref object of OpenApiRestCall_772597
proc url_PutConfigurationRecorder_773947(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutConfigurationRecorder_773946(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773950 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_773950 != nil:
    section.add "X-Amz-Target", valid_773950
  var valid_773951 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_773951 = validateParameter(valid_773951, JString, required = false,
                                 default = nil)
  if valid_773951 != nil:
    section.add "X-Amz-Content-Sha256", valid_773951
  var valid_773952 = header.getOrDefault("X-Amz-Algorithm")
  valid_773952 = validateParameter(valid_773952, JString, required = false,
                                 default = nil)
  if valid_773952 != nil:
    section.add "X-Amz-Algorithm", valid_773952
  var valid_773953 = header.getOrDefault("X-Amz-Signature")
  valid_773953 = validateParameter(valid_773953, JString, required = false,
                                 default = nil)
  if valid_773953 != nil:
    section.add "X-Amz-Signature", valid_773953
  var valid_773954 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_773954 = validateParameter(valid_773954, JString, required = false,
                                 default = nil)
  if valid_773954 != nil:
    section.add "X-Amz-SignedHeaders", valid_773954
  var valid_773955 = header.getOrDefault("X-Amz-Credential")
  valid_773955 = validateParameter(valid_773955, JString, required = false,
                                 default = nil)
  if valid_773955 != nil:
    section.add "X-Amz-Credential", valid_773955
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_773957: Call_PutConfigurationRecorder_773945; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a new configuration recorder to record the selected resource configurations.</p> <p>You can use this action to change the role <code>roleARN</code> or the <code>recordingGroup</code> of an existing recorder. To change the role, call the action on the existing configuration recorder and specify a role.</p> <note> <p>Currently, you can specify only one configuration recorder per region in your account.</p> <p>If <code>ConfigurationRecorder</code> does not have the <b>recordingGroup</b> parameter specified, the default is to record all supported resource types.</p> </note>
  ## 
...
proc call*(call_773958: Call_PutConfigurationRecorder_773945; body: JsonNode): Recallable =
  ## putConfigurationRecorder
  ## <p>Creates a new configuration recorder to record the selected resource configurations.</p> <p>You can use this action to change the role <code>roleARN</code> or the <code>recordingGroup</code> of an existing recorder. To change the role, call the action on the existing configuration recorder and specify a role.</p> <note> <p>Currently, you can specify only one configuration recorder per region in your account.</p> <p>If <code>ConfigurationRecorder</code> does not have the <b>recordingGroup</b> parameter specified, the default is to record all supported resource types.</p> </note>
  ##   body: JObject (required)
  var body_773959 = newJObject()
  if body != nil:
    body_773959 = body
  result = call_773958.call(nil, nil, nil, nil, body_773959)

var putConfigurationRecorder* = Call_PutConfigurationRecorder_773945(
    name: "putConfigurationRecorder", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutConfigurationRecorder",
    validator: validate_PutConfigurationRecorder_773946, base: "/",
    url: url_PutConfigurationRecorder_773947, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutDeliveryChannel_773960 = ref object of OpenApiRestCall_772597
proc url_PutDeliveryChannel_773962(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutDeliveryChannel_773961(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773965 = header.getOrDefault("X-Amz-Target")
  valid_773965 = validateParameter(valid_773965, JString, required = true, default = newJString(
      "StarlingDoveService.PutDeliveryChannel"))
  if valid_773965 != nil:
    section.add "X-Amz-Target", valid_773965
  var valid_773966 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_773966 = validateParameter(valid_773966, JString, required = false,
                                 default = nil)
  if valid_773966 != nil:
    section.add "X-Amz-Content-Sha256", valid_773966
  var valid_773967 = header.getOrDefault("X-Amz-Algorithm")
  valid_773967 = validateParameter(valid_773967, JString, required = false,
                                 default = nil)
  if valid_773967 != nil:
    section.add "X-Amz-Algorithm", valid_773967
  var valid_773968 = header.getOrDefault("X-Amz-Signature")
  valid_773968 = validateParameter(valid_773968, JString, required = false,
                                 default = nil)
  if valid_773968 != nil:
    section.add "X-Amz-Signature", valid_773968
  var valid_773969 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_773969 = validateParameter(valid_773969, JString, required = false,
                                 default = nil)
  if valid_773969 != nil:
    section.add "X-Amz-SignedHeaders", valid_773969
  var valid_773970 = header.getOrDefault("X-Amz-Credential")
  valid_773970 = validateParameter(valid_773970, JString, required = false,
                                 default = nil)
  if valid_773970 != nil:
    section.add "X-Amz-Credential", valid_773970
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_773972: Call_PutDeliveryChannel_773960; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a delivery channel object to deliver configuration information to an Amazon S3 bucket and Amazon SNS topic.</p> <p>Before you can create a delivery channel, you must create a configuration recorder.</p> <p>You can use this action to change the Amazon S3 bucket or an Amazon SNS topic of the existing delivery channel. To change the Amazon S3 bucket or an Amazon SNS topic, call this action and specify the changed values for the S3 bucket and the SNS topic. If you specify a different value for either the S3 bucket or the SNS topic, this action will keep the existing value for the parameter that is not changed.</p> <note> <p>You can have only one delivery channel per region in your account.</p> </note>
  ## 
  let valid = call_773972.validator(path, query, header, formData, body)
  let scheme = call_773972.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_773972.url(scheme.get, call_773972.host, call_773972.base,
                         call_773972.route, valid.getOrDefault("path"))
  result = hook(call_773972, url, valid)

proc call*(call_773973: Call_PutDeliveryChannel_773960; body: JsonNode): Recallable =
  ## putDeliveryChannel
  ## <p>Creates a delivery channel object to deliver configuration information to an Amazon S3 bucket and Amazon SNS topic.</p> <p>Before you can create a delivery channel, you must create a configuration recorder.</p> <p>You can use this action to change the Amazon S3 bucket or an Amazon SNS topic of the existing delivery channel. To change the Amazon S3 bucket or an Amazon SNS topic, call this action and specify the changed values for the S3 bucket and the SNS topic. If you specify a different value for either the S3 bucket or the SNS topic, this action will keep the existing value for the parameter that is not changed.</p> <note> <p>You can have only one delivery channel per region in your account.</p> </note>
  ##   body: JObject (required)
  var body_773974 = newJObject()
  if body != nil:
    body_773974 = body
  result = call_773973.call(nil, nil, nil, nil, body_773974)

var putDeliveryChannel* = Call_PutDeliveryChannel_773960(
    name: "putDeliveryChannel", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutDeliveryChannel",
    validator: validate_PutDeliveryChannel_773961, base: "/",
    url: url_PutDeliveryChannel_773962, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutEvaluations_773975 = ref object of OpenApiRestCall_772597
proc url_PutEvaluations_773977(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutEvaluations_773976(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773980 = header.getOrDefault("X-Amz-Target")
  valid_773980 = validateParameter(valid_773980, JString, required = true, default = newJString(
      "StarlingDoveService.PutEvaluations"))
  if valid_773980 != nil:
    section.add "X-Amz-Target", valid_773980
  var valid_773981 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_773981 = validateParameter(valid_773981, JString, required = false,
                                 default = nil)
  if valid_773981 != nil:
    section.add "X-Amz-Content-Sha256", valid_773981
  var valid_773982 = header.getOrDefault("X-Amz-Algorithm")
  valid_773982 = validateParameter(valid_773982, JString, required = false,
                                 default = nil)
  if valid_773982 != nil:
    section.add "X-Amz-Algorithm", valid_773982
  var valid_773983 = header.getOrDefault("X-Amz-Signature")
  valid_773983 = validateParameter(valid_773983, JString, required = false,
                                 default = nil)
  if valid_773983 != nil:
    section.add "X-Amz-Signature", valid_773983
  var valid_773984 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_773984 = validateParameter(valid_773984, JString, required = false,
                                 default = nil)
  if valid_773984 != nil:
    section.add "X-Amz-SignedHeaders", valid_773984
  var valid_773985 = header.getOrDefault("X-Amz-Credential")
  valid_773985 = validateParameter(valid_773985, JString, required = false,
                                 default = nil)
  if valid_773985 != nil:
    section.add "X-Amz-Credential", valid_773985
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_773987: Call_PutEvaluations_773975; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Used by an AWS Lambda function to deliver evaluation results to AWS Config. This action is required in every AWS Lambda function that is invoked by an AWS Config rule.
  ## 
...
proc call*(call_773988: Call_PutEvaluations_773975; body: JsonNode): Recallable =
  ## putEvaluations
  ## Used by an AWS Lambda function to deliver evaluation results to AWS Config. This action is required in every AWS Lambda function that is invoked by an AWS Config rule.
  ##   body: JObject (required)
  var body_773989 = newJObject()
  if body != nil:
    body_773989 = body
  result = call_773988.call(nil, nil, nil, nil, body_773989)

var putEvaluations* = Call_PutEvaluations_773975(name: "putEvaluations",
    meth: HttpMethod.HttpPost, host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutEvaluations",
    validator: validate_PutEvaluations_773976, base: "/", url: url_PutEvaluations_773977,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutOrganizationConfigRule_773990 = ref object of OpenApiRestCall_772597
proc url_PutOrganizationConfigRule_773992(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutOrganizationConfigRule_773991(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_773995 = header.getOrDefault("X-Amz-Target")
  valid_773995 = validateParameter(valid_773995, JString, required = true, default = newJString(
      "StarlingDoveService.PutOrganizationConfigRule"))
  if valid_773995 != nil:
    section.add "X-Amz-Target", valid_773995
  var valid_773996 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_773996 = validateParameter(valid_773996, JString, required = false,
                                 default = nil)
  if valid_773996 != nil:
    section.add "X-Amz-Content-Sha256", valid_773996
  var valid_773997 = header.getOrDefault("X-Amz-Algorithm")
  valid_773997 = validateParameter(valid_773997, JString, required = false,
                                 default = nil)
  if valid_773997 != nil:
    section.add "X-Amz-Algorithm", valid_773997
  var valid_773998 = header.getOrDefault("X-Amz-Signature")
  valid_773998 = validateParameter(valid_773998, JString, required = false,
                                 default = nil)
  if valid_773998 != nil:
    section.add "X-Amz-Signature", valid_773998
  var valid_773999 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_773999 = validateParameter(valid_773999, JString, required = false,
                                 default = nil)
  if valid_773999 != nil:
    section.add "X-Amz-SignedHeaders", valid_773999
  var valid_774000 = header.getOrDefault("X-Amz-Credential")
  valid_774000 = validateParameter(valid_774000, JString, required = false,
                                 default = nil)
  if valid_774000 != nil:
    section.add "X-Amz-Credential", valid_774000
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_774002: Call_PutOrganizationConfigRule_773990; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Adds or updates organization config rule for your entire organization evaluating whether your AWS resources comply with your desired configurations. Only a master account can create or update an organization config rule.</p> <p>This API enables organization service access through the <code>EnableAWSServiceAccess</code> action and creates a service linked role <code>AWSServiceRoleForConfigMultiAccountSetup</code> in the master account of your organization. The service linked role is created only when the role does not exist in the master account. AWS Config verifies the existence of role with <code>GetRole</code> action.</p> <p>You can use this action to create both custom AWS Config rules and AWS managed Config rules. If you are adding a new custom AWS Config rule, you must first create AWS Lambda function in the master account that the rule invokes to evaluate your resources. When you use the <code>PutOrganizationConfigRule</code> action to add the rule to AWS Config, you must specify the Amazon Resource Name (ARN) that AWS Lambda assigns to the function. If you are adding an AWS managed Config rule, specify the rule's identifier for the <code>RuleIdentifier</code> key.</p> <p>The maximum number of organization config rules that AWS Config supports is 150.</p> <note> <p>Specify either <code>OrganizationCustomRuleMetadata</code> or <code>OrganizationManagedRuleMetadata</code>.</p> </note>
  ## 
...
proc call*(call_774003: Call_PutOrganizationConfigRule_773990; body: JsonNode): Recallable =
  ## putOrganizationConfigRule
  ## <p>Adds or updates organization config rule for your entire organization evaluating whether your AWS resources comply with your desired configurations. Only a master account can create or update an organization config rule.</p> <p>This API enables organization service access through the <code>EnableAWSServiceAccess</code> action and creates a service linked role <code>AWSServiceRoleForConfigMultiAccountSetup</code> in the master account of your organization. The service linked role is created only when the role does not exist in the master account. AWS Config verifies the existence of role with <code>GetRole</code> action.</p> <p>You can use this action to create both custom AWS Config rules and AWS managed Config rules. If you are adding a new custom AWS Config rule, you must first create AWS Lambda function in the master account that the rule invokes to evaluate your resources. When you use the <code>PutOrganizationConfigRule</code> action to add the rule to AWS Config, you must specify the Amazon Resource Name (ARN) that AWS Lambda assigns to the function. If you are adding an AWS managed Config rule, specify the rule's identifier for the <code>RuleIdentifier</code> key.</p> <p>The maximum number of organization config rules that AWS Config supports is 150.</p> <note> <p>Specify either <code>OrganizationCustomRuleMetadata</code> or <code>OrganizationManagedRuleMetadata</code>.</p> </note>
  ##   body: JObject (required)
  var body_774004 = newJObject()
  if body != nil:
    body_774004 = body
  result = call_774003.call(nil, nil, nil, nil, body_774004)

var putOrganizationConfigRule* = Call_PutOrganizationConfigRule_773990(
    name: "putOrganizationConfigRule", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutOrganizationConfigRule",
    validator: validate_PutOrganizationConfigRule_773991, base: "/",
    url: url_PutOrganizationConfigRule_773992,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutRemediationConfigurations_774005 = ref object of OpenApiRestCall_772597
proc url_PutRemediationConfigurations_774007(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutRemediationConfigurations_774006(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774010 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_774010 != nil:
    section.add "X-Amz-Target", valid_774010
...
proc call*(call_774017: Call_PutRemediationConfigurations_774005; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds or updates the remediation configuration with a specific AWS Config rule with the selected target or action. The API creates the <code>RemediationConfiguration</code> object for the AWS Config rule. The AWS Config rule must already exist for you to add a remediation configuration. The target (SSM document) must exist and have permissions to use the target. 
  ## 
...
proc call*(call_774018: Call_PutRemediationConfigurations_774005; body: JsonNode): Recallable =
  ## putRemediationConfigurations
  ## Adds or updates the remediation configuration with a specific AWS Config rule with the selected target or action. The API creates the <code>RemediationConfiguration</code> object for the AWS Config rule. The AWS Config rule must already exist for you to add a remediation configuration. The target (SSM document) must exist and have permissions to use the target. 
  ##   body: JObject (required)
  var body_774019 = newJObject()
  if body != nil:
    body_774019 = body
  result = call_774018.call(nil, nil, nil, nil, body_774019)

var putRemediationConfigurations* = Call_PutRemediationConfigurations_774005(
    ...
    validator: validate_PutRemediationConfigurations_774006, base: "/",
    url: url_PutRemediationConfigurations_774007,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutRemediationExceptions_774020 = ref object of OpenApiRestCall_772597
proc url_PutRemediationExceptions_774022(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutRemediationExceptions_774021(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774025 = header.getOrDefault("X-Amz-Target")
  valid_774025 = validateParameter(valid_774025, JString, required = true, default = newJString(
      "StarlingDoveService.PutRemediationExceptions"))
  if valid_774025 != nil:
    section.add "X-Amz-Target", valid_774025
...
proc call*(call_774032: Call_PutRemediationExceptions_774020; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A remediation exception is when a specific resource is no longer considered for auto-remediation. This API adds a new exception or updates an exisiting exception for a specific resource with a specific AWS Config rule. 
  ## 
...
proc call*(call_774033: Call_PutRemediationExceptions_774020; body: JsonNode): Recallable =
  ## putRemediationExceptions
  ## A remediation exception is when a specific resource is no longer considered for auto-remediation. This API adds a new exception or updates an exisiting exception for a specific resource with a specific AWS Config rule. 
  ##   body: JObject (required)
  var body_774034 = newJObject()
  if body != nil:
    body_774034 = body
  result = call_774033.call(nil, nil, nil, nil, body_774034)

var putRemediationExceptions* = Call_PutRemediationExceptions_774020(
    name: "putRemediationExceptions", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutRemediationExceptions",
    validator: validate_PutRemediationExceptions_774021, base: "/",
    url: url_PutRemediationExceptions_774022, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutRetentionConfiguration_774035 = ref object of OpenApiRestCall_772597
proc url_PutRetentionConfiguration_774037(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutRetentionConfiguration_774036(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774040 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_774040 != nil:
    section.add "X-Amz-Target", valid_774040
...
proc call*(call_774047: Call_PutRetentionConfiguration_774035; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates and updates the retention configuration with details about retention period (number of days) that AWS Config stores your historical information. The API creates the <code>RetentionConfiguration</code> object and names the object as <b>default</b>. When you have a <code>RetentionConfiguration</code> object named <b>default</b>, calling the API modifies the default object. </p> <note> <p>Currently, AWS Config supports only one retention configuration per region in your account.</p> </note>
  ## 
...
proc call*(call_774048: Call_PutRetentionConfiguration_774035; body: JsonNode): Recallable =
  ## putRetentionConfiguration
  ## <p>Creates and updates the retention configuration with details about retention period (number of days) that AWS Config stores your historical information. The API creates the <code>RetentionConfiguration</code> object and names the object as <b>default</b>. When you have a <code>RetentionConfiguration</code> object named <b>default</b>, calling the API modifies the default object. </p> <note> <p>Currently, AWS Config supports only one retention configuration per region in your account.</p> </note>
  ##   body: JObject (required)
  var body_774049 = newJObject()
  if body != nil:
    body_774049 = body
  result = call_774048.call(nil, nil, nil, nil, body_774049)

var putRetentionConfiguration* = Call_PutRetentionConfiguration_774035(
    name: "putRetentionConfiguration", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.PutRetentionConfiguration",
    validator: validate_PutRetentionConfiguration_774036, base: "/",
    url: url_PutRetentionConfiguration_774037,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SelectResourceConfig_774050 = ref object of OpenApiRestCall_772597
proc url_SelectResourceConfig_774052(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_SelectResourceConfig_774051(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774055 = header.getOrDefault("X-Amz-Target")
  valid_774055 = validateParameter(valid_774055, JString, required = true, default = newJString(
      "StarlingDoveService.SelectResourceConfig"))
  if valid_774055 != nil:
    section.add "X-Amz-Target", valid_774055
  var valid_774056 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_774056 = validateParameter(valid_774056, JString, required = false,
                                 default = nil)
  if valid_774056 != nil:
    section.add "X-Amz-Content-Sha256", valid_774056
  var valid_774057 = header.getOrDefault("X-Amz-Algorithm")
  valid_774057 = validateParameter(valid_774057, JString, required = false,
                                 default = nil)
  if valid_774057 != nil:
    section.add "X-Amz-Algorithm", valid_774057
  var valid_774058 = header.getOrDefault("X-Amz-Signature")
  valid_774058 = validateParameter(valid_774058, JString, required = false,
                                 default = nil)
  if valid_774058 != nil:
    section.add "X-Amz-Signature", valid_774058
  var valid_774059 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_774059 = validateParameter(valid_774059, JString, required = false,
                                 default = nil)
  if valid_774059 != nil:
    section.add "X-Amz-SignedHeaders", valid_774059
  var valid_774060 = header.getOrDefault("X-Amz-Credential")
  valid_774060 = validateParameter(valid_774060, JString, required = false,
                                 default = nil)
  if valid_774060 != nil:
    section.add "X-Amz-Credential", valid_774060
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_774062: Call_SelectResourceConfig_774050; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Accepts a structured query language (SQL) <code>SELECT</code> command, performs the corresponding search, and returns resource configurations matching the properties.</p> <p>For more information about query components, see the <a href="https://docs.aws.amazon.com/config/latest/developerguide/query-components.html"> <b>Query Components</b> </a> section in the AWS Config Developer Guide.</p>
  ## 
...
proc call*(call_774063: Call_SelectResourceConfig_774050; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_774064 = body
  result = call_774063.call(nil, nil, nil, nil, body_774064)

var selectResourceConfig* = Call_SelectResourceConfig_774050(
    name: "selectResourceConfig", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.SelectResourceConfig",
    validator: validate_SelectResourceConfig_774051, base: "/",
    url: url_SelectResourceConfig_774052, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartConfigRulesEvaluation_774065 = ref object of OpenApiRestCall_772597
proc url_StartConfigRulesEvaluation_774067(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartConfigRulesEvaluation_774066(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774070 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_774070 != nil:
    section.add "X-Amz-Target", valid_774070
...
proc call*(call_774077: Call_StartConfigRulesEvaluation_774065; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Runs an on-demand evaluation for the specified AWS Config rules against the last known configuration state of the resources. Use <code>StartConfigRulesEvaluation</code> when you want to test that a rule you updated is working as expected. <code>StartConfigRulesEvaluation</code> does not re-record the latest configuration state for your resources. It re-runs an evaluation against the last known state of your resources. </p> <p>You can specify up to 25 AWS Config rules per request. </p> <p>An existing <code>StartConfigRulesEvaluation</code> call for the specified rules must complete before you can call the API again. If you chose to have AWS Config stream to an Amazon SNS topic, you will receive a <code>ConfigRuleEvaluationStarted</code> notification when the evaluation starts.</p> <note> <p>You don't need to call the <code>StartConfigRulesEvaluation</code> API to run an evaluation for a new rule. When you create a rule, AWS Config evaluates your resources against the rule automatically. </p> </note> <p>The <code>StartConfigRulesEvaluation</code> API is useful if you want to run on-demand evaluations, such as the following example:</p> <ol> <li> <p>You have a custom rule that evaluates your IAM resources every 24 hours.</p> </li> <li> <p>You update your Lambda function to add additional conditions to your rule.</p> </li> <li> <p>Instead of waiting for the next periodic evaluation, you call the <code>StartConfigRulesEvaluation</code> API.</p> </li> <li> <p>AWS Config invokes your Lambda function and evaluates your IAM resources.</p> </li> <li> <p>Your custom rule will still run periodic evaluations every 24 hours.</p> </li> </ol>
  ## 
...
proc call*(call_774078: Call_StartConfigRulesEvaluation_774065; body: JsonNode): Recallable =
  ## startConfigRulesEvaluation
  ## <p>Runs an on-demand evaluation for the specified AWS Config rules against the last known configuration state of the resources. Use <code>StartConfigRulesEvaluation</code> when you want to test that a rule you updated is working as expected. <code>StartConfigRulesEvaluation</code> does not re-record the latest configuration state for your resources. It re-runs an evaluation against the last known state of your resources. </p> <p>You can specify up to 25 AWS Config rules per request. </p> <p>An existing <code>StartConfigRulesEvaluation</code> call for the specified rules must complete before you can call the API again. If you chose to have AWS Config stream to an Amazon SNS topic, you will receive a <code>ConfigRuleEvaluationStarted</code> notification when the evaluation starts.</p> <note> <p>You don't need to call the <code>StartConfigRulesEvaluation</code> API to run an evaluation for a new rule. When you create a rule, AWS Config evaluates your resources against the rule automatically. </p> </note> <p>The <code>StartConfigRulesEvaluation</code> API is useful if you want to run on-demand evaluations, such as the following example:</p> <ol> <li> <p>You have a custom rule that evaluates your IAM resources every 24 hours.</p> </li> <li> <p>You update your Lambda function to add additional conditions to your rule.</p> </li> <li> <p>Instead of waiting for the next periodic evaluation, you call the <code>StartConfigRulesEvaluation</code> API.</p> </li> <li> <p>AWS Config invokes your Lambda function and evaluates your IAM resources.</p> </li> <li> <p>Your custom rule will still run periodic evaluations every 24 hours.</p> </li> </ol>
  ##   body: JObject (required)
  var body_774079 = newJObject()
  if body != nil:
    body_774079 = body
  result = call_774078.call(nil, nil, nil, nil, body_774079)

var startConfigRulesEvaluation* = Call_StartConfigRulesEvaluation_774065(
    ...
    validator: validate_StartConfigRulesEvaluation_774066, base: "/",
    url: url_StartConfigRulesEvaluation_774067,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartConfigurationRecorder_774080 = ref object of OpenApiRestCall_772597
proc url_StartConfigurationRecorder_774082(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartConfigurationRecorder_774081(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774085 = header.getOrDefault("X-Amz-Target")
  valid_774085 = validateParameter(valid_774085, JString, required = true, default = newJString(
      "StarlingDoveService.StartConfigurationRecorder"))
  if valid_774085 != nil:
    section.add "X-Amz-Target", valid_774085
...
proc call*(call_774092: Call_StartConfigurationRecorder_774080; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Starts recording configurations of the AWS resources you have selected to record in your AWS account.</p> <p>You must have created at least one delivery channel to successfully start the configuration recorder.</p>
  ## 
  let valid = call_774092.validator(path, query, header, formData, body)
  let scheme = call_774092.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_774092.url(scheme.get, call_774092.host, call_774092.base,
                         call_774092.route, valid.getOrDefault("path"))
  result = hook(call_774092, url, valid)

proc call*(call_774093: Call_StartConfigurationRecorder_774080; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_774094 = body
  result = call_774093.call(nil, nil, nil, nil, body_774094)

var startConfigurationRecorder* = Call_StartConfigurationRecorder_774080(
    ...
    validator: validate_StartConfigurationRecorder_774081, base: "/",
    url: url_StartConfigurationRecorder_774082,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartRemediationExecution_774095 = ref object of OpenApiRestCall_772597
proc url_StartRemediationExecution_774097(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartRemediationExecution_774096(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774100 = header.getOrDefault("X-Amz-Target")
  valid_774100 = validateParameter(valid_774100, JString, required = true, default = newJString(
      "StarlingDoveService.StartRemediationExecution"))
  if valid_774100 != nil:
    section.add "X-Amz-Target", valid_774100
...
proc call*(call_774107: Call_StartRemediationExecution_774095; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Runs an on-demand remediation for the specified AWS Config rules against the last known remediation configuration. It runs an execution against the current state of your resources. Remediation execution is asynchronous.</p> <p>You can specify up to 100 resource keys per request. An existing StartRemediationExecution call for the specified resource keys must complete before you can call the API again.</p>
  ## 
...
proc call*(call_774108: Call_StartRemediationExecution_774095; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_774109 = body
  result = call_774108.call(nil, nil, nil, nil, body_774109)

var startRemediationExecution* = Call_StartRemediationExecution_774095(
    name: "startRemediationExecution", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.StartRemediationExecution",
    validator: validate_StartRemediationExecution_774096, base: "/",
    url: url_StartRemediationExecution_774097,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopConfigurationRecorder_774110 = ref object of OpenApiRestCall_772597
proc url_StopConfigurationRecorder_774112(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StopConfigurationRecorder_774111(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774115 = header.getOrDefault("X-Amz-Target")
  valid_774115 = validateParameter(valid_774115, JString, required = true, default = newJString(
      "StarlingDoveService.StopConfigurationRecorder"))
  if valid_774115 != nil:
    section.add "X-Amz-Target", valid_774115
...
proc call*(call_774122: Call_StopConfigurationRecorder_774110; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops recording configurations of the AWS resources you have selected to record in your AWS account.
  ## 
...
proc call*(call_774123: Call_StopConfigurationRecorder_774110; body: JsonNode): Recallable =
  ## stopConfigurationRecorder
  ## Stops recording configurations of the AWS resources you have selected to record in your AWS account.
  ##   body: JObject (required)
  var body_774124 = newJObject()
  if body != nil:
    body_774124 = body
  result = call_774123.call(nil, nil, nil, nil, body_774124)

var stopConfigurationRecorder* = Call_StopConfigurationRecorder_774110(
    name: "stopConfigurationRecorder", meth: HttpMethod.HttpPost,
    host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.StopConfigurationRecorder",
    validator: validate_StopConfigurationRecorder_774111, base: "/",
    url: url_StopConfigurationRecorder_774112,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_774125 = ref object of OpenApiRestCall_772597
proc url_TagResource_774127(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_TagResource_774126(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-Credential: JString
  section = newJObject()
  var valid_774128 = header.getOrDefault("X-Amz-Date")
  valid_774128 = validateParameter(valid_774128, JString, required = false,
                                 default = nil)
  if valid_774128 != nil:
    section.add "X-Amz-Date", valid_774128
  var valid_774129 = header.getOrDefault("X-Amz-Security-Token")
  valid_774129 = validateParameter(valid_774129, JString, required = false,
                                 default = nil)
  if valid_774129 != nil:
    section.add "X-Amz-Security-Token", valid_774129
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_774130 = header.getOrDefault("X-Amz-Target")
  valid_774130 = validateParameter(valid_774130, JString, required = true, default = newJString(
      "StarlingDoveService.TagResource"))
  if valid_774130 != nil:
    section.add "X-Amz-Target", valid_774130
...
proc call*(call_774137: Call_TagResource_774125; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates the specified tags to a resource with the specified resourceArn. If existing tags on a resource are not specified in the request parameters, they are not changed. When a resource is deleted, the tags associated with that resource are deleted as well.
  ## 
...
proc call*(call_774138: Call_TagResource_774125; body: JsonNode): Recallable =
  ## tagResource
  ## Associates the specified tags to a resource with the specified resourceArn. If existing tags on a resource are not specified in the request parameters, they are not changed. When a resource is deleted, the tags associated with that resource are deleted as well.
  ##   body: JObject (required)
  var body_774139 = newJObject()
  if body != nil:
    body_774139 = body
  result = call_774138.call(nil, nil, nil, nil, body_774139)

var tagResource* = Call_TagResource_774125(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "config.amazonaws.com", route: "/#X-Amz-Target=StarlingDoveService.TagResource",
                                        validator: validate_TagResource_774126,
                                        base: "/", url: url_TagResource_774127,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_774140 = ref object of OpenApiRestCall_772597
proc url_UntagResource_774142(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UntagResource_774141(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_774152: Call_UntagResource_774140; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specified tags from a resource.
  ## 
...
proc call*(call_774153: Call_UntagResource_774140; body: JsonNode): Recallable =
  ## untagResource
  ## Deletes specified tags from a resource.
  ##   body: JObject (required)
  var body_774154 = newJObject()
  if body != nil:
    body_774154 = body
  result = call_774153.call(nil, nil, nil, nil, body_774154)

var untagResource* = Call_UntagResource_774140(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "config.amazonaws.com",
    route: "/#X-Amz-Target=StarlingDoveService.UntagResource",
    validator: validate_UntagResource_774141, base: "/", url: url_UntagResource_774142,
    schemes: {Scheme.Https, Scheme.Http})
