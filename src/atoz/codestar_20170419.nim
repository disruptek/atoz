...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "codestar.ap-northeast-1.amazonaws.com", "ap-southeast-1": "codestar.ap-southeast-1.amazonaws.com",
                               ...
                               "us-east-1": "codestar.us-east-1.amazonaws.com", "cn-northwest-1": "codestar.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "codestar.ap-south-1.amazonaws.com", "eu-north-1": "codestar.eu-north-1.amazonaws.com", "ap-northeast-2": "codestar.ap-northeast-2.amazonaws.com",
                               ...
                               "eu-west-1": "codestar.eu-west-1.amazonaws.com", "us-gov-west-1": "codestar.us-gov-west-1.amazonaws.com", "ap-southeast-2": "codestar.ap-southeast-2.amazonaws.com", "ca-central-1": "codestar.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_AssociateTeamMember_402656294 = ref object of OpenApiRestCall_402656044
proc url_AssociateTeamMember_402656296(protocol: Scheme; host: string;
...
proc validate_AssociateTeamMember_402656295(path: JsonNode; query: JsonNode;
...
proc call*(call_402656412: Call_AssociateTeamMember_402656294;
...
proc call*(call_402656461: Call_AssociateTeamMember_402656294; body: JsonNode): Recallable =
  ## associateTeamMember
  ## Adds an IAM user to the team for an AWS CodeStar project.
  ##   body: JObject (required)
...
var associateTeamMember* = Call_AssociateTeamMember_402656294(
    ...
    validator: validate_AssociateTeamMember_402656295, base: "/",
    makeUrl: url_AssociateTeamMember_402656296,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProject_402656489 = ref object of OpenApiRestCall_402656044
proc url_CreateProject_402656491(protocol: Scheme; host: string; base: string;
...
proc validate_CreateProject_402656490(path: JsonNode; query: JsonNode;
...
proc call*(call_402656501: Call_CreateProject_402656489; path: JsonNode = nil;
...
proc call*(call_402656502: Call_CreateProject_402656489; body: JsonNode): Recallable =
  ## createProject
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ##   
                                                                                                                                                                                                                                                                                   ## body: JObject (required)
...
var createProject* = Call_CreateProject_402656489(name: "createProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateProject",
    validator: validate_CreateProject_402656490, base: "/",
    makeUrl: url_CreateProject_402656491, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUserProfile_402656504 = ref object of OpenApiRestCall_402656044
proc url_CreateUserProfile_402656506(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_CreateUserProfile_402656505(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656516: Call_CreateUserProfile_402656504;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
                                                                                         ## 
...
proc call*(call_402656517: Call_CreateUserProfile_402656504; body: JsonNode): Recallable =
  ## createUserProfile
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ##   
                                                                                                                                                                                                                                                                                                                       ## body: JObject (required)
...
var createUserProfile* = Call_CreateUserProfile_402656504(
    name: "createUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateUserProfile",
    validator: validate_CreateUserProfile_402656505, base: "/",
    makeUrl: url_CreateUserProfile_402656506,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProject_402656519 = ref object of OpenApiRestCall_402656044
proc url_DeleteProject_402656521(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProject_402656520(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656531: Call_DeleteProject_402656519; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
                                                                                         ## 
...
proc call*(call_402656532: Call_DeleteProject_402656519; body: JsonNode): Recallable =
  ## deleteProject
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ##   
                                                                                                                                                                         ## body: JObject (required)
...
var deleteProject* = Call_DeleteProject_402656519(name: "deleteProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteProject",
    validator: validate_DeleteProject_402656520, base: "/",
    makeUrl: url_DeleteProject_402656521, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUserProfile_402656534 = ref object of OpenApiRestCall_402656044
proc url_DeleteUserProfile_402656536(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteUserProfile_402656535(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656546: Call_DeleteUserProfile_402656534;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
                                                                                         ## 
...
proc call*(call_402656547: Call_DeleteUserProfile_402656534; body: JsonNode): Recallable =
  ## deleteUserProfile
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ##   
                                                                                                                                                                                                                                                            ## body: JObject (required)
...
var deleteUserProfile* = Call_DeleteUserProfile_402656534(
    name: "deleteUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteUserProfile",
    validator: validate_DeleteUserProfile_402656535, base: "/",
    makeUrl: url_DeleteUserProfile_402656536,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProject_402656549 = ref object of OpenApiRestCall_402656044
proc url_DescribeProject_402656551(protocol: Scheme; host: string; base: string;
...
proc validate_DescribeProject_402656550(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656561: Call_DescribeProject_402656549; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes a project and its resources.
                                                                                         ## 
...
proc call*(call_402656562: Call_DescribeProject_402656549; body: JsonNode): Recallable =
  ## describeProject
  ## Describes a project and its resources.
  ##   body: JObject (required)
...
var describeProject* = Call_DescribeProject_402656549(name: "describeProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeProject",
    validator: validate_DescribeProject_402656550, base: "/",
    makeUrl: url_DescribeProject_402656551, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUserProfile_402656564 = ref object of OpenApiRestCall_402656044
proc url_DescribeUserProfile_402656566(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeUserProfile_402656565(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656576: Call_DescribeUserProfile_402656564;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
                                                                                         ## 
...
proc call*(call_402656577: Call_DescribeUserProfile_402656564; body: JsonNode): Recallable =
  ## describeUserProfile
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ##   
                                                                                  ## body: JObject (required)
...
var describeUserProfile* = Call_DescribeUserProfile_402656564(
    name: "describeUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeUserProfile",
    validator: validate_DescribeUserProfile_402656565, base: "/",
    makeUrl: url_DescribeUserProfile_402656566,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateTeamMember_402656579 = ref object of OpenApiRestCall_402656044
proc url_DisassociateTeamMember_402656581(protocol: Scheme; host: string;
...
proc validate_DisassociateTeamMember_402656580(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656591: Call_DisassociateTeamMember_402656579;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes a user from a project. Removing a user from a project also removes the IAM policies from that user that allowed access to the project and its resources. Disassociating a team member does not remove that user's profile from AWS CodeStar. It does not remove the user from IAM.
                                                                                         ## 
...
proc call*(call_402656592: Call_DisassociateTeamMember_402656579; body: JsonNode): Recallable =
...
var disassociateTeamMember* = Call_DisassociateTeamMember_402656579(
    name: "disassociateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DisassociateTeamMember",
    validator: validate_DisassociateTeamMember_402656580, base: "/",
    makeUrl: url_DisassociateTeamMember_402656581,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProjects_402656594 = ref object of OpenApiRestCall_402656044
proc url_ListProjects_402656596(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProjects_402656595(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656606: Call_ListProjects_402656594; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all projects in AWS CodeStar associated with your AWS account.
                                                                                         ## 
...
proc call*(call_402656607: Call_ListProjects_402656594; body: JsonNode): Recallable =
  ## listProjects
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ##   body: JObject 
                                                                         ## (required)
...
var listProjects* = Call_ListProjects_402656594(name: "listProjects",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListProjects",
    validator: validate_ListProjects_402656595, base: "/",
    makeUrl: url_ListProjects_402656596, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_402656609 = ref object of OpenApiRestCall_402656044
proc url_ListResources_402656611(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_402656610(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656621: Call_ListResources_402656609; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists resources associated with a project in AWS CodeStar.
                                                                                         ## 
...
proc call*(call_402656622: Call_ListResources_402656609; body: JsonNode): Recallable =
  ## listResources
  ## Lists resources associated with a project in AWS CodeStar.
  ##   body: JObject (required)
...
var listResources* = Call_ListResources_402656609(name: "listResources",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListResources",
    validator: validate_ListResources_402656610, base: "/",
    makeUrl: url_ListResources_402656611, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForProject_402656624 = ref object of OpenApiRestCall_402656044
proc url_ListTagsForProject_402656626(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTagsForProject_402656625(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656636: Call_ListTagsForProject_402656624;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets the tags for a project.
                                                                                         ## 
...
proc call*(call_402656637: Call_ListTagsForProject_402656624; body: JsonNode): Recallable =
  ## listTagsForProject
  ## Gets the tags for a project.
  ##   body: JObject (required)
...
var listTagsForProject* = Call_ListTagsForProject_402656624(
    name: "listTagsForProject", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTagsForProject",
    validator: validate_ListTagsForProject_402656625, base: "/",
    makeUrl: url_ListTagsForProject_402656626,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTeamMembers_402656639 = ref object of OpenApiRestCall_402656044
proc url_ListTeamMembers_402656641(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode;
                                   query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTeamMembers_402656640(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656651: Call_ListTeamMembers_402656639; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all team members associated with a project.
                                                                                         ## 
...
proc call*(call_402656652: Call_ListTeamMembers_402656639; body: JsonNode): Recallable =
  ## listTeamMembers
  ## Lists all team members associated with a project.
  ##   body: JObject (required)
...
var listTeamMembers* = Call_ListTeamMembers_402656639(name: "listTeamMembers",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTeamMembers",
    validator: validate_ListTeamMembers_402656640, base: "/",
    makeUrl: url_ListTeamMembers_402656641, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUserProfiles_402656654 = ref object of OpenApiRestCall_402656044
proc url_ListUserProfiles_402656656(protocol: Scheme; host: string;
...
proc validate_ListUserProfiles_402656655(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656666: Call_ListUserProfiles_402656654;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
                                                                                         ## 
...
proc call*(call_402656667: Call_ListUserProfiles_402656654; body: JsonNode): Recallable =
  ## listUserProfiles
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ##   
                                                                                 ## body: JObject (required)
...
var listUserProfiles* = Call_ListUserProfiles_402656654(
    name: "listUserProfiles", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListUserProfiles",
    validator: validate_ListUserProfiles_402656655, base: "/",
    makeUrl: url_ListUserProfiles_402656656,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagProject_402656669 = ref object of OpenApiRestCall_402656044
proc url_TagProject_402656671(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagProject_402656670(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656681: Call_TagProject_402656669; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Adds tags to a project.
                                                                                         ## 
...
proc call*(call_402656682: Call_TagProject_402656669; body: JsonNode): Recallable =
  ## tagProject
  ## Adds tags to a project.
  ##   body: JObject (required)
...
var tagProject* = Call_TagProject_402656669(name: "tagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.TagProject",
    validator: validate_TagProject_402656670, base: "/",
    makeUrl: url_TagProject_402656671, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagProject_402656684 = ref object of OpenApiRestCall_402656044
proc url_UntagProject_402656686(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagProject_402656685(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656696: Call_UntagProject_402656684; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes tags from a project.
                                                                                         ## 
...
proc call*(call_402656697: Call_UntagProject_402656684; body: JsonNode): Recallable =
  ## untagProject
  ## Removes tags from a project.
  ##   body: JObject (required)
...
var untagProject* = Call_UntagProject_402656684(name: "untagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UntagProject",
    validator: validate_UntagProject_402656685, base: "/",
    makeUrl: url_UntagProject_402656686, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProject_402656699 = ref object of OpenApiRestCall_402656044
proc url_UpdateProject_402656701(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProject_402656700(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656711: Call_UpdateProject_402656699; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a project in AWS CodeStar.
                                                                                         ## 
...
proc call*(call_402656712: Call_UpdateProject_402656699; body: JsonNode): Recallable =
  ## updateProject
  ## Updates a project in AWS CodeStar.
  ##   body: JObject (required)
...
var updateProject* = Call_UpdateProject_402656699(name: "updateProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateProject",
    validator: validate_UpdateProject_402656700, base: "/",
    makeUrl: url_UpdateProject_402656701, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTeamMember_402656714 = ref object of OpenApiRestCall_402656044
proc url_UpdateTeamMember_402656716(protocol: Scheme; host: string;
                                    base: string; route: string; path: JsonNode;
                                    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateTeamMember_402656715(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656726: Call_UpdateTeamMember_402656714;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
                                                                                         ## 
...
proc call*(call_402656727: Call_UpdateTeamMember_402656714; body: JsonNode): Recallable =
  ## updateTeamMember
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ##   
                                                                                                                                                                                                    ## body: JObject (required)
...
var updateTeamMember* = Call_UpdateTeamMember_402656714(
    name: "updateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateTeamMember",
    validator: validate_UpdateTeamMember_402656715, base: "/",
    makeUrl: url_UpdateTeamMember_402656716,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateUserProfile_402656729 = ref object of OpenApiRestCall_402656044
proc url_UpdateUserProfile_402656731(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateUserProfile_402656730(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656741: Call_UpdateUserProfile_402656729;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
                                                                                         ## 
...
proc call*(call_402656742: Call_UpdateUserProfile_402656729; body: JsonNode): Recallable =
  ## updateUserProfile
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ##   
                                                                                                                                                                                                              ## body: JObject (required)
...
var updateUserProfile* = Call_UpdateUserProfile_402656729(
    name: "updateUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateUserProfile",
    validator: validate_UpdateUserProfile_402656730, base: "/",
    makeUrl: url_UpdateUserProfile_402656731,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
