...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_AssociateTeamMember_21625779 = ref object of OpenApiRestCall_21625435
proc url_AssociateTeamMember_21625781(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateTeamMember_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_AssociateTeamMember_21625779; path: JsonNode = nil;
...
proc call*(call_21625992: Call_AssociateTeamMember_21625779; body: JsonNode): Recallable =
  ## associateTeamMember
  ## Adds an IAM user to the team for an AWS CodeStar project.
  ##   body: JObject (required)
...
var associateTeamMember* = Call_AssociateTeamMember_21625779(
    ...
    validator: validate_AssociateTeamMember_21625780, base: "/",
    makeUrl: url_AssociateTeamMember_21625781,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProject_21626029 = ref object of OpenApiRestCall_21625435
proc url_CreateProject_21626031(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateProject_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_CreateProject_21626029; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ## 
...
proc call*(call_21626042: Call_CreateProject_21626029; body: JsonNode): Recallable =
  ## createProject
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ##   body: JObject (required)
...
var createProject* = Call_CreateProject_21626029(name: "createProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateProject",
    validator: validate_CreateProject_21626030, base: "/",
    makeUrl: url_CreateProject_21626031, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUserProfile_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateUserProfile_21626046(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUserProfile_21626045(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
...
proc call*(call_21626056: Call_CreateUserProfile_21626044; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ## 
...
proc call*(call_21626057: Call_CreateUserProfile_21626044; body: JsonNode): Recallable =
  ## createUserProfile
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ##   body: JObject (required)
...
var createUserProfile* = Call_CreateUserProfile_21626044(name: "createUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateUserProfile",
    validator: validate_CreateUserProfile_21626045, base: "/",
    makeUrl: url_CreateUserProfile_21626046, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProject_21626059 = ref object of OpenApiRestCall_21625435
proc url_DeleteProject_21626061(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProject_21626060(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626071: Call_DeleteProject_21626059; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ## 
...
proc call*(call_21626072: Call_DeleteProject_21626059; body: JsonNode): Recallable =
  ## deleteProject
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ##   body: JObject (required)
...
var deleteProject* = Call_DeleteProject_21626059(name: "deleteProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteProject",
    validator: validate_DeleteProject_21626060, base: "/",
    makeUrl: url_DeleteProject_21626061, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUserProfile_21626074 = ref object of OpenApiRestCall_21625435
proc url_DeleteUserProfile_21626076(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUserProfile_21626075(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_DeleteUserProfile_21626074; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ## 
...
proc call*(call_21626087: Call_DeleteUserProfile_21626074; body: JsonNode): Recallable =
  ## deleteUserProfile
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ##   body: JObject (required)
...
var deleteUserProfile* = Call_DeleteUserProfile_21626074(name: "deleteUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteUserProfile",
    validator: validate_DeleteUserProfile_21626075, base: "/",
    makeUrl: url_DeleteUserProfile_21626076, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProject_21626089 = ref object of OpenApiRestCall_21625435
proc url_DescribeProject_21626091(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProject_21626090(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_DescribeProject_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes a project and its resources.
  ## 
...
proc call*(call_21626102: Call_DescribeProject_21626089; body: JsonNode): Recallable =
  ## describeProject
  ## Describes a project and its resources.
  ##   body: JObject (required)
...
var describeProject* = Call_DescribeProject_21626089(name: "describeProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeProject",
    validator: validate_DescribeProject_21626090, base: "/",
    makeUrl: url_DescribeProject_21626091, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUserProfile_21626104 = ref object of OpenApiRestCall_21625435
proc url_DescribeUserProfile_21626106(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeUserProfile_21626105(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_DescribeUserProfile_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ## 
...
proc call*(call_21626117: Call_DescribeUserProfile_21626104; body: JsonNode): Recallable =
  ## describeUserProfile
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ##   body: JObject (required)
...
var describeUserProfile* = Call_DescribeUserProfile_21626104(
    name: "describeUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeUserProfile",
    validator: validate_DescribeUserProfile_21626105, base: "/",
    makeUrl: url_DescribeUserProfile_21626106,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateTeamMember_21626119 = ref object of OpenApiRestCall_21625435
proc url_DisassociateTeamMember_21626121(protocol: Scheme; host: string;
...
proc validate_DisassociateTeamMember_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_DisassociateTeamMember_21626119;
...
proc call*(call_21626132: Call_DisassociateTeamMember_21626119; body: JsonNode): Recallable =
...
var disassociateTeamMember* = Call_DisassociateTeamMember_21626119(
    name: "disassociateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DisassociateTeamMember",
    validator: validate_DisassociateTeamMember_21626120, base: "/",
    makeUrl: url_DisassociateTeamMember_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProjects_21626134 = ref object of OpenApiRestCall_21625435
proc url_ListProjects_21626136(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProjects_21626135(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626146: Call_ListProjects_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ## 
...
proc call*(call_21626147: Call_ListProjects_21626134; body: JsonNode): Recallable =
  ## listProjects
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ##   body: JObject (required)
...
var listProjects* = Call_ListProjects_21626134(name: "listProjects",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListProjects",
    validator: validate_ListProjects_21626135, base: "/", makeUrl: url_ListProjects_21626136,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_21626149 = ref object of OpenApiRestCall_21625435
proc url_ListResources_21626151(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_21626150(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626161: Call_ListResources_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists resources associated with a project in AWS CodeStar.
  ## 
...
proc call*(call_21626162: Call_ListResources_21626149; body: JsonNode): Recallable =
  ## listResources
  ## Lists resources associated with a project in AWS CodeStar.
  ##   body: JObject (required)
...
var listResources* = Call_ListResources_21626149(name: "listResources",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListResources",
    validator: validate_ListResources_21626150, base: "/",
    makeUrl: url_ListResources_21626151, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForProject_21626164 = ref object of OpenApiRestCall_21625435
proc url_ListTagsForProject_21626166(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForProject_21626165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_ListTagsForProject_21626164; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets the tags for a project.
  ## 
...
proc call*(call_21626177: Call_ListTagsForProject_21626164; body: JsonNode): Recallable =
  ## listTagsForProject
  ## Gets the tags for a project.
  ##   body: JObject (required)
...
var listTagsForProject* = Call_ListTagsForProject_21626164(
    name: "listTagsForProject", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTagsForProject",
    validator: validate_ListTagsForProject_21626165, base: "/",
    makeUrl: url_ListTagsForProject_21626166, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTeamMembers_21626179 = ref object of OpenApiRestCall_21625435
proc url_ListTeamMembers_21626181(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTeamMembers_21626180(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626191: Call_ListTeamMembers_21626179; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all team members associated with a project.
  ## 
...
proc call*(call_21626192: Call_ListTeamMembers_21626179; body: JsonNode): Recallable =
  ## listTeamMembers
  ## Lists all team members associated with a project.
  ##   body: JObject (required)
...
var listTeamMembers* = Call_ListTeamMembers_21626179(name: "listTeamMembers",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTeamMembers",
    validator: validate_ListTeamMembers_21626180, base: "/",
    makeUrl: url_ListTeamMembers_21626181, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUserProfiles_21626194 = ref object of OpenApiRestCall_21625435
proc url_ListUserProfiles_21626196(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListUserProfiles_21626195(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626206: Call_ListUserProfiles_21626194; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ## 
...
proc call*(call_21626207: Call_ListUserProfiles_21626194; body: JsonNode): Recallable =
  ## listUserProfiles
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ##   body: JObject (required)
...
var listUserProfiles* = Call_ListUserProfiles_21626194(name: "listUserProfiles",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListUserProfiles",
    validator: validate_ListUserProfiles_21626195, base: "/",
    makeUrl: url_ListUserProfiles_21626196, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagProject_21626209 = ref object of OpenApiRestCall_21625435
proc url_TagProject_21626211(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagProject_21626210(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_21626221: Call_TagProject_21626209; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Adds tags to a project.
  ## 
...
proc call*(call_21626222: Call_TagProject_21626209; body: JsonNode): Recallable =
  ## tagProject
  ## Adds tags to a project.
  ##   body: JObject (required)
...
var tagProject* = Call_TagProject_21626209(name: "tagProject",
                                        meth: HttpMethod.HttpPost,
                                        host: "codestar.amazonaws.com", route: "/#X-Amz-Target=CodeStar_20170419.TagProject",
                                        validator: validate_TagProject_21626210,
                                        base: "/", makeUrl: url_TagProject_21626211,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagProject_21626224 = ref object of OpenApiRestCall_21625435
proc url_UntagProject_21626226(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagProject_21626225(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626236: Call_UntagProject_21626224; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes tags from a project.
  ## 
...
proc call*(call_21626237: Call_UntagProject_21626224; body: JsonNode): Recallable =
  ## untagProject
  ## Removes tags from a project.
  ##   body: JObject (required)
...
var untagProject* = Call_UntagProject_21626224(name: "untagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UntagProject",
    validator: validate_UntagProject_21626225, base: "/", makeUrl: url_UntagProject_21626226,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProject_21626239 = ref object of OpenApiRestCall_21625435
proc url_UpdateProject_21626241(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProject_21626240(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626251: Call_UpdateProject_21626239; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a project in AWS CodeStar.
  ## 
...
proc call*(call_21626252: Call_UpdateProject_21626239; body: JsonNode): Recallable =
  ## updateProject
  ## Updates a project in AWS CodeStar.
  ##   body: JObject (required)
...
var updateProject* = Call_UpdateProject_21626239(name: "updateProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateProject",
    validator: validate_UpdateProject_21626240, base: "/",
    makeUrl: url_UpdateProject_21626241, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTeamMember_21626254 = ref object of OpenApiRestCall_21625435
proc url_UpdateTeamMember_21626256(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTeamMember_21626255(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626266: Call_UpdateTeamMember_21626254; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ## 
...
proc call*(call_21626267: Call_UpdateTeamMember_21626254; body: JsonNode): Recallable =
  ## updateTeamMember
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ##   body: JObject (required)
...
var updateTeamMember* = Call_UpdateTeamMember_21626254(name: "updateTeamMember",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateTeamMember",
    validator: validate_UpdateTeamMember_21626255, base: "/",
    makeUrl: url_UpdateTeamMember_21626256, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateUserProfile_21626269 = ref object of OpenApiRestCall_21625435
proc url_UpdateUserProfile_21626271(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateUserProfile_21626270(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626281: Call_UpdateUserProfile_21626269; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ## 
...
proc call*(call_21626282: Call_UpdateUserProfile_21626269; body: JsonNode): Recallable =
  ## updateUserProfile
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ##   body: JObject (required)
...
var updateUserProfile* = Call_UpdateUserProfile_21626269(name: "updateUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateUserProfile",
    validator: validate_UpdateUserProfile_21626270, base: "/",
    makeUrl: url_UpdateUserProfile_21626271, schemes: {Scheme.Https, Scheme.Http})
export
  rest
