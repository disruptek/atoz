...
type
  Call_AssociateTeamMember_599705 = ref object of OpenApiRestCall_599368
proc url_AssociateTeamMember_599707(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateTeamMember_599706(path: JsonNode; query: JsonNode;
...
proc call*(call_599863: Call_AssociateTeamMember_599705; path: JsonNode;
...
proc call*(call_599934: Call_AssociateTeamMember_599705; body: JsonNode): Recallable =
  ## associateTeamMember
  ## Adds an IAM user to the team for an AWS CodeStar project.
  ##   body: JObject (required)
...
var associateTeamMember* = Call_AssociateTeamMember_599705(
    ...
    validator: validate_AssociateTeamMember_599706, base: "/",
    url: url_AssociateTeamMember_599707, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProject_599974 = ref object of OpenApiRestCall_599368
proc url_CreateProject_599976(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateProject_599975(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_599986: Call_CreateProject_599974; path: JsonNode; query: JsonNode;
...
proc call*(call_599987: Call_CreateProject_599974; body: JsonNode): Recallable =
  ## createProject
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ##   body: JObject (required)
...
var createProject* = Call_CreateProject_599974(name: "createProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateProject",
    validator: validate_CreateProject_599975, base: "/", url: url_CreateProject_599976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUserProfile_599989 = ref object of OpenApiRestCall_599368
proc url_CreateUserProfile_599991(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUserProfile_599990(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_600001: Call_CreateUserProfile_599989; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ## 
...
proc call*(call_600002: Call_CreateUserProfile_599989; body: JsonNode): Recallable =
  ## createUserProfile
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ##   body: JObject (required)
...
var createUserProfile* = Call_CreateUserProfile_599989(name: "createUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateUserProfile",
    validator: validate_CreateUserProfile_599990, base: "/",
    url: url_CreateUserProfile_599991, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProject_600004 = ref object of OpenApiRestCall_599368
proc url_DeleteProject_600006(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProject_600005(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600016: Call_DeleteProject_600004; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ## 
...
proc call*(call_600017: Call_DeleteProject_600004; body: JsonNode): Recallable =
  ## deleteProject
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ##   body: JObject (required)
...
var deleteProject* = Call_DeleteProject_600004(name: "deleteProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteProject",
    validator: validate_DeleteProject_600005, base: "/", url: url_DeleteProject_600006,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUserProfile_600019 = ref object of OpenApiRestCall_599368
proc url_DeleteUserProfile_600021(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUserProfile_600020(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_600031: Call_DeleteUserProfile_600019; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ## 
...
proc call*(call_600032: Call_DeleteUserProfile_600019; body: JsonNode): Recallable =
  ## deleteUserProfile
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ##   body: JObject (required)
...
var deleteUserProfile* = Call_DeleteUserProfile_600019(name: "deleteUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteUserProfile",
    validator: validate_DeleteUserProfile_600020, base: "/",
    url: url_DeleteUserProfile_600021, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProject_600034 = ref object of OpenApiRestCall_599368
proc url_DescribeProject_600036(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProject_600035(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_600046: Call_DescribeProject_600034; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a project and its resources.
  ## 
...
proc call*(call_600047: Call_DescribeProject_600034; body: JsonNode): Recallable =
  ## describeProject
  ## Describes a project and its resources.
  ##   body: JObject (required)
...
var describeProject* = Call_DescribeProject_600034(name: "describeProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeProject",
    validator: validate_DescribeProject_600035, base: "/", url: url_DescribeProject_600036,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUserProfile_600049 = ref object of OpenApiRestCall_599368
proc url_DescribeUserProfile_600051(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeUserProfile_600050(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_600061: Call_DescribeUserProfile_600049; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ## 
...
proc call*(call_600062: Call_DescribeUserProfile_600049; body: JsonNode): Recallable =
  ## describeUserProfile
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ##   body: JObject (required)
...
var describeUserProfile* = Call_DescribeUserProfile_600049(
    name: "describeUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeUserProfile",
    validator: validate_DescribeUserProfile_600050, base: "/",
    url: url_DescribeUserProfile_600051, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateTeamMember_600064 = ref object of OpenApiRestCall_599368
proc url_DisassociateTeamMember_600066(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateTeamMember_600065(path: JsonNode; query: JsonNode;
...
proc call*(call_600076: Call_DisassociateTeamMember_600064; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a user from a project. Removing a user from a project also removes the IAM policies from that user that allowed access to the project and its resources. Disassociating a team member does not remove that user's profile from AWS CodeStar. It does not remove the user from IAM.
  ## 
...
proc call*(call_600077: Call_DisassociateTeamMember_600064; body: JsonNode): Recallable =
...
var disassociateTeamMember* = Call_DisassociateTeamMember_600064(
    name: "disassociateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DisassociateTeamMember",
    validator: validate_DisassociateTeamMember_600065, base: "/",
    url: url_DisassociateTeamMember_600066, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProjects_600079 = ref object of OpenApiRestCall_599368
proc url_ListProjects_600081(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProjects_600080(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600091: Call_ListProjects_600079; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ## 
...
proc call*(call_600092: Call_ListProjects_600079; body: JsonNode): Recallable =
  ## listProjects
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ##   body: JObject (required)
...
var listProjects* = Call_ListProjects_600079(name: "listProjects",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListProjects",
    validator: validate_ListProjects_600080, base: "/", url: url_ListProjects_600081,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_600094 = ref object of OpenApiRestCall_599368
proc url_ListResources_600096(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_600095(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600106: Call_ListResources_600094; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists resources associated with a project in AWS CodeStar.
  ## 
...
proc call*(call_600107: Call_ListResources_600094; body: JsonNode): Recallable =
  ## listResources
  ## Lists resources associated with a project in AWS CodeStar.
  ##   body: JObject (required)
...
var listResources* = Call_ListResources_600094(name: "listResources",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListResources",
    validator: validate_ListResources_600095, base: "/", url: url_ListResources_600096,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForProject_600109 = ref object of OpenApiRestCall_599368
proc url_ListTagsForProject_600111(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForProject_600110(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_600121: Call_ListTagsForProject_600109; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the tags for a project.
  ## 
...
proc call*(call_600122: Call_ListTagsForProject_600109; body: JsonNode): Recallable =
  ## listTagsForProject
  ## Gets the tags for a project.
  ##   body: JObject (required)
...
var listTagsForProject* = Call_ListTagsForProject_600109(
    name: "listTagsForProject", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTagsForProject",
    validator: validate_ListTagsForProject_600110, base: "/",
    url: url_ListTagsForProject_600111, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTeamMembers_600124 = ref object of OpenApiRestCall_599368
proc url_ListTeamMembers_600126(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTeamMembers_600125(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_600136: Call_ListTeamMembers_600124; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all team members associated with a project.
  ## 
...
proc call*(call_600137: Call_ListTeamMembers_600124; body: JsonNode): Recallable =
  ## listTeamMembers
  ## Lists all team members associated with a project.
  ##   body: JObject (required)
...
var listTeamMembers* = Call_ListTeamMembers_600124(name: "listTeamMembers",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTeamMembers",
    validator: validate_ListTeamMembers_600125, base: "/", url: url_ListTeamMembers_600126,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUserProfiles_600139 = ref object of OpenApiRestCall_599368
proc url_ListUserProfiles_600141(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListUserProfiles_600140(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600151: Call_ListUserProfiles_600139; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ## 
...
proc call*(call_600152: Call_ListUserProfiles_600139; body: JsonNode): Recallable =
  ## listUserProfiles
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ##   body: JObject (required)
...
var listUserProfiles* = Call_ListUserProfiles_600139(name: "listUserProfiles",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListUserProfiles",
    validator: validate_ListUserProfiles_600140, base: "/",
    url: url_ListUserProfiles_600141, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagProject_600154 = ref object of OpenApiRestCall_599368
proc url_TagProject_600156(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagProject_600155(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600166: Call_TagProject_600154; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds tags to a project.
  ## 
...
proc call*(call_600167: Call_TagProject_600154; body: JsonNode): Recallable =
  ## tagProject
  ## Adds tags to a project.
  ##   body: JObject (required)
...
var tagProject* = Call_TagProject_600154(name: "tagProject",
                                      meth: HttpMethod.HttpPost,
                                      host: "codestar.amazonaws.com", route: "/#X-Amz-Target=CodeStar_20170419.TagProject",
                                      validator: validate_TagProject_600155,
                                      base: "/", url: url_TagProject_600156,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagProject_600169 = ref object of OpenApiRestCall_599368
proc url_UntagProject_600171(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagProject_600170(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600181: Call_UntagProject_600169; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes tags from a project.
  ## 
...
proc call*(call_600182: Call_UntagProject_600169; body: JsonNode): Recallable =
  ## untagProject
  ## Removes tags from a project.
  ##   body: JObject (required)
...
var untagProject* = Call_UntagProject_600169(name: "untagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UntagProject",
    validator: validate_UntagProject_600170, base: "/", url: url_UntagProject_600171,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProject_600184 = ref object of OpenApiRestCall_599368
proc url_UpdateProject_600186(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProject_600185(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600196: Call_UpdateProject_600184; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a project in AWS CodeStar.
  ## 
...
proc call*(call_600197: Call_UpdateProject_600184; body: JsonNode): Recallable =
  ## updateProject
  ## Updates a project in AWS CodeStar.
  ##   body: JObject (required)
...
var updateProject* = Call_UpdateProject_600184(name: "updateProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateProject",
    validator: validate_UpdateProject_600185, base: "/", url: url_UpdateProject_600186,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTeamMember_600199 = ref object of OpenApiRestCall_599368
proc url_UpdateTeamMember_600201(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTeamMember_600200(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600211: Call_UpdateTeamMember_600199; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ## 
...
proc call*(call_600212: Call_UpdateTeamMember_600199; body: JsonNode): Recallable =
  ## updateTeamMember
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ##   body: JObject (required)
...
var updateTeamMember* = Call_UpdateTeamMember_600199(name: "updateTeamMember",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateTeamMember",
    validator: validate_UpdateTeamMember_600200, base: "/",
    url: url_UpdateTeamMember_600201, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateUserProfile_600214 = ref object of OpenApiRestCall_599368
proc url_UpdateUserProfile_600216(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateUserProfile_600215(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_600226: Call_UpdateUserProfile_600214; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ## 
...
proc call*(call_600227: Call_UpdateUserProfile_600214; body: JsonNode): Recallable =
  ## updateUserProfile
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ##   body: JObject (required)
...
var updateUserProfile* = Call_UpdateUserProfile_600214(name: "updateUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateUserProfile",
    validator: validate_UpdateUserProfile_600215, base: "/",
    url: url_UpdateUserProfile_600216, schemes: {Scheme.Https, Scheme.Http})
export
  rest
