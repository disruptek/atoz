...
type
  Call_AssociateTeamMember_602803 = ref object of OpenApiRestCall_602466
proc url_AssociateTeamMember_602805(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateTeamMember_602804(path: JsonNode; query: JsonNode;
...
proc call*(call_602961: Call_AssociateTeamMember_602803; path: JsonNode;
...
proc call*(call_603032: Call_AssociateTeamMember_602803; body: JsonNode): Recallable =
  ## associateTeamMember
  ## Adds an IAM user to the team for an AWS CodeStar project.
  ##   body: JObject (required)
...
var associateTeamMember* = Call_AssociateTeamMember_602803(
    ...
    validator: validate_AssociateTeamMember_602804, base: "/",
    url: url_AssociateTeamMember_602805, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProject_603072 = ref object of OpenApiRestCall_602466
proc url_CreateProject_603074(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateProject_603073(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603084: Call_CreateProject_603072; path: JsonNode; query: JsonNode;
...
proc call*(call_603085: Call_CreateProject_603072; body: JsonNode): Recallable =
  ## createProject
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ##   body: JObject (required)
...
var createProject* = Call_CreateProject_603072(name: "createProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateProject",
    validator: validate_CreateProject_603073, base: "/", url: url_CreateProject_603074,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUserProfile_603087 = ref object of OpenApiRestCall_602466
proc url_CreateUserProfile_603089(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUserProfile_603088(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603099: Call_CreateUserProfile_603087; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ## 
...
proc call*(call_603100: Call_CreateUserProfile_603087; body: JsonNode): Recallable =
  ## createUserProfile
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ##   body: JObject (required)
...
var createUserProfile* = Call_CreateUserProfile_603087(name: "createUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateUserProfile",
    validator: validate_CreateUserProfile_603088, base: "/",
    url: url_CreateUserProfile_603089, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProject_603102 = ref object of OpenApiRestCall_602466
proc url_DeleteProject_603104(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProject_603103(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603114: Call_DeleteProject_603102; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ## 
...
proc call*(call_603115: Call_DeleteProject_603102; body: JsonNode): Recallable =
  ## deleteProject
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ##   body: JObject (required)
...
var deleteProject* = Call_DeleteProject_603102(name: "deleteProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteProject",
    validator: validate_DeleteProject_603103, base: "/", url: url_DeleteProject_603104,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUserProfile_603117 = ref object of OpenApiRestCall_602466
proc url_DeleteUserProfile_603119(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUserProfile_603118(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603129: Call_DeleteUserProfile_603117; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ## 
...
proc call*(call_603130: Call_DeleteUserProfile_603117; body: JsonNode): Recallable =
  ## deleteUserProfile
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ##   body: JObject (required)
...
var deleteUserProfile* = Call_DeleteUserProfile_603117(name: "deleteUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteUserProfile",
    validator: validate_DeleteUserProfile_603118, base: "/",
    url: url_DeleteUserProfile_603119, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProject_603132 = ref object of OpenApiRestCall_602466
proc url_DescribeProject_603134(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProject_603133(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_603144: Call_DescribeProject_603132; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a project and its resources.
  ## 
...
proc call*(call_603145: Call_DescribeProject_603132; body: JsonNode): Recallable =
  ## describeProject
  ## Describes a project and its resources.
  ##   body: JObject (required)
...
var describeProject* = Call_DescribeProject_603132(name: "describeProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeProject",
    validator: validate_DescribeProject_603133, base: "/", url: url_DescribeProject_603134,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUserProfile_603147 = ref object of OpenApiRestCall_602466
proc url_DescribeUserProfile_603149(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeUserProfile_603148(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603159: Call_DescribeUserProfile_603147; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ## 
...
proc call*(call_603160: Call_DescribeUserProfile_603147; body: JsonNode): Recallable =
  ## describeUserProfile
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ##   body: JObject (required)
...
var describeUserProfile* = Call_DescribeUserProfile_603147(
    name: "describeUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeUserProfile",
    validator: validate_DescribeUserProfile_603148, base: "/",
    url: url_DescribeUserProfile_603149, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateTeamMember_603162 = ref object of OpenApiRestCall_602466
proc url_DisassociateTeamMember_603164(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateTeamMember_603163(path: JsonNode; query: JsonNode;
...
proc call*(call_603174: Call_DisassociateTeamMember_603162; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a user from a project. Removing a user from a project also removes the IAM policies from that user that allowed access to the project and its resources. Disassociating a team member does not remove that user's profile from AWS CodeStar. It does not remove the user from IAM.
  ## 
...
proc call*(call_603175: Call_DisassociateTeamMember_603162; body: JsonNode): Recallable =
...
var disassociateTeamMember* = Call_DisassociateTeamMember_603162(
    name: "disassociateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DisassociateTeamMember",
    validator: validate_DisassociateTeamMember_603163, base: "/",
    url: url_DisassociateTeamMember_603164, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProjects_603177 = ref object of OpenApiRestCall_602466
proc url_ListProjects_603179(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProjects_603178(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603189: Call_ListProjects_603177; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ## 
...
proc call*(call_603190: Call_ListProjects_603177; body: JsonNode): Recallable =
  ## listProjects
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ##   body: JObject (required)
...
var listProjects* = Call_ListProjects_603177(name: "listProjects",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListProjects",
    validator: validate_ListProjects_603178, base: "/", url: url_ListProjects_603179,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_603192 = ref object of OpenApiRestCall_602466
proc url_ListResources_603194(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_603193(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603204: Call_ListResources_603192; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists resources associated with a project in AWS CodeStar.
  ## 
...
proc call*(call_603205: Call_ListResources_603192; body: JsonNode): Recallable =
  ## listResources
  ## Lists resources associated with a project in AWS CodeStar.
  ##   body: JObject (required)
...
var listResources* = Call_ListResources_603192(name: "listResources",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListResources",
    validator: validate_ListResources_603193, base: "/", url: url_ListResources_603194,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForProject_603207 = ref object of OpenApiRestCall_602466
proc url_ListTagsForProject_603209(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForProject_603208(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603219: Call_ListTagsForProject_603207; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the tags for a project.
  ## 
...
proc call*(call_603220: Call_ListTagsForProject_603207; body: JsonNode): Recallable =
  ## listTagsForProject
  ## Gets the tags for a project.
  ##   body: JObject (required)
...
var listTagsForProject* = Call_ListTagsForProject_603207(
    name: "listTagsForProject", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTagsForProject",
    validator: validate_ListTagsForProject_603208, base: "/",
    url: url_ListTagsForProject_603209, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTeamMembers_603222 = ref object of OpenApiRestCall_602466
proc url_ListTeamMembers_603224(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTeamMembers_603223(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_603234: Call_ListTeamMembers_603222; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all team members associated with a project.
  ## 
...
proc call*(call_603235: Call_ListTeamMembers_603222; body: JsonNode): Recallable =
  ## listTeamMembers
  ## Lists all team members associated with a project.
  ##   body: JObject (required)
...
var listTeamMembers* = Call_ListTeamMembers_603222(name: "listTeamMembers",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTeamMembers",
    validator: validate_ListTeamMembers_603223, base: "/", url: url_ListTeamMembers_603224,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUserProfiles_603237 = ref object of OpenApiRestCall_602466
proc url_ListUserProfiles_603239(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListUserProfiles_603238(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603249: Call_ListUserProfiles_603237; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ## 
...
proc call*(call_603250: Call_ListUserProfiles_603237; body: JsonNode): Recallable =
  ## listUserProfiles
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ##   body: JObject (required)
...
var listUserProfiles* = Call_ListUserProfiles_603237(name: "listUserProfiles",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListUserProfiles",
    validator: validate_ListUserProfiles_603238, base: "/",
    url: url_ListUserProfiles_603239, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagProject_603252 = ref object of OpenApiRestCall_602466
proc url_TagProject_603254(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagProject_603253(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603264: Call_TagProject_603252; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds tags to a project.
  ## 
...
proc call*(call_603265: Call_TagProject_603252; body: JsonNode): Recallable =
  ## tagProject
  ## Adds tags to a project.
  ##   body: JObject (required)
...
var tagProject* = Call_TagProject_603252(name: "tagProject",
                                      meth: HttpMethod.HttpPost,
                                      host: "codestar.amazonaws.com", route: "/#X-Amz-Target=CodeStar_20170419.TagProject",
                                      validator: validate_TagProject_603253,
                                      base: "/", url: url_TagProject_603254,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagProject_603267 = ref object of OpenApiRestCall_602466
proc url_UntagProject_603269(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagProject_603268(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603279: Call_UntagProject_603267; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes tags from a project.
  ## 
...
proc call*(call_603280: Call_UntagProject_603267; body: JsonNode): Recallable =
  ## untagProject
  ## Removes tags from a project.
  ##   body: JObject (required)
...
var untagProject* = Call_UntagProject_603267(name: "untagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UntagProject",
    validator: validate_UntagProject_603268, base: "/", url: url_UntagProject_603269,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProject_603282 = ref object of OpenApiRestCall_602466
proc url_UpdateProject_603284(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProject_603283(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603294: Call_UpdateProject_603282; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a project in AWS CodeStar.
  ## 
...
proc call*(call_603295: Call_UpdateProject_603282; body: JsonNode): Recallable =
  ## updateProject
  ## Updates a project in AWS CodeStar.
  ##   body: JObject (required)
...
var updateProject* = Call_UpdateProject_603282(name: "updateProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateProject",
    validator: validate_UpdateProject_603283, base: "/", url: url_UpdateProject_603284,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTeamMember_603297 = ref object of OpenApiRestCall_602466
proc url_UpdateTeamMember_603299(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTeamMember_603298(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603309: Call_UpdateTeamMember_603297; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ## 
...
proc call*(call_603310: Call_UpdateTeamMember_603297; body: JsonNode): Recallable =
  ## updateTeamMember
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ##   body: JObject (required)
...
var updateTeamMember* = Call_UpdateTeamMember_603297(name: "updateTeamMember",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateTeamMember",
    validator: validate_UpdateTeamMember_603298, base: "/",
    url: url_UpdateTeamMember_603299, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateUserProfile_603312 = ref object of OpenApiRestCall_602466
proc url_UpdateUserProfile_603314(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateUserProfile_603313(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603324: Call_UpdateUserProfile_603312; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ## 
...
proc call*(call_603325: Call_UpdateUserProfile_603312; body: JsonNode): Recallable =
  ## updateUserProfile
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ##   body: JObject (required)
...
var updateUserProfile* = Call_UpdateUserProfile_603312(name: "updateUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateUserProfile",
    validator: validate_UpdateUserProfile_603313, base: "/",
    url: url_UpdateUserProfile_603314, schemes: {Scheme.Https, Scheme.Http})
export
  rest
