...
type
  Call_AssociateTeamMember_592703 = ref object of OpenApiRestCall_592364
proc url_AssociateTeamMember_592705(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateTeamMember_592704(path: JsonNode; query: JsonNode;
...
proc call*(call_592861: Call_AssociateTeamMember_592703; path: JsonNode;
...
proc call*(call_592932: Call_AssociateTeamMember_592703; body: JsonNode): Recallable =
  ## associateTeamMember
  ## Adds an IAM user to the team for an AWS CodeStar project.
  ##   body: JObject (required)
...
var associateTeamMember* = Call_AssociateTeamMember_592703(
    ...
    validator: validate_AssociateTeamMember_592704, base: "/",
    url: url_AssociateTeamMember_592705, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateProject_592972 = ref object of OpenApiRestCall_592364
proc url_CreateProject_592974(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateProject_592973(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_592984: Call_CreateProject_592972; path: JsonNode; query: JsonNode;
...
proc call*(call_592985: Call_CreateProject_592972; body: JsonNode): Recallable =
  ## createProject
  ## Creates a project, including project resources. This action creates a project based on a submitted project request. A set of source code files and a toolchain template file can be included with the project request. If these are not provided, an empty project is created.
  ##   body: JObject (required)
...
var createProject* = Call_CreateProject_592972(name: "createProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateProject",
    validator: validate_CreateProject_592973, base: "/", url: url_CreateProject_592974,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUserProfile_592987 = ref object of OpenApiRestCall_592364
proc url_CreateUserProfile_592989(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUserProfile_592988(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_592999: Call_CreateUserProfile_592987; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ## 
...
proc call*(call_593000: Call_CreateUserProfile_592987; body: JsonNode): Recallable =
  ## createUserProfile
  ## Creates a profile for a user that includes user preferences, such as the display name and email address assocciated with the user, in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar.
  ##   body: JObject (required)
...
var createUserProfile* = Call_CreateUserProfile_592987(name: "createUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.CreateUserProfile",
    validator: validate_CreateUserProfile_592988, base: "/",
    url: url_CreateUserProfile_592989, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteProject_593002 = ref object of OpenApiRestCall_592364
proc url_DeleteProject_593004(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteProject_593003(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593014: Call_DeleteProject_593002; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ## 
...
proc call*(call_593015: Call_DeleteProject_593002; body: JsonNode): Recallable =
  ## deleteProject
  ## Deletes a project, including project resources. Does not delete users associated with the project, but does delete the IAM roles that allowed access to the project.
  ##   body: JObject (required)
...
var deleteProject* = Call_DeleteProject_593002(name: "deleteProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteProject",
    validator: validate_DeleteProject_593003, base: "/", url: url_DeleteProject_593004,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUserProfile_593017 = ref object of OpenApiRestCall_592364
proc url_DeleteUserProfile_593019(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUserProfile_593018(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_593029: Call_DeleteUserProfile_593017; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ## 
...
proc call*(call_593030: Call_DeleteUserProfile_593017; body: JsonNode): Recallable =
  ## deleteUserProfile
  ## Deletes a user profile in AWS CodeStar, including all personal preference data associated with that profile, such as display name and email address. It does not delete the history of that user, for example the history of commits made by that user.
  ##   body: JObject (required)
...
var deleteUserProfile* = Call_DeleteUserProfile_593017(name: "deleteUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DeleteUserProfile",
    validator: validate_DeleteUserProfile_593018, base: "/",
    url: url_DeleteUserProfile_593019, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeProject_593032 = ref object of OpenApiRestCall_592364
proc url_DescribeProject_593034(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeProject_593033(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_593044: Call_DescribeProject_593032; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a project and its resources.
  ## 
...
proc call*(call_593045: Call_DescribeProject_593032; body: JsonNode): Recallable =
  ## describeProject
  ## Describes a project and its resources.
  ##   body: JObject (required)
...
var describeProject* = Call_DescribeProject_593032(name: "describeProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeProject",
    validator: validate_DescribeProject_593033, base: "/", url: url_DescribeProject_593034,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUserProfile_593047 = ref object of OpenApiRestCall_592364
proc url_DescribeUserProfile_593049(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeUserProfile_593048(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593059: Call_DescribeUserProfile_593047; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ## 
...
proc call*(call_593060: Call_DescribeUserProfile_593047; body: JsonNode): Recallable =
  ## describeUserProfile
  ## Describes a user in AWS CodeStar and the user attributes across all projects.
  ##   body: JObject (required)
...
var describeUserProfile* = Call_DescribeUserProfile_593047(
    name: "describeUserProfile", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DescribeUserProfile",
    validator: validate_DescribeUserProfile_593048, base: "/",
    url: url_DescribeUserProfile_593049, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateTeamMember_593062 = ref object of OpenApiRestCall_592364
proc url_DisassociateTeamMember_593064(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateTeamMember_593063(path: JsonNode; query: JsonNode;
...
proc call*(call_593074: Call_DisassociateTeamMember_593062; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a user from a project. Removing a user from a project also removes the IAM policies from that user that allowed access to the project and its resources. Disassociating a team member does not remove that user's profile from AWS CodeStar. It does not remove the user from IAM.
  ## 
...
proc call*(call_593075: Call_DisassociateTeamMember_593062; body: JsonNode): Recallable =
...
var disassociateTeamMember* = Call_DisassociateTeamMember_593062(
    name: "disassociateTeamMember", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.DisassociateTeamMember",
    validator: validate_DisassociateTeamMember_593063, base: "/",
    url: url_DisassociateTeamMember_593064, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListProjects_593077 = ref object of OpenApiRestCall_592364
proc url_ListProjects_593079(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListProjects_593078(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593089: Call_ListProjects_593077; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ## 
...
proc call*(call_593090: Call_ListProjects_593077; body: JsonNode): Recallable =
  ## listProjects
  ## Lists all projects in AWS CodeStar associated with your AWS account.
  ##   body: JObject (required)
...
var listProjects* = Call_ListProjects_593077(name: "listProjects",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListProjects",
    validator: validate_ListProjects_593078, base: "/", url: url_ListProjects_593079,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_593092 = ref object of OpenApiRestCall_592364
proc url_ListResources_593094(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_593093(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593104: Call_ListResources_593092; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists resources associated with a project in AWS CodeStar.
  ## 
...
proc call*(call_593105: Call_ListResources_593092; body: JsonNode): Recallable =
  ## listResources
  ## Lists resources associated with a project in AWS CodeStar.
  ##   body: JObject (required)
...
var listResources* = Call_ListResources_593092(name: "listResources",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListResources",
    validator: validate_ListResources_593093, base: "/", url: url_ListResources_593094,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForProject_593107 = ref object of OpenApiRestCall_592364
proc url_ListTagsForProject_593109(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForProject_593108(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_593119: Call_ListTagsForProject_593107; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the tags for a project.
  ## 
...
proc call*(call_593120: Call_ListTagsForProject_593107; body: JsonNode): Recallable =
  ## listTagsForProject
  ## Gets the tags for a project.
  ##   body: JObject (required)
...
var listTagsForProject* = Call_ListTagsForProject_593107(
    name: "listTagsForProject", meth: HttpMethod.HttpPost,
    host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTagsForProject",
    validator: validate_ListTagsForProject_593108, base: "/",
    url: url_ListTagsForProject_593109, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTeamMembers_593122 = ref object of OpenApiRestCall_592364
proc url_ListTeamMembers_593124(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTeamMembers_593123(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_593134: Call_ListTeamMembers_593122; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all team members associated with a project.
  ## 
...
proc call*(call_593135: Call_ListTeamMembers_593122; body: JsonNode): Recallable =
  ## listTeamMembers
  ## Lists all team members associated with a project.
  ##   body: JObject (required)
...
var listTeamMembers* = Call_ListTeamMembers_593122(name: "listTeamMembers",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListTeamMembers",
    validator: validate_ListTeamMembers_593123, base: "/", url: url_ListTeamMembers_593124,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUserProfiles_593137 = ref object of OpenApiRestCall_592364
proc url_ListUserProfiles_593139(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListUserProfiles_593138(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_593149: Call_ListUserProfiles_593137; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ## 
...
proc call*(call_593150: Call_ListUserProfiles_593137; body: JsonNode): Recallable =
  ## listUserProfiles
  ## Lists all the user profiles configured for your AWS account in AWS CodeStar.
  ##   body: JObject (required)
...
var listUserProfiles* = Call_ListUserProfiles_593137(name: "listUserProfiles",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.ListUserProfiles",
    validator: validate_ListUserProfiles_593138, base: "/",
    url: url_ListUserProfiles_593139, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagProject_593152 = ref object of OpenApiRestCall_592364
proc url_TagProject_593154(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagProject_593153(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593164: Call_TagProject_593152; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds tags to a project.
  ## 
...
proc call*(call_593165: Call_TagProject_593152; body: JsonNode): Recallable =
  ## tagProject
  ## Adds tags to a project.
  ##   body: JObject (required)
...
var tagProject* = Call_TagProject_593152(name: "tagProject",
                                      meth: HttpMethod.HttpPost,
                                      host: "codestar.amazonaws.com", route: "/#X-Amz-Target=CodeStar_20170419.TagProject",
                                      validator: validate_TagProject_593153,
                                      base: "/", url: url_TagProject_593154,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagProject_593167 = ref object of OpenApiRestCall_592364
proc url_UntagProject_593169(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagProject_593168(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593179: Call_UntagProject_593167; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes tags from a project.
  ## 
...
proc call*(call_593180: Call_UntagProject_593167; body: JsonNode): Recallable =
  ## untagProject
  ## Removes tags from a project.
  ##   body: JObject (required)
...
var untagProject* = Call_UntagProject_593167(name: "untagProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UntagProject",
    validator: validate_UntagProject_593168, base: "/", url: url_UntagProject_593169,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateProject_593182 = ref object of OpenApiRestCall_592364
proc url_UpdateProject_593184(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateProject_593183(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593194: Call_UpdateProject_593182; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a project in AWS CodeStar.
  ## 
...
proc call*(call_593195: Call_UpdateProject_593182; body: JsonNode): Recallable =
  ## updateProject
  ## Updates a project in AWS CodeStar.
  ##   body: JObject (required)
...
var updateProject* = Call_UpdateProject_593182(name: "updateProject",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateProject",
    validator: validate_UpdateProject_593183, base: "/", url: url_UpdateProject_593184,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTeamMember_593197 = ref object of OpenApiRestCall_592364
proc url_UpdateTeamMember_593199(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTeamMember_593198(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_593209: Call_UpdateTeamMember_593197; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ## 
...
proc call*(call_593210: Call_UpdateTeamMember_593197; body: JsonNode): Recallable =
  ## updateTeamMember
  ## Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
  ##   body: JObject (required)
...
var updateTeamMember* = Call_UpdateTeamMember_593197(name: "updateTeamMember",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateTeamMember",
    validator: validate_UpdateTeamMember_593198, base: "/",
    url: url_UpdateTeamMember_593199, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateUserProfile_593212 = ref object of OpenApiRestCall_592364
proc url_UpdateUserProfile_593214(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateUserProfile_593213(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_593224: Call_UpdateUserProfile_593212; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ## 
...
proc call*(call_593225: Call_UpdateUserProfile_593212; body: JsonNode): Recallable =
  ## updateUserProfile
  ## Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in the user profile is displayed wherever the user's information appears to other users in AWS CodeStar. 
  ##   body: JObject (required)
...
var updateUserProfile* = Call_UpdateUserProfile_593212(name: "updateUserProfile",
    meth: HttpMethod.HttpPost, host: "codestar.amazonaws.com",
    route: "/#X-Amz-Target=CodeStar_20170419.UpdateUserProfile",
    validator: validate_UpdateUserProfile_593213, base: "/",
    url: url_UpdateUserProfile_593214, schemes: {Scheme.Https, Scheme.Http})
export
  rest
