...
type
  Call_CancelCommand_599974 = ref object of OpenApiRestCall_599368
proc url_CancelCommand_599976(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CancelCommand_599975(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_599986: Call_CancelCommand_599974; path: JsonNode; query: JsonNode;
...
proc call*(call_599987: Call_CancelCommand_599974; body: JsonNode): Recallable =
  ## cancelCommand
  ## Attempts to cancel the command specified by the Command ID. There is no guarantee that the command will be terminated and the underlying process stopped.
  ##   body: JObject (required)
...
var cancelCommand* = Call_CancelCommand_599974(name: "cancelCommand",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CancelCommand",
    validator: validate_CancelCommand_599975, base: "/", url: url_CancelCommand_599976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CancelMaintenanceWindowExecution_599989 = ref object of OpenApiRestCall_599368
proc url_CancelMaintenanceWindowExecution_599991(protocol: Scheme; host: string;
...
proc validate_CancelMaintenanceWindowExecution_599990(path: JsonNode;
...
proc call*(call_600001: Call_CancelMaintenanceWindowExecution_599989;
...
proc call*(call_600002: Call_CancelMaintenanceWindowExecution_599989;
          body: JsonNode): Recallable =
...
var cancelMaintenanceWindowExecution* = Call_CancelMaintenanceWindowExecution_599989(
    ...
    validator: validate_CancelMaintenanceWindowExecution_599990, base: "/",
    url: url_CancelMaintenanceWindowExecution_599991,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateActivation_600004 = ref object of OpenApiRestCall_599368
proc url_CreateActivation_600006(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateActivation_600005(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600016: Call_CreateActivation_600004; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Registers your on-premises server or virtual machine with Amazon EC2 so that you can manage these resources using Run Command. An on-premises server or virtual machine that has been registered with EC2 is called a managed instance. For more information about activations, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-managedinstances.html">Setting Up AWS Systems Manager for Hybrid Environments</a>.
  ## 
...
proc call*(call_600017: Call_CreateActivation_600004; body: JsonNode): Recallable =
  ## createActivation
  ## Registers your on-premises server or virtual machine with Amazon EC2 so that you can manage these resources using Run Command. An on-premises server or virtual machine that has been registered with EC2 is called a managed instance. For more information about activations, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-managedinstances.html">Setting Up AWS Systems Manager for Hybrid Environments</a>.
  ##   body: JObject (required)
...
var createActivation* = Call_CreateActivation_600004(name: "createActivation",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateActivation",
    validator: validate_CreateActivation_600005, base: "/",
    url: url_CreateActivation_600006, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAssociation_600019 = ref object of OpenApiRestCall_599368
proc url_CreateAssociation_600021(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAssociation_600020(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_600031: Call_CreateAssociation_600019; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Associates the specified Systems Manager document with the specified instances or targets.</p> <p>When you associate a document with one or more instances using instance IDs or tags, SSM Agent running on the instance processes the document and configures the instance as specified.</p> <p>If you associate a document with an instance that already has an associated document, the system returns the AssociationAlreadyExists exception.</p>
  ## 
...
proc call*(call_600032: Call_CreateAssociation_600019; body: JsonNode): Recallable =
  ## createAssociation
  ## <p>Associates the specified Systems Manager document with the specified instances or targets.</p> <p>When you associate a document with one or more instances using instance IDs or tags, SSM Agent running on the instance processes the document and configures the instance as specified.</p> <p>If you associate a document with an instance that already has an associated document, the system returns the AssociationAlreadyExists exception.</p>
  ##   body: JObject (required)
...
var createAssociation* = Call_CreateAssociation_600019(name: "createAssociation",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateAssociation",
    validator: validate_CreateAssociation_600020, base: "/",
    url: url_CreateAssociation_600021, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAssociationBatch_600034 = ref object of OpenApiRestCall_599368
proc url_CreateAssociationBatch_600036(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAssociationBatch_600035(path: JsonNode; query: JsonNode;
...
proc call*(call_600046: Call_CreateAssociationBatch_600034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Associates the specified Systems Manager document with the specified instances or targets.</p> <p>When you associate a document with one or more instances using instance IDs or tags, SSM Agent running on the instance processes the document and configures the instance as specified.</p> <p>If you associate a document with an instance that already has an associated document, the system returns the AssociationAlreadyExists exception.</p>
  ## 
...
proc call*(call_600047: Call_CreateAssociationBatch_600034; body: JsonNode): Recallable =
...
var createAssociationBatch* = Call_CreateAssociationBatch_600034(
    name: "createAssociationBatch", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateAssociationBatch",
    validator: validate_CreateAssociationBatch_600035, base: "/",
    url: url_CreateAssociationBatch_600036, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDocument_600049 = ref object of OpenApiRestCall_599368
proc url_CreateDocument_600051(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDocument_600050(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_600061: Call_CreateDocument_600049; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a Systems Manager document.</p> <p>After you create a document, you can use CreateAssociation to associate it with one or more running instances.</p>
  ## 
...
proc call*(call_600062: Call_CreateDocument_600049; body: JsonNode): Recallable =
  ## createDocument
  ## <p>Creates a Systems Manager document.</p> <p>After you create a document, you can use CreateAssociation to associate it with one or more running instances.</p>
  ##   body: JObject (required)
...
var createDocument* = Call_CreateDocument_600049(name: "createDocument",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateDocument",
    validator: validate_CreateDocument_600050, base: "/", url: url_CreateDocument_600051,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateMaintenanceWindow_600064 = ref object of OpenApiRestCall_599368
proc url_CreateMaintenanceWindow_600066(protocol: Scheme; host: string; base: string;
...
proc validate_CreateMaintenanceWindow_600065(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600076: Call_CreateMaintenanceWindow_600064; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a new maintenance window.</p> <note> <p>The value you specify for <code>Duration</code> determines the specific end time for the maintenance window based on the time it begins. No maintenance window tasks are permitted to start after the resulting endtime minus the number of hours you specify for <code>Cutoff</code>. For example, if the maintenance window starts at 3 PM, the duration is three hours, and the value you specify for <code>Cutoff</code> is one hour, no maintenance window tasks can start after 5 PM.</p> </note>
  ## 
...
proc call*(call_600077: Call_CreateMaintenanceWindow_600064; body: JsonNode): Recallable =
...
var createMaintenanceWindow* = Call_CreateMaintenanceWindow_600064(
    name: "createMaintenanceWindow", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateMaintenanceWindow",
    validator: validate_CreateMaintenanceWindow_600065, base: "/",
    url: url_CreateMaintenanceWindow_600066, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateOpsItem_600079 = ref object of OpenApiRestCall_599368
proc url_CreateOpsItem_600081(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateOpsItem_600080(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600091: Call_CreateOpsItem_600079; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a new OpsItem. You must have permission in AWS Identity and Access Management (IAM) to create a new OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ## 
...
proc call*(call_600092: Call_CreateOpsItem_600079; body: JsonNode): Recallable =
  ## createOpsItem
  ## <p>Creates a new OpsItem. You must have permission in AWS Identity and Access Management (IAM) to create a new OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ##   body: JObject (required)
...
var createOpsItem* = Call_CreateOpsItem_600079(name: "createOpsItem",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateOpsItem",
    validator: validate_CreateOpsItem_600080, base: "/", url: url_CreateOpsItem_600081,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreatePatchBaseline_600094 = ref object of OpenApiRestCall_599368
proc url_CreatePatchBaseline_600096(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreatePatchBaseline_600095(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_600106: Call_CreatePatchBaseline_600094; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a patch baseline.</p> <note> <p>For information about valid key and value pairs in <code>PatchFilters</code> for each supported operating system type, see <a href="http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html">PatchFilter</a>.</p> </note>
  ## 
...
proc call*(call_600107: Call_CreatePatchBaseline_600094; body: JsonNode): Recallable =
  ## createPatchBaseline
  ## <p>Creates a patch baseline.</p> <note> <p>For information about valid key and value pairs in <code>PatchFilters</code> for each supported operating system type, see <a href="http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html">PatchFilter</a>.</p> </note>
  ##   body: JObject (required)
...
var createPatchBaseline* = Call_CreatePatchBaseline_600094(
    name: "createPatchBaseline", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreatePatchBaseline",
    validator: validate_CreatePatchBaseline_600095, base: "/",
    url: url_CreatePatchBaseline_600096, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResourceDataSync_600109 = ref object of OpenApiRestCall_599368
proc url_CreateResourceDataSync_600111(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateResourceDataSync_600110(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600121: Call_CreateResourceDataSync_600109; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>A resource data sync helps you view data from multiple sources in a single location. Systems Manager offers two types of resource data sync: <code>SyncToDestination</code> and <code>SyncFromSource</code>.</p> <p>You can configure Systems Manager Inventory to use the <code>SyncToDestination</code> type to synchronize Inventory data from multiple AWS Regions to a single Amazon S3 bucket. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-inventory-datasync.html">Configuring Resource Data Sync for Inventory</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>You can configure Systems Manager Explorer to use the <code>SyncToDestination</code> type to synchronize operational work items (OpsItems) and operational data (OpsData) from multiple AWS Regions to a single Amazon S3 bucket. You can also configure Explorer to use the <code>SyncFromSource</code> type. This type synchronizes OpsItems and OpsData from multiple AWS accounts and Regions by using AWS Organizations. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/Explorer-resource-data-sync.html">Setting Up Explorer to Display Data from Multiple Accounts and Regions</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>A resource data sync is an asynchronous operation that returns immediately. After a successful initial sync is completed, the system continuously syncs data. To check the status of a sync, use the <a>ListResourceDataSync</a>.</p> <note> <p>By default, data is not encrypted in Amazon S3. We strongly recommend that you enable encryption in Amazon S3 to ensure secure data storage. We also recommend that you secure access to the Amazon S3 bucket by creating a restrictive bucket policy. </p> </note>
  ## 
...
proc call*(call_600122: Call_CreateResourceDataSync_600109; body: JsonNode): Recallable =
...
var createResourceDataSync* = Call_CreateResourceDataSync_600109(
    name: "createResourceDataSync", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.CreateResourceDataSync",
    validator: validate_CreateResourceDataSync_600110, base: "/",
    url: url_CreateResourceDataSync_600111, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteActivation_600124 = ref object of OpenApiRestCall_599368
proc url_DeleteActivation_600126(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteActivation_600125(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600136: Call_DeleteActivation_600124; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an activation. You are not required to delete an activation. If you delete an activation, you can no longer use it to register additional managed instances. Deleting an activation does not de-register managed instances. You must manually de-register managed instances.
  ## 
...
proc call*(call_600137: Call_DeleteActivation_600124; body: JsonNode): Recallable =
  ## deleteActivation
  ## Deletes an activation. You are not required to delete an activation. If you delete an activation, you can no longer use it to register additional managed instances. Deleting an activation does not de-register managed instances. You must manually de-register managed instances.
  ##   body: JObject (required)
...
var deleteActivation* = Call_DeleteActivation_600124(name: "deleteActivation",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteActivation",
    validator: validate_DeleteActivation_600125, base: "/",
    url: url_DeleteActivation_600126, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAssociation_600139 = ref object of OpenApiRestCall_599368
proc url_DeleteAssociation_600141(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAssociation_600140(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_600151: Call_DeleteAssociation_600139; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Disassociates the specified Systems Manager document from the specified instance.</p> <p>When you disassociate a document from an instance, it does not change the configuration of the instance. To change the configuration state of an instance after you disassociate a document, you must create a new document with the desired configuration and associate it with the instance.</p>
  ## 
...
proc call*(call_600152: Call_DeleteAssociation_600139; body: JsonNode): Recallable =
  ## deleteAssociation
  ## <p>Disassociates the specified Systems Manager document from the specified instance.</p> <p>When you disassociate a document from an instance, it does not change the configuration of the instance. To change the configuration state of an instance after you disassociate a document, you must create a new document with the desired configuration and associate it with the instance.</p>
  ##   body: JObject (required)
...
var deleteAssociation* = Call_DeleteAssociation_600139(name: "deleteAssociation",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteAssociation",
    validator: validate_DeleteAssociation_600140, base: "/",
    url: url_DeleteAssociation_600141, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDocument_600154 = ref object of OpenApiRestCall_599368
proc url_DeleteDocument_600156(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDocument_600155(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_600166: Call_DeleteDocument_600154; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the Systems Manager document and all instance associations to the document.</p> <p>Before you delete the document, we recommend that you use <a>DeleteAssociation</a> to disassociate all instances that are associated with the document.</p>
  ## 
...
proc call*(call_600167: Call_DeleteDocument_600154; body: JsonNode): Recallable =
  ## deleteDocument
  ## <p>Deletes the Systems Manager document and all instance associations to the document.</p> <p>Before you delete the document, we recommend that you use <a>DeleteAssociation</a> to disassociate all instances that are associated with the document.</p>
  ##   body: JObject (required)
...
var deleteDocument* = Call_DeleteDocument_600154(name: "deleteDocument",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteDocument",
    validator: validate_DeleteDocument_600155, base: "/", url: url_DeleteDocument_600156,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteInventory_600169 = ref object of OpenApiRestCall_599368
proc url_DeleteInventory_600171(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteInventory_600170(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_600181: Call_DeleteInventory_600169; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a custom inventory type, or the data associated with a custom Inventory type. Deleting a custom inventory type is also referred to as deleting a custom inventory schema.
  ## 
...
proc call*(call_600182: Call_DeleteInventory_600169; body: JsonNode): Recallable =
  ## deleteInventory
  ## Delete a custom inventory type, or the data associated with a custom Inventory type. Deleting a custom inventory type is also referred to as deleting a custom inventory schema.
  ##   body: JObject (required)
...
var deleteInventory* = Call_DeleteInventory_600169(name: "deleteInventory",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteInventory",
    validator: validate_DeleteInventory_600170, base: "/", url: url_DeleteInventory_600171,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteMaintenanceWindow_600184 = ref object of OpenApiRestCall_599368
proc url_DeleteMaintenanceWindow_600186(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteMaintenanceWindow_600185(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600196: Call_DeleteMaintenanceWindow_600184; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a maintenance window.
  ## 
...
proc call*(call_600197: Call_DeleteMaintenanceWindow_600184; body: JsonNode): Recallable =
...
var deleteMaintenanceWindow* = Call_DeleteMaintenanceWindow_600184(
    name: "deleteMaintenanceWindow", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteMaintenanceWindow",
    validator: validate_DeleteMaintenanceWindow_600185, base: "/",
    url: url_DeleteMaintenanceWindow_600186, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteParameter_600199 = ref object of OpenApiRestCall_599368
proc url_DeleteParameter_600201(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteParameter_600200(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_600211: Call_DeleteParameter_600199; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a parameter from the system.
  ## 
...
proc call*(call_600212: Call_DeleteParameter_600199; body: JsonNode): Recallable =
  ## deleteParameter
  ## Delete a parameter from the system.
  ##   body: JObject (required)
...
var deleteParameter* = Call_DeleteParameter_600199(name: "deleteParameter",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteParameter",
    validator: validate_DeleteParameter_600200, base: "/", url: url_DeleteParameter_600201,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteParameters_600214 = ref object of OpenApiRestCall_599368
proc url_DeleteParameters_600216(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteParameters_600215(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600226: Call_DeleteParameters_600214; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a list of parameters.
  ## 
...
proc call*(call_600227: Call_DeleteParameters_600214; body: JsonNode): Recallable =
  ## deleteParameters
  ## Delete a list of parameters.
  ##   body: JObject (required)
...
var deleteParameters* = Call_DeleteParameters_600214(name: "deleteParameters",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteParameters",
    validator: validate_DeleteParameters_600215, base: "/",
    url: url_DeleteParameters_600216, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeletePatchBaseline_600229 = ref object of OpenApiRestCall_599368
proc url_DeletePatchBaseline_600231(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeletePatchBaseline_600230(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_600241: Call_DeletePatchBaseline_600229; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a patch baseline.
  ## 
...
proc call*(call_600242: Call_DeletePatchBaseline_600229; body: JsonNode): Recallable =
  ## deletePatchBaseline
  ## Deletes a patch baseline.
  ##   body: JObject (required)
...
var deletePatchBaseline* = Call_DeletePatchBaseline_600229(
    name: "deletePatchBaseline", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeletePatchBaseline",
    validator: validate_DeletePatchBaseline_600230, base: "/",
    url: url_DeletePatchBaseline_600231, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResourceDataSync_600244 = ref object of OpenApiRestCall_599368
proc url_DeleteResourceDataSync_600246(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteResourceDataSync_600245(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600256: Call_DeleteResourceDataSync_600244; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a Resource Data Sync configuration. After the configuration is deleted, changes to data on managed instances are no longer synced to or from the target. Deleting a sync configuration does not delete data.
  ## 
...
proc call*(call_600257: Call_DeleteResourceDataSync_600244; body: JsonNode): Recallable =
...
var deleteResourceDataSync* = Call_DeleteResourceDataSync_600244(
    name: "deleteResourceDataSync", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeleteResourceDataSync",
    validator: validate_DeleteResourceDataSync_600245, base: "/",
    url: url_DeleteResourceDataSync_600246, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterManagedInstance_600259 = ref object of OpenApiRestCall_599368
proc url_DeregisterManagedInstance_600261(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterManagedInstance_600260(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600271: Call_DeregisterManagedInstance_600259; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the server or virtual machine from the list of registered servers. You can reregister the instance again at any time. If you don't plan to use Run Command on the server, we suggest uninstalling SSM Agent first.
  ## 
...
proc call*(call_600272: Call_DeregisterManagedInstance_600259; body: JsonNode): Recallable =
...
var deregisterManagedInstance* = Call_DeregisterManagedInstance_600259(
    name: "deregisterManagedInstance", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DeregisterManagedInstance",
    validator: validate_DeregisterManagedInstance_600260, base: "/",
    url: url_DeregisterManagedInstance_600261,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterPatchBaselineForPatchGroup_600274 = ref object of OpenApiRestCall_599368
proc url_DeregisterPatchBaselineForPatchGroup_600276(protocol: Scheme;
...
proc validate_DeregisterPatchBaselineForPatchGroup_600275(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600286: Call_DeregisterPatchBaselineForPatchGroup_600274;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Removes a patch group from a patch baseline.
  ## 
...
proc call*(call_600287: Call_DeregisterPatchBaselineForPatchGroup_600274;
          body: JsonNode): Recallable =
...
var deregisterPatchBaselineForPatchGroup* = Call_DeregisterPatchBaselineForPatchGroup_600274(
    ...
    validator: validate_DeregisterPatchBaselineForPatchGroup_600275, base: "/",
    url: url_DeregisterPatchBaselineForPatchGroup_600276,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterTargetFromMaintenanceWindow_600289 = ref object of OpenApiRestCall_599368
proc url_DeregisterTargetFromMaintenanceWindow_600291(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterTargetFromMaintenanceWindow_600290(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600301: Call_DeregisterTargetFromMaintenanceWindow_600289;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Removes a target from a maintenance window.
  ## 
...
proc call*(call_600302: Call_DeregisterTargetFromMaintenanceWindow_600289;
          body: JsonNode): Recallable =
...
var deregisterTargetFromMaintenanceWindow* = Call_DeregisterTargetFromMaintenanceWindow_600289(
    ...
    validator: validate_DeregisterTargetFromMaintenanceWindow_600290, base: "/",
    url: url_DeregisterTargetFromMaintenanceWindow_600291,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterTaskFromMaintenanceWindow_600304 = ref object of OpenApiRestCall_599368
proc url_DeregisterTaskFromMaintenanceWindow_600306(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterTaskFromMaintenanceWindow_600305(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600316: Call_DeregisterTaskFromMaintenanceWindow_600304;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Removes a task from a maintenance window.
  ## 
...
proc call*(call_600317: Call_DeregisterTaskFromMaintenanceWindow_600304;
          body: JsonNode): Recallable =
...
var deregisterTaskFromMaintenanceWindow* = Call_DeregisterTaskFromMaintenanceWindow_600304(
    ...
    validator: validate_DeregisterTaskFromMaintenanceWindow_600305, base: "/",
    url: url_DeregisterTaskFromMaintenanceWindow_600306,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeActivations_600319 = ref object of OpenApiRestCall_599368
proc url_DescribeActivations_600321(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeActivations_600320(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_600323 = query.getOrDefault("MaxResults")
  valid_600323 = validateParameter(valid_600323, JString, required = false,
                                 default = nil)
  if valid_600323 != nil:
    section.add "MaxResults", valid_600323
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600326 = header.getOrDefault("X-Amz-Target")
  valid_600326 = validateParameter(valid_600326, JString, required = true, default = newJString(
      "AmazonSSM.DescribeActivations"))
  if valid_600326 != nil:
    section.add "X-Amz-Target", valid_600326
...
proc call*(call_600333: Call_DescribeActivations_600319; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes details about the activation, such as the date and time the activation was created, its expiration date, the IAM role assigned to the instances in the activation, and the number of instances registered by using this activation.
  ## 
...
proc call*(call_600334: Call_DescribeActivations_600319; body: JsonNode;
  ...
  ##   MaxResults: string
  ##             : Pagination limit
  var query_600335 = newJObject()
  var body_600336 = newJObject()
  add(query_600335, "NextToken", newJString(NextToken))
  if body != nil:
    body_600336 = body
  add(query_600335, "MaxResults", newJString(MaxResults))
  result = call_600334.call(nil, query_600335, nil, nil, body_600336)

var describeActivations* = Call_DescribeActivations_600319(
    name: "describeActivations", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeActivations",
    validator: validate_DescribeActivations_600320, base: "/",
    url: url_DescribeActivations_600321, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAssociation_600338 = ref object of OpenApiRestCall_599368
proc url_DescribeAssociation_600340(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAssociation_600339(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_600350: Call_DescribeAssociation_600338; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the association for the specified target or instance. If you created the association by using the <code>Targets</code> parameter, then you must retrieve the association by using the association ID. If you created the association by specifying an instance ID and a Systems Manager document, then you retrieve the association by specifying the document name and the instance ID. 
  ## 
...
proc call*(call_600351: Call_DescribeAssociation_600338; body: JsonNode): Recallable =
  ## describeAssociation
  ## Describes the association for the specified target or instance. If you created the association by using the <code>Targets</code> parameter, then you must retrieve the association by using the association ID. If you created the association by specifying an instance ID and a Systems Manager document, then you retrieve the association by specifying the document name and the instance ID. 
  ##   body: JObject (required)
...
var describeAssociation* = Call_DescribeAssociation_600338(
    name: "describeAssociation", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeAssociation",
    validator: validate_DescribeAssociation_600339, base: "/",
    url: url_DescribeAssociation_600340, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAssociationExecutionTargets_600353 = ref object of OpenApiRestCall_599368
proc url_DescribeAssociationExecutionTargets_600355(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAssociationExecutionTargets_600354(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600365: Call_DescribeAssociationExecutionTargets_600353;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Use this API action to view information about a specific execution of a specific association.
  ## 
...
proc call*(call_600366: Call_DescribeAssociationExecutionTargets_600353;
          body: JsonNode): Recallable =
...
var describeAssociationExecutionTargets* = Call_DescribeAssociationExecutionTargets_600353(
    ...
    validator: validate_DescribeAssociationExecutionTargets_600354, base: "/",
    url: url_DescribeAssociationExecutionTargets_600355,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAssociationExecutions_600368 = ref object of OpenApiRestCall_599368
proc url_DescribeAssociationExecutions_600370(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAssociationExecutions_600369(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600380: Call_DescribeAssociationExecutions_600368; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Use this API action to view all executions for a specific association ID. 
  ## 
...
proc call*(call_600381: Call_DescribeAssociationExecutions_600368; body: JsonNode): Recallable =
...
var describeAssociationExecutions* = Call_DescribeAssociationExecutions_600368(
    name: "describeAssociationExecutions", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutions",
    validator: validate_DescribeAssociationExecutions_600369, base: "/",
    url: url_DescribeAssociationExecutions_600370,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAutomationExecutions_600383 = ref object of OpenApiRestCall_599368
proc url_DescribeAutomationExecutions_600385(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAutomationExecutions_600384(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600395: Call_DescribeAutomationExecutions_600383; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides details about all active and terminated Automation executions.
  ## 
...
proc call*(call_600396: Call_DescribeAutomationExecutions_600383; body: JsonNode): Recallable =
...
var describeAutomationExecutions* = Call_DescribeAutomationExecutions_600383(
    name: "describeAutomationExecutions", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeAutomationExecutions",
    validator: validate_DescribeAutomationExecutions_600384, base: "/",
    url: url_DescribeAutomationExecutions_600385,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAutomationStepExecutions_600398 = ref object of OpenApiRestCall_599368
proc url_DescribeAutomationStepExecutions_600400(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAutomationStepExecutions_600399(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600410: Call_DescribeAutomationStepExecutions_600398;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Information about all active and terminated step executions in an Automation workflow.
  ## 
...
proc call*(call_600411: Call_DescribeAutomationStepExecutions_600398;
          body: JsonNode): Recallable =
...
var describeAutomationStepExecutions* = Call_DescribeAutomationStepExecutions_600398(
    ...
    validator: validate_DescribeAutomationStepExecutions_600399, base: "/",
    url: url_DescribeAutomationStepExecutions_600400,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAvailablePatches_600413 = ref object of OpenApiRestCall_599368
proc url_DescribeAvailablePatches_600415(protocol: Scheme; host: string;
...
proc validate_DescribeAvailablePatches_600414(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600425: Call_DescribeAvailablePatches_600413; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all patches eligible to be included in a patch baseline.
  ## 
...
proc call*(call_600426: Call_DescribeAvailablePatches_600413; body: JsonNode): Recallable =
...
var describeAvailablePatches* = Call_DescribeAvailablePatches_600413(
    name: "describeAvailablePatches", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeAvailablePatches",
    validator: validate_DescribeAvailablePatches_600414, base: "/",
    url: url_DescribeAvailablePatches_600415, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDocument_600428 = ref object of OpenApiRestCall_599368
proc url_DescribeDocument_600430(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDocument_600429(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600440: Call_DescribeDocument_600428; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the specified Systems Manager document.
  ## 
...
proc call*(call_600441: Call_DescribeDocument_600428; body: JsonNode): Recallable =
  ## describeDocument
  ## Describes the specified Systems Manager document.
  ##   body: JObject (required)
...
var describeDocument* = Call_DescribeDocument_600428(name: "describeDocument",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeDocument",
    validator: validate_DescribeDocument_600429, base: "/",
    url: url_DescribeDocument_600430, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDocumentPermission_600443 = ref object of OpenApiRestCall_599368
proc url_DescribeDocumentPermission_600445(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDocumentPermission_600444(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600455: Call_DescribeDocumentPermission_600443; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the permissions for a Systems Manager document. If you created the document, you are the owner. If a document is shared, it can either be shared privately (by specifying a user's AWS account ID) or publicly (<i>All</i>). 
  ## 
...
proc call*(call_600456: Call_DescribeDocumentPermission_600443; body: JsonNode): Recallable =
...
var describeDocumentPermission* = Call_DescribeDocumentPermission_600443(
    name: "describeDocumentPermission", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeDocumentPermission",
    validator: validate_DescribeDocumentPermission_600444, base: "/",
    url: url_DescribeDocumentPermission_600445,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEffectiveInstanceAssociations_600458 = ref object of OpenApiRestCall_599368
proc url_DescribeEffectiveInstanceAssociations_600460(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEffectiveInstanceAssociations_600459(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600470: Call_DescribeEffectiveInstanceAssociations_600458;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## All associations for the instance(s).
  ## 
...
proc call*(call_600471: Call_DescribeEffectiveInstanceAssociations_600458;
          body: JsonNode): Recallable =
...
var describeEffectiveInstanceAssociations* = Call_DescribeEffectiveInstanceAssociations_600458(
    ...
    validator: validate_DescribeEffectiveInstanceAssociations_600459, base: "/",
    url: url_DescribeEffectiveInstanceAssociations_600460,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEffectivePatchesForPatchBaseline_600473 = ref object of OpenApiRestCall_599368
proc url_DescribeEffectivePatchesForPatchBaseline_600475(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEffectivePatchesForPatchBaseline_600474(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600485: Call_DescribeEffectivePatchesForPatchBaseline_600473;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the current effective patches (the patch and the approval state) for the specified patch baseline. Note that this API applies only to Windows patch baselines.
  ## 
...
proc call*(call_600486: Call_DescribeEffectivePatchesForPatchBaseline_600473;
          body: JsonNode): Recallable =
...
var describeEffectivePatchesForPatchBaseline* = Call_DescribeEffectivePatchesForPatchBaseline_600473(
    ...
    validator: validate_DescribeEffectivePatchesForPatchBaseline_600474,
    base: "/", url: url_DescribeEffectivePatchesForPatchBaseline_600475,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInstanceAssociationsStatus_600488 = ref object of OpenApiRestCall_599368
proc url_DescribeInstanceAssociationsStatus_600490(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInstanceAssociationsStatus_600489(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600500: Call_DescribeInstanceAssociationsStatus_600488;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## The status of the associations for the instance(s).
  ## 
...
proc call*(call_600501: Call_DescribeInstanceAssociationsStatus_600488;
          body: JsonNode): Recallable =
...
var describeInstanceAssociationsStatus* = Call_DescribeInstanceAssociationsStatus_600488(
    ...
    validator: validate_DescribeInstanceAssociationsStatus_600489, base: "/",
    url: url_DescribeInstanceAssociationsStatus_600490,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInstanceInformation_600503 = ref object of OpenApiRestCall_599368
proc url_DescribeInstanceInformation_600505(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInstanceInformation_600504(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_600506 = query.getOrDefault("NextToken")
  valid_600506 = validateParameter(valid_600506, JString, required = false,
                                 default = nil)
  if valid_600506 != nil:
    section.add "NextToken", valid_600506
  var valid_600507 = query.getOrDefault("MaxResults")
  valid_600507 = validateParameter(valid_600507, JString, required = false,
                                 default = nil)
  if valid_600507 != nil:
    section.add "MaxResults", valid_600507
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600510 = header.getOrDefault("X-Amz-Target")
  valid_600510 = validateParameter(valid_600510, JString, required = true, default = newJString(
      "AmazonSSM.DescribeInstanceInformation"))
  if valid_600510 != nil:
    section.add "X-Amz-Target", valid_600510
...
proc call*(call_600517: Call_DescribeInstanceInformation_600503; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes one or more of your instances. You can use this to get information about instances like the operating system platform, the SSM Agent version (Linux), status etc. If you specify one or more instance IDs, it returns information for those instances. If you do not specify instance IDs, it returns information for all your instances. If you specify an instance ID that is not valid or an instance that you do not own, you receive an error. </p> <note> <p>The IamRole field for this API action is the Amazon Identity and Access Management (IAM) role assigned to on-premises instances. This call does not return the IAM role for Amazon EC2 instances.</p> </note>
  ## 
...
proc call*(call_600518: Call_DescribeInstanceInformation_600503; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_600519, "NextToken", newJString(NextToken))
  if body != nil:
    body_600520 = body
  add(query_600519, "MaxResults", newJString(MaxResults))
  result = call_600518.call(nil, query_600519, nil, nil, body_600520)

var describeInstanceInformation* = Call_DescribeInstanceInformation_600503(
    name: "describeInstanceInformation", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeInstanceInformation",
    validator: validate_DescribeInstanceInformation_600504, base: "/",
    url: url_DescribeInstanceInformation_600505,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInstancePatchStates_600521 = ref object of OpenApiRestCall_599368
proc url_DescribeInstancePatchStates_600523(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInstancePatchStates_600522(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600533: Call_DescribeInstancePatchStates_600521; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the high-level patch state of one or more instances.
  ## 
...
proc call*(call_600534: Call_DescribeInstancePatchStates_600521; body: JsonNode): Recallable =
...
var describeInstancePatchStates* = Call_DescribeInstancePatchStates_600521(
    name: "describeInstancePatchStates", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStates",
    validator: validate_DescribeInstancePatchStates_600522, base: "/",
    url: url_DescribeInstancePatchStates_600523,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInstancePatchStatesForPatchGroup_600536 = ref object of OpenApiRestCall_599368
proc url_DescribeInstancePatchStatesForPatchGroup_600538(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInstancePatchStatesForPatchGroup_600537(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600548: Call_DescribeInstancePatchStatesForPatchGroup_600536;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the high-level patch state for the instances in the specified patch group.
  ## 
...
proc call*(call_600549: Call_DescribeInstancePatchStatesForPatchGroup_600536;
          body: JsonNode): Recallable =
...
var describeInstancePatchStatesForPatchGroup* = Call_DescribeInstancePatchStatesForPatchGroup_600536(
    ...
    validator: validate_DescribeInstancePatchStatesForPatchGroup_600537,
    base: "/", url: url_DescribeInstancePatchStatesForPatchGroup_600538,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInstancePatches_600551 = ref object of OpenApiRestCall_599368
proc url_DescribeInstancePatches_600553(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeInstancePatches_600552(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600563: Call_DescribeInstancePatches_600551; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves information about the patches on the specified instance and their state relative to the patch baseline being used for the instance.
  ## 
...
proc call*(call_600564: Call_DescribeInstancePatches_600551; body: JsonNode): Recallable =
...
var describeInstancePatches* = Call_DescribeInstancePatches_600551(
    name: "describeInstancePatches", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeInstancePatches",
    validator: validate_DescribeInstancePatches_600552, base: "/",
    url: url_DescribeInstancePatches_600553, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeInventoryDeletions_600566 = ref object of OpenApiRestCall_599368
proc url_DescribeInventoryDeletions_600568(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeInventoryDeletions_600567(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600578: Call_DescribeInventoryDeletions_600566; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a specific delete inventory operation.
  ## 
...
proc call*(call_600579: Call_DescribeInventoryDeletions_600566; body: JsonNode): Recallable =
...
var describeInventoryDeletions* = Call_DescribeInventoryDeletions_600566(
    name: "describeInventoryDeletions", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeInventoryDeletions",
    validator: validate_DescribeInventoryDeletions_600567, base: "/",
    url: url_DescribeInventoryDeletions_600568,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowExecutionTaskInvocations_600581 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowExecutionTaskInvocations_600583(
...
proc validate_DescribeMaintenanceWindowExecutionTaskInvocations_600582(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_600593: Call_DescribeMaintenanceWindowExecutionTaskInvocations_600581;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the individual task executions (one per target) for a particular task run as part of a maintenance window execution.
  ## 
...
proc call*(call_600594: Call_DescribeMaintenanceWindowExecutionTaskInvocations_600581;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowExecutionTaskInvocations* = Call_DescribeMaintenanceWindowExecutionTaskInvocations_600581(
    ...
    validator: validate_DescribeMaintenanceWindowExecutionTaskInvocations_600582,
    base: "/", url: url_DescribeMaintenanceWindowExecutionTaskInvocations_600583,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowExecutionTasks_600596 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowExecutionTasks_600598(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowExecutionTasks_600597(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600608: Call_DescribeMaintenanceWindowExecutionTasks_600596;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## For a given maintenance window execution, lists the tasks that were run.
  ## 
...
proc call*(call_600609: Call_DescribeMaintenanceWindowExecutionTasks_600596;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowExecutionTasks* = Call_DescribeMaintenanceWindowExecutionTasks_600596(
    ...
    validator: validate_DescribeMaintenanceWindowExecutionTasks_600597, base: "/",
    url: url_DescribeMaintenanceWindowExecutionTasks_600598,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowExecutions_600611 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowExecutions_600613(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowExecutions_600612(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600623: Call_DescribeMaintenanceWindowExecutions_600611;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the executions of a maintenance window. This includes information about when the maintenance window was scheduled to be active, and information about tasks registered and run with the maintenance window.
  ## 
...
proc call*(call_600624: Call_DescribeMaintenanceWindowExecutions_600611;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowExecutions* = Call_DescribeMaintenanceWindowExecutions_600611(
    ...
    validator: validate_DescribeMaintenanceWindowExecutions_600612, base: "/",
    url: url_DescribeMaintenanceWindowExecutions_600613,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowSchedule_600626 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowSchedule_600628(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowSchedule_600627(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600638: Call_DescribeMaintenanceWindowSchedule_600626;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves information about upcoming executions of a maintenance window.
  ## 
...
proc call*(call_600639: Call_DescribeMaintenanceWindowSchedule_600626;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowSchedule* = Call_DescribeMaintenanceWindowSchedule_600626(
    ...
    validator: validate_DescribeMaintenanceWindowSchedule_600627, base: "/",
    url: url_DescribeMaintenanceWindowSchedule_600628,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowTargets_600641 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowTargets_600643(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowTargets_600642(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600653: Call_DescribeMaintenanceWindowTargets_600641;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the targets registered with the maintenance window.
  ## 
...
proc call*(call_600654: Call_DescribeMaintenanceWindowTargets_600641;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowTargets* = Call_DescribeMaintenanceWindowTargets_600641(
    ...
    validator: validate_DescribeMaintenanceWindowTargets_600642, base: "/",
    url: url_DescribeMaintenanceWindowTargets_600643,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowTasks_600656 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowTasks_600658(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowTasks_600657(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600668: Call_DescribeMaintenanceWindowTasks_600656; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the tasks in a maintenance window.
  ## 
...
proc call*(call_600669: Call_DescribeMaintenanceWindowTasks_600656; body: JsonNode): Recallable =
...
var describeMaintenanceWindowTasks* = Call_DescribeMaintenanceWindowTasks_600656(
    name: "describeMaintenanceWindowTasks", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTasks",
    validator: validate_DescribeMaintenanceWindowTasks_600657, base: "/",
    url: url_DescribeMaintenanceWindowTasks_600658,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindows_600671 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindows_600673(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindows_600672(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600683: Call_DescribeMaintenanceWindows_600671; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the maintenance windows in an AWS account.
  ## 
...
proc call*(call_600684: Call_DescribeMaintenanceWindows_600671; body: JsonNode): Recallable =
...
var describeMaintenanceWindows* = Call_DescribeMaintenanceWindows_600671(
    name: "describeMaintenanceWindows", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindows",
    validator: validate_DescribeMaintenanceWindows_600672, base: "/",
    url: url_DescribeMaintenanceWindows_600673,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeMaintenanceWindowsForTarget_600686 = ref object of OpenApiRestCall_599368
proc url_DescribeMaintenanceWindowsForTarget_600688(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeMaintenanceWindowsForTarget_600687(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600698: Call_DescribeMaintenanceWindowsForTarget_600686;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves information about the maintenance window targets or tasks that an instance is associated with.
  ## 
...
proc call*(call_600699: Call_DescribeMaintenanceWindowsForTarget_600686;
          body: JsonNode): Recallable =
...
var describeMaintenanceWindowsForTarget* = Call_DescribeMaintenanceWindowsForTarget_600686(
    ...
    validator: validate_DescribeMaintenanceWindowsForTarget_600687, base: "/",
    url: url_DescribeMaintenanceWindowsForTarget_600688,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOpsItems_600701 = ref object of OpenApiRestCall_599368
proc url_DescribeOpsItems_600703(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeOpsItems_600702(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_600713: Call_DescribeOpsItems_600701; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Query a set of OpsItems. You must have permission in AWS Identity and Access Management (IAM) to query a list of OpsItems. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ## 
...
proc call*(call_600714: Call_DescribeOpsItems_600701; body: JsonNode): Recallable =
  ## describeOpsItems
  ## <p>Query a set of OpsItems. You must have permission in AWS Identity and Access Management (IAM) to query a list of OpsItems. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ##   body: JObject (required)
...
var describeOpsItems* = Call_DescribeOpsItems_600701(name: "describeOpsItems",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeOpsItems",
    validator: validate_DescribeOpsItems_600702, base: "/",
    url: url_DescribeOpsItems_600703, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeParameters_600716 = ref object of OpenApiRestCall_599368
proc url_DescribeParameters_600718(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeParameters_600717(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_600719 = query.getOrDefault("NextToken")
  valid_600719 = validateParameter(valid_600719, JString, required = false,
                                 default = nil)
  if valid_600719 != nil:
    section.add "NextToken", valid_600719
  var valid_600720 = query.getOrDefault("MaxResults")
  valid_600720 = validateParameter(valid_600720, JString, required = false,
                                 default = nil)
  if valid_600720 != nil:
    section.add "MaxResults", valid_600720
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600723 = header.getOrDefault("X-Amz-Target")
  valid_600723 = validateParameter(valid_600723, JString, required = true, default = newJString(
      "AmazonSSM.DescribeParameters"))
  if valid_600723 != nil:
    section.add "X-Amz-Target", valid_600723
...
proc call*(call_600730: Call_DescribeParameters_600716; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Get information about a parameter.</p> <note> <p>Request results are returned on a best-effort basis. If you specify <code>MaxResults</code> in the request, the response includes information up to the limit specified. The number of items returned, however, can be between zero and the value of <code>MaxResults</code>. If the service reaches an internal limit while processing the results, it stops the operation and returns the matching values up to that point and a <code>NextToken</code>. You can specify the <code>NextToken</code> in a subsequent call to get the next set of results.</p> </note>
  ## 
  let valid = call_600730.validator(path, query, header, formData, body)
  let scheme = call_600730.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_600730.url(scheme.get, call_600730.host, call_600730.base,
                         call_600730.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_600730, url, valid)

proc call*(call_600731: Call_DescribeParameters_600716; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## describeParameters
  ## <p>Get information about a parameter.</p> <note> <p>Request results are returned on a best-effort basis. If you specify <code>MaxResults</code> in the request, the response includes information up to the limit specified. The number of items returned, however, can be between zero and the value of <code>MaxResults</code>. If the service reaches an internal limit while processing the results, it stops the operation and returns the matching values up to that point and a <code>NextToken</code>. You can specify the <code>NextToken</code> in a subsequent call to get the next set of results.</p> </note>
  ##   NextToken: string
  ...
  ##   MaxResults: string
  ##             : Pagination limit
  var query_600732 = newJObject()
  var body_600733 = newJObject()
  add(query_600732, "NextToken", newJString(NextToken))
  if body != nil:
    body_600733 = body
  add(query_600732, "MaxResults", newJString(MaxResults))
  result = call_600731.call(nil, query_600732, nil, nil, body_600733)

var describeParameters* = Call_DescribeParameters_600716(
    name: "describeParameters", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeParameters",
    validator: validate_DescribeParameters_600717, base: "/",
    url: url_DescribeParameters_600718, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePatchBaselines_600734 = ref object of OpenApiRestCall_599368
proc url_DescribePatchBaselines_600736(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribePatchBaselines_600735(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600746: Call_DescribePatchBaselines_600734; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the patch baselines in your AWS account.
  ## 
...
proc call*(call_600747: Call_DescribePatchBaselines_600734; body: JsonNode): Recallable =
...
var describePatchBaselines* = Call_DescribePatchBaselines_600734(
    name: "describePatchBaselines", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribePatchBaselines",
    validator: validate_DescribePatchBaselines_600735, base: "/",
    url: url_DescribePatchBaselines_600736, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePatchGroupState_600749 = ref object of OpenApiRestCall_599368
proc url_DescribePatchGroupState_600751(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribePatchGroupState_600750(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600754 = header.getOrDefault("X-Amz-Target")
  valid_600754 = validateParameter(valid_600754, JString, required = true, default = newJString(
      "AmazonSSM.DescribePatchGroupState"))
  if valid_600754 != nil:
    section.add "X-Amz-Target", valid_600754
...
proc call*(call_600761: Call_DescribePatchGroupState_600749; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns high-level aggregated patch compliance state for a patch group.
  ## 
...
proc call*(call_600762: Call_DescribePatchGroupState_600749; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_600763 = body
  result = call_600762.call(nil, nil, nil, nil, body_600763)

var describePatchGroupState* = Call_DescribePatchGroupState_600749(
    name: "describePatchGroupState", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribePatchGroupState",
    validator: validate_DescribePatchGroupState_600750, base: "/",
    url: url_DescribePatchGroupState_600751, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePatchGroups_600764 = ref object of OpenApiRestCall_599368
proc url_DescribePatchGroups_600766(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribePatchGroups_600765(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600769 = header.getOrDefault("X-Amz-Target")
  valid_600769 = validateParameter(valid_600769, JString, required = true, default = newJString(
      "AmazonSSM.DescribePatchGroups"))
  if valid_600769 != nil:
    section.add "X-Amz-Target", valid_600769
  ...
  var valid_600771 = header.getOrDefault("X-Amz-Algorithm")
  valid_600771 = validateParameter(valid_600771, JString, required = false,
                                 default = nil)
  if valid_600771 != nil:
    section.add "X-Amz-Algorithm", valid_600771
  var valid_600772 = header.getOrDefault("X-Amz-Signature")
  valid_600772 = validateParameter(valid_600772, JString, required = false,
                                 default = nil)
  if valid_600772 != nil:
    section.add "X-Amz-Signature", valid_600772
  var valid_600773 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_600773 = validateParameter(valid_600773, JString, required = false,
                                 default = nil)
  if valid_600773 != nil:
    section.add "X-Amz-SignedHeaders", valid_600773
  var valid_600774 = header.getOrDefault("X-Amz-Credential")
  valid_600774 = validateParameter(valid_600774, JString, required = false,
                                 default = nil)
  if valid_600774 != nil:
    section.add "X-Amz-Credential", valid_600774
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_600776: Call_DescribePatchGroups_600764; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all patch groups that have been registered with patch baselines.
  ## 
...
proc call*(call_600777: Call_DescribePatchGroups_600764; body: JsonNode): Recallable =
  ## describePatchGroups
  ## Lists all patch groups that have been registered with patch baselines.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_600778 = body
  result = call_600777.call(nil, nil, nil, nil, body_600778)

var describePatchGroups* = Call_DescribePatchGroups_600764(
    name: "describePatchGroups", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribePatchGroups",
    validator: validate_DescribePatchGroups_600765, base: "/",
    url: url_DescribePatchGroups_600766, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePatchProperties_600779 = ref object of OpenApiRestCall_599368
proc url_DescribePatchProperties_600781(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribePatchProperties_600780(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600784 = header.getOrDefault("X-Amz-Target")
  valid_600784 = validateParameter(valid_600784, JString, required = true, default = newJString(
      "AmazonSSM.DescribePatchProperties"))
  if valid_600784 != nil:
    section.add "X-Amz-Target", valid_600784
...
proc call*(call_600791: Call_DescribePatchProperties_600779; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the properties of available patches organized by product, product family, classification, severity, and other properties of available patches. You can use the reported properties in the filters you specify in requests for actions such as <a>CreatePatchBaseline</a>, <a>UpdatePatchBaseline</a>, <a>DescribeAvailablePatches</a>, and <a>DescribePatchBaselines</a>.</p> <p>The following section lists the properties that can be used in filters for each major operating system type:</p> <dl> <dt>WINDOWS</dt> <dd> <p>Valid properties: PRODUCT, PRODUCT_FAMILY, CLASSIFICATION, MSRC_SEVERITY</p> </dd> <dt>AMAZON_LINUX</dt> <dd> <p>Valid properties: PRODUCT, CLASSIFICATION, SEVERITY</p> </dd> <dt>AMAZON_LINUX_2</dt> <dd> <p>Valid properties: PRODUCT, CLASSIFICATION, SEVERITY</p> </dd> <dt>UBUNTU </dt> <dd> <p>Valid properties: PRODUCT, PRIORITY</p> </dd> <dt>REDHAT_ENTERPRISE_LINUX</dt> <dd> <p>Valid properties: PRODUCT, CLASSIFICATION, SEVERITY</p> </dd> <dt>SUSE</dt> <dd> <p>Valid properties: PRODUCT, CLASSIFICATION, SEVERITY</p> </dd> <dt>CENTOS</dt> <dd> <p>Valid properties: PRODUCT, CLASSIFICATION, SEVERITY</p> </dd> </dl>
  ## 
  let valid = call_600791.validator(path, query, header, formData, body)
  let scheme = call_600791.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_600791.url(scheme.get, call_600791.host, call_600791.base,
                         call_600791.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_600791, url, valid)

proc call*(call_600792: Call_DescribePatchProperties_600779; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_600793 = body
  result = call_600792.call(nil, nil, nil, nil, body_600793)

var describePatchProperties* = Call_DescribePatchProperties_600779(
    name: "describePatchProperties", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribePatchProperties",
    validator: validate_DescribePatchProperties_600780, base: "/",
    url: url_DescribePatchProperties_600781, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSessions_600794 = ref object of OpenApiRestCall_599368
proc url_DescribeSessions_600796(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSessions_600795(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600799 = header.getOrDefault("X-Amz-Target")
  valid_600799 = validateParameter(valid_600799, JString, required = true, default = newJString(
      "AmazonSSM.DescribeSessions"))
  if valid_600799 != nil:
    section.add "X-Amz-Target", valid_600799
...
proc call*(call_600806: Call_DescribeSessions_600794; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a list of all active sessions (both connected and disconnected) or terminated sessions from the past 30 days.
  ## 
...
proc call*(call_600807: Call_DescribeSessions_600794; body: JsonNode): Recallable =
  ## describeSessions
  ## Retrieves a list of all active sessions (both connected and disconnected) or terminated sessions from the past 30 days.
  ##   body: JObject (required)
  var body_600808 = newJObject()
  if body != nil:
    body_600808 = body
  result = call_600807.call(nil, nil, nil, nil, body_600808)

var describeSessions* = Call_DescribeSessions_600794(name: "describeSessions",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.DescribeSessions",
    validator: validate_DescribeSessions_600795, base: "/",
    url: url_DescribeSessions_600796, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetAutomationExecution_600809 = ref object of OpenApiRestCall_599368
proc url_GetAutomationExecution_600811(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetAutomationExecution_600810(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600814 = header.getOrDefault("X-Amz-Target")
  valid_600814 = validateParameter(valid_600814, JString, required = true, default = newJString(
      "AmazonSSM.GetAutomationExecution"))
  if valid_600814 != nil:
    section.add "X-Amz-Target", valid_600814
...
proc call*(call_600821: Call_GetAutomationExecution_600809; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get detailed information about a particular Automation execution.
  ## 
...
proc call*(call_600822: Call_GetAutomationExecution_600809; body: JsonNode): Recallable =
  ## getAutomationExecution
  ## Get detailed information about a particular Automation execution.
  ##   body: JObject (required)
  var body_600823 = newJObject()
  if body != nil:
    body_600823 = body
  result = call_600822.call(nil, nil, nil, nil, body_600823)

var getAutomationExecution* = Call_GetAutomationExecution_600809(
    name: "getAutomationExecution", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetAutomationExecution",
    validator: validate_GetAutomationExecution_600810, base: "/",
    url: url_GetAutomationExecution_600811, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCalendarState_600824 = ref object of OpenApiRestCall_599368
proc url_GetCalendarState_600826(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCalendarState_600825(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600829 = header.getOrDefault("X-Amz-Target")
  valid_600829 = validateParameter(valid_600829, JString, required = true, default = newJString(
      "AmazonSSM.GetCalendarState"))
  if valid_600829 != nil:
    section.add "X-Amz-Target", valid_600829
...
proc call*(call_600836: Call_GetCalendarState_600824; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the state of the AWS Systems Manager Change Calendar at an optional, specified time. If you specify a time, <code>GetCalendarState</code> returns the state of the calendar at a specific time, and returns the next time that the Change Calendar state will transition. If you do not specify a time, <code>GetCalendarState</code> assumes the current time. Change Calendar entries have two possible states: <code>OPEN</code> or <code>CLOSED</code>. For more information about Systems Manager Change Calendar, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-change-calendar.html">AWS Systems Manager Change Calendar</a> in the <i>AWS Systems Manager User Guide</i>.
  ## 
  let valid = call_600836.validator(path, query, header, formData, body)
  let scheme = call_600836.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_600836.url(scheme.get, call_600836.host, call_600836.base,
                         call_600836.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_600836, url, valid)

proc call*(call_600837: Call_GetCalendarState_600824; body: JsonNode): Recallable =
  ## getCalendarState
  ## Gets the state of the AWS Systems Manager Change Calendar at an optional, specified time. If you specify a time, <code>GetCalendarState</code> returns the state of the calendar at a specific time, and returns the next time that the Change Calendar state will transition. If you do not specify a time, <code>GetCalendarState</code> assumes the current time. Change Calendar entries have two possible states: <code>OPEN</code> or <code>CLOSED</code>. For more information about Systems Manager Change Calendar, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-change-calendar.html">AWS Systems Manager Change Calendar</a> in the <i>AWS Systems Manager User Guide</i>.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_600838 = body
  result = call_600837.call(nil, nil, nil, nil, body_600838)

var getCalendarState* = Call_GetCalendarState_600824(name: "getCalendarState",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetCalendarState",
    validator: validate_GetCalendarState_600825, base: "/",
    url: url_GetCalendarState_600826, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCommandInvocation_600839 = ref object of OpenApiRestCall_599368
proc url_GetCommandInvocation_600841(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCommandInvocation_600840(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600851: Call_GetCommandInvocation_600839; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns detailed information about command execution for an invocation or plugin. 
  ## 
...
proc call*(call_600852: Call_GetCommandInvocation_600839; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_600853 = body
  result = call_600852.call(nil, nil, nil, nil, body_600853)

var getCommandInvocation* = Call_GetCommandInvocation_600839(
    name: "getCommandInvocation", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetCommandInvocation",
    validator: validate_GetCommandInvocation_600840, base: "/",
    url: url_GetCommandInvocation_600841, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetConnectionStatus_600854 = ref object of OpenApiRestCall_599368
proc url_GetConnectionStatus_600856(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetConnectionStatus_600855(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600859 = header.getOrDefault("X-Amz-Target")
  valid_600859 = validateParameter(valid_600859, JString, required = true, default = newJString(
      "AmazonSSM.GetConnectionStatus"))
  if valid_600859 != nil:
    section.add "X-Amz-Target", valid_600859
...
proc call*(call_600866: Call_GetConnectionStatus_600854; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the Session Manager connection status for an instance to determine whether it is connected and ready to receive Session Manager connections.
  ## 
...
proc call*(call_600867: Call_GetConnectionStatus_600854; body: JsonNode): Recallable =
  ## getConnectionStatus
  ## Retrieves the Session Manager connection status for an instance to determine whether it is connected and ready to receive Session Manager connections.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_600868 = body
  result = call_600867.call(nil, nil, nil, nil, body_600868)

var getConnectionStatus* = Call_GetConnectionStatus_600854(
    name: "getConnectionStatus", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetConnectionStatus",
    validator: validate_GetConnectionStatus_600855, base: "/",
    url: url_GetConnectionStatus_600856, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDefaultPatchBaseline_600869 = ref object of OpenApiRestCall_599368
proc url_GetDefaultPatchBaseline_600871(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetDefaultPatchBaseline_600870(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600881: Call_GetDefaultPatchBaseline_600869; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieves the default patch baseline. Note that Systems Manager supports creating multiple default patch baselines. For example, you can create a default patch baseline for each operating system.</p> <p>If you do not specify an operating system value, the default patch baseline for Windows is returned.</p>
  ## 
...
proc call*(call_600882: Call_GetDefaultPatchBaseline_600869; body: JsonNode): Recallable =
...
var getDefaultPatchBaseline* = Call_GetDefaultPatchBaseline_600869(
    name: "getDefaultPatchBaseline", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetDefaultPatchBaseline",
    validator: validate_GetDefaultPatchBaseline_600870, base: "/",
    url: url_GetDefaultPatchBaseline_600871, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDeployablePatchSnapshotForInstance_600884 = ref object of OpenApiRestCall_599368
proc url_GetDeployablePatchSnapshotForInstance_600886(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDeployablePatchSnapshotForInstance_600885(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600896: Call_GetDeployablePatchSnapshotForInstance_600884;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the current snapshot for the patch baseline the instance uses. This API is primarily used by the AWS-RunPatchBaseline Systems Manager document. 
  ## 
...
proc call*(call_600897: Call_GetDeployablePatchSnapshotForInstance_600884;
          body: JsonNode): Recallable =
...
var getDeployablePatchSnapshotForInstance* = Call_GetDeployablePatchSnapshotForInstance_600884(
    ...
    validator: validate_GetDeployablePatchSnapshotForInstance_600885, base: "/",
    url: url_GetDeployablePatchSnapshotForInstance_600886,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDocument_600899 = ref object of OpenApiRestCall_599368
proc url_GetDocument_600901(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDocument_600900(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600911: Call_GetDocument_600899; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the contents of the specified Systems Manager document.
  ## 
...
proc call*(call_600912: Call_GetDocument_600899; body: JsonNode): Recallable =
  ## getDocument
  ## Gets the contents of the specified Systems Manager document.
  ##   body: JObject (required)
...
var getDocument* = Call_GetDocument_600899(name: "getDocument",
                                        meth: HttpMethod.HttpPost,
                                        host: "ssm.amazonaws.com", route: "/#X-Amz-Target=AmazonSSM.GetDocument",
                                        validator: validate_GetDocument_600900,
                                        base: "/", url: url_GetDocument_600901,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInventory_600914 = ref object of OpenApiRestCall_599368
proc url_GetInventory_600916(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetInventory_600915(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_600926: Call_GetInventory_600914; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Query inventory information.
  ## 
...
proc call*(call_600927: Call_GetInventory_600914; body: JsonNode): Recallable =
  ## getInventory
  ## Query inventory information.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_600928 = body
  result = call_600927.call(nil, nil, nil, nil, body_600928)

var getInventory* = Call_GetInventory_600914(name: "getInventory",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetInventory",
    validator: validate_GetInventory_600915, base: "/", url: url_GetInventory_600916,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInventorySchema_600929 = ref object of OpenApiRestCall_599368
proc url_GetInventorySchema_600931(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetInventorySchema_600930(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600934 = header.getOrDefault("X-Amz-Target")
  valid_600934 = validateParameter(valid_600934, JString, required = true, default = newJString(
      "AmazonSSM.GetInventorySchema"))
  if valid_600934 != nil:
    section.add "X-Amz-Target", valid_600934
...
proc call*(call_600941: Call_GetInventorySchema_600929; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Return a list of inventory type names for the account, or return a list of attribute names for a specific Inventory item type. 
  ## 
...
proc call*(call_600942: Call_GetInventorySchema_600929; body: JsonNode): Recallable =
  ## getInventorySchema
  ## Return a list of inventory type names for the account, or return a list of attribute names for a specific Inventory item type. 
  ##   body: JObject (required)
  var body_600943 = newJObject()
  if body != nil:
    body_600943 = body
  result = call_600942.call(nil, nil, nil, nil, body_600943)

var getInventorySchema* = Call_GetInventorySchema_600929(
    name: "getInventorySchema", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetInventorySchema",
    validator: validate_GetInventorySchema_600930, base: "/",
    url: url_GetInventorySchema_600931, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMaintenanceWindow_600944 = ref object of OpenApiRestCall_599368
proc url_GetMaintenanceWindow_600946(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMaintenanceWindow_600945(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600949 = header.getOrDefault("X-Amz-Target")
  valid_600949 = validateParameter(valid_600949, JString, required = true, default = newJString(
      "AmazonSSM.GetMaintenanceWindow"))
  if valid_600949 != nil:
    section.add "X-Amz-Target", valid_600949
...
proc call*(call_600956: Call_GetMaintenanceWindow_600944; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves a maintenance window.
  ## 
...
proc call*(call_600957: Call_GetMaintenanceWindow_600944; body: JsonNode): Recallable =
  ## getMaintenanceWindow
  ## Retrieves a maintenance window.
  ##   body: JObject (required)
  var body_600958 = newJObject()
  if body != nil:
    body_600958 = body
  result = call_600957.call(nil, nil, nil, nil, body_600958)

var getMaintenanceWindow* = Call_GetMaintenanceWindow_600944(
    name: "getMaintenanceWindow", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetMaintenanceWindow",
    validator: validate_GetMaintenanceWindow_600945, base: "/",
    url: url_GetMaintenanceWindow_600946, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMaintenanceWindowExecution_600959 = ref object of OpenApiRestCall_599368
proc url_GetMaintenanceWindowExecution_600961(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMaintenanceWindowExecution_600960(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600964 = header.getOrDefault("X-Amz-Target")
  valid_600964 = validateParameter(valid_600964, JString, required = true, default = newJString(
      "AmazonSSM.GetMaintenanceWindowExecution"))
  if valid_600964 != nil:
    section.add "X-Amz-Target", valid_600964
...
proc call*(call_600971: Call_GetMaintenanceWindowExecution_600959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves details about a specific a maintenance window execution.
  ## 
  let valid = call_600971.validator(path, query, header, formData, body)
  let scheme = call_600971.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_600971.url(scheme.get, call_600971.host, call_600971.base,
                         call_600971.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_600971, url, valid)

proc call*(call_600972: Call_GetMaintenanceWindowExecution_600959; body: JsonNode): Recallable =
...
var getMaintenanceWindowExecution* = Call_GetMaintenanceWindowExecution_600959(
    name: "getMaintenanceWindowExecution", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecution",
    validator: validate_GetMaintenanceWindowExecution_600960, base: "/",
    url: url_GetMaintenanceWindowExecution_600961,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMaintenanceWindowExecutionTask_600974 = ref object of OpenApiRestCall_599368
proc url_GetMaintenanceWindowExecutionTask_600976(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMaintenanceWindowExecutionTask_600975(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600979 = header.getOrDefault("X-Amz-Target")
  valid_600979 = validateParameter(valid_600979, JString, required = true, default = newJString(
      "AmazonSSM.GetMaintenanceWindowExecutionTask"))
  if valid_600979 != nil:
    section.add "X-Amz-Target", valid_600979
...
proc call*(call_600986: Call_GetMaintenanceWindowExecutionTask_600974;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves the details about a specific task run as part of a maintenance window execution.
  ## 
  let valid = call_600986.validator(path, query, header, formData, body)
  let scheme = call_600986.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_600986.url(scheme.get, call_600986.host, call_600986.base,
                         call_600986.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_600986, url, valid)

proc call*(call_600987: Call_GetMaintenanceWindowExecutionTask_600974;
          body: JsonNode): Recallable =
...
var getMaintenanceWindowExecutionTask* = Call_GetMaintenanceWindowExecutionTask_600974(
    ...
    validator: validate_GetMaintenanceWindowExecutionTask_600975, base: "/",
    url: url_GetMaintenanceWindowExecutionTask_600976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMaintenanceWindowExecutionTaskInvocation_600989 = ref object of OpenApiRestCall_599368
proc url_GetMaintenanceWindowExecutionTaskInvocation_600991(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMaintenanceWindowExecutionTaskInvocation_600990(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_600994 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_600994 != nil:
    section.add "X-Amz-Target", valid_600994
  ...
  var valid_600996 = header.getOrDefault("X-Amz-Algorithm")
  valid_600996 = validateParameter(valid_600996, JString, required = false,
                                 default = nil)
  if valid_600996 != nil:
    section.add "X-Amz-Algorithm", valid_600996
  var valid_600997 = header.getOrDefault("X-Amz-Signature")
  valid_600997 = validateParameter(valid_600997, JString, required = false,
                                 default = nil)
  if valid_600997 != nil:
    section.add "X-Amz-Signature", valid_600997
  var valid_600998 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_600998 = validateParameter(valid_600998, JString, required = false,
                                 default = nil)
  if valid_600998 != nil:
    section.add "X-Amz-SignedHeaders", valid_600998
  var valid_600999 = header.getOrDefault("X-Amz-Credential")
  valid_600999 = validateParameter(valid_600999, JString, required = false,
                                 default = nil)
  if valid_600999 != nil:
    section.add "X-Amz-Credential", valid_600999
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_601001: Call_GetMaintenanceWindowExecutionTaskInvocation_600989;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves information about a specific task running on a specific target.
  ## 
...
proc call*(call_601002: Call_GetMaintenanceWindowExecutionTaskInvocation_600989;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_601003 = body
  result = call_601002.call(nil, nil, nil, nil, body_601003)

var getMaintenanceWindowExecutionTaskInvocation* = Call_GetMaintenanceWindowExecutionTaskInvocation_600989(
    ...
    validator: validate_GetMaintenanceWindowExecutionTaskInvocation_600990,
    base: "/", url: url_GetMaintenanceWindowExecutionTaskInvocation_600991,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMaintenanceWindowTask_601004 = ref object of OpenApiRestCall_599368
proc url_GetMaintenanceWindowTask_601006(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetMaintenanceWindowTask_601005(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Lists the tasks in a maintenance window.
  ## 
  var section: JsonNode
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601009 = header.getOrDefault("X-Amz-Target")
  valid_601009 = validateParameter(valid_601009, JString, required = true, default = newJString(
      "AmazonSSM.GetMaintenanceWindowTask"))
  if valid_601009 != nil:
    section.add "X-Amz-Target", valid_601009
...
proc call*(call_601016: Call_GetMaintenanceWindowTask_601004; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the tasks in a maintenance window.
  ## 
...
proc call*(call_601017: Call_GetMaintenanceWindowTask_601004; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_601018 = body
  result = call_601017.call(nil, nil, nil, nil, body_601018)

var getMaintenanceWindowTask* = Call_GetMaintenanceWindowTask_601004(
    name: "getMaintenanceWindowTask", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowTask",
    validator: validate_GetMaintenanceWindowTask_601005, base: "/",
    url: url_GetMaintenanceWindowTask_601006, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpsItem_601019 = ref object of OpenApiRestCall_599368
proc url_GetOpsItem_601021(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetOpsItem_601020(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601031: Call_GetOpsItem_601019; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Get information about an OpsItem by using the ID. You must have permission in AWS Identity and Access Management (IAM) to view information about an OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ## 
...
proc call*(call_601032: Call_GetOpsItem_601019; body: JsonNode): Recallable =
  ## getOpsItem
  ## <p>Get information about an OpsItem by using the ID. You must have permission in AWS Identity and Access Management (IAM) to view information about an OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ##   body: JObject (required)
...
var getOpsItem* = Call_GetOpsItem_601019(name: "getOpsItem",
                                      meth: HttpMethod.HttpPost,
                                      host: "ssm.amazonaws.com", route: "/#X-Amz-Target=AmazonSSM.GetOpsItem",
                                      validator: validate_GetOpsItem_601020,
                                      base: "/", url: url_GetOpsItem_601021,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetOpsSummary_601034 = ref object of OpenApiRestCall_599368
proc url_GetOpsSummary_601036(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetOpsSummary_601035(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601046: Call_GetOpsSummary_601034; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## View a summary of OpsItems based on specified filters and aggregators.
  ## 
...
proc call*(call_601047: Call_GetOpsSummary_601034; body: JsonNode): Recallable =
  ## getOpsSummary
  ## View a summary of OpsItems based on specified filters and aggregators.
  ##   body: JObject (required)
...
var getOpsSummary* = Call_GetOpsSummary_601034(name: "getOpsSummary",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetOpsSummary",
    validator: validate_GetOpsSummary_601035, base: "/", url: url_GetOpsSummary_601036,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetParameter_601049 = ref object of OpenApiRestCall_599368
proc url_GetParameter_601051(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetParameter_601050(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601061: Call_GetParameter_601049; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get information about a parameter by using the parameter name. Don't confuse this API action with the <a>GetParameters</a> API action.
  ## 
...
proc call*(call_601062: Call_GetParameter_601049; body: JsonNode): Recallable =
  ## getParameter
  ## Get information about a parameter by using the parameter name. Don't confuse this API action with the <a>GetParameters</a> API action.
  ##   body: JObject (required)
...
var getParameter* = Call_GetParameter_601049(name: "getParameter",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetParameter",
    validator: validate_GetParameter_601050, base: "/", url: url_GetParameter_601051,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetParameterHistory_601064 = ref object of OpenApiRestCall_599368
proc url_GetParameterHistory_601066(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetParameterHistory_601065(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601078: Call_GetParameterHistory_601064; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Query a list of all parameters used by the AWS account.
  ## 
...
proc call*(call_601079: Call_GetParameterHistory_601064; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## getParameterHistory
  ## Query a list of all parameters used by the AWS account.
  ##   NextToken: string
...
var getParameterHistory* = Call_GetParameterHistory_601064(
    name: "getParameterHistory", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetParameterHistory",
    validator: validate_GetParameterHistory_601065, base: "/",
    url: url_GetParameterHistory_601066, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetParameters_601082 = ref object of OpenApiRestCall_599368
proc url_GetParameters_601084(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetParameters_601083(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601094: Call_GetParameters_601082; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get details of a parameter. Don't confuse this API action with the <a>GetParameter</a> API action.
  ## 
...
proc call*(call_601095: Call_GetParameters_601082; body: JsonNode): Recallable =
  ## getParameters
  ## Get details of a parameter. Don't confuse this API action with the <a>GetParameter</a> API action.
  ##   body: JObject (required)
...
var getParameters* = Call_GetParameters_601082(name: "getParameters",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetParameters",
    validator: validate_GetParameters_601083, base: "/", url: url_GetParameters_601084,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetParametersByPath_601097 = ref object of OpenApiRestCall_599368
proc url_GetParametersByPath_601099(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetParametersByPath_601098(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601111: Call_GetParametersByPath_601097; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Retrieve information about one or more parameters in a specific hierarchy. </p> <note> <p>Request results are returned on a best-effort basis. If you specify <code>MaxResults</code> in the request, the response includes information up to the limit specified. The number of items returned, however, can be between zero and the value of <code>MaxResults</code>. If the service reaches an internal limit while processing the results, it stops the operation and returns the matching values up to that point and a <code>NextToken</code>. You can specify the <code>NextToken</code> in a subsequent call to get the next set of results.</p> </note>
  ## 
...
proc call*(call_601112: Call_GetParametersByPath_601097; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## getParametersByPath
  ## <p>Retrieve information about one or more parameters in a specific hierarchy. </p> <note> <p>Request results are returned on a best-effort basis. If you specify <code>MaxResults</code> in the request, the response includes information up to the limit specified. The number of items returned, however, can be between zero and the value of <code>MaxResults</code>. If the service reaches an internal limit while processing the results, it stops the operation and returns the matching values up to that point and a <code>NextToken</code>. You can specify the <code>NextToken</code> in a subsequent call to get the next set of results.</p> </note>
  ##   NextToken: string
...
var getParametersByPath* = Call_GetParametersByPath_601097(
    name: "getParametersByPath", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetParametersByPath",
    validator: validate_GetParametersByPath_601098, base: "/",
    url: url_GetParametersByPath_601099, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetPatchBaseline_601115 = ref object of OpenApiRestCall_599368
proc url_GetPatchBaseline_601117(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetPatchBaseline_601116(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601127: Call_GetPatchBaseline_601115; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves information about a patch baseline.
  ## 
  ...
  let url = call_601127.url(scheme.get, call_601127.host, call_601127.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601127, url, valid)

proc call*(call_601128: Call_GetPatchBaseline_601115; body: JsonNode): Recallable =
  ## getPatchBaseline
  ## Retrieves information about a patch baseline.
  ##   body: JObject (required)
...
var getPatchBaseline* = Call_GetPatchBaseline_601115(name: "getPatchBaseline",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetPatchBaseline",
    validator: validate_GetPatchBaseline_601116, base: "/",
    url: url_GetPatchBaseline_601117, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetPatchBaselineForPatchGroup_601130 = ref object of OpenApiRestCall_599368
proc url_GetPatchBaselineForPatchGroup_601132(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetPatchBaselineForPatchGroup_601131(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601135 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_601135 != nil:
    section.add "X-Amz-Target", valid_601135
...
proc call*(call_601142: Call_GetPatchBaselineForPatchGroup_601130; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the patch baseline that should be used for the specified patch group.
  ## 
  ...
  let url = call_601142.url(scheme.get, call_601142.host, call_601142.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601142, url, valid)

proc call*(call_601143: Call_GetPatchBaselineForPatchGroup_601130; body: JsonNode): Recallable =
...
var getPatchBaselineForPatchGroup* = Call_GetPatchBaselineForPatchGroup_601130(
    name: "getPatchBaselineForPatchGroup", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetPatchBaselineForPatchGroup",
    validator: validate_GetPatchBaselineForPatchGroup_601131, base: "/",
    url: url_GetPatchBaselineForPatchGroup_601132,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetServiceSetting_601145 = ref object of OpenApiRestCall_599368
proc url_GetServiceSetting_601147(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetServiceSetting_601146(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601150 = header.getOrDefault("X-Amz-Target")
  valid_601150 = validateParameter(valid_601150, JString, required = true, default = newJString(
      "AmazonSSM.GetServiceSetting"))
  if valid_601150 != nil:
    section.add "X-Amz-Target", valid_601150
...
proc call*(call_601157: Call_GetServiceSetting_601145; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting defines how a user interacts with or uses a service or a feature of a service. For example, if an AWS service charges money to the account based on feature or service usage, then the AWS service team might create a default setting of "false". This means the user can't use this feature unless they change the setting to "true" and intentionally opt in for a paid feature.</p> <p>Services map a <code>SettingId</code> object to a setting value. AWS services teams define the default value for a <code>SettingId</code>. You can't create a new <code>SettingId</code>, but you can overwrite the default value if you have the <code>ssm:UpdateServiceSetting</code> permission for the setting. Use the <a>UpdateServiceSetting</a> API action to change the default setting. Or use the <a>ResetServiceSetting</a> to change the value back to the original value defined by the AWS service team.</p> <p>Query the current service setting for the account. </p>
  ## 
  ...
  let url = call_601157.url(scheme.get, call_601157.host, call_601157.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601157, url, valid)

proc call*(call_601158: Call_GetServiceSetting_601145; body: JsonNode): Recallable =
  ## getServiceSetting
  ## <p> <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting defines how a user interacts with or uses a service or a feature of a service. For example, if an AWS service charges money to the account based on feature or service usage, then the AWS service team might create a default setting of "false". This means the user can't use this feature unless they change the setting to "true" and intentionally opt in for a paid feature.</p> <p>Services map a <code>SettingId</code> object to a setting value. AWS services teams define the default value for a <code>SettingId</code>. You can't create a new <code>SettingId</code>, but you can overwrite the default value if you have the <code>ssm:UpdateServiceSetting</code> permission for the setting. Use the <a>UpdateServiceSetting</a> API action to change the default setting. Or use the <a>ResetServiceSetting</a> to change the value back to the original value defined by the AWS service team.</p> <p>Query the current service setting for the account. </p>
  ##   body: JObject (required)
...
var getServiceSetting* = Call_GetServiceSetting_601145(name: "getServiceSetting",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.GetServiceSetting",
    validator: validate_GetServiceSetting_601146, base: "/",
    url: url_GetServiceSetting_601147, schemes: {Scheme.Https, Scheme.Http})
type
  Call_LabelParameterVersion_601160 = ref object of OpenApiRestCall_599368
proc url_LabelParameterVersion_601162(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LabelParameterVersion_601161(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601165 = header.getOrDefault("X-Amz-Target")
  valid_601165 = validateParameter(valid_601165, JString, required = true, default = newJString(
      "AmazonSSM.LabelParameterVersion"))
  if valid_601165 != nil:
    section.add "X-Amz-Target", valid_601165
...
proc call*(call_601172: Call_LabelParameterVersion_601160; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>A parameter label is a user-defined alias to help you manage different versions of a parameter. When you modify a parameter, Systems Manager automatically saves a new version and increments the version number by one. A label can help you remember the purpose of a parameter when there are multiple versions. </p> <p>Parameter labels have the following requirements and restrictions.</p> <ul> <li> <p>A version of a parameter can have a maximum of 10 labels.</p> </li> <li> <p>You can't attach the same label to different versions of the same parameter. For example, if version 1 has the label Production, then you can't attach Production to version 2.</p> </li> <li> <p>You can move a label from one version of a parameter to another.</p> </li> <li> <p>You can't create a label when you create a new parameter. You must attach a label to a specific version of a parameter.</p> </li> <li> <p>You can't delete a parameter label. If you no longer want to use a parameter label, then you must move it to a different version of a parameter.</p> </li> <li> <p>A label can have a maximum of 100 characters.</p> </li> <li> <p>Labels can contain letters (case sensitive), numbers, periods (.), hyphens (-), or underscores (_).</p> </li> <li> <p>Labels can't begin with a number, "aws," or "ssm" (not case sensitive). If a label fails to meet these requirements, then the label is not associated with a parameter and the system displays it in the list of InvalidLabels.</p> </li> </ul>
  ## 
...
proc call*(call_601173: Call_LabelParameterVersion_601160; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_601174 = body
  result = call_601173.call(nil, nil, nil, nil, body_601174)

var labelParameterVersion* = Call_LabelParameterVersion_601160(
    name: "labelParameterVersion", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.LabelParameterVersion",
    validator: validate_LabelParameterVersion_601161, base: "/",
    url: url_LabelParameterVersion_601162, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAssociationVersions_601175 = ref object of OpenApiRestCall_599368
proc url_ListAssociationVersions_601177(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListAssociationVersions_601176(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601180 = header.getOrDefault("X-Amz-Target")
  valid_601180 = validateParameter(valid_601180, JString, required = true, default = newJString(
      "AmazonSSM.ListAssociationVersions"))
  if valid_601180 != nil:
    section.add "X-Amz-Target", valid_601180
...
proc call*(call_601187: Call_ListAssociationVersions_601175; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves all versions of an association for a specific association ID.
  ## 
...
proc call*(call_601188: Call_ListAssociationVersions_601175; body: JsonNode): Recallable =
...
var listAssociationVersions* = Call_ListAssociationVersions_601175(
    name: "listAssociationVersions", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListAssociationVersions",
    validator: validate_ListAssociationVersions_601176, base: "/",
    url: url_ListAssociationVersions_601177, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAssociations_601190 = ref object of OpenApiRestCall_599368
proc url_ListAssociations_601192(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAssociations_601191(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601204: Call_ListAssociations_601190; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the associations for the specified Systems Manager document or instance.
  ## 
...
proc call*(call_601205: Call_ListAssociations_601190; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listAssociations
  ## Lists the associations for the specified Systems Manager document or instance.
  ##   NextToken: string
  ...
  result = call_601205.call(nil, query_601206, nil, nil, body_601207)

var listAssociations* = Call_ListAssociations_601190(name: "listAssociations",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListAssociations",
    validator: validate_ListAssociations_601191, base: "/",
    url: url_ListAssociations_601192, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCommandInvocations_601208 = ref object of OpenApiRestCall_599368
proc url_ListCommandInvocations_601210(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListCommandInvocations_601209(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601222: Call_ListCommandInvocations_601208; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## An invocation is copy of a command sent to a specific instance. A command can apply to one or more instances. A command invocation applies to one instance. For example, if a user runs SendCommand against three instances, then a command invocation is created for each requested instance ID. ListCommandInvocations provide status about command execution.
  ## 
...
proc call*(call_601223: Call_ListCommandInvocations_601208; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listCommandInvocations* = Call_ListCommandInvocations_601208(
    name: "listCommandInvocations", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListCommandInvocations",
    validator: validate_ListCommandInvocations_601209, base: "/",
    url: url_ListCommandInvocations_601210, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCommands_601226 = ref object of OpenApiRestCall_599368
proc url_ListCommands_601228(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListCommands_601227(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601240: Call_ListCommands_601226; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the commands requested by users of the AWS account.
  ## 
...
proc call*(call_601241: Call_ListCommands_601226; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listCommands
  ## Lists the commands requested by users of the AWS account.
  ##   NextToken: string
...
var listCommands* = Call_ListCommands_601226(name: "listCommands",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListCommands",
    validator: validate_ListCommands_601227, base: "/", url: url_ListCommands_601228,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListComplianceItems_601244 = ref object of OpenApiRestCall_599368
proc url_ListComplianceItems_601246(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListComplianceItems_601245(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601256: Call_ListComplianceItems_601244; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## For a specified resource ID, this API action returns a list of compliance statuses for different resource types. Currently, you can only specify one resource ID per call. List results depend on the criteria specified in the filter. 
  ## 
...
proc call*(call_601257: Call_ListComplianceItems_601244; body: JsonNode): Recallable =
  ## listComplianceItems
  ## For a specified resource ID, this API action returns a list of compliance statuses for different resource types. Currently, you can only specify one resource ID per call. List results depend on the criteria specified in the filter. 
  ##   body: JObject (required)
...
var listComplianceItems* = Call_ListComplianceItems_601244(
    name: "listComplianceItems", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListComplianceItems",
    validator: validate_ListComplianceItems_601245, base: "/",
    url: url_ListComplianceItems_601246, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListComplianceSummaries_601259 = ref object of OpenApiRestCall_599368
proc url_ListComplianceSummaries_601261(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListComplianceSummaries_601260(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601271: Call_ListComplianceSummaries_601259; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a summary count of compliant and non-compliant resources for a compliance type. For example, this call can return State Manager associations, patches, or custom compliance types according to the filter criteria that you specify. 
  ## 
...
proc call*(call_601272: Call_ListComplianceSummaries_601259; body: JsonNode): Recallable =
...
var listComplianceSummaries* = Call_ListComplianceSummaries_601259(
    name: "listComplianceSummaries", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListComplianceSummaries",
    validator: validate_ListComplianceSummaries_601260, base: "/",
    url: url_ListComplianceSummaries_601261, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDocumentVersions_601274 = ref object of OpenApiRestCall_599368
proc url_ListDocumentVersions_601276(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDocumentVersions_601275(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601286: Call_ListDocumentVersions_601274; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List all versions for a document.
  ## 
...
proc call*(call_601287: Call_ListDocumentVersions_601274; body: JsonNode): Recallable =
...
var listDocumentVersions* = Call_ListDocumentVersions_601274(
    name: "listDocumentVersions", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListDocumentVersions",
    validator: validate_ListDocumentVersions_601275, base: "/",
    url: url_ListDocumentVersions_601276, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDocuments_601289 = ref object of OpenApiRestCall_599368
proc url_ListDocuments_601291(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDocuments_601290(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601303: Call_ListDocuments_601289; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes one or more of your Systems Manager documents.
  ## 
...
proc call*(call_601304: Call_ListDocuments_601289; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listDocuments
  ## Describes one or more of your Systems Manager documents.
  ##   NextToken: string
...
var listDocuments* = Call_ListDocuments_601289(name: "listDocuments",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListDocuments",
    validator: validate_ListDocuments_601290, base: "/", url: url_ListDocuments_601291,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListInventoryEntries_601307 = ref object of OpenApiRestCall_599368
proc url_ListInventoryEntries_601309(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListInventoryEntries_601308(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601319: Call_ListInventoryEntries_601307; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A list of inventory items returned by the request.
  ## 
...
proc call*(call_601320: Call_ListInventoryEntries_601307; body: JsonNode): Recallable =
...
var listInventoryEntries* = Call_ListInventoryEntries_601307(
    name: "listInventoryEntries", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListInventoryEntries",
    validator: validate_ListInventoryEntries_601308, base: "/",
    url: url_ListInventoryEntries_601309, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResourceComplianceSummaries_601322 = ref object of OpenApiRestCall_599368
proc url_ListResourceComplianceSummaries_601324(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResourceComplianceSummaries_601323(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601334: Call_ListResourceComplianceSummaries_601322;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns a resource-level summary count. The summary includes information about compliant and non-compliant statuses and detailed compliance-item severity counts, according to the filter criteria you specify.
  ## 
...
proc call*(call_601335: Call_ListResourceComplianceSummaries_601322; body: JsonNode): Recallable =
...
var listResourceComplianceSummaries* = Call_ListResourceComplianceSummaries_601322(
    ...
    validator: validate_ListResourceComplianceSummaries_601323, base: "/",
    url: url_ListResourceComplianceSummaries_601324,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResourceDataSync_601337 = ref object of OpenApiRestCall_599368
proc url_ListResourceDataSync_601339(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResourceDataSync_601338(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601349: Call_ListResourceDataSync_601337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists your resource data sync configurations. Includes information about the last time a sync attempted to start, the last sync status, and the last time a sync successfully completed.</p> <p>The number of sync configurations might be too large to return using a single call to <code>ListResourceDataSync</code>. You can limit the number of sync configurations returned by using the <code>MaxResults</code> parameter. To determine whether there are more sync configurations to list, check the value of <code>NextToken</code> in the output. If there are more sync configurations to list, you can request them by specifying the <code>NextToken</code> returned in the call to the parameter of a subsequent call. </p>
  ## 
...
proc call*(call_601350: Call_ListResourceDataSync_601337; body: JsonNode): Recallable =
...
var listResourceDataSync* = Call_ListResourceDataSync_601337(
    name: "listResourceDataSync", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListResourceDataSync",
    validator: validate_ListResourceDataSync_601338, base: "/",
    url: url_ListResourceDataSync_601339, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_601352 = ref object of OpenApiRestCall_599368
proc url_ListTagsForResource_601354(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_601353(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601364: Call_ListTagsForResource_601352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of the tags assigned to the specified resource.
  ## 
...
proc call*(call_601365: Call_ListTagsForResource_601352; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Returns a list of the tags assigned to the specified resource.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_601352(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ListTagsForResource",
    validator: validate_ListTagsForResource_601353, base: "/",
    url: url_ListTagsForResource_601354, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyDocumentPermission_601367 = ref object of OpenApiRestCall_599368
proc url_ModifyDocumentPermission_601369(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ModifyDocumentPermission_601368(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601379: Call_ModifyDocumentPermission_601367; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Shares a Systems Manager document publicly or privately. If you share a document privately, you must specify the AWS user account IDs for those people who can use the document. If you share a document publicly, you must specify <i>All</i> as the account ID.
  ## 
...
proc call*(call_601380: Call_ModifyDocumentPermission_601367; body: JsonNode): Recallable =
...
var modifyDocumentPermission* = Call_ModifyDocumentPermission_601367(
    name: "modifyDocumentPermission", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ModifyDocumentPermission",
    validator: validate_ModifyDocumentPermission_601368, base: "/",
    url: url_ModifyDocumentPermission_601369, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutComplianceItems_601382 = ref object of OpenApiRestCall_599368
proc url_PutComplianceItems_601384(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutComplianceItems_601383(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601394: Call_PutComplianceItems_601382; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Registers a compliance type and other compliance details on a designated resource. This action lets you register custom compliance details with a resource. This call overwrites existing compliance information on the resource, so you must provide a full list of compliance items each time that you send the request.</p> <p>ComplianceType can be one of the following:</p> <ul> <li> <p>ExecutionId: The execution ID when the patch, association, or custom compliance item was applied.</p> </li> <li> <p>ExecutionType: Specify patch, association, or Custom:<code>string</code>.</p> </li> <li> <p>ExecutionTime. The time the patch, association, or custom compliance item was applied to the instance.</p> </li> <li> <p>Id: The patch, association, or custom compliance ID.</p> </li> <li> <p>Title: A title.</p> </li> <li> <p>Status: The status of the compliance item. For example, <code>approved</code> for patches, or <code>Failed</code> for associations.</p> </li> <li> <p>Severity: A patch severity. For example, <code>critical</code>.</p> </li> <li> <p>DocumentName: A SSM document name. For example, AWS-RunPatchBaseline.</p> </li> <li> <p>DocumentVersion: An SSM document version number. For example, 4.</p> </li> <li> <p>Classification: A patch classification. For example, <code>security updates</code>.</p> </li> <li> <p>PatchBaselineId: A patch baseline ID.</p> </li> <li> <p>PatchSeverity: A patch severity. For example, <code>Critical</code>.</p> </li> <li> <p>PatchState: A patch state. For example, <code>InstancesWithFailedPatches</code>.</p> </li> <li> <p>PatchGroup: The name of a patch group.</p> </li> <li> <p>InstalledTime: The time the association, patch, or custom compliance item was applied to the resource. Specify the time by using the following format: yyyy-MM-dd'T'HH:mm:ss'Z'</p> </li> </ul>
  ## 
...
proc call*(call_601395: Call_PutComplianceItems_601382; body: JsonNode): Recallable =
  ## putComplianceItems
  ## <p>Registers a compliance type and other compliance details on a designated resource. This action lets you register custom compliance details with a resource. This call overwrites existing compliance information on the resource, so you must provide a full list of compliance items each time that you send the request.</p> <p>ComplianceType can be one of the following:</p> <ul> <li> <p>ExecutionId: The execution ID when the patch, association, or custom compliance item was applied.</p> </li> <li> <p>ExecutionType: Specify patch, association, or Custom:<code>string</code>.</p> </li> <li> <p>ExecutionTime. The time the patch, association, or custom compliance item was applied to the instance.</p> </li> <li> <p>Id: The patch, association, or custom compliance ID.</p> </li> <li> <p>Title: A title.</p> </li> <li> <p>Status: The status of the compliance item. For example, <code>approved</code> for patches, or <code>Failed</code> for associations.</p> </li> <li> <p>Severity: A patch severity. For example, <code>critical</code>.</p> </li> <li> <p>DocumentName: A SSM document name. For example, AWS-RunPatchBaseline.</p> </li> <li> <p>DocumentVersion: An SSM document version number. For example, 4.</p> </li> <li> <p>Classification: A patch classification. For example, <code>security updates</code>.</p> </li> <li> <p>PatchBaselineId: A patch baseline ID.</p> </li> <li> <p>PatchSeverity: A patch severity. For example, <code>Critical</code>.</p> </li> <li> <p>PatchState: A patch state. For example, <code>InstancesWithFailedPatches</code>.</p> </li> <li> <p>PatchGroup: The name of a patch group.</p> </li> <li> <p>InstalledTime: The time the association, patch, or custom compliance item was applied to the resource. Specify the time by using the following format: yyyy-MM-dd'T'HH:mm:ss'Z'</p> </li> </ul>
  ##   body: JObject (required)
...
var putComplianceItems* = Call_PutComplianceItems_601382(
    name: "putComplianceItems", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.PutComplianceItems",
    validator: validate_PutComplianceItems_601383, base: "/",
    url: url_PutComplianceItems_601384, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutInventory_601397 = ref object of OpenApiRestCall_599368
proc url_PutInventory_601399(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutInventory_601398(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601409: Call_PutInventory_601397; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Bulk update custom inventory items on one more instance. The request adds an inventory item, if it doesn't already exist, or updates an inventory item, if it does exist.
  ## 
...
proc call*(call_601410: Call_PutInventory_601397; body: JsonNode): Recallable =
  ## putInventory
  ## Bulk update custom inventory items on one more instance. The request adds an inventory item, if it doesn't already exist, or updates an inventory item, if it does exist.
  ##   body: JObject (required)
...
var putInventory* = Call_PutInventory_601397(name: "putInventory",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.PutInventory",
    validator: validate_PutInventory_601398, base: "/", url: url_PutInventory_601399,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutParameter_601412 = ref object of OpenApiRestCall_599368
proc url_PutParameter_601414(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutParameter_601413(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601424: Call_PutParameter_601412; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Add a parameter to the system.
  ## 
...
proc call*(call_601425: Call_PutParameter_601412; body: JsonNode): Recallable =
  ## putParameter
  ## Add a parameter to the system.
  ##   body: JObject (required)
...
var putParameter* = Call_PutParameter_601412(name: "putParameter",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.PutParameter",
    validator: validate_PutParameter_601413, base: "/", url: url_PutParameter_601414,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterDefaultPatchBaseline_601427 = ref object of OpenApiRestCall_599368
proc url_RegisterDefaultPatchBaseline_601429(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterDefaultPatchBaseline_601428(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601439: Call_RegisterDefaultPatchBaseline_601427; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Defines the default patch baseline for the relevant operating system.</p> <p>To reset the AWS predefined patch baseline as the default, specify the full patch baseline ARN as the baseline ID value. For example, for CentOS, specify <code>arn:aws:ssm:us-east-2:733109147000:patchbaseline/pb-0574b43a65ea646ed</code> instead of <code>pb-0574b43a65ea646ed</code>.</p>
  ## 
...
proc call*(call_601440: Call_RegisterDefaultPatchBaseline_601427; body: JsonNode): Recallable =
...
var registerDefaultPatchBaseline* = Call_RegisterDefaultPatchBaseline_601427(
    name: "registerDefaultPatchBaseline", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.RegisterDefaultPatchBaseline",
    validator: validate_RegisterDefaultPatchBaseline_601428, base: "/",
    url: url_RegisterDefaultPatchBaseline_601429,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterPatchBaselineForPatchGroup_601442 = ref object of OpenApiRestCall_599368
proc url_RegisterPatchBaselineForPatchGroup_601444(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterPatchBaselineForPatchGroup_601443(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601454: Call_RegisterPatchBaselineForPatchGroup_601442;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Registers a patch baseline for a patch group.
  ## 
...
proc call*(call_601455: Call_RegisterPatchBaselineForPatchGroup_601442;
          body: JsonNode): Recallable =
...
var registerPatchBaselineForPatchGroup* = Call_RegisterPatchBaselineForPatchGroup_601442(
    ...
    validator: validate_RegisterPatchBaselineForPatchGroup_601443, base: "/",
    url: url_RegisterPatchBaselineForPatchGroup_601444,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterTargetWithMaintenanceWindow_601457 = ref object of OpenApiRestCall_599368
proc url_RegisterTargetWithMaintenanceWindow_601459(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterTargetWithMaintenanceWindow_601458(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601469: Call_RegisterTargetWithMaintenanceWindow_601457;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Registers a target with a maintenance window.
  ## 
...
proc call*(call_601470: Call_RegisterTargetWithMaintenanceWindow_601457;
          body: JsonNode): Recallable =
...
var registerTargetWithMaintenanceWindow* = Call_RegisterTargetWithMaintenanceWindow_601457(
    ...
    validator: validate_RegisterTargetWithMaintenanceWindow_601458, base: "/",
    url: url_RegisterTargetWithMaintenanceWindow_601459,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterTaskWithMaintenanceWindow_601472 = ref object of OpenApiRestCall_599368
proc url_RegisterTaskWithMaintenanceWindow_601474(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterTaskWithMaintenanceWindow_601473(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601484: Call_RegisterTaskWithMaintenanceWindow_601472;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Adds a new task to a maintenance window.
  ## 
...
proc call*(call_601485: Call_RegisterTaskWithMaintenanceWindow_601472;
          body: JsonNode): Recallable =
...
var registerTaskWithMaintenanceWindow* = Call_RegisterTaskWithMaintenanceWindow_601472(
    ...
    validator: validate_RegisterTaskWithMaintenanceWindow_601473, base: "/",
    url: url_RegisterTaskWithMaintenanceWindow_601474,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveTagsFromResource_601487 = ref object of OpenApiRestCall_599368
proc url_RemoveTagsFromResource_601489(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveTagsFromResource_601488(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601499: Call_RemoveTagsFromResource_601487; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes tag keys from the specified resource.
  ## 
  ...
  let url = call_601499.url(scheme.get, call_601499.host, call_601499.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601499, url, valid)

proc call*(call_601500: Call_RemoveTagsFromResource_601487; body: JsonNode): Recallable =
...
var removeTagsFromResource* = Call_RemoveTagsFromResource_601487(
    name: "removeTagsFromResource", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.RemoveTagsFromResource",
    validator: validate_RemoveTagsFromResource_601488, base: "/",
    url: url_RemoveTagsFromResource_601489, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ResetServiceSetting_601502 = ref object of OpenApiRestCall_599368
proc url_ResetServiceSetting_601504(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResetServiceSetting_601503(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601514: Call_ResetServiceSetting_601502; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting defines how a user interacts with or uses a service or a feature of a service. For example, if an AWS service charges money to the account based on feature or service usage, then the AWS service team might create a default setting of "false". This means the user can't use this feature unless they change the setting to "true" and intentionally opt in for a paid feature.</p> <p>Services map a <code>SettingId</code> object to a setting value. AWS services teams define the default value for a <code>SettingId</code>. You can't create a new <code>SettingId</code>, but you can overwrite the default value if you have the <code>ssm:UpdateServiceSetting</code> permission for the setting. Use the <a>GetServiceSetting</a> API action to view the current value. Use the <a>UpdateServiceSetting</a> API action to change the default setting. </p> <p>Reset the service setting for the account to the default value as provisioned by the AWS service team. </p>
  ## 
  ...
  let url = call_601514.url(scheme.get, call_601514.host, call_601514.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601514, url, valid)

proc call*(call_601515: Call_ResetServiceSetting_601502; body: JsonNode): Recallable =
  ## resetServiceSetting
  ## <p> <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting defines how a user interacts with or uses a service or a feature of a service. For example, if an AWS service charges money to the account based on feature or service usage, then the AWS service team might create a default setting of "false". This means the user can't use this feature unless they change the setting to "true" and intentionally opt in for a paid feature.</p> <p>Services map a <code>SettingId</code> object to a setting value. AWS services teams define the default value for a <code>SettingId</code>. You can't create a new <code>SettingId</code>, but you can overwrite the default value if you have the <code>ssm:UpdateServiceSetting</code> permission for the setting. Use the <a>GetServiceSetting</a> API action to view the current value. Use the <a>UpdateServiceSetting</a> API action to change the default setting. </p> <p>Reset the service setting for the account to the default value as provisioned by the AWS service team. </p>
  ##   body: JObject (required)
...
var resetServiceSetting* = Call_ResetServiceSetting_601502(
    name: "resetServiceSetting", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ResetServiceSetting",
    validator: validate_ResetServiceSetting_601503, base: "/",
    url: url_ResetServiceSetting_601504, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ResumeSession_601517 = ref object of OpenApiRestCall_599368
proc url_ResumeSession_601519(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResumeSession_601518(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601529: Call_ResumeSession_601517; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Reconnects a session to an instance after it has been disconnected. Connections can be resumed for disconnected sessions, but not terminated sessions.</p> <note> <p>This command is primarily for use by client machines to automatically reconnect during intermittent network issues. It is not intended for any other use.</p> </note>
  ## 
  ...
  let url = call_601529.url(scheme.get, call_601529.host, call_601529.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601529, url, valid)

proc call*(call_601530: Call_ResumeSession_601517; body: JsonNode): Recallable =
  ## resumeSession
  ## <p>Reconnects a session to an instance after it has been disconnected. Connections can be resumed for disconnected sessions, but not terminated sessions.</p> <note> <p>This command is primarily for use by client machines to automatically reconnect during intermittent network issues. It is not intended for any other use.</p> </note>
  ##   body: JObject (required)
...
var resumeSession* = Call_ResumeSession_601517(name: "resumeSession",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.ResumeSession",
    validator: validate_ResumeSession_601518, base: "/", url: url_ResumeSession_601519,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendAutomationSignal_601532 = ref object of OpenApiRestCall_599368
proc url_SendAutomationSignal_601534(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendAutomationSignal_601533(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601544: Call_SendAutomationSignal_601532; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sends a signal to an Automation execution to change the current behavior or status of the execution. 
  ## 
...
proc call*(call_601545: Call_SendAutomationSignal_601532; body: JsonNode): Recallable =
...
var sendAutomationSignal* = Call_SendAutomationSignal_601532(
    name: "sendAutomationSignal", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.SendAutomationSignal",
    validator: validate_SendAutomationSignal_601533, base: "/",
    url: url_SendAutomationSignal_601534, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SendCommand_601547 = ref object of OpenApiRestCall_599368
proc url_SendCommand_601549(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SendCommand_601548(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601559: Call_SendCommand_601547; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Runs commands on one or more managed instances.
  ## 
...
proc call*(call_601560: Call_SendCommand_601547; body: JsonNode): Recallable =
  ## sendCommand
  ## Runs commands on one or more managed instances.
  ##   body: JObject (required)
...
var sendCommand* = Call_SendCommand_601547(name: "sendCommand",
                                        meth: HttpMethod.HttpPost,
                                        host: "ssm.amazonaws.com", route: "/#X-Amz-Target=AmazonSSM.SendCommand",
                                        validator: validate_SendCommand_601548,
                                        base: "/", url: url_SendCommand_601549,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartAssociationsOnce_601562 = ref object of OpenApiRestCall_599368
proc url_StartAssociationsOnce_601564(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartAssociationsOnce_601563(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601574: Call_StartAssociationsOnce_601562; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Use this API action to run an association immediately and only one time. This action can be helpful when troubleshooting associations.
  ## 
...
proc call*(call_601575: Call_StartAssociationsOnce_601562; body: JsonNode): Recallable =
...
var startAssociationsOnce* = Call_StartAssociationsOnce_601562(
    name: "startAssociationsOnce", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.StartAssociationsOnce",
    validator: validate_StartAssociationsOnce_601563, base: "/",
    url: url_StartAssociationsOnce_601564, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartAutomationExecution_601577 = ref object of OpenApiRestCall_599368
proc url_StartAutomationExecution_601579(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StartAutomationExecution_601578(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601589: Call_StartAutomationExecution_601577; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Initiates execution of an Automation document.
  ## 
  ...
  let url = call_601589.url(scheme.get, call_601589.host, call_601589.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601589, url, valid)

proc call*(call_601590: Call_StartAutomationExecution_601577; body: JsonNode): Recallable =
...
var startAutomationExecution* = Call_StartAutomationExecution_601577(
    name: "startAutomationExecution", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.StartAutomationExecution",
    validator: validate_StartAutomationExecution_601578, base: "/",
    url: url_StartAutomationExecution_601579, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSession_601592 = ref object of OpenApiRestCall_599368
proc url_StartSession_601594(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartSession_601593(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601604: Call_StartSession_601592; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Initiates a connection to a target (for example, an instance) for a Session Manager session. Returns a URL and token that can be used to open a WebSocket connection for sending input and receiving outputs.</p> <note> <p>AWS CLI usage: <code>start-session</code> is an interactive command that requires the Session Manager plugin to be installed on the client machine making the call. For information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager-working-with-install-plugin.html"> Install the Session Manager Plugin for the AWS CLI</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>AWS Tools for PowerShell usage: Start-SSMSession is not currently supported by AWS Tools for PowerShell on Windows local machines.</p> </note>
  ## 
...
proc call*(call_601605: Call_StartSession_601592; body: JsonNode): Recallable =
  ## startSession
  ## <p>Initiates a connection to a target (for example, an instance) for a Session Manager session. Returns a URL and token that can be used to open a WebSocket connection for sending input and receiving outputs.</p> <note> <p>AWS CLI usage: <code>start-session</code> is an interactive command that requires the Session Manager plugin to be installed on the client machine making the call. For information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager-working-with-install-plugin.html"> Install the Session Manager Plugin for the AWS CLI</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>AWS Tools for PowerShell usage: Start-SSMSession is not currently supported by AWS Tools for PowerShell on Windows local machines.</p> </note>
  ##   body: JObject (required)
...
var startSession* = Call_StartSession_601592(name: "startSession",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.StartSession",
    validator: validate_StartSession_601593, base: "/", url: url_StartSession_601594,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopAutomationExecution_601607 = ref object of OpenApiRestCall_599368
proc url_StopAutomationExecution_601609(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StopAutomationExecution_601608(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601619: Call_StopAutomationExecution_601607; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stop an Automation that is currently running.
  ## 
...
proc call*(call_601620: Call_StopAutomationExecution_601607; body: JsonNode): Recallable =
...
var stopAutomationExecution* = Call_StopAutomationExecution_601607(
    name: "stopAutomationExecution", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.StopAutomationExecution",
    validator: validate_StopAutomationExecution_601608, base: "/",
    url: url_StopAutomationExecution_601609, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TerminateSession_601622 = ref object of OpenApiRestCall_599368
proc url_TerminateSession_601624(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TerminateSession_601623(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601634: Call_TerminateSession_601622; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Permanently ends a session and closes the data connection between the Session Manager client and SSM Agent on the instance. A terminated session cannot be resumed.
  ## 
...
proc call*(call_601635: Call_TerminateSession_601622; body: JsonNode): Recallable =
  ## terminateSession
  ## Permanently ends a session and closes the data connection between the Session Manager client and SSM Agent on the instance. A terminated session cannot be resumed.
  ##   body: JObject (required)
...
var terminateSession* = Call_TerminateSession_601622(name: "terminateSession",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.TerminateSession",
    validator: validate_TerminateSession_601623, base: "/",
    url: url_TerminateSession_601624, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAssociation_601637 = ref object of OpenApiRestCall_599368
proc url_UpdateAssociation_601639(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateAssociation_601638(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601649: Call_UpdateAssociation_601637; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates an association. You can update the association name and version, the document version, schedule, parameters, and Amazon S3 output. </p> <p>In order to call this API action, your IAM user account, group, or role must be configured with permission to call the <a>DescribeAssociation</a> API action. If you don't have permission to call DescribeAssociation, then you receive the following error: <code>An error occurred (AccessDeniedException) when calling the UpdateAssociation operation: User: &lt;user_arn&gt; is not authorized to perform: ssm:DescribeAssociation on resource: &lt;resource_arn&gt;</code> </p> <important> <p>When you update an association, the association immediately runs against the specified targets.</p> </important>
  ## 
...
proc call*(call_601650: Call_UpdateAssociation_601637; body: JsonNode): Recallable =
  ## updateAssociation
  ## <p>Updates an association. You can update the association name and version, the document version, schedule, parameters, and Amazon S3 output. </p> <p>In order to call this API action, your IAM user account, group, or role must be configured with permission to call the <a>DescribeAssociation</a> API action. If you don't have permission to call DescribeAssociation, then you receive the following error: <code>An error occurred (AccessDeniedException) when calling the UpdateAssociation operation: User: &lt;user_arn&gt; is not authorized to perform: ssm:DescribeAssociation on resource: &lt;resource_arn&gt;</code> </p> <important> <p>When you update an association, the association immediately runs against the specified targets.</p> </important>
  ##   body: JObject (required)
...
var updateAssociation* = Call_UpdateAssociation_601637(name: "updateAssociation",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateAssociation",
    validator: validate_UpdateAssociation_601638, base: "/",
    url: url_UpdateAssociation_601639, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateAssociationStatus_601652 = ref object of OpenApiRestCall_599368
proc url_UpdateAssociationStatus_601654(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateAssociationStatus_601653(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601664: Call_UpdateAssociationStatus_601652; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the status of the Systems Manager document associated with the specified instance.
  ## 
...
proc call*(call_601665: Call_UpdateAssociationStatus_601652; body: JsonNode): Recallable =
...
var updateAssociationStatus* = Call_UpdateAssociationStatus_601652(
    name: "updateAssociationStatus", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateAssociationStatus",
    validator: validate_UpdateAssociationStatus_601653, base: "/",
    url: url_UpdateAssociationStatus_601654, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDocument_601667 = ref object of OpenApiRestCall_599368
proc url_UpdateDocument_601669(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDocument_601668(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601679: Call_UpdateDocument_601667; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates one or more values for an SSM document.
  ## 
...
proc call*(call_601680: Call_UpdateDocument_601667; body: JsonNode): Recallable =
  ## updateDocument
  ## Updates one or more values for an SSM document.
  ##   body: JObject (required)
...
var updateDocument* = Call_UpdateDocument_601667(name: "updateDocument",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateDocument",
    validator: validate_UpdateDocument_601668, base: "/", url: url_UpdateDocument_601669,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDocumentDefaultVersion_601682 = ref object of OpenApiRestCall_599368
proc url_UpdateDocumentDefaultVersion_601684(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDocumentDefaultVersion_601683(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601694: Call_UpdateDocumentDefaultVersion_601682; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Set the default version of a document. 
  ## 
...
proc call*(call_601695: Call_UpdateDocumentDefaultVersion_601682; body: JsonNode): Recallable =
...
var updateDocumentDefaultVersion* = Call_UpdateDocumentDefaultVersion_601682(
    name: "updateDocumentDefaultVersion", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateDocumentDefaultVersion",
    validator: validate_UpdateDocumentDefaultVersion_601683, base: "/",
    url: url_UpdateDocumentDefaultVersion_601684,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateMaintenanceWindow_601697 = ref object of OpenApiRestCall_599368
proc url_UpdateMaintenanceWindow_601699(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateMaintenanceWindow_601698(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601709: Call_UpdateMaintenanceWindow_601697; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates an existing maintenance window. Only specified parameters are modified.</p> <note> <p>The value you specify for <code>Duration</code> determines the specific end time for the maintenance window based on the time it begins. No maintenance window tasks are permitted to start after the resulting endtime minus the number of hours you specify for <code>Cutoff</code>. For example, if the maintenance window starts at 3 PM, the duration is three hours, and the value you specify for <code>Cutoff</code> is one hour, no maintenance window tasks can start after 5 PM.</p> </note>
  ## 
...
proc call*(call_601710: Call_UpdateMaintenanceWindow_601697; body: JsonNode): Recallable =
...
var updateMaintenanceWindow* = Call_UpdateMaintenanceWindow_601697(
    name: "updateMaintenanceWindow", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindow",
    validator: validate_UpdateMaintenanceWindow_601698, base: "/",
    url: url_UpdateMaintenanceWindow_601699, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateMaintenanceWindowTarget_601712 = ref object of OpenApiRestCall_599368
proc url_UpdateMaintenanceWindowTarget_601714(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateMaintenanceWindowTarget_601713(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601724: Call_UpdateMaintenanceWindowTarget_601712; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modifies the target of an existing maintenance window. You can change the following:</p> <ul> <li> <p>Name</p> </li> <li> <p>Description</p> </li> <li> <p>Owner</p> </li> <li> <p>IDs for an ID target</p> </li> <li> <p>Tags for a Tag target</p> </li> <li> <p>From any supported tag type to another. The three supported tag types are ID target, Tag target, and resource group. For more information, see <a>Target</a>.</p> </li> </ul> <note> <p>If a parameter is null, then the corresponding field is not modified.</p> </note>
  ## 
  ...
  let url = call_601724.url(scheme.get, call_601724.host, call_601724.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601724, url, valid)

proc call*(call_601725: Call_UpdateMaintenanceWindowTarget_601712; body: JsonNode): Recallable =
...
var updateMaintenanceWindowTarget* = Call_UpdateMaintenanceWindowTarget_601712(
    name: "updateMaintenanceWindowTarget", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTarget",
    validator: validate_UpdateMaintenanceWindowTarget_601713, base: "/",
    url: url_UpdateMaintenanceWindowTarget_601714,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateMaintenanceWindowTask_601727 = ref object of OpenApiRestCall_599368
proc url_UpdateMaintenanceWindowTask_601729(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateMaintenanceWindowTask_601728(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601739: Call_UpdateMaintenanceWindowTask_601727; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modifies a task assigned to a maintenance window. You can't change the task type, but you can change the following values:</p> <ul> <li> <p>TaskARN. For example, you can change a RUN_COMMAND task from AWS-RunPowerShellScript to AWS-RunShellScript.</p> </li> <li> <p>ServiceRoleArn</p> </li> <li> <p>TaskInvocationParameters</p> </li> <li> <p>Priority</p> </li> <li> <p>MaxConcurrency</p> </li> <li> <p>MaxErrors</p> </li> </ul> <p>If a parameter is null, then the corresponding field is not modified. Also, if you set Replace to true, then all fields required by the <a>RegisterTaskWithMaintenanceWindow</a> action are required for this request. Optional fields that aren't specified are set to null.</p>
  ## 
  ...
  let url = call_601739.url(scheme.get, call_601739.host, call_601739.base,
                         ...
                         valid.getOrDefault("query"))
  result = atozHook(call_601739, url, valid)

proc call*(call_601740: Call_UpdateMaintenanceWindowTask_601727; body: JsonNode): Recallable =
...
var updateMaintenanceWindowTask* = Call_UpdateMaintenanceWindowTask_601727(
    name: "updateMaintenanceWindowTask", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTask",
    validator: validate_UpdateMaintenanceWindowTask_601728, base: "/",
    url: url_UpdateMaintenanceWindowTask_601729,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateManagedInstanceRole_601742 = ref object of OpenApiRestCall_599368
proc url_UpdateManagedInstanceRole_601744(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateManagedInstanceRole_601743(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601754: Call_UpdateManagedInstanceRole_601742; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Assigns or changes an Amazon Identity and Access Management (IAM) role for the managed instance.
  ## 
...
proc call*(call_601755: Call_UpdateManagedInstanceRole_601742; body: JsonNode): Recallable =
...
var updateManagedInstanceRole* = Call_UpdateManagedInstanceRole_601742(
    name: "updateManagedInstanceRole", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateManagedInstanceRole",
    validator: validate_UpdateManagedInstanceRole_601743, base: "/",
    url: url_UpdateManagedInstanceRole_601744,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateOpsItem_601757 = ref object of OpenApiRestCall_599368
proc url_UpdateOpsItem_601759(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateOpsItem_601758(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601769: Call_UpdateOpsItem_601757; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Edit or change an OpsItem. You must have permission in AWS Identity and Access Management (IAM) to update an OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ## 
...
proc call*(call_601770: Call_UpdateOpsItem_601757; body: JsonNode): Recallable =
  ## updateOpsItem
  ## <p>Edit or change an OpsItem. You must have permission in AWS Identity and Access Management (IAM) to update an OpsItem. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html">Getting Started with OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>.</p> <p>Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see <a href="http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the <i>AWS Systems Manager User Guide</i>. </p>
  ##   body: JObject (required)
...
var updateOpsItem* = Call_UpdateOpsItem_601757(name: "updateOpsItem",
    meth: HttpMethod.HttpPost, host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateOpsItem",
    validator: validate_UpdateOpsItem_601758, base: "/", url: url_UpdateOpsItem_601759,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdatePatchBaseline_601772 = ref object of OpenApiRestCall_599368
proc url_UpdatePatchBaseline_601774(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdatePatchBaseline_601773(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601784: Call_UpdatePatchBaseline_601772; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modifies an existing patch baseline. Fields not specified in the request are left unchanged.</p> <note> <p>For information about valid key and value pairs in <code>PatchFilters</code> for each supported operating system type, see <a href="http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html">PatchFilter</a>.</p> </note>
  ## 
...
proc call*(call_601785: Call_UpdatePatchBaseline_601772; body: JsonNode): Recallable =
  ## updatePatchBaseline
  ## <p>Modifies an existing patch baseline. Fields not specified in the request are left unchanged.</p> <note> <p>For information about valid key and value pairs in <code>PatchFilters</code> for each supported operating system type, see <a href="http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html">PatchFilter</a>.</p> </note>
  ##   body: JObject (required)
...
var updatePatchBaseline* = Call_UpdatePatchBaseline_601772(
    name: "updatePatchBaseline", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdatePatchBaseline",
    validator: validate_UpdatePatchBaseline_601773, base: "/",
    url: url_UpdatePatchBaseline_601774, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResourceDataSync_601787 = ref object of OpenApiRestCall_599368
proc url_UpdateResourceDataSync_601789(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateResourceDataSync_601788(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601799: Call_UpdateResourceDataSync_601787; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a resource data sync. After you create a resource data sync for a Region, you can't change the account options for that sync. For example, if you create a sync in the us-east-2 (Ohio) Region and you choose the Include only the current account option, you can't edit that sync later and choose the Include all accounts from my AWS Organizations configuration option. Instead, you must delete the first resource data sync, and create a new one.
  ## 
...
proc call*(call_601800: Call_UpdateResourceDataSync_601787; body: JsonNode): Recallable =
...
var updateResourceDataSync* = Call_UpdateResourceDataSync_601787(
    name: "updateResourceDataSync", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateResourceDataSync",
    validator: validate_UpdateResourceDataSync_601788, base: "/",
    url: url_UpdateResourceDataSync_601789, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateServiceSetting_601802 = ref object of OpenApiRestCall_599368
proc url_UpdateServiceSetting_601804(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateServiceSetting_601803(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601814: Call_UpdateServiceSetting_601802; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting defines how a user interacts with or uses a service or a feature of a service. For example, if an AWS service charges money to the account based on feature or service usage, then the AWS service team might create a default setting of "false". This means the user can't use this feature unless they change the setting to "true" and intentionally opt in for a paid feature.</p> <p>Services map a <code>SettingId</code> object to a setting value. AWS services teams define the default value for a <code>SettingId</code>. You can't create a new <code>SettingId</code>, but you can overwrite the default value if you have the <code>ssm:UpdateServiceSetting</code> permission for the setting. Use the <a>GetServiceSetting</a> API action to view the current value. Or, use the <a>ResetServiceSetting</a> to change the value back to the original value defined by the AWS service team.</p> <p>Update the service setting for the account. </p>
  ## 
...
proc call*(call_601815: Call_UpdateServiceSetting_601802; body: JsonNode): Recallable =
...
var updateServiceSetting* = Call_UpdateServiceSetting_601802(
    name: "updateServiceSetting", meth: HttpMethod.HttpPost,
    host: "ssm.amazonaws.com",
    route: "/#X-Amz-Target=AmazonSSM.UpdateServiceSetting",
    validator: validate_UpdateServiceSetting_601803, base: "/",
    url: url_UpdateServiceSetting_601804, schemes: {Scheme.Https, Scheme.Http})
export
  rest
