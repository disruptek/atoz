...
type
  Call_AcceptSharedDirectory_600768 = ref object of OpenApiRestCall_600426
proc url_AcceptSharedDirectory_600770(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AcceptSharedDirectory_600769(path: JsonNode; query: JsonNode;
...
proc call*(call_600926: Call_AcceptSharedDirectory_600768; path: JsonNode;
...
proc call*(call_600997: Call_AcceptSharedDirectory_600768; body: JsonNode): Recallable =
...
var acceptSharedDirectory* = Call_AcceptSharedDirectory_600768(
    ...
    validator: validate_AcceptSharedDirectory_600769, base: "/",
    url: url_AcceptSharedDirectory_600770, schemes: {Scheme.Https, Scheme.Http})
type
  Call_AddIpRoutes_601037 = ref object of OpenApiRestCall_600426
proc url_AddIpRoutes_601039(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AddIpRoutes_601038(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601049: Call_AddIpRoutes_601037; path: JsonNode; query: JsonNode;
...
proc call*(call_601050: Call_AddIpRoutes_601037; body: JsonNode): Recallable =
  ## addIpRoutes
  ## <p>If the DNS server for your on-premises domain uses a publicly addressable IP address, you must add a CIDR address block to correctly route traffic to and from your Microsoft AD on Amazon Web Services. <i>AddIpRoutes</i> adds this address block. You can also use <i>AddIpRoutes</i> to facilitate routing traffic that uses public IP ranges from your Microsoft AD on AWS to a peer VPC. </p> <p>Before you call <i>AddIpRoutes</i>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <i>AddIpRoutes</i> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ##   body: JObject (required)
...
var addIpRoutes* = Call_AddIpRoutes_601037(name: "addIpRoutes",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.AddIpRoutes",
                                        validator: validate_AddIpRoutes_601038,
                                        base: "/", url: url_AddIpRoutes_601039,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_AddTagsToResource_601052 = ref object of OpenApiRestCall_600426
proc url_AddTagsToResource_601054(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AddTagsToResource_601053(path: JsonNode; query: JsonNode;
...
proc call*(call_601064: Call_AddTagsToResource_601052; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds or overwrites one or more tags for the specified directory. Each directory can have a maximum of 50 tags. Each tag consists of a key and optional value. Tag keys must be unique to each resource.
  ## 
...
proc call*(call_601065: Call_AddTagsToResource_601052; body: JsonNode): Recallable =
  ## addTagsToResource
  ## Adds or overwrites one or more tags for the specified directory. Each directory can have a maximum of 50 tags. Each tag consists of a key and optional value. Tag keys must be unique to each resource.
  ##   body: JObject (required)
...
var addTagsToResource* = Call_AddTagsToResource_601052(name: "addTagsToResource",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.AddTagsToResource",
    validator: validate_AddTagsToResource_601053, base: "/",
    url: url_AddTagsToResource_601054, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CancelSchemaExtension_601067 = ref object of OpenApiRestCall_600426
proc url_CancelSchemaExtension_601069(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CancelSchemaExtension_601068(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601079: Call_CancelSchemaExtension_601067; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Cancels an in-progress schema extension to a Microsoft AD directory. Once a schema extension has started replicating to all domain controllers, the task can no longer be canceled. A schema extension can be canceled during any of the following states; <code>Initializing</code>, <code>CreatingSnapshot</code>, and <code>UpdatingSchema</code>.
  ## 
...
proc call*(call_601080: Call_CancelSchemaExtension_601067; body: JsonNode): Recallable =
...
var cancelSchemaExtension* = Call_CancelSchemaExtension_601067(
    name: "cancelSchemaExtension", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CancelSchemaExtension",
    validator: validate_CancelSchemaExtension_601068, base: "/",
    url: url_CancelSchemaExtension_601069, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ConnectDirectory_601082 = ref object of OpenApiRestCall_600426
proc url_ConnectDirectory_601084(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ConnectDirectory_601083(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601094: Call_ConnectDirectory_601082; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates an AD Connector to connect to an on-premises directory.</p> <p>Before you call <code>ConnectDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>ConnectDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ## 
...
proc call*(call_601095: Call_ConnectDirectory_601082; body: JsonNode): Recallable =
  ## connectDirectory
  ## <p>Creates an AD Connector to connect to an on-premises directory.</p> <p>Before you call <code>ConnectDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>ConnectDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ##   body: JObject (required)
...
var connectDirectory* = Call_ConnectDirectory_601082(name: "connectDirectory",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ConnectDirectory",
    validator: validate_ConnectDirectory_601083, base: "/",
    url: url_ConnectDirectory_601084, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAlias_601097 = ref object of OpenApiRestCall_600426
proc url_CreateAlias_601099(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateAlias_601098(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601109: Call_CreateAlias_601097; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates an alias for a directory and assigns the alias to the directory. The alias is used to construct the access URL for the directory, such as <code>http://&lt;alias&gt;.awsapps.com</code>.</p> <important> <p>After an alias has been created, it cannot be deleted or reused, so this operation should only be used when absolutely necessary.</p> </important>
  ## 
...
proc call*(call_601110: Call_CreateAlias_601097; body: JsonNode): Recallable =
  ## createAlias
  ## <p>Creates an alias for a directory and assigns the alias to the directory. The alias is used to construct the access URL for the directory, such as <code>http://&lt;alias&gt;.awsapps.com</code>.</p> <important> <p>After an alias has been created, it cannot be deleted or reused, so this operation should only be used when absolutely necessary.</p> </important>
  ##   body: JObject (required)
...
var createAlias* = Call_CreateAlias_601097(name: "createAlias",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.CreateAlias",
                                        validator: validate_CreateAlias_601098,
                                        base: "/", url: url_CreateAlias_601099,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateComputer_601112 = ref object of OpenApiRestCall_600426
proc url_CreateComputer_601114(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateComputer_601113(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601124: Call_CreateComputer_601112; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a computer account in the specified directory, and joins the computer to the directory.
  ## 
...
proc call*(call_601125: Call_CreateComputer_601112; body: JsonNode): Recallable =
  ## createComputer
  ## Creates a computer account in the specified directory, and joins the computer to the directory.
  ##   body: JObject (required)
...
var createComputer* = Call_CreateComputer_601112(name: "createComputer",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CreateComputer",
    validator: validate_CreateComputer_601113, base: "/", url: url_CreateComputer_601114,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateConditionalForwarder_601127 = ref object of OpenApiRestCall_600426
proc url_CreateConditionalForwarder_601129(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateConditionalForwarder_601128(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601139: Call_CreateConditionalForwarder_601127; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a conditional forwarder associated with your AWS directory. Conditional forwarders are required in order to set up a trust relationship with another domain. The conditional forwarder points to the trusted domain.
  ## 
...
proc call*(call_601140: Call_CreateConditionalForwarder_601127; body: JsonNode): Recallable =
...
var createConditionalForwarder* = Call_CreateConditionalForwarder_601127(
    ...
    validator: validate_CreateConditionalForwarder_601128, base: "/",
    url: url_CreateConditionalForwarder_601129,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDirectory_601142 = ref object of OpenApiRestCall_600426
proc url_CreateDirectory_601144(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateDirectory_601143(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_601154: Call_CreateDirectory_601142; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a Simple AD directory.</p> <p>Before you call <code>CreateDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>CreateDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ## 
...
proc call*(call_601155: Call_CreateDirectory_601142; body: JsonNode): Recallable =
  ## createDirectory
  ## <p>Creates a Simple AD directory.</p> <p>Before you call <code>CreateDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>CreateDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ##   body: JObject (required)
...
var createDirectory* = Call_CreateDirectory_601142(name: "createDirectory",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CreateDirectory",
    validator: validate_CreateDirectory_601143, base: "/", url: url_CreateDirectory_601144,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateLogSubscription_601157 = ref object of OpenApiRestCall_600426
proc url_CreateLogSubscription_601159(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateLogSubscription_601158(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601169: Call_CreateLogSubscription_601157; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a subscription to forward real time Directory Service domain controller security logs to the specified CloudWatch log group in your AWS account.
  ## 
...
proc call*(call_601170: Call_CreateLogSubscription_601157; body: JsonNode): Recallable =
...
var createLogSubscription* = Call_CreateLogSubscription_601157(
    name: "createLogSubscription", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CreateLogSubscription",
    validator: validate_CreateLogSubscription_601158, base: "/",
    url: url_CreateLogSubscription_601159, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateMicrosoftAD_601172 = ref object of OpenApiRestCall_600426
proc url_CreateMicrosoftAD_601174(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateMicrosoftAD_601173(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601184: Call_CreateMicrosoftAD_601172; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates an AWS Managed Microsoft AD directory.</p> <p>Before you call <i>CreateMicrosoftAD</i>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <i>CreateMicrosoftAD</i> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ## 
...
proc call*(call_601185: Call_CreateMicrosoftAD_601172; body: JsonNode): Recallable =
  ## createMicrosoftAD
  ## <p>Creates an AWS Managed Microsoft AD directory.</p> <p>Before you call <i>CreateMicrosoftAD</i>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <i>CreateMicrosoftAD</i> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ##   body: JObject (required)
...
var createMicrosoftAD* = Call_CreateMicrosoftAD_601172(name: "createMicrosoftAD",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CreateMicrosoftAD",
    validator: validate_CreateMicrosoftAD_601173, base: "/",
    url: url_CreateMicrosoftAD_601174, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSnapshot_601187 = ref object of OpenApiRestCall_600426
proc url_CreateSnapshot_601189(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateSnapshot_601188(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601199: Call_CreateSnapshot_601187; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a snapshot of a Simple AD or Microsoft AD directory in the AWS cloud.</p> <note> <p>You cannot take snapshots of AD Connector directories.</p> </note>
  ## 
...
proc call*(call_601200: Call_CreateSnapshot_601187; body: JsonNode): Recallable =
  ## createSnapshot
  ## <p>Creates a snapshot of a Simple AD or Microsoft AD directory in the AWS cloud.</p> <note> <p>You cannot take snapshots of AD Connector directories.</p> </note>
  ##   body: JObject (required)
...
var createSnapshot* = Call_CreateSnapshot_601187(name: "createSnapshot",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.CreateSnapshot",
    validator: validate_CreateSnapshot_601188, base: "/", url: url_CreateSnapshot_601189,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateTrust_601202 = ref object of OpenApiRestCall_600426
proc url_CreateTrust_601204(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateTrust_601203(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601214: Call_CreateTrust_601202; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>AWS Directory Service for Microsoft Active Directory allows you to configure trust relationships. For example, you can establish a trust between your AWS Managed Microsoft AD directory, and your existing on-premises Microsoft Active Directory. This would allow you to provide users and groups access to resources in either domain, with a single set of credentials.</p> <p>This action initiates the creation of the AWS side of a trust relationship between an AWS Managed Microsoft AD directory and an external domain. You can create either a forest trust or an external trust.</p>
  ## 
...
proc call*(call_601215: Call_CreateTrust_601202; body: JsonNode): Recallable =
  ## createTrust
  ## <p>AWS Directory Service for Microsoft Active Directory allows you to configure trust relationships. For example, you can establish a trust between your AWS Managed Microsoft AD directory, and your existing on-premises Microsoft Active Directory. This would allow you to provide users and groups access to resources in either domain, with a single set of credentials.</p> <p>This action initiates the creation of the AWS side of a trust relationship between an AWS Managed Microsoft AD directory and an external domain. You can create either a forest trust or an external trust.</p>
  ##   body: JObject (required)
...
var createTrust* = Call_CreateTrust_601202(name: "createTrust",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.CreateTrust",
                                        validator: validate_CreateTrust_601203,
                                        base: "/", url: url_CreateTrust_601204,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConditionalForwarder_601217 = ref object of OpenApiRestCall_600426
proc url_DeleteConditionalForwarder_601219(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteConditionalForwarder_601218(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601229: Call_DeleteConditionalForwarder_601217; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a conditional forwarder that has been set up for your AWS directory.
  ## 
...
proc call*(call_601230: Call_DeleteConditionalForwarder_601217; body: JsonNode): Recallable =
...
var deleteConditionalForwarder* = Call_DeleteConditionalForwarder_601217(
    ...
    validator: validate_DeleteConditionalForwarder_601218, base: "/",
    url: url_DeleteConditionalForwarder_601219,
    schemes: {Scheme.Https, Scheme.Http})
type
...
proc call*(call_601244: Call_DeleteDirectory_601232; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes an AWS Directory Service directory.</p> <p>Before you call <code>DeleteDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>DeleteDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ## 
...
proc call*(call_601245: Call_DeleteDirectory_601232; body: JsonNode): Recallable =
  ## deleteDirectory
  ## <p>Deletes an AWS Directory Service directory.</p> <p>Before you call <code>DeleteDirectory</code>, ensure that all of the required permissions have been explicitly granted through a policy. For details about what permissions are required to run the <code>DeleteDirectory</code> operation, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html">AWS Directory Service API Permissions: Actions, Resources, and Conditions Reference</a>.</p>
  ##   body: JObject (required)
...
var deleteDirectory* = Call_DeleteDirectory_601232(name: "deleteDirectory",
    ...
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteLogSubscription_601247 = ref object of OpenApiRestCall_600426
proc url_DeleteLogSubscription_601249(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteLogSubscription_601248(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601259: Call_DeleteLogSubscription_601247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified log subscription.
  ## 
...
proc call*(call_601260: Call_DeleteLogSubscription_601247; body: JsonNode): Recallable =
...
var deleteLogSubscription* = Call_DeleteLogSubscription_601247(
    name: "deleteLogSubscription", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DeleteLogSubscription",
    validator: validate_DeleteLogSubscription_601248, base: "/",
    url: url_DeleteLogSubscription_601249, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSnapshot_601262 = ref object of OpenApiRestCall_600426
proc url_DeleteSnapshot_601264(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteSnapshot_601263(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601274: Call_DeleteSnapshot_601262; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a directory snapshot.
  ## 
...
proc call*(call_601275: Call_DeleteSnapshot_601262; body: JsonNode): Recallable =
  ## deleteSnapshot
  ## Deletes a directory snapshot.
  ##   body: JObject (required)
...
var deleteSnapshot* = Call_DeleteSnapshot_601262(name: "deleteSnapshot",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DeleteSnapshot",
    validator: validate_DeleteSnapshot_601263, base: "/", url: url_DeleteSnapshot_601264,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTrust_601277 = ref object of OpenApiRestCall_600426
proc url_DeleteTrust_601279(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteTrust_601278(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601289: Call_DeleteTrust_601277; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an existing trust relationship between your AWS Managed Microsoft AD directory and an external domain.
  ## 
...
proc call*(call_601290: Call_DeleteTrust_601277; body: JsonNode): Recallable =
  ## deleteTrust
  ## Deletes an existing trust relationship between your AWS Managed Microsoft AD directory and an external domain.
  ##   body: JObject (required)
...
var deleteTrust* = Call_DeleteTrust_601277(name: "deleteTrust",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.DeleteTrust",
                                        validator: validate_DeleteTrust_601278,
                                        base: "/", url: url_DeleteTrust_601279,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterEventTopic_601292 = ref object of OpenApiRestCall_600426
proc url_DeregisterEventTopic_601294(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeregisterEventTopic_601293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601304: Call_DeregisterEventTopic_601292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes the specified directory as a publisher to the specified SNS topic.
  ## 
...
proc call*(call_601305: Call_DeregisterEventTopic_601292; body: JsonNode): Recallable =
...
var deregisterEventTopic* = Call_DeregisterEventTopic_601292(
    name: "deregisterEventTopic", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DeregisterEventTopic",
    validator: validate_DeregisterEventTopic_601293, base: "/",
    url: url_DeregisterEventTopic_601294, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConditionalForwarders_601307 = ref object of OpenApiRestCall_600426
proc url_DescribeConditionalForwarders_601309(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeConditionalForwarders_601308(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601319: Call_DescribeConditionalForwarders_601307; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Obtains information about the conditional forwarders for this account.</p> <p>If no input parameters are provided for RemoteDomainNames, this request describes all conditional forwarders for the specified directory ID.</p>
  ## 
...
proc call*(call_601320: Call_DescribeConditionalForwarders_601307; body: JsonNode): Recallable =
...
var describeConditionalForwarders* = Call_DescribeConditionalForwarders_601307(
    ...
    validator: validate_DescribeConditionalForwarders_601308, base: "/",
    url: url_DescribeConditionalForwarders_601309,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDirectories_601322 = ref object of OpenApiRestCall_600426
proc url_DescribeDirectories_601324(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeDirectories_601323(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601334: Call_DescribeDirectories_601322; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Obtains information about the directories that belong to this account.</p> <p>You can retrieve information about specific directories by passing the directory identifiers in the <code>DirectoryIds</code> parameter. Otherwise, all directories that belong to the current account are returned.</p> <p>This operation supports pagination with the use of the <code>NextToken</code> request and response parameters. If more results are available, the <code>DescribeDirectoriesResult.NextToken</code> member contains a token that you pass in the next call to <a>DescribeDirectories</a> to retrieve the next set of items.</p> <p>You can also specify a maximum number of return results with the <code>Limit</code> parameter.</p>
  ## 
...
proc call*(call_601335: Call_DescribeDirectories_601322; body: JsonNode): Recallable =
  ## describeDirectories
  ## <p>Obtains information about the directories that belong to this account.</p> <p>You can retrieve information about specific directories by passing the directory identifiers in the <code>DirectoryIds</code> parameter. Otherwise, all directories that belong to the current account are returned.</p> <p>This operation supports pagination with the use of the <code>NextToken</code> request and response parameters. If more results are available, the <code>DescribeDirectoriesResult.NextToken</code> member contains a token that you pass in the next call to <a>DescribeDirectories</a> to retrieve the next set of items.</p> <p>You can also specify a maximum number of return results with the <code>Limit</code> parameter.</p>
  ##   body: JObject (required)
...
var describeDirectories* = Call_DescribeDirectories_601322(
    name: "describeDirectories", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DescribeDirectories",
    validator: validate_DescribeDirectories_601323, base: "/",
    url: url_DescribeDirectories_601324, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDomainControllers_601337 = ref object of OpenApiRestCall_600426
proc url_DescribeDomainControllers_601339(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeDomainControllers_601338(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_601340 = query.getOrDefault("Limit")
  valid_601340 = validateParameter(valid_601340, JString, required = false,
                                 default = nil)
  if valid_601340 != nil:
    section.add "Limit", valid_601340
...
proc call*(call_601351: Call_DescribeDomainControllers_601337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides information about any domain controllers in your directory.
  ## 
...
proc call*(call_601352: Call_DescribeDomainControllers_601337; body: JsonNode;
...
var describeDomainControllers* = Call_DescribeDomainControllers_601337(
    ...
    validator: validate_DescribeDomainControllers_601338, base: "/",
    url: url_DescribeDomainControllers_601339,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEventTopics_601356 = ref object of OpenApiRestCall_600426
proc url_DescribeEventTopics_601358(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeEventTopics_601357(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601368: Call_DescribeEventTopics_601356; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Obtains information about which SNS topics receive status messages from the specified directory.</p> <p>If no input parameters are provided, such as DirectoryId or TopicName, this request describes all of the associations in the account.</p>
  ## 
...
proc call*(call_601369: Call_DescribeEventTopics_601356; body: JsonNode): Recallable =
  ## describeEventTopics
  ## <p>Obtains information about which SNS topics receive status messages from the specified directory.</p> <p>If no input parameters are provided, such as DirectoryId or TopicName, this request describes all of the associations in the account.</p>
  ##   body: JObject (required)
...
var describeEventTopics* = Call_DescribeEventTopics_601356(
    name: "describeEventTopics", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DescribeEventTopics",
    validator: validate_DescribeEventTopics_601357, base: "/",
    url: url_DescribeEventTopics_601358, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSharedDirectories_601371 = ref object of OpenApiRestCall_600426
proc url_DescribeSharedDirectories_601373(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeSharedDirectories_601372(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601383: Call_DescribeSharedDirectories_601371; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the shared directories in your account. 
  ## 
...
proc call*(call_601384: Call_DescribeSharedDirectories_601371; body: JsonNode): Recallable =
...
var describeSharedDirectories* = Call_DescribeSharedDirectories_601371(
    ...
    validator: validate_DescribeSharedDirectories_601372, base: "/",
    url: url_DescribeSharedDirectories_601373,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSnapshots_601386 = ref object of OpenApiRestCall_600426
proc url_DescribeSnapshots_601388(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeSnapshots_601387(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601398: Call_DescribeSnapshots_601386; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Obtains information about the directory snapshots that belong to this account.</p> <p>This operation supports pagination with the use of the <i>NextToken</i> request and response parameters. If more results are available, the <i>DescribeSnapshots.NextToken</i> member contains a token that you pass in the next call to <a>DescribeSnapshots</a> to retrieve the next set of items.</p> <p>You can also specify a maximum number of return results with the <i>Limit</i> parameter.</p>
  ## 
...
proc call*(call_601399: Call_DescribeSnapshots_601386; body: JsonNode): Recallable =
  ## describeSnapshots
  ## <p>Obtains information about the directory snapshots that belong to this account.</p> <p>This operation supports pagination with the use of the <i>NextToken</i> request and response parameters. If more results are available, the <i>DescribeSnapshots.NextToken</i> member contains a token that you pass in the next call to <a>DescribeSnapshots</a> to retrieve the next set of items.</p> <p>You can also specify a maximum number of return results with the <i>Limit</i> parameter.</p>
  ##   body: JObject (required)
...
var describeSnapshots* = Call_DescribeSnapshots_601386(name: "describeSnapshots",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DescribeSnapshots",
    validator: validate_DescribeSnapshots_601387, base: "/",
    url: url_DescribeSnapshots_601388, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTrusts_601401 = ref object of OpenApiRestCall_600426
proc url_DescribeTrusts_601403(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeTrusts_601402(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601413: Call_DescribeTrusts_601401; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Obtains information about the trust relationships for this account.</p> <p>If no input parameters are provided, such as DirectoryId or TrustIds, this request describes all the trust relationships belonging to the account.</p>
  ## 
...
proc call*(call_601414: Call_DescribeTrusts_601401; body: JsonNode): Recallable =
  ## describeTrusts
  ## <p>Obtains information about the trust relationships for this account.</p> <p>If no input parameters are provided, such as DirectoryId or TrustIds, this request describes all the trust relationships belonging to the account.</p>
  ##   body: JObject (required)
...
var describeTrusts* = Call_DescribeTrusts_601401(name: "describeTrusts",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DescribeTrusts",
    validator: validate_DescribeTrusts_601402, base: "/", url: url_DescribeTrusts_601403,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisableRadius_601416 = ref object of OpenApiRestCall_600426
proc url_DisableRadius_601418(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisableRadius_601417(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601428: Call_DisableRadius_601416; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
  ## 
...
proc call*(call_601429: Call_DisableRadius_601416; body: JsonNode): Recallable =
  ## disableRadius
  ## Disables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
  ##   body: JObject (required)
...
var disableRadius* = Call_DisableRadius_601416(name: "disableRadius",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.DisableRadius",
    validator: validate_DisableRadius_601417, base: "/", url: url_DisableRadius_601418,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisableSso_601431 = ref object of OpenApiRestCall_600426
proc url_DisableSso_601433(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisableSso_601432(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601443: Call_DisableSso_601431; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Disables single-sign on for a directory.
  ## 
...
proc call*(call_601444: Call_DisableSso_601431; body: JsonNode): Recallable =
  ## disableSso
  ## Disables single-sign on for a directory.
  ##   body: JObject (required)
...
var disableSso* = Call_DisableSso_601431(name: "disableSso",
                                      meth: HttpMethod.HttpPost,
                                      host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.DisableSso",
                                      validator: validate_DisableSso_601432,
                                      base: "/", url: url_DisableSso_601433,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_EnableRadius_601446 = ref object of OpenApiRestCall_600426
proc url_EnableRadius_601448(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_EnableRadius_601447(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601458: Call_EnableRadius_601446; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Enables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
  ## 
...
proc call*(call_601459: Call_EnableRadius_601446; body: JsonNode): Recallable =
  ## enableRadius
  ## Enables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
  ##   body: JObject (required)
...
var enableRadius* = Call_EnableRadius_601446(name: "enableRadius",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.EnableRadius",
    validator: validate_EnableRadius_601447, base: "/", url: url_EnableRadius_601448,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_EnableSso_601461 = ref object of OpenApiRestCall_600426
proc url_EnableSso_601463(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_EnableSso_601462(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601473: Call_EnableSso_601461; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Enables single sign-on for a directory.
  ## 
...
proc call*(call_601474: Call_EnableSso_601461; body: JsonNode): Recallable =
  ## enableSso
  ## Enables single sign-on for a directory.
  ##   body: JObject (required)
...
var enableSso* = Call_EnableSso_601461(name: "enableSso", meth: HttpMethod.HttpPost,
                                    host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.EnableSso",
                                    validator: validate_EnableSso_601462,
                                    base: "/", url: url_EnableSso_601463,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDirectoryLimits_601476 = ref object of OpenApiRestCall_600426
proc url_GetDirectoryLimits_601478(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetDirectoryLimits_601477(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601488: Call_GetDirectoryLimits_601476; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Obtains directory limit information for the current region.
  ## 
...
proc call*(call_601489: Call_GetDirectoryLimits_601476; body: JsonNode): Recallable =
  ## getDirectoryLimits
  ## Obtains directory limit information for the current region.
  ##   body: JObject (required)
...
var getDirectoryLimits* = Call_GetDirectoryLimits_601476(
    ...
    validator: validate_GetDirectoryLimits_601477, base: "/",
    url: url_GetDirectoryLimits_601478, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSnapshotLimits_601491 = ref object of OpenApiRestCall_600426
proc url_GetSnapshotLimits_601493(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetSnapshotLimits_601492(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601503: Call_GetSnapshotLimits_601491; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Obtains the manual snapshot limits for a directory.
  ## 
...
proc call*(call_601504: Call_GetSnapshotLimits_601491; body: JsonNode): Recallable =
  ## getSnapshotLimits
  ## Obtains the manual snapshot limits for a directory.
  ##   body: JObject (required)
...
var getSnapshotLimits* = Call_GetSnapshotLimits_601491(name: "getSnapshotLimits",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.GetSnapshotLimits",
    validator: validate_GetSnapshotLimits_601492, base: "/",
    url: url_GetSnapshotLimits_601493, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListIpRoutes_601506 = ref object of OpenApiRestCall_600426
proc url_ListIpRoutes_601508(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListIpRoutes_601507(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601518: Call_ListIpRoutes_601506; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the address blocks that you have added to a directory.
  ## 
...
proc call*(call_601519: Call_ListIpRoutes_601506; body: JsonNode): Recallable =
  ## listIpRoutes
  ## Lists the address blocks that you have added to a directory.
  ##   body: JObject (required)
...
var listIpRoutes* = Call_ListIpRoutes_601506(name: "listIpRoutes",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ListIpRoutes",
    validator: validate_ListIpRoutes_601507, base: "/", url: url_ListIpRoutes_601508,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListLogSubscriptions_601521 = ref object of OpenApiRestCall_600426
proc url_ListLogSubscriptions_601523(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListLogSubscriptions_601522(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601533: Call_ListLogSubscriptions_601521; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the active log subscriptions for the AWS account.
  ## 
...
proc call*(call_601534: Call_ListLogSubscriptions_601521; body: JsonNode): Recallable =
...
var listLogSubscriptions* = Call_ListLogSubscriptions_601521(
    name: "listLogSubscriptions", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ListLogSubscriptions",
    validator: validate_ListLogSubscriptions_601522, base: "/",
    url: url_ListLogSubscriptions_601523, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSchemaExtensions_601536 = ref object of OpenApiRestCall_600426
proc url_ListSchemaExtensions_601538(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListSchemaExtensions_601537(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601548: Call_ListSchemaExtensions_601536; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all schema extensions applied to a Microsoft AD Directory.
  ## 
...
proc call*(call_601549: Call_ListSchemaExtensions_601536; body: JsonNode): Recallable =
...
var listSchemaExtensions* = Call_ListSchemaExtensions_601536(
    name: "listSchemaExtensions", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ListSchemaExtensions",
    validator: validate_ListSchemaExtensions_601537, base: "/",
    url: url_ListSchemaExtensions_601538, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_601551 = ref object of OpenApiRestCall_600426
proc url_ListTagsForResource_601553(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListTagsForResource_601552(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601563: Call_ListTagsForResource_601551; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all tags on a directory.
  ## 
...
proc call*(call_601564: Call_ListTagsForResource_601551; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists all tags on a directory.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_601551(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ListTagsForResource",
    validator: validate_ListTagsForResource_601552, base: "/",
    url: url_ListTagsForResource_601553, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterEventTopic_601566 = ref object of OpenApiRestCall_600426
proc url_RegisterEventTopic_601568(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RegisterEventTopic_601567(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601578: Call_RegisterEventTopic_601566; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Associates a directory with an SNS topic. This establishes the directory as a publisher to the specified SNS topic. You can then receive email or text (SMS) messages when the status of your directory changes. You get notified if your directory goes from an Active status to an Impaired or Inoperable status. You also receive a notification when the directory returns to an Active status.
  ## 
...
proc call*(call_601579: Call_RegisterEventTopic_601566; body: JsonNode): Recallable =
  ## registerEventTopic
  ## Associates a directory with an SNS topic. This establishes the directory as a publisher to the specified SNS topic. You can then receive email or text (SMS) messages when the status of your directory changes. You get notified if your directory goes from an Active status to an Impaired or Inoperable status. You also receive a notification when the directory returns to an Active status.
  ##   body: JObject (required)
...
var registerEventTopic* = Call_RegisterEventTopic_601566(
    ...
    validator: validate_RegisterEventTopic_601567, base: "/",
    url: url_RegisterEventTopic_601568, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RejectSharedDirectory_601581 = ref object of OpenApiRestCall_600426
proc url_RejectSharedDirectory_601583(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RejectSharedDirectory_601582(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601593: Call_RejectSharedDirectory_601581; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Rejects a directory sharing request that was sent from the directory owner account.
  ## 
...
proc call*(call_601594: Call_RejectSharedDirectory_601581; body: JsonNode): Recallable =
...
var rejectSharedDirectory* = Call_RejectSharedDirectory_601581(
    name: "rejectSharedDirectory", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.RejectSharedDirectory",
    validator: validate_RejectSharedDirectory_601582, base: "/",
    url: url_RejectSharedDirectory_601583, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveIpRoutes_601596 = ref object of OpenApiRestCall_600426
proc url_RemoveIpRoutes_601598(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RemoveIpRoutes_601597(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601608: Call_RemoveIpRoutes_601596; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes IP address blocks from a directory.
  ## 
...
proc call*(call_601609: Call_RemoveIpRoutes_601596; body: JsonNode): Recallable =
  ## removeIpRoutes
  ## Removes IP address blocks from a directory.
  ##   body: JObject (required)
...
var removeIpRoutes* = Call_RemoveIpRoutes_601596(name: "removeIpRoutes",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.RemoveIpRoutes",
    validator: validate_RemoveIpRoutes_601597, base: "/", url: url_RemoveIpRoutes_601598,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveTagsFromResource_601611 = ref object of OpenApiRestCall_600426
proc url_RemoveTagsFromResource_601613(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RemoveTagsFromResource_601612(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601623: Call_RemoveTagsFromResource_601611; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes tags from a directory.
  ## 
...
proc call*(call_601624: Call_RemoveTagsFromResource_601611; body: JsonNode): Recallable =
...
var removeTagsFromResource* = Call_RemoveTagsFromResource_601611(
    name: "removeTagsFromResource", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.RemoveTagsFromResource",
    validator: validate_RemoveTagsFromResource_601612, base: "/",
    url: url_RemoveTagsFromResource_601613, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ResetUserPassword_601626 = ref object of OpenApiRestCall_600426
proc url_ResetUserPassword_601628(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ResetUserPassword_601627(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_601638: Call_ResetUserPassword_601626; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resets the password for any user in your AWS Managed Microsoft AD or Simple AD directory.
  ## 
...
proc call*(call_601639: Call_ResetUserPassword_601626; body: JsonNode): Recallable =
  ## resetUserPassword
  ## Resets the password for any user in your AWS Managed Microsoft AD or Simple AD directory.
  ##   body: JObject (required)
...
var resetUserPassword* = Call_ResetUserPassword_601626(name: "resetUserPassword",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ResetUserPassword",
    validator: validate_ResetUserPassword_601627, base: "/",
    url: url_ResetUserPassword_601628, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RestoreFromSnapshot_601641 = ref object of OpenApiRestCall_600426
proc url_RestoreFromSnapshot_601643(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_RestoreFromSnapshot_601642(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601653: Call_RestoreFromSnapshot_601641; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Restores a directory using an existing directory snapshot.</p> <p>When you restore a directory from a snapshot, any changes made to the directory after the snapshot date are overwritten.</p> <p>This action returns as soon as the restore operation is initiated. You can monitor the progress of the restore operation by calling the <a>DescribeDirectories</a> operation with the directory identifier. When the <b>DirectoryDescription.Stage</b> value changes to <code>Active</code>, the restore operation is complete.</p>
  ## 
...
proc call*(call_601654: Call_RestoreFromSnapshot_601641; body: JsonNode): Recallable =
  ## restoreFromSnapshot
  ## <p>Restores a directory using an existing directory snapshot.</p> <p>When you restore a directory from a snapshot, any changes made to the directory after the snapshot date are overwritten.</p> <p>This action returns as soon as the restore operation is initiated. You can monitor the progress of the restore operation by calling the <a>DescribeDirectories</a> operation with the directory identifier. When the <b>DirectoryDescription.Stage</b> value changes to <code>Active</code>, the restore operation is complete.</p>
  ##   body: JObject (required)
...
var restoreFromSnapshot* = Call_RestoreFromSnapshot_601641(
    name: "restoreFromSnapshot", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.RestoreFromSnapshot",
    validator: validate_RestoreFromSnapshot_601642, base: "/",
    url: url_RestoreFromSnapshot_601643, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ShareDirectory_601656 = ref object of OpenApiRestCall_600426
proc url_ShareDirectory_601658(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ShareDirectory_601657(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601668: Call_ShareDirectory_601656; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Shares a specified directory (<code>DirectoryId</code>) in your AWS account (directory owner) with another AWS account (directory consumer). With this operation you can use your directory from any AWS account and from any Amazon VPC within an AWS Region.</p> <p>When you share your AWS Managed Microsoft AD directory, AWS Directory Service creates a shared directory in the directory consumer account. This shared directory contains the metadata to provide access to the directory within the directory owner account. The shared directory is visible in all VPCs in the directory consumer account.</p> <p>The <code>ShareMethod</code> parameter determines whether the specified directory can be shared between AWS accounts inside the same AWS organization (<code>ORGANIZATIONS</code>). It also determines whether you can share the directory with any other AWS account either inside or outside of the organization (<code>HANDSHAKE</code>).</p> <p>The <code>ShareNotes</code> parameter is only used when <code>HANDSHAKE</code> is called, which sends a directory sharing request to the directory consumer. </p>
  ## 
...
proc call*(call_601669: Call_ShareDirectory_601656; body: JsonNode): Recallable =
  ## shareDirectory
  ## <p>Shares a specified directory (<code>DirectoryId</code>) in your AWS account (directory owner) with another AWS account (directory consumer). With this operation you can use your directory from any AWS account and from any Amazon VPC within an AWS Region.</p> <p>When you share your AWS Managed Microsoft AD directory, AWS Directory Service creates a shared directory in the directory consumer account. This shared directory contains the metadata to provide access to the directory within the directory owner account. The shared directory is visible in all VPCs in the directory consumer account.</p> <p>The <code>ShareMethod</code> parameter determines whether the specified directory can be shared between AWS accounts inside the same AWS organization (<code>ORGANIZATIONS</code>). It also determines whether you can share the directory with any other AWS account either inside or outside of the organization (<code>HANDSHAKE</code>).</p> <p>The <code>ShareNotes</code> parameter is only used when <code>HANDSHAKE</code> is called, which sends a directory sharing request to the directory consumer. </p>
  ##   body: JObject (required)
...
var shareDirectory* = Call_ShareDirectory_601656(name: "shareDirectory",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.ShareDirectory",
    validator: validate_ShareDirectory_601657, base: "/", url: url_ShareDirectory_601658,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSchemaExtension_601671 = ref object of OpenApiRestCall_600426
proc url_StartSchemaExtension_601673(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartSchemaExtension_601672(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601683: Call_StartSchemaExtension_601671; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Applies a schema extension to a Microsoft AD directory.
  ## 
...
proc call*(call_601684: Call_StartSchemaExtension_601671; body: JsonNode): Recallable =
...
var startSchemaExtension* = Call_StartSchemaExtension_601671(
    name: "startSchemaExtension", meth: HttpMethod.HttpPost,
    host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.StartSchemaExtension",
    validator: validate_StartSchemaExtension_601672, base: "/",
    url: url_StartSchemaExtension_601673, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UnshareDirectory_601686 = ref object of OpenApiRestCall_600426
proc url_UnshareDirectory_601688(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UnshareDirectory_601687(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601698: Call_UnshareDirectory_601686; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops the directory sharing between the directory owner and consumer accounts. 
  ## 
...
proc call*(call_601699: Call_UnshareDirectory_601686; body: JsonNode): Recallable =
  ## unshareDirectory
  ## Stops the directory sharing between the directory owner and consumer accounts. 
  ##   body: JObject (required)
...
var unshareDirectory* = Call_UnshareDirectory_601686(name: "unshareDirectory",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.UnshareDirectory",
    validator: validate_UnshareDirectory_601687, base: "/",
    url: url_UnshareDirectory_601688, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateConditionalForwarder_601701 = ref object of OpenApiRestCall_600426
proc url_UpdateConditionalForwarder_601703(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateConditionalForwarder_601702(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601713: Call_UpdateConditionalForwarder_601701; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a conditional forwarder that has been set up for your AWS directory.
  ## 
...
proc call*(call_601714: Call_UpdateConditionalForwarder_601701; body: JsonNode): Recallable =
...
var updateConditionalForwarder* = Call_UpdateConditionalForwarder_601701(
    ...
    validator: validate_UpdateConditionalForwarder_601702, base: "/",
    url: url_UpdateConditionalForwarder_601703,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNumberOfDomainControllers_601716 = ref object of OpenApiRestCall_600426
proc url_UpdateNumberOfDomainControllers_601718(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateNumberOfDomainControllers_601717(path: JsonNode;
...
proc call*(call_601728: Call_UpdateNumberOfDomainControllers_601716;
...
proc call*(call_601729: Call_UpdateNumberOfDomainControllers_601716; body: JsonNode): Recallable =
...
var updateNumberOfDomainControllers* = Call_UpdateNumberOfDomainControllers_601716(
    ...
    validator: validate_UpdateNumberOfDomainControllers_601717, base: "/",
    url: url_UpdateNumberOfDomainControllers_601718,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateRadius_601731 = ref object of OpenApiRestCall_600426
proc url_UpdateRadius_601733(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateRadius_601732(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601743: Call_UpdateRadius_601731; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the Remote Authentication Dial In User Service (RADIUS) server information for an AD Connector or Microsoft AD directory.
  ## 
...
proc call*(call_601744: Call_UpdateRadius_601731; body: JsonNode): Recallable =
  ## updateRadius
  ## Updates the Remote Authentication Dial In User Service (RADIUS) server information for an AD Connector or Microsoft AD directory.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_601745 = body
  result = call_601744.call(nil, nil, nil, nil, body_601745)

var updateRadius* = Call_UpdateRadius_601731(name: "updateRadius",
    meth: HttpMethod.HttpPost, host: "ds.amazonaws.com",
    route: "/#X-Amz-Target=DirectoryService_20150416.UpdateRadius",
    validator: validate_UpdateRadius_601732, base: "/", url: url_UpdateRadius_601733,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTrust_601746 = ref object of OpenApiRestCall_600426
proc url_UpdateTrust_601748(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateTrust_601747(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601751 = header.getOrDefault("X-Amz-Target")
  valid_601751 = validateParameter(valid_601751, JString, required = true, default = newJString(
      "DirectoryService_20150416.UpdateTrust"))
  if valid_601751 != nil:
    section.add "X-Amz-Target", valid_601751
...
proc call*(call_601758: Call_UpdateTrust_601746; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the trust that has been set up between your AWS Managed Microsoft AD directory and an on-premises Active Directory.
  ## 
...
proc call*(call_601759: Call_UpdateTrust_601746; body: JsonNode): Recallable =
  ## updateTrust
  ## Updates the trust that has been set up between your AWS Managed Microsoft AD directory and an on-premises Active Directory.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_601760 = body
  result = call_601759.call(nil, nil, nil, nil, body_601760)

var updateTrust* = Call_UpdateTrust_601746(name: "updateTrust",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.UpdateTrust",
                                        validator: validate_UpdateTrust_601747,
                                        base: "/", url: url_UpdateTrust_601748,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_VerifyTrust_601761 = ref object of OpenApiRestCall_600426
proc url_VerifyTrust_601763(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_VerifyTrust_601762(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_601766 = header.getOrDefault("X-Amz-Target")
  valid_601766 = validateParameter(valid_601766, JString, required = true, default = newJString(
      "DirectoryService_20150416.VerifyTrust"))
  if valid_601766 != nil:
    section.add "X-Amz-Target", valid_601766
...
proc call*(call_601773: Call_VerifyTrust_601761; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>AWS Directory Service for Microsoft Active Directory allows you to configure and verify trust relationships.</p> <p>This action verifies a trust relationship between your AWS Managed Microsoft AD directory and an external domain.</p>
  ## 
...
proc call*(call_601774: Call_VerifyTrust_601761; body: JsonNode): Recallable =
  ## verifyTrust
  ## <p>AWS Directory Service for Microsoft Active Directory allows you to configure and verify trust relationships.</p> <p>This action verifies a trust relationship between your AWS Managed Microsoft AD directory and an external domain.</p>
  ##   body: JObject (required)
  var body_601775 = newJObject()
  if body != nil:
    body_601775 = body
  result = call_601774.call(nil, nil, nil, nil, body_601775)

var verifyTrust* = Call_VerifyTrust_601761(name: "verifyTrust",
                                        meth: HttpMethod.HttpPost,
                                        host: "ds.amazonaws.com", route: "/#X-Amz-Target=DirectoryService_20150416.VerifyTrust",
                                        validator: validate_VerifyTrust_601762,
                                        base: "/", url: url_VerifyTrust_601763,
                                        schemes: {Scheme.Https, Scheme.Http})
export
  rest
