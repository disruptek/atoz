...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "discovery.ap-northeast-1.amazonaws.com", "ap-southeast-1": "discovery.ap-southeast-1.amazonaws.com", "us-west-2": "discovery.us-west-2.amazonaws.com", "eu-west-2": "discovery.eu-west-2.amazonaws.com", "ap-northeast-3": "discovery.ap-northeast-3.amazonaws.com", "eu-central-1": "discovery.eu-central-1.amazonaws.com", "us-east-2": "discovery.us-east-2.amazonaws.com", "us-east-1": "discovery.us-east-1.amazonaws.com", "cn-northwest-1": "discovery.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "discovery.ap-south-1.amazonaws.com", "eu-north-1": "discovery.eu-north-1.amazonaws.com", "ap-northeast-2": "discovery.ap-northeast-2.amazonaws.com", "us-west-1": "discovery.us-west-1.amazonaws.com", "us-gov-east-1": "discovery.us-gov-east-1.amazonaws.com", "eu-west-3": "discovery.eu-west-3.amazonaws.com", "cn-north-1": "discovery.cn-north-1.amazonaws.com.cn", "sa-east-1": "discovery.sa-east-1.amazonaws.com", "eu-west-1": "discovery.eu-west-1.amazonaws.com", "us-gov-west-1": "discovery.us-gov-west-1.amazonaws.com", "ap-southeast-2": "discovery.ap-southeast-2.amazonaws.com", "ca-central-1": "discovery.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_AssociateConfigurationItemsToApplication_402656294 = ref object of OpenApiRestCall_402656044
proc url_AssociateConfigurationItemsToApplication_402656296(protocol: Scheme;
...
proc validate_AssociateConfigurationItemsToApplication_402656295(path: JsonNode;
...
proc call*(call_402656412: Call_AssociateConfigurationItemsToApplication_402656294;
...
proc call*(call_402656461: Call_AssociateConfigurationItemsToApplication_402656294;
...
var associateConfigurationItemsToApplication* = Call_AssociateConfigurationItemsToApplication_402656294(
    ...
    validator: validate_AssociateConfigurationItemsToApplication_402656295,
    base: "/", makeUrl: url_AssociateConfigurationItemsToApplication_402656296,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_BatchDeleteImportData_402656489 = ref object of OpenApiRestCall_402656044
proc url_BatchDeleteImportData_402656491(protocol: Scheme; host: string;
...
proc validate_BatchDeleteImportData_402656490(path: JsonNode; query: JsonNode;
...
proc call*(call_402656501: Call_BatchDeleteImportData_402656489;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes one or more import tasks, each identified by their import ID. Each import task has a number of records that can identify servers or applications. </p> <p>AWS Application Discovery Service has built-in matching logic that will identify when discovered servers match existing entries that you've previously discovered, the information for the already-existing discovered server is updated. When you delete an import task that contains records that were used to match, the information in those matched records that comes from the deleted records will also be deleted.</p>
                                                                                         ## 
...
proc call*(call_402656502: Call_BatchDeleteImportData_402656489; body: JsonNode): Recallable =
...
var batchDeleteImportData* = Call_BatchDeleteImportData_402656489(
    ...
    validator: validate_BatchDeleteImportData_402656490, base: "/",
    makeUrl: url_BatchDeleteImportData_402656491,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateApplication_402656504 = ref object of OpenApiRestCall_402656044
proc url_CreateApplication_402656506(protocol: Scheme; host: string;
...
proc validate_CreateApplication_402656505(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656516: Call_CreateApplication_402656504;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates an application with the given name and description.
                                                                                         ## 
...
proc call*(call_402656517: Call_CreateApplication_402656504; body: JsonNode): Recallable =
  ## createApplication
  ## Creates an application with the given name and description.
  ##   body: JObject (required)
...
var createApplication* = Call_CreateApplication_402656504(
    ...
    validator: validate_CreateApplication_402656505, base: "/",
    makeUrl: url_CreateApplication_402656506,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateTags_402656519 = ref object of OpenApiRestCall_402656044
proc url_CreateTags_402656521(protocol: Scheme; host: string; base: string;
...
proc validate_CreateTags_402656520(path: JsonNode; query: JsonNode;
...
proc call*(call_402656531: Call_CreateTags_402656519; path: JsonNode = nil;
...
proc call*(call_402656532: Call_CreateTags_402656519; body: JsonNode): Recallable =
  ## createTags
  ## Creates one or more tags for configuration items. Tags are metadata that help you categorize IT assets. This API accepts a list of multiple configuration items.
  ##   
                                                                                                                                                                     ## body: JObject (required)
...
var createTags* = Call_CreateTags_402656519(name: "createTags",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateTags",
    validator: validate_CreateTags_402656520, base: "/",
    makeUrl: url_CreateTags_402656521, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteApplications_402656534 = ref object of OpenApiRestCall_402656044
proc url_DeleteApplications_402656536(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteApplications_402656535(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656546: Call_DeleteApplications_402656534;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a list of applications and their associations with configuration items.
                                                                                         ## 
...
proc call*(call_402656547: Call_DeleteApplications_402656534; body: JsonNode): Recallable =
  ## deleteApplications
  ## Deletes a list of applications and their associations with configuration items.
  ##   
                                                                                    ## body: JObject (required)
...
var deleteApplications* = Call_DeleteApplications_402656534(
    name: "deleteApplications", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteApplications",
    validator: validate_DeleteApplications_402656535, base: "/",
    makeUrl: url_DeleteApplications_402656536,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTags_402656549 = ref object of OpenApiRestCall_402656044
proc url_DeleteTags_402656551(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteTags_402656550(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656561: Call_DeleteTags_402656549; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the association between configuration items and one or more tags. This API accepts a list of multiple configuration items.
                                                                                         ## 
...
proc call*(call_402656562: Call_DeleteTags_402656549; body: JsonNode): Recallable =
  ## deleteTags
  ## Deletes the association between configuration items and one or more tags. This API accepts a list of multiple configuration items.
  ##   
                                                                                                                                       ## body: JObject (required)
...
var deleteTags* = Call_DeleteTags_402656549(name: "deleteTags",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteTags",
    validator: validate_DeleteTags_402656550, base: "/",
    makeUrl: url_DeleteTags_402656551, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAgents_402656564 = ref object of OpenApiRestCall_402656044
proc url_DescribeAgents_402656566(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAgents_402656565(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656576: Call_DescribeAgents_402656564; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists agents or connectors as specified by ID or other filters. All agents/connectors associated with your user account can be listed if you call <code>DescribeAgents</code> as is without passing any parameters.
                                                                                         ## 
...
proc call*(call_402656577: Call_DescribeAgents_402656564; body: JsonNode): Recallable =
  ## describeAgents
  ## Lists agents or connectors as specified by ID or other filters. All agents/connectors associated with your user account can be listed if you call <code>DescribeAgents</code> as is without passing any parameters.
  ##   
                                                                                                                                                                                                                        ## body: JObject (required)
...
var describeAgents* = Call_DescribeAgents_402656564(name: "describeAgents",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeAgents",
    validator: validate_DescribeAgents_402656565, base: "/",
    makeUrl: url_DescribeAgents_402656566, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConfigurations_402656579 = ref object of OpenApiRestCall_402656044
proc url_DescribeConfigurations_402656581(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeConfigurations_402656580(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656591: Call_DescribeConfigurations_402656579;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves attributes for a list of configuration item IDs.</p> <note> <p>All of the supplied IDs must be for the same asset type from one of the following:</p> <ul> <li> <p>server</p> </li> <li> <p>application</p> </li> <li> <p>process</p> </li> <li> <p>connection</p> </li> </ul> <p>Output fields are specific to the asset type specified. For example, the output for a <i>server</i> configuration item includes a list of attributes about the server, such as host name, operating system, number of network cards, etc.</p> <p>For a complete list of outputs for each asset type, see <a href="https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-api-queries.html#DescribeConfigurations">Using the DescribeConfigurations Action</a> in the <i>AWS Application Discovery Service User Guide</i>.</p> </note>
                                                                                         ## 
...
proc call*(call_402656592: Call_DescribeConfigurations_402656579; body: JsonNode): Recallable =
...
var describeConfigurations* = Call_DescribeConfigurations_402656579(
    ...
    validator: validate_DescribeConfigurations_402656580, base: "/",
    makeUrl: url_DescribeConfigurations_402656581,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeContinuousExports_402656594 = ref object of OpenApiRestCall_402656044
proc url_DescribeContinuousExports_402656596(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeContinuousExports_402656595(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656608: Call_DescribeContinuousExports_402656594;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists exports as specified by ID. All continuous exports associated with your user account can be listed if you call <code>DescribeContinuousExports</code> as is without passing any parameters.
                                                                                         ## 
...
proc call*(call_402656609: Call_DescribeContinuousExports_402656594;
...
var describeContinuousExports* = Call_DescribeContinuousExports_402656594(
    ...
    validator: validate_DescribeContinuousExports_402656595, base: "/",
    makeUrl: url_DescribeContinuousExports_402656596,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeExportConfigurations_402656612 = ref object of OpenApiRestCall_402656044
proc url_DescribeExportConfigurations_402656614(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeExportConfigurations_402656613(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656624: Call_DescribeExportConfigurations_402656612;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  <code>DescribeExportConfigurations</code> is deprecated. Use <a href="https://docs.aws.amazon.com/application-discovery/latest/APIReference/API_DescribeExportTasks.html">DescribeImportTasks</a>, instead.
                                                                                         ## 
...
proc call*(call_402656625: Call_DescribeExportConfigurations_402656612;
           body: JsonNode): Recallable =
...
var describeExportConfigurations* = Call_DescribeExportConfigurations_402656612(
    ...
    validator: validate_DescribeExportConfigurations_402656613, base: "/",
    makeUrl: url_DescribeExportConfigurations_402656614,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeExportTasks_402656627 = ref object of OpenApiRestCall_402656044
proc url_DescribeExportTasks_402656629(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeExportTasks_402656628(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656639: Call_DescribeExportTasks_402656627;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieve status of one or more export tasks. You can retrieve the status of up to 100 export tasks.
                                                                                         ## 
...
proc call*(call_402656640: Call_DescribeExportTasks_402656627; body: JsonNode): Recallable =
  ## describeExportTasks
  ## Retrieve status of one or more export tasks. You can retrieve the status of up to 100 export tasks.
  ##   
                                                                                                        ## body: JObject (required)
...
var describeExportTasks* = Call_DescribeExportTasks_402656627(
    name: "describeExportTasks", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportTasks",
    validator: validate_DescribeExportTasks_402656628, base: "/",
    makeUrl: url_DescribeExportTasks_402656629,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeImportTasks_402656642 = ref object of OpenApiRestCall_402656044
proc url_DescribeImportTasks_402656644(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeImportTasks_402656643(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656656: Call_DescribeImportTasks_402656642;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns an array of import tasks for your account, including status information, times, IDs, the Amazon S3 Object URL for the import file, and more.
                                                                                         ## 
...
proc call*(call_402656657: Call_DescribeImportTasks_402656642; body: JsonNode;
...
var describeImportTasks* = Call_DescribeImportTasks_402656642(
    name: "describeImportTasks", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeImportTasks",
    validator: validate_DescribeImportTasks_402656643, base: "/",
    makeUrl: url_DescribeImportTasks_402656644,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTags_402656660 = ref object of OpenApiRestCall_402656044
proc url_DescribeTags_402656662(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeTags_402656661(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656672: Call_DescribeTags_402656660; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves a list of configuration items that have tags as specified by the key-value pairs, name and value, passed to the optional parameter <code>filters</code>.</p> <p>There are three valid tag filter names:</p> <ul> <li> <p>tagKey</p> </li> <li> <p>tagValue</p> </li> <li> <p>configurationId</p> </li> </ul> <p>Also, all configuration items associated with your user account that have tags can be listed if you call <code>DescribeTags</code> as is without passing any parameters.</p>
                                                                                         ## 
...
proc call*(call_402656673: Call_DescribeTags_402656660; body: JsonNode): Recallable =
  ## describeTags
  ## <p>Retrieves a list of configuration items that have tags as specified by the key-value pairs, name and value, passed to the optional parameter <code>filters</code>.</p> <p>There are three valid tag filter names:</p> <ul> <li> <p>tagKey</p> </li> <li> <p>tagValue</p> </li> <li> <p>configurationId</p> </li> </ul> <p>Also, all configuration items associated with your user account that have tags can be listed if you call <code>DescribeTags</code> as is without passing any parameters.</p>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ## body: JObject (required)
...
var describeTags* = Call_DescribeTags_402656660(name: "describeTags",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeTags",
    validator: validate_DescribeTags_402656661, base: "/",
    makeUrl: url_DescribeTags_402656662, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateConfigurationItemsFromApplication_402656675 = ref object of OpenApiRestCall_402656044
proc url_DisassociateConfigurationItemsFromApplication_402656677(
...
proc validate_DisassociateConfigurationItemsFromApplication_402656676(
  ...
  valid_402656678 = validateParameter(valid_402656678, JString, required = true, default = newJString("AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication"))
...
proc call*(call_402656687: Call_DisassociateConfigurationItemsFromApplication_402656675;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Disassociates one or more configuration items from an application.
                                                                                         ## 
...
proc call*(call_402656688: Call_DisassociateConfigurationItemsFromApplication_402656675;
           body: JsonNode): Recallable =
...
var disassociateConfigurationItemsFromApplication* = Call_DisassociateConfigurationItemsFromApplication_402656675(
    ...
    validator: validate_DisassociateConfigurationItemsFromApplication_402656676,
    base: "/", makeUrl: url_DisassociateConfigurationItemsFromApplication_402656677,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ExportConfigurations_402656690 = ref object of OpenApiRestCall_402656044
proc url_ExportConfigurations_402656692(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ExportConfigurations_402656691(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656701: Call_ExportConfigurations_402656690;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deprecated. Use <code>StartExportTask</code> instead.</p> <p>Exports all discovered configuration data to an Amazon S3 bucket or an application that enables you to view and evaluate the data. Data includes tags and tag associations, processes, connections, servers, and system performance. This API returns an export ID that you can query using the <i>DescribeExportConfigurations</i> API. The system imposes a limit of two configuration exports in six hours.</p>
                                                                                         ## 
...
proc call*(call_402656702: Call_ExportConfigurations_402656690): Recallable =
  ## exportConfigurations
  ## <p>Deprecated. Use <code>StartExportTask</code> instead.</p> <p>Exports all discovered configuration data to an Amazon S3 bucket or an application that enables you to view and evaluate the data. Data includes tags and tag associations, processes, connections, servers, and system performance. This API returns an export ID that you can query using the <i>DescribeExportConfigurations</i> API. The system imposes a limit of two configuration exports in six hours.</p>
  result = call_402656702.call(nil, nil, nil, nil, nil)

var exportConfigurations* = Call_ExportConfigurations_402656690(
    ...
    validator: validate_ExportConfigurations_402656691, base: "/",
    makeUrl: url_ExportConfigurations_402656692,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDiscoverySummary_402656703 = ref object of OpenApiRestCall_402656044
proc url_GetDiscoverySummary_402656705(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetDiscoverySummary_402656704(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656706 = header.getOrDefault("X-Amz-Target")
  valid_402656706 = validateParameter(valid_402656706, JString, required = true, default = newJString(
      "AWSPoseidonService_V2015_11_01.GetDiscoverySummary"))
  if valid_402656706 != nil:
    section.add "X-Amz-Target", valid_402656706
  var valid_402656707 = header.getOrDefault("X-Amz-Security-Token")
  valid_402656707 = validateParameter(valid_402656707, JString,
                                      required = false, default = nil)
  if valid_402656707 != nil:
    section.add "X-Amz-Security-Token", valid_402656707
  var valid_402656708 = header.getOrDefault("X-Amz-Signature")
  valid_402656708 = validateParameter(valid_402656708, JString,
                                      required = false, default = nil)
  if valid_402656708 != nil:
    section.add "X-Amz-Signature", valid_402656708
  var valid_402656709 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_402656709 = validateParameter(valid_402656709, JString,
                                      required = false, default = nil)
  if valid_402656709 != nil:
    section.add "X-Amz-Content-Sha256", valid_402656709
  var valid_402656710 = header.getOrDefault("X-Amz-Algorithm")
  valid_402656710 = validateParameter(valid_402656710, JString,
                                      required = false, default = nil)
  if valid_402656710 != nil:
    section.add "X-Amz-Algorithm", valid_402656710
  var valid_402656711 = header.getOrDefault("X-Amz-Date")
  valid_402656711 = validateParameter(valid_402656711, JString,
                                      required = false, default = nil)
  if valid_402656711 != nil:
    section.add "X-Amz-Date", valid_402656711
  var valid_402656712 = header.getOrDefault("X-Amz-Credential")
  valid_402656712 = validateParameter(valid_402656712, JString,
                                      required = false, default = nil)
  if valid_402656712 != nil:
    section.add "X-Amz-Credential", valid_402656712
  var valid_402656713 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_402656713 = validateParameter(valid_402656713, JString,
                                      required = false, default = nil)
  if valid_402656713 != nil:
    section.add "X-Amz-SignedHeaders", valid_402656713
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_402656715: Call_GetDiscoverySummary_402656703;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves a short summary of discovered assets.</p> <p>This API operation takes no request parameters and is called as is at the command prompt as shown in the example.</p>
                                                                                         ## 
  let valid = call_402656715.validator(path, query, header, formData, body, _)
  let scheme = call_402656715.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402656715.makeUrl(scheme.get, call_402656715.host, call_402656715.base,
                                   call_402656715.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402656715, uri, valid, _)

proc call*(call_402656716: Call_GetDiscoverySummary_402656703; body: JsonNode): Recallable =
  ## getDiscoverySummary
  ## <p>Retrieves a short summary of discovered assets.</p> <p>This API operation takes no request parameters and is called as is at the command prompt as shown in the example.</p>
  ##   
                                                                                                                                                                                    ## body: JObject (required)
  ...
  if body != nil:
    body_402656717 = body
  result = call_402656716.call(nil, nil, nil, nil, body_402656717)

var getDiscoverySummary* = Call_GetDiscoverySummary_402656703(
    name: "getDiscoverySummary", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.GetDiscoverySummary",
    validator: validate_GetDiscoverySummary_402656704, base: "/",
    makeUrl: url_GetDiscoverySummary_402656705,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListConfigurations_402656718 = ref object of OpenApiRestCall_402656044
proc url_ListConfigurations_402656720(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListConfigurations_402656719(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656730: Call_ListConfigurations_402656718;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieves a list of configuration items as specified by the value passed to the required parameter <code>configurationType</code>. Optional filtering may be applied to refine search results.
                                                                                         ## 
...
proc call*(call_402656731: Call_ListConfigurations_402656718; body: JsonNode): Recallable =
  ## listConfigurations
  ## Retrieves a list of configuration items as specified by the value passed to the required parameter <code>configurationType</code>. Optional filtering may be applied to refine search results.
  ##   
                                                                                                                                                                                                   ## body: JObject (required)
...
var listConfigurations* = Call_ListConfigurations_402656718(
    name: "listConfigurations", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListConfigurations",
    validator: validate_ListConfigurations_402656719, base: "/",
    makeUrl: url_ListConfigurations_402656720,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListServerNeighbors_402656733 = ref object of OpenApiRestCall_402656044
proc url_ListServerNeighbors_402656735(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListServerNeighbors_402656734(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656745: Call_ListServerNeighbors_402656733;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieves a list of servers that are one network hop away from a specified server.
                                                                                         ## 
...
proc call*(call_402656746: Call_ListServerNeighbors_402656733; body: JsonNode): Recallable =
  ## listServerNeighbors
  ## Retrieves a list of servers that are one network hop away from a specified server.
  ##   
                                                                                       ## body: JObject (required)
...
var listServerNeighbors* = Call_ListServerNeighbors_402656733(
    name: "listServerNeighbors", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListServerNeighbors",
    validator: validate_ListServerNeighbors_402656734, base: "/",
    makeUrl: url_ListServerNeighbors_402656735,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartContinuousExport_402656748 = ref object of OpenApiRestCall_402656044
proc url_StartContinuousExport_402656750(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartContinuousExport_402656749(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656760: Call_StartContinuousExport_402656748;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Start the continuous flow of agent's discovered data into Amazon Athena.
                                                                                         ## 
...
proc call*(call_402656761: Call_StartContinuousExport_402656748; body: JsonNode): Recallable =
...
var startContinuousExport* = Call_StartContinuousExport_402656748(
    ...
    validator: validate_StartContinuousExport_402656749, base: "/",
    makeUrl: url_StartContinuousExport_402656750,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartDataCollectionByAgentIds_402656763 = ref object of OpenApiRestCall_402656044
proc url_StartDataCollectionByAgentIds_402656765(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartDataCollectionByAgentIds_402656764(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656766 = header.getOrDefault("X-Amz-Target")
  valid_402656766 = validateParameter(valid_402656766, JString, required = true, default = newJString(
      "AWSPoseidonService_V2015_11_01.StartDataCollectionByAgentIds"))
  if valid_402656766 != nil:
    section.add "X-Amz-Target", valid_402656766
...
proc call*(call_402656775: Call_StartDataCollectionByAgentIds_402656763;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Instructs the specified agents or connectors to start collecting data.
                                                                                         ## 
  let valid = call_402656775.validator(path, query, header, formData, body, _)
  let scheme = call_402656775.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402656775.makeUrl(scheme.get, call_402656775.host, call_402656775.base,
                                   call_402656775.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402656775, uri, valid, _)

proc call*(call_402656776: Call_StartDataCollectionByAgentIds_402656763;
           body: JsonNode): Recallable =
  ...
  if body != nil:
    body_402656777 = body
  result = call_402656776.call(nil, nil, nil, nil, body_402656777)

var startDataCollectionByAgentIds* = Call_StartDataCollectionByAgentIds_402656763(
    ...
    validator: validate_StartDataCollectionByAgentIds_402656764, base: "/",
    makeUrl: url_StartDataCollectionByAgentIds_402656765,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartExportTask_402656778 = ref object of OpenApiRestCall_402656044
proc url_StartExportTask_402656780(protocol: Scheme; host: string; base: string;
...
proc validate_StartExportTask_402656779(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656790: Call_StartExportTask_402656778; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> Begins the export of discovered data to an S3 bucket.</p> <p> If you specify <code>agentIds</code> in a filter, the task exports up to 72 hours of detailed data collected by the identified Application Discovery Agent, including network, process, and performance details. A time range for exported agent data may be set by using <code>startTime</code> and <code>endTime</code>. Export of detailed agent data is limited to five concurrently running exports. </p> <p> If you do not include an <code>agentIds</code> filter, summary data is exported that includes both AWS Agentless Discovery Connector data and summary data from AWS Discovery Agents. Export of summary data is limited to two exports per day. </p>
                                                                                         ## 
...
proc call*(call_402656791: Call_StartExportTask_402656778; body: JsonNode): Recallable =
  ## startExportTask
  ## <p> Begins the export of discovered data to an S3 bucket.</p> <p> If you specify <code>agentIds</code> in a filter, the task exports up to 72 hours of detailed data collected by the identified Application Discovery Agent, including network, process, and performance details. A time range for exported agent data may be set by using <code>startTime</code> and <code>endTime</code>. Export of detailed agent data is limited to five concurrently running exports. </p> <p> If you do not include an <code>agentIds</code> filter, summary data is exported that includes both AWS Agentless Discovery Connector data and summary data from AWS Discovery Agents. Export of summary data is limited to two exports per day. </p>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ## body: JObject (required)
  var body_402656792 = newJObject()
  if body != nil:
    body_402656792 = body
  result = call_402656791.call(nil, nil, nil, nil, body_402656792)

var startExportTask* = Call_StartExportTask_402656778(name: "startExportTask",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartExportTask",
    validator: validate_StartExportTask_402656779, base: "/",
    makeUrl: url_StartExportTask_402656780, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartImportTask_402656793 = ref object of OpenApiRestCall_402656044
proc url_StartImportTask_402656795(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode;
                                   query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StartImportTask_402656794(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656796 = header.getOrDefault("X-Amz-Target")
  valid_402656796 = validateParameter(valid_402656796, JString, required = true, default = newJString(
      "AWSPoseidonService_V2015_11_01.StartImportTask"))
  if valid_402656796 != nil:
    section.add "X-Amz-Target", valid_402656796
...
proc call*(call_402656805: Call_StartImportTask_402656793; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Starts an import task, which allows you to import details of your on-premises environment directly into AWS Migration Hub without having to use the Application Discovery Service (ADS) tools such as the Discovery Connector or Discovery Agent. This gives you the option to perform migration assessment and planning directly from your imported data, including the ability to group your devices as applications and track their migration status.</p> <p>To start an import request, do this:</p> <ol> <li> <p>Download the specially formatted comma separated value (CSV) import template, which you can find here: <a href="https://s3-us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv">https://s3-us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv</a>.</p> </li> <li> <p>Fill out the template with your server and application data.</p> </li> <li> <p>Upload your import file to an Amazon S3 bucket, and make a note of it's Object URL. Your import file must be in the CSV format.</p> </li> <li> <p>Use the console or the <code>StartImportTask</code> command with the AWS CLI or one of the AWS SDKs to import the records from your file.</p> </li> </ol> <p>For more information, including step-by-step procedures, see <a href="https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-import.html">Migration Hub Import</a> in the <i>AWS Application Discovery Service User Guide</i>.</p> <note> <p>There are limits to the number of import tasks you can create (and delete) in an AWS account. For more information, see <a href="https://docs.aws.amazon.com/application-discovery/latest/userguide/ads_service_limits.html">AWS Application Discovery Service Limits</a> in the <i>AWS Application Discovery Service User Guide</i>.</p> </note>
                                                                                         ## 
...
proc call*(call_402656806: Call_StartImportTask_402656793; body: JsonNode): Recallable =
  ## startImportTask
  ## <p>Starts an import task, which allows you to import details of your on-premises environment directly into AWS Migration Hub without having to use the Application Discovery Service (ADS) tools such as the Discovery Connector or Discovery Agent. This gives you the option to perform migration assessment and planning directly from your imported data, including the ability to group your devices as applications and track their migration status.</p> <p>To start an import request, do this:</p> <ol> <li> <p>Download the specially formatted comma separated value (CSV) import template, which you can find here: <a href="https://s3-us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv">https://s3-us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv</a>.</p> </li> <li> <p>Fill out the template with your server and application data.</p> </li> <li> <p>Upload your import file to an Amazon S3 bucket, and make a note of it's Object URL. Your import file must be in the CSV format.</p> </li> <li> <p>Use the console or the <code>StartImportTask</code> command with the AWS CLI or one of the AWS SDKs to import the records from your file.</p> </li> </ol> <p>For more information, including step-by-step procedures, see <a href="https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-import.html">Migration Hub Import</a> in the <i>AWS Application Discovery Service User Guide</i>.</p> <note> <p>There are limits to the number of import tasks you can create (and delete) in an AWS account. For more information, see <a href="https://docs.aws.amazon.com/application-discovery/latest/userguide/ads_service_limits.html">AWS Application Discovery Service Limits</a> in the <i>AWS Application Discovery Service User Guide</i>.</p> </note>
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ## body: JObject (required)
  ...
  if body != nil:
    body_402656807 = body
  result = call_402656806.call(nil, nil, nil, nil, body_402656807)

var startImportTask* = Call_StartImportTask_402656793(name: "startImportTask",
    meth: HttpMethod.HttpPost, host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartImportTask",
    validator: validate_StartImportTask_402656794, base: "/",
    makeUrl: url_StartImportTask_402656795, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopContinuousExport_402656808 = ref object of OpenApiRestCall_402656044
proc url_StopContinuousExport_402656810(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StopContinuousExport_402656809(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656811 = header.getOrDefault("X-Amz-Target")
  valid_402656811 = validateParameter(valid_402656811, JString, required = true, default = newJString(
      "AWSPoseidonService_V2015_11_01.StopContinuousExport"))
  if valid_402656811 != nil:
    section.add "X-Amz-Target", valid_402656811
...
proc call*(call_402656820: Call_StopContinuousExport_402656808;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Stop the continuous flow of agent's discovered data into Amazon Athena.
                                                                                         ## 
...
proc call*(call_402656821: Call_StopContinuousExport_402656808; body: JsonNode): Recallable =
  ## stopContinuousExport
  ## Stop the continuous flow of agent's discovered data into Amazon Athena.
  ##   
                                                                            ## body: JObject (required)
  var body_402656822 = newJObject()
  if body != nil:
    body_402656822 = body
  result = call_402656821.call(nil, nil, nil, nil, body_402656822)

var stopContinuousExport* = Call_StopContinuousExport_402656808(
    ...
    validator: validate_StopContinuousExport_402656809, base: "/",
    makeUrl: url_StopContinuousExport_402656810,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopDataCollectionByAgentIds_402656823 = ref object of OpenApiRestCall_402656044
proc url_StopDataCollectionByAgentIds_402656825(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopDataCollectionByAgentIds_402656824(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656826 = header.getOrDefault("X-Amz-Target")
  valid_402656826 = validateParameter(valid_402656826, JString, required = true, default = newJString(
      "AWSPoseidonService_V2015_11_01.StopDataCollectionByAgentIds"))
  if valid_402656826 != nil:
    section.add "X-Amz-Target", valid_402656826
...
proc call*(call_402656835: Call_StopDataCollectionByAgentIds_402656823;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Instructs the specified agents or connectors to stop collecting data.
                                                                                         ## 
  let valid = call_402656835.validator(path, query, header, formData, body, _)
  let scheme = call_402656835.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402656835.makeUrl(scheme.get, call_402656835.host, call_402656835.base,
                                   call_402656835.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402656835, uri, valid, _)

proc call*(call_402656836: Call_StopDataCollectionByAgentIds_402656823;
           body: JsonNode): Recallable =
  ## stopDataCollectionByAgentIds
  ## Instructs the specified agents or connectors to stop collecting data.
  ##   body: 
                                                                          ## JObject (required)
  var body_402656837 = newJObject()
  if body != nil:
    body_402656837 = body
  result = call_402656836.call(nil, nil, nil, nil, body_402656837)

var stopDataCollectionByAgentIds* = Call_StopDataCollectionByAgentIds_402656823(
    ...
    validator: validate_StopDataCollectionByAgentIds_402656824, base: "/",
    makeUrl: url_StopDataCollectionByAgentIds_402656825,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateApplication_402656838 = ref object of OpenApiRestCall_402656044
proc url_UpdateApplication_402656840(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateApplication_402656839(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402656841 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_402656841 != nil:
    section.add "X-Amz-Target", valid_402656841
...
proc call*(call_402656850: Call_UpdateApplication_402656838;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates metadata about an application.
                                                                                         ## 
...
proc call*(call_402656851: Call_UpdateApplication_402656838; body: JsonNode): Recallable =
  ## updateApplication
  ## Updates metadata about an application.
  ##   body: JObject (required)
  var body_402656852 = newJObject()
  if body != nil:
    body_402656852 = body
  result = call_402656851.call(nil, nil, nil, nil, body_402656852)

var updateApplication* = Call_UpdateApplication_402656838(
    name: "updateApplication", meth: HttpMethod.HttpPost,
    host: "discovery.amazonaws.com",
    route: "/#X-Amz-Target=AWSPoseidonService_V2015_11_01.UpdateApplication",
    validator: validate_UpdateApplication_402656839, base: "/",
    makeUrl: url_UpdateApplication_402656840,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
