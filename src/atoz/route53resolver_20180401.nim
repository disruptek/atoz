...
type
  Call_AssociateResolverEndpointIpAddress_602770 = ref object of OpenApiRestCall_602433
proc url_AssociateResolverEndpointIpAddress_602772(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateResolverEndpointIpAddress_602771(path: JsonNode;
...
proc call*(call_602928: Call_AssociateResolverEndpointIpAddress_602770;
...
proc call*(call_602999: Call_AssociateResolverEndpointIpAddress_602770;
          body: JsonNode): Recallable =
...
var associateResolverEndpointIpAddress* = Call_AssociateResolverEndpointIpAddress_602770(
    ...
    validator: validate_AssociateResolverEndpointIpAddress_602771, base: "/",
    url: url_AssociateResolverEndpointIpAddress_602772,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateResolverRule_603039 = ref object of OpenApiRestCall_602433
proc url_AssociateResolverRule_603041(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_AssociateResolverRule_603040(path: JsonNode; query: JsonNode;
...
proc call*(call_603051: Call_AssociateResolverRule_603039; path: JsonNode;
...
proc call*(call_603052: Call_AssociateResolverRule_603039; body: JsonNode): Recallable =
...
var associateResolverRule* = Call_AssociateResolverRule_603039(
    name: "associateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.AssociateResolverRule",
    validator: validate_AssociateResolverRule_603040, base: "/",
    url: url_AssociateResolverRule_603041, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResolverEndpoint_603054 = ref object of OpenApiRestCall_602433
proc url_CreateResolverEndpoint_603056(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateResolverEndpoint_603055(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603066: Call_CreateResolverEndpoint_603054; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a resolver endpoint. There are two types of resolver endpoints, inbound and outbound:</p> <ul> <li> <p>An <i>inbound resolver endpoint</i> forwards DNS queries to the DNS service for a VPC from your network or another VPC.</p> </li> <li> <p>An <i>outbound resolver endpoint</i> forwards DNS queries from the DNS service for a VPC to your network or another VPC.</p> </li> </ul>
  ## 
...
proc call*(call_603067: Call_CreateResolverEndpoint_603054; body: JsonNode): Recallable =
...
var createResolverEndpoint* = Call_CreateResolverEndpoint_603054(
    name: "createResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.CreateResolverEndpoint",
    validator: validate_CreateResolverEndpoint_603055, base: "/",
    url: url_CreateResolverEndpoint_603056, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResolverRule_603069 = ref object of OpenApiRestCall_602433
proc url_CreateResolverRule_603071(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateResolverRule_603070(path: JsonNode; query: JsonNode;
...
proc call*(call_603081: Call_CreateResolverRule_603069; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## For DNS queries that originate in your VPCs, specifies which resolver endpoint the queries pass through, one domain name that you want to forward to your network, and the IP addresses of the DNS resolvers in your network.
  ## 
...
proc call*(call_603082: Call_CreateResolverRule_603069; body: JsonNode): Recallable =
  ## createResolverRule
  ## For DNS queries that originate in your VPCs, specifies which resolver endpoint the queries pass through, one domain name that you want to forward to your network, and the IP addresses of the DNS resolvers in your network.
  ##   body: JObject (required)
...
var createResolverRule* = Call_CreateResolverRule_603069(
    name: "createResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.CreateResolverRule",
    validator: validate_CreateResolverRule_603070, base: "/",
    url: url_CreateResolverRule_603071, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResolverEndpoint_603084 = ref object of OpenApiRestCall_602433
proc url_DeleteResolverEndpoint_603086(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteResolverEndpoint_603085(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603096: Call_DeleteResolverEndpoint_603084; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a resolver endpoint. The effect of deleting a resolver endpoint depends on whether it's an inbound or an outbound resolver endpoint:</p> <ul> <li> <p> <b>Inbound</b>: DNS queries from your network or another VPC are no longer routed to the DNS service for the specified VPC.</p> </li> <li> <p> <b>Outbound</b>: DNS queries from a VPC are no longer routed to your network or to another VPC.</p> </li> </ul>
  ## 
...
proc call*(call_603097: Call_DeleteResolverEndpoint_603084; body: JsonNode): Recallable =
...
var deleteResolverEndpoint* = Call_DeleteResolverEndpoint_603084(
    name: "deleteResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DeleteResolverEndpoint",
    validator: validate_DeleteResolverEndpoint_603085, base: "/",
    url: url_DeleteResolverEndpoint_603086, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResolverRule_603099 = ref object of OpenApiRestCall_602433
proc url_DeleteResolverRule_603101(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteResolverRule_603100(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603111: Call_DeleteResolverRule_603099; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a resolver rule. Before you can delete a resolver rule, you must disassociate it from all the VPCs that you associated the resolver rule with. For more infomation, see <a>DisassociateResolverRule</a>.
  ## 
...
proc call*(call_603112: Call_DeleteResolverRule_603099; body: JsonNode): Recallable =
  ## deleteResolverRule
  ## Deletes a resolver rule. Before you can delete a resolver rule, you must disassociate it from all the VPCs that you associated the resolver rule with. For more infomation, see <a>DisassociateResolverRule</a>.
  ##   body: JObject (required)
...
var deleteResolverRule* = Call_DeleteResolverRule_603099(
    name: "deleteResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DeleteResolverRule",
    validator: validate_DeleteResolverRule_603100, base: "/",
    url: url_DeleteResolverRule_603101, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateResolverEndpointIpAddress_603114 = ref object of OpenApiRestCall_602433
proc url_DisassociateResolverEndpointIpAddress_603116(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateResolverEndpointIpAddress_603115(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603126: Call_DisassociateResolverEndpointIpAddress_603114;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Removes IP addresses from an inbound or an outbound resolver endpoint. If you want to remove more than one IP address, submit one <code>DisassociateResolverEndpointIpAddress</code> request for each IP address.</p> <p>To add an IP address to an endpoint, see <a>AssociateResolverEndpointIpAddress</a>.</p>
  ## 
...
proc call*(call_603127: Call_DisassociateResolverEndpointIpAddress_603114;
          body: JsonNode): Recallable =
...
var disassociateResolverEndpointIpAddress* = Call_DisassociateResolverEndpointIpAddress_603114(
    ...
    validator: validate_DisassociateResolverEndpointIpAddress_603115, base: "/",
    url: url_DisassociateResolverEndpointIpAddress_603116,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateResolverRule_603129 = ref object of OpenApiRestCall_602433
proc url_DisassociateResolverRule_603131(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DisassociateResolverRule_603130(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603141: Call_DisassociateResolverRule_603129; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Removes the association between a specified resolver rule and a specified VPC.</p> <important> <p>If you disassociate a resolver rule from a VPC, Resolver stops forwarding DNS queries for the domain name that you specified in the resolver rule. </p> </important>
  ## 
...
proc call*(call_603142: Call_DisassociateResolverRule_603129; body: JsonNode): Recallable =
...
var disassociateResolverRule* = Call_DisassociateResolverRule_603129(
    name: "disassociateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DisassociateResolverRule",
    validator: validate_DisassociateResolverRule_603130, base: "/",
    url: url_DisassociateResolverRule_603131, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverEndpoint_603144 = ref object of OpenApiRestCall_602433
proc url_GetResolverEndpoint_603146(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetResolverEndpoint_603145(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603156: Call_GetResolverEndpoint_603144; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about a specified resolver endpoint, such as whether it's an inbound or an outbound resolver endpoint, and the current status of the endpoint.
  ## 
...
proc call*(call_603157: Call_GetResolverEndpoint_603144; body: JsonNode): Recallable =
  ## getResolverEndpoint
  ## Gets information about a specified resolver endpoint, such as whether it's an inbound or an outbound resolver endpoint, and the current status of the endpoint.
  ##   body: JObject (required)
...
var getResolverEndpoint* = Call_GetResolverEndpoint_603144(
    name: "getResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverEndpoint",
    validator: validate_GetResolverEndpoint_603145, base: "/",
    url: url_GetResolverEndpoint_603146, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRule_603159 = ref object of OpenApiRestCall_602433
proc url_GetResolverRule_603161(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetResolverRule_603160(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_603171: Call_GetResolverRule_603159; path: JsonNode; query: JsonNode;
...
proc call*(call_603172: Call_GetResolverRule_603159; body: JsonNode): Recallable =
  ## getResolverRule
  ## Gets information about a specified resolver rule, such as the domain name that the rule forwards DNS queries for and the ID of the outbound resolver endpoint that the rule is associated with.
  ##   body: JObject (required)
...
var getResolverRule* = Call_GetResolverRule_603159(name: "getResolverRule",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRule",
    validator: validate_GetResolverRule_603160, base: "/", url: url_GetResolverRule_603161,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRuleAssociation_603174 = ref object of OpenApiRestCall_602433
proc url_GetResolverRuleAssociation_603176(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetResolverRuleAssociation_603175(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603186: Call_GetResolverRuleAssociation_603174; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about an association between a specified resolver rule and a VPC. You associate a resolver rule and a VPC using <a>AssociateResolverRule</a>. 
  ## 
...
proc call*(call_603187: Call_GetResolverRuleAssociation_603174; body: JsonNode): Recallable =
...
var getResolverRuleAssociation* = Call_GetResolverRuleAssociation_603174(
    name: "getResolverRuleAssociation", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRuleAssociation",
    validator: validate_GetResolverRuleAssociation_603175, base: "/",
    url: url_GetResolverRuleAssociation_603176,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRulePolicy_603189 = ref object of OpenApiRestCall_602433
proc url_GetResolverRulePolicy_603191(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetResolverRulePolicy_603190(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603201: Call_GetResolverRulePolicy_603189; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about a resolver rule policy. A resolver rule policy specifies the Resolver operations and resources that you want to allow another AWS account to be able to use. 
  ## 
...
proc call*(call_603202: Call_GetResolverRulePolicy_603189; body: JsonNode): Recallable =
...
var getResolverRulePolicy* = Call_GetResolverRulePolicy_603189(
    name: "getResolverRulePolicy", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRulePolicy",
    validator: validate_GetResolverRulePolicy_603190, base: "/",
    url: url_GetResolverRulePolicy_603191, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverEndpointIpAddresses_603204 = ref object of OpenApiRestCall_602433
proc url_ListResolverEndpointIpAddresses_603206(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListResolverEndpointIpAddresses_603205(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603218: Call_ListResolverEndpointIpAddresses_603204;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the IP addresses for a specified resolver endpoint.
  ## 
...
proc call*(call_603219: Call_ListResolverEndpointIpAddresses_603204;
...
var listResolverEndpointIpAddresses* = Call_ListResolverEndpointIpAddresses_603204(
    ...
    validator: validate_ListResolverEndpointIpAddresses_603205, base: "/",
    url: url_ListResolverEndpointIpAddresses_603206,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverEndpoints_603223 = ref object of OpenApiRestCall_602433
proc url_ListResolverEndpoints_603225(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListResolverEndpoints_603224(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603237: Call_ListResolverEndpoints_603223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the resolver endpoints that were created using the current AWS account.
  ## 
...
proc call*(call_603238: Call_ListResolverEndpoints_603223; body: JsonNode;
...
var listResolverEndpoints* = Call_ListResolverEndpoints_603223(
    name: "listResolverEndpoints", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListResolverEndpoints",
    validator: validate_ListResolverEndpoints_603224, base: "/",
    url: url_ListResolverEndpoints_603225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverRuleAssociations_603241 = ref object of OpenApiRestCall_602433
proc url_ListResolverRuleAssociations_603243(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListResolverRuleAssociations_603242(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603255: Call_ListResolverRuleAssociations_603241; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the associations that were created between resolver rules and VPCs using the current AWS account.
  ## 
...
proc call*(call_603256: Call_ListResolverRuleAssociations_603241; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listResolverRuleAssociations* = Call_ListResolverRuleAssociations_603241(
    ...
    validator: validate_ListResolverRuleAssociations_603242, base: "/",
    url: url_ListResolverRuleAssociations_603243,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverRules_603259 = ref object of OpenApiRestCall_602433
proc url_ListResolverRules_603261(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListResolverRules_603260(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603273: Call_ListResolverRules_603259; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the resolver rules that were created using the current AWS account.
  ## 
...
proc call*(call_603274: Call_ListResolverRules_603259; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listResolverRules
  ## Lists the resolver rules that were created using the current AWS account.
  ##   NextToken: string
...
var listResolverRules* = Call_ListResolverRules_603259(name: "listResolverRules",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListResolverRules",
    validator: validate_ListResolverRules_603260, base: "/",
    url: url_ListResolverRules_603261, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_603277 = ref object of OpenApiRestCall_602433
proc url_ListTagsForResource_603279(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListTagsForResource_603278(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603289: Call_ListTagsForResource_603277; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the tags that you associated with the specified resource.
  ## 
...
proc call*(call_603290: Call_ListTagsForResource_603277; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists the tags that you associated with the specified resource.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_603277(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListTagsForResource",
    validator: validate_ListTagsForResource_603278, base: "/",
    url: url_ListTagsForResource_603279, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutResolverRulePolicy_603292 = ref object of OpenApiRestCall_602433
proc url_PutResolverRulePolicy_603294(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_PutResolverRulePolicy_603293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603304: Call_PutResolverRulePolicy_603292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Specifies the Resolver operations and resources that you want to allow another AWS account to be able to use.
  ## 
...
proc call*(call_603305: Call_PutResolverRulePolicy_603292; body: JsonNode): Recallable =
...
var putResolverRulePolicy* = Call_PutResolverRulePolicy_603292(
    name: "putResolverRulePolicy", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.PutResolverRulePolicy",
    validator: validate_PutResolverRulePolicy_603293, base: "/",
    url: url_PutResolverRulePolicy_603294, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_603307 = ref object of OpenApiRestCall_602433
proc url_TagResource_603309(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_TagResource_603308(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603319: Call_TagResource_603307; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds one or more tags to a specified resource.
  ## 
...
proc call*(call_603320: Call_TagResource_603307; body: JsonNode): Recallable =
  ## tagResource
  ## Adds one or more tags to a specified resource.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_603307(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "route53resolver.amazonaws.com", route: "/#X-Amz-Target=Route53Resolver.TagResource",
                                        validator: validate_TagResource_603308,
                                        base: "/", url: url_TagResource_603309,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_603322 = ref object of OpenApiRestCall_602433
proc url_UntagResource_603324(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UntagResource_603323(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603334: Call_UntagResource_603322; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes one or more tags from a specified resource.
  ## 
...
proc call*(call_603335: Call_UntagResource_603322; body: JsonNode): Recallable =
  ## untagResource
  ## Removes one or more tags from a specified resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_603322(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UntagResource",
    validator: validate_UntagResource_603323, base: "/", url: url_UntagResource_603324,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResolverEndpoint_603337 = ref object of OpenApiRestCall_602433
proc url_UpdateResolverEndpoint_603339(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateResolverEndpoint_603338(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603349: Call_UpdateResolverEndpoint_603337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the name of an inbound or an outbound resolver endpoint. 
  ## 
...
proc call*(call_603350: Call_UpdateResolverEndpoint_603337; body: JsonNode): Recallable =
...
var updateResolverEndpoint* = Call_UpdateResolverEndpoint_603337(
    name: "updateResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UpdateResolverEndpoint",
    validator: validate_UpdateResolverEndpoint_603338, base: "/",
    url: url_UpdateResolverEndpoint_603339, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResolverRule_603352 = ref object of OpenApiRestCall_602433
proc url_UpdateResolverRule_603354(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateResolverRule_603353(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603364: Call_UpdateResolverRule_603352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates settings for a specified resolver rule. <code>ResolverRuleId</code> is required, and all other parameters are optional. If you don't specify a parameter, it retains its current value.
  ## 
...
proc call*(call_603365: Call_UpdateResolverRule_603352; body: JsonNode): Recallable =
  ## updateResolverRule
  ## Updates settings for a specified resolver rule. <code>ResolverRuleId</code> is required, and all other parameters are optional. If you don't specify a parameter, it retains its current value.
  ##   body: JObject (required)
...
var updateResolverRule* = Call_UpdateResolverRule_603352(
    name: "updateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UpdateResolverRule",
    validator: validate_UpdateResolverRule_603353, base: "/",
    url: url_UpdateResolverRule_603354, schemes: {Scheme.Https, Scheme.Http})
export
  rest
