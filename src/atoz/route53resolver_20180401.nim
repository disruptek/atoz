...
type
  Call_AssociateResolverEndpointIpAddress_610996 = ref object of OpenApiRestCall_610658
proc url_AssociateResolverEndpointIpAddress_610998(protocol: Scheme; host: string;
...
proc validate_AssociateResolverEndpointIpAddress_610997(path: JsonNode;
...
proc call*(call_611154: Call_AssociateResolverEndpointIpAddress_610996;
...
proc call*(call_611225: Call_AssociateResolverEndpointIpAddress_610996;
          body: JsonNode): Recallable =
...
var associateResolverEndpointIpAddress* = Call_AssociateResolverEndpointIpAddress_610996(
    ...
    validator: validate_AssociateResolverEndpointIpAddress_610997, base: "/",
    url: url_AssociateResolverEndpointIpAddress_610998,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateResolverRule_611265 = ref object of OpenApiRestCall_610658
proc url_AssociateResolverRule_611267(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateResolverRule_611266(path: JsonNode; query: JsonNode;
...
proc call*(call_611277: Call_AssociateResolverRule_611265; path: JsonNode;
...
proc call*(call_611278: Call_AssociateResolverRule_611265; body: JsonNode): Recallable =
...
var associateResolverRule* = Call_AssociateResolverRule_611265(
    name: "associateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.AssociateResolverRule",
    validator: validate_AssociateResolverRule_611266, base: "/",
    url: url_AssociateResolverRule_611267, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResolverEndpoint_611280 = ref object of OpenApiRestCall_610658
proc url_CreateResolverEndpoint_611282(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateResolverEndpoint_611281(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611292: Call_CreateResolverEndpoint_611280; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a resolver endpoint. There are two types of resolver endpoints, inbound and outbound:</p> <ul> <li> <p>An <i>inbound resolver endpoint</i> forwards DNS queries to the DNS service for a VPC from your network or another VPC.</p> </li> <li> <p>An <i>outbound resolver endpoint</i> forwards DNS queries from the DNS service for a VPC to your network or another VPC.</p> </li> </ul>
  ## 
...
proc call*(call_611293: Call_CreateResolverEndpoint_611280; body: JsonNode): Recallable =
...
var createResolverEndpoint* = Call_CreateResolverEndpoint_611280(
    name: "createResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.CreateResolverEndpoint",
    validator: validate_CreateResolverEndpoint_611281, base: "/",
    url: url_CreateResolverEndpoint_611282, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResolverRule_611295 = ref object of OpenApiRestCall_610658
proc url_CreateResolverRule_611297(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateResolverRule_611296(path: JsonNode; query: JsonNode;
...
proc call*(call_611307: Call_CreateResolverRule_611295; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## For DNS queries that originate in your VPCs, specifies which resolver endpoint the queries pass through, one domain name that you want to forward to your network, and the IP addresses of the DNS resolvers in your network.
  ## 
...
proc call*(call_611308: Call_CreateResolverRule_611295; body: JsonNode): Recallable =
  ## createResolverRule
  ## For DNS queries that originate in your VPCs, specifies which resolver endpoint the queries pass through, one domain name that you want to forward to your network, and the IP addresses of the DNS resolvers in your network.
  ##   body: JObject (required)
...
var createResolverRule* = Call_CreateResolverRule_611295(
    name: "createResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.CreateResolverRule",
    validator: validate_CreateResolverRule_611296, base: "/",
    url: url_CreateResolverRule_611297, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResolverEndpoint_611310 = ref object of OpenApiRestCall_610658
proc url_DeleteResolverEndpoint_611312(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteResolverEndpoint_611311(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611322: Call_DeleteResolverEndpoint_611310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a resolver endpoint. The effect of deleting a resolver endpoint depends on whether it's an inbound or an outbound resolver endpoint:</p> <ul> <li> <p> <b>Inbound</b>: DNS queries from your network or another VPC are no longer routed to the DNS service for the specified VPC.</p> </li> <li> <p> <b>Outbound</b>: DNS queries from a VPC are no longer routed to your network or to another VPC.</p> </li> </ul>
  ## 
...
proc call*(call_611323: Call_DeleteResolverEndpoint_611310; body: JsonNode): Recallable =
...
var deleteResolverEndpoint* = Call_DeleteResolverEndpoint_611310(
    name: "deleteResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DeleteResolverEndpoint",
    validator: validate_DeleteResolverEndpoint_611311, base: "/",
    url: url_DeleteResolverEndpoint_611312, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResolverRule_611325 = ref object of OpenApiRestCall_610658
proc url_DeleteResolverRule_611327(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteResolverRule_611326(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_611337: Call_DeleteResolverRule_611325; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a resolver rule. Before you can delete a resolver rule, you must disassociate it from all the VPCs that you associated the resolver rule with. For more infomation, see <a>DisassociateResolverRule</a>.
  ## 
...
proc call*(call_611338: Call_DeleteResolverRule_611325; body: JsonNode): Recallable =
  ## deleteResolverRule
  ## Deletes a resolver rule. Before you can delete a resolver rule, you must disassociate it from all the VPCs that you associated the resolver rule with. For more infomation, see <a>DisassociateResolverRule</a>.
  ##   body: JObject (required)
...
var deleteResolverRule* = Call_DeleteResolverRule_611325(
    name: "deleteResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DeleteResolverRule",
    validator: validate_DeleteResolverRule_611326, base: "/",
    url: url_DeleteResolverRule_611327, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateResolverEndpointIpAddress_611340 = ref object of OpenApiRestCall_610658
proc url_DisassociateResolverEndpointIpAddress_611342(protocol: Scheme;
...
proc validate_DisassociateResolverEndpointIpAddress_611341(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611352: Call_DisassociateResolverEndpointIpAddress_611340;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Removes IP addresses from an inbound or an outbound resolver endpoint. If you want to remove more than one IP address, submit one <code>DisassociateResolverEndpointIpAddress</code> request for each IP address.</p> <p>To add an IP address to an endpoint, see <a>AssociateResolverEndpointIpAddress</a>.</p>
  ## 
...
proc call*(call_611353: Call_DisassociateResolverEndpointIpAddress_611340;
          body: JsonNode): Recallable =
...
var disassociateResolverEndpointIpAddress* = Call_DisassociateResolverEndpointIpAddress_611340(
    ...
    validator: validate_DisassociateResolverEndpointIpAddress_611341, base: "/",
    url: url_DisassociateResolverEndpointIpAddress_611342,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateResolverRule_611355 = ref object of OpenApiRestCall_610658
proc url_DisassociateResolverRule_611357(protocol: Scheme; host: string;
...
proc validate_DisassociateResolverRule_611356(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611367: Call_DisassociateResolverRule_611355; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Removes the association between a specified resolver rule and a specified VPC.</p> <important> <p>If you disassociate a resolver rule from a VPC, Resolver stops forwarding DNS queries for the domain name that you specified in the resolver rule. </p> </important>
  ## 
...
proc call*(call_611368: Call_DisassociateResolverRule_611355; body: JsonNode): Recallable =
...
var disassociateResolverRule* = Call_DisassociateResolverRule_611355(
    name: "disassociateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.DisassociateResolverRule",
    validator: validate_DisassociateResolverRule_611356, base: "/",
    url: url_DisassociateResolverRule_611357, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverEndpoint_611370 = ref object of OpenApiRestCall_610658
proc url_GetResolverEndpoint_611372(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetResolverEndpoint_611371(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_611382: Call_GetResolverEndpoint_611370; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about a specified resolver endpoint, such as whether it's an inbound or an outbound resolver endpoint, and the current status of the endpoint.
  ## 
...
proc call*(call_611383: Call_GetResolverEndpoint_611370; body: JsonNode): Recallable =
  ## getResolverEndpoint
  ## Gets information about a specified resolver endpoint, such as whether it's an inbound or an outbound resolver endpoint, and the current status of the endpoint.
  ##   body: JObject (required)
...
var getResolverEndpoint* = Call_GetResolverEndpoint_611370(
    name: "getResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverEndpoint",
    validator: validate_GetResolverEndpoint_611371, base: "/",
    url: url_GetResolverEndpoint_611372, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRule_611385 = ref object of OpenApiRestCall_610658
proc url_GetResolverRule_611387(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetResolverRule_611386(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_611397: Call_GetResolverRule_611385; path: JsonNode; query: JsonNode;
...
proc call*(call_611398: Call_GetResolverRule_611385; body: JsonNode): Recallable =
  ## getResolverRule
  ## Gets information about a specified resolver rule, such as the domain name that the rule forwards DNS queries for and the ID of the outbound resolver endpoint that the rule is associated with.
  ##   body: JObject (required)
...
var getResolverRule* = Call_GetResolverRule_611385(name: "getResolverRule",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRule",
    validator: validate_GetResolverRule_611386, base: "/", url: url_GetResolverRule_611387,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRuleAssociation_611400 = ref object of OpenApiRestCall_610658
proc url_GetResolverRuleAssociation_611402(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetResolverRuleAssociation_611401(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611412: Call_GetResolverRuleAssociation_611400; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about an association between a specified resolver rule and a VPC. You associate a resolver rule and a VPC using <a>AssociateResolverRule</a>. 
  ## 
...
proc call*(call_611413: Call_GetResolverRuleAssociation_611400; body: JsonNode): Recallable =
...
var getResolverRuleAssociation* = Call_GetResolverRuleAssociation_611400(
    name: "getResolverRuleAssociation", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRuleAssociation",
    validator: validate_GetResolverRuleAssociation_611401, base: "/",
    url: url_GetResolverRuleAssociation_611402,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResolverRulePolicy_611415 = ref object of OpenApiRestCall_610658
proc url_GetResolverRulePolicy_611417(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetResolverRulePolicy_611416(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611427: Call_GetResolverRulePolicy_611415; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about a resolver rule policy. A resolver rule policy specifies the Resolver operations and resources that you want to allow another AWS account to be able to use. 
  ## 
...
proc call*(call_611428: Call_GetResolverRulePolicy_611415; body: JsonNode): Recallable =
...
var getResolverRulePolicy* = Call_GetResolverRulePolicy_611415(
    name: "getResolverRulePolicy", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.GetResolverRulePolicy",
    validator: validate_GetResolverRulePolicy_611416, base: "/",
    url: url_GetResolverRulePolicy_611417, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverEndpointIpAddresses_611430 = ref object of OpenApiRestCall_610658
proc url_ListResolverEndpointIpAddresses_611432(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResolverEndpointIpAddresses_611431(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611444: Call_ListResolverEndpointIpAddresses_611430;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the IP addresses for a specified resolver endpoint.
  ## 
...
proc call*(call_611445: Call_ListResolverEndpointIpAddresses_611430;
...
var listResolverEndpointIpAddresses* = Call_ListResolverEndpointIpAddresses_611430(
    ...
    validator: validate_ListResolverEndpointIpAddresses_611431, base: "/",
    url: url_ListResolverEndpointIpAddresses_611432,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverEndpoints_611449 = ref object of OpenApiRestCall_610658
proc url_ListResolverEndpoints_611451(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResolverEndpoints_611450(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611463: Call_ListResolverEndpoints_611449; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the resolver endpoints that were created using the current AWS account.
  ## 
...
proc call*(call_611464: Call_ListResolverEndpoints_611449; body: JsonNode;
...
var listResolverEndpoints* = Call_ListResolverEndpoints_611449(
    name: "listResolverEndpoints", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListResolverEndpoints",
    validator: validate_ListResolverEndpoints_611450, base: "/",
    url: url_ListResolverEndpoints_611451, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverRuleAssociations_611467 = ref object of OpenApiRestCall_610658
proc url_ListResolverRuleAssociations_611469(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResolverRuleAssociations_611468(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  valid_611472 = validateParameter(valid_611472, JString, required = true, default = newJString(
...
proc call*(call_611481: Call_ListResolverRuleAssociations_611467; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the associations that were created between resolver rules and VPCs using the current AWS account.
  ## 
...
proc call*(call_611482: Call_ListResolverRuleAssociations_611467; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
...
var listResolverRuleAssociations* = Call_ListResolverRuleAssociations_611467(
    ...
    validator: validate_ListResolverRuleAssociations_611468, base: "/",
    url: url_ListResolverRuleAssociations_611469,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResolverRules_611485 = ref object of OpenApiRestCall_610658
proc url_ListResolverRules_611487(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResolverRules_611486(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_611489 = query.getOrDefault("NextToken")
  valid_611489 = validateParameter(valid_611489, JString, required = false,
                                 default = nil)
  if valid_611489 != nil:
    section.add "NextToken", valid_611489
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611490 = header.getOrDefault("X-Amz-Target")
  valid_611490 = validateParameter(valid_611490, JString, required = true, default = newJString(
      "Route53Resolver.ListResolverRules"))
  if valid_611490 != nil:
    section.add "X-Amz-Target", valid_611490
...
proc call*(call_611499: Call_ListResolverRules_611485; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the resolver rules that were created using the current AWS account.
  ## 
...
proc call*(call_611500: Call_ListResolverRules_611485; body: JsonNode;
          MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listResolverRules
  ## Lists the resolver rules that were created using the current AWS account.
  ##   MaxResults: string
  ...
  add(query_611501, "MaxResults", newJString(MaxResults))
  add(query_611501, "NextToken", newJString(NextToken))
  if body != nil:
    body_611502 = body
  result = call_611500.call(nil, query_611501, nil, nil, body_611502)

var listResolverRules* = Call_ListResolverRules_611485(name: "listResolverRules",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListResolverRules",
    validator: validate_ListResolverRules_611486, base: "/",
    url: url_ListResolverRules_611487, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_611503 = ref object of OpenApiRestCall_610658
proc url_ListTagsForResource_611505(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_611504(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_611515: Call_ListTagsForResource_611503; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the tags that you associated with the specified resource.
  ## 
...
proc call*(call_611516: Call_ListTagsForResource_611503; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists the tags that you associated with the specified resource.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_611503(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.ListTagsForResource",
    validator: validate_ListTagsForResource_611504, base: "/",
    url: url_ListTagsForResource_611505, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutResolverRulePolicy_611518 = ref object of OpenApiRestCall_610658
proc url_PutResolverRulePolicy_611520(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutResolverRulePolicy_611519(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611530: Call_PutResolverRulePolicy_611518; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Specifies the Resolver operations and resources that you want to allow another AWS account to be able to use.
  ## 
...
proc call*(call_611531: Call_PutResolverRulePolicy_611518; body: JsonNode): Recallable =
...
var putResolverRulePolicy* = Call_PutResolverRulePolicy_611518(
    name: "putResolverRulePolicy", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.PutResolverRulePolicy",
    validator: validate_PutResolverRulePolicy_611519, base: "/",
    url: url_PutResolverRulePolicy_611520, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_611533 = ref object of OpenApiRestCall_610658
proc url_TagResource_611535(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_611534(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_611545: Call_TagResource_611533; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds one or more tags to a specified resource.
  ## 
...
proc call*(call_611546: Call_TagResource_611533; body: JsonNode): Recallable =
  ## tagResource
  ## Adds one or more tags to a specified resource.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_611533(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "route53resolver.amazonaws.com", route: "/#X-Amz-Target=Route53Resolver.TagResource",
                                        validator: validate_TagResource_611534,
                                        base: "/", url: url_TagResource_611535,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_611548 = ref object of OpenApiRestCall_610658
proc url_UntagResource_611550(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_611549(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611560: Call_UntagResource_611548; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes one or more tags from a specified resource.
  ## 
...
proc call*(call_611561: Call_UntagResource_611548; body: JsonNode): Recallable =
  ## untagResource
  ## Removes one or more tags from a specified resource.
  ##   body: JObject (required)
...
var untagResource* = Call_UntagResource_611548(name: "untagResource",
    meth: HttpMethod.HttpPost, host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UntagResource",
    validator: validate_UntagResource_611549, base: "/", url: url_UntagResource_611550,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResolverEndpoint_611563 = ref object of OpenApiRestCall_610658
proc url_UpdateResolverEndpoint_611565(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateResolverEndpoint_611564(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611575: Call_UpdateResolverEndpoint_611563; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the name of an inbound or an outbound resolver endpoint. 
  ## 
...
proc call*(call_611576: Call_UpdateResolverEndpoint_611563; body: JsonNode): Recallable =
...
var updateResolverEndpoint* = Call_UpdateResolverEndpoint_611563(
    name: "updateResolverEndpoint", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UpdateResolverEndpoint",
    validator: validate_UpdateResolverEndpoint_611564, base: "/",
    url: url_UpdateResolverEndpoint_611565, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResolverRule_611578 = ref object of OpenApiRestCall_610658
proc url_UpdateResolverRule_611580(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateResolverRule_611579(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_611590: Call_UpdateResolverRule_611578; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates settings for a specified resolver rule. <code>ResolverRuleId</code> is required, and all other parameters are optional. If you don't specify a parameter, it retains its current value.
  ## 
...
proc call*(call_611591: Call_UpdateResolverRule_611578; body: JsonNode): Recallable =
  ## updateResolverRule
  ## Updates settings for a specified resolver rule. <code>ResolverRuleId</code> is required, and all other parameters are optional. If you don't specify a parameter, it retains its current value.
  ##   body: JObject (required)
...
var updateResolverRule* = Call_UpdateResolverRule_611578(
    name: "updateResolverRule", meth: HttpMethod.HttpPost,
    host: "route53resolver.amazonaws.com",
    route: "/#X-Amz-Target=Route53Resolver.UpdateResolverRule",
    validator: validate_UpdateResolverRule_611579, base: "/",
    url: url_UpdateResolverRule_611580, schemes: {Scheme.Https, Scheme.Http})
export
  rest
