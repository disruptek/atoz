...
type
  Call_CreateBudget_600774 = ref object of OpenApiRestCall_600437
proc url_CreateBudget_600776(protocol: Scheme; host: string; base: string;
...
proc validate_CreateBudget_600775(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_600932: Call_CreateBudget_600774; path: JsonNode; query: JsonNode;
...
proc call*(call_601003: Call_CreateBudget_600774; body: JsonNode): Recallable =
  ## createBudget
  ## <p>Creates a budget and, if included, notifications and subscribers. </p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_CreateBudget.html#API_CreateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var createBudget* = Call_CreateBudget_600774(name: "createBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget",
    validator: validate_CreateBudget_600775, base: "/", url: url_CreateBudget_600776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateNotification_601043 = ref object of OpenApiRestCall_600437
proc url_CreateNotification_601045(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateNotification_601044(path: JsonNode; query: JsonNode;
...
proc call*(call_601055: Call_CreateNotification_601043; path: JsonNode;
...
proc call*(call_601056: Call_CreateNotification_601043; body: JsonNode): Recallable =
  ## createNotification
  ## Creates a notification. You must create the budget before you create the associated notification.
  ##   body: JObject (required)
...
var createNotification* = Call_CreateNotification_601043(
    ...
    validator: validate_CreateNotification_601044, base: "/",
    url: url_CreateNotification_601045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSubscriber_601058 = ref object of OpenApiRestCall_600437
proc url_CreateSubscriber_601060(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSubscriber_601059(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601070: Call_CreateSubscriber_601058; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ## 
...
proc call*(call_601071: Call_CreateSubscriber_601058; body: JsonNode): Recallable =
  ## createSubscriber
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ##   body: JObject (required)
...
var createSubscriber* = Call_CreateSubscriber_601058(name: "createSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber",
    validator: validate_CreateSubscriber_601059, base: "/",
    url: url_CreateSubscriber_601060, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBudget_601073 = ref object of OpenApiRestCall_600437
proc url_DeleteBudget_601075(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteBudget_601074(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601085: Call_DeleteBudget_601073; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ## 
...
proc call*(call_601086: Call_DeleteBudget_601073; body: JsonNode): Recallable =
  ## deleteBudget
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ##   body: JObject (required)
...
var deleteBudget* = Call_DeleteBudget_601073(name: "deleteBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget",
    validator: validate_DeleteBudget_601074, base: "/", url: url_DeleteBudget_601075,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteNotification_601088 = ref object of OpenApiRestCall_600437
proc url_DeleteNotification_601090(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteNotification_601089(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601100: Call_DeleteNotification_601088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ## 
...
proc call*(call_601101: Call_DeleteNotification_601088; body: JsonNode): Recallable =
  ## deleteNotification
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteNotification* = Call_DeleteNotification_601088(
    name: "deleteNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification",
    validator: validate_DeleteNotification_601089, base: "/",
    url: url_DeleteNotification_601090, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSubscriber_601103 = ref object of OpenApiRestCall_600437
proc url_DeleteSubscriber_601105(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteSubscriber_601104(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601115: Call_DeleteSubscriber_601103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ## 
...
proc call*(call_601116: Call_DeleteSubscriber_601103; body: JsonNode): Recallable =
  ## deleteSubscriber
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteSubscriber* = Call_DeleteSubscriber_601103(name: "deleteSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber",
    validator: validate_DeleteSubscriber_601104, base: "/",
    url: url_DeleteSubscriber_601105, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudget_601118 = ref object of OpenApiRestCall_600437
proc url_DescribeBudget_601120(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudget_601119(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_601130: Call_DescribeBudget_601118; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_601131: Call_DescribeBudget_601118; body: JsonNode): Recallable =
  ## describeBudget
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudget* = Call_DescribeBudget_601118(name: "describeBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget",
    validator: validate_DescribeBudget_601119, base: "/", url: url_DescribeBudget_601120,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgetPerformanceHistory_601133 = ref object of OpenApiRestCall_600437
proc url_DescribeBudgetPerformanceHistory_601135(protocol: Scheme; host: string;
...
proc validate_DescribeBudgetPerformanceHistory_601134(path: JsonNode;
...
proc call*(call_601145: Call_DescribeBudgetPerformanceHistory_601133;
...
proc call*(call_601146: Call_DescribeBudgetPerformanceHistory_601133;
          body: JsonNode): Recallable =
...
var describeBudgetPerformanceHistory* = Call_DescribeBudgetPerformanceHistory_601133(
    ...
    validator: validate_DescribeBudgetPerformanceHistory_601134, base: "/",
    url: url_DescribeBudgetPerformanceHistory_601135,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgets_601148 = ref object of OpenApiRestCall_600437
proc url_DescribeBudgets_601150(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudgets_601149(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_601160: Call_DescribeBudgets_601148; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_601161: Call_DescribeBudgets_601148; body: JsonNode): Recallable =
  ## describeBudgets
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudgets* = Call_DescribeBudgets_601148(name: "describeBudgets",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets",
    validator: validate_DescribeBudgets_601149, base: "/", url: url_DescribeBudgets_601150,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeNotificationsForBudget_601163 = ref object of OpenApiRestCall_600437
proc url_DescribeNotificationsForBudget_601165(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeNotificationsForBudget_601164(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601175: Call_DescribeNotificationsForBudget_601163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the notifications that are associated with a budget.
  ## 
...
proc call*(call_601176: Call_DescribeNotificationsForBudget_601163; body: JsonNode): Recallable =
...
var describeNotificationsForBudget* = Call_DescribeNotificationsForBudget_601163(
    ...
    validator: validate_DescribeNotificationsForBudget_601164, base: "/",
    url: url_DescribeNotificationsForBudget_601165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSubscribersForNotification_601178 = ref object of OpenApiRestCall_600437
proc url_DescribeSubscribersForNotification_601180(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSubscribersForNotification_601179(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601190: Call_DescribeSubscribersForNotification_601178;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the subscribers that are associated with a notification.
  ## 
...
proc call*(call_601191: Call_DescribeSubscribersForNotification_601178;
          body: JsonNode): Recallable =
...
var describeSubscribersForNotification* = Call_DescribeSubscribersForNotification_601178(
    ...
    validator: validate_DescribeSubscribersForNotification_601179, base: "/",
    url: url_DescribeSubscribersForNotification_601180,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBudget_601193 = ref object of OpenApiRestCall_600437
proc url_UpdateBudget_601195(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateBudget_601194(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601205: Call_UpdateBudget_601193; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_601206: Call_UpdateBudget_601193; body: JsonNode): Recallable =
  ## updateBudget
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var updateBudget* = Call_UpdateBudget_601193(name: "updateBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget",
    validator: validate_UpdateBudget_601194, base: "/", url: url_UpdateBudget_601195,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotification_601208 = ref object of OpenApiRestCall_600437
proc url_UpdateNotification_601210(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateNotification_601209(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601220: Call_UpdateNotification_601208; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a notification.
  ## 
...
proc call*(call_601221: Call_UpdateNotification_601208; body: JsonNode): Recallable =
  ## updateNotification
  ## Updates a notification.
  ##   body: JObject (required)
...
var updateNotification* = Call_UpdateNotification_601208(
    name: "updateNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification",
    validator: validate_UpdateNotification_601209, base: "/",
    url: url_UpdateNotification_601210, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSubscriber_601223 = ref object of OpenApiRestCall_600437
proc url_UpdateSubscriber_601225(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSubscriber_601224(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601235: Call_UpdateSubscriber_601223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a subscriber.
  ## 
...
proc call*(call_601236: Call_UpdateSubscriber_601223; body: JsonNode): Recallable =
  ## updateSubscriber
  ## Updates a subscriber.
  ##   body: JObject (required)
...
var updateSubscriber* = Call_UpdateSubscriber_601223(name: "updateSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber",
    validator: validate_UpdateSubscriber_601224, base: "/",
    url: url_UpdateSubscriber_601225, schemes: {Scheme.Https, Scheme.Http})
export
  rest
