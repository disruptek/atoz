...
type
  Call_CreateBudget_612996 = ref object of OpenApiRestCall_612658
proc url_CreateBudget_612998(protocol: Scheme; host: string; base: string;
...
proc validate_CreateBudget_612997(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_613154: Call_CreateBudget_612996; path: JsonNode; query: JsonNode;
...
proc call*(call_613225: Call_CreateBudget_612996; body: JsonNode): Recallable =
  ## createBudget
  ## <p>Creates a budget and, if included, notifications and subscribers. </p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_CreateBudget.html#API_CreateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var createBudget* = Call_CreateBudget_612996(name: "createBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget",
    validator: validate_CreateBudget_612997, base: "/", url: url_CreateBudget_612998,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateNotification_613265 = ref object of OpenApiRestCall_612658
proc url_CreateNotification_613267(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateNotification_613266(path: JsonNode; query: JsonNode;
...
proc call*(call_613277: Call_CreateNotification_613265; path: JsonNode;
...
proc call*(call_613278: Call_CreateNotification_613265; body: JsonNode): Recallable =
  ## createNotification
  ## Creates a notification. You must create the budget before you create the associated notification.
  ##   body: JObject (required)
...
var createNotification* = Call_CreateNotification_613265(
    ...
    validator: validate_CreateNotification_613266, base: "/",
    url: url_CreateNotification_613267, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSubscriber_613280 = ref object of OpenApiRestCall_612658
proc url_CreateSubscriber_613282(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSubscriber_613281(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_613292: Call_CreateSubscriber_613280; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ## 
...
proc call*(call_613293: Call_CreateSubscriber_613280; body: JsonNode): Recallable =
  ## createSubscriber
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ##   body: JObject (required)
...
var createSubscriber* = Call_CreateSubscriber_613280(name: "createSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber",
    validator: validate_CreateSubscriber_613281, base: "/",
    url: url_CreateSubscriber_613282, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBudget_613295 = ref object of OpenApiRestCall_612658
proc url_DeleteBudget_613297(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteBudget_613296(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613307: Call_DeleteBudget_613295; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ## 
...
proc call*(call_613308: Call_DeleteBudget_613295; body: JsonNode): Recallable =
  ## deleteBudget
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ##   body: JObject (required)
...
var deleteBudget* = Call_DeleteBudget_613295(name: "deleteBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget",
    validator: validate_DeleteBudget_613296, base: "/", url: url_DeleteBudget_613297,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteNotification_613310 = ref object of OpenApiRestCall_612658
proc url_DeleteNotification_613312(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteNotification_613311(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_613322: Call_DeleteNotification_613310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ## 
...
proc call*(call_613323: Call_DeleteNotification_613310; body: JsonNode): Recallable =
  ## deleteNotification
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteNotification* = Call_DeleteNotification_613310(
    name: "deleteNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification",
    validator: validate_DeleteNotification_613311, base: "/",
    url: url_DeleteNotification_613312, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSubscriber_613325 = ref object of OpenApiRestCall_612658
proc url_DeleteSubscriber_613327(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteSubscriber_613326(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_613337: Call_DeleteSubscriber_613325; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ## 
...
proc call*(call_613338: Call_DeleteSubscriber_613325; body: JsonNode): Recallable =
  ## deleteSubscriber
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteSubscriber* = Call_DeleteSubscriber_613325(name: "deleteSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber",
    validator: validate_DeleteSubscriber_613326, base: "/",
    url: url_DeleteSubscriber_613327, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudget_613340 = ref object of OpenApiRestCall_612658
proc url_DescribeBudget_613342(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudget_613341(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_613352: Call_DescribeBudget_613340; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_613353: Call_DescribeBudget_613340; body: JsonNode): Recallable =
  ## describeBudget
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudget* = Call_DescribeBudget_613340(name: "describeBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget",
    validator: validate_DescribeBudget_613341, base: "/", url: url_DescribeBudget_613342,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgetPerformanceHistory_613355 = ref object of OpenApiRestCall_612658
proc url_DescribeBudgetPerformanceHistory_613357(protocol: Scheme; host: string;
...
proc validate_DescribeBudgetPerformanceHistory_613356(path: JsonNode;
...
proc call*(call_613367: Call_DescribeBudgetPerformanceHistory_613355;
...
proc call*(call_613368: Call_DescribeBudgetPerformanceHistory_613355;
          body: JsonNode): Recallable =
...
var describeBudgetPerformanceHistory* = Call_DescribeBudgetPerformanceHistory_613355(
    ...
    validator: validate_DescribeBudgetPerformanceHistory_613356, base: "/",
    url: url_DescribeBudgetPerformanceHistory_613357,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgets_613370 = ref object of OpenApiRestCall_612658
proc url_DescribeBudgets_613372(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudgets_613371(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_613382: Call_DescribeBudgets_613370; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_613383: Call_DescribeBudgets_613370; body: JsonNode): Recallable =
  ## describeBudgets
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudgets* = Call_DescribeBudgets_613370(name: "describeBudgets",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets",
    validator: validate_DescribeBudgets_613371, base: "/", url: url_DescribeBudgets_613372,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeNotificationsForBudget_613385 = ref object of OpenApiRestCall_612658
proc url_DescribeNotificationsForBudget_613387(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeNotificationsForBudget_613386(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613397: Call_DescribeNotificationsForBudget_613385; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the notifications that are associated with a budget.
  ## 
...
proc call*(call_613398: Call_DescribeNotificationsForBudget_613385; body: JsonNode): Recallable =
...
var describeNotificationsForBudget* = Call_DescribeNotificationsForBudget_613385(
    ...
    validator: validate_DescribeNotificationsForBudget_613386, base: "/",
    url: url_DescribeNotificationsForBudget_613387,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSubscribersForNotification_613400 = ref object of OpenApiRestCall_612658
proc url_DescribeSubscribersForNotification_613402(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSubscribersForNotification_613401(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613412: Call_DescribeSubscribersForNotification_613400;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the subscribers that are associated with a notification.
  ## 
...
proc call*(call_613413: Call_DescribeSubscribersForNotification_613400;
          body: JsonNode): Recallable =
...
var describeSubscribersForNotification* = Call_DescribeSubscribersForNotification_613400(
    ...
    validator: validate_DescribeSubscribersForNotification_613401, base: "/",
    url: url_DescribeSubscribersForNotification_613402,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBudget_613415 = ref object of OpenApiRestCall_612658
proc url_UpdateBudget_613417(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateBudget_613416(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_613427: Call_UpdateBudget_613415; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_613428: Call_UpdateBudget_613415; body: JsonNode): Recallable =
  ## updateBudget
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var updateBudget* = Call_UpdateBudget_613415(name: "updateBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget",
    validator: validate_UpdateBudget_613416, base: "/", url: url_UpdateBudget_613417,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotification_613430 = ref object of OpenApiRestCall_612658
proc url_UpdateNotification_613432(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateNotification_613431(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_613442: Call_UpdateNotification_613430; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a notification.
  ## 
...
proc call*(call_613443: Call_UpdateNotification_613430; body: JsonNode): Recallable =
  ## updateNotification
  ## Updates a notification.
  ##   body: JObject (required)
...
var updateNotification* = Call_UpdateNotification_613430(
    name: "updateNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification",
    validator: validate_UpdateNotification_613431, base: "/",
    url: url_UpdateNotification_613432, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSubscriber_613445 = ref object of OpenApiRestCall_612658
proc url_UpdateSubscriber_613447(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSubscriber_613446(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_613457: Call_UpdateSubscriber_613445; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a subscriber.
  ## 
...
proc call*(call_613458: Call_UpdateSubscriber_613445; body: JsonNode): Recallable =
  ## updateSubscriber
  ## Updates a subscriber.
  ##   body: JObject (required)
...
var updateSubscriber* = Call_UpdateSubscriber_613445(name: "updateSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber",
    validator: validate_UpdateSubscriber_613446, base: "/",
    url: url_UpdateSubscriber_613447, schemes: {Scheme.Https, Scheme.Http})
export
  rest
