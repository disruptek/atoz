...
type
  Call_CreateBudget_602770 = ref object of OpenApiRestCall_602433
proc url_CreateBudget_602772(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateBudget_602771(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_602928: Call_CreateBudget_602770; path: JsonNode; query: JsonNode;
...
proc call*(call_602999: Call_CreateBudget_602770; body: JsonNode): Recallable =
  ## createBudget
  ## <p>Creates a budget and, if included, notifications and subscribers. </p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_CreateBudget.html#API_CreateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var createBudget* = Call_CreateBudget_602770(name: "createBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget",
    validator: validate_CreateBudget_602771, base: "/", url: url_CreateBudget_602772,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateNotification_603039 = ref object of OpenApiRestCall_602433
proc url_CreateNotification_603041(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateNotification_603040(path: JsonNode; query: JsonNode;
...
proc call*(call_603051: Call_CreateNotification_603039; path: JsonNode;
...
proc call*(call_603052: Call_CreateNotification_603039; body: JsonNode): Recallable =
  ## createNotification
  ## Creates a notification. You must create the budget before you create the associated notification.
  ##   body: JObject (required)
...
var createNotification* = Call_CreateNotification_603039(
    ...
    validator: validate_CreateNotification_603040, base: "/",
    url: url_CreateNotification_603041, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSubscriber_603054 = ref object of OpenApiRestCall_602433
proc url_CreateSubscriber_603056(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateSubscriber_603055(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603066: Call_CreateSubscriber_603054; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ## 
...
proc call*(call_603067: Call_CreateSubscriber_603054; body: JsonNode): Recallable =
  ## createSubscriber
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ##   body: JObject (required)
...
var createSubscriber* = Call_CreateSubscriber_603054(name: "createSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber",
    validator: validate_CreateSubscriber_603055, base: "/",
    url: url_CreateSubscriber_603056, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBudget_603069 = ref object of OpenApiRestCall_602433
proc url_DeleteBudget_603071(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteBudget_603070(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603081: Call_DeleteBudget_603069; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ## 
...
proc call*(call_603082: Call_DeleteBudget_603069; body: JsonNode): Recallable =
  ## deleteBudget
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ##   body: JObject (required)
...
var deleteBudget* = Call_DeleteBudget_603069(name: "deleteBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget",
    validator: validate_DeleteBudget_603070, base: "/", url: url_DeleteBudget_603071,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteNotification_603084 = ref object of OpenApiRestCall_602433
proc url_DeleteNotification_603086(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteNotification_603085(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603096: Call_DeleteNotification_603084; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ## 
...
proc call*(call_603097: Call_DeleteNotification_603084; body: JsonNode): Recallable =
  ## deleteNotification
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteNotification* = Call_DeleteNotification_603084(
    name: "deleteNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification",
    validator: validate_DeleteNotification_603085, base: "/",
    url: url_DeleteNotification_603086, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSubscriber_603099 = ref object of OpenApiRestCall_602433
proc url_DeleteSubscriber_603101(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteSubscriber_603100(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603111: Call_DeleteSubscriber_603099; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ## 
...
proc call*(call_603112: Call_DeleteSubscriber_603099; body: JsonNode): Recallable =
  ## deleteSubscriber
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteSubscriber* = Call_DeleteSubscriber_603099(name: "deleteSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber",
    validator: validate_DeleteSubscriber_603100, base: "/",
    url: url_DeleteSubscriber_603101, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudget_603114 = ref object of OpenApiRestCall_602433
proc url_DescribeBudget_603116(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeBudget_603115(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_603126: Call_DescribeBudget_603114; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_603127: Call_DescribeBudget_603114; body: JsonNode): Recallable =
  ## describeBudget
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudget* = Call_DescribeBudget_603114(name: "describeBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget",
    validator: validate_DescribeBudget_603115, base: "/", url: url_DescribeBudget_603116,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgetPerformanceHistory_603129 = ref object of OpenApiRestCall_602433
proc url_DescribeBudgetPerformanceHistory_603131(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeBudgetPerformanceHistory_603130(path: JsonNode;
...
proc call*(call_603141: Call_DescribeBudgetPerformanceHistory_603129;
...
proc call*(call_603142: Call_DescribeBudgetPerformanceHistory_603129;
          body: JsonNode): Recallable =
...
var describeBudgetPerformanceHistory* = Call_DescribeBudgetPerformanceHistory_603129(
    ...
    validator: validate_DescribeBudgetPerformanceHistory_603130, base: "/",
    url: url_DescribeBudgetPerformanceHistory_603131,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgets_603144 = ref object of OpenApiRestCall_602433
proc url_DescribeBudgets_603146(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeBudgets_603145(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_603156: Call_DescribeBudgets_603144; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_603157: Call_DescribeBudgets_603144; body: JsonNode): Recallable =
  ## describeBudgets
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudgets* = Call_DescribeBudgets_603144(name: "describeBudgets",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets",
    validator: validate_DescribeBudgets_603145, base: "/", url: url_DescribeBudgets_603146,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeNotificationsForBudget_603159 = ref object of OpenApiRestCall_602433
proc url_DescribeNotificationsForBudget_603161(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeNotificationsForBudget_603160(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603171: Call_DescribeNotificationsForBudget_603159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the notifications that are associated with a budget.
  ## 
...
proc call*(call_603172: Call_DescribeNotificationsForBudget_603159; body: JsonNode): Recallable =
...
var describeNotificationsForBudget* = Call_DescribeNotificationsForBudget_603159(
    ...
    validator: validate_DescribeNotificationsForBudget_603160, base: "/",
    url: url_DescribeNotificationsForBudget_603161,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSubscribersForNotification_603174 = ref object of OpenApiRestCall_602433
proc url_DescribeSubscribersForNotification_603176(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DescribeSubscribersForNotification_603175(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603186: Call_DescribeSubscribersForNotification_603174;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the subscribers that are associated with a notification.
  ## 
...
proc call*(call_603187: Call_DescribeSubscribersForNotification_603174;
          body: JsonNode): Recallable =
...
var describeSubscribersForNotification* = Call_DescribeSubscribersForNotification_603174(
    ...
    validator: validate_DescribeSubscribersForNotification_603175, base: "/",
    url: url_DescribeSubscribersForNotification_603176,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBudget_603189 = ref object of OpenApiRestCall_602433
proc url_UpdateBudget_603191(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateBudget_603190(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603201: Call_UpdateBudget_603189; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_603202: Call_UpdateBudget_603189; body: JsonNode): Recallable =
  ## updateBudget
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var updateBudget* = Call_UpdateBudget_603189(name: "updateBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget",
    validator: validate_UpdateBudget_603190, base: "/", url: url_UpdateBudget_603191,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotification_603204 = ref object of OpenApiRestCall_602433
proc url_UpdateNotification_603206(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateNotification_603205(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603216: Call_UpdateNotification_603204; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a notification.
  ## 
...
proc call*(call_603217: Call_UpdateNotification_603204; body: JsonNode): Recallable =
  ## updateNotification
  ## Updates a notification.
  ##   body: JObject (required)
...
var updateNotification* = Call_UpdateNotification_603204(
    name: "updateNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification",
    validator: validate_UpdateNotification_603205, base: "/",
    url: url_UpdateNotification_603206, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSubscriber_603219 = ref object of OpenApiRestCall_602433
proc url_UpdateSubscriber_603221(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateSubscriber_603220(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_603231: Call_UpdateSubscriber_603219; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a subscriber.
  ## 
...
proc call*(call_603232: Call_UpdateSubscriber_603219; body: JsonNode): Recallable =
  ## updateSubscriber
  ## Updates a subscriber.
  ##   body: JObject (required)
...
var updateSubscriber* = Call_UpdateSubscriber_603219(name: "updateSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber",
    validator: validate_UpdateSubscriber_603220, base: "/",
    url: url_UpdateSubscriber_603221, schemes: {Scheme.Https, Scheme.Http})
export
  rest
