...
type
  Call_CreateBudget_601727 = ref object of OpenApiRestCall_601389
proc url_CreateBudget_601729(protocol: Scheme; host: string; base: string;
...
proc validate_CreateBudget_601728(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601885: Call_CreateBudget_601727; path: JsonNode; query: JsonNode;
...
proc call*(call_601956: Call_CreateBudget_601727; body: JsonNode): Recallable =
  ## createBudget
  ## <p>Creates a budget and, if included, notifications and subscribers. </p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_CreateBudget.html#API_CreateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var createBudget* = Call_CreateBudget_601727(name: "createBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget",
    validator: validate_CreateBudget_601728, base: "/", url: url_CreateBudget_601729,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateNotification_601996 = ref object of OpenApiRestCall_601389
proc url_CreateNotification_601998(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateNotification_601997(path: JsonNode; query: JsonNode;
...
proc call*(call_602008: Call_CreateNotification_601996; path: JsonNode;
...
proc call*(call_602009: Call_CreateNotification_601996; body: JsonNode): Recallable =
  ## createNotification
  ## Creates a notification. You must create the budget before you create the associated notification.
  ##   body: JObject (required)
...
var createNotification* = Call_CreateNotification_601996(
    ...
    validator: validate_CreateNotification_601997, base: "/",
    url: url_CreateNotification_601998, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSubscriber_602011 = ref object of OpenApiRestCall_601389
proc url_CreateSubscriber_602013(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSubscriber_602012(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602023: Call_CreateSubscriber_602011; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ## 
...
proc call*(call_602024: Call_CreateSubscriber_602011; body: JsonNode): Recallable =
  ## createSubscriber
  ## Creates a subscriber. You must create the associated budget and notification before you create the subscriber.
  ##   body: JObject (required)
...
var createSubscriber* = Call_CreateSubscriber_602011(name: "createSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber",
    validator: validate_CreateSubscriber_602012, base: "/",
    url: url_CreateSubscriber_602013, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteBudget_602026 = ref object of OpenApiRestCall_601389
proc url_DeleteBudget_602028(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteBudget_602027(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602038: Call_DeleteBudget_602026; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ## 
...
proc call*(call_602039: Call_DeleteBudget_602026; body: JsonNode): Recallable =
  ## deleteBudget
  ## <p>Deletes a budget. You can delete your budget at any time.</p> <important> <p>Deleting a budget also deletes the notifications and subscribers that are associated with that budget.</p> </important>
  ##   body: JObject (required)
...
var deleteBudget* = Call_DeleteBudget_602026(name: "deleteBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget",
    validator: validate_DeleteBudget_602027, base: "/", url: url_DeleteBudget_602028,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteNotification_602041 = ref object of OpenApiRestCall_601389
proc url_DeleteNotification_602043(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteNotification_602042(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_602053: Call_DeleteNotification_602041; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ## 
...
proc call*(call_602054: Call_DeleteNotification_602041; body: JsonNode): Recallable =
  ## deleteNotification
  ## <p>Deletes a notification.</p> <important> <p>Deleting a notification also deletes the subscribers that are associated with the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteNotification* = Call_DeleteNotification_602041(
    name: "deleteNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification",
    validator: validate_DeleteNotification_602042, base: "/",
    url: url_DeleteNotification_602043, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSubscriber_602056 = ref object of OpenApiRestCall_601389
proc url_DeleteSubscriber_602058(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteSubscriber_602057(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602068: Call_DeleteSubscriber_602056; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ## 
...
proc call*(call_602069: Call_DeleteSubscriber_602056; body: JsonNode): Recallable =
  ## deleteSubscriber
  ## <p>Deletes a subscriber.</p> <important> <p>Deleting the last subscriber to a notification also deletes the notification.</p> </important>
  ##   body: JObject (required)
...
var deleteSubscriber* = Call_DeleteSubscriber_602056(name: "deleteSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber",
    validator: validate_DeleteSubscriber_602057, base: "/",
    url: url_DeleteSubscriber_602058, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudget_602071 = ref object of OpenApiRestCall_601389
proc url_DescribeBudget_602073(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudget_602072(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_602083: Call_DescribeBudget_602071; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_602084: Call_DescribeBudget_602071; body: JsonNode): Recallable =
  ## describeBudget
  ## <p>Describes a budget.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudget* = Call_DescribeBudget_602071(name: "describeBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget",
    validator: validate_DescribeBudget_602072, base: "/", url: url_DescribeBudget_602073,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgetPerformanceHistory_602086 = ref object of OpenApiRestCall_601389
proc url_DescribeBudgetPerformanceHistory_602088(protocol: Scheme; host: string;
...
proc validate_DescribeBudgetPerformanceHistory_602087(path: JsonNode;
...
proc call*(call_602098: Call_DescribeBudgetPerformanceHistory_602086;
...
proc call*(call_602099: Call_DescribeBudgetPerformanceHistory_602086;
          body: JsonNode): Recallable =
...
var describeBudgetPerformanceHistory* = Call_DescribeBudgetPerformanceHistory_602086(
    ...
    validator: validate_DescribeBudgetPerformanceHistory_602087, base: "/",
    url: url_DescribeBudgetPerformanceHistory_602088,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeBudgets_602101 = ref object of OpenApiRestCall_601389
proc url_DescribeBudgets_602103(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeBudgets_602102(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_602113: Call_DescribeBudgets_602101; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_602114: Call_DescribeBudgets_602101; body: JsonNode): Recallable =
  ## describeBudgets
  ## <p>Lists the budgets that are associated with an account.</p> <important> <p>The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var describeBudgets* = Call_DescribeBudgets_602101(name: "describeBudgets",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets",
    validator: validate_DescribeBudgets_602102, base: "/", url: url_DescribeBudgets_602103,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeNotificationsForBudget_602116 = ref object of OpenApiRestCall_601389
proc url_DescribeNotificationsForBudget_602118(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeNotificationsForBudget_602117(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602128: Call_DescribeNotificationsForBudget_602116; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the notifications that are associated with a budget.
  ## 
...
proc call*(call_602129: Call_DescribeNotificationsForBudget_602116; body: JsonNode): Recallable =
...
var describeNotificationsForBudget* = Call_DescribeNotificationsForBudget_602116(
    ...
    validator: validate_DescribeNotificationsForBudget_602117, base: "/",
    url: url_DescribeNotificationsForBudget_602118,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSubscribersForNotification_602131 = ref object of OpenApiRestCall_601389
proc url_DescribeSubscribersForNotification_602133(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSubscribersForNotification_602132(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602143: Call_DescribeSubscribersForNotification_602131;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists the subscribers that are associated with a notification.
  ## 
...
proc call*(call_602144: Call_DescribeSubscribersForNotification_602131;
          body: JsonNode): Recallable =
...
var describeSubscribersForNotification* = Call_DescribeSubscribersForNotification_602131(
    ...
    validator: validate_DescribeSubscribersForNotification_602132, base: "/",
    url: url_DescribeSubscribersForNotification_602133,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateBudget_602146 = ref object of OpenApiRestCall_601389
proc url_UpdateBudget_602148(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateBudget_602147(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602158: Call_UpdateBudget_602146; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ## 
...
proc call*(call_602159: Call_UpdateBudget_602146; body: JsonNode): Recallable =
  ## updateBudget
  ## <p>Updates a budget. You can change every part of a budget except for the <code>budgetName</code> and the <code>calculatedSpend</code>. When you modify a budget, the <code>calculatedSpend</code> drops to zero until AWS has new usage data to use for forecasting.</p> <important> <p>Only one of <code>BudgetLimit</code> or <code>PlannedBudgetLimits</code> can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the <code>BudgetLimit</code> syntax. For <code>PlannedBudgetLimits</code>, see the <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_UpdateBudget.html#API_UpdateBudget_Examples">Examples</a> section. </p> </important>
  ##   body: JObject (required)
...
var updateBudget* = Call_UpdateBudget_602146(name: "updateBudget",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget",
    validator: validate_UpdateBudget_602147, base: "/", url: url_UpdateBudget_602148,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateNotification_602161 = ref object of OpenApiRestCall_601389
proc url_UpdateNotification_602163(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateNotification_602162(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_602173: Call_UpdateNotification_602161; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a notification.
  ## 
...
proc call*(call_602174: Call_UpdateNotification_602161; body: JsonNode): Recallable =
  ## updateNotification
  ## Updates a notification.
  ##   body: JObject (required)
...
var updateNotification* = Call_UpdateNotification_602161(
    name: "updateNotification", meth: HttpMethod.HttpPost,
    host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification",
    validator: validate_UpdateNotification_602162, base: "/",
    url: url_UpdateNotification_602163, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSubscriber_602176 = ref object of OpenApiRestCall_601389
proc url_UpdateSubscriber_602178(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSubscriber_602177(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_602188: Call_UpdateSubscriber_602176; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a subscriber.
  ## 
...
proc call*(call_602189: Call_UpdateSubscriber_602176; body: JsonNode): Recallable =
  ## updateSubscriber
  ## Updates a subscriber.
  ##   body: JObject (required)
...
var updateSubscriber* = Call_UpdateSubscriber_602176(name: "updateSubscriber",
    meth: HttpMethod.HttpPost, host: "budgets.amazonaws.com",
    route: "/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber",
    validator: validate_UpdateSubscriber_602177, base: "/",
    url: url_UpdateSubscriber_602178, schemes: {Scheme.Https, Scheme.Http})
export
  rest
