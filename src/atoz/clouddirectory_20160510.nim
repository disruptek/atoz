...
var listIndex* = Call_ListIndex_21626653(name: "listIndex",
                                      ...
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectAttributes_21626672 = ref object of OpenApiRestCall_21625435
proc url_ListObjectAttributes_21626674(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectAttributes_21626673(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626683 = header.getOrDefault("x-amz-consistency-level")
  valid_21626683 = validateParameter(valid_21626683, JString, required = false,
                                   default = newJString("SERIALIZABLE"))
  if valid_21626683 != nil:
    section.add "x-amz-consistency-level", valid_21626683
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626685 = header.getOrDefault("x-amz-data-partition")
  valid_21626685 = validateParameter(valid_21626685, JString, required = true,
                                   default = nil)
  if valid_21626685 != nil:
    section.add "x-amz-data-partition", valid_21626685
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626687: Call_ListObjectAttributes_21626672; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all attributes that are associated with an object. 
  ## 
...
proc call*(call_21626688: Call_ListObjectAttributes_21626672; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  var body_21626690 = newJObject()
  add(query_21626689, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626690 = body
  add(query_21626689, "MaxResults", newJString(MaxResults))
  result = call_21626688.call(nil, query_21626689, nil, nil, body_21626690)

var listObjectAttributes* = Call_ListObjectAttributes_21626672(
    ...
    validator: validate_ListObjectAttributes_21626673, base: "/",
    makeUrl: url_ListObjectAttributes_21626674,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectChildren_21626691 = ref object of OpenApiRestCall_21625435
proc url_ListObjectChildren_21626693(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectChildren_21626692(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626702 = header.getOrDefault("x-amz-consistency-level")
  valid_21626702 = validateParameter(valid_21626702, JString, required = false,
                                   default = newJString("SERIALIZABLE"))
  if valid_21626702 != nil:
    section.add "x-amz-consistency-level", valid_21626702
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626704 = header.getOrDefault("x-amz-data-partition")
  valid_21626704 = validateParameter(valid_21626704, JString, required = true,
                                   default = nil)
  if valid_21626704 != nil:
    section.add "x-amz-data-partition", valid_21626704
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626706: Call_ListObjectChildren_21626691; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of child objects that are associated with a given object.
  ## 
  let valid = call_21626706.validator(path, query, header, formData, body, _)
  let scheme = call_21626706.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_21626706.makeUrl(scheme.get, call_21626706.host, call_21626706.base,
                               call_21626706.route, valid.getOrDefault("path"),
                               valid.getOrDefault("query"))
  result = atozHook(call_21626706, uri, valid, _)

proc call*(call_21626707: Call_ListObjectChildren_21626691; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectChildren
  ## Returns a paginated list of child objects that are associated with a given object.
  ##   NextToken: string
  ...
  ##   MaxResults: string
  ##             : Pagination limit
  var query_21626708 = newJObject()
  var body_21626709 = newJObject()
  add(query_21626708, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626709 = body
  add(query_21626708, "MaxResults", newJString(MaxResults))
  result = call_21626707.call(nil, query_21626708, nil, nil, body_21626709)

var listObjectChildren* = Call_ListObjectChildren_21626691(
    ...
    validator: validate_ListObjectChildren_21626692, base: "/",
    makeUrl: url_ListObjectChildren_21626693, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParentPaths_21626710 = ref object of OpenApiRestCall_21625435
proc url_ListObjectParentPaths_21626712(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListObjectParentPaths_21626711(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  section = newJObject()
  var valid_21626715 = header.getOrDefault("X-Amz-Date")
  valid_21626715 = validateParameter(valid_21626715, JString, required = false,
                                   default = nil)
  if valid_21626715 != nil:
    section.add "X-Amz-Date", valid_21626715
  var valid_21626716 = header.getOrDefault("X-Amz-Security-Token")
  valid_21626716 = validateParameter(valid_21626716, JString, required = false,
                                   default = nil)
  if valid_21626716 != nil:
    section.add "X-Amz-Security-Token", valid_21626716
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626722 = header.getOrDefault("x-amz-data-partition")
  valid_21626722 = validateParameter(valid_21626722, JString, required = true,
                                   default = nil)
  if valid_21626722 != nil:
    section.add "x-amz-data-partition", valid_21626722
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626724: Call_ListObjectParentPaths_21626710;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves all available parent paths for any object type such as node, leaf node, policy node, and index node objects. For more information about objects, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#dirstructure">Directory Structure</a>.</p> <p>Use this API to evaluate all parents for an object. The call returns all objects from the root of the directory up to the requested object. The API returns the number of paths based on user-defined <code>MaxResults</code>, in case there are multiple paths to the parent. The order of the paths and nodes returned is consistent among multiple API calls unless the objects are deleted or moved. Paths not leading to the directory root are ignored from the target object.</p>
  ## 
...
proc call*(call_21626725: Call_ListObjectParentPaths_21626710; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  add(query_21626726, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626727 = body
  add(query_21626726, "MaxResults", newJString(MaxResults))
  result = call_21626725.call(nil, query_21626726, nil, nil, body_21626727)

var listObjectParentPaths* = Call_ListObjectParentPaths_21626710(
    ...
    validator: validate_ListObjectParentPaths_21626711, base: "/",
    makeUrl: url_ListObjectParentPaths_21626712,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParents_21626728 = ref object of OpenApiRestCall_21625435
proc url_ListObjectParents_21626730(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParents_21626729(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626739 = header.getOrDefault("x-amz-consistency-level")
  valid_21626739 = validateParameter(valid_21626739, JString, required = false,
                                   default = newJString("SERIALIZABLE"))
  if valid_21626739 != nil:
    section.add "x-amz-consistency-level", valid_21626739
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626741 = header.getOrDefault("x-amz-data-partition")
  valid_21626741 = validateParameter(valid_21626741, JString, required = true,
                                   default = nil)
  if valid_21626741 != nil:
    section.add "x-amz-data-partition", valid_21626741
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626743: Call_ListObjectParents_21626728; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ## 
...
proc call*(call_21626744: Call_ListObjectParents_21626728; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectParents
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ##   NextToken: string
  ...
  add(query_21626745, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626746 = body
  add(query_21626745, "MaxResults", newJString(MaxResults))
  result = call_21626744.call(nil, query_21626745, nil, nil, body_21626746)

var listObjectParents* = Call_ListObjectParents_21626728(name: "listObjectParents",
    ...
    validator: validate_ListObjectParents_21626729, base: "/",
    makeUrl: url_ListObjectParents_21626730, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectPolicies_21626747 = ref object of OpenApiRestCall_21625435
proc url_ListObjectPolicies_21626749(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectPolicies_21626748(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626754 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_21626754 = validateParameter(valid_21626754, JString, required = false,
                                   default = nil)
  if valid_21626754 != nil:
    section.add "X-Amz-Content-Sha256", valid_21626754
  var valid_21626755 = header.getOrDefault("X-Amz-Algorithm")
  valid_21626755 = validateParameter(valid_21626755, JString, required = false,
                                   default = nil)
  if valid_21626755 != nil:
    section.add "X-Amz-Algorithm", valid_21626755
  var valid_21626756 = header.getOrDefault("X-Amz-Signature")
  valid_21626756 = validateParameter(valid_21626756, JString, required = false,
                                   default = nil)
  if valid_21626756 != nil:
    section.add "X-Amz-Signature", valid_21626756
  var valid_21626757 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_21626757 = validateParameter(valid_21626757, JString, required = false,
                                   default = nil)
  if valid_21626757 != nil:
    section.add "X-Amz-SignedHeaders", valid_21626757
  var valid_21626758 = header.getOrDefault("x-amz-consistency-level")
  valid_21626758 = validateParameter(valid_21626758, JString, required = false,
                                   default = newJString("SERIALIZABLE"))
  if valid_21626758 != nil:
    section.add "x-amz-consistency-level", valid_21626758
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626760 = header.getOrDefault("x-amz-data-partition")
  valid_21626760 = validateParameter(valid_21626760, JString, required = true,
                                   default = nil)
  if valid_21626760 != nil:
    section.add "x-amz-data-partition", valid_21626760
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626762: Call_ListObjectPolicies_21626747; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns policies attached to an object in pagination fashion.
  ## 
...
proc call*(call_21626763: Call_ListObjectPolicies_21626747; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listObjectPolicies
  ## Returns policies attached to an object in pagination fashion.
  ##   NextToken: string
  ...
  add(query_21626764, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626765 = body
  add(query_21626764, "MaxResults", newJString(MaxResults))
  result = call_21626763.call(nil, query_21626764, nil, nil, body_21626765)

var listObjectPolicies* = Call_ListObjectPolicies_21626747(
    ...
    validator: validate_ListObjectPolicies_21626748, base: "/",
    makeUrl: url_ListObjectPolicies_21626749, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOutgoingTypedLinks_21626766 = ref object of OpenApiRestCall_21625435
proc url_ListOutgoingTypedLinks_21626768(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListOutgoingTypedLinks_21626767(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626776 = header.getOrDefault("x-amz-data-partition")
  valid_21626776 = validateParameter(valid_21626776, JString, required = true,
                                   default = nil)
  if valid_21626776 != nil:
    section.add "x-amz-data-partition", valid_21626776
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626778: Call_ListOutgoingTypedLinks_21626766;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ## 
...
proc call*(call_21626779: Call_ListOutgoingTypedLinks_21626766; body: JsonNode): Recallable =
  ## listOutgoingTypedLinks
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ##   body: JObject (required)
  var body_21626780 = newJObject()
  if body != nil:
    body_21626780 = body
  result = call_21626779.call(nil, nil, nil, nil, body_21626780)

var listOutgoingTypedLinks* = Call_ListOutgoingTypedLinks_21626766(
    ...
    validator: validate_ListOutgoingTypedLinks_21626767, base: "/",
    makeUrl: url_ListOutgoingTypedLinks_21626768,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPolicyAttachments_21626781 = ref object of OpenApiRestCall_21625435
proc url_ListPolicyAttachments_21626783(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListPolicyAttachments_21626782(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_21626784 = query.getOrDefault("NextToken")
  ...
  var valid_21626792 = header.getOrDefault("x-amz-consistency-level")
  valid_21626792 = validateParameter(valid_21626792, JString, required = false,
                                   default = newJString("SERIALIZABLE"))
  if valid_21626792 != nil:
    section.add "x-amz-consistency-level", valid_21626792
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626794 = header.getOrDefault("x-amz-data-partition")
  valid_21626794 = validateParameter(valid_21626794, JString, required = true,
                                   default = nil)
  if valid_21626794 != nil:
    section.add "x-amz-data-partition", valid_21626794
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626796: Call_ListPolicyAttachments_21626781;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns all of the <code>ObjectIdentifiers</code> to which a given policy is attached.
  ## 
...
proc call*(call_21626797: Call_ListPolicyAttachments_21626781; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  var body_21626799 = newJObject()
  add(query_21626798, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626799 = body
  add(query_21626798, "MaxResults", newJString(MaxResults))
  result = call_21626797.call(nil, query_21626798, nil, nil, body_21626799)

var listPolicyAttachments* = Call_ListPolicyAttachments_21626781(
    ...
    validator: validate_ListPolicyAttachments_21626782, base: "/",
    makeUrl: url_ListPolicyAttachments_21626783,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPublishedSchemaArns_21626800 = ref object of OpenApiRestCall_21625435
proc url_ListPublishedSchemaArns_21626802(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPublishedSchemaArns_21626801(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626813: Call_ListPublishedSchemaArns_21626800;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the major version families of each published schema. If a major version ARN is provided as <code>SchemaArn</code>, the minor version revisions in that family are listed instead.
  ## 
...
proc call*(call_21626814: Call_ListPublishedSchemaArns_21626800; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listPublishedSchemaArns* = Call_ListPublishedSchemaArns_21626800(
    name: "listPublishedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/published",
    validator: validate_ListPublishedSchemaArns_21626801, base: "/",
    makeUrl: url_ListPublishedSchemaArns_21626802,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_21626817 = ref object of OpenApiRestCall_21625435
proc url_ListTagsForResource_21626819(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_21626818(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626830: Call_ListTagsForResource_21626817; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ## 
...
proc call*(call_21626831: Call_ListTagsForResource_21626817; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listTagsForResource
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ##   NextToken: string
...
var listTagsForResource* = Call_ListTagsForResource_21626817(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags",
    validator: validate_ListTagsForResource_21626818, base: "/",
    makeUrl: url_ListTagsForResource_21626819,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetAttributes_21626834 = ref object of OpenApiRestCall_21625435
proc url_ListTypedLinkFacetAttributes_21626836(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetAttributes_21626835(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626846 = header.getOrDefault("x-amz-data-partition")
  valid_21626846 = validateParameter(valid_21626846, JString, required = true,
                                   default = nil)
  if valid_21626846 != nil:
    section.add "x-amz-data-partition", valid_21626846
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626848: Call_ListTypedLinkFacetAttributes_21626834;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of all attribute definitions for a particular <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ## 
...
proc call*(call_21626849: Call_ListTypedLinkFacetAttributes_21626834;
  ...
  ##   MaxResults: string
  ##             : Pagination limit
  var query_21626850 = newJObject()
  var body_21626851 = newJObject()
  add(query_21626850, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626851 = body
  add(query_21626850, "MaxResults", newJString(MaxResults))
  result = call_21626849.call(nil, query_21626850, nil, nil, body_21626851)

var listTypedLinkFacetAttributes* = Call_ListTypedLinkFacetAttributes_21626834(
    ...
    validator: validate_ListTypedLinkFacetAttributes_21626835, base: "/",
    makeUrl: url_ListTypedLinkFacetAttributes_21626836,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetNames_21626852 = ref object of OpenApiRestCall_21625435
proc url_ListTypedLinkFacetNames_21626854(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetNames_21626853(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626864 = header.getOrDefault("x-amz-data-partition")
  valid_21626864 = validateParameter(valid_21626864, JString, required = true,
                                   default = nil)
  if valid_21626864 != nil:
    section.add "x-amz-data-partition", valid_21626864
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626866: Call_ListTypedLinkFacetNames_21626852;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of <code>TypedLink</code> facet names for a particular schema. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ## 
...
proc call*(call_21626867: Call_ListTypedLinkFacetNames_21626852; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ...
  var body_21626869 = newJObject()
  add(query_21626868, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626869 = body
  add(query_21626868, "MaxResults", newJString(MaxResults))
  result = call_21626867.call(nil, query_21626868, nil, nil, body_21626869)

var listTypedLinkFacetNames* = Call_ListTypedLinkFacetNames_21626852(
    ...
    validator: validate_ListTypedLinkFacetNames_21626853, base: "/",
    makeUrl: url_ListTypedLinkFacetNames_21626854,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupPolicy_21626870 = ref object of OpenApiRestCall_21625435
proc url_LookupPolicy_21626872(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LookupPolicy_21626871(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626877 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_21626877 = validateParameter(valid_21626877, JString, required = false,
                                   default = nil)
  if valid_21626877 != nil:
    section.add "X-Amz-Content-Sha256", valid_21626877
  var valid_21626878 = header.getOrDefault("X-Amz-Algorithm")
  valid_21626878 = validateParameter(valid_21626878, JString, required = false,
                                   default = nil)
  if valid_21626878 != nil:
    section.add "X-Amz-Algorithm", valid_21626878
  var valid_21626879 = header.getOrDefault("X-Amz-Signature")
  valid_21626879 = validateParameter(valid_21626879, JString, required = false,
                                   default = nil)
  if valid_21626879 != nil:
    section.add "X-Amz-Signature", valid_21626879
  var valid_21626880 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_21626880 = validateParameter(valid_21626880, JString, required = false,
                                   default = nil)
  if valid_21626880 != nil:
    section.add "X-Amz-SignedHeaders", valid_21626880
  var valid_21626881 = header.getOrDefault("X-Amz-Credential")
  valid_21626881 = validateParameter(valid_21626881, JString, required = false,
                                   default = nil)
  if valid_21626881 != nil:
    section.add "X-Amz-Credential", valid_21626881
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626882 = header.getOrDefault("x-amz-data-partition")
  valid_21626882 = validateParameter(valid_21626882, JString, required = true,
                                   default = nil)
  if valid_21626882 != nil:
    section.add "x-amz-data-partition", valid_21626882
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626884: Call_LookupPolicy_21626870; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#policies">Policies</a>.
  ## 
...
proc call*(call_21626885: Call_LookupPolicy_21626870; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## lookupPolicy
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#policies">Policies</a>.
  ##   NextToken: string
  ...
  var body_21626887 = newJObject()
  add(query_21626886, "NextToken", newJString(NextToken))
  if body != nil:
    body_21626887 = body
  add(query_21626886, "MaxResults", newJString(MaxResults))
  result = call_21626885.call(nil, query_21626886, nil, nil, body_21626887)

var lookupPolicy* = Call_LookupPolicy_21626870(name: "lookupPolicy",
    ...
    validator: validate_LookupPolicy_21626871, base: "/", makeUrl: url_LookupPolicy_21626872,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishSchema_21626888 = ref object of OpenApiRestCall_21625435
proc url_PublishSchema_21626890(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishSchema_21626889(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626898 = header.getOrDefault("x-amz-data-partition")
  valid_21626898 = validateParameter(valid_21626898, JString, required = true,
                                   default = nil)
  if valid_21626898 != nil:
    section.add "x-amz-data-partition", valid_21626898
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626900: Call_PublishSchema_21626888; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Publishes a development schema with a major version and a recommended minor version.
  ## 
...
proc call*(call_21626901: Call_PublishSchema_21626888; body: JsonNode): Recallable =
  ## publishSchema
  ## Publishes a development schema with a major version and a recommended minor version.
  ##   body: JObject (required)
  var body_21626902 = newJObject()
  if body != nil:
    body_21626902 = body
  result = call_21626901.call(nil, nil, nil, nil, body_21626902)

var publishSchema* = Call_PublishSchema_21626888(name: "publishSchema",
    ...
    validator: validate_PublishSchema_21626889, base: "/",
    makeUrl: url_PublishSchema_21626890, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveFacetFromObject_21626903 = ref object of OpenApiRestCall_21625435
proc url_RemoveFacetFromObject_21626905(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_RemoveFacetFromObject_21626904(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626913 = header.getOrDefault("x-amz-data-partition")
  valid_21626913 = validateParameter(valid_21626913, JString, required = true,
                                   default = nil)
  if valid_21626913 != nil:
    section.add "x-amz-data-partition", valid_21626913
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626915: Call_RemoveFacetFromObject_21626903;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes the specified facet from the specified object.
  ## 
...
proc call*(call_21626916: Call_RemoveFacetFromObject_21626903; body: JsonNode): Recallable =
  ## removeFacetFromObject
  ## Removes the specified facet from the specified object.
  ##   body: JObject (required)
  var body_21626917 = newJObject()
  if body != nil:
    body_21626917 = body
  result = call_21626916.call(nil, nil, nil, nil, body_21626917)

var removeFacetFromObject* = Call_RemoveFacetFromObject_21626903(
    ...
    validator: validate_RemoveFacetFromObject_21626904, base: "/",
    makeUrl: url_RemoveFacetFromObject_21626905,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_21626918 = ref object of OpenApiRestCall_21625435
proc url_TagResource_21626920(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_21626919(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-Credential: JString
  section = newJObject()
  var valid_21626921 = header.getOrDefault("X-Amz-Date")
  valid_21626921 = validateParameter(valid_21626921, JString, required = false,
                                   default = nil)
  if valid_21626921 != nil:
    section.add "X-Amz-Date", valid_21626921
  var valid_21626922 = header.getOrDefault("X-Amz-Security-Token")
  valid_21626922 = validateParameter(valid_21626922, JString, required = false,
                                   default = nil)
  if valid_21626922 != nil:
    section.add "X-Amz-Security-Token", valid_21626922
...
proc call*(call_21626929: Call_TagResource_21626918; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## An API operation for adding tags to a resource.
  ## 
...
proc call*(call_21626930: Call_TagResource_21626918; body: JsonNode): Recallable =
  ## tagResource
  ## An API operation for adding tags to a resource.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_21626918(name: "tagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/add",
    validator: validate_TagResource_21626919, base: "/", makeUrl: url_TagResource_21626920,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_21626932 = ref object of OpenApiRestCall_21625435
proc url_UntagResource_21626934(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_21626933(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626943: Call_UntagResource_21626932; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## An API operation for removing tags from a resource.
  ## 
...
proc call*(call_21626944: Call_UntagResource_21626932; body: JsonNode): Recallable =
  ## untagResource
  ## An API operation for removing tags from a resource.
  ##   body: JObject (required)
  var body_21626945 = newJObject()
  if body != nil:
    body_21626945 = body
  result = call_21626944.call(nil, nil, nil, nil, body_21626945)

var untagResource* = Call_UntagResource_21626932(name: "untagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/remove",
    validator: validate_UntagResource_21626933, base: "/",
    makeUrl: url_UntagResource_21626934, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateLinkAttributes_21626946 = ref object of OpenApiRestCall_21625435
proc url_UpdateLinkAttributes_21626948(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateLinkAttributes_21626947(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626956 = header.getOrDefault("x-amz-data-partition")
  valid_21626956 = validateParameter(valid_21626956, JString, required = true,
                                   default = nil)
  if valid_21626956 != nil:
    section.add "x-amz-data-partition", valid_21626956
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626958: Call_UpdateLinkAttributes_21626946; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a given typed link’s attributes. Attributes to be updated must not contribute to the typed link’s identity, as defined by its <code>IdentityAttributeOrder</code>.
  ## 
...
proc call*(call_21626959: Call_UpdateLinkAttributes_21626946; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_21626960 = body
  result = call_21626959.call(nil, nil, nil, nil, body_21626960)

var updateLinkAttributes* = Call_UpdateLinkAttributes_21626946(
    ...
    validator: validate_UpdateLinkAttributes_21626947, base: "/",
    makeUrl: url_UpdateLinkAttributes_21626948,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateObjectAttributes_21626961 = ref object of OpenApiRestCall_21625435
proc url_UpdateObjectAttributes_21626963(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateObjectAttributes_21626962(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626971 = header.getOrDefault("x-amz-data-partition")
  valid_21626971 = validateParameter(valid_21626971, JString, required = true,
                                   default = nil)
  if valid_21626971 != nil:
    section.add "x-amz-data-partition", valid_21626971
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626973: Call_UpdateObjectAttributes_21626961;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a given object's attributes.
  ## 
...
proc call*(call_21626974: Call_UpdateObjectAttributes_21626961; body: JsonNode): Recallable =
  ## updateObjectAttributes
  ## Updates a given object's attributes.
  ##   body: JObject (required)
  var body_21626975 = newJObject()
  if body != nil:
    body_21626975 = body
  result = call_21626974.call(nil, nil, nil, nil, body_21626975)

var updateObjectAttributes* = Call_UpdateObjectAttributes_21626961(
    ...
    validator: validate_UpdateObjectAttributes_21626962, base: "/",
    makeUrl: url_UpdateObjectAttributes_21626963,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSchema_21626976 = ref object of OpenApiRestCall_21625435
proc url_UpdateSchema_21626978(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSchema_21626977(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode; _: string = ""): JsonNode {.nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21626986 = header.getOrDefault("x-amz-data-partition")
  valid_21626986 = validateParameter(valid_21626986, JString, required = true,
                                   default = nil)
  if valid_21626986 != nil:
    section.add "x-amz-data-partition", valid_21626986
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626988: Call_UpdateSchema_21626976; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ## 
...
proc call*(call_21626989: Call_UpdateSchema_21626976; body: JsonNode): Recallable =
  ## updateSchema
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ##   body: JObject (required)
  var body_21626990 = newJObject()
  if body != nil:
    body_21626990 = body
  result = call_21626989.call(nil, nil, nil, nil, body_21626990)

var updateSchema* = Call_UpdateSchema_21626976(name: "updateSchema",
    ...
    validator: validate_UpdateSchema_21626977, base: "/", makeUrl: url_UpdateSchema_21626978,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTypedLinkFacet_21626991 = ref object of OpenApiRestCall_21625435
proc url_UpdateTypedLinkFacet_21626993(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateTypedLinkFacet_21626992(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_21627001 = header.getOrDefault("x-amz-data-partition")
  valid_21627001 = validateParameter(valid_21627001, JString, required = true,
                                   default = nil)
  if valid_21627001 != nil:
    section.add "x-amz-data-partition", valid_21627001
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21627003: Call_UpdateTypedLinkFacet_21626991; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ## 
...
proc call*(call_21627004: Call_UpdateTypedLinkFacet_21626991; body: JsonNode): Recallable =
  ## updateTypedLinkFacet
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ##   body: JObject (required)
  var body_21627005 = newJObject()
  if body != nil:
    body_21627005 = body
  result = call_21627004.call(nil, nil, nil, nil, body_21627005)

var updateTypedLinkFacet* = Call_UpdateTypedLinkFacet_21626991(
    ...
    validator: validate_UpdateTypedLinkFacet_21626992, base: "/",
    makeUrl: url_UpdateTypedLinkFacet_21626993,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradeAppliedSchema_21627006 = ref object of OpenApiRestCall_21625435
proc url_UpgradeAppliedSchema_21627008(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradeAppliedSchema_21627007(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21627017: Call_UpgradeAppliedSchema_21627006; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Upgrades a single directory in-place using the <code>PublishedSchemaArn</code> with schema updates found in <code>MinorVersion</code>. Backwards-compatible minor version upgrades are instantaneously available for readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one schema on a given directory per call. To upgrade multiple directories from one schema, you would need to call this API on each directory.
  ## 
...
proc call*(call_21627018: Call_UpgradeAppliedSchema_21627006; body: JsonNode): Recallable =
...
var upgradeAppliedSchema* = Call_UpgradeAppliedSchema_21627006(
    name: "upgradeAppliedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradeapplied",
    validator: validate_UpgradeAppliedSchema_21627007, base: "/",
    makeUrl: url_UpgradeAppliedSchema_21627008,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradePublishedSchema_21627020 = ref object of OpenApiRestCall_21625435
proc url_UpgradePublishedSchema_21627022(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpgradePublishedSchema_21627021(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21627031: Call_UpgradePublishedSchema_21627020;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.
  ## 
...
proc call*(call_21627032: Call_UpgradePublishedSchema_21627020; body: JsonNode): Recallable =
...
var upgradePublishedSchema* = Call_UpgradePublishedSchema_21627020(
    name: "upgradePublishedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradepublished",
    validator: validate_UpgradePublishedSchema_21627021, base: "/",
    makeUrl: url_UpgradePublishedSchema_21627022,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
