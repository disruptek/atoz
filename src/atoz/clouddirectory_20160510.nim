...
var listIndex* = Call_ListIndex_402657109(name: "listIndex",
    ...
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectAttributes_402657128 = ref object of OpenApiRestCall_402656044
proc url_ListObjectAttributes_402657130(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListObjectAttributes_402657129(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_402657135 = header.getOrDefault("x-amz-consistency-level")
  valid_402657135 = validateParameter(valid_402657135, JString,
                                      required = false,
                                      default = newJString("SERIALIZABLE"))
  if valid_402657135 != nil:
    section.add "x-amz-consistency-level", valid_402657135
  var valid_402657136 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_402657136 = validateParameter(valid_402657136, JString,
                                      required = false, default = nil)
  if valid_402657136 != nil:
    section.add "X-Amz-Content-Sha256", valid_402657136
  var valid_402657137 = header.getOrDefault("X-Amz-Algorithm")
  valid_402657137 = validateParameter(valid_402657137, JString,
                                      required = false, default = nil)
  if valid_402657137 != nil:
    section.add "X-Amz-Algorithm", valid_402657137
  var valid_402657138 = header.getOrDefault("X-Amz-Date")
  valid_402657138 = validateParameter(valid_402657138, JString,
                                      required = false, default = nil)
  if valid_402657138 != nil:
    section.add "X-Amz-Date", valid_402657138
  var valid_402657139 = header.getOrDefault("X-Amz-Credential")
  valid_402657139 = validateParameter(valid_402657139, JString,
                                      required = false, default = nil)
  if valid_402657139 != nil:
    section.add "X-Amz-Credential", valid_402657139
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657140 = header.getOrDefault("x-amz-data-partition")
  valid_402657140 = validateParameter(valid_402657140, JString, required = true,
                                      default = nil)
  if valid_402657140 != nil:
    section.add "x-amz-data-partition", valid_402657140
...
proc call*(call_402657143: Call_ListObjectAttributes_402657128;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all attributes that are associated with an object. 
                                                                                         ## 
...
proc call*(call_402657144: Call_ListObjectAttributes_402657128; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  add(query_402657145, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657146 = body
  add(query_402657145, "NextToken", newJString(NextToken))
  result = call_402657144.call(nil, query_402657145, nil, nil, body_402657146)

var listObjectAttributes* = Call_ListObjectAttributes_402657128(
    ...
    validator: validate_ListObjectAttributes_402657129, base: "/",
    makeUrl: url_ListObjectAttributes_402657130,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectChildren_402657147 = ref object of OpenApiRestCall_402656044
proc url_ListObjectChildren_402657149(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListObjectChildren_402657148(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657150 = query.getOrDefault("MaxResults")
  valid_402657150 = validateParameter(valid_402657150, JString,
                                      required = false, default = nil)
  if valid_402657150 != nil:
    section.add "MaxResults", valid_402657150
  var valid_402657151 = query.getOrDefault("NextToken")
  valid_402657151 = validateParameter(valid_402657151, JString,
                                      required = false, default = nil)
  if valid_402657151 != nil:
    section.add "NextToken", valid_402657151
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
  ...
  var valid_402657154 = header.getOrDefault("x-amz-consistency-level")
  valid_402657154 = validateParameter(valid_402657154, JString,
                                      required = false,
                                      default = newJString("SERIALIZABLE"))
  if valid_402657154 != nil:
    section.add "x-amz-consistency-level", valid_402657154
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657159 = header.getOrDefault("x-amz-data-partition")
  valid_402657159 = validateParameter(valid_402657159, JString, required = true,
                                      default = nil)
  if valid_402657159 != nil:
    section.add "x-amz-data-partition", valid_402657159
...
proc call*(call_402657162: Call_ListObjectChildren_402657147;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of child objects that are associated with a given object.
                                                                                         ## 
...
proc call*(call_402657163: Call_ListObjectChildren_402657147; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectChildren
  ## Returns a paginated list of child objects that are associated with a given object.
  ##   
  ...
  ##   
                                                                                                                          ...
                                                                                                                          ## Pagination 
                                                                                                                          ## token
  var query_402657164 = newJObject()
  var body_402657165 = newJObject()
  add(query_402657164, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657165 = body
  add(query_402657164, "NextToken", newJString(NextToken))
  result = call_402657163.call(nil, query_402657164, nil, nil, body_402657165)

var listObjectChildren* = Call_ListObjectChildren_402657147(
    ...
    validator: validate_ListObjectChildren_402657148, base: "/",
    makeUrl: url_ListObjectChildren_402657149,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParentPaths_402657166 = ref object of OpenApiRestCall_402656044
proc url_ListObjectParentPaths_402657168(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListObjectParentPaths_402657167(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657169 = query.getOrDefault("MaxResults")
  valid_402657169 = validateParameter(valid_402657169, JString,
                                      required = false, default = nil)
  if valid_402657169 != nil:
    section.add "MaxResults", valid_402657169
  var valid_402657170 = query.getOrDefault("NextToken")
  valid_402657170 = validateParameter(valid_402657170, JString,
                                      required = false, default = nil)
  if valid_402657170 != nil:
    section.add "NextToken", valid_402657170
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657177 = header.getOrDefault("x-amz-data-partition")
  valid_402657177 = validateParameter(valid_402657177, JString, required = true,
                                      default = nil)
  if valid_402657177 != nil:
    section.add "x-amz-data-partition", valid_402657177
...
proc call*(call_402657180: Call_ListObjectParentPaths_402657166;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves all available parent paths for any object type such as node, leaf node, policy node, and index node objects. For more information about objects, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#dirstructure">Directory Structure</a>.</p> <p>Use this API to evaluate all parents for an object. The call returns all objects from the root of the directory up to the requested object. The API returns the number of paths based on user-defined <code>MaxResults</code>, in case there are multiple paths to the parent. The order of the paths and nodes returned is consistent among multiple API calls unless the objects are deleted or moved. Paths not leading to the directory root are ignored from the target object.</p>
                                                                                         ## 
...
proc call*(call_402657181: Call_ListObjectParentPaths_402657166; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  var body_402657183 = newJObject()
  add(query_402657182, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657183 = body
  add(query_402657182, "NextToken", newJString(NextToken))
  result = call_402657181.call(nil, query_402657182, nil, nil, body_402657183)

var listObjectParentPaths* = Call_ListObjectParentPaths_402657166(
    ...
    validator: validate_ListObjectParentPaths_402657167, base: "/",
    makeUrl: url_ListObjectParentPaths_402657168,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectParents_402657184 = ref object of OpenApiRestCall_402656044
proc url_ListObjectParents_402657186(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListObjectParents_402657185(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657187 = query.getOrDefault("MaxResults")
  valid_402657187 = validateParameter(valid_402657187, JString,
                                      required = false, default = nil)
  if valid_402657187 != nil:
    section.add "MaxResults", valid_402657187
  var valid_402657188 = query.getOrDefault("NextToken")
  valid_402657188 = validateParameter(valid_402657188, JString,
                                      required = false, default = nil)
  if valid_402657188 != nil:
    section.add "NextToken", valid_402657188
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
  ...
  var valid_402657191 = header.getOrDefault("x-amz-consistency-level")
  valid_402657191 = validateParameter(valid_402657191, JString,
                                      required = false,
                                      default = newJString("SERIALIZABLE"))
  if valid_402657191 != nil:
    section.add "x-amz-consistency-level", valid_402657191
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657196 = header.getOrDefault("x-amz-data-partition")
  valid_402657196 = validateParameter(valid_402657196, JString, required = true,
                                      default = nil)
  if valid_402657196 != nil:
    section.add "x-amz-data-partition", valid_402657196
  var valid_402657197 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_402657197 = validateParameter(valid_402657197, JString,
                                      required = false, default = nil)
  if valid_402657197 != nil:
    section.add "X-Amz-SignedHeaders", valid_402657197
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_402657199: Call_ListObjectParents_402657184;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists parent objects that are associated with a given object in pagination fashion.
                                                                                         ## 
  let valid = call_402657199.validator(path, query, header, formData, body, _)
  let scheme = call_402657199.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657199.makeUrl(scheme.get, call_402657199.host, call_402657199.base,
                                   call_402657199.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657199, uri, valid, _)

proc call*(call_402657200: Call_ListObjectParents_402657184; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectParents
  ## Lists parent objects that are associated with a given object in pagination fashion.
  ##   
  ...
  ##   
                                                                                                                           ...
                                                                                                                           ## Pagination 
                                                                                                                           ## token
  var query_402657201 = newJObject()
  var body_402657202 = newJObject()
  add(query_402657201, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657202 = body
  add(query_402657201, "NextToken", newJString(NextToken))
  result = call_402657200.call(nil, query_402657201, nil, nil, body_402657202)

var listObjectParents* = Call_ListObjectParents_402657184(
    ...
    validator: validate_ListObjectParents_402657185, base: "/",
    makeUrl: url_ListObjectParents_402657186,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListObjectPolicies_402657203 = ref object of OpenApiRestCall_402656044
proc url_ListObjectPolicies_402657205(protocol: Scheme; host: string;
                                      base: string; route: string;
                                      path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListObjectPolicies_402657204(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657206 = query.getOrDefault("MaxResults")
  valid_402657206 = validateParameter(valid_402657206, JString,
                                      required = false, default = nil)
  if valid_402657206 != nil:
    section.add "MaxResults", valid_402657206
  var valid_402657207 = query.getOrDefault("NextToken")
  valid_402657207 = validateParameter(valid_402657207, JString,
                                      required = false, default = nil)
  if valid_402657207 != nil:
    section.add "NextToken", valid_402657207
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
  ...
  var valid_402657210 = header.getOrDefault("x-amz-consistency-level")
  valid_402657210 = validateParameter(valid_402657210, JString,
                                      required = false,
                                      default = newJString("SERIALIZABLE"))
  if valid_402657210 != nil:
    section.add "x-amz-consistency-level", valid_402657210
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657215 = header.getOrDefault("x-amz-data-partition")
  valid_402657215 = validateParameter(valid_402657215, JString, required = true,
                                      default = nil)
  if valid_402657215 != nil:
    section.add "x-amz-data-partition", valid_402657215
...
proc call*(call_402657218: Call_ListObjectPolicies_402657203;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns policies attached to an object in pagination fashion.
                                                                                         ## 
...
proc call*(call_402657219: Call_ListObjectPolicies_402657203; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listObjectPolicies
  ## Returns policies attached to an object in pagination fashion.
  ##   MaxResults: string
  ...
  ##   
                                                                                                                              ...
                                                                                                                              ## Pagination 
                                                                                                                              ## token
  var query_402657220 = newJObject()
  var body_402657221 = newJObject()
  add(query_402657220, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657221 = body
  add(query_402657220, "NextToken", newJString(NextToken))
  result = call_402657219.call(nil, query_402657220, nil, nil, body_402657221)

var listObjectPolicies* = Call_ListObjectPolicies_402657203(
    ...
    validator: validate_ListObjectPolicies_402657204, base: "/",
    makeUrl: url_ListObjectPolicies_402657205,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOutgoingTypedLinks_402657222 = ref object of OpenApiRestCall_402656044
proc url_ListOutgoingTypedLinks_402657224(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListOutgoingTypedLinks_402657223(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_402657227 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_402657227 = validateParameter(valid_402657227, JString,
                                      required = false, default = nil)
  if valid_402657227 != nil:
    section.add "X-Amz-Content-Sha256", valid_402657227
  var valid_402657228 = header.getOrDefault("X-Amz-Algorithm")
  valid_402657228 = validateParameter(valid_402657228, JString,
                                      required = false, default = nil)
  if valid_402657228 != nil:
    section.add "X-Amz-Algorithm", valid_402657228
  var valid_402657229 = header.getOrDefault("X-Amz-Date")
  valid_402657229 = validateParameter(valid_402657229, JString,
                                      required = false, default = nil)
  if valid_402657229 != nil:
    section.add "X-Amz-Date", valid_402657229
  var valid_402657230 = header.getOrDefault("X-Amz-Credential")
  valid_402657230 = validateParameter(valid_402657230, JString,
                                      required = false, default = nil)
  if valid_402657230 != nil:
    section.add "X-Amz-Credential", valid_402657230
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657231 = header.getOrDefault("x-amz-data-partition")
  valid_402657231 = validateParameter(valid_402657231, JString, required = true,
                                      default = nil)
  if valid_402657231 != nil:
    section.add "x-amz-data-partition", valid_402657231
...
proc call*(call_402657234: Call_ListOutgoingTypedLinks_402657222;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
                                                                                         ## 
...
proc call*(call_402657235: Call_ListOutgoingTypedLinks_402657222; body: JsonNode): Recallable =
  ## listOutgoingTypedLinks
  ## Returns a paginated list of all the outgoing <a>TypedLinkSpecifier</a> information for an object. It also supports filtering by typed link facet and identity attributes. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ##   
                                                                                                                                                                                                                                                                                                                                ## body: JObject (required)
  var body_402657236 = newJObject()
  if body != nil:
    body_402657236 = body
  result = call_402657235.call(nil, nil, nil, nil, body_402657236)

var listOutgoingTypedLinks* = Call_ListOutgoingTypedLinks_402657222(
    ...
    validator: validate_ListOutgoingTypedLinks_402657223, base: "/",
    makeUrl: url_ListOutgoingTypedLinks_402657224,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPolicyAttachments_402657237 = ref object of OpenApiRestCall_402656044
proc url_ListPolicyAttachments_402657239(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPolicyAttachments_402657238(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657240 = query.getOrDefault("MaxResults")
  valid_402657240 = validateParameter(valid_402657240, JString,
                                      required = false, default = nil)
  if valid_402657240 != nil:
    section.add "MaxResults", valid_402657240
  var valid_402657241 = query.getOrDefault("NextToken")
  valid_402657241 = validateParameter(valid_402657241, JString,
                                      required = false, default = nil)
  if valid_402657241 != nil:
    section.add "NextToken", valid_402657241
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
  ...
  var valid_402657244 = header.getOrDefault("x-amz-consistency-level")
  valid_402657244 = validateParameter(valid_402657244, JString,
                                      required = false,
                                      default = newJString("SERIALIZABLE"))
  if valid_402657244 != nil:
    section.add "x-amz-consistency-level", valid_402657244
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657249 = header.getOrDefault("x-amz-data-partition")
  valid_402657249 = validateParameter(valid_402657249, JString, required = true,
                                      default = nil)
  if valid_402657249 != nil:
    section.add "x-amz-data-partition", valid_402657249
...
proc call*(call_402657252: Call_ListPolicyAttachments_402657237;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns all of the <code>ObjectIdentifiers</code> to which a given policy is attached.
                                                                                         ## 
  let valid = call_402657252.validator(path, query, header, formData, body, _)
  let scheme = call_402657252.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657252.makeUrl(scheme.get, call_402657252.host, call_402657252.base,
                                   call_402657252.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657252, uri, valid, _)

proc call*(call_402657253: Call_ListPolicyAttachments_402657237; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  ##   
                                                                                                                              ...
                                                                                                                              ## Pagination 
                                                                                                                              ## token
  var query_402657254 = newJObject()
  var body_402657255 = newJObject()
  add(query_402657254, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657255 = body
  add(query_402657254, "NextToken", newJString(NextToken))
  result = call_402657253.call(nil, query_402657254, nil, nil, body_402657255)

var listPolicyAttachments* = Call_ListPolicyAttachments_402657237(
    ...
    validator: validate_ListPolicyAttachments_402657238, base: "/",
    makeUrl: url_ListPolicyAttachments_402657239,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListPublishedSchemaArns_402657256 = ref object of OpenApiRestCall_402656044
proc url_ListPublishedSchemaArns_402657258(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListPublishedSchemaArns_402657257(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657259 = query.getOrDefault("MaxResults")
  valid_402657259 = validateParameter(valid_402657259, JString,
                                      required = false, default = nil)
  if valid_402657259 != nil:
    section.add "MaxResults", valid_402657259
  var valid_402657260 = query.getOrDefault("NextToken")
  valid_402657260 = validateParameter(valid_402657260, JString,
                                      required = false, default = nil)
  if valid_402657260 != nil:
    section.add "NextToken", valid_402657260
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
...
proc call*(call_402657269: Call_ListPublishedSchemaArns_402657256;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists the major version families of each published schema. If a major version ARN is provided as <code>SchemaArn</code>, the minor version revisions in that family are listed instead.
                                                                                         ## 
...
proc call*(call_402657270: Call_ListPublishedSchemaArns_402657256;
           body: JsonNode; MaxResults: string = ""; NextToken: string = ""): Recallable =
...
var listPublishedSchemaArns* = Call_ListPublishedSchemaArns_402657256(
    name: "listPublishedSchemaArns", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/published",
    validator: validate_ListPublishedSchemaArns_402657257, base: "/",
    makeUrl: url_ListPublishedSchemaArns_402657258,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_402657273 = ref object of OpenApiRestCall_402656044
proc url_ListTagsForResource_402657275(protocol: Scheme; host: string;
                                       base: string; route: string;
                                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListTagsForResource_402657274(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402657286: Call_ListTagsForResource_402657273;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
                                                                                         ## 
...
proc call*(call_402657287: Call_ListTagsForResource_402657273; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## listTagsForResource
  ## Returns tags for a resource. Tagging is currently supported only for directories with a limit of 50 tags per directory. All 50 tags are returned for a given directory with this API call.
  ##   
...
var listTagsForResource* = Call_ListTagsForResource_402657273(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags",
    validator: validate_ListTagsForResource_402657274, base: "/",
    makeUrl: url_ListTagsForResource_402657275,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetAttributes_402657290 = ref object of OpenApiRestCall_402656044
proc url_ListTypedLinkFacetAttributes_402657292(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetAttributes_402657291(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657301 = header.getOrDefault("x-amz-data-partition")
  valid_402657301 = validateParameter(valid_402657301, JString, required = true,
                                      default = nil)
  if valid_402657301 != nil:
    section.add "x-amz-data-partition", valid_402657301
...
proc call*(call_402657304: Call_ListTypedLinkFacetAttributes_402657290;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of all attribute definitions for a particular <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
                                                                                         ## 
...
proc call*(call_402657305: Call_ListTypedLinkFacetAttributes_402657290;
           body: JsonNode; MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  ##   
                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                       ## Pagination 
                                                                                                                                                                                                                                                                                       ## token
  var query_402657306 = newJObject()
  var body_402657307 = newJObject()
  add(query_402657306, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657307 = body
  add(query_402657306, "NextToken", newJString(NextToken))
  result = call_402657305.call(nil, query_402657306, nil, nil, body_402657307)

var listTypedLinkFacetAttributes* = Call_ListTypedLinkFacetAttributes_402657290(
    ...
    validator: validate_ListTypedLinkFacetAttributes_402657291, base: "/",
    makeUrl: url_ListTypedLinkFacetAttributes_402657292,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTypedLinkFacetNames_402657308 = ref object of OpenApiRestCall_402656044
proc url_ListTypedLinkFacetNames_402657310(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTypedLinkFacetNames_402657309(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   NextToken: JString
                                                                   ##            : Pagination token
  section = newJObject()
  var valid_402657311 = query.getOrDefault("MaxResults")
  valid_402657311 = validateParameter(valid_402657311, JString,
                                      required = false, default = nil)
  if valid_402657311 != nil:
    section.add "MaxResults", valid_402657311
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657319 = header.getOrDefault("x-amz-data-partition")
  valid_402657319 = validateParameter(valid_402657319, JString, required = true,
                                      default = nil)
  if valid_402657319 != nil:
    section.add "x-amz-data-partition", valid_402657319
  var valid_402657320 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_402657320 = validateParameter(valid_402657320, JString,
                                      required = false, default = nil)
  if valid_402657320 != nil:
    section.add "X-Amz-SignedHeaders", valid_402657320
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_402657322: Call_ListTypedLinkFacetNames_402657308;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a paginated list of <code>TypedLink</code> facet names for a particular schema. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
                                                                                         ## 
  let valid = call_402657322.validator(path, query, header, formData, body, _)
  let scheme = call_402657322.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657322.makeUrl(scheme.get, call_402657322.host, call_402657322.base,
                                   call_402657322.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657322, uri, valid, _)

proc call*(call_402657323: Call_ListTypedLinkFacetNames_402657308;
           body: JsonNode; MaxResults: string = ""; NextToken: string = ""): Recallable =
  ...
  ##   
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 ## Pagination 
                                                                                                                                                                                                                                                                                 ## token
  var query_402657324 = newJObject()
  var body_402657325 = newJObject()
  add(query_402657324, "MaxResults", newJString(MaxResults))
  if body != nil:
    body_402657325 = body
  add(query_402657324, "NextToken", newJString(NextToken))
  result = call_402657323.call(nil, query_402657324, nil, nil, body_402657325)

var listTypedLinkFacetNames* = Call_ListTypedLinkFacetNames_402657308(
    ...
    validator: validate_ListTypedLinkFacetNames_402657309, base: "/",
    makeUrl: url_ListTypedLinkFacetNames_402657310,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_LookupPolicy_402657326 = ref object of OpenApiRestCall_402656044
proc url_LookupPolicy_402657328(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LookupPolicy_402657327(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   
                                                                                                                                                                              ## X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402657331 = header.getOrDefault("X-Amz-Security-Token")
  valid_402657331 = validateParameter(valid_402657331, JString,
                                      required = false, default = nil)
  if valid_402657331 != nil:
    section.add "X-Amz-Security-Token", valid_402657331
  var valid_402657332 = header.getOrDefault("X-Amz-Signature")
  valid_402657332 = validateParameter(valid_402657332, JString,
                                      required = false, default = nil)
  if valid_402657332 != nil:
    section.add "X-Amz-Signature", valid_402657332
  var valid_402657333 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_402657333 = validateParameter(valid_402657333, JString,
                                      required = false, default = nil)
  if valid_402657333 != nil:
    section.add "X-Amz-Content-Sha256", valid_402657333
  var valid_402657334 = header.getOrDefault("X-Amz-Algorithm")
  valid_402657334 = validateParameter(valid_402657334, JString,
                                      required = false, default = nil)
  if valid_402657334 != nil:
    section.add "X-Amz-Algorithm", valid_402657334
  var valid_402657335 = header.getOrDefault("X-Amz-Date")
  valid_402657335 = validateParameter(valid_402657335, JString,
                                      required = false, default = nil)
  if valid_402657335 != nil:
    section.add "X-Amz-Date", valid_402657335
  var valid_402657336 = header.getOrDefault("X-Amz-Credential")
  valid_402657336 = validateParameter(valid_402657336, JString,
                                      required = false, default = nil)
  if valid_402657336 != nil:
    section.add "X-Amz-Credential", valid_402657336
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657337 = header.getOrDefault("x-amz-data-partition")
  valid_402657337 = validateParameter(valid_402657337, JString, required = true,
                                      default = nil)
  if valid_402657337 != nil:
    section.add "x-amz-data-partition", valid_402657337
...
proc call*(call_402657340: Call_LookupPolicy_402657326; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#policies">Policies</a>.
                                                                                         ## 
...
proc call*(call_402657341: Call_LookupPolicy_402657326; body: JsonNode;
           MaxResults: string = ""; NextToken: string = ""): Recallable =
  ## lookupPolicy
  ## Lists all policies from the root of the <a>Directory</a> to the object specified. If there are no policies present, an empty list is returned. If policies are present, and if some objects don't have the policies attached, it returns the <code>ObjectIdentifier</code> for such objects. If policies are present, it returns <code>ObjectIdentifier</code>, <code>policyId</code>, and <code>policyType</code>. Paths that don't lead to the root from the target object are ignored. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/cd_key_concepts.html#policies">Policies</a>.
  ##   
  ...
  result = call_402657341.call(nil, query_402657342, nil, nil, body_402657343)

var lookupPolicy* = Call_LookupPolicy_402657326(name: "lookupPolicy",
    ...
    validator: validate_LookupPolicy_402657327, base: "/",
    makeUrl: url_LookupPolicy_402657328, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PublishSchema_402657344 = ref object of OpenApiRestCall_402656044
proc url_PublishSchema_402657346(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublishSchema_402657345(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657353 = header.getOrDefault("x-amz-data-partition")
  valid_402657353 = validateParameter(valid_402657353, JString, required = true,
                                      default = nil)
  if valid_402657353 != nil:
    section.add "x-amz-data-partition", valid_402657353
...
proc call*(call_402657356: Call_PublishSchema_402657344; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Publishes a development schema with a major version and a recommended minor version.
                                                                                         ## 
...
proc call*(call_402657357: Call_PublishSchema_402657344; body: JsonNode): Recallable =
  ## publishSchema
  ## Publishes a development schema with a major version and a recommended minor version.
  ##   
                                                                                         ## body: JObject (required)
...
var publishSchema* = Call_PublishSchema_402657344(name: "publishSchema",
    ...
    validator: validate_PublishSchema_402657345, base: "/",
    makeUrl: url_PublishSchema_402657346, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveFacetFromObject_402657359 = ref object of OpenApiRestCall_402656044
proc url_RemoveFacetFromObject_402657361(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveFacetFromObject_402657360(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657368 = header.getOrDefault("x-amz-data-partition")
  valid_402657368 = validateParameter(valid_402657368, JString, required = true,
                                      default = nil)
  if valid_402657368 != nil:
    section.add "x-amz-data-partition", valid_402657368
...
proc call*(call_402657371: Call_RemoveFacetFromObject_402657359;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes the specified facet from the specified object.
                                                                                         ## 
...
proc call*(call_402657372: Call_RemoveFacetFromObject_402657359; body: JsonNode): Recallable =
...
var removeFacetFromObject* = Call_RemoveFacetFromObject_402657359(
    ...
    validator: validate_RemoveFacetFromObject_402657360, base: "/",
    makeUrl: url_RemoveFacetFromObject_402657361,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_402657374 = ref object of OpenApiRestCall_402656044
proc url_TagResource_402657376(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_402657375(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402657385: Call_TagResource_402657374; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## An API operation for adding tags to a resource.
                                                                                         ## 
...
proc call*(call_402657386: Call_TagResource_402657374; body: JsonNode): Recallable =
  ## tagResource
  ## An API operation for adding tags to a resource.
  ##   body: JObject (required)
...
var tagResource* = Call_TagResource_402657374(name: "tagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/add",
    validator: validate_TagResource_402657375, base: "/",
    makeUrl: url_TagResource_402657376, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_402657388 = ref object of OpenApiRestCall_402656044
proc url_UntagResource_402657390(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_402657389(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402657399: Call_UntagResource_402657388; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## An API operation for removing tags from a resource.
                                                                                         ## 
  let valid = call_402657399.validator(path, query, header, formData, body, _)
  let scheme = call_402657399.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657399.makeUrl(scheme.get, call_402657399.host, call_402657399.base,
                                   call_402657399.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657399, uri, valid, _)

proc call*(call_402657400: Call_UntagResource_402657388; body: JsonNode): Recallable =
  ## untagResource
  ## An API operation for removing tags from a resource.
  ##   body: JObject (required)
  var body_402657401 = newJObject()
  if body != nil:
    body_402657401 = body
  result = call_402657400.call(nil, nil, nil, nil, body_402657401)

var untagResource* = Call_UntagResource_402657388(name: "untagResource",
    meth: HttpMethod.HttpPut, host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/tags/remove",
    validator: validate_UntagResource_402657389, base: "/",
    makeUrl: url_UntagResource_402657390, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateLinkAttributes_402657402 = ref object of OpenApiRestCall_402656044
proc url_UpdateLinkAttributes_402657404(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateLinkAttributes_402657403(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657411 = header.getOrDefault("x-amz-data-partition")
  valid_402657411 = validateParameter(valid_402657411, JString, required = true,
                                      default = nil)
  if valid_402657411 != nil:
    section.add "x-amz-data-partition", valid_402657411
  var valid_402657412 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_402657412 = validateParameter(valid_402657412, JString,
                                      required = false, default = nil)
  if valid_402657412 != nil:
    section.add "X-Amz-SignedHeaders", valid_402657412
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_402657414: Call_UpdateLinkAttributes_402657402;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a given typed link’s attributes. Attributes to be updated must not contribute to the typed link’s identity, as defined by its <code>IdentityAttributeOrder</code>.
                                                                                         ## 
  let valid = call_402657414.validator(path, query, header, formData, body, _)
  let scheme = call_402657414.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657414.makeUrl(scheme.get, call_402657414.host, call_402657414.base,
                                   call_402657414.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657414, uri, valid, _)

proc call*(call_402657415: Call_UpdateLinkAttributes_402657402; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_402657416 = body
  result = call_402657415.call(nil, nil, nil, nil, body_402657416)

var updateLinkAttributes* = Call_UpdateLinkAttributes_402657402(
    ...
    validator: validate_UpdateLinkAttributes_402657403, base: "/",
    makeUrl: url_UpdateLinkAttributes_402657404,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateObjectAttributes_402657417 = ref object of OpenApiRestCall_402656044
proc url_UpdateObjectAttributes_402657419(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateObjectAttributes_402657418(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657426 = header.getOrDefault("x-amz-data-partition")
  valid_402657426 = validateParameter(valid_402657426, JString, required = true,
                                      default = nil)
  if valid_402657426 != nil:
    section.add "x-amz-data-partition", valid_402657426
...
proc call*(call_402657429: Call_UpdateObjectAttributes_402657417;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a given object's attributes.
                                                                                         ## 
...
proc call*(call_402657430: Call_UpdateObjectAttributes_402657417; body: JsonNode): Recallable =
  ## updateObjectAttributes
  ## Updates a given object's attributes.
  ##   body: JObject (required)
  var body_402657431 = newJObject()
  if body != nil:
    body_402657431 = body
  result = call_402657430.call(nil, nil, nil, nil, body_402657431)

var updateObjectAttributes* = Call_UpdateObjectAttributes_402657417(
    ...
    validator: validate_UpdateObjectAttributes_402657418, base: "/",
    makeUrl: url_UpdateObjectAttributes_402657419,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSchema_402657432 = ref object of OpenApiRestCall_402656044
proc url_UpdateSchema_402657434(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSchema_402657433(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657441 = header.getOrDefault("x-amz-data-partition")
  valid_402657441 = validateParameter(valid_402657441, JString, required = true,
                                      default = nil)
  if valid_402657441 != nil:
    section.add "x-amz-data-partition", valid_402657441
...
proc call*(call_402657444: Call_UpdateSchema_402657432; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates the schema name with a new name. Only development schema names can be updated.
                                                                                         ## 
...
proc call*(call_402657445: Call_UpdateSchema_402657432; body: JsonNode): Recallable =
  ## updateSchema
  ## Updates the schema name with a new name. Only development schema names can be updated.
  ##   
                                                                                           ## body: JObject (required)
  var body_402657446 = newJObject()
  if body != nil:
    body_402657446 = body
  result = call_402657445.call(nil, nil, nil, nil, body_402657446)

var updateSchema* = Call_UpdateSchema_402657432(name: "updateSchema",
    ...
    validator: validate_UpdateSchema_402657433, base: "/",
    makeUrl: url_UpdateSchema_402657434, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateTypedLinkFacet_402657447 = ref object of OpenApiRestCall_402656044
proc url_UpdateTypedLinkFacet_402657449(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateTypedLinkFacet_402657448(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  assert header != nil, "header argument is necessary due to required `x-amz-data-partition` field"
  var valid_402657456 = header.getOrDefault("x-amz-data-partition")
  valid_402657456 = validateParameter(valid_402657456, JString, required = true,
                                      default = nil)
  if valid_402657456 != nil:
    section.add "x-amz-data-partition", valid_402657456
...
proc call*(call_402657459: Call_UpdateTypedLinkFacet_402657447;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
                                                                                         ## 
  let valid = call_402657459.validator(path, query, header, formData, body, _)
  let scheme = call_402657459.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_402657459.makeUrl(scheme.get, call_402657459.host, call_402657459.base,
                                   call_402657459.route,
                                   valid.getOrDefault("path"),
                                   valid.getOrDefault("query"))
  result = atozHook(call_402657459, uri, valid, _)

proc call*(call_402657460: Call_UpdateTypedLinkFacet_402657447; body: JsonNode): Recallable =
  ## updateTypedLinkFacet
  ## Updates a <a>TypedLinkFacet</a>. For more information, see <a href="http://docs.aws.amazon.com/directoryservice/latest/admin-guide/objectsandlinks.html#typedlink">Typed link</a>.
  ##   
                                                                                                                                                                                       ## body: JObject (required)
  var body_402657461 = newJObject()
  if body != nil:
    body_402657461 = body
  result = call_402657460.call(nil, nil, nil, nil, body_402657461)

var updateTypedLinkFacet* = Call_UpdateTypedLinkFacet_402657447(
    ...
    validator: validate_UpdateTypedLinkFacet_402657448, base: "/",
    makeUrl: url_UpdateTypedLinkFacet_402657449,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradeAppliedSchema_402657462 = ref object of OpenApiRestCall_402656044
proc url_UpgradeAppliedSchema_402657464(protocol: Scheme; host: string;
                                        base: string; route: string;
                                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpgradeAppliedSchema_402657463(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402657473: Call_UpgradeAppliedSchema_402657462;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Upgrades a single directory in-place using the <code>PublishedSchemaArn</code> with schema updates found in <code>MinorVersion</code>. Backwards-compatible minor version upgrades are instantaneously available for readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one schema on a given directory per call. To upgrade multiple directories from one schema, you would need to call this API on each directory.
                                                                                         ## 
...
proc call*(call_402657474: Call_UpgradeAppliedSchema_402657462; body: JsonNode): Recallable =
...
var upgradeAppliedSchema* = Call_UpgradeAppliedSchema_402657462(
    name: "upgradeAppliedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradeapplied",
    validator: validate_UpgradeAppliedSchema_402657463, base: "/",
    makeUrl: url_UpgradeAppliedSchema_402657464,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpgradePublishedSchema_402657476 = ref object of OpenApiRestCall_402656044
proc url_UpgradePublishedSchema_402657478(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpgradePublishedSchema_402657477(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_402657479 = header.getOrDefault("X-Amz-Security-Token")
  valid_402657479 = validateParameter(valid_402657479, JString,
                                      required = false, default = nil)
  if valid_402657479 != nil:
    section.add "X-Amz-Security-Token", valid_402657479
  var valid_402657480 = header.getOrDefault("X-Amz-Signature")
  valid_402657480 = validateParameter(valid_402657480, JString,
                                      required = false, default = nil)
  if valid_402657480 != nil:
    section.add "X-Amz-Signature", valid_402657480
  var valid_402657481 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_402657481 = validateParameter(valid_402657481, JString,
                                      required = false, default = nil)
  if valid_402657481 != nil:
    section.add "X-Amz-Content-Sha256", valid_402657481
  var valid_402657482 = header.getOrDefault("X-Amz-Algorithm")
  valid_402657482 = validateParameter(valid_402657482, JString,
                                      required = false, default = nil)
  if valid_402657482 != nil:
    section.add "X-Amz-Algorithm", valid_402657482
  var valid_402657483 = header.getOrDefault("X-Amz-Date")
  valid_402657483 = validateParameter(valid_402657483, JString,
                                      required = false, default = nil)
  if valid_402657483 != nil:
    section.add "X-Amz-Date", valid_402657483
  var valid_402657484 = header.getOrDefault("X-Amz-Credential")
  valid_402657484 = validateParameter(valid_402657484, JString,
                                      required = false, default = nil)
  if valid_402657484 != nil:
    section.add "X-Amz-Credential", valid_402657484
  var valid_402657485 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_402657485 = validateParameter(valid_402657485, JString,
                                      required = false, default = nil)
  if valid_402657485 != nil:
    section.add "X-Amz-SignedHeaders", valid_402657485
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_402657487: Call_UpgradePublishedSchema_402657476;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.
                                                                                         ## 
...
proc call*(call_402657488: Call_UpgradePublishedSchema_402657476; body: JsonNode): Recallable =
  ## upgradePublishedSchema
  ## Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.
  ##   
                                                                                                                                    ## body: JObject (required)
  var body_402657489 = newJObject()
  if body != nil:
    body_402657489 = body
  result = call_402657488.call(nil, nil, nil, nil, body_402657489)

var upgradePublishedSchema* = Call_UpgradePublishedSchema_402657476(
    name: "upgradePublishedSchema", meth: HttpMethod.HttpPut,
    host: "clouddirectory.amazonaws.com",
    route: "/amazonclouddirectory/2017-01-11/schema/upgradepublished",
    validator: validate_UpgradePublishedSchema_402657477, base: "/",
    makeUrl: url_UpgradePublishedSchema_402657478,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
