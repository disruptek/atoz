...
type
  Call_BatchDescribeSimulationJob_602803 = ref object of OpenApiRestCall_602466
proc url_BatchDescribeSimulationJob_602805(protocol: Scheme; host: string;
...
proc validate_BatchDescribeSimulationJob_602804(path: JsonNode; query: JsonNode;
...
proc call*(call_602947: Call_BatchDescribeSimulationJob_602803; path: JsonNode;
...
proc call*(call_603018: Call_BatchDescribeSimulationJob_602803; body: JsonNode): Recallable =
...
var batchDescribeSimulationJob* = Call_BatchDescribeSimulationJob_602803(
    name: "batchDescribeSimulationJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/batchDescribeSimulationJob",
    validator: validate_BatchDescribeSimulationJob_602804, base: "/",
    url: url_BatchDescribeSimulationJob_602805,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CancelDeploymentJob_603058 = ref object of OpenApiRestCall_602466
proc url_CancelDeploymentJob_603060(protocol: Scheme; host: string; base: string;
...
proc validate_CancelDeploymentJob_603059(path: JsonNode; query: JsonNode;
...
proc call*(call_603069: Call_CancelDeploymentJob_603058; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Cancels the specified deployment job.
  ## 
...
proc call*(call_603070: Call_CancelDeploymentJob_603058; body: JsonNode): Recallable =
  ## cancelDeploymentJob
  ## Cancels the specified deployment job.
  ##   body: JObject (required)
...
var cancelDeploymentJob* = Call_CancelDeploymentJob_603058(
    name: "cancelDeploymentJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/cancelDeploymentJob",
    validator: validate_CancelDeploymentJob_603059, base: "/",
    url: url_CancelDeploymentJob_603060, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CancelSimulationJob_603072 = ref object of OpenApiRestCall_602466
proc url_CancelSimulationJob_603074(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CancelSimulationJob_603073(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603083: Call_CancelSimulationJob_603072; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Cancels the specified simulation job.
  ## 
...
proc call*(call_603084: Call_CancelSimulationJob_603072; body: JsonNode): Recallable =
  ## cancelSimulationJob
  ## Cancels the specified simulation job.
  ##   body: JObject (required)
...
var cancelSimulationJob* = Call_CancelSimulationJob_603072(
    name: "cancelSimulationJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/cancelSimulationJob",
    validator: validate_CancelSimulationJob_603073, base: "/",
    url: url_CancelSimulationJob_603074, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDeploymentJob_603086 = ref object of OpenApiRestCall_602466
proc url_CreateDeploymentJob_603088(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDeploymentJob_603087(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603097: Call_CreateDeploymentJob_603086; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deploys a specific version of a robot application to robots in a fleet.</p> <p>The robot application must have a numbered <code>applicationVersion</code> for consistency reasons. To create a new version, use <code>CreateRobotApplicationVersion</code> or see <a href="https://docs.aws.amazon.com/robomaker/latest/dg/create-robot-application-version.html">Creating a Robot Application Version</a>. </p> <note> <p>After 90 days, deployment jobs expire and will be deleted. They will no longer be accessible. </p> </note>
  ## 
...
proc call*(call_603098: Call_CreateDeploymentJob_603086; body: JsonNode): Recallable =
  ## createDeploymentJob
  ## <p>Deploys a specific version of a robot application to robots in a fleet.</p> <p>The robot application must have a numbered <code>applicationVersion</code> for consistency reasons. To create a new version, use <code>CreateRobotApplicationVersion</code> or see <a href="https://docs.aws.amazon.com/robomaker/latest/dg/create-robot-application-version.html">Creating a Robot Application Version</a>. </p> <note> <p>After 90 days, deployment jobs expire and will be deleted. They will no longer be accessible. </p> </note>
  ##   body: JObject (required)
...
var createDeploymentJob* = Call_CreateDeploymentJob_603086(
    name: "createDeploymentJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/createDeploymentJob",
    validator: validate_CreateDeploymentJob_603087, base: "/",
    url: url_CreateDeploymentJob_603088, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateFleet_603100 = ref object of OpenApiRestCall_602466
proc url_CreateFleet_603102(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateFleet_603101(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_603111: Call_CreateFleet_603100; path: JsonNode; query: JsonNode;
...
proc call*(call_603112: Call_CreateFleet_603100; body: JsonNode): Recallable =
  ## createFleet
  ## Creates a fleet, a logical group of robots running the same robot application.
  ##   body: JObject (required)
...
var createFleet* = Call_CreateFleet_603100(name: "createFleet",
                                        meth: HttpMethod.HttpPost,
                                        host: "robomaker.amazonaws.com",
                                        route: "/createFleet",
                                        validator: validate_CreateFleet_603101,
                                        base: "/", url: url_CreateFleet_603102,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRobot_603114 = ref object of OpenApiRestCall_602466
proc url_CreateRobot_603116(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateRobot_603115(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a robot.
  ## 
  var section: JsonNode
...
proc call*(call_603125: Call_CreateRobot_603114; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a robot.
  ## 
...
proc call*(call_603126: Call_CreateRobot_603114; body: JsonNode): Recallable =
  ## createRobot
  ## Creates a robot.
  ##   body: JObject (required)
...
var createRobot* = Call_CreateRobot_603114(name: "createRobot",
                                        meth: HttpMethod.HttpPost,
                                        host: "robomaker.amazonaws.com",
                                        route: "/createRobot",
                                        validator: validate_CreateRobot_603115,
                                        base: "/", url: url_CreateRobot_603116,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRobotApplication_603128 = ref object of OpenApiRestCall_602466
proc url_CreateRobotApplication_603130(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateRobotApplication_603129(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603139: Call_CreateRobotApplication_603128; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a robot application. 
  ## 
...
proc call*(call_603140: Call_CreateRobotApplication_603128; body: JsonNode): Recallable =
...
var createRobotApplication* = Call_CreateRobotApplication_603128(
    name: "createRobotApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/createRobotApplication",
    validator: validate_CreateRobotApplication_603129, base: "/",
    url: url_CreateRobotApplication_603130, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateRobotApplicationVersion_603142 = ref object of OpenApiRestCall_602466
proc url_CreateRobotApplicationVersion_603144(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateRobotApplicationVersion_603143(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603153: Call_CreateRobotApplicationVersion_603142; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a version of a robot application.
  ## 
...
proc call*(call_603154: Call_CreateRobotApplicationVersion_603142; body: JsonNode): Recallable =
...
var createRobotApplicationVersion* = Call_CreateRobotApplicationVersion_603142(
    ...
    validator: validate_CreateRobotApplicationVersion_603143, base: "/",
    url: url_CreateRobotApplicationVersion_603144,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSimulationApplication_603156 = ref object of OpenApiRestCall_602466
proc url_CreateSimulationApplication_603158(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSimulationApplication_603157(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603167: Call_CreateSimulationApplication_603156; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a simulation application.
  ## 
...
proc call*(call_603168: Call_CreateSimulationApplication_603156; body: JsonNode): Recallable =
...
var createSimulationApplication* = Call_CreateSimulationApplication_603156(
    name: "createSimulationApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/createSimulationApplication",
    validator: validate_CreateSimulationApplication_603157, base: "/",
    url: url_CreateSimulationApplication_603158,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSimulationApplicationVersion_603170 = ref object of OpenApiRestCall_602466
proc url_CreateSimulationApplicationVersion_603172(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSimulationApplicationVersion_603171(path: JsonNode;
...
proc call*(call_603181: Call_CreateSimulationApplicationVersion_603170;
...
proc call*(call_603182: Call_CreateSimulationApplicationVersion_603170;
          body: JsonNode): Recallable =
...
var createSimulationApplicationVersion* = Call_CreateSimulationApplicationVersion_603170(
    ...
    validator: validate_CreateSimulationApplicationVersion_603171, base: "/",
    url: url_CreateSimulationApplicationVersion_603172,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateSimulationJob_603184 = ref object of OpenApiRestCall_602466
proc url_CreateSimulationJob_603186(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateSimulationJob_603185(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_603195: Call_CreateSimulationJob_603184; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates a simulation job.</p> <note> <p>After 90 days, simulation jobs expire and will be deleted. They will no longer be accessible. </p> </note>
  ## 
...
proc call*(call_603196: Call_CreateSimulationJob_603184; body: JsonNode): Recallable =
  ## createSimulationJob
  ## <p>Creates a simulation job.</p> <note> <p>After 90 days, simulation jobs expire and will be deleted. They will no longer be accessible. </p> </note>
  ##   body: JObject (required)
...
var createSimulationJob* = Call_CreateSimulationJob_603184(
    name: "createSimulationJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/createSimulationJob",
    validator: validate_CreateSimulationJob_603185, base: "/",
    url: url_CreateSimulationJob_603186, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteFleet_603198 = ref object of OpenApiRestCall_602466
proc url_DeleteFleet_603200(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteFleet_603199(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes a fleet.
  ## 
  var section: JsonNode
...
proc call*(call_603209: Call_DeleteFleet_603198; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a fleet.
  ## 
...
proc call*(call_603210: Call_DeleteFleet_603198; body: JsonNode): Recallable =
  ## deleteFleet
  ## Deletes a fleet.
  ##   body: JObject (required)
...
var deleteFleet* = Call_DeleteFleet_603198(name: "deleteFleet",
                                        meth: HttpMethod.HttpPost,
                                        host: "robomaker.amazonaws.com",
                                        route: "/deleteFleet",
                                        validator: validate_DeleteFleet_603199,
                                        base: "/", url: url_DeleteFleet_603200,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRobot_603212 = ref object of OpenApiRestCall_602466
proc url_DeleteRobot_603214(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRobot_603213(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes a robot.
  ## 
  var section: JsonNode
...
proc call*(call_603223: Call_DeleteRobot_603212; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a robot.
  ## 
...
proc call*(call_603224: Call_DeleteRobot_603212; body: JsonNode): Recallable =
  ## deleteRobot
  ## Deletes a robot.
  ##   body: JObject (required)
...
var deleteRobot* = Call_DeleteRobot_603212(name: "deleteRobot",
                                        meth: HttpMethod.HttpPost,
                                        host: "robomaker.amazonaws.com",
                                        route: "/deleteRobot",
                                        validator: validate_DeleteRobot_603213,
                                        base: "/", url: url_DeleteRobot_603214,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteRobotApplication_603226 = ref object of OpenApiRestCall_602466
proc url_DeleteRobotApplication_603228(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteRobotApplication_603227(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603237: Call_DeleteRobotApplication_603226; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a robot application.
  ## 
...
proc call*(call_603238: Call_DeleteRobotApplication_603226; body: JsonNode): Recallable =
...
var deleteRobotApplication* = Call_DeleteRobotApplication_603226(
    name: "deleteRobotApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/deleteRobotApplication",
    validator: validate_DeleteRobotApplication_603227, base: "/",
    url: url_DeleteRobotApplication_603228, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteSimulationApplication_603240 = ref object of OpenApiRestCall_602466
proc url_DeleteSimulationApplication_603242(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteSimulationApplication_603241(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603251: Call_DeleteSimulationApplication_603240; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a simulation application.
  ## 
...
proc call*(call_603252: Call_DeleteSimulationApplication_603240; body: JsonNode): Recallable =
...
var deleteSimulationApplication* = Call_DeleteSimulationApplication_603240(
    name: "deleteSimulationApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/deleteSimulationApplication",
    validator: validate_DeleteSimulationApplication_603241, base: "/",
    url: url_DeleteSimulationApplication_603242,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterRobot_603254 = ref object of OpenApiRestCall_602466
proc url_DeregisterRobot_603256(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterRobot_603255(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ## Deregisters a robot.
  ## 
...
proc call*(call_603265: Call_DeregisterRobot_603254; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deregisters a robot.
  ## 
...
proc call*(call_603266: Call_DeregisterRobot_603254; body: JsonNode): Recallable =
  ## deregisterRobot
  ## Deregisters a robot.
  ##   body: JObject (required)
...
var deregisterRobot* = Call_DeregisterRobot_603254(name: "deregisterRobot",
    meth: HttpMethod.HttpPost, host: "robomaker.amazonaws.com",
    route: "/deregisterRobot", validator: validate_DeregisterRobot_603255,
    base: "/", url: url_DeregisterRobot_603256, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeDeploymentJob_603268 = ref object of OpenApiRestCall_602466
proc url_DescribeDeploymentJob_603270(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeDeploymentJob_603269(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603279: Call_DescribeDeploymentJob_603268; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a deployment job.
  ## 
...
proc call*(call_603280: Call_DescribeDeploymentJob_603268; body: JsonNode): Recallable =
...
var describeDeploymentJob* = Call_DescribeDeploymentJob_603268(
    name: "describeDeploymentJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/describeDeploymentJob",
    validator: validate_DescribeDeploymentJob_603269, base: "/",
    url: url_DescribeDeploymentJob_603270, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeFleet_603282 = ref object of OpenApiRestCall_602466
proc url_DescribeFleet_603284(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeFleet_603283(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ## Describes a fleet.
  ## 
  var section: JsonNode
...
proc call*(call_603293: Call_DescribeFleet_603282; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a fleet.
  ## 
...
proc call*(call_603294: Call_DescribeFleet_603282; body: JsonNode): Recallable =
  ## describeFleet
  ## Describes a fleet.
  ##   body: JObject (required)
...
var describeFleet* = Call_DescribeFleet_603282(name: "describeFleet",
    meth: HttpMethod.HttpPost, host: "robomaker.amazonaws.com",
    route: "/describeFleet", validator: validate_DescribeFleet_603283, base: "/",
    url: url_DescribeFleet_603284, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRobot_603296 = ref object of OpenApiRestCall_602466
proc url_DescribeRobot_603298(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeRobot_603297(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ## Describes a robot.
  ## 
  var section: JsonNode
...
proc call*(call_603307: Call_DescribeRobot_603296; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a robot.
  ## 
...
proc call*(call_603308: Call_DescribeRobot_603296; body: JsonNode): Recallable =
  ## describeRobot
  ## Describes a robot.
  ##   body: JObject (required)
...
var describeRobot* = Call_DescribeRobot_603296(name: "describeRobot",
    meth: HttpMethod.HttpPost, host: "robomaker.amazonaws.com",
    route: "/describeRobot", validator: validate_DescribeRobot_603297, base: "/",
    url: url_DescribeRobot_603298, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRobotApplication_603310 = ref object of OpenApiRestCall_602466
proc url_DescribeRobotApplication_603312(protocol: Scheme; host: string;
...
proc validate_DescribeRobotApplication_603311(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603321: Call_DescribeRobotApplication_603310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a robot application.
  ## 
...
proc call*(call_603322: Call_DescribeRobotApplication_603310; body: JsonNode): Recallable =
...
var describeRobotApplication* = Call_DescribeRobotApplication_603310(
    name: "describeRobotApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/describeRobotApplication",
    validator: validate_DescribeRobotApplication_603311, base: "/",
    url: url_DescribeRobotApplication_603312, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSimulationApplication_603324 = ref object of OpenApiRestCall_602466
proc url_DescribeSimulationApplication_603326(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSimulationApplication_603325(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603335: Call_DescribeSimulationApplication_603324; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a simulation application.
  ## 
...
proc call*(call_603336: Call_DescribeSimulationApplication_603324; body: JsonNode): Recallable =
...
var describeSimulationApplication* = Call_DescribeSimulationApplication_603324(
    ...
    validator: validate_DescribeSimulationApplication_603325, base: "/",
    url: url_DescribeSimulationApplication_603326,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSimulationJob_603338 = ref object of OpenApiRestCall_602466
proc url_DescribeSimulationJob_603340(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSimulationJob_603339(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603349: Call_DescribeSimulationJob_603338; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes a simulation job.
  ## 
...
proc call*(call_603350: Call_DescribeSimulationJob_603338; body: JsonNode): Recallable =
...
var describeSimulationJob* = Call_DescribeSimulationJob_603338(
    name: "describeSimulationJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/describeSimulationJob",
    validator: validate_DescribeSimulationJob_603339, base: "/",
    url: url_DescribeSimulationJob_603340, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDeploymentJobs_603352 = ref object of OpenApiRestCall_602466
proc url_ListDeploymentJobs_603354(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDeploymentJobs_603353(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_603365: Call_ListDeploymentJobs_603352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns a list of deployment jobs for a fleet. You can optionally provide filters to retrieve specific deployment jobs. </p> <note> <p> </p> </note>
  ## 
...
proc call*(call_603366: Call_ListDeploymentJobs_603352; body: JsonNode;
  ...
  if body != nil:
    body_603368 = body
  result = call_603366.call(nil, query_603367, nil, nil, body_603368)

var listDeploymentJobs* = Call_ListDeploymentJobs_603352(
    name: "listDeploymentJobs", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/listDeploymentJobs",
    validator: validate_ListDeploymentJobs_603353, base: "/",
    url: url_ListDeploymentJobs_603354, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListFleets_603370 = ref object of OpenApiRestCall_602466
proc url_ListFleets_603372(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListFleets_603371(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603383: Call_ListFleets_603370; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of fleets. You can optionally provide filters to retrieve specific fleets. 
  ## 
...
proc call*(call_603384: Call_ListFleets_603370; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ## listFleets
  ## Returns a list of fleets. You can optionally provide filters to retrieve specific fleets. 
  ##   maxResults: string
...
var listFleets* = Call_ListFleets_603370(name: "listFleets",
                                      meth: HttpMethod.HttpPost,
                                      host: "robomaker.amazonaws.com",
                                      route: "/listFleets",
                                      validator: validate_ListFleets_603371,
                                      base: "/", url: url_ListFleets_603372,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListRobotApplications_603387 = ref object of OpenApiRestCall_602466
proc url_ListRobotApplications_603389(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListRobotApplications_603388(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603400: Call_ListRobotApplications_603387; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of robot application. You can optionally provide filters to retrieve specific robot applications.
  ## 
...
proc call*(call_603401: Call_ListRobotApplications_603387; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ...
  add(query_603402, "maxResults", newJString(maxResults))
  add(query_603402, "nextToken", newJString(nextToken))
  if body != nil:
    body_603403 = body
  result = call_603401.call(nil, query_603402, nil, nil, body_603403)

var listRobotApplications* = Call_ListRobotApplications_603387(
    name: "listRobotApplications", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/listRobotApplications",
    validator: validate_ListRobotApplications_603388, base: "/",
    url: url_ListRobotApplications_603389, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListRobots_603404 = ref object of OpenApiRestCall_602466
proc url_ListRobots_603406(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListRobots_603405(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_603407 = query.getOrDefault("maxResults")
  valid_603407 = validateParameter(valid_603407, JString, required = false,
                                 default = nil)
  if valid_603407 != nil:
    section.add "maxResults", valid_603407
  var valid_603408 = query.getOrDefault("nextToken")
  valid_603408 = validateParameter(valid_603408, JString, required = false,
                                 default = nil)
  if valid_603408 != nil:
    section.add "nextToken", valid_603408
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_603417: Call_ListRobots_603404; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of robots. You can optionally provide filters to retrieve specific robots.
  ## 
...
proc call*(call_603418: Call_ListRobots_603404; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ## listRobots
  ## Returns a list of robots. You can optionally provide filters to retrieve specific robots.
  ##   maxResults: string
  ...
  add(query_603419, "maxResults", newJString(maxResults))
  add(query_603419, "nextToken", newJString(nextToken))
  if body != nil:
    body_603420 = body
  result = call_603418.call(nil, query_603419, nil, nil, body_603420)

var listRobots* = Call_ListRobots_603404(name: "listRobots",
                                      meth: HttpMethod.HttpPost,
                                      host: "robomaker.amazonaws.com",
                                      route: "/listRobots",
                                      validator: validate_ListRobots_603405,
                                      base: "/", url: url_ListRobots_603406,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSimulationApplications_603421 = ref object of OpenApiRestCall_602466
proc url_ListSimulationApplications_603423(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSimulationApplications_603422(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_603424 = query.getOrDefault("maxResults")
  valid_603424 = validateParameter(valid_603424, JString, required = false,
                                 default = nil)
  if valid_603424 != nil:
    section.add "maxResults", valid_603424
  var valid_603425 = query.getOrDefault("nextToken")
  valid_603425 = validateParameter(valid_603425, JString, required = false,
                                 default = nil)
  if valid_603425 != nil:
    section.add "nextToken", valid_603425
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_603434: Call_ListSimulationApplications_603421; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of simulation applications. You can optionally provide filters to retrieve specific simulation applications. 
  ## 
...
proc call*(call_603435: Call_ListSimulationApplications_603421; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ...
  add(query_603436, "maxResults", newJString(maxResults))
  add(query_603436, "nextToken", newJString(nextToken))
  if body != nil:
    body_603437 = body
  result = call_603435.call(nil, query_603436, nil, nil, body_603437)

var listSimulationApplications* = Call_ListSimulationApplications_603421(
    name: "listSimulationApplications", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/listSimulationApplications",
    validator: validate_ListSimulationApplications_603422, base: "/",
    url: url_ListSimulationApplications_603423,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSimulationJobs_603438 = ref object of OpenApiRestCall_602466
proc url_ListSimulationJobs_603440(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListSimulationJobs_603439(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  ##            : Pagination token
  section = newJObject()
  var valid_603441 = query.getOrDefault("maxResults")
  valid_603441 = validateParameter(valid_603441, JString, required = false,
                                 default = nil)
  if valid_603441 != nil:
    section.add "maxResults", valid_603441
  var valid_603442 = query.getOrDefault("nextToken")
  valid_603442 = validateParameter(valid_603442, JString, required = false,
                                 default = nil)
  if valid_603442 != nil:
    section.add "nextToken", valid_603442
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_603451: Call_ListSimulationJobs_603438; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of simulation jobs. You can optionally provide filters to retrieve specific simulation jobs. 
  ## 
...
proc call*(call_603452: Call_ListSimulationJobs_603438; body: JsonNode;
          maxResults: string = ""; nextToken: string = ""): Recallable =
  ## listSimulationJobs
  ## Returns a list of simulation jobs. You can optionally provide filters to retrieve specific simulation jobs. 
  ##   maxResults: string
...
var listSimulationJobs* = Call_ListSimulationJobs_603438(
    name: "listSimulationJobs", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/listSimulationJobs",
    validator: validate_ListSimulationJobs_603439, base: "/",
    url: url_ListSimulationJobs_603440, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource_603483 = ref object of OpenApiRestCall_602466
proc url_TagResource_603485(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagResource_603484(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603495: Call_TagResource_603483; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Adds or edits tags for a AWS RoboMaker resource.</p> <p>Each tag consists of a tag key and a tag value. Tag keys and tag values are both required, but tag values can be empty strings. </p> <p>For information about the rules that apply to tag keys and tag values, see <a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html">User-Defined Tag Restrictions</a> in the <i>AWS Billing and Cost Management User Guide</i>. </p>
  ## 
...
proc call*(call_603496: Call_TagResource_603483; body: JsonNode; resourceArn: string): Recallable =
  ## tagResource
  ## <p>Adds or edits tags for a AWS RoboMaker resource.</p> <p>Each tag consists of a tag key and a tag value. Tag keys and tag values are both required, but tag values can be empty strings. </p> <p>For information about the rules that apply to tag keys and tag values, see <a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html">User-Defined Tag Restrictions</a> in the <i>AWS Billing and Cost Management User Guide</i>. </p>
  ##   body: JObject (required)
  ...
  result = call_603496.call(path_603497, nil, nil, nil, body_603498)

var tagResource* = Call_TagResource_603483(name: "tagResource",
                                        meth: HttpMethod.HttpPost,
                                        host: "robomaker.amazonaws.com",
                                        route: "/tags/{resourceArn}",
                                        validator: validate_TagResource_603484,
                                        base: "/", url: url_TagResource_603485,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_603455 = ref object of OpenApiRestCall_602466
...
proc validate_ListTagsForResource_603456(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceArn` field"
  var valid_603472 = path.getOrDefault("resourceArn")
  valid_603472 = validateParameter(valid_603472, JString, required = true,
                                 default = nil)
  if valid_603472 != nil:
    section.add "resourceArn", valid_603472
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_603480: Call_ListTagsForResource_603455; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all tags on a AWS RoboMaker resource.
  ## 
...
proc call*(call_603481: Call_ListTagsForResource_603455; resourceArn: string): Recallable =
  ## listTagsForResource
  ## Lists all tags on a AWS RoboMaker resource.
  ##   resourceArn: string (required)
  ##              : The AWS RoboMaker Amazon Resource Name (ARN) with tags to be listed.
  var path_603482 = newJObject()
  add(path_603482, "resourceArn", newJString(resourceArn))
...
type
  Call_RegisterRobot_603499 = ref object of OpenApiRestCall_602466
proc url_RegisterRobot_603501(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterRobot_603500(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603510: Call_RegisterRobot_603499; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Registers a robot with a fleet.
  ## 
...
proc call*(call_603511: Call_RegisterRobot_603499; body: JsonNode): Recallable =
  ## registerRobot
  ## Registers a robot with a fleet.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_603512 = body
  result = call_603511.call(nil, nil, nil, nil, body_603512)

var registerRobot* = Call_RegisterRobot_603499(name: "registerRobot",
    meth: HttpMethod.HttpPost, host: "robomaker.amazonaws.com",
    route: "/registerRobot", validator: validate_RegisterRobot_603500, base: "/",
    url: url_RegisterRobot_603501, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RestartSimulationJob_603513 = ref object of OpenApiRestCall_602466
proc url_RestartSimulationJob_603515(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RestartSimulationJob_603514(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603524: Call_RestartSimulationJob_603513; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Restarts a running simulation job.
  ## 
...
proc call*(call_603525: Call_RestartSimulationJob_603513; body: JsonNode): Recallable =
...
var restartSimulationJob* = Call_RestartSimulationJob_603513(
    name: "restartSimulationJob", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/restartSimulationJob",
    validator: validate_RestartSimulationJob_603514, base: "/",
    url: url_RestartSimulationJob_603515, schemes: {Scheme.Https, Scheme.Http})
type
  Call_SyncDeploymentJob_603527 = ref object of OpenApiRestCall_602466
proc url_SyncDeploymentJob_603529(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SyncDeploymentJob_603528(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_603538: Call_SyncDeploymentJob_603527; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Syncrhonizes robots in a fleet to the latest deployment. This is helpful if robots were added after a deployment.
  ## 
...
proc call*(call_603539: Call_SyncDeploymentJob_603527; body: JsonNode): Recallable =
  ## syncDeploymentJob
  ## Syncrhonizes robots in a fleet to the latest deployment. This is helpful if robots were added after a deployment.
  ##   body: JObject (required)
...
var syncDeploymentJob* = Call_SyncDeploymentJob_603527(name: "syncDeploymentJob",
    meth: HttpMethod.HttpPost, host: "robomaker.amazonaws.com",
    route: "/syncDeploymentJob", validator: validate_SyncDeploymentJob_603528,
    base: "/", url: url_SyncDeploymentJob_603529,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource_603541 = ref object of OpenApiRestCall_602466
proc url_UntagResource_603543(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource_603542(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceArn` field"
  var valid_603544 = path.getOrDefault("resourceArn")
  valid_603544 = validateParameter(valid_603544, JString, required = true,
                                 default = nil)
  if valid_603544 != nil:
    section.add "resourceArn", valid_603544
  result.add "path", section
  ## parameters in `query` object:
  ...
  var valid_603545 = query.getOrDefault("tagKeys")
  valid_603545 = validateParameter(valid_603545, JArray, required = true, default = nil)
  if valid_603545 != nil:
    section.add "tagKeys", valid_603545
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_603553: Call_UntagResource_603541; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Removes the specified tags from the specified AWS RoboMaker resource.</p> <p>To remove a tag, specify the tag key. To change the tag value of an existing tag key, use <a href="https://docs.aws.amazon.com/robomaker/latest/dg/API_TagResource.html"> <code>TagResource</code> </a>. </p>
  ## 
...
proc call*(call_603554: Call_UntagResource_603541; tagKeys: JsonNode;
  ...
  ##   resourceArn: string (required)
  ##              : The Amazon Resource Name (ARN) of the AWS RoboMaker resource you are removing tags.
  var path_603555 = newJObject()
  var query_603556 = newJObject()
  if tagKeys != nil:
    query_603556.add "tagKeys", tagKeys
  add(path_603555, "resourceArn", newJString(resourceArn))
  result = call_603554.call(path_603555, query_603556, nil, nil, nil)

var untagResource* = Call_UntagResource_603541(name: "untagResource",
    meth: HttpMethod.HttpDelete, host: "robomaker.amazonaws.com",
    route: "/tags/{resourceArn}#tagKeys", validator: validate_UntagResource_603542,
    base: "/", url: url_UntagResource_603543, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateRobotApplication_603557 = ref object of OpenApiRestCall_602466
proc url_UpdateRobotApplication_603559(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateRobotApplication_603558(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603568: Call_UpdateRobotApplication_603557; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a robot application.
  ## 
...
proc call*(call_603569: Call_UpdateRobotApplication_603557; body: JsonNode): Recallable =
...
var updateRobotApplication* = Call_UpdateRobotApplication_603557(
    name: "updateRobotApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/updateRobotApplication",
    validator: validate_UpdateRobotApplication_603558, base: "/",
    url: url_UpdateRobotApplication_603559, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateSimulationApplication_603571 = ref object of OpenApiRestCall_602466
proc url_UpdateSimulationApplication_603573(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateSimulationApplication_603572(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_603582: Call_UpdateSimulationApplication_603571; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a simulation application.
  ## 
...
proc call*(call_603583: Call_UpdateSimulationApplication_603571; body: JsonNode): Recallable =
  ## updateSimulationApplication
  ## Updates a simulation application.
  ##   body: JObject (required)
  var body_603584 = newJObject()
  if body != nil:
    body_603584 = body
  result = call_603583.call(nil, nil, nil, nil, body_603584)

var updateSimulationApplication* = Call_UpdateSimulationApplication_603571(
    name: "updateSimulationApplication", meth: HttpMethod.HttpPost,
    host: "robomaker.amazonaws.com", route: "/updateSimulationApplication",
    validator: validate_UpdateSimulationApplication_603572, base: "/",
    url: url_UpdateSimulationApplication_603573,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
