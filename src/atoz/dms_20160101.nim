...
type
  Call_ApplyPendingMaintenanceAction_21626029 = ref object of OpenApiRestCall_21625435
proc url_ApplyPendingMaintenanceAction_21626031(protocol: Scheme; host: string;
...
proc validate_ApplyPendingMaintenanceAction_21626030(path: JsonNode;
...
proc call*(call_21626041: Call_ApplyPendingMaintenanceAction_21626029;
...
proc call*(call_21626042: Call_ApplyPendingMaintenanceAction_21626029;
...
var applyPendingMaintenanceAction* = Call_ApplyPendingMaintenanceAction_21626029(
    ...
    validator: validate_ApplyPendingMaintenanceAction_21626030, base: "/",
    makeUrl: url_ApplyPendingMaintenanceAction_21626031,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpoint_21626044 = ref object of OpenApiRestCall_21625435
proc url_CreateEndpoint_21626046(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpoint_21626045(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626056: Call_CreateEndpoint_21626044; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates an endpoint using the provided settings.
  ## 
...
proc call*(call_21626057: Call_CreateEndpoint_21626044; body: JsonNode): Recallable =
  ## createEndpoint
  ## Creates an endpoint using the provided settings.
  ##   body: JObject (required)
...
var createEndpoint* = Call_CreateEndpoint_21626044(name: "createEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateEndpoint",
    validator: validate_CreateEndpoint_21626045, base: "/",
    makeUrl: url_CreateEndpoint_21626046, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEventSubscription_21626059 = ref object of OpenApiRestCall_21625435
proc url_CreateEventSubscription_21626061(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEventSubscription_21626060(path: JsonNode; query: JsonNode;
...
proc call*(call_21626071: Call_CreateEventSubscription_21626059;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p> Creates an AWS DMS event notification subscription. </p> <p>You can specify the type of source (<code>SourceType</code>) you want to be notified of, provide a list of AWS DMS source IDs (<code>SourceIds</code>) that triggers the events, and provide a list of event categories (<code>EventCategories</code>) for events you want to be notified of. If you specify both the <code>SourceType</code> and <code>SourceIds</code>, such as <code>SourceType = replication-instance</code> and <code>SourceIdentifier = my-replinstance</code>, you will be notified of all the replication instance events for the specified source. If you specify a <code>SourceType</code> but don't specify a <code>SourceIdentifier</code>, you receive notice of the events for that source type for all your AWS DMS sources. If you don't specify either <code>SourceType</code> nor <code>SourceIdentifier</code>, you will be notified of events generated from all AWS DMS sources belonging to your customer account.</p> <p>For more information about AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ## 
...
proc call*(call_21626072: Call_CreateEventSubscription_21626059; body: JsonNode): Recallable =
...
var createEventSubscription* = Call_CreateEventSubscription_21626059(
    name: "createEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateEventSubscription",
    validator: validate_CreateEventSubscription_21626060, base: "/",
    makeUrl: url_CreateEventSubscription_21626061,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationInstance_21626074 = ref object of OpenApiRestCall_21625435
proc url_CreateReplicationInstance_21626076(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateReplicationInstance_21626075(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_CreateReplicationInstance_21626074;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Creates the replication instance using the specified parameters.</p> <p>AWS DMS requires that your account have certain roles with appropriate permissions before you can create a replication instance. For information on the required roles, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.APIRole.html">Creating the IAM Roles to Use With the AWS CLI and AWS DMS API</a>. For information on the required permissions, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.IAMPermissions.html">IAM Permissions Needed to Use AWS DMS</a>.</p>
  ## 
...
proc call*(call_21626087: Call_CreateReplicationInstance_21626074; body: JsonNode): Recallable =
...
var createReplicationInstance* = Call_CreateReplicationInstance_21626074(
    name: "createReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationInstance",
    validator: validate_CreateReplicationInstance_21626075, base: "/",
    makeUrl: url_CreateReplicationInstance_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationSubnetGroup_21626089 = ref object of OpenApiRestCall_21625435
proc url_CreateReplicationSubnetGroup_21626091(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateReplicationSubnetGroup_21626090(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626101: Call_CreateReplicationSubnetGroup_21626089;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a replication subnet group given a list of the subnet IDs in a VPC.
  ## 
...
proc call*(call_21626102: Call_CreateReplicationSubnetGroup_21626089;
          body: JsonNode): Recallable =
...
var createReplicationSubnetGroup* = Call_CreateReplicationSubnetGroup_21626089(
    ...
    validator: validate_CreateReplicationSubnetGroup_21626090, base: "/",
    makeUrl: url_CreateReplicationSubnetGroup_21626091,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationTask_21626104 = ref object of OpenApiRestCall_21625435
proc url_CreateReplicationTask_21626106(protocol: Scheme; host: string; base: string;
...
proc validate_CreateReplicationTask_21626105(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626116: Call_CreateReplicationTask_21626104;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Creates a replication task using the specified parameters.
  ## 
...
proc call*(call_21626117: Call_CreateReplicationTask_21626104; body: JsonNode): Recallable =
...
var createReplicationTask* = Call_CreateReplicationTask_21626104(
    name: "createReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationTask",
    validator: validate_CreateReplicationTask_21626105, base: "/",
    makeUrl: url_CreateReplicationTask_21626106,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteCertificate_21626119 = ref object of OpenApiRestCall_21625435
proc url_DeleteCertificate_21626121(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteCertificate_21626120(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_DeleteCertificate_21626119; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the specified certificate. 
  ## 
...
proc call*(call_21626132: Call_DeleteCertificate_21626119; body: JsonNode): Recallable =
  ## deleteCertificate
  ## Deletes the specified certificate. 
  ##   body: JObject (required)
...
var deleteCertificate* = Call_DeleteCertificate_21626119(name: "deleteCertificate",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteCertificate",
    validator: validate_DeleteCertificate_21626120, base: "/",
    makeUrl: url_DeleteCertificate_21626121, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConnection_21626134 = ref object of OpenApiRestCall_21625435
proc url_DeleteConnection_21626136(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteConnection_21626135(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626146: Call_DeleteConnection_21626134; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the connection between a replication instance and an endpoint.
  ## 
...
proc call*(call_21626147: Call_DeleteConnection_21626134; body: JsonNode): Recallable =
  ## deleteConnection
  ## Deletes the connection between a replication instance and an endpoint.
  ##   body: JObject (required)
...
var deleteConnection* = Call_DeleteConnection_21626134(name: "deleteConnection",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteConnection",
    validator: validate_DeleteConnection_21626135, base: "/",
    makeUrl: url_DeleteConnection_21626136, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpoint_21626149 = ref object of OpenApiRestCall_21625435
proc url_DeleteEndpoint_21626151(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpoint_21626150(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626161: Call_DeleteEndpoint_21626149; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes the specified endpoint.</p> <note> <p>All tasks associated with the endpoint must be deleted before you can delete the endpoint.</p> </note> <p/>
  ## 
...
proc call*(call_21626162: Call_DeleteEndpoint_21626149; body: JsonNode): Recallable =
  ## deleteEndpoint
  ## <p>Deletes the specified endpoint.</p> <note> <p>All tasks associated with the endpoint must be deleted before you can delete the endpoint.</p> </note> <p/>
  ##   body: JObject (required)
...
var deleteEndpoint* = Call_DeleteEndpoint_21626149(name: "deleteEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteEndpoint",
    validator: validate_DeleteEndpoint_21626150, base: "/",
    makeUrl: url_DeleteEndpoint_21626151, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEventSubscription_21626164 = ref object of OpenApiRestCall_21625435
proc url_DeleteEventSubscription_21626166(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEventSubscription_21626165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626176: Call_DeleteEventSubscription_21626164;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Deletes an AWS DMS event subscription. 
  ## 
...
proc call*(call_21626177: Call_DeleteEventSubscription_21626164; body: JsonNode): Recallable =
...
var deleteEventSubscription* = Call_DeleteEventSubscription_21626164(
    name: "deleteEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteEventSubscription",
    validator: validate_DeleteEventSubscription_21626165, base: "/",
    makeUrl: url_DeleteEventSubscription_21626166,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationInstance_21626179 = ref object of OpenApiRestCall_21625435
proc url_DeleteReplicationInstance_21626181(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteReplicationInstance_21626180(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626191: Call_DeleteReplicationInstance_21626179;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes the specified replication instance.</p> <note> <p>You must delete any migration tasks that are associated with the replication instance before you can delete it.</p> </note> <p/>
  ## 
...
proc call*(call_21626192: Call_DeleteReplicationInstance_21626179; body: JsonNode): Recallable =
...
var deleteReplicationInstance* = Call_DeleteReplicationInstance_21626179(
    name: "deleteReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationInstance",
    validator: validate_DeleteReplicationInstance_21626180, base: "/",
    makeUrl: url_DeleteReplicationInstance_21626181,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationSubnetGroup_21626194 = ref object of OpenApiRestCall_21625435
proc url_DeleteReplicationSubnetGroup_21626196(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteReplicationSubnetGroup_21626195(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626206: Call_DeleteReplicationSubnetGroup_21626194;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a subnet group.
  ## 
...
proc call*(call_21626207: Call_DeleteReplicationSubnetGroup_21626194;
          body: JsonNode): Recallable =
...
var deleteReplicationSubnetGroup* = Call_DeleteReplicationSubnetGroup_21626194(
    ...
    validator: validate_DeleteReplicationSubnetGroup_21626195, base: "/",
    makeUrl: url_DeleteReplicationSubnetGroup_21626196,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationTask_21626209 = ref object of OpenApiRestCall_21625435
proc url_DeleteReplicationTask_21626211(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteReplicationTask_21626210(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626221: Call_DeleteReplicationTask_21626209;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes the specified replication task.
  ## 
...
proc call*(call_21626222: Call_DeleteReplicationTask_21626209; body: JsonNode): Recallable =
...
var deleteReplicationTask* = Call_DeleteReplicationTask_21626209(
    name: "deleteReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationTask",
    validator: validate_DeleteReplicationTask_21626210, base: "/",
    makeUrl: url_DeleteReplicationTask_21626211,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccountAttributes_21626224 = ref object of OpenApiRestCall_21625435
proc url_DescribeAccountAttributes_21626226(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccountAttributes_21626225(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626236: Call_DescribeAccountAttributes_21626224;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists all of the AWS DMS attributes for a customer account. These attributes include AWS DMS quotas for the account and a unique account identifier in a particular DMS region. DMS quotas include a list of resource quotas supported by the account, such as the number of replication instances allowed. The description for each resource quota, includes the quota name, current usage toward that quota, and the quota's maximum value. DMS uses the unique account identifier to name each artifact used by DMS in the given region.</p> <p>This command does not take any parameters.</p>
  ## 
...
proc call*(call_21626237: Call_DescribeAccountAttributes_21626224; body: JsonNode): Recallable =
...
var describeAccountAttributes* = Call_DescribeAccountAttributes_21626224(
    name: "describeAccountAttributes", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeAccountAttributes",
    validator: validate_DescribeAccountAttributes_21626225, base: "/",
    makeUrl: url_DescribeAccountAttributes_21626226,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeCertificates_21626239 = ref object of OpenApiRestCall_21625435
proc url_DescribeCertificates_21626241(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeCertificates_21626240(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##         : Pagination token
  section = newJObject()
  var valid_21626242 = query.getOrDefault("MaxRecords")
  valid_21626242 = validateParameter(valid_21626242, JString, required = false,
                                   default = nil)
  if valid_21626242 != nil:
    section.add "MaxRecords", valid_21626242
  var valid_21626243 = query.getOrDefault("Marker")
  valid_21626243 = validateParameter(valid_21626243, JString, required = false,
                                   default = nil)
  if valid_21626243 != nil:
    section.add "Marker", valid_21626243
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626253: Call_DescribeCertificates_21626239; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Provides a description of the certificate.
  ## 
...
proc call*(call_21626254: Call_DescribeCertificates_21626239; body: JsonNode;
  ...
  add(query_21626256, "MaxRecords", newJString(MaxRecords))
  add(query_21626256, "Marker", newJString(Marker))
  if body != nil:
    body_21626257 = body
  result = call_21626254.call(nil, query_21626256, nil, nil, body_21626257)

var describeCertificates* = Call_DescribeCertificates_21626239(
    name: "describeCertificates", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeCertificates",
    validator: validate_DescribeCertificates_21626240, base: "/",
    makeUrl: url_DescribeCertificates_21626241,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConnections_21626261 = ref object of OpenApiRestCall_21625435
proc url_DescribeConnections_21626263(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeConnections_21626262(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##         : Pagination token
  section = newJObject()
  var valid_21626264 = query.getOrDefault("MaxRecords")
  valid_21626264 = validateParameter(valid_21626264, JString, required = false,
                                   default = nil)
  if valid_21626264 != nil:
    section.add "MaxRecords", valid_21626264
  var valid_21626265 = query.getOrDefault("Marker")
  valid_21626265 = validateParameter(valid_21626265, JString, required = false,
                                   default = nil)
  if valid_21626265 != nil:
    section.add "Marker", valid_21626265
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626275: Call_DescribeConnections_21626261; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes the status of the connections that have been made between the replication instance and an endpoint. Connections are created when you test an endpoint.
  ## 
...
proc call*(call_21626276: Call_DescribeConnections_21626261; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ## describeConnections
  ## Describes the status of the connections that have been made between the replication instance and an endpoint. Connections are created when you test an endpoint.
  ##   MaxRecords: string
  ...
  add(query_21626277, "MaxRecords", newJString(MaxRecords))
  add(query_21626277, "Marker", newJString(Marker))
  if body != nil:
    body_21626278 = body
  result = call_21626276.call(nil, query_21626277, nil, nil, body_21626278)

var describeConnections* = Call_DescribeConnections_21626261(
    name: "describeConnections", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeConnections",
    validator: validate_DescribeConnections_21626262, base: "/",
    makeUrl: url_DescribeConnections_21626263,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointTypes_21626279 = ref object of OpenApiRestCall_21625435
proc url_DescribeEndpointTypes_21626281(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeEndpointTypes_21626280(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626286 = header.getOrDefault("X-Amz-Target")
  valid_21626286 = validateParameter(valid_21626286, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeEndpointTypes"))
  if valid_21626286 != nil:
    section.add "X-Amz-Target", valid_21626286
...
proc call*(call_21626293: Call_DescribeEndpointTypes_21626279;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about the type of endpoints available.
  ## 
...
proc call*(call_21626294: Call_DescribeEndpointTypes_21626279; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626295, "MaxRecords", newJString(MaxRecords))
  add(query_21626295, "Marker", newJString(Marker))
  if body != nil:
    body_21626296 = body
  result = call_21626294.call(nil, query_21626295, nil, nil, body_21626296)

var describeEndpointTypes* = Call_DescribeEndpointTypes_21626279(
    name: "describeEndpointTypes", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpointTypes",
    validator: validate_DescribeEndpointTypes_21626280, base: "/",
    makeUrl: url_DescribeEndpointTypes_21626281,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpoints_21626297 = ref object of OpenApiRestCall_21625435
proc url_DescribeEndpoints_21626299(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpoints_21626298(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626311: Call_DescribeEndpoints_21626297; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about the endpoints for your account in the current region.
  ## 
...
proc call*(call_21626312: Call_DescribeEndpoints_21626297; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ## describeEndpoints
  ## Returns information about the endpoints for your account in the current region.
  ##   MaxRecords: string
  ...
  add(query_21626313, "MaxRecords", newJString(MaxRecords))
  add(query_21626313, "Marker", newJString(Marker))
  if body != nil:
    body_21626314 = body
  result = call_21626312.call(nil, query_21626313, nil, nil, body_21626314)

var describeEndpoints* = Call_DescribeEndpoints_21626297(name: "describeEndpoints",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpoints",
    validator: validate_DescribeEndpoints_21626298, base: "/",
    makeUrl: url_DescribeEndpoints_21626299, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEventCategories_21626315 = ref object of OpenApiRestCall_21625435
proc url_DescribeEventCategories_21626317(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEventCategories_21626316(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626327: Call_DescribeEventCategories_21626315;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration Service User Guide.</i> 
  ## 
...
proc call*(call_21626328: Call_DescribeEventCategories_21626315; body: JsonNode): Recallable =
...
var describeEventCategories* = Call_DescribeEventCategories_21626315(
    name: "describeEventCategories", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEventCategories",
    validator: validate_DescribeEventCategories_21626316, base: "/",
    makeUrl: url_DescribeEventCategories_21626317,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEventSubscriptions_21626330 = ref object of OpenApiRestCall_21625435
proc url_DescribeEventSubscriptions_21626332(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEventSubscriptions_21626331(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##         : Pagination token
  section = newJObject()
  var valid_21626333 = query.getOrDefault("MaxRecords")
  valid_21626333 = validateParameter(valid_21626333, JString, required = false,
                                   default = nil)
  if valid_21626333 != nil:
    section.add "MaxRecords", valid_21626333
  var valid_21626334 = query.getOrDefault("Marker")
  valid_21626334 = validateParameter(valid_21626334, JString, required = false,
                                   default = nil)
  if valid_21626334 != nil:
    section.add "Marker", valid_21626334
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_21626344: Call_DescribeEventSubscriptions_21626330;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Lists all the event subscriptions for a customer account. The description of a subscription includes <code>SubscriptionName</code>, <code>SNSTopicARN</code>, <code>CustomerID</code>, <code>SourceType</code>, <code>SourceID</code>, <code>CreationTime</code>, and <code>Status</code>. </p> <p>If you specify <code>SubscriptionName</code>, this action lists the description for that subscription.</p>
  ## 
...
proc call*(call_21626345: Call_DescribeEventSubscriptions_21626330; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626346, "MaxRecords", newJString(MaxRecords))
  add(query_21626346, "Marker", newJString(Marker))
  if body != nil:
    body_21626347 = body
  result = call_21626345.call(nil, query_21626346, nil, nil, body_21626347)

var describeEventSubscriptions* = Call_DescribeEventSubscriptions_21626330(
    name: "describeEventSubscriptions", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEventSubscriptions",
    validator: validate_DescribeEventSubscriptions_21626331, base: "/",
    makeUrl: url_DescribeEventSubscriptions_21626332,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEvents_21626348 = ref object of OpenApiRestCall_21625435
proc url_DescribeEvents_21626350(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEvents_21626349(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##         : Pagination token
  section = newJObject()
  var valid_21626351 = query.getOrDefault("MaxRecords")
  valid_21626351 = validateParameter(valid_21626351, JString, required = false,
                                   default = nil)
  if valid_21626351 != nil:
    section.add "MaxRecords", valid_21626351
  var valid_21626352 = query.getOrDefault("Marker")
  valid_21626352 = validateParameter(valid_21626352, JString, required = false,
                                   default = nil)
  if valid_21626352 != nil:
    section.add "Marker", valid_21626352
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
  ...
  var valid_21626355 = header.getOrDefault("X-Amz-Target")
  valid_21626355 = validateParameter(valid_21626355, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeEvents"))
  if valid_21626355 != nil:
    section.add "X-Amz-Target", valid_21626355
...
proc call*(call_21626362: Call_DescribeEvents_21626348; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ##  Lists events for a given source identifier and source type. You can also specify a start and end time. For more information on AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration User Guide.</i> 
  ## 
...
proc call*(call_21626363: Call_DescribeEvents_21626348; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ## describeEvents
  ##  Lists events for a given source identifier and source type. You can also specify a start and end time. For more information on AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration User Guide.</i> 
  ##   MaxRecords: string
  ...
  var body_21626365 = newJObject()
  add(query_21626364, "MaxRecords", newJString(MaxRecords))
  add(query_21626364, "Marker", newJString(Marker))
  if body != nil:
    body_21626365 = body
  result = call_21626363.call(nil, query_21626364, nil, nil, body_21626365)

var describeEvents* = Call_DescribeEvents_21626348(name: "describeEvents",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEvents",
    validator: validate_DescribeEvents_21626349, base: "/",
    makeUrl: url_DescribeEvents_21626350, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOrderableReplicationInstances_21626366 = ref object of OpenApiRestCall_21625435
proc url_DescribeOrderableReplicationInstances_21626368(protocol: Scheme;
...
proc validate_DescribeOrderableReplicationInstances_21626367(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626380: Call_DescribeOrderableReplicationInstances_21626366;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about the replication instance types that can be created in the specified region.
  ## 
...
proc call*(call_21626381: Call_DescribeOrderableReplicationInstances_21626366;
  ...
  add(query_21626382, "MaxRecords", newJString(MaxRecords))
  add(query_21626382, "Marker", newJString(Marker))
  if body != nil:
    body_21626383 = body
  result = call_21626381.call(nil, query_21626382, nil, nil, body_21626383)

var describeOrderableReplicationInstances* = Call_DescribeOrderableReplicationInstances_21626366(
    ...
    validator: validate_DescribeOrderableReplicationInstances_21626367, base: "/",
    makeUrl: url_DescribeOrderableReplicationInstances_21626368,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePendingMaintenanceActions_21626384 = ref object of OpenApiRestCall_21625435
proc url_DescribePendingMaintenanceActions_21626386(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribePendingMaintenanceActions_21626385(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626398: Call_DescribePendingMaintenanceActions_21626384;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## For internal use only
  ## 
...
proc call*(call_21626399: Call_DescribePendingMaintenanceActions_21626384;
          body: JsonNode; MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626400, "MaxRecords", newJString(MaxRecords))
  add(query_21626400, "Marker", newJString(Marker))
  if body != nil:
    body_21626401 = body
  result = call_21626399.call(nil, query_21626400, nil, nil, body_21626401)

var describePendingMaintenanceActions* = Call_DescribePendingMaintenanceActions_21626384(
    ...
    validator: validate_DescribePendingMaintenanceActions_21626385, base: "/",
    makeUrl: url_DescribePendingMaintenanceActions_21626386,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRefreshSchemasStatus_21626402 = ref object of OpenApiRestCall_21625435
proc url_DescribeRefreshSchemasStatus_21626404(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeRefreshSchemasStatus_21626403(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626414: Call_DescribeRefreshSchemasStatus_21626402;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns the status of the RefreshSchemas operation.
  ## 
...
proc call*(call_21626415: Call_DescribeRefreshSchemasStatus_21626402;
          body: JsonNode): Recallable =
...
var describeRefreshSchemasStatus* = Call_DescribeRefreshSchemasStatus_21626402(
    ...
    validator: validate_DescribeRefreshSchemasStatus_21626403, base: "/",
    makeUrl: url_DescribeRefreshSchemasStatus_21626404,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationInstanceTaskLogs_21626417 = ref object of OpenApiRestCall_21625435
proc url_DescribeReplicationInstanceTaskLogs_21626419(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationInstanceTaskLogs_21626418(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626431: Call_DescribeReplicationInstanceTaskLogs_21626417;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about the task logs for the specified task.
  ## 
...
proc call*(call_21626432: Call_DescribeReplicationInstanceTaskLogs_21626417;
          body: JsonNode; MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626433, "MaxRecords", newJString(MaxRecords))
  add(query_21626433, "Marker", newJString(Marker))
  if body != nil:
    body_21626434 = body
  result = call_21626432.call(nil, query_21626433, nil, nil, body_21626434)

var describeReplicationInstanceTaskLogs* = Call_DescribeReplicationInstanceTaskLogs_21626417(
    ...
    validator: validate_DescribeReplicationInstanceTaskLogs_21626418, base: "/",
    makeUrl: url_DescribeReplicationInstanceTaskLogs_21626419,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationInstances_21626435 = ref object of OpenApiRestCall_21625435
proc url_DescribeReplicationInstances_21626437(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationInstances_21626436(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626449: Call_DescribeReplicationInstances_21626435;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about replication instances for your account in the current region.
  ## 
...
proc call*(call_21626450: Call_DescribeReplicationInstances_21626435;
          body: JsonNode; MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626451, "MaxRecords", newJString(MaxRecords))
  add(query_21626451, "Marker", newJString(Marker))
  if body != nil:
    body_21626452 = body
  result = call_21626450.call(nil, query_21626451, nil, nil, body_21626452)

var describeReplicationInstances* = Call_DescribeReplicationInstances_21626435(
    ...
    validator: validate_DescribeReplicationInstances_21626436, base: "/",
    makeUrl: url_DescribeReplicationInstances_21626437,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationSubnetGroups_21626453 = ref object of OpenApiRestCall_21625435
proc url_DescribeReplicationSubnetGroups_21626455(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationSubnetGroups_21626454(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626460 = header.getOrDefault("X-Amz-Target")
  valid_21626460 = validateParameter(valid_21626460, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeReplicationSubnetGroups"))
  if valid_21626460 != nil:
    section.add "X-Amz-Target", valid_21626460
...
proc call*(call_21626467: Call_DescribeReplicationSubnetGroups_21626453;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about the replication subnet groups.
  ## 
...
proc call*(call_21626468: Call_DescribeReplicationSubnetGroups_21626453;
          body: JsonNode; MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626469, "MaxRecords", newJString(MaxRecords))
  add(query_21626469, "Marker", newJString(Marker))
  if body != nil:
    body_21626470 = body
  result = call_21626468.call(nil, query_21626469, nil, nil, body_21626470)

var describeReplicationSubnetGroups* = Call_DescribeReplicationSubnetGroups_21626453(
    ...
    validator: validate_DescribeReplicationSubnetGroups_21626454, base: "/",
    makeUrl: url_DescribeReplicationSubnetGroups_21626455,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationTaskAssessmentResults_21626471 = ref object of OpenApiRestCall_21625435
proc url_DescribeReplicationTaskAssessmentResults_21626473(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationTaskAssessmentResults_21626472(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626478 = header.getOrDefault("X-Amz-Target")
  valid_21626478 = validateParameter(valid_21626478, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeReplicationTaskAssessmentResults"))
  if valid_21626478 != nil:
    section.add "X-Amz-Target", valid_21626478
...
proc call*(call_21626485: Call_DescribeReplicationTaskAssessmentResults_21626471;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns the task assessment results from Amazon S3. This action always returns the latest results.
  ## 
...
proc call*(call_21626486: Call_DescribeReplicationTaskAssessmentResults_21626471;
          body: JsonNode; MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626487, "MaxRecords", newJString(MaxRecords))
  add(query_21626487, "Marker", newJString(Marker))
  if body != nil:
    body_21626488 = body
  result = call_21626486.call(nil, query_21626487, nil, nil, body_21626488)

var describeReplicationTaskAssessmentResults* = Call_DescribeReplicationTaskAssessmentResults_21626471(
    ...
    validator: validate_DescribeReplicationTaskAssessmentResults_21626472,
    base: "/", makeUrl: url_DescribeReplicationTaskAssessmentResults_21626473,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationTasks_21626489 = ref object of OpenApiRestCall_21625435
proc url_DescribeReplicationTasks_21626491(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationTasks_21626490(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626503: Call_DescribeReplicationTasks_21626489;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about replication tasks for your account in the current region.
  ## 
...
proc call*(call_21626504: Call_DescribeReplicationTasks_21626489; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  add(query_21626505, "MaxRecords", newJString(MaxRecords))
  add(query_21626505, "Marker", newJString(Marker))
  if body != nil:
    body_21626506 = body
  result = call_21626504.call(nil, query_21626505, nil, nil, body_21626506)

var describeReplicationTasks* = Call_DescribeReplicationTasks_21626489(
    name: "describeReplicationTasks", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTasks",
    validator: validate_DescribeReplicationTasks_21626490, base: "/",
    makeUrl: url_DescribeReplicationTasks_21626491,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSchemas_21626507 = ref object of OpenApiRestCall_21625435
proc url_DescribeSchemas_21626509(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSchemas_21626508(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626521: Call_DescribeSchemas_21626507; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns information about the schema for the specified endpoint.</p> <p/>
  ## 
...
proc call*(call_21626522: Call_DescribeSchemas_21626507; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ## describeSchemas
  ## <p>Returns information about the schema for the specified endpoint.</p> <p/>
  ##   MaxRecords: string
  ...
  add(query_21626523, "MaxRecords", newJString(MaxRecords))
  add(query_21626523, "Marker", newJString(Marker))
  if body != nil:
    body_21626524 = body
  result = call_21626522.call(nil, query_21626523, nil, nil, body_21626524)

var describeSchemas* = Call_DescribeSchemas_21626507(name: "describeSchemas",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeSchemas",
    validator: validate_DescribeSchemas_21626508, base: "/",
    makeUrl: url_DescribeSchemas_21626509, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTableStatistics_21626525 = ref object of OpenApiRestCall_21625435
proc url_DescribeTableStatistics_21626527(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeTableStatistics_21626526(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626539: Call_DescribeTableStatistics_21626525;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns table statistics on the database migration task, including table name, rows inserted, rows updated, and rows deleted.</p> <p>Note that the "last updated" column the DMS console only indicates the time that AWS DMS last updated the table statistics record for a table. It does not indicate the time of the last update to the table.</p>
  ## 
...
proc call*(call_21626540: Call_DescribeTableStatistics_21626525; body: JsonNode;
          MaxRecords: string = ""; Marker: string = ""): Recallable =
  ...
  ##         : Pagination token
  ##   body: JObject (required)
  var query_21626541 = newJObject()
  var body_21626542 = newJObject()
  add(query_21626541, "MaxRecords", newJString(MaxRecords))
  add(query_21626541, "Marker", newJString(Marker))
  if body != nil:
    body_21626542 = body
  result = call_21626540.call(nil, query_21626541, nil, nil, body_21626542)

var describeTableStatistics* = Call_DescribeTableStatistics_21626525(
    name: "describeTableStatistics", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeTableStatistics",
    validator: validate_DescribeTableStatistics_21626526, base: "/",
    makeUrl: url_DescribeTableStatistics_21626527,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ImportCertificate_21626543 = ref object of OpenApiRestCall_21625435
proc url_ImportCertificate_21626545(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ImportCertificate_21626544(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626548 = header.getOrDefault("X-Amz-Target")
  valid_21626548 = validateParameter(valid_21626548, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ImportCertificate"))
  if valid_21626548 != nil:
    section.add "X-Amz-Target", valid_21626548
...
proc call*(call_21626555: Call_ImportCertificate_21626543; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Uploads the specified certificate.
  ## 
...
proc call*(call_21626556: Call_ImportCertificate_21626543; body: JsonNode): Recallable =
  ## importCertificate
  ## Uploads the specified certificate.
  ##   body: JObject (required)
  var body_21626557 = newJObject()
  if body != nil:
    body_21626557 = body
  result = call_21626556.call(nil, nil, nil, nil, body_21626557)

var importCertificate* = Call_ImportCertificate_21626543(name: "importCertificate",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ImportCertificate",
    validator: validate_ImportCertificate_21626544, base: "/",
    makeUrl: url_ImportCertificate_21626545, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_21626558 = ref object of OpenApiRestCall_21625435
proc url_ListTagsForResource_21626560(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_21626559(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626563 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626563 != nil:
    section.add "X-Amz-Target", valid_21626563
...
proc call*(call_21626570: Call_ListTagsForResource_21626558; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists all tags for an AWS DMS resource.
  ## 
...
proc call*(call_21626571: Call_ListTagsForResource_21626558; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists all tags for an AWS DMS resource.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626572 = body
  result = call_21626571.call(nil, nil, nil, nil, body_21626572)

var listTagsForResource* = Call_ListTagsForResource_21626558(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ListTagsForResource",
    validator: validate_ListTagsForResource_21626559, base: "/",
    makeUrl: url_ListTagsForResource_21626560,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyEndpoint_21626573 = ref object of OpenApiRestCall_21625435
proc url_ModifyEndpoint_21626575(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyEndpoint_21626574(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626585: Call_ModifyEndpoint_21626573; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Modifies the specified endpoint.
  ## 
...
proc call*(call_21626586: Call_ModifyEndpoint_21626573; body: JsonNode): Recallable =
  ## modifyEndpoint
  ## Modifies the specified endpoint.
  ##   body: JObject (required)
  var body_21626587 = newJObject()
  if body != nil:
    body_21626587 = body
  result = call_21626586.call(nil, nil, nil, nil, body_21626587)

var modifyEndpoint* = Call_ModifyEndpoint_21626573(name: "modifyEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyEndpoint",
    validator: validate_ModifyEndpoint_21626574, base: "/",
    makeUrl: url_ModifyEndpoint_21626575, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyEventSubscription_21626588 = ref object of OpenApiRestCall_21625435
proc url_ModifyEventSubscription_21626590(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyEventSubscription_21626589(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626593 = header.getOrDefault("X-Amz-Target")
  valid_21626593 = validateParameter(valid_21626593, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ModifyEventSubscription"))
  if valid_21626593 != nil:
    section.add "X-Amz-Target", valid_21626593
...
proc call*(call_21626600: Call_ModifyEventSubscription_21626588;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Modifies an existing AWS DMS event notification subscription. 
  ## 
...
proc call*(call_21626601: Call_ModifyEventSubscription_21626588; body: JsonNode): Recallable =
...
var modifyEventSubscription* = Call_ModifyEventSubscription_21626588(
    name: "modifyEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyEventSubscription",
    validator: validate_ModifyEventSubscription_21626589, base: "/",
    makeUrl: url_ModifyEventSubscription_21626590,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationInstance_21626603 = ref object of OpenApiRestCall_21625435
proc url_ModifyReplicationInstance_21626605(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReplicationInstance_21626604(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626608 = header.getOrDefault("X-Amz-Target")
  valid_21626608 = validateParameter(valid_21626608, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ModifyReplicationInstance"))
  if valid_21626608 != nil:
    section.add "X-Amz-Target", valid_21626608
...
proc call*(call_21626615: Call_ModifyReplicationInstance_21626603;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Modifies the replication instance to apply new settings. You can change one or more parameters by specifying these parameters and the new values in the request.</p> <p>Some settings are applied during the maintenance window.</p> <p/>
  ## 
...
proc call*(call_21626616: Call_ModifyReplicationInstance_21626603; body: JsonNode): Recallable =
  ## modifyReplicationInstance
  ## <p>Modifies the replication instance to apply new settings. You can change one or more parameters by specifying these parameters and the new values in the request.</p> <p>Some settings are applied during the maintenance window.</p> <p/>
  ##   body: JObject (required)
  var body_21626617 = newJObject()
  if body != nil:
    body_21626617 = body
  result = call_21626616.call(nil, nil, nil, nil, body_21626617)

var modifyReplicationInstance* = Call_ModifyReplicationInstance_21626603(
    name: "modifyReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationInstance",
    validator: validate_ModifyReplicationInstance_21626604, base: "/",
    makeUrl: url_ModifyReplicationInstance_21626605,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationSubnetGroup_21626618 = ref object of OpenApiRestCall_21625435
proc url_ModifyReplicationSubnetGroup_21626620(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReplicationSubnetGroup_21626619(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  var valid_21626623 = header.getOrDefault("X-Amz-Target")
  valid_21626623 = validateParameter(valid_21626623, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ModifyReplicationSubnetGroup"))
  if valid_21626623 != nil:
    section.add "X-Amz-Target", valid_21626623
...
proc call*(call_21626630: Call_ModifyReplicationSubnetGroup_21626618;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Modifies the settings for the specified replication subnet group.
  ## 
...
proc call*(call_21626631: Call_ModifyReplicationSubnetGroup_21626618;
          body: JsonNode): Recallable =
  ...
  if body != nil:
    body_21626632 = body
  result = call_21626631.call(nil, nil, nil, nil, body_21626632)

var modifyReplicationSubnetGroup* = Call_ModifyReplicationSubnetGroup_21626618(
    ...
    validator: validate_ModifyReplicationSubnetGroup_21626619, base: "/",
    makeUrl: url_ModifyReplicationSubnetGroup_21626620,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationTask_21626633 = ref object of OpenApiRestCall_21625435
proc url_ModifyReplicationTask_21626635(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ModifyReplicationTask_21626634(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626638 = header.getOrDefault("X-Amz-Target")
  valid_21626638 = validateParameter(valid_21626638, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ModifyReplicationTask"))
  if valid_21626638 != nil:
    section.add "X-Amz-Target", valid_21626638
...
proc call*(call_21626645: Call_ModifyReplicationTask_21626633;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Modifies the specified replication task.</p> <p>You can't modify the task endpoints. The task must be stopped before you can modify it. </p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks</a> in the <i>AWS Database Migration Service User Guide</i>.</p>
  ## 
...
proc call*(call_21626646: Call_ModifyReplicationTask_21626633; body: JsonNode): Recallable =
  ## modifyReplicationTask
  ## <p>Modifies the specified replication task.</p> <p>You can't modify the task endpoints. The task must be stopped before you can modify it. </p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks</a> in the <i>AWS Database Migration Service User Guide</i>.</p>
  ##   body: JObject (required)
  var body_21626647 = newJObject()
  if body != nil:
    body_21626647 = body
  result = call_21626646.call(nil, nil, nil, nil, body_21626647)

var modifyReplicationTask* = Call_ModifyReplicationTask_21626633(
    name: "modifyReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationTask",
    validator: validate_ModifyReplicationTask_21626634, base: "/",
    makeUrl: url_ModifyReplicationTask_21626635,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RebootReplicationInstance_21626648 = ref object of OpenApiRestCall_21625435
proc url_RebootReplicationInstance_21626650(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RebootReplicationInstance_21626649(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626653 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626653 != nil:
    section.add "X-Amz-Target", valid_21626653
...
proc call*(call_21626660: Call_RebootReplicationInstance_21626648;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Reboots a replication instance. Rebooting results in a momentary outage, until the replication instance becomes available again.
  ## 
  let valid = call_21626660.validator(path, query, header, formData, body, _)
  let scheme = call_21626660.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_21626660.makeUrl(scheme.get, call_21626660.host, call_21626660.base,
                               call_21626660.route, valid.getOrDefault("path"),
                               valid.getOrDefault("query"))
  result = atozHook(call_21626660, uri, valid, _)

proc call*(call_21626661: Call_RebootReplicationInstance_21626648; body: JsonNode): Recallable =
  ## rebootReplicationInstance
  ## Reboots a replication instance. Rebooting results in a momentary outage, until the replication instance becomes available again.
  ##   body: JObject (required)
  var body_21626662 = newJObject()
  if body != nil:
    body_21626662 = body
  result = call_21626661.call(nil, nil, nil, nil, body_21626662)

var rebootReplicationInstance* = Call_RebootReplicationInstance_21626648(
    name: "rebootReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RebootReplicationInstance",
    validator: validate_RebootReplicationInstance_21626649, base: "/",
    makeUrl: url_RebootReplicationInstance_21626650,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RefreshSchemas_21626663 = ref object of OpenApiRestCall_21625435
proc url_RefreshSchemas_21626665(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RefreshSchemas_21626664(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626668 = header.getOrDefault("X-Amz-Target")
  valid_21626668 = validateParameter(valid_21626668, JString, required = true, default = newJString(
      "AmazonDMSv20160101.RefreshSchemas"))
  if valid_21626668 != nil:
    section.add "X-Amz-Target", valid_21626668
  var valid_21626669 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_21626669 = validateParameter(valid_21626669, JString, required = false,
                                   default = nil)
  if valid_21626669 != nil:
    section.add "X-Amz-Content-Sha256", valid_21626669
  var valid_21626670 = header.getOrDefault("X-Amz-Algorithm")
  valid_21626670 = validateParameter(valid_21626670, JString, required = false,
                                   default = nil)
  if valid_21626670 != nil:
    section.add "X-Amz-Algorithm", valid_21626670
  var valid_21626671 = header.getOrDefault("X-Amz-Signature")
  valid_21626671 = validateParameter(valid_21626671, JString, required = false,
                                   default = nil)
  if valid_21626671 != nil:
    section.add "X-Amz-Signature", valid_21626671
  var valid_21626672 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_21626672 = validateParameter(valid_21626672, JString, required = false,
                                   default = nil)
  if valid_21626672 != nil:
    section.add "X-Amz-SignedHeaders", valid_21626672
  var valid_21626673 = header.getOrDefault("X-Amz-Credential")
  valid_21626673 = validateParameter(valid_21626673, JString, required = false,
                                   default = nil)
  if valid_21626673 != nil:
    section.add "X-Amz-Credential", valid_21626673
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_21626675: Call_RefreshSchemas_21626663; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Populates the schema for the specified endpoint. This is an asynchronous operation and can take several minutes. You can check the status of this operation by calling the DescribeRefreshSchemasStatus operation.
  ## 
...
proc call*(call_21626676: Call_RefreshSchemas_21626663; body: JsonNode): Recallable =
  ## refreshSchemas
  ## Populates the schema for the specified endpoint. This is an asynchronous operation and can take several minutes. You can check the status of this operation by calling the DescribeRefreshSchemasStatus operation.
  ##   body: JObject (required)
  var body_21626677 = newJObject()
  if body != nil:
    body_21626677 = body
  result = call_21626676.call(nil, nil, nil, nil, body_21626677)

var refreshSchemas* = Call_RefreshSchemas_21626663(name: "refreshSchemas",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RefreshSchemas",
    validator: validate_RefreshSchemas_21626664, base: "/",
    makeUrl: url_RefreshSchemas_21626665, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ReloadTables_21626678 = ref object of OpenApiRestCall_21625435
proc url_ReloadTables_21626680(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ReloadTables_21626679(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
  ...
  var valid_21626683 = header.getOrDefault("X-Amz-Target")
  valid_21626683 = validateParameter(valid_21626683, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ReloadTables"))
  if valid_21626683 != nil:
    section.add "X-Amz-Target", valid_21626683
...
proc call*(call_21626690: Call_ReloadTables_21626678; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Reloads the target database table with the source data. 
  ## 
...
proc call*(call_21626691: Call_ReloadTables_21626678; body: JsonNode): Recallable =
  ## reloadTables
  ## Reloads the target database table with the source data. 
  ##   body: JObject (required)
  ...
  if body != nil:
    body_21626692 = body
  result = call_21626691.call(nil, nil, nil, nil, body_21626692)

var reloadTables* = Call_ReloadTables_21626678(name: "reloadTables",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ReloadTables",
    validator: validate_ReloadTables_21626679, base: "/", makeUrl: url_ReloadTables_21626680,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveTagsFromResource_21626693 = ref object of OpenApiRestCall_21625435
proc url_RemoveTagsFromResource_21626695(protocol: Scheme; host: string;
...
proc validate_RemoveTagsFromResource_21626694(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626698 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626698 != nil:
    section.add "X-Amz-Target", valid_21626698
...
proc call*(call_21626705: Call_RemoveTagsFromResource_21626693;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes metadata tags from a DMS resource.
  ## 
  let valid = call_21626705.validator(path, query, header, formData, body, _)
  let scheme = call_21626705.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let uri = call_21626705.makeUrl(scheme.get, call_21626705.host, call_21626705.base,
                               call_21626705.route, valid.getOrDefault("path"),
                               valid.getOrDefault("query"))
  result = atozHook(call_21626705, uri, valid, _)

proc call*(call_21626706: Call_RemoveTagsFromResource_21626693; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_21626707 = body
  result = call_21626706.call(nil, nil, nil, nil, body_21626707)

var removeTagsFromResource* = Call_RemoveTagsFromResource_21626693(
    name: "removeTagsFromResource", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RemoveTagsFromResource",
    validator: validate_RemoveTagsFromResource_21626694, base: "/",
    makeUrl: url_RemoveTagsFromResource_21626695,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartReplicationTask_21626708 = ref object of OpenApiRestCall_21625435
proc url_StartReplicationTask_21626710(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartReplicationTask_21626709(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626713 = header.getOrDefault("X-Amz-Target")
  valid_21626713 = validateParameter(valid_21626713, JString, required = true, default = newJString(
      "AmazonDMSv20160101.StartReplicationTask"))
  if valid_21626713 != nil:
    section.add "X-Amz-Target", valid_21626713
...
proc call*(call_21626720: Call_StartReplicationTask_21626708; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Starts the replication task.</p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks </a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ## 
...
proc call*(call_21626721: Call_StartReplicationTask_21626708; body: JsonNode): Recallable =
  ## startReplicationTask
  ## <p>Starts the replication task.</p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks </a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ##   body: JObject (required)
  var body_21626722 = newJObject()
  if body != nil:
    body_21626722 = body
  result = call_21626721.call(nil, nil, nil, nil, body_21626722)

var startReplicationTask* = Call_StartReplicationTask_21626708(
    name: "startReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTask",
    validator: validate_StartReplicationTask_21626709, base: "/",
    makeUrl: url_StartReplicationTask_21626710,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartReplicationTaskAssessment_21626723 = ref object of OpenApiRestCall_21625435
proc url_StartReplicationTaskAssessment_21626725(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartReplicationTaskAssessment_21626724(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_21626735: Call_StartReplicationTaskAssessment_21626723;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ##  Starts the replication task assessment for unsupported data types in the source database. 
  ## 
...
proc call*(call_21626736: Call_StartReplicationTaskAssessment_21626723;
          body: JsonNode): Recallable =
  ## startReplicationTaskAssessment
  ##  Starts the replication task assessment for unsupported data types in the source database. 
  ##   body: JObject (required)
  var body_21626737 = newJObject()
  if body != nil:
    body_21626737 = body
  result = call_21626736.call(nil, nil, nil, nil, body_21626737)

var startReplicationTaskAssessment* = Call_StartReplicationTaskAssessment_21626723(
    ...
    validator: validate_StartReplicationTaskAssessment_21626724, base: "/",
    makeUrl: url_StartReplicationTaskAssessment_21626725,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopReplicationTask_21626738 = ref object of OpenApiRestCall_21625435
proc url_StopReplicationTask_21626740(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopReplicationTask_21626739(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   X-Amz-Credential: JString
  section = newJObject()
  var valid_21626741 = header.getOrDefault("X-Amz-Date")
  valid_21626741 = validateParameter(valid_21626741, JString, required = false,
                                   default = nil)
  if valid_21626741 != nil:
    section.add "X-Amz-Date", valid_21626741
  var valid_21626742 = header.getOrDefault("X-Amz-Security-Token")
  valid_21626742 = validateParameter(valid_21626742, JString, required = false,
                                   default = nil)
  if valid_21626742 != nil:
    section.add "X-Amz-Security-Token", valid_21626742
  var valid_21626743 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_21626743 != nil:
    section.add "X-Amz-Target", valid_21626743
...
proc call*(call_21626750: Call_StopReplicationTask_21626738; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Stops the replication task.</p> <p/>
  ## 
...
proc call*(call_21626751: Call_StopReplicationTask_21626738; body: JsonNode): Recallable =
  ## stopReplicationTask
  ## <p>Stops the replication task.</p> <p/>
  ##   body: JObject (required)
  var body_21626752 = newJObject()
  if body != nil:
    body_21626752 = body
  result = call_21626751.call(nil, nil, nil, nil, body_21626752)

var stopReplicationTask* = Call_StopReplicationTask_21626738(
    name: "stopReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.StopReplicationTask",
    validator: validate_StopReplicationTask_21626739, base: "/",
    makeUrl: url_StopReplicationTask_21626740,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TestConnection_21626753 = ref object of OpenApiRestCall_21625435
proc url_TestConnection_21626755(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TestConnection_21626754(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  var valid_21626758 = header.getOrDefault("X-Amz-Target")
  valid_21626758 = validateParameter(valid_21626758, JString, required = true, default = newJString(
      "AmazonDMSv20160101.TestConnection"))
  if valid_21626758 != nil:
    section.add "X-Amz-Target", valid_21626758
...
proc call*(call_21626765: Call_TestConnection_21626753; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Tests the connection between the replication instance and the endpoint.
  ## 
...
proc call*(call_21626766: Call_TestConnection_21626753; body: JsonNode): Recallable =
  ## testConnection
  ## Tests the connection between the replication instance and the endpoint.
  ##   body: JObject (required)
  var body_21626767 = newJObject()
  if body != nil:
    body_21626767 = body
  result = call_21626766.call(nil, nil, nil, nil, body_21626767)

var testConnection* = Call_TestConnection_21626753(name: "testConnection",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.TestConnection",
    validator: validate_TestConnection_21626754, base: "/",
    makeUrl: url_TestConnection_21626755, schemes: {Scheme.Https, Scheme.Http})
export
  rest
