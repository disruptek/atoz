...
type
  Call_ApplyPendingMaintenanceAction_611265 = ref object of OpenApiRestCall_610658
proc url_ApplyPendingMaintenanceAction_611267(protocol: Scheme; host: string;
...
proc validate_ApplyPendingMaintenanceAction_611266(path: JsonNode; query: JsonNode;
...
proc call*(call_611277: Call_ApplyPendingMaintenanceAction_611265; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Applies a pending maintenance action to a resource (for example, to a replication instance).
  ## 
...
proc call*(call_611278: Call_ApplyPendingMaintenanceAction_611265; body: JsonNode): Recallable =
...
var applyPendingMaintenanceAction* = Call_ApplyPendingMaintenanceAction_611265(
    ...
    validator: validate_ApplyPendingMaintenanceAction_611266, base: "/",
    url: url_ApplyPendingMaintenanceAction_611267,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEndpoint_611280 = ref object of OpenApiRestCall_610658
proc url_CreateEndpoint_611282(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateEndpoint_611281(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611292: Call_CreateEndpoint_611280; path: JsonNode; query: JsonNode;
...
proc call*(call_611293: Call_CreateEndpoint_611280; body: JsonNode): Recallable =
  ## createEndpoint
  ## Creates an endpoint using the provided settings.
  ##   body: JObject (required)
...
var createEndpoint* = Call_CreateEndpoint_611280(name: "createEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateEndpoint",
    validator: validate_CreateEndpoint_611281, base: "/", url: url_CreateEndpoint_611282,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateEventSubscription_611295 = ref object of OpenApiRestCall_610658
proc url_CreateEventSubscription_611297(protocol: Scheme; host: string; base: string;
...
proc validate_CreateEventSubscription_611296(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611307: Call_CreateEventSubscription_611295; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p> Creates an AWS DMS event notification subscription. </p> <p>You can specify the type of source (<code>SourceType</code>) you want to be notified of, provide a list of AWS DMS source IDs (<code>SourceIds</code>) that triggers the events, and provide a list of event categories (<code>EventCategories</code>) for events you want to be notified of. If you specify both the <code>SourceType</code> and <code>SourceIds</code>, such as <code>SourceType = replication-instance</code> and <code>SourceIdentifier = my-replinstance</code>, you will be notified of all the replication instance events for the specified source. If you specify a <code>SourceType</code> but don't specify a <code>SourceIdentifier</code>, you receive notice of the events for that source type for all your AWS DMS sources. If you don't specify either <code>SourceType</code> nor <code>SourceIdentifier</code>, you will be notified of events generated from all AWS DMS sources belonging to your customer account.</p> <p>For more information about AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ## 
...
proc call*(call_611308: Call_CreateEventSubscription_611295; body: JsonNode): Recallable =
...
var createEventSubscription* = Call_CreateEventSubscription_611295(
    name: "createEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateEventSubscription",
    validator: validate_CreateEventSubscription_611296, base: "/",
    url: url_CreateEventSubscription_611297, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationInstance_611310 = ref object of OpenApiRestCall_610658
proc url_CreateReplicationInstance_611312(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateReplicationInstance_611311(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611322: Call_CreateReplicationInstance_611310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Creates the replication instance using the specified parameters.</p> <p>AWS DMS requires that your account have certain roles with appropriate permissions before you can create a replication instance. For information on the required roles, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.APIRole.html">Creating the IAM Roles to Use With the AWS CLI and AWS DMS API</a>. For information on the required permissions, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.IAMPermissions.html">IAM Permissions Needed to Use AWS DMS</a>.</p>
  ## 
...
proc call*(call_611323: Call_CreateReplicationInstance_611310; body: JsonNode): Recallable =
...
var createReplicationInstance* = Call_CreateReplicationInstance_611310(
    name: "createReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationInstance",
    validator: validate_CreateReplicationInstance_611311, base: "/",
    url: url_CreateReplicationInstance_611312,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationSubnetGroup_611325 = ref object of OpenApiRestCall_610658
proc url_CreateReplicationSubnetGroup_611327(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateReplicationSubnetGroup_611326(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611337: Call_CreateReplicationSubnetGroup_611325; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a replication subnet group given a list of the subnet IDs in a VPC.
  ## 
...
proc call*(call_611338: Call_CreateReplicationSubnetGroup_611325; body: JsonNode): Recallable =
...
var createReplicationSubnetGroup* = Call_CreateReplicationSubnetGroup_611325(
    ...
    validator: validate_CreateReplicationSubnetGroup_611326, base: "/",
    url: url_CreateReplicationSubnetGroup_611327,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateReplicationTask_611340 = ref object of OpenApiRestCall_610658
proc url_CreateReplicationTask_611342(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateReplicationTask_611341(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611352: Call_CreateReplicationTask_611340; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a replication task using the specified parameters.
  ## 
...
proc call*(call_611353: Call_CreateReplicationTask_611340; body: JsonNode): Recallable =
...
var createReplicationTask* = Call_CreateReplicationTask_611340(
    name: "createReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationTask",
    validator: validate_CreateReplicationTask_611341, base: "/",
    url: url_CreateReplicationTask_611342, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteCertificate_611355 = ref object of OpenApiRestCall_610658
proc url_DeleteCertificate_611357(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteCertificate_611356(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_611367: Call_DeleteCertificate_611355; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified certificate. 
  ## 
...
proc call*(call_611368: Call_DeleteCertificate_611355; body: JsonNode): Recallable =
  ## deleteCertificate
  ## Deletes the specified certificate. 
  ##   body: JObject (required)
...
var deleteCertificate* = Call_DeleteCertificate_611355(name: "deleteCertificate",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteCertificate",
    validator: validate_DeleteCertificate_611356, base: "/",
    url: url_DeleteCertificate_611357, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteConnection_611370 = ref object of OpenApiRestCall_610658
proc url_DeleteConnection_611372(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteConnection_611371(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_611382: Call_DeleteConnection_611370; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the connection between a replication instance and an endpoint.
  ## 
...
proc call*(call_611383: Call_DeleteConnection_611370; body: JsonNode): Recallable =
  ## deleteConnection
  ## Deletes the connection between a replication instance and an endpoint.
  ##   body: JObject (required)
...
var deleteConnection* = Call_DeleteConnection_611370(name: "deleteConnection",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteConnection",
    validator: validate_DeleteConnection_611371, base: "/",
    url: url_DeleteConnection_611372, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEndpoint_611385 = ref object of OpenApiRestCall_610658
proc url_DeleteEndpoint_611387(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteEndpoint_611386(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611397: Call_DeleteEndpoint_611385; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the specified endpoint.</p> <note> <p>All tasks associated with the endpoint must be deleted before you can delete the endpoint.</p> </note> <p/>
  ## 
...
proc call*(call_611398: Call_DeleteEndpoint_611385; body: JsonNode): Recallable =
  ## deleteEndpoint
  ## <p>Deletes the specified endpoint.</p> <note> <p>All tasks associated with the endpoint must be deleted before you can delete the endpoint.</p> </note> <p/>
  ##   body: JObject (required)
...
var deleteEndpoint* = Call_DeleteEndpoint_611385(name: "deleteEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteEndpoint",
    validator: validate_DeleteEndpoint_611386, base: "/", url: url_DeleteEndpoint_611387,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteEventSubscription_611400 = ref object of OpenApiRestCall_610658
proc url_DeleteEventSubscription_611402(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteEventSubscription_611401(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611412: Call_DeleteEventSubscription_611400; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Deletes an AWS DMS event subscription. 
  ## 
...
proc call*(call_611413: Call_DeleteEventSubscription_611400; body: JsonNode): Recallable =
...
var deleteEventSubscription* = Call_DeleteEventSubscription_611400(
    name: "deleteEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteEventSubscription",
    validator: validate_DeleteEventSubscription_611401, base: "/",
    url: url_DeleteEventSubscription_611402, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationInstance_611415 = ref object of OpenApiRestCall_610658
proc url_DeleteReplicationInstance_611417(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteReplicationInstance_611416(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611427: Call_DeleteReplicationInstance_611415; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes the specified replication instance.</p> <note> <p>You must delete any migration tasks that are associated with the replication instance before you can delete it.</p> </note> <p/>
  ## 
...
proc call*(call_611428: Call_DeleteReplicationInstance_611415; body: JsonNode): Recallable =
...
var deleteReplicationInstance* = Call_DeleteReplicationInstance_611415(
    name: "deleteReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationInstance",
    validator: validate_DeleteReplicationInstance_611416, base: "/",
    url: url_DeleteReplicationInstance_611417,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationSubnetGroup_611430 = ref object of OpenApiRestCall_610658
proc url_DeleteReplicationSubnetGroup_611432(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteReplicationSubnetGroup_611431(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611442: Call_DeleteReplicationSubnetGroup_611430; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a subnet group.
  ## 
...
proc call*(call_611443: Call_DeleteReplicationSubnetGroup_611430; body: JsonNode): Recallable =
...
var deleteReplicationSubnetGroup* = Call_DeleteReplicationSubnetGroup_611430(
    ...
    validator: validate_DeleteReplicationSubnetGroup_611431, base: "/",
    url: url_DeleteReplicationSubnetGroup_611432,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteReplicationTask_611445 = ref object of OpenApiRestCall_610658
proc url_DeleteReplicationTask_611447(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteReplicationTask_611446(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611457: Call_DeleteReplicationTask_611445; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified replication task.
  ## 
...
proc call*(call_611458: Call_DeleteReplicationTask_611445; body: JsonNode): Recallable =
...
var deleteReplicationTask* = Call_DeleteReplicationTask_611445(
    name: "deleteReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationTask",
    validator: validate_DeleteReplicationTask_611446, base: "/",
    url: url_DeleteReplicationTask_611447, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeAccountAttributes_611460 = ref object of OpenApiRestCall_610658
proc url_DescribeAccountAttributes_611462(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeAccountAttributes_611461(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611472: Call_DescribeAccountAttributes_611460; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all of the AWS DMS attributes for a customer account. These attributes include AWS DMS quotas for the account and a unique account identifier in a particular DMS region. DMS quotas include a list of resource quotas supported by the account, such as the number of replication instances allowed. The description for each resource quota, includes the quota name, current usage toward that quota, and the quota's maximum value. DMS uses the unique account identifier to name each artifact used by DMS in the given region.</p> <p>This command does not take any parameters.</p>
  ## 
...
proc call*(call_611473: Call_DescribeAccountAttributes_611460; body: JsonNode): Recallable =
...
var describeAccountAttributes* = Call_DescribeAccountAttributes_611460(
    name: "describeAccountAttributes", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeAccountAttributes",
    validator: validate_DescribeAccountAttributes_611461, base: "/",
    url: url_DescribeAccountAttributes_611462,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeCertificates_611475 = ref object of OpenApiRestCall_610658
proc url_DescribeCertificates_611477(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeCertificates_611476(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611478 = query.getOrDefault("Marker")
  valid_611478 = validateParameter(valid_611478, JString, required = false,
                                 default = nil)
  if valid_611478 != nil:
    section.add "Marker", valid_611478
  var valid_611479 = query.getOrDefault("MaxRecords")
  valid_611479 = validateParameter(valid_611479, JString, required = false,
                                 default = nil)
  if valid_611479 != nil:
    section.add "MaxRecords", valid_611479
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611489: Call_DescribeCertificates_611475; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides a description of the certificate.
  ## 
...
proc call*(call_611490: Call_DescribeCertificates_611475; body: JsonNode;
  ...
  add(query_611491, "Marker", newJString(Marker))
  if body != nil:
    body_611492 = body
  add(query_611491, "MaxRecords", newJString(MaxRecords))
  result = call_611490.call(nil, query_611491, nil, nil, body_611492)

var describeCertificates* = Call_DescribeCertificates_611475(
    name: "describeCertificates", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeCertificates",
    validator: validate_DescribeCertificates_611476, base: "/",
    url: url_DescribeCertificates_611477, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeConnections_611494 = ref object of OpenApiRestCall_610658
proc url_DescribeConnections_611496(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeConnections_611495(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_611498 = query.getOrDefault("MaxRecords")
  valid_611498 = validateParameter(valid_611498, JString, required = false,
                                 default = nil)
  if valid_611498 != nil:
    section.add "MaxRecords", valid_611498
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611508: Call_DescribeConnections_611494; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Describes the status of the connections that have been made between the replication instance and an endpoint. Connections are created when you test an endpoint.
  ## 
...
proc call*(call_611509: Call_DescribeConnections_611494; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ## describeConnections
  ## Describes the status of the connections that have been made between the replication instance and an endpoint. Connections are created when you test an endpoint.
  ##   Marker: string
  ...
  add(query_611510, "Marker", newJString(Marker))
  if body != nil:
    body_611511 = body
  add(query_611510, "MaxRecords", newJString(MaxRecords))
  result = call_611509.call(nil, query_611510, nil, nil, body_611511)

var describeConnections* = Call_DescribeConnections_611494(
    name: "describeConnections", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeConnections",
    validator: validate_DescribeConnections_611495, base: "/",
    url: url_DescribeConnections_611496, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpointTypes_611512 = ref object of OpenApiRestCall_610658
proc url_DescribeEndpointTypes_611514(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpointTypes_611513(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611515 = query.getOrDefault("Marker")
  valid_611515 = validateParameter(valid_611515, JString, required = false,
                                 default = nil)
  if valid_611515 != nil:
    section.add "Marker", valid_611515
  var valid_611516 = query.getOrDefault("MaxRecords")
  valid_611516 = validateParameter(valid_611516, JString, required = false,
                                 default = nil)
  if valid_611516 != nil:
    section.add "MaxRecords", valid_611516
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611517 = header.getOrDefault("X-Amz-Target")
  valid_611517 = validateParameter(valid_611517, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeEndpointTypes"))
  if valid_611517 != nil:
    section.add "X-Amz-Target", valid_611517
...
proc call*(call_611526: Call_DescribeEndpointTypes_611512; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about the type of endpoints available.
  ## 
...
proc call*(call_611527: Call_DescribeEndpointTypes_611512; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611528, "Marker", newJString(Marker))
  if body != nil:
    body_611529 = body
  add(query_611528, "MaxRecords", newJString(MaxRecords))
  result = call_611527.call(nil, query_611528, nil, nil, body_611529)

var describeEndpointTypes* = Call_DescribeEndpointTypes_611512(
    name: "describeEndpointTypes", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpointTypes",
    validator: validate_DescribeEndpointTypes_611513, base: "/",
    url: url_DescribeEndpointTypes_611514, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEndpoints_611530 = ref object of OpenApiRestCall_610658
proc url_DescribeEndpoints_611532(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEndpoints_611531(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611533 = query.getOrDefault("Marker")
  valid_611533 = validateParameter(valid_611533, JString, required = false,
                                 default = nil)
  if valid_611533 != nil:
    section.add "Marker", valid_611533
  var valid_611534 = query.getOrDefault("MaxRecords")
  valid_611534 = validateParameter(valid_611534, JString, required = false,
                                 default = nil)
  if valid_611534 != nil:
    section.add "MaxRecords", valid_611534
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611544: Call_DescribeEndpoints_611530; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about the endpoints for your account in the current region.
  ## 
...
proc call*(call_611545: Call_DescribeEndpoints_611530; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ## describeEndpoints
  ## Returns information about the endpoints for your account in the current region.
  ##   Marker: string
  ...
  add(query_611546, "Marker", newJString(Marker))
  if body != nil:
    body_611547 = body
  add(query_611546, "MaxRecords", newJString(MaxRecords))
  result = call_611545.call(nil, query_611546, nil, nil, body_611547)

var describeEndpoints* = Call_DescribeEndpoints_611530(name: "describeEndpoints",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpoints",
    validator: validate_DescribeEndpoints_611531, base: "/",
    url: url_DescribeEndpoints_611532, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEventCategories_611548 = ref object of OpenApiRestCall_610658
proc url_DescribeEventCategories_611550(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeEventCategories_611549(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611560: Call_DescribeEventCategories_611548; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration Service User Guide.</i> 
  ## 
...
proc call*(call_611561: Call_DescribeEventCategories_611548; body: JsonNode): Recallable =
...
var describeEventCategories* = Call_DescribeEventCategories_611548(
    name: "describeEventCategories", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEventCategories",
    validator: validate_DescribeEventCategories_611549, base: "/",
    url: url_DescribeEventCategories_611550, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEventSubscriptions_611563 = ref object of OpenApiRestCall_610658
proc url_DescribeEventSubscriptions_611565(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEventSubscriptions_611564(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611566 = query.getOrDefault("Marker")
  valid_611566 = validateParameter(valid_611566, JString, required = false,
                                 default = nil)
  if valid_611566 != nil:
    section.add "Marker", valid_611566
  var valid_611567 = query.getOrDefault("MaxRecords")
  valid_611567 = validateParameter(valid_611567, JString, required = false,
                                 default = nil)
  if valid_611567 != nil:
    section.add "MaxRecords", valid_611567
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611577: Call_DescribeEventSubscriptions_611563; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Lists all the event subscriptions for a customer account. The description of a subscription includes <code>SubscriptionName</code>, <code>SNSTopicARN</code>, <code>CustomerID</code>, <code>SourceType</code>, <code>SourceID</code>, <code>CreationTime</code>, and <code>Status</code>. </p> <p>If you specify <code>SubscriptionName</code>, this action lists the description for that subscription.</p>
  ## 
...
proc call*(call_611578: Call_DescribeEventSubscriptions_611563; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611579, "Marker", newJString(Marker))
  if body != nil:
    body_611580 = body
  add(query_611579, "MaxRecords", newJString(MaxRecords))
  result = call_611578.call(nil, query_611579, nil, nil, body_611580)

var describeEventSubscriptions* = Call_DescribeEventSubscriptions_611563(
    name: "describeEventSubscriptions", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEventSubscriptions",
    validator: validate_DescribeEventSubscriptions_611564, base: "/",
    url: url_DescribeEventSubscriptions_611565,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeEvents_611581 = ref object of OpenApiRestCall_610658
proc url_DescribeEvents_611583(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeEvents_611582(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611584 = query.getOrDefault("Marker")
  valid_611584 = validateParameter(valid_611584, JString, required = false,
                                 default = nil)
  if valid_611584 != nil:
    section.add "Marker", valid_611584
  var valid_611585 = query.getOrDefault("MaxRecords")
  valid_611585 = validateParameter(valid_611585, JString, required = false,
                                 default = nil)
  if valid_611585 != nil:
    section.add "MaxRecords", valid_611585
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611595: Call_DescribeEvents_611581; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Lists events for a given source identifier and source type. You can also specify a start and end time. For more information on AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration User Guide.</i> 
  ## 
...
proc call*(call_611596: Call_DescribeEvents_611581; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ## describeEvents
  ##  Lists events for a given source identifier and source type. You can also specify a start and end time. For more information on AWS DMS events, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html">Working with Events and Notifications</a> in the <i>AWS Database Migration User Guide.</i> 
  ##   Marker: string
  ...
  add(query_611597, "Marker", newJString(Marker))
  if body != nil:
    body_611598 = body
  add(query_611597, "MaxRecords", newJString(MaxRecords))
  result = call_611596.call(nil, query_611597, nil, nil, body_611598)

var describeEvents* = Call_DescribeEvents_611581(name: "describeEvents",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeEvents",
    validator: validate_DescribeEvents_611582, base: "/", url: url_DescribeEvents_611583,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOrderableReplicationInstances_611599 = ref object of OpenApiRestCall_610658
proc url_DescribeOrderableReplicationInstances_611601(protocol: Scheme;
...
proc validate_DescribeOrderableReplicationInstances_611600(path: JsonNode;
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611602 = query.getOrDefault("Marker")
  valid_611602 = validateParameter(valid_611602, JString, required = false,
                                 default = nil)
  if valid_611602 != nil:
    section.add "Marker", valid_611602
  var valid_611603 = query.getOrDefault("MaxRecords")
  valid_611603 = validateParameter(valid_611603, JString, required = false,
                                 default = nil)
  if valid_611603 != nil:
    section.add "MaxRecords", valid_611603
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611613: Call_DescribeOrderableReplicationInstances_611599;
...
proc call*(call_611614: Call_DescribeOrderableReplicationInstances_611599;
  ...
  if body != nil:
    body_611616 = body
  add(query_611615, "MaxRecords", newJString(MaxRecords))
  result = call_611614.call(nil, query_611615, nil, nil, body_611616)

var describeOrderableReplicationInstances* = Call_DescribeOrderableReplicationInstances_611599(
    ...
    validator: validate_DescribeOrderableReplicationInstances_611600, base: "/",
    url: url_DescribeOrderableReplicationInstances_611601,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribePendingMaintenanceActions_611617 = ref object of OpenApiRestCall_610658
proc url_DescribePendingMaintenanceActions_611619(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribePendingMaintenanceActions_611618(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611620 = query.getOrDefault("Marker")
  valid_611620 = validateParameter(valid_611620, JString, required = false,
                                 default = nil)
  if valid_611620 != nil:
    section.add "Marker", valid_611620
  var valid_611621 = query.getOrDefault("MaxRecords")
  valid_611621 = validateParameter(valid_611621, JString, required = false,
                                 default = nil)
  if valid_611621 != nil:
    section.add "MaxRecords", valid_611621
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611631: Call_DescribePendingMaintenanceActions_611617;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## For internal use only
  ## 
...
proc call*(call_611632: Call_DescribePendingMaintenanceActions_611617;
          body: JsonNode; Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611633, "Marker", newJString(Marker))
  if body != nil:
    body_611634 = body
  add(query_611633, "MaxRecords", newJString(MaxRecords))
  result = call_611632.call(nil, query_611633, nil, nil, body_611634)

var describePendingMaintenanceActions* = Call_DescribePendingMaintenanceActions_611617(
    ...
    validator: validate_DescribePendingMaintenanceActions_611618, base: "/",
    url: url_DescribePendingMaintenanceActions_611619,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeRefreshSchemasStatus_611635 = ref object of OpenApiRestCall_610658
proc url_DescribeRefreshSchemasStatus_611637(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeRefreshSchemasStatus_611636(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611638 = header.getOrDefault("X-Amz-Target")
  valid_611638 = validateParameter(valid_611638, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeRefreshSchemasStatus"))
  if valid_611638 != nil:
    section.add "X-Amz-Target", valid_611638
...
proc call*(call_611647: Call_DescribeRefreshSchemasStatus_611635; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of the RefreshSchemas operation.
  ## 
...
proc call*(call_611648: Call_DescribeRefreshSchemasStatus_611635; body: JsonNode): Recallable =
  ## describeRefreshSchemasStatus
  ## Returns the status of the RefreshSchemas operation.
  ##   body: JObject (required)
  var body_611649 = newJObject()
  if body != nil:
    body_611649 = body
  result = call_611648.call(nil, nil, nil, nil, body_611649)

var describeRefreshSchemasStatus* = Call_DescribeRefreshSchemasStatus_611635(
    ...
    validator: validate_DescribeRefreshSchemasStatus_611636, base: "/",
    url: url_DescribeRefreshSchemasStatus_611637,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationInstanceTaskLogs_611650 = ref object of OpenApiRestCall_610658
proc url_DescribeReplicationInstanceTaskLogs_611652(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationInstanceTaskLogs_611651(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611653 = query.getOrDefault("Marker")
  valid_611653 = validateParameter(valid_611653, JString, required = false,
                                 default = nil)
  if valid_611653 != nil:
    section.add "Marker", valid_611653
  var valid_611654 = query.getOrDefault("MaxRecords")
  valid_611654 = validateParameter(valid_611654, JString, required = false,
                                 default = nil)
  if valid_611654 != nil:
    section.add "MaxRecords", valid_611654
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611664: Call_DescribeReplicationInstanceTaskLogs_611650;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns information about the task logs for the specified task.
  ## 
...
proc call*(call_611665: Call_DescribeReplicationInstanceTaskLogs_611650;
          body: JsonNode; Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  var body_611667 = newJObject()
  add(query_611666, "Marker", newJString(Marker))
  if body != nil:
    body_611667 = body
  add(query_611666, "MaxRecords", newJString(MaxRecords))
  result = call_611665.call(nil, query_611666, nil, nil, body_611667)

var describeReplicationInstanceTaskLogs* = Call_DescribeReplicationInstanceTaskLogs_611650(
    ...
    validator: validate_DescribeReplicationInstanceTaskLogs_611651, base: "/",
    url: url_DescribeReplicationInstanceTaskLogs_611652,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationInstances_611668 = ref object of OpenApiRestCall_610658
proc url_DescribeReplicationInstances_611670(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationInstances_611669(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611671 = query.getOrDefault("Marker")
  valid_611671 = validateParameter(valid_611671, JString, required = false,
                                 default = nil)
  if valid_611671 != nil:
    section.add "Marker", valid_611671
  var valid_611672 = query.getOrDefault("MaxRecords")
  valid_611672 = validateParameter(valid_611672, JString, required = false,
                                 default = nil)
  if valid_611672 != nil:
    section.add "MaxRecords", valid_611672
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611682: Call_DescribeReplicationInstances_611668; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about replication instances for your account in the current region.
  ## 
...
proc call*(call_611683: Call_DescribeReplicationInstances_611668; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611684, "Marker", newJString(Marker))
  if body != nil:
    body_611685 = body
  add(query_611684, "MaxRecords", newJString(MaxRecords))
  result = call_611683.call(nil, query_611684, nil, nil, body_611685)

var describeReplicationInstances* = Call_DescribeReplicationInstances_611668(
    ...
    validator: validate_DescribeReplicationInstances_611669, base: "/",
    url: url_DescribeReplicationInstances_611670,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationSubnetGroups_611686 = ref object of OpenApiRestCall_610658
proc url_DescribeReplicationSubnetGroups_611688(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationSubnetGroups_611687(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611689 = query.getOrDefault("Marker")
  valid_611689 = validateParameter(valid_611689, JString, required = false,
                                 default = nil)
  if valid_611689 != nil:
    section.add "Marker", valid_611689
  var valid_611690 = query.getOrDefault("MaxRecords")
  valid_611690 = validateParameter(valid_611690, JString, required = false,
                                 default = nil)
  if valid_611690 != nil:
    section.add "MaxRecords", valid_611690
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611691 = header.getOrDefault("X-Amz-Target")
  valid_611691 = validateParameter(valid_611691, JString, required = true, default = newJString(
      "AmazonDMSv20160101.DescribeReplicationSubnetGroups"))
  if valid_611691 != nil:
    section.add "X-Amz-Target", valid_611691
...
proc call*(call_611700: Call_DescribeReplicationSubnetGroups_611686;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns information about the replication subnet groups.
  ## 
...
proc call*(call_611701: Call_DescribeReplicationSubnetGroups_611686;
          body: JsonNode; Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611702, "Marker", newJString(Marker))
  if body != nil:
    body_611703 = body
  add(query_611702, "MaxRecords", newJString(MaxRecords))
  result = call_611701.call(nil, query_611702, nil, nil, body_611703)

var describeReplicationSubnetGroups* = Call_DescribeReplicationSubnetGroups_611686(
    ...
    validator: validate_DescribeReplicationSubnetGroups_611687, base: "/",
    url: url_DescribeReplicationSubnetGroups_611688,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationTaskAssessmentResults_611704 = ref object of OpenApiRestCall_610658
proc url_DescribeReplicationTaskAssessmentResults_611706(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeReplicationTaskAssessmentResults_611705(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611707 = query.getOrDefault("Marker")
  valid_611707 = validateParameter(valid_611707, JString, required = false,
                                 default = nil)
  if valid_611707 != nil:
    section.add "Marker", valid_611707
  var valid_611708 = query.getOrDefault("MaxRecords")
  valid_611708 = validateParameter(valid_611708, JString, required = false,
                                 default = nil)
  if valid_611708 != nil:
    section.add "MaxRecords", valid_611708
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611709 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_611709 != nil:
    section.add "X-Amz-Target", valid_611709
...
proc call*(call_611718: Call_DescribeReplicationTaskAssessmentResults_611704;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the task assessment results from Amazon S3. This action always returns the latest results.
  ## 
...
proc call*(call_611719: Call_DescribeReplicationTaskAssessmentResults_611704;
          body: JsonNode; Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611720, "Marker", newJString(Marker))
  if body != nil:
    body_611721 = body
  add(query_611720, "MaxRecords", newJString(MaxRecords))
  result = call_611719.call(nil, query_611720, nil, nil, body_611721)

var describeReplicationTaskAssessmentResults* = Call_DescribeReplicationTaskAssessmentResults_611704(
    ...
    validator: validate_DescribeReplicationTaskAssessmentResults_611705,
    base: "/", url: url_DescribeReplicationTaskAssessmentResults_611706,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReplicationTasks_611722 = ref object of OpenApiRestCall_610658
proc url_DescribeReplicationTasks_611724(protocol: Scheme; host: string;
...
proc validate_DescribeReplicationTasks_611723(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611725 = query.getOrDefault("Marker")
  valid_611725 = validateParameter(valid_611725, JString, required = false,
                                 default = nil)
  if valid_611725 != nil:
    section.add "Marker", valid_611725
  var valid_611726 = query.getOrDefault("MaxRecords")
  valid_611726 = validateParameter(valid_611726, JString, required = false,
                                 default = nil)
  if valid_611726 != nil:
    section.add "MaxRecords", valid_611726
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611736: Call_DescribeReplicationTasks_611722; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about replication tasks for your account in the current region.
  ## 
...
proc call*(call_611737: Call_DescribeReplicationTasks_611722; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  add(query_611738, "Marker", newJString(Marker))
  if body != nil:
    body_611739 = body
  add(query_611738, "MaxRecords", newJString(MaxRecords))
  result = call_611737.call(nil, query_611738, nil, nil, body_611739)

var describeReplicationTasks* = Call_DescribeReplicationTasks_611722(
    name: "describeReplicationTasks", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTasks",
    validator: validate_DescribeReplicationTasks_611723, base: "/",
    url: url_DescribeReplicationTasks_611724, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSchemas_611740 = ref object of OpenApiRestCall_610658
proc url_DescribeSchemas_611742(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeSchemas_611741(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611743 = query.getOrDefault("Marker")
  valid_611743 = validateParameter(valid_611743, JString, required = false,
                                 default = nil)
  if valid_611743 != nil:
    section.add "Marker", valid_611743
  var valid_611744 = query.getOrDefault("MaxRecords")
  valid_611744 = validateParameter(valid_611744, JString, required = false,
                                 default = nil)
  if valid_611744 != nil:
    section.add "MaxRecords", valid_611744
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611754: Call_DescribeSchemas_611740; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns information about the schema for the specified endpoint.</p> <p/>
  ## 
...
proc call*(call_611755: Call_DescribeSchemas_611740; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ## describeSchemas
  ## <p>Returns information about the schema for the specified endpoint.</p> <p/>
  ##   Marker: string
  ...
  add(query_611756, "Marker", newJString(Marker))
  if body != nil:
    body_611757 = body
  add(query_611756, "MaxRecords", newJString(MaxRecords))
  result = call_611755.call(nil, query_611756, nil, nil, body_611757)

var describeSchemas* = Call_DescribeSchemas_611740(name: "describeSchemas",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeSchemas",
    validator: validate_DescribeSchemas_611741, base: "/", url: url_DescribeSchemas_611742,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeTableStatistics_611758 = ref object of OpenApiRestCall_610658
proc url_DescribeTableStatistics_611760(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DescribeTableStatistics_611759(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##             : Pagination limit
  section = newJObject()
  var valid_611761 = query.getOrDefault("Marker")
  valid_611761 = validateParameter(valid_611761, JString, required = false,
                                 default = nil)
  if valid_611761 != nil:
    section.add "Marker", valid_611761
  var valid_611762 = query.getOrDefault("MaxRecords")
  valid_611762 = validateParameter(valid_611762, JString, required = false,
                                 default = nil)
  if valid_611762 != nil:
    section.add "MaxRecords", valid_611762
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Target: JString (required)
  ##   X-Amz-Signature: JString
...
proc call*(call_611772: Call_DescribeTableStatistics_611758; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns table statistics on the database migration task, including table name, rows inserted, rows updated, and rows deleted.</p> <p>Note that the "last updated" column the DMS console only indicates the time that AWS DMS last updated the table statistics record for a table. It does not indicate the time of the last update to the table.</p>
  ## 
...
proc call*(call_611773: Call_DescribeTableStatistics_611758; body: JsonNode;
          Marker: string = ""; MaxRecords: string = ""): Recallable =
  ...
  ##   MaxRecords: string
  ##             : Pagination limit
  var query_611774 = newJObject()
  var body_611775 = newJObject()
  add(query_611774, "Marker", newJString(Marker))
  if body != nil:
    body_611775 = body
  add(query_611774, "MaxRecords", newJString(MaxRecords))
  result = call_611773.call(nil, query_611774, nil, nil, body_611775)

var describeTableStatistics* = Call_DescribeTableStatistics_611758(
    name: "describeTableStatistics", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.DescribeTableStatistics",
    validator: validate_DescribeTableStatistics_611759, base: "/",
    url: url_DescribeTableStatistics_611760, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ImportCertificate_611776 = ref object of OpenApiRestCall_610658
proc url_ImportCertificate_611778(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ImportCertificate_611777(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_611788: Call_ImportCertificate_611776; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Uploads the specified certificate.
  ## 
...
proc call*(call_611789: Call_ImportCertificate_611776; body: JsonNode): Recallable =
  ## importCertificate
  ## Uploads the specified certificate.
  ##   body: JObject (required)
...
var importCertificate* = Call_ImportCertificate_611776(name: "importCertificate",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ImportCertificate",
    validator: validate_ImportCertificate_611777, base: "/",
    url: url_ImportCertificate_611778, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource_611791 = ref object of OpenApiRestCall_610658
proc url_ListTagsForResource_611793(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource_611792(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_611803: Call_ListTagsForResource_611791; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all tags for an AWS DMS resource.
  ## 
...
proc call*(call_611804: Call_ListTagsForResource_611791; body: JsonNode): Recallable =
  ## listTagsForResource
  ## Lists all tags for an AWS DMS resource.
  ##   body: JObject (required)
...
var listTagsForResource* = Call_ListTagsForResource_611791(
    name: "listTagsForResource", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ListTagsForResource",
    validator: validate_ListTagsForResource_611792, base: "/",
    url: url_ListTagsForResource_611793, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyEndpoint_611806 = ref object of OpenApiRestCall_610658
proc url_ModifyEndpoint_611808(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyEndpoint_611807(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_611818: Call_ModifyEndpoint_611806; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the specified endpoint.
  ## 
...
proc call*(call_611819: Call_ModifyEndpoint_611806; body: JsonNode): Recallable =
  ## modifyEndpoint
  ## Modifies the specified endpoint.
  ##   body: JObject (required)
...
var modifyEndpoint* = Call_ModifyEndpoint_611806(name: "modifyEndpoint",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyEndpoint",
    validator: validate_ModifyEndpoint_611807, base: "/", url: url_ModifyEndpoint_611808,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyEventSubscription_611821 = ref object of OpenApiRestCall_610658
proc url_ModifyEventSubscription_611823(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ModifyEventSubscription_611822(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611833: Call_ModifyEventSubscription_611821; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies an existing AWS DMS event notification subscription. 
  ## 
...
proc call*(call_611834: Call_ModifyEventSubscription_611821; body: JsonNode): Recallable =
...
var modifyEventSubscription* = Call_ModifyEventSubscription_611821(
    name: "modifyEventSubscription", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyEventSubscription",
    validator: validate_ModifyEventSubscription_611822, base: "/",
    url: url_ModifyEventSubscription_611823, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationInstance_611836 = ref object of OpenApiRestCall_610658
proc url_ModifyReplicationInstance_611838(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReplicationInstance_611837(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611848: Call_ModifyReplicationInstance_611836; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modifies the replication instance to apply new settings. You can change one or more parameters by specifying these parameters and the new values in the request.</p> <p>Some settings are applied during the maintenance window.</p> <p/>
  ## 
...
proc call*(call_611849: Call_ModifyReplicationInstance_611836; body: JsonNode): Recallable =
...
var modifyReplicationInstance* = Call_ModifyReplicationInstance_611836(
    name: "modifyReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationInstance",
    validator: validate_ModifyReplicationInstance_611837, base: "/",
    url: url_ModifyReplicationInstance_611838,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationSubnetGroup_611851 = ref object of OpenApiRestCall_610658
proc url_ModifyReplicationSubnetGroup_611853(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReplicationSubnetGroup_611852(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611863: Call_ModifyReplicationSubnetGroup_611851; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Modifies the settings for the specified replication subnet group.
  ## 
...
proc call*(call_611864: Call_ModifyReplicationSubnetGroup_611851; body: JsonNode): Recallable =
...
var modifyReplicationSubnetGroup* = Call_ModifyReplicationSubnetGroup_611851(
    ...
    validator: validate_ModifyReplicationSubnetGroup_611852, base: "/",
    url: url_ModifyReplicationSubnetGroup_611853,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReplicationTask_611866 = ref object of OpenApiRestCall_610658
proc url_ModifyReplicationTask_611868(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReplicationTask_611867(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611869 = header.getOrDefault("X-Amz-Target")
  valid_611869 = validateParameter(valid_611869, JString, required = true, default = newJString(
      "AmazonDMSv20160101.ModifyReplicationTask"))
  if valid_611869 != nil:
    section.add "X-Amz-Target", valid_611869
...
proc call*(call_611878: Call_ModifyReplicationTask_611866; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Modifies the specified replication task.</p> <p>You can't modify the task endpoints. The task must be stopped before you can modify it. </p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks</a> in the <i>AWS Database Migration Service User Guide</i>.</p>
  ## 
  let valid = call_611878.validator(path, query, header, formData, body)
  let scheme = call_611878.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_611878.url(scheme.get, call_611878.host, call_611878.base,
                         call_611878.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_611878, url, valid)

proc call*(call_611879: Call_ModifyReplicationTask_611866; body: JsonNode): Recallable =
  ## modifyReplicationTask
  ## <p>Modifies the specified replication task.</p> <p>You can't modify the task endpoints. The task must be stopped before you can modify it. </p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks</a> in the <i>AWS Database Migration Service User Guide</i>.</p>
  ##   body: JObject (required)
  var body_611880 = newJObject()
  if body != nil:
    body_611880 = body
  result = call_611879.call(nil, nil, nil, nil, body_611880)

var modifyReplicationTask* = Call_ModifyReplicationTask_611866(
    name: "modifyReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationTask",
    validator: validate_ModifyReplicationTask_611867, base: "/",
    url: url_ModifyReplicationTask_611868, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RebootReplicationInstance_611881 = ref object of OpenApiRestCall_610658
proc url_RebootReplicationInstance_611883(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RebootReplicationInstance_611882(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611884 = header.getOrDefault("X-Amz-Target")
  valid_611884 = validateParameter(valid_611884, JString, required = true, default = newJString(
      "AmazonDMSv20160101.RebootReplicationInstance"))
  if valid_611884 != nil:
    section.add "X-Amz-Target", valid_611884
...
proc call*(call_611893: Call_RebootReplicationInstance_611881; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Reboots a replication instance. Rebooting results in a momentary outage, until the replication instance becomes available again.
  ## 
  let valid = call_611893.validator(path, query, header, formData, body)
  let scheme = call_611893.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_611893.url(scheme.get, call_611893.host, call_611893.base,
                         call_611893.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_611893, url, valid)

proc call*(call_611894: Call_RebootReplicationInstance_611881; body: JsonNode): Recallable =
  ## rebootReplicationInstance
  ## Reboots a replication instance. Rebooting results in a momentary outage, until the replication instance becomes available again.
  ##   body: JObject (required)
  var body_611895 = newJObject()
  if body != nil:
    body_611895 = body
  result = call_611894.call(nil, nil, nil, nil, body_611895)

var rebootReplicationInstance* = Call_RebootReplicationInstance_611881(
    name: "rebootReplicationInstance", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RebootReplicationInstance",
    validator: validate_RebootReplicationInstance_611882, base: "/",
    url: url_RebootReplicationInstance_611883,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RefreshSchemas_611896 = ref object of OpenApiRestCall_610658
proc url_RefreshSchemas_611898(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RefreshSchemas_611897(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611899 = header.getOrDefault("X-Amz-Target")
  valid_611899 = validateParameter(valid_611899, JString, required = true, default = newJString(
      "AmazonDMSv20160101.RefreshSchemas"))
  if valid_611899 != nil:
    section.add "X-Amz-Target", valid_611899
...
proc call*(call_611908: Call_RefreshSchemas_611896; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Populates the schema for the specified endpoint. This is an asynchronous operation and can take several minutes. You can check the status of this operation by calling the DescribeRefreshSchemasStatus operation.
  ## 
...
proc call*(call_611909: Call_RefreshSchemas_611896; body: JsonNode): Recallable =
  ## refreshSchemas
  ## Populates the schema for the specified endpoint. This is an asynchronous operation and can take several minutes. You can check the status of this operation by calling the DescribeRefreshSchemasStatus operation.
  ##   body: JObject (required)
  var body_611910 = newJObject()
  if body != nil:
    body_611910 = body
  result = call_611909.call(nil, nil, nil, nil, body_611910)

var refreshSchemas* = Call_RefreshSchemas_611896(name: "refreshSchemas",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RefreshSchemas",
    validator: validate_RefreshSchemas_611897, base: "/", url: url_RefreshSchemas_611898,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ReloadTables_611911 = ref object of OpenApiRestCall_610658
proc url_ReloadTables_611913(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ReloadTables_611912(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_611923: Call_ReloadTables_611911; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Reloads the target database table with the source data. 
  ## 
...
proc call*(call_611924: Call_ReloadTables_611911; body: JsonNode): Recallable =
  ## reloadTables
  ## Reloads the target database table with the source data. 
  ##   body: JObject (required)
  var body_611925 = newJObject()
  if body != nil:
    body_611925 = body
  result = call_611924.call(nil, nil, nil, nil, body_611925)

var reloadTables* = Call_ReloadTables_611911(name: "reloadTables",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.ReloadTables",
    validator: validate_ReloadTables_611912, base: "/", url: url_ReloadTables_611913,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_RemoveTagsFromResource_611926 = ref object of OpenApiRestCall_610658
proc url_RemoveTagsFromResource_611928(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoveTagsFromResource_611927(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611929 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_611929 != nil:
    section.add "X-Amz-Target", valid_611929
...
proc call*(call_611938: Call_RemoveTagsFromResource_611926; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes metadata tags from a DMS resource.
  ## 
  let valid = call_611938.validator(path, query, header, formData, body)
  let scheme = call_611938.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_611938.url(scheme.get, call_611938.host, call_611938.base,
                         call_611938.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = atozHook(call_611938, url, valid)

proc call*(call_611939: Call_RemoveTagsFromResource_611926; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_611940 = body
  result = call_611939.call(nil, nil, nil, nil, body_611940)

var removeTagsFromResource* = Call_RemoveTagsFromResource_611926(
    name: "removeTagsFromResource", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.RemoveTagsFromResource",
    validator: validate_RemoveTagsFromResource_611927, base: "/",
    url: url_RemoveTagsFromResource_611928, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartReplicationTask_611941 = ref object of OpenApiRestCall_610658
proc url_StartReplicationTask_611943(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartReplicationTask_611942(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611944 = header.getOrDefault("X-Amz-Target")
  valid_611944 = validateParameter(valid_611944, JString, required = true, default = newJString(
      "AmazonDMSv20160101.StartReplicationTask"))
  if valid_611944 != nil:
    section.add "X-Amz-Target", valid_611944
...
proc call*(call_611953: Call_StartReplicationTask_611941; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Starts the replication task.</p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks </a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ## 
...
proc call*(call_611954: Call_StartReplicationTask_611941; body: JsonNode): Recallable =
  ## startReplicationTask
  ## <p>Starts the replication task.</p> <p>For more information about AWS DMS tasks, see <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html">Working with Migration Tasks </a> in the <i>AWS Database Migration Service User Guide.</i> </p>
  ##   body: JObject (required)
  var body_611955 = newJObject()
  if body != nil:
    body_611955 = body
  result = call_611954.call(nil, nil, nil, nil, body_611955)

var startReplicationTask* = Call_StartReplicationTask_611941(
    name: "startReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTask",
    validator: validate_StartReplicationTask_611942, base: "/",
    url: url_StartReplicationTask_611943, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartReplicationTaskAssessment_611956 = ref object of OpenApiRestCall_610658
proc url_StartReplicationTaskAssessment_611958(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StartReplicationTaskAssessment_611957(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_611968: Call_StartReplicationTaskAssessment_611956; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ##  Starts the replication task assessment for unsupported data types in the source database. 
  ## 
...
proc call*(call_611969: Call_StartReplicationTaskAssessment_611956; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_611970 = body
  result = call_611969.call(nil, nil, nil, nil, body_611970)

var startReplicationTaskAssessment* = Call_StartReplicationTaskAssessment_611956(
    ...
    validator: validate_StartReplicationTaskAssessment_611957, base: "/",
    url: url_StartReplicationTaskAssessment_611958,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StopReplicationTask_611971 = ref object of OpenApiRestCall_610658
proc url_StopReplicationTask_611973(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StopReplicationTask_611972(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611974 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_611974 != nil:
    section.add "X-Amz-Target", valid_611974
...
proc call*(call_611983: Call_StopReplicationTask_611971; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Stops the replication task.</p> <p/>
  ## 
...
proc call*(call_611984: Call_StopReplicationTask_611971; body: JsonNode): Recallable =
  ## stopReplicationTask
  ## <p>Stops the replication task.</p> <p/>
  ##   body: JObject (required)
  var body_611985 = newJObject()
  if body != nil:
    body_611985 = body
  result = call_611984.call(nil, nil, nil, nil, body_611985)

var stopReplicationTask* = Call_StopReplicationTask_611971(
    name: "stopReplicationTask", meth: HttpMethod.HttpPost,
    host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.StopReplicationTask",
    validator: validate_StopReplicationTask_611972, base: "/",
    url: url_StopReplicationTask_611973, schemes: {Scheme.Https, Scheme.Http})
type
  Call_TestConnection_611986 = ref object of OpenApiRestCall_610658
proc url_TestConnection_611988(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TestConnection_611987(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_611989 = header.getOrDefault("X-Amz-Target")
  valid_611989 = validateParameter(valid_611989, JString, required = true, default = newJString(
      "AmazonDMSv20160101.TestConnection"))
  if valid_611989 != nil:
    section.add "X-Amz-Target", valid_611989
...
proc call*(call_611998: Call_TestConnection_611986; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Tests the connection between the replication instance and the endpoint.
  ## 
...
proc call*(call_611999: Call_TestConnection_611986; body: JsonNode): Recallable =
  ## testConnection
  ## Tests the connection between the replication instance and the endpoint.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_612000 = body
  result = call_611999.call(nil, nil, nil, nil, body_612000)

var testConnection* = Call_TestConnection_611986(name: "testConnection",
    meth: HttpMethod.HttpPost, host: "dms.amazonaws.com",
    route: "/#X-Amz-Target=AmazonDMSv20160101.TestConnection",
    validator: validate_TestConnection_611987, base: "/", url: url_TestConnection_611988,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
