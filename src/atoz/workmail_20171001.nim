...
type
  Call_AssociateDelegateToResource_593774 = ref object of OpenApiRestCall_593437
proc url_AssociateDelegateToResource_593776(protocol: Scheme; host: string;
...
proc validate_AssociateDelegateToResource_593775(path: JsonNode; query: JsonNode;
...
proc call*(call_593932: Call_AssociateDelegateToResource_593774; path: JsonNode;
...
proc call*(call_594003: Call_AssociateDelegateToResource_593774; body: JsonNode): Recallable =
...
var associateDelegateToResource* = Call_AssociateDelegateToResource_593774(
    ...
    validator: validate_AssociateDelegateToResource_593775, base: "/",
    url: url_AssociateDelegateToResource_593776,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_AssociateMemberToGroup_594043 = ref object of OpenApiRestCall_593437
proc url_AssociateMemberToGroup_594045(protocol: Scheme; host: string; base: string;
...
proc validate_AssociateMemberToGroup_594044(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594055: Call_AssociateMemberToGroup_594043; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds a member (user or group) to the group's set.
  ## 
...
proc call*(call_594056: Call_AssociateMemberToGroup_594043; body: JsonNode): Recallable =
...
var associateMemberToGroup* = Call_AssociateMemberToGroup_594043(
    name: "associateMemberToGroup", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.AssociateMemberToGroup",
    validator: validate_AssociateMemberToGroup_594044, base: "/",
    url: url_AssociateMemberToGroup_594045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateAlias_594058 = ref object of OpenApiRestCall_593437
proc url_CreateAlias_594060(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateAlias_594059(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_594070: Call_CreateAlias_594058; path: JsonNode; query: JsonNode;
...
proc call*(call_594071: Call_CreateAlias_594058; body: JsonNode): Recallable =
  ## createAlias
  ## Adds an alias to the set of a given member (user or group) of Amazon WorkMail.
  ##   body: JObject (required)
...
var createAlias* = Call_CreateAlias_594058(name: "createAlias",
                                        meth: HttpMethod.HttpPost,
                                        host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.CreateAlias",
                                        validator: validate_CreateAlias_594059,
                                        base: "/", url: url_CreateAlias_594060,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateGroup_594073 = ref object of OpenApiRestCall_593437
proc url_CreateGroup_594075(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateGroup_594074(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594085: Call_CreateGroup_594073; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a group that can be used in Amazon WorkMail by calling the <a>RegisterToWorkMail</a> operation.
  ## 
...
proc call*(call_594086: Call_CreateGroup_594073; body: JsonNode): Recallable =
  ## createGroup
  ## Creates a group that can be used in Amazon WorkMail by calling the <a>RegisterToWorkMail</a> operation.
  ##   body: JObject (required)
...
var createGroup* = Call_CreateGroup_594073(name: "createGroup",
                                        meth: HttpMethod.HttpPost,
                                        host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.CreateGroup",
                                        validator: validate_CreateGroup_594074,
                                        base: "/", url: url_CreateGroup_594075,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateResource_594088 = ref object of OpenApiRestCall_593437
proc url_CreateResource_594090(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateResource_594089(path: JsonNode; query: JsonNode;
...
proc call*(call_594100: Call_CreateResource_594088; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new Amazon WorkMail resource. 
  ## 
...
proc call*(call_594101: Call_CreateResource_594088; body: JsonNode): Recallable =
  ## createResource
  ## Creates a new Amazon WorkMail resource. 
  ##   body: JObject (required)
...
var createResource* = Call_CreateResource_594088(name: "createResource",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.CreateResource",
    validator: validate_CreateResource_594089, base: "/", url: url_CreateResource_594090,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateUser_594103 = ref object of OpenApiRestCall_593437
proc url_CreateUser_594105(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateUser_594104(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594115: Call_CreateUser_594103; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a user who can be used in Amazon WorkMail by calling the <a>RegisterToWorkMail</a> operation.
  ## 
...
proc call*(call_594116: Call_CreateUser_594103; body: JsonNode): Recallable =
  ## createUser
  ## Creates a user who can be used in Amazon WorkMail by calling the <a>RegisterToWorkMail</a> operation.
  ##   body: JObject (required)
...
var createUser* = Call_CreateUser_594103(name: "createUser",
                                      meth: HttpMethod.HttpPost,
                                      host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.CreateUser",
                                      validator: validate_CreateUser_594104,
                                      base: "/", url: url_CreateUser_594105,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteAlias_594118 = ref object of OpenApiRestCall_593437
proc url_DeleteAlias_594120(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteAlias_594119(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594130: Call_DeleteAlias_594118; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Remove one or more specified aliases from a set of aliases for a given user.
  ## 
...
proc call*(call_594131: Call_DeleteAlias_594118; body: JsonNode): Recallable =
  ## deleteAlias
  ## Remove one or more specified aliases from a set of aliases for a given user.
  ##   body: JObject (required)
...
var deleteAlias* = Call_DeleteAlias_594118(name: "deleteAlias",
                                        meth: HttpMethod.HttpPost,
                                        host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.DeleteAlias",
                                        validator: validate_DeleteAlias_594119,
                                        base: "/", url: url_DeleteAlias_594120,
                                        schemes: {Scheme.Https, Scheme.Http})
type
...
proc call*(call_594145: Call_DeleteGroup_594133; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a group from Amazon WorkMail.
  ## 
...
proc call*(call_594146: Call_DeleteGroup_594133; body: JsonNode): Recallable =
  ## deleteGroup
  ## Deletes a group from Amazon WorkMail.
  ##   body: JObject (required)
...
var deleteGroup* = Call_DeleteGroup_594133(name: "deleteGroup",
                                        ...
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteMailboxPermissions_594148 = ref object of OpenApiRestCall_593437
proc url_DeleteMailboxPermissions_594150(protocol: Scheme; host: string;
...
proc validate_DeleteMailboxPermissions_594149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594160: Call_DeleteMailboxPermissions_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes permissions granted to a member (user or group).
  ## 
...
proc call*(call_594161: Call_DeleteMailboxPermissions_594148; body: JsonNode): Recallable =
...
var deleteMailboxPermissions* = Call_DeleteMailboxPermissions_594148(
    name: "deleteMailboxPermissions", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DeleteMailboxPermissions",
    validator: validate_DeleteMailboxPermissions_594149, base: "/",
    url: url_DeleteMailboxPermissions_594150, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteResource_594163 = ref object of OpenApiRestCall_593437
proc url_DeleteResource_594165(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteResource_594164(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594175: Call_DeleteResource_594163; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified resource. 
  ## 
...
proc call*(call_594176: Call_DeleteResource_594163; body: JsonNode): Recallable =
  ## deleteResource
  ## Deletes the specified resource. 
  ##   body: JObject (required)
...
var deleteResource* = Call_DeleteResource_594163(name: "deleteResource",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DeleteResource",
    validator: validate_DeleteResource_594164, base: "/", url: url_DeleteResource_594165,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteUser_594178 = ref object of OpenApiRestCall_593437
proc url_DeleteUser_594180(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteUser_594179(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594190: Call_DeleteUser_594178; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Deletes a user from Amazon WorkMail and all subsequent systems. Before you can delete a user, the user state must be <code>DISABLED</code>. Use the <a>DescribeUser</a> action to confirm the user state.</p> <p>Deleting a user is permanent and cannot be undone. WorkMail archives user mailboxes for 30 days before they are permanently removed.</p>
  ## 
...
proc call*(call_594191: Call_DeleteUser_594178; body: JsonNode): Recallable =
  ## deleteUser
  ## <p>Deletes a user from Amazon WorkMail and all subsequent systems. Before you can delete a user, the user state must be <code>DISABLED</code>. Use the <a>DescribeUser</a> action to confirm the user state.</p> <p>Deleting a user is permanent and cannot be undone. WorkMail archives user mailboxes for 30 days before they are permanently removed.</p>
  ##   body: JObject (required)
...
var deleteUser* = Call_DeleteUser_594178(name: "deleteUser",
                                      meth: HttpMethod.HttpPost,
                                      host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.DeleteUser",
                                      validator: validate_DeleteUser_594179,
                                      base: "/", url: url_DeleteUser_594180,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeregisterFromWorkMail_594193 = ref object of OpenApiRestCall_593437
proc url_DeregisterFromWorkMail_594195(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeregisterFromWorkMail_594194(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594205: Call_DeregisterFromWorkMail_594193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Mark a user, group, or resource as no longer used in Amazon WorkMail. This action disassociates the mailbox and schedules it for clean-up. WorkMail keeps mailboxes for 30 days before they are permanently removed. The functionality in the console is <i>Disable</i>.
  ## 
...
proc call*(call_594206: Call_DeregisterFromWorkMail_594193; body: JsonNode): Recallable =
...
var deregisterFromWorkMail* = Call_DeregisterFromWorkMail_594193(
    name: "deregisterFromWorkMail", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DeregisterFromWorkMail",
    validator: validate_DeregisterFromWorkMail_594194, base: "/",
    url: url_DeregisterFromWorkMail_594195, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeGroup_594208 = ref object of OpenApiRestCall_593437
proc url_DescribeGroup_594210(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeGroup_594209(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594220: Call_DescribeGroup_594208; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the data available for the group.
  ## 
...
proc call*(call_594221: Call_DescribeGroup_594208; body: JsonNode): Recallable =
  ## describeGroup
  ## Returns the data available for the group.
  ##   body: JObject (required)
...
var describeGroup* = Call_DescribeGroup_594208(name: "describeGroup",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DescribeGroup",
    validator: validate_DescribeGroup_594209, base: "/", url: url_DescribeGroup_594210,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeOrganization_594223 = ref object of OpenApiRestCall_593437
proc url_DescribeOrganization_594225(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeOrganization_594224(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594235: Call_DescribeOrganization_594223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides more information regarding a given organization based on its identifier.
  ## 
...
proc call*(call_594236: Call_DescribeOrganization_594223; body: JsonNode): Recallable =
...
var describeOrganization* = Call_DescribeOrganization_594223(
    name: "describeOrganization", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DescribeOrganization",
    validator: validate_DescribeOrganization_594224, base: "/",
    url: url_DescribeOrganization_594225, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeResource_594238 = ref object of OpenApiRestCall_593437
proc url_DescribeResource_594240(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeResource_594239(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594250: Call_DescribeResource_594238; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the data available for the resource.
  ## 
...
proc call*(call_594251: Call_DescribeResource_594238; body: JsonNode): Recallable =
  ## describeResource
  ## Returns the data available for the resource.
  ##   body: JObject (required)
...
var describeResource* = Call_DescribeResource_594238(name: "describeResource",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DescribeResource",
    validator: validate_DescribeResource_594239, base: "/",
    url: url_DescribeResource_594240, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeUser_594253 = ref object of OpenApiRestCall_593437
proc url_DescribeUser_594255(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeUser_594254(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594265: Call_DescribeUser_594253; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Provides information regarding the user.
  ## 
...
proc call*(call_594266: Call_DescribeUser_594253; body: JsonNode): Recallable =
  ## describeUser
  ## Provides information regarding the user.
  ##   body: JObject (required)
...
var describeUser* = Call_DescribeUser_594253(name: "describeUser",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DescribeUser",
    validator: validate_DescribeUser_594254, base: "/", url: url_DescribeUser_594255,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateDelegateFromResource_594268 = ref object of OpenApiRestCall_593437
proc url_DisassociateDelegateFromResource_594270(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateDelegateFromResource_594269(path: JsonNode;
...
proc call*(call_594280: Call_DisassociateDelegateFromResource_594268;
...
proc call*(call_594281: Call_DisassociateDelegateFromResource_594268;
          body: JsonNode): Recallable =
...
var disassociateDelegateFromResource* = Call_DisassociateDelegateFromResource_594268(
    ...
    validator: validate_DisassociateDelegateFromResource_594269, base: "/",
    url: url_DisassociateDelegateFromResource_594270,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DisassociateMemberFromGroup_594283 = ref object of OpenApiRestCall_593437
proc url_DisassociateMemberFromGroup_594285(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DisassociateMemberFromGroup_594284(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594295: Call_DisassociateMemberFromGroup_594283; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Removes a member from a group.
  ## 
...
proc call*(call_594296: Call_DisassociateMemberFromGroup_594283; body: JsonNode): Recallable =
...
var disassociateMemberFromGroup* = Call_DisassociateMemberFromGroup_594283(
    name: "disassociateMemberFromGroup", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.DisassociateMemberFromGroup",
    validator: validate_DisassociateMemberFromGroup_594284, base: "/",
    url: url_DisassociateMemberFromGroup_594285,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetMailboxDetails_594298 = ref object of OpenApiRestCall_593437
proc url_GetMailboxDetails_594300(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetMailboxDetails_594299(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594310: Call_GetMailboxDetails_594298; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Requests a user's mailbox details for a specified organization and user.
  ## 
...
proc call*(call_594311: Call_GetMailboxDetails_594298; body: JsonNode): Recallable =
  ## getMailboxDetails
  ## Requests a user's mailbox details for a specified organization and user.
  ##   body: JObject (required)
...
var getMailboxDetails* = Call_GetMailboxDetails_594298(name: "getMailboxDetails",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.GetMailboxDetails",
    validator: validate_GetMailboxDetails_594299, base: "/",
    url: url_GetMailboxDetails_594300, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListAliases_594313 = ref object of OpenApiRestCall_593437
proc url_ListAliases_594315(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListAliases_594314(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594327: Call_ListAliases_594313; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a paginated call to list the aliases associated with a given entity.
  ## 
...
proc call*(call_594328: Call_ListAliases_594313; body: JsonNode;
...
var listAliases* = Call_ListAliases_594313(name: "listAliases",
                                        meth: HttpMethod.HttpPost,
                                        host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.ListAliases",
                                        validator: validate_ListAliases_594314,
                                        base: "/", url: url_ListAliases_594315,
                                        schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListGroupMembers_594332 = ref object of OpenApiRestCall_593437
proc url_ListGroupMembers_594334(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListGroupMembers_594333(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594346: Call_ListGroupMembers_594332; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns an overview of the members of a group. Users and groups can be members of a group.
  ## 
...
proc call*(call_594347: Call_ListGroupMembers_594332; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listGroupMembers
  ## Returns an overview of the members of a group. Users and groups can be members of a group.
  ##   NextToken: string
...
var listGroupMembers* = Call_ListGroupMembers_594332(name: "listGroupMembers",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ListGroupMembers",
    validator: validate_ListGroupMembers_594333, base: "/",
    url: url_ListGroupMembers_594334, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListGroups_594350 = ref object of OpenApiRestCall_593437
proc url_ListGroups_594352(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListGroups_594351(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594364: Call_ListGroups_594350; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns summaries of the organization's groups.
  ## 
...
proc call*(call_594365: Call_ListGroups_594350; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listGroups
  ## Returns summaries of the organization's groups.
  ##   NextToken: string
...
var listGroups* = Call_ListGroups_594350(name: "listGroups",
                                      meth: HttpMethod.HttpPost,
                                      host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.ListGroups",
                                      validator: validate_ListGroups_594351,
                                      base: "/", url: url_ListGroups_594352,
                                      schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListMailboxPermissions_594368 = ref object of OpenApiRestCall_593437
proc url_ListMailboxPermissions_594370(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListMailboxPermissions_594369(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594382: Call_ListMailboxPermissions_594368; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the mailbox permissions associated with a user, group, or resource mailbox.
  ## 
...
proc call*(call_594383: Call_ListMailboxPermissions_594368; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listMailboxPermissions* = Call_ListMailboxPermissions_594368(
    name: "listMailboxPermissions", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ListMailboxPermissions",
    validator: validate_ListMailboxPermissions_594369, base: "/",
    url: url_ListMailboxPermissions_594370, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListOrganizations_594386 = ref object of OpenApiRestCall_593437
proc url_ListOrganizations_594388(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListOrganizations_594387(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594400: Call_ListOrganizations_594386; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns summaries of the customer's non-deleted organizations.
  ## 
...
proc call*(call_594401: Call_ListOrganizations_594386; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listOrganizations
  ## Returns summaries of the customer's non-deleted organizations.
  ##   NextToken: string
...
var listOrganizations* = Call_ListOrganizations_594386(name: "listOrganizations",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ListOrganizations",
    validator: validate_ListOrganizations_594387, base: "/",
    url: url_ListOrganizations_594388, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResourceDelegates_594404 = ref object of OpenApiRestCall_593437
proc url_ListResourceDelegates_594406(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResourceDelegates_594405(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594418: Call_ListResourceDelegates_594404; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the delegates associated with a resource. Users and groups can be resource delegates and answer requests on behalf of the resource.
  ## 
...
proc call*(call_594419: Call_ListResourceDelegates_594404; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listResourceDelegates* = Call_ListResourceDelegates_594404(
    name: "listResourceDelegates", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ListResourceDelegates",
    validator: validate_ListResourceDelegates_594405, base: "/",
    url: url_ListResourceDelegates_594406, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListResources_594422 = ref object of OpenApiRestCall_593437
proc url_ListResources_594424(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListResources_594423(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594436: Call_ListResources_594422; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns summaries of the organization's resources.
  ## 
...
proc call*(call_594437: Call_ListResources_594422; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listResources
  ## Returns summaries of the organization's resources.
  ##   NextToken: string
...
var listResources* = Call_ListResources_594422(name: "listResources",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ListResources",
    validator: validate_ListResources_594423, base: "/", url: url_ListResources_594424,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListUsers_594440 = ref object of OpenApiRestCall_593437
proc url_ListUsers_594442(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListUsers_594441(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594454: Call_ListUsers_594440; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns summaries of the organization's users.
  ## 
...
proc call*(call_594455: Call_ListUsers_594440; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listUsers
  ## Returns summaries of the organization's users.
  ##   NextToken: string
...
var listUsers* = Call_ListUsers_594440(name: "listUsers", meth: HttpMethod.HttpPost,
                                    host: "workmail.amazonaws.com", route: "/#X-Amz-Target=WorkMailService.ListUsers",
                                    validator: validate_ListUsers_594441,
                                    base: "/", url: url_ListUsers_594442,
                                    schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutMailboxPermissions_594458 = ref object of OpenApiRestCall_593437
proc url_PutMailboxPermissions_594460(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutMailboxPermissions_594459(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594463 = header.getOrDefault("X-Amz-Target")
  ...
  if valid_594463 != nil:
    section.add "X-Amz-Target", valid_594463
...
proc call*(call_594470: Call_PutMailboxPermissions_594458; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Sets permissions for a user, group, or resource. This replaces any pre-existing permissions.
  ## 
...
proc call*(call_594471: Call_PutMailboxPermissions_594458; body: JsonNode): Recallable =
  ...
  if body != nil:
    body_594472 = body
  result = call_594471.call(nil, nil, nil, nil, body_594472)

var putMailboxPermissions* = Call_PutMailboxPermissions_594458(
    name: "putMailboxPermissions", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.PutMailboxPermissions",
    validator: validate_PutMailboxPermissions_594459, base: "/",
    url: url_PutMailboxPermissions_594460, schemes: {Scheme.Https, Scheme.Http})
type
  Call_RegisterToWorkMail_594473 = ref object of OpenApiRestCall_593437
proc url_RegisterToWorkMail_594475(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegisterToWorkMail_594474(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594485: Call_RegisterToWorkMail_594473; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Registers an existing and disabled user, group, or resource for Amazon WorkMail use by associating a mailbox and calendaring capabilities. It performs no change if the user, group, or resource is enabled and fails if the user, group, or resource is deleted. This operation results in the accumulation of costs. For more information, see <a href="https://aws.amazon.com//workmail/pricing">Pricing</a>. The equivalent console functionality for this operation is <i>Enable</i>. </p> <p>Users can either be created by calling the <a>CreateUser</a> API operation or they can be synchronized from your directory. For more information, see <a>DeregisterFromWorkMail</a>.</p>
  ## 
...
proc call*(call_594486: Call_RegisterToWorkMail_594473; body: JsonNode): Recallable =
  ## registerToWorkMail
  ## <p>Registers an existing and disabled user, group, or resource for Amazon WorkMail use by associating a mailbox and calendaring capabilities. It performs no change if the user, group, or resource is enabled and fails if the user, group, or resource is deleted. This operation results in the accumulation of costs. For more information, see <a href="https://aws.amazon.com//workmail/pricing">Pricing</a>. The equivalent console functionality for this operation is <i>Enable</i>. </p> <p>Users can either be created by calling the <a>CreateUser</a> API operation or they can be synchronized from your directory. For more information, see <a>DeregisterFromWorkMail</a>.</p>
  ##   body: JObject (required)
  ...
  if body != nil:
    body_594487 = body
  result = call_594486.call(nil, nil, nil, nil, body_594487)

var registerToWorkMail* = Call_RegisterToWorkMail_594473(
    name: "registerToWorkMail", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.RegisterToWorkMail",
    validator: validate_RegisterToWorkMail_594474, base: "/",
    url: url_RegisterToWorkMail_594475, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ResetPassword_594488 = ref object of OpenApiRestCall_593437
proc url_ResetPassword_594490(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResetPassword_594489(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594500: Call_ResetPassword_594488; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Allows the administrator to reset the password for a user.
  ## 
...
proc call*(call_594501: Call_ResetPassword_594488; body: JsonNode): Recallable =
  ## resetPassword
  ## Allows the administrator to reset the password for a user.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_594502 = body
  result = call_594501.call(nil, nil, nil, nil, body_594502)

var resetPassword* = Call_ResetPassword_594488(name: "resetPassword",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.ResetPassword",
    validator: validate_ResetPassword_594489, base: "/", url: url_ResetPassword_594490,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateMailboxQuota_594503 = ref object of OpenApiRestCall_593437
proc url_UpdateMailboxQuota_594505(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateMailboxQuota_594504(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert header != nil,
        "header argument is necessary due to required `X-Amz-Target` field"
  var valid_594508 = header.getOrDefault("X-Amz-Target")
  valid_594508 = validateParameter(valid_594508, JString, required = true, default = newJString(
      "WorkMailService.UpdateMailboxQuota"))
  if valid_594508 != nil:
    section.add "X-Amz-Target", valid_594508
...
proc call*(call_594515: Call_UpdateMailboxQuota_594503; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a user's current mailbox quota for a specified organization and user.
  ## 
...
proc call*(call_594516: Call_UpdateMailboxQuota_594503; body: JsonNode): Recallable =
  ## updateMailboxQuota
  ## Updates a user's current mailbox quota for a specified organization and user.
  ##   body: JObject (required)
  ...
  if body != nil:
    body_594517 = body
  result = call_594516.call(nil, nil, nil, nil, body_594517)

var updateMailboxQuota* = Call_UpdateMailboxQuota_594503(
    name: "updateMailboxQuota", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.UpdateMailboxQuota",
    validator: validate_UpdateMailboxQuota_594504, base: "/",
    url: url_UpdateMailboxQuota_594505, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdatePrimaryEmailAddress_594518 = ref object of OpenApiRestCall_593437
proc url_UpdatePrimaryEmailAddress_594520(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdatePrimaryEmailAddress_594519(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594530: Call_UpdatePrimaryEmailAddress_594518; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the primary email for a user, group, or resource. The current email is moved into the list of aliases (or swapped between an existing alias and the current primary email), and the email provided in the input is promoted as the primary.
  ## 
...
proc call*(call_594531: Call_UpdatePrimaryEmailAddress_594518; body: JsonNode): Recallable =
...
var updatePrimaryEmailAddress* = Call_UpdatePrimaryEmailAddress_594518(
    name: "updatePrimaryEmailAddress", meth: HttpMethod.HttpPost,
    host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.UpdatePrimaryEmailAddress",
    validator: validate_UpdatePrimaryEmailAddress_594519, base: "/",
    url: url_UpdatePrimaryEmailAddress_594520,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateResource_594533 = ref object of OpenApiRestCall_593437
proc url_UpdateResource_594535(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateResource_594534(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_594545: Call_UpdateResource_594533; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates data for the resource. To have the latest information, it must be preceded by a <a>DescribeResource</a> call. The dataset in the request should be the one expected when performing another <code>DescribeResource</code> call.
  ## 
...
proc call*(call_594546: Call_UpdateResource_594533; body: JsonNode): Recallable =
  ## updateResource
  ## Updates data for the resource. To have the latest information, it must be preceded by a <a>DescribeResource</a> call. The dataset in the request should be the one expected when performing another <code>DescribeResource</code> call.
  ##   body: JObject (required)
...
var updateResource* = Call_UpdateResource_594533(name: "updateResource",
    meth: HttpMethod.HttpPost, host: "workmail.amazonaws.com",
    route: "/#X-Amz-Target=WorkMailService.UpdateResource",
    validator: validate_UpdateResource_594534, base: "/", url: url_UpdateResource_594535,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
