...
type
  Call_PutSigningProfile_601038 = ref object of OpenApiRestCall_600426
proc url_PutSigningProfile_601040(protocol: Scheme; host: string; base: string;
...
proc validate_PutSigningProfile_601039(path: JsonNode; query: JsonNode;
  ...
  var valid_601041 = path.getOrDefault("profileName")
  valid_601041 = validateParameter(valid_601041, JString, required = true,
                                 default = nil)
  if valid_601041 != nil:
    section.add "profileName", valid_601041
...
proc call*(call_601050: Call_PutSigningProfile_601038; path: JsonNode;
...
proc call*(call_601051: Call_PutSigningProfile_601038; profileName: string;
  ...
  add(path_601052, "profileName", newJString(profileName))
  if body != nil:
    body_601053 = body
  result = call_601051.call(path_601052, nil, nil, nil, body_601053)

var putSigningProfile* = Call_PutSigningProfile_601038(name: "putSigningProfile",
    meth: HttpMethod.HttpPut, host: "signer.amazonaws.com",
    route: "/signing-profiles/{profileName}",
    validator: validate_PutSigningProfile_601039, base: "/",
    url: url_PutSigningProfile_601040, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSigningProfile_600768 = ref object of OpenApiRestCall_600426
proc url_GetSigningProfile_600770(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "profileName" in path, "`profileName` is a required path parameter"
  const
...
proc validate_GetSigningProfile_600769(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `profileName` field"
  var valid_600896 = path.getOrDefault("profileName")
  valid_600896 = validateParameter(valid_600896, JString, required = true,
                                 default = nil)
  if valid_600896 != nil:
    section.add "profileName", valid_600896
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_600926: Call_GetSigningProfile_600768; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information on a specific signing profile.
  ## 
...
proc call*(call_600997: Call_GetSigningProfile_600768; profileName: string): Recallable =
  ## getSigningProfile
  ## Returns information on a specific signing profile.
  ##   profileName: string (required)
  ##              : The name of the target signing profile.
  var path_600998 = newJObject()
  add(path_600998, "profileName", newJString(profileName))
  result = call_600997.call(path_600998, nil, nil, nil, nil)

var getSigningProfile* = Call_GetSigningProfile_600768(name: "getSigningProfile",
    meth: HttpMethod.HttpGet, host: "signer.amazonaws.com",
    route: "/signing-profiles/{profileName}",
    validator: validate_GetSigningProfile_600769, base: "/",
    url: url_GetSigningProfile_600770, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CancelSigningProfile_601054 = ref object of OpenApiRestCall_600426
proc url_CancelSigningProfile_601056(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "profileName" in path, "`profileName` is a required path parameter"
  const
...
proc validate_CancelSigningProfile_601055(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `profileName` field"
  var valid_601057 = path.getOrDefault("profileName")
  valid_601057 = validateParameter(valid_601057, JString, required = true,
                                 default = nil)
  if valid_601057 != nil:
    section.add "profileName", valid_601057
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601065: Call_CancelSigningProfile_601054; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Changes the state of an <code>ACTIVE</code> signing profile to <code>CANCELED</code>. A canceled profile is still viewable with the <code>ListSigningProfiles</code> operation, but it cannot perform new signing jobs, and is deleted two years after cancelation.
  ## 
...
proc call*(call_601066: Call_CancelSigningProfile_601054; profileName: string): Recallable =
  ## cancelSigningProfile
  ## Changes the state of an <code>ACTIVE</code> signing profile to <code>CANCELED</code>. A canceled profile is still viewable with the <code>ListSigningProfiles</code> operation, but it cannot perform new signing jobs, and is deleted two years after cancelation.
  ##   profileName: string (required)
  ##              : The name of the signing profile to be canceled.
  var path_601067 = newJObject()
  add(path_601067, "profileName", newJString(profileName))
  result = call_601066.call(path_601067, nil, nil, nil, nil)

var cancelSigningProfile* = Call_CancelSigningProfile_601054(
    name: "cancelSigningProfile", meth: HttpMethod.HttpDelete,
    host: "signer.amazonaws.com", route: "/signing-profiles/{profileName}",
    validator: validate_CancelSigningProfile_601055, base: "/",
    url: url_CancelSigningProfile_601056, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeSigningJob_601068 = ref object of OpenApiRestCall_600426
proc url_DescribeSigningJob_601070(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
...
proc validate_DescribeSigningJob_601069(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_601079: Call_DescribeSigningJob_601068; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about a specific code signing job. You specify the job by using the <code>jobId</code> value that is returned by the <a>StartSigningJob</a> operation. 
  ## 
...
proc call*(call_601080: Call_DescribeSigningJob_601068; jobId: string): Recallable =
  ## describeSigningJob
  ## Returns information about a specific code signing job. You specify the job by using the <code>jobId</code> value that is returned by the <a>StartSigningJob</a> operation. 
  ##   jobId: string (required)
  ##        : The ID of the signing job on input.
  var path_601081 = newJObject()
  add(path_601081, "jobId", newJString(jobId))
  result = call_601080.call(path_601081, nil, nil, nil, nil)

var describeSigningJob* = Call_DescribeSigningJob_601068(
    name: "describeSigningJob", meth: HttpMethod.HttpGet,
    host: "signer.amazonaws.com", route: "/signing-jobs/{jobId}",
    validator: validate_DescribeSigningJob_601069, base: "/",
    url: url_DescribeSigningJob_601070, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetSigningPlatform_601082 = ref object of OpenApiRestCall_600426
proc url_GetSigningPlatform_601084(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
...
proc validate_GetSigningPlatform_601083(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_601085 = path.getOrDefault("platformId")
  valid_601085 = validateParameter(valid_601085, JString, required = true,
                                 default = nil)
  if valid_601085 != nil:
    section.add "platformId", valid_601085
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_601093: Call_GetSigningPlatform_601082; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information on a specific signing platform.
  ## 
...
proc call*(call_601094: Call_GetSigningPlatform_601082; platformId: string): Recallable =
  ## getSigningPlatform
  ## Returns information on a specific signing platform.
  ##   platformId: string (required)
  ##             : The ID of the target signing platform.
  var path_601095 = newJObject()
  add(path_601095, "platformId", newJString(platformId))
  result = call_601094.call(path_601095, nil, nil, nil, nil)

var getSigningPlatform* = Call_GetSigningPlatform_601082(
    name: "getSigningPlatform", meth: HttpMethod.HttpGet,
    host: "signer.amazonaws.com", route: "/signing-platforms/{platformId}",
    validator: validate_GetSigningPlatform_601083, base: "/",
    url: url_GetSigningPlatform_601084, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartSigningJob_601127 = ref object of OpenApiRestCall_600426
proc url_StartSigningJob_601129(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartSigningJob_601128(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_601138: Call_StartSigningJob_601127; path: JsonNode; query: JsonNode;
...
proc call*(call_601139: Call_StartSigningJob_601127; body: JsonNode): Recallable =
  ## startSigningJob
  ## <p>Initiates a signing job to be performed on the code provided. Signing jobs are viewable by the <code>ListSigningJobs</code> operation for two years after they are performed. Note the following requirements: </p> <ul> <li> <p> You must create an Amazon S3 source bucket. For more information, see <a href="http://docs.aws.amazon.com/AmazonS3/latest/gsg/CreatingABucket.html">Create a Bucket</a> in the <i>Amazon S3 Getting Started Guide</i>. </p> </li> <li> <p>Your S3 source bucket must be version enabled.</p> </li> <li> <p>You must create an S3 destination bucket. AWS Signer uses your S3 destination bucket to write your signed code.</p> </li> <li> <p>You specify the name of the source and destination buckets when calling the <code>StartSigningJob</code> operation.</p> </li> <li> <p>You must also specify a request token that identifies your request to AWS Signer. </p> </li> </ul> <p>You can call the <a>DescribeSigningJob</a> and the <a>ListSigningJobs</a> actions after you call <code>StartSigningJob</code>.</p> <p>For a Java example that shows how to use this action, see <a href="http://docs.aws.amazon.com/acm/latest/userguide/">http://docs.aws.amazon.com/acm/latest/userguide/</a> </p>
  ##   body: JObject (required)
...
var startSigningJob* = Call_StartSigningJob_601127(name: "startSigningJob",
    meth: HttpMethod.HttpPost, host: "signer.amazonaws.com", route: "/signing-jobs",
    validator: validate_StartSigningJob_601128, base: "/", url: url_StartSigningJob_601129,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSigningJobs_601096 = ref object of OpenApiRestCall_600426
proc url_ListSigningJobs_601098(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListSigningJobs_601097(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_601099 = query.getOrDefault("platformId")
  valid_601099 = validateParameter(valid_601099, JString, required = false,
                                 default = nil)
  if valid_601099 != nil:
    section.add "platformId", valid_601099
  var valid_601100 = query.getOrDefault("requestedBy")
  valid_601100 = validateParameter(valid_601100, JString, required = false,
                                 default = nil)
  if valid_601100 != nil:
    section.add "requestedBy", valid_601100
  var valid_601101 = query.getOrDefault("maxResults")
  valid_601101 = validateParameter(valid_601101, JInt, required = false, default = nil)
  if valid_601101 != nil:
    section.add "maxResults", valid_601101
  var valid_601102 = query.getOrDefault("nextToken")
  valid_601102 = validateParameter(valid_601102, JString, required = false,
                                 default = nil)
  if valid_601102 != nil:
    section.add "nextToken", valid_601102
  var valid_601116 = query.getOrDefault("status")
  valid_601116 = validateParameter(valid_601116, JString, required = false,
                                 default = newJString("InProgress"))
  if valid_601116 != nil:
    section.add "status", valid_601116
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601124: Call_ListSigningJobs_601096; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all your signing jobs. You can use the <code>maxResults</code> parameter to limit the number of signing jobs that are returned in the response. If additional jobs remain to be listed, AWS Signer returns a <code>nextToken</code> value. Use this value in subsequent calls to <code>ListSigningJobs</code> to fetch the remaining values. You can continue calling <code>ListSigningJobs</code> with your <code>maxResults</code> parameter and with new values that AWS Signer returns in the <code>nextToken</code> parameter until all of your signing jobs have been returned. 
  ## 
...
proc call*(call_601125: Call_ListSigningJobs_601096; platformId: string = "";
  ...
  add(query_601126, "platformId", newJString(platformId))
  add(query_601126, "requestedBy", newJString(requestedBy))
  add(query_601126, "maxResults", newJInt(maxResults))
  add(query_601126, "nextToken", newJString(nextToken))
  add(query_601126, "status", newJString(status))
  result = call_601125.call(nil, query_601126, nil, nil, nil)

var listSigningJobs* = Call_ListSigningJobs_601096(name: "listSigningJobs",
    meth: HttpMethod.HttpGet, host: "signer.amazonaws.com", route: "/signing-jobs",
    validator: validate_ListSigningJobs_601097, base: "/", url: url_ListSigningJobs_601098,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSigningPlatforms_601141 = ref object of OpenApiRestCall_600426
proc url_ListSigningPlatforms_601143(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListSigningPlatforms_601142(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_601144 = query.getOrDefault("target")
  valid_601144 = validateParameter(valid_601144, JString, required = false,
                                 default = nil)
  if valid_601144 != nil:
    section.add "target", valid_601144
  ...
  var valid_601147 = query.getOrDefault("partner")
  valid_601147 = validateParameter(valid_601147, JString, required = false,
                                 default = nil)
  if valid_601147 != nil:
    section.add "partner", valid_601147
  var valid_601148 = query.getOrDefault("category")
  valid_601148 = validateParameter(valid_601148, JString, required = false,
                                 default = nil)
  if valid_601148 != nil:
    section.add "category", valid_601148
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601156: Call_ListSigningPlatforms_601141; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all signing platforms available in AWS Signer that match the request parameters. If additional jobs remain to be listed, AWS Signer returns a <code>nextToken</code> value. Use this value in subsequent calls to <code>ListSigningJobs</code> to fetch the remaining values. You can continue calling <code>ListSigningJobs</code> with your <code>maxResults</code> parameter and with new values that AWS Signer returns in the <code>nextToken</code> parameter until all of your signing jobs have been returned.
  ## 
...
proc call*(call_601157: Call_ListSigningPlatforms_601141; target: string = "";
  ...
  add(query_601158, "target", newJString(target))
  add(query_601158, "maxResults", newJInt(maxResults))
  add(query_601158, "nextToken", newJString(nextToken))
  add(query_601158, "partner", newJString(partner))
  add(query_601158, "category", newJString(category))
  result = call_601157.call(nil, query_601158, nil, nil, nil)

var listSigningPlatforms* = Call_ListSigningPlatforms_601141(
    name: "listSigningPlatforms", meth: HttpMethod.HttpGet,
    host: "signer.amazonaws.com", route: "/signing-platforms",
    validator: validate_ListSigningPlatforms_601142, base: "/",
    url: url_ListSigningPlatforms_601143, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListSigningProfiles_601159 = ref object of OpenApiRestCall_600426
proc url_ListSigningProfiles_601161(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListSigningProfiles_601160(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  valid_601162 = validateParameter(valid_601162, JInt, required = false, default = nil)
  if valid_601162 != nil:
  ...
  var valid_601164 = query.getOrDefault("includeCanceled")
  valid_601164 = validateParameter(valid_601164, JBool, required = false, default = nil)
  if valid_601164 != nil:
    section.add "includeCanceled", valid_601164
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_601172: Call_ListSigningProfiles_601159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all available signing profiles in your AWS account. Returns only profiles with an <code>ACTIVE</code> status unless the <code>includeCanceled</code> request field is set to <code>true</code>. If additional jobs remain to be listed, AWS Signer returns a <code>nextToken</code> value. Use this value in subsequent calls to <code>ListSigningJobs</code> to fetch the remaining values. You can continue calling <code>ListSigningJobs</code> with your <code>maxResults</code> parameter and with new values that AWS Signer returns in the <code>nextToken</code> parameter until all of your signing jobs have been returned.
  ## 
...
proc call*(call_601173: Call_ListSigningProfiles_601159; maxResults: int = 0;
  ...
  add(query_601174, "maxResults", newJInt(maxResults))
  add(query_601174, "nextToken", newJString(nextToken))
  add(query_601174, "includeCanceled", newJBool(includeCanceled))
  result = call_601173.call(nil, query_601174, nil, nil, nil)

var listSigningProfiles* = Call_ListSigningProfiles_601159(
    name: "listSigningProfiles", meth: HttpMethod.HttpGet,
    host: "signer.amazonaws.com", route: "/signing-profiles",
    validator: validate_ListSigningProfiles_601160, base: "/",
    url: url_ListSigningProfiles_601161, schemes: {Scheme.Https, Scheme.Http})
export
  rest
