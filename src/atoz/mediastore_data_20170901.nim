...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "data.mediastore.ap-northeast-1.amazonaws.com", "ap-southeast-1": "data.mediastore.ap-southeast-1.amazonaws.com", "us-west-2": "data.mediastore.us-west-2.amazonaws.com", "eu-west-2": "data.mediastore.eu-west-2.amazonaws.com", "ap-northeast-3": "data.mediastore.ap-northeast-3.amazonaws.com", "eu-central-1": "data.mediastore.eu-central-1.amazonaws.com", "us-east-2": "data.mediastore.us-east-2.amazonaws.com", "us-east-1": "data.mediastore.us-east-1.amazonaws.com", "cn-northwest-1": "data.mediastore.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "data.mediastore.ap-south-1.amazonaws.com", "eu-north-1": "data.mediastore.eu-north-1.amazonaws.com", "ap-northeast-2": "data.mediastore.ap-northeast-2.amazonaws.com", "us-west-1": "data.mediastore.us-west-1.amazonaws.com", "us-gov-east-1": "data.mediastore.us-gov-east-1.amazonaws.com", "eu-west-3": "data.mediastore.eu-west-3.amazonaws.com", "cn-north-1": "data.mediastore.cn-north-1.amazonaws.com.cn", "sa-east-1": "data.mediastore.sa-east-1.amazonaws.com", "eu-west-1": "data.mediastore.eu-west-1.amazonaws.com", "us-gov-west-1": "data.mediastore.us-gov-west-1.amazonaws.com", "ap-southeast-2": "data.mediastore.ap-southeast-2.amazonaws.com", "ca-central-1": "data.mediastore.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_PutObject_402656482 = ref object of OpenApiRestCall_402656038
proc url_PutObject_402656484(protocol: Scheme; host: string; base: string;
...
proc validate_PutObject_402656483(path: JsonNode; query: JsonNode;
  ...
  ##   Cache-Control: JString
                               ...
                               ## <p>Headers 
                               ## with a custom user-defined value are also accepted.</p>
  ##   
  ...
  ##   
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           ## received.
  section = newJObject()
  var valid_402656486 = header.getOrDefault("X-Amz-Security-Token")
  valid_402656486 = validateParameter(valid_402656486, JString,
                                      required = false, default = nil)
  if valid_402656486 != nil:
    section.add "X-Amz-Security-Token", valid_402656486
  var valid_402656487 = header.getOrDefault("X-Amz-Signature")
  valid_402656487 = validateParameter(valid_402656487, JString,
                                      required = false, default = nil)
  if valid_402656487 != nil:
    section.add "X-Amz-Signature", valid_402656487
  var valid_402656488 = header.getOrDefault("Cache-Control")
  valid_402656488 = validateParameter(valid_402656488, JString,
                                      required = false, default = nil)
  if valid_402656488 != nil:
    section.add "Cache-Control", valid_402656488
  var valid_402656501 = header.getOrDefault("x-amz-upload-availability")
  valid_402656501 = validateParameter(valid_402656501, JString,
                                      required = false,
                                      default = newJString("STANDARD"))
  if valid_402656501 != nil:
    section.add "x-amz-upload-availability", valid_402656501
  ...
  var valid_402656507 = header.getOrDefault("Content-Type")
  valid_402656507 = validateParameter(valid_402656507, JString,
                                      required = false, default = nil)
  if valid_402656507 != nil:
    section.add "Content-Type", valid_402656507
  var valid_402656508 = header.getOrDefault("x-amz-storage-class")
  valid_402656508 = validateParameter(valid_402656508, JString,
                                      required = false,
                                      default = newJString("TEMPORAL"))
  if valid_402656508 != nil:
    section.add "x-amz-storage-class", valid_402656508
...
proc call*(call_402656510: Call_PutObject_402656482; path: JsonNode = nil;
...
proc call*(call_402656511: Call_PutObject_402656482; body: JsonNode;
  ...
  if body != nil:
    body_402656513 = body
  add(path_402656512, "Path", newJString(Path))
  result = call_402656511.call(path_402656512, nil, nil, nil, body_402656513)

var putObject* = Call_PutObject_402656482(name: "putObject",
    meth: HttpMethod.HttpPut, host: "data.mediastore.amazonaws.com",
    route: "/{Path}", validator: validate_PutObject_402656483, base: "/",
    makeUrl: url_PutObject_402656484, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeObject_402656528 = ref object of OpenApiRestCall_402656038
proc url_DescribeObject_402656530(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeObject_402656529(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656539: Call_DescribeObject_402656528; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets the headers for an object at the specified path.
                                                                                         ## 
...
proc call*(call_402656540: Call_DescribeObject_402656528; Path: string): Recallable =
  ## describeObject
  ## Gets the headers for an object at the specified path.
  ##   Path: string (required)
                                                          ##       : The path (including the file name) where the object is stored in the container. Format: &lt;folder name&gt;/&lt;folder name&gt;/&lt;file name&gt;
  var path_402656541 = newJObject()
  add(path_402656541, "Path", newJString(Path))
  result = call_402656540.call(path_402656541, nil, nil, nil, nil)

var describeObject* = Call_DescribeObject_402656528(name: "describeObject",
    meth: HttpMethod.HttpHead, host: "data.mediastore.amazonaws.com",
    route: "/{Path}", validator: validate_DescribeObject_402656529, base: "/",
    makeUrl: url_DescribeObject_402656530, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetObject_402656288 = ref object of OpenApiRestCall_402656038
proc url_GetObject_402656290(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetObject_402656289(path: JsonNode; query: JsonNode;
                                  header: JsonNode; formData: JsonNode;
                                  body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   Range: JString
                               ...
                               ## AWS 
                               ## Elemental MediaStore ignores this header for partially uploaded objects that have streaming upload availability.
  ##   
                                                                                                                                                  ## X-Amz-Content-Sha256: JString
  ##   
                                                                                                                                                                                  ## X-Amz-Algorithm: JString
  ...
  var valid_402656383 = header.getOrDefault("Range")
  valid_402656383 = validateParameter(valid_402656383, JString,
                                      required = false, default = nil)
  if valid_402656383 != nil:
    section.add "Range", valid_402656383
...
proc call*(call_402656402: Call_GetObject_402656288; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Downloads the object at the specified path. If the object’s upload availability is set to <code>streaming</code>, AWS Elemental MediaStore downloads the object even if it’s still uploading the object.
                                                                                         ## 
...
proc call*(call_402656451: Call_GetObject_402656288; Path: string): Recallable =
  ## getObject
  ## Downloads the object at the specified path. If the object’s upload availability is set to <code>streaming</code>, AWS Elemental MediaStore downloads the object even if it’s still uploading the object.
  ##   
                                                                                                                                                                                                                 ## Path: string (required)
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 ## extension. 
                                                                                                                                                                                                                 ## </p>
  var path_402656452 = newJObject()
  add(path_402656452, "Path", newJString(Path))
  result = call_402656451.call(path_402656452, nil, nil, nil, nil)

var getObject* = Call_GetObject_402656288(name: "getObject",
    meth: HttpMethod.HttpGet, host: "data.mediastore.amazonaws.com",
    route: "/{Path}", validator: validate_GetObject_402656289, base: "/",
    makeUrl: url_GetObject_402656290, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteObject_402656514 = ref object of OpenApiRestCall_402656038
proc url_DeleteObject_402656516(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteObject_402656515(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656525: Call_DeleteObject_402656514; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes an object at the specified path.
                                                                                         ## 
...
proc call*(call_402656526: Call_DeleteObject_402656514; Path: string): Recallable =
  ## deleteObject
  ## Deletes an object at the specified path.
  ##   Path: string (required)
                                             ##       : The path (including the file name) where the object is stored in the container. Format: &lt;folder name&gt;/&lt;folder name&gt;/&lt;file name&gt;
  var path_402656527 = newJObject()
  add(path_402656527, "Path", newJString(Path))
  result = call_402656526.call(path_402656527, nil, nil, nil, nil)

var deleteObject* = Call_DeleteObject_402656514(name: "deleteObject",
    meth: HttpMethod.HttpDelete, host: "data.mediastore.amazonaws.com",
    route: "/{Path}", validator: validate_DeleteObject_402656515, base: "/",
    makeUrl: url_DeleteObject_402656516, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListItems_402656542 = ref object of OpenApiRestCall_402656038
proc url_ListItems_402656544(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListItems_402656543(path: JsonNode; query: JsonNode;
                                  header: JsonNode; formData: JsonNode;
                                  body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
  ...
  ##   
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ## name&gt;
  section = newJObject()
  var valid_402656545 = query.getOrDefault("MaxResults")
  valid_402656545 = validateParameter(valid_402656545, JInt, required = false,
                                      default = nil)
  if valid_402656545 != nil:
    section.add "MaxResults", valid_402656545
  var valid_402656546 = query.getOrDefault("NextToken")
  valid_402656546 = validateParameter(valid_402656546, JString,
                                      required = false, default = nil)
  if valid_402656546 != nil:
    section.add "NextToken", valid_402656546
  var valid_402656547 = query.getOrDefault("Path")
  valid_402656547 = validateParameter(valid_402656547, JString,
                                      required = false, default = nil)
  if valid_402656547 != nil:
    section.add "Path", valid_402656547
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Security-Token: JString
  ##   X-Amz-Signature: JString
...
proc call*(call_402656555: Call_ListItems_402656542; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Provides a list of metadata entries about folders and objects in the specified folder.
                                                                                         ## 
...
proc call*(call_402656556: Call_ListItems_402656542; MaxResults: int = 0;
  ...
  ##   
                                                                                                                      ...
                                                                                                                      ## name&gt;/&lt;file 
                                                                                                                      ## name&gt;
  var query_402656557 = newJObject()
  add(query_402656557, "MaxResults", newJInt(MaxResults))
  add(query_402656557, "NextToken", newJString(NextToken))
  add(query_402656557, "Path", newJString(Path))
  result = call_402656556.call(nil, query_402656557, nil, nil, nil)

var listItems* = Call_ListItems_402656542(name: "listItems",
    meth: HttpMethod.HttpGet, host: "data.mediastore.amazonaws.com", route: "/",
    validator: validate_ListItems_402656543, base: "/", makeUrl: url_ListItems_402656544,
