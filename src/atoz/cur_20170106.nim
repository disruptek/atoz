...
type
  Call_DeleteReportDefinition_601718 = ref object of OpenApiRestCall_601380
proc url_DeleteReportDefinition_601720(protocol: Scheme; host: string; base: string;
...
proc validate_DeleteReportDefinition_601719(path: JsonNode; query: JsonNode;
...
proc call*(call_601876: Call_DeleteReportDefinition_601718; path: JsonNode;
...
proc call*(call_601947: Call_DeleteReportDefinition_601718; body: JsonNode): Recallable =
...
var deleteReportDefinition* = Call_DeleteReportDefinition_601718(
    ...
    validator: validate_DeleteReportDefinition_601719, base: "/",
    url: url_DeleteReportDefinition_601720, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeReportDefinitions_601987 = ref object of OpenApiRestCall_601380
proc url_DescribeReportDefinitions_601989(protocol: Scheme; host: string;
...
proc validate_DescribeReportDefinitions_601988(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602001: Call_DescribeReportDefinitions_601987; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the AWS Cost and Usage reports available to this account.
  ## 
...
proc call*(call_602002: Call_DescribeReportDefinitions_601987; body: JsonNode;
...
var describeReportDefinitions* = Call_DescribeReportDefinitions_601987(
    ...
    validator: validate_DescribeReportDefinitions_601988, base: "/",
    url: url_DescribeReportDefinitions_601989,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ModifyReportDefinition_602006 = ref object of OpenApiRestCall_601380
proc url_ModifyReportDefinition_602008(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ModifyReportDefinition_602007(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602018: Call_ModifyReportDefinition_602006; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Allows you to programatically update your report preferences.
  ## 
...
proc call*(call_602019: Call_ModifyReportDefinition_602006; body: JsonNode): Recallable =
...
var modifyReportDefinition* = Call_ModifyReportDefinition_602006(
    ...
    validator: validate_ModifyReportDefinition_602007, base: "/",
    url: url_ModifyReportDefinition_602008, schemes: {Scheme.Https, Scheme.Http})
type
  Call_PutReportDefinition_602021 = ref object of OpenApiRestCall_601380
proc url_PutReportDefinition_602023(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PutReportDefinition_602022(path: JsonNode; query: JsonNode;
...
proc call*(call_602033: Call_PutReportDefinition_602021; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new report using the description that you provide.
  ## 
...
proc call*(call_602034: Call_PutReportDefinition_602021; body: JsonNode): Recallable =
  ## putReportDefinition
  ## Creates a new report using the description that you provide.
  ##   body: JObject (required)
...
var putReportDefinition* = Call_PutReportDefinition_602021(
    ...
    validator: validate_PutReportDefinition_602022, base: "/",
    url: url_PutReportDefinition_602023, schemes: {Scheme.Https, Scheme.Http})
export
  rest
