...
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_CreateVocabulary_21625779 = ref object of OpenApiRestCall_21625435
proc url_CreateVocabulary_21625781(protocol: Scheme; host: string; base: string;
...
proc validate_CreateVocabulary_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_CreateVocabulary_21625779; path: JsonNode = nil;
...
proc call*(call_21625992: Call_CreateVocabulary_21625779; body: JsonNode): Recallable =
  ## createVocabulary
  ## Creates a new custom vocabulary that you can use to change the way Amazon Transcribe handles transcription of an audio file. 
  ##   body: JObject (required)
...
var createVocabulary* = Call_CreateVocabulary_21625779(name: "createVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.CreateVocabulary",
    validator: validate_CreateVocabulary_21625780, base: "/",
    makeUrl: url_CreateVocabulary_21625781, schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateVocabularyFilter_21626029 = ref object of OpenApiRestCall_21625435
proc url_CreateVocabularyFilter_21626031(protocol: Scheme; host: string;
...
proc validate_CreateVocabularyFilter_21626030(path: JsonNode; query: JsonNode;
...
proc call*(call_21626041: Call_CreateVocabularyFilter_21626029;
...
proc call*(call_21626042: Call_CreateVocabularyFilter_21626029; body: JsonNode): Recallable =
...
var createVocabularyFilter* = Call_CreateVocabularyFilter_21626029(
    ...
    validator: validate_CreateVocabularyFilter_21626030, base: "/",
    makeUrl: url_CreateVocabularyFilter_21626031,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTranscriptionJob_21626044 = ref object of OpenApiRestCall_21625435
proc url_DeleteTranscriptionJob_21626046(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteTranscriptionJob_21626045(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626056: Call_DeleteTranscriptionJob_21626044;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a previously submitted transcription job along with any other generated results such as the transcription, models, and so on.
  ## 
...
proc call*(call_21626057: Call_DeleteTranscriptionJob_21626044; body: JsonNode): Recallable =
...
var deleteTranscriptionJob* = Call_DeleteTranscriptionJob_21626044(
    name: "deleteTranscriptionJob", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.DeleteTranscriptionJob",
    validator: validate_DeleteTranscriptionJob_21626045, base: "/",
    makeUrl: url_DeleteTranscriptionJob_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteVocabulary_21626059 = ref object of OpenApiRestCall_21625435
proc url_DeleteVocabulary_21626061(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteVocabulary_21626060(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626071: Call_DeleteVocabulary_21626059; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Deletes a vocabulary from Amazon Transcribe. 
  ## 
...
proc call*(call_21626072: Call_DeleteVocabulary_21626059; body: JsonNode): Recallable =
  ## deleteVocabulary
  ## Deletes a vocabulary from Amazon Transcribe. 
  ##   body: JObject (required)
...
var deleteVocabulary* = Call_DeleteVocabulary_21626059(name: "deleteVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.DeleteVocabulary",
    validator: validate_DeleteVocabulary_21626060, base: "/",
    makeUrl: url_DeleteVocabulary_21626061, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteVocabularyFilter_21626074 = ref object of OpenApiRestCall_21625435
proc url_DeleteVocabularyFilter_21626076(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteVocabularyFilter_21626075(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626086: Call_DeleteVocabularyFilter_21626074;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Removes a vocabulary filter.
  ## 
...
proc call*(call_21626087: Call_DeleteVocabularyFilter_21626074; body: JsonNode): Recallable =
...
var deleteVocabularyFilter* = Call_DeleteVocabularyFilter_21626074(
    name: "deleteVocabularyFilter", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.DeleteVocabularyFilter",
    validator: validate_DeleteVocabularyFilter_21626075, base: "/",
    makeUrl: url_DeleteVocabularyFilter_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetTranscriptionJob_21626089 = ref object of OpenApiRestCall_21625435
proc url_GetTranscriptionJob_21626091(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetTranscriptionJob_21626090(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_GetTranscriptionJob_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about a transcription job. To see the status of the job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in the <code>TranscriptFileUri</code> field. If you enable content redaction, the redacted transcript appears in <code>RedactedTranscriptFileUri</code>.
  ## 
...
proc call*(call_21626102: Call_GetTranscriptionJob_21626089; body: JsonNode): Recallable =
  ## getTranscriptionJob
  ## Returns information about a transcription job. To see the status of the job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in the <code>TranscriptFileUri</code> field. If you enable content redaction, the redacted transcript appears in <code>RedactedTranscriptFileUri</code>.
  ##   body: JObject (required)
...
var getTranscriptionJob* = Call_GetTranscriptionJob_21626089(
    name: "getTranscriptionJob", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.GetTranscriptionJob",
    validator: validate_GetTranscriptionJob_21626090, base: "/",
    makeUrl: url_GetTranscriptionJob_21626091,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetVocabulary_21626104 = ref object of OpenApiRestCall_21625435
proc url_GetVocabulary_21626106(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetVocabulary_21626105(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
...
proc call*(call_21626116: Call_GetVocabulary_21626104; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about a vocabulary. 
  ## 
...
proc call*(call_21626117: Call_GetVocabulary_21626104; body: JsonNode): Recallable =
  ## getVocabulary
  ## Gets information about a vocabulary. 
  ##   body: JObject (required)
...
var getVocabulary* = Call_GetVocabulary_21626104(name: "getVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.GetVocabulary",
    validator: validate_GetVocabulary_21626105, base: "/",
    makeUrl: url_GetVocabulary_21626106, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetVocabularyFilter_21626119 = ref object of OpenApiRestCall_21625435
proc url_GetVocabularyFilter_21626121(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetVocabularyFilter_21626120(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626131: Call_GetVocabularyFilter_21626119; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns information about a vocabulary filter.
  ## 
...
proc call*(call_21626132: Call_GetVocabularyFilter_21626119; body: JsonNode): Recallable =
  ## getVocabularyFilter
  ## Returns information about a vocabulary filter.
  ##   body: JObject (required)
...
var getVocabularyFilter* = Call_GetVocabularyFilter_21626119(
    name: "getVocabularyFilter", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.GetVocabularyFilter",
    validator: validate_GetVocabularyFilter_21626120, base: "/",
    makeUrl: url_GetVocabularyFilter_21626121,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTranscriptionJobs_21626134 = ref object of OpenApiRestCall_21625435
proc url_ListTranscriptionJobs_21626136(protocol: Scheme; host: string; base: string;
...
proc validate_ListTranscriptionJobs_21626135(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626148: Call_ListTranscriptionJobs_21626134;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Lists transcription jobs with the specified status.
  ## 
...
proc call*(call_21626149: Call_ListTranscriptionJobs_21626134; body: JsonNode;
...
var listTranscriptionJobs* = Call_ListTranscriptionJobs_21626134(
    name: "listTranscriptionJobs", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.ListTranscriptionJobs",
    validator: validate_ListTranscriptionJobs_21626135, base: "/",
    makeUrl: url_ListTranscriptionJobs_21626136,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListVocabularies_21626156 = ref object of OpenApiRestCall_21625435
proc url_ListVocabularies_21626158(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListVocabularies_21626157(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626170: Call_ListVocabularies_21626156; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns a list of vocabularies that match the specified criteria. If no criteria are specified, returns the entire list of vocabularies.
  ## 
...
proc call*(call_21626171: Call_ListVocabularies_21626156; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listVocabularies
  ## Returns a list of vocabularies that match the specified criteria. If no criteria are specified, returns the entire list of vocabularies.
  ##   NextToken: string
...
var listVocabularies* = Call_ListVocabularies_21626156(name: "listVocabularies",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.ListVocabularies",
    validator: validate_ListVocabularies_21626157, base: "/",
    makeUrl: url_ListVocabularies_21626158, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListVocabularyFilters_21626174 = ref object of OpenApiRestCall_21625435
proc url_ListVocabularyFilters_21626176(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ListVocabularyFilters_21626175(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626188: Call_ListVocabularyFilters_21626174;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Gets information about vocabulary filters.
  ## 
...
proc call*(call_21626189: Call_ListVocabularyFilters_21626174; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
...
var listVocabularyFilters* = Call_ListVocabularyFilters_21626174(
    name: "listVocabularyFilters", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.ListVocabularyFilters",
    validator: validate_ListVocabularyFilters_21626175, base: "/",
    makeUrl: url_ListVocabularyFilters_21626176,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartTranscriptionJob_21626192 = ref object of OpenApiRestCall_21625435
proc url_StartTranscriptionJob_21626194(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_StartTranscriptionJob_21626193(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626204: Call_StartTranscriptionJob_21626192;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Starts an asynchronous job to transcribe speech to text. 
  ## 
...
proc call*(call_21626205: Call_StartTranscriptionJob_21626192; body: JsonNode): Recallable =
...
var startTranscriptionJob* = Call_StartTranscriptionJob_21626192(
    name: "startTranscriptionJob", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.StartTranscriptionJob",
    validator: validate_StartTranscriptionJob_21626193, base: "/",
    makeUrl: url_StartTranscriptionJob_21626194,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateVocabulary_21626207 = ref object of OpenApiRestCall_21625435
proc url_UpdateVocabulary_21626209(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateVocabulary_21626208(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626219: Call_UpdateVocabulary_21626207; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates an existing vocabulary with new values. The <code>UpdateVocabulary</code> operation overwrites all of the existing information with the values that you provide in the request. 
  ## 
...
proc call*(call_21626220: Call_UpdateVocabulary_21626207; body: JsonNode): Recallable =
  ## updateVocabulary
  ## Updates an existing vocabulary with new values. The <code>UpdateVocabulary</code> operation overwrites all of the existing information with the values that you provide in the request. 
  ##   body: JObject (required)
...
var updateVocabulary* = Call_UpdateVocabulary_21626207(name: "updateVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.UpdateVocabulary",
    validator: validate_UpdateVocabulary_21626208, base: "/",
    makeUrl: url_UpdateVocabulary_21626209, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateVocabularyFilter_21626222 = ref object of OpenApiRestCall_21625435
proc url_UpdateVocabularyFilter_21626224(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_UpdateVocabularyFilter_21626223(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626234: Call_UpdateVocabularyFilter_21626222;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Updates a vocabulary filter with a new list of filtered words.
  ## 
...
proc call*(call_21626235: Call_UpdateVocabularyFilter_21626222; body: JsonNode): Recallable =
...
var updateVocabularyFilter* = Call_UpdateVocabularyFilter_21626222(
    name: "updateVocabularyFilter", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.UpdateVocabularyFilter",
    validator: validate_UpdateVocabularyFilter_21626223, base: "/",
    makeUrl: url_UpdateVocabularyFilter_21626224,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
