...
type
  Call_CreateVocabulary_600768 = ref object of OpenApiRestCall_600426
proc url_CreateVocabulary_600770(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateVocabulary_600769(path: JsonNode; query: JsonNode;
...
proc call*(call_600926: Call_CreateVocabulary_600768; path: JsonNode;
...
proc call*(call_600997: Call_CreateVocabulary_600768; body: JsonNode): Recallable =
  ## createVocabulary
  ## Creates a new custom vocabulary that you can use to change the way Amazon Transcribe handles transcription of an audio file. 
  ##   body: JObject (required)
...
var createVocabulary* = Call_CreateVocabulary_600768(name: "createVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.CreateVocabulary",
    validator: validate_CreateVocabulary_600769, base: "/",
    url: url_CreateVocabulary_600770, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteTranscriptionJob_601037 = ref object of OpenApiRestCall_600426
proc url_DeleteTranscriptionJob_601039(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteTranscriptionJob_601038(path: JsonNode; query: JsonNode;
...
proc call*(call_601049: Call_DeleteTranscriptionJob_601037; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a previously submitted transcription job along with any other generated results such as the transcription, models, and so on.
  ## 
...
proc call*(call_601050: Call_DeleteTranscriptionJob_601037; body: JsonNode): Recallable =
...
var deleteTranscriptionJob* = Call_DeleteTranscriptionJob_601037(
    ...
    validator: validate_DeleteTranscriptionJob_601038, base: "/",
    url: url_DeleteTranscriptionJob_601039, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteVocabulary_601052 = ref object of OpenApiRestCall_600426
proc url_DeleteVocabulary_601054(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_DeleteVocabulary_601053(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601064: Call_DeleteVocabulary_601052; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a vocabulary from Amazon Transcribe. 
  ## 
...
proc call*(call_601065: Call_DeleteVocabulary_601052; body: JsonNode): Recallable =
  ## deleteVocabulary
  ## Deletes a vocabulary from Amazon Transcribe. 
  ##   body: JObject (required)
...
var deleteVocabulary* = Call_DeleteVocabulary_601052(name: "deleteVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.DeleteVocabulary",
    validator: validate_DeleteVocabulary_601053, base: "/",
    url: url_DeleteVocabulary_601054, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetTranscriptionJob_601067 = ref object of OpenApiRestCall_600426
proc url_GetTranscriptionJob_601069(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetTranscriptionJob_601068(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_601079: Call_GetTranscriptionJob_601067; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns information about a transcription job. To see the status of the job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in the <code>TranscriptionFileUri</code> field.
  ## 
...
proc call*(call_601080: Call_GetTranscriptionJob_601067; body: JsonNode): Recallable =
  ## getTranscriptionJob
  ## Returns information about a transcription job. To see the status of the job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in the <code>TranscriptionFileUri</code> field.
  ##   body: JObject (required)
...
var getTranscriptionJob* = Call_GetTranscriptionJob_601067(
    name: "getTranscriptionJob", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.GetTranscriptionJob",
    validator: validate_GetTranscriptionJob_601068, base: "/",
    url: url_GetTranscriptionJob_601069, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetVocabulary_601082 = ref object of OpenApiRestCall_600426
proc url_GetVocabulary_601084(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetVocabulary_601083(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_601094: Call_GetVocabulary_601082; path: JsonNode; query: JsonNode;
...
proc call*(call_601095: Call_GetVocabulary_601082; body: JsonNode): Recallable =
  ## getVocabulary
  ## Gets information about a vocabulary. 
  ##   body: JObject (required)
...
var getVocabulary* = Call_GetVocabulary_601082(name: "getVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.GetVocabulary",
    validator: validate_GetVocabulary_601083, base: "/", url: url_GetVocabulary_601084,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTranscriptionJobs_601097 = ref object of OpenApiRestCall_600426
proc url_ListTranscriptionJobs_601099(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListTranscriptionJobs_601098(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601111: Call_ListTranscriptionJobs_601097; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists transcription jobs with the specified status.
  ## 
...
proc call*(call_601112: Call_ListTranscriptionJobs_601097; body: JsonNode;
...
var listTranscriptionJobs* = Call_ListTranscriptionJobs_601097(
    name: "listTranscriptionJobs", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.ListTranscriptionJobs",
    validator: validate_ListTranscriptionJobs_601098, base: "/",
    url: url_ListTranscriptionJobs_601099, schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListVocabularies_601116 = ref object of OpenApiRestCall_600426
proc url_ListVocabularies_601118(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_ListVocabularies_601117(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601130: Call_ListVocabularies_601116; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of vocabularies that match the specified criteria. If no criteria are specified, returns the entire list of vocabularies.
  ## 
...
proc call*(call_601131: Call_ListVocabularies_601116; body: JsonNode;
          NextToken: string = ""; MaxResults: string = ""): Recallable =
  ## listVocabularies
  ## Returns a list of vocabularies that match the specified criteria. If no criteria are specified, returns the entire list of vocabularies.
  ##   NextToken: string
...
var listVocabularies* = Call_ListVocabularies_601116(name: "listVocabularies",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.ListVocabularies",
    validator: validate_ListVocabularies_601117, base: "/",
    url: url_ListVocabularies_601118, schemes: {Scheme.Https, Scheme.Http})
type
  Call_StartTranscriptionJob_601134 = ref object of OpenApiRestCall_600426
proc url_StartTranscriptionJob_601136(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_StartTranscriptionJob_601135(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_601146: Call_StartTranscriptionJob_601134; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts an asynchronous job to transcribe speech to text. 
  ## 
...
proc call*(call_601147: Call_StartTranscriptionJob_601134; body: JsonNode): Recallable =
...
var startTranscriptionJob* = Call_StartTranscriptionJob_601134(
    name: "startTranscriptionJob", meth: HttpMethod.HttpPost,
    host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.StartTranscriptionJob",
    validator: validate_StartTranscriptionJob_601135, base: "/",
    url: url_StartTranscriptionJob_601136, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateVocabulary_601149 = ref object of OpenApiRestCall_600426
proc url_UpdateVocabulary_601151(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_UpdateVocabulary_601150(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_601161: Call_UpdateVocabulary_601149; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing vocabulary with new values. The <code>UpdateVocabulary</code> operation overwrites all of the existing information with the values that you provide in the request. 
  ## 
...
proc call*(call_601162: Call_UpdateVocabulary_601149; body: JsonNode): Recallable =
  ## updateVocabulary
  ## Updates an existing vocabulary with new values. The <code>UpdateVocabulary</code> operation overwrites all of the existing information with the values that you provide in the request. 
  ##   body: JObject (required)
...
var updateVocabulary* = Call_UpdateVocabulary_601149(name: "updateVocabulary",
    meth: HttpMethod.HttpPost, host: "transcribe.amazonaws.com",
    route: "/#X-Amz-Target=Transcribe.UpdateVocabulary",
    validator: validate_UpdateVocabulary_601150, base: "/",
    url: url_UpdateVocabulary_601151, schemes: {Scheme.Https, Scheme.Http})
export
  rest
