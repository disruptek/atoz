...
type
  Call_GetAutoScalingGroupRecommendations_402656294 = ref object of OpenApiRestCall_402656044
proc url_GetAutoScalingGroupRecommendations_402656296(protocol: Scheme;
...
proc validate_GetAutoScalingGroupRecommendations_402656295(path: JsonNode;
...
proc call*(call_402656412: Call_GetAutoScalingGroupRecommendations_402656294;
...
proc call*(call_402656461: Call_GetAutoScalingGroupRecommendations_402656294;
...
var getAutoScalingGroupRecommendations* = Call_GetAutoScalingGroupRecommendations_402656294(
    ...
    validator: validate_GetAutoScalingGroupRecommendations_402656295, base: "/",
    makeUrl: url_GetAutoScalingGroupRecommendations_402656296,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEC2InstanceRecommendations_402656489 = ref object of OpenApiRestCall_402656044
proc url_GetEC2InstanceRecommendations_402656491(protocol: Scheme; host: string;
...
proc validate_GetEC2InstanceRecommendations_402656490(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656501: Call_GetEC2InstanceRecommendations_402656489;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns Amazon EC2 instance recommendations.</p> <p>AWS Compute Optimizer currently generates recommendations for Amazon Elastic Compute Cloud (Amazon EC2) and Amazon EC2 Auto Scaling. It generates recommendations for M, C, R, T, and X instance families. For more information, see the <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/what-is.html">AWS Compute Optimizer User Guide</a>.</p>
                                                                                         ## 
...
proc call*(call_402656502: Call_GetEC2InstanceRecommendations_402656489;
           body: JsonNode): Recallable =
...
var getEC2InstanceRecommendations* = Call_GetEC2InstanceRecommendations_402656489(
    ...
    validator: validate_GetEC2InstanceRecommendations_402656490, base: "/",
    makeUrl: url_GetEC2InstanceRecommendations_402656491,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEC2RecommendationProjectedMetrics_402656504 = ref object of OpenApiRestCall_402656044
proc url_GetEC2RecommendationProjectedMetrics_402656506(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetEC2RecommendationProjectedMetrics_402656505(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656516: Call_GetEC2RecommendationProjectedMetrics_402656504;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Returns the projected utilization metrics of Amazon EC2 instance recommendations.
                                                                                         ## 
...
proc call*(call_402656517: Call_GetEC2RecommendationProjectedMetrics_402656504;
           body: JsonNode): Recallable =
...
var getEC2RecommendationProjectedMetrics* = Call_GetEC2RecommendationProjectedMetrics_402656504(
    ...
    validator: validate_GetEC2RecommendationProjectedMetrics_402656505,
    base: "/", makeUrl: url_GetEC2RecommendationProjectedMetrics_402656506,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEnrollmentStatus_402656519 = ref object of OpenApiRestCall_402656044
proc url_GetEnrollmentStatus_402656521(protocol: Scheme; host: string;
...
proc validate_GetEnrollmentStatus_402656520(path: JsonNode; query: JsonNode;
...
proc call*(call_402656531: Call_GetEnrollmentStatus_402656519;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation also confirms the enrollment status of member accounts within the organization.</p>
                                                                                         ## 
...
proc call*(call_402656532: Call_GetEnrollmentStatus_402656519; body: JsonNode): Recallable =
  ## getEnrollmentStatus
  ## <p>Returns the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation also confirms the enrollment status of member accounts within the organization.</p>
  ##   
                                                                                                                                                                                                                                                                   ## body: JObject (required)
...
var getEnrollmentStatus* = Call_GetEnrollmentStatus_402656519(
    ...
    validator: validate_GetEnrollmentStatus_402656520, base: "/",
    makeUrl: url_GetEnrollmentStatus_402656521,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRecommendationSummaries_402656534 = ref object of OpenApiRestCall_402656044
proc url_GetRecommendationSummaries_402656536(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRecommendationSummaries_402656535(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
...
proc call*(call_402656546: Call_GetRecommendationSummaries_402656534;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Returns the optimization findings for an account.</p> <p>For example, it returns the number of Amazon EC2 instances in an account that are under-provisioned, over-provisioned, or optimized. It also returns the number of Auto Scaling groups in an account that are not optimized, or optimized.</p>
                                                                                         ## 
...
proc call*(call_402656547: Call_GetRecommendationSummaries_402656534;
           body: JsonNode): Recallable =
...
var getRecommendationSummaries* = Call_GetRecommendationSummaries_402656534(
    ...
    validator: validate_GetRecommendationSummaries_402656535, base: "/",
    makeUrl: url_GetRecommendationSummaries_402656536,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEnrollmentStatus_402656549 = ref object of OpenApiRestCall_402656044
proc url_UpdateEnrollmentStatus_402656551(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEnrollmentStatus_402656550(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656561: Call_UpdateEnrollmentStatus_402656549;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation can also enroll member accounts within the organization.</p>
                                                                                         ## 
...
proc call*(call_402656562: Call_UpdateEnrollmentStatus_402656549; body: JsonNode): Recallable =
...
var updateEnrollmentStatus* = Call_UpdateEnrollmentStatus_402656549(
    name: "updateEnrollmentStatus", meth: HttpMethod.HttpPost,
    host: "compute-optimizer.amazonaws.com",
    route: "/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus",
    validator: validate_UpdateEnrollmentStatus_402656550, base: "/",
    makeUrl: url_UpdateEnrollmentStatus_402656551,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
