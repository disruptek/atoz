...
type
  Call_GetAutoScalingGroupRecommendations_601727 = ref object of OpenApiRestCall_601389
proc url_GetAutoScalingGroupRecommendations_601729(protocol: Scheme; host: string;
...
proc validate_GetAutoScalingGroupRecommendations_601728(path: JsonNode;
...
proc call*(call_601885: Call_GetAutoScalingGroupRecommendations_601727;
...
proc call*(call_601956: Call_GetAutoScalingGroupRecommendations_601727;
          body: JsonNode): Recallable =
...
var getAutoScalingGroupRecommendations* = Call_GetAutoScalingGroupRecommendations_601727(
    ...
    validator: validate_GetAutoScalingGroupRecommendations_601728, base: "/",
    url: url_GetAutoScalingGroupRecommendations_601729,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEC2InstanceRecommendations_601996 = ref object of OpenApiRestCall_601389
proc url_GetEC2InstanceRecommendations_601998(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetEC2InstanceRecommendations_601997(path: JsonNode; query: JsonNode;
...
proc call*(call_602008: Call_GetEC2InstanceRecommendations_601996; path: JsonNode;
...
proc call*(call_602009: Call_GetEC2InstanceRecommendations_601996; body: JsonNode): Recallable =
...
var getEC2InstanceRecommendations* = Call_GetEC2InstanceRecommendations_601996(
    ...
    validator: validate_GetEC2InstanceRecommendations_601997, base: "/",
    url: url_GetEC2InstanceRecommendations_601998,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEC2RecommendationProjectedMetrics_602011 = ref object of OpenApiRestCall_601389
proc url_GetEC2RecommendationProjectedMetrics_602013(protocol: Scheme;
...
proc validate_GetEC2RecommendationProjectedMetrics_602012(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602023: Call_GetEC2RecommendationProjectedMetrics_602011;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Returns the projected utilization metrics of Amazon EC2 instance recommendations.
  ## 
...
proc call*(call_602024: Call_GetEC2RecommendationProjectedMetrics_602011;
          body: JsonNode): Recallable =
...
var getEC2RecommendationProjectedMetrics* = Call_GetEC2RecommendationProjectedMetrics_602011(
    ...
    validator: validate_GetEC2RecommendationProjectedMetrics_602012, base: "/",
    url: url_GetEC2RecommendationProjectedMetrics_602013,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetEnrollmentStatus_602026 = ref object of OpenApiRestCall_601389
proc url_GetEnrollmentStatus_602028(protocol: Scheme; host: string; base: string;
...
proc validate_GetEnrollmentStatus_602027(path: JsonNode; query: JsonNode;
...
proc call*(call_602038: Call_GetEnrollmentStatus_602026; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation also confirms the enrollment status of member accounts within the organization.</p>
  ## 
...
proc call*(call_602039: Call_GetEnrollmentStatus_602026; body: JsonNode): Recallable =
  ## getEnrollmentStatus
  ## <p>Returns the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation also confirms the enrollment status of member accounts within the organization.</p>
  ##   body: JObject (required)
...
var getEnrollmentStatus* = Call_GetEnrollmentStatus_602026(
    ...
    validator: validate_GetEnrollmentStatus_602027, base: "/",
    url: url_GetEnrollmentStatus_602028, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetRecommendationSummaries_602041 = ref object of OpenApiRestCall_601389
proc url_GetRecommendationSummaries_602043(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetRecommendationSummaries_602042(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602053: Call_GetRecommendationSummaries_602041; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Returns the optimization findings for an account.</p> <p>For example, it returns the number of Amazon EC2 instances in an account that are under-provisioned, over-provisioned, or optimized. It also returns the number of Auto Scaling groups in an account that are not optimized, or optimized.</p>
  ## 
...
proc call*(call_602054: Call_GetRecommendationSummaries_602041; body: JsonNode): Recallable =
...
var getRecommendationSummaries* = Call_GetRecommendationSummaries_602041(
    ...
    validator: validate_GetRecommendationSummaries_602042, base: "/",
    url: url_GetRecommendationSummaries_602043,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateEnrollmentStatus_602056 = ref object of OpenApiRestCall_601389
proc url_UpdateEnrollmentStatus_602058(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateEnrollmentStatus_602057(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_602068: Call_UpdateEnrollmentStatus_602056; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Updates the enrollment (opt in) status of an account to the AWS Compute Optimizer service.</p> <p>If the account is a master account of an organization, this operation can also enroll member accounts within the organization.</p>
  ## 
...
proc call*(call_602069: Call_UpdateEnrollmentStatus_602056; body: JsonNode): Recallable =
...
var updateEnrollmentStatus* = Call_UpdateEnrollmentStatus_602056(
    name: "updateEnrollmentStatus", meth: HttpMethod.HttpPost,
    host: "compute-optimizer.amazonaws.com",
    route: "/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus",
    validator: validate_UpdateEnrollmentStatus_602057, base: "/",
    url: url_UpdateEnrollmentStatus_602058, schemes: {Scheme.Https, Scheme.Http})
export
  rest
