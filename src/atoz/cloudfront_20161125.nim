...
type
  Call_CreateCloudFrontOriginAccessIdentity20161125_592960 = ref object of OpenApiRestCall_592364
proc url_CreateCloudFrontOriginAccessIdentity20161125_592962(protocol: Scheme;
...
proc validate_CreateCloudFrontOriginAccessIdentity20161125_592961(path: JsonNode;
...
proc call*(call_592971: Call_CreateCloudFrontOriginAccessIdentity20161125_592960;
...
proc call*(call_592972: Call_CreateCloudFrontOriginAccessIdentity20161125_592960;
          body: JsonNode): Recallable =
...
var createCloudFrontOriginAccessIdentity20161125* = Call_CreateCloudFrontOriginAccessIdentity20161125_592960(
    ...
    validator: validate_CreateCloudFrontOriginAccessIdentity20161125_592961,
    base: "/", url: url_CreateCloudFrontOriginAccessIdentity20161125_592962,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListCloudFrontOriginAccessIdentities20161125_592703 = ref object of OpenApiRestCall_592364
proc url_ListCloudFrontOriginAccessIdentities20161125_592705(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListCloudFrontOriginAccessIdentities20161125_592704(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_592848: Call_ListCloudFrontOriginAccessIdentities20161125_592703;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Lists origin access identities.
  ## 
...
proc call*(call_592919: Call_ListCloudFrontOriginAccessIdentities20161125_592703;
...
var listCloudFrontOriginAccessIdentities20161125* = Call_ListCloudFrontOriginAccessIdentities20161125_592703(
    name: "listCloudFrontOriginAccessIdentities20161125",
    meth: HttpMethod.HttpGet, host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/origin-access-identity/cloudfront",
    validator: validate_ListCloudFrontOriginAccessIdentities20161125_592704,
    base: "/", url: url_ListCloudFrontOriginAccessIdentities20161125_592705,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDistribution20161125_592989 = ref object of OpenApiRestCall_592364
proc url_CreateDistribution20161125_592991(protocol: Scheme; host: string;
...
proc validate_CreateDistribution20161125_592990(path: JsonNode; query: JsonNode;
...
proc call*(call_593000: Call_CreateDistribution20161125_592989; path: JsonNode;
...
proc call*(call_593001: Call_CreateDistribution20161125_592989; body: JsonNode): Recallable =
...
var createDistribution20161125* = Call_CreateDistribution20161125_592989(
    name: "createDistribution20161125", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/distribution",
    validator: validate_CreateDistribution20161125_592990, base: "/",
    url: url_CreateDistribution20161125_592991,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDistributions20161125_592974 = ref object of OpenApiRestCall_592364
proc url_ListDistributions20161125_592976(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDistributions20161125_592975(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## List distributions. 
  ## 
  var section: JsonNode
...
proc call*(call_592986: Call_ListDistributions20161125_592974; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List distributions. 
  ## 
...
proc call*(call_592987: Call_ListDistributions20161125_592974; Marker: string = "";
...
var listDistributions20161125* = Call_ListDistributions20161125_592974(
    name: "listDistributions20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/distribution",
    validator: validate_ListDistributions20161125_592975, base: "/",
    url: url_ListDistributions20161125_592976,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateDistributionWithTags20161125_593003 = ref object of OpenApiRestCall_592364
proc url_CreateDistributionWithTags20161125_593005(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateDistributionWithTags20161125_593004(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593015: Call_CreateDistributionWithTags20161125_593003;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Create a new distribution with tags.
  ## 
...
proc call*(call_593016: Call_CreateDistributionWithTags20161125_593003;
...
var createDistributionWithTags20161125* = Call_CreateDistributionWithTags20161125_593003(
    ...
    validator: validate_CreateDistributionWithTags20161125_593004, base: "/",
    url: url_CreateDistributionWithTags20161125_593005,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateInvalidation20161125_593050 = ref object of OpenApiRestCall_592364
proc url_CreateInvalidation20161125_593052(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateInvalidation20161125_593051(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593053 = path.getOrDefault("DistributionId")
  valid_593053 = validateParameter(valid_593053, JString, required = true,
                                 default = nil)
  if valid_593053 != nil:
    section.add "DistributionId", valid_593053
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_593062: Call_CreateInvalidation20161125_593050; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create a new invalidation. 
  ## 
...
proc call*(call_593063: Call_CreateInvalidation20161125_593050;
  ...
  add(path_593064, "DistributionId", newJString(DistributionId))
  if body != nil:
    body_593065 = body
  result = call_593063.call(path_593064, nil, nil, nil, body_593065)

var createInvalidation20161125* = Call_CreateInvalidation20161125_593050(
    name: "createInvalidation20161125", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distribution/{DistributionId}/invalidation",
    validator: validate_CreateInvalidation20161125_593051, base: "/",
    url: url_CreateInvalidation20161125_593052,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListInvalidations20161125_593019 = ref object of OpenApiRestCall_592364
proc url_ListInvalidations20161125_593021(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListInvalidations20161125_593020(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `DistributionId` field"
  var valid_593036 = path.getOrDefault("DistributionId")
  valid_593036 = validateParameter(valid_593036, JString, required = true,
                                 default = nil)
  if valid_593036 != nil:
    section.add "DistributionId", valid_593036
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ...
  section = newJObject()
  var valid_593037 = query.getOrDefault("Marker")
  valid_593037 = validateParameter(valid_593037, JString, required = false,
                                 default = nil)
  if valid_593037 != nil:
    section.add "Marker", valid_593037
  var valid_593038 = query.getOrDefault("MaxItems")
  valid_593038 = validateParameter(valid_593038, JString, required = false,
                                 default = nil)
  if valid_593038 != nil:
    section.add "MaxItems", valid_593038
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593046: Call_ListInvalidations20161125_593019; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists invalidation batches. 
  ## 
...
proc call*(call_593047: Call_ListInvalidations20161125_593019;
  ...
  add(query_593049, "Marker", newJString(Marker))
  add(query_593049, "MaxItems", newJString(MaxItems))
  add(path_593048, "DistributionId", newJString(DistributionId))
  result = call_593047.call(path_593048, query_593049, nil, nil, nil)

var listInvalidations20161125* = Call_ListInvalidations20161125_593019(
    name: "listInvalidations20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distribution/{DistributionId}/invalidation",
    validator: validate_ListInvalidations20161125_593020, base: "/",
    url: url_ListInvalidations20161125_593021,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateStreamingDistribution20161125_593081 = ref object of OpenApiRestCall_592364
proc url_CreateStreamingDistribution20161125_593083(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateStreamingDistribution20161125_593082(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593092: Call_CreateStreamingDistribution20161125_593081;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Creates a new RMTP distribution. An RTMP distribution is similar to a web distribution, but an RTMP distribution streams media files using the Adobe Real-Time Messaging Protocol (RTMP) instead of serving files using HTTP. </p> <p>To create a new web distribution, submit a <code>POST</code> request to the <i>CloudFront API version</i>/distribution resource. The request body must include a document with a <i>StreamingDistributionConfig</i> element. The response echoes the <code>StreamingDistributionConfig</code> element and returns other information about the RTMP distribution.</p> <p>To get the status of your request, use the <i>GET StreamingDistribution</i> API action. When the value of <code>Enabled</code> is <code>true</code> and the value of <code>Status</code> is <code>Deployed</code>, your distribution is ready. A distribution usually deploys in less than 15 minutes.</p> <p>For more information about web distributions, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-rtmp.html">Working with RTMP Distributions</a> in the <i>Amazon CloudFront Developer Guide</i>.</p> <important> <p>Beginning with the 2012-05-05 version of the CloudFront API, we made substantial changes to the format of the XML document that you include in the request body when you create or update a web distribution or an RTMP distribution, and when you invalidate objects. With previous versions of the API, we discovered that it was too easy to accidentally delete one or more values for an element that accepts multiple values, for example, CNAMEs and trusted signers. Our changes for the 2012-05-05 release are intended to prevent these accidental deletions and to notify you when there's a mismatch between the number of values you say you're specifying in the <code>Quantity</code> element and the number of values specified.</p> </important>
  ## 
...
proc call*(call_593093: Call_CreateStreamingDistribution20161125_593081;
          body: JsonNode): Recallable =
...
var createStreamingDistribution20161125* = Call_CreateStreamingDistribution20161125_593081(
    ...
    validator: validate_CreateStreamingDistribution20161125_593082, base: "/",
    url: url_CreateStreamingDistribution20161125_593083,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListStreamingDistributions20161125_593066 = ref object of OpenApiRestCall_592364
proc url_ListStreamingDistributions20161125_593068(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListStreamingDistributions20161125_593067(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593070 = query.getOrDefault("MaxItems")
  valid_593070 = validateParameter(valid_593070, JString, required = false,
                                 default = nil)
  if valid_593070 != nil:
    section.add "MaxItems", valid_593070
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593078: Call_ListStreamingDistributions20161125_593066;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List streaming distributions. 
  ## 
...
proc call*(call_593079: Call_ListStreamingDistributions20161125_593066;
          Marker: string = ""; MaxItems: string = ""): Recallable =
  ...
  add(query_593080, "Marker", newJString(Marker))
  add(query_593080, "MaxItems", newJString(MaxItems))
  result = call_593079.call(nil, query_593080, nil, nil, nil)

var listStreamingDistributions20161125* = Call_ListStreamingDistributions20161125_593066(
    name: "listStreamingDistributions20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/streaming-distribution",
    validator: validate_ListStreamingDistributions20161125_593067, base: "/",
    url: url_ListStreamingDistributions20161125_593068,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_CreateStreamingDistributionWithTags20161125_593095 = ref object of OpenApiRestCall_592364
proc url_CreateStreamingDistributionWithTags20161125_593097(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CreateStreamingDistributionWithTags20161125_593096(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert query != nil,
        "query argument is necessary due to required `WithTags` field"
  var valid_593098 = query.getOrDefault("WithTags")
  valid_593098 = validateParameter(valid_593098, JBool, required = true, default = nil)
  if valid_593098 != nil:
    section.add "WithTags", valid_593098
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593107: Call_CreateStreamingDistributionWithTags20161125_593095;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Create a new streaming distribution with tags.
  ## 
...
proc call*(call_593108: Call_CreateStreamingDistributionWithTags20161125_593095;
          body: JsonNode; WithTags: bool): Recallable =
  ...
  if body != nil:
    body_593110 = body
  add(query_593109, "WithTags", newJBool(WithTags))
  result = call_593108.call(nil, query_593109, nil, nil, body_593110)

var createStreamingDistributionWithTags20161125* = Call_CreateStreamingDistributionWithTags20161125_593095(
    name: "createStreamingDistributionWithTags20161125",
    meth: HttpMethod.HttpPost, host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/streaming-distribution#WithTags",
    validator: validate_CreateStreamingDistributionWithTags20161125_593096,
    base: "/", url: url_CreateStreamingDistributionWithTags20161125_593097,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCloudFrontOriginAccessIdentity20161125_593111 = ref object of OpenApiRestCall_592364
proc url_GetCloudFrontOriginAccessIdentity20161125_593113(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCloudFrontOriginAccessIdentity20161125_593112(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593122: Call_GetCloudFrontOriginAccessIdentity20161125_593111;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the information about an origin access identity. 
  ## 
...
proc call*(call_593123: Call_GetCloudFrontOriginAccessIdentity20161125_593111;
  ...
  add(path_593124, "Id", newJString(Id))
  result = call_593123.call(path_593124, nil, nil, nil, nil)

var getCloudFrontOriginAccessIdentity20161125* = Call_GetCloudFrontOriginAccessIdentity20161125_593111(
    ...
    validator: validate_GetCloudFrontOriginAccessIdentity20161125_593112,
    base: "/", url: url_GetCloudFrontOriginAccessIdentity20161125_593113,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteCloudFrontOriginAccessIdentity20161125_593125 = ref object of OpenApiRestCall_592364
proc url_DeleteCloudFrontOriginAccessIdentity20161125_593127(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteCloudFrontOriginAccessIdentity20161125_593126(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593134 = header.getOrDefault("If-Match")
  valid_593134 = validateParameter(valid_593134, JString, required = false,
                                 default = nil)
  if valid_593134 != nil:
    section.add "If-Match", valid_593134
...
proc call*(call_593137: Call_DeleteCloudFrontOriginAccessIdentity20161125_593125;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Delete an origin access identity. 
  ## 
...
proc call*(call_593138: Call_DeleteCloudFrontOriginAccessIdentity20161125_593125;
          Id: string): Recallable =
  ...
  add(path_593139, "Id", newJString(Id))
  result = call_593138.call(path_593139, nil, nil, nil, nil)

var deleteCloudFrontOriginAccessIdentity20161125* = Call_DeleteCloudFrontOriginAccessIdentity20161125_593125(
    name: "deleteCloudFrontOriginAccessIdentity20161125",
    meth: HttpMethod.HttpDelete, host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/origin-access-identity/cloudfront/{Id}",
    validator: validate_DeleteCloudFrontOriginAccessIdentity20161125_593126,
    base: "/", url: url_DeleteCloudFrontOriginAccessIdentity20161125_593127,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDistribution20161125_593140 = ref object of OpenApiRestCall_592364
proc url_GetDistribution20161125_593142(protocol: Scheme; host: string; base: string;
...
proc validate_GetDistribution20161125_593141(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593151: Call_GetDistribution20161125_593140; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the information about a distribution. 
  ## 
...
proc call*(call_593152: Call_GetDistribution20161125_593140; Id: string): Recallable =
  ...
  result = call_593152.call(path_593153, nil, nil, nil, nil)

var getDistribution20161125* = Call_GetDistribution20161125_593140(
    name: "getDistribution20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/distribution/{Id}",
    validator: validate_GetDistribution20161125_593141, base: "/",
    url: url_GetDistribution20161125_593142, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteDistribution20161125_593154 = ref object of OpenApiRestCall_592364
proc url_DeleteDistribution20161125_593156(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteDistribution20161125_593155(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593163 = header.getOrDefault("If-Match")
  valid_593163 = validateParameter(valid_593163, JString, required = false,
                                 default = nil)
  if valid_593163 != nil:
    section.add "If-Match", valid_593163
...
proc call*(call_593166: Call_DeleteDistribution20161125_593154; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a distribution. 
  ## 
...
proc call*(call_593167: Call_DeleteDistribution20161125_593154; Id: string): Recallable =
  ## deleteDistribution20161125
  ## Delete a distribution. 
  ##   Id: string (required)
  ##     : The distribution ID. 
  var path_593168 = newJObject()
  add(path_593168, "Id", newJString(Id))
  result = call_593167.call(path_593168, nil, nil, nil, nil)

var deleteDistribution20161125* = Call_DeleteDistribution20161125_593154(
    name: "deleteDistribution20161125", meth: HttpMethod.HttpDelete,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/distribution/{Id}",
    validator: validate_DeleteDistribution20161125_593155, base: "/",
    url: url_DeleteDistribution20161125_593156,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetStreamingDistribution20161125_593169 = ref object of OpenApiRestCall_592364
proc url_GetStreamingDistribution20161125_593171(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetStreamingDistribution20161125_593170(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593180: Call_GetStreamingDistribution20161125_593169;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets information about a specified RTMP distribution, including the distribution configuration.
  ## 
...
proc call*(call_593181: Call_GetStreamingDistribution20161125_593169; Id: string): Recallable =
  ## getStreamingDistribution20161125
  ## Gets information about a specified RTMP distribution, including the distribution configuration.
  ##   Id: string (required)
  ##     : The streaming distribution's ID.
  var path_593182 = newJObject()
  add(path_593182, "Id", newJString(Id))
  result = call_593181.call(path_593182, nil, nil, nil, nil)

var getStreamingDistribution20161125* = Call_GetStreamingDistribution20161125_593169(
    name: "getStreamingDistribution20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/streaming-distribution/{Id}",
    validator: validate_GetStreamingDistribution20161125_593170, base: "/",
    url: url_GetStreamingDistribution20161125_593171,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteStreamingDistribution20161125_593183 = ref object of OpenApiRestCall_592364
proc url_DeleteStreamingDistribution20161125_593185(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteStreamingDistribution20161125_593184(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593192 = header.getOrDefault("If-Match")
  valid_593192 = validateParameter(valid_593192, JString, required = false,
                                 default = nil)
  if valid_593192 != nil:
    section.add "If-Match", valid_593192
...
proc call*(call_593195: Call_DeleteStreamingDistribution20161125_593183;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## <p>Delete a streaming distribution. To delete an RTMP distribution using the CloudFront API, perform the following steps.</p> <p> <b>To delete an RTMP distribution using the CloudFront API</b>:</p> <ol> <li> <p>Disable the RTMP distribution.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to get the current configuration and the <code>Etag</code> header for the distribution. </p> </li> <li> <p>Update the XML document that was returned in the response to your <code>GET Streaming Distribution Config</code> request to change the value of <code>Enabled</code> to <code>false</code>.</p> </li> <li> <p>Submit a <code>PUT Streaming Distribution Config</code> request to update the configuration for your distribution. In the request body, include the XML document that you updated in Step 3. Then set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to the <code>PUT Streaming Distribution Config</code> request to confirm that the distribution was successfully disabled.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to confirm that your changes have propagated. When propagation is complete, the value of <code>Status</code> is <code>Deployed</code>.</p> </li> <li> <p>Submit a <code>DELETE Streaming Distribution</code> request. Set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to your <code>DELETE Streaming Distribution</code> request to confirm that the distribution was successfully deleted.</p> </li> </ol> <p>For information about deleting a distribution using the CloudFront console, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowToDeleteDistribution.html">Deleting a Distribution</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>
  ## 
...
proc call*(call_593196: Call_DeleteStreamingDistribution20161125_593183; Id: string): Recallable =
  ## deleteStreamingDistribution20161125
  ## <p>Delete a streaming distribution. To delete an RTMP distribution using the CloudFront API, perform the following steps.</p> <p> <b>To delete an RTMP distribution using the CloudFront API</b>:</p> <ol> <li> <p>Disable the RTMP distribution.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to get the current configuration and the <code>Etag</code> header for the distribution. </p> </li> <li> <p>Update the XML document that was returned in the response to your <code>GET Streaming Distribution Config</code> request to change the value of <code>Enabled</code> to <code>false</code>.</p> </li> <li> <p>Submit a <code>PUT Streaming Distribution Config</code> request to update the configuration for your distribution. In the request body, include the XML document that you updated in Step 3. Then set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to the <code>PUT Streaming Distribution Config</code> request to confirm that the distribution was successfully disabled.</p> </li> <li> <p>Submit a <code>GET Streaming Distribution Config</code> request to confirm that your changes have propagated. When propagation is complete, the value of <code>Status</code> is <code>Deployed</code>.</p> </li> <li> <p>Submit a <code>DELETE Streaming Distribution</code> request. Set the value of the HTTP <code>If-Match</code> header to the value of the <code>ETag</code> header that CloudFront returned when you submitted the <code>GET Streaming Distribution Config</code> request in Step 2.</p> </li> <li> <p>Review the response to your <code>DELETE Streaming Distribution</code> request to confirm that the distribution was successfully deleted.</p> </li> </ol> <p>For information about deleting a distribution using the CloudFront console, see <a href="http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowToDeleteDistribution.html">Deleting a Distribution</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>
  ##   Id: string (required)
  ##     : The distribution ID. 
  var path_593197 = newJObject()
  add(path_593197, "Id", newJString(Id))
  result = call_593196.call(path_593197, nil, nil, nil, nil)

var deleteStreamingDistribution20161125* = Call_DeleteStreamingDistribution20161125_593183(
    name: "deleteStreamingDistribution20161125", meth: HttpMethod.HttpDelete,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/streaming-distribution/{Id}",
    validator: validate_DeleteStreamingDistribution20161125_593184, base: "/",
    url: url_DeleteStreamingDistribution20161125_593185,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateCloudFrontOriginAccessIdentity20161125_593212 = ref object of OpenApiRestCall_592364
proc url_UpdateCloudFrontOriginAccessIdentity20161125_593214(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateCloudFrontOriginAccessIdentity20161125_593213(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593225: Call_UpdateCloudFrontOriginAccessIdentity20161125_593212;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update an origin access identity. 
  ## 
...
proc call*(call_593226: Call_UpdateCloudFrontOriginAccessIdentity20161125_593212;
  ...
  ##   Id: string (required)
  ##     : The identity's id.
  var path_593227 = newJObject()
  var body_593228 = newJObject()
  if body != nil:
    body_593228 = body
  add(path_593227, "Id", newJString(Id))
  result = call_593226.call(path_593227, nil, nil, nil, body_593228)

var updateCloudFrontOriginAccessIdentity20161125* = Call_UpdateCloudFrontOriginAccessIdentity20161125_593212(
    ...
    validator: validate_UpdateCloudFrontOriginAccessIdentity20161125_593213,
    base: "/", url: url_UpdateCloudFrontOriginAccessIdentity20161125_593214,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetCloudFrontOriginAccessIdentityConfig20161125_593198 = ref object of OpenApiRestCall_592364
proc url_GetCloudFrontOriginAccessIdentityConfig20161125_593200(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetCloudFrontOriginAccessIdentityConfig20161125_593199(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_593209: Call_GetCloudFrontOriginAccessIdentityConfig20161125_593198;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the configuration information about an origin access identity. 
  ## 
...
proc call*(call_593210: Call_GetCloudFrontOriginAccessIdentityConfig20161125_593198;
          Id: string): Recallable =
...
var getCloudFrontOriginAccessIdentityConfig20161125* = Call_GetCloudFrontOriginAccessIdentityConfig20161125_593198(
    name: "getCloudFrontOriginAccessIdentityConfig20161125",
    meth: HttpMethod.HttpGet, host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/origin-access-identity/cloudfront/{Id}/config",
    validator: validate_GetCloudFrontOriginAccessIdentityConfig20161125_593199,
    base: "/", url: url_GetCloudFrontOriginAccessIdentityConfig20161125_593200,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateDistribution20161125_593243 = ref object of OpenApiRestCall_592364
proc url_UpdateDistribution20161125_593245(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateDistribution20161125_593244(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593252 = header.getOrDefault("If-Match")
  valid_593252 = validateParameter(valid_593252, JString, required = false,
                                 default = nil)
  if valid_593252 != nil:
    section.add "If-Match", valid_593252
...
proc call*(call_593256: Call_UpdateDistribution20161125_593243; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a distribution. 
  ## 
...
proc call*(call_593257: Call_UpdateDistribution20161125_593243; body: JsonNode;
          Id: string): Recallable =
  ...
  ##   Id: string (required)
  ##     : The distribution's id.
  var path_593258 = newJObject()
  var body_593259 = newJObject()
  if body != nil:
    body_593259 = body
  add(path_593258, "Id", newJString(Id))
  result = call_593257.call(path_593258, nil, nil, nil, body_593259)

var updateDistribution20161125* = Call_UpdateDistribution20161125_593243(
    name: "updateDistribution20161125", meth: HttpMethod.HttpPut,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distribution/{Id}/config",
    validator: validate_UpdateDistribution20161125_593244, base: "/",
    url: url_UpdateDistribution20161125_593245,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetDistributionConfig20161125_593229 = ref object of OpenApiRestCall_592364
proc url_GetDistributionConfig20161125_593231(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetDistributionConfig20161125_593230(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593240: Call_GetDistributionConfig20161125_593229; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the configuration information about a distribution. 
  ## 
...
proc call*(call_593241: Call_GetDistributionConfig20161125_593229; Id: string): Recallable =
  ## getDistributionConfig20161125
  ## Get the configuration information about a distribution. 
  ##   Id: string (required)
  ##     : The distribution's ID.
  var path_593242 = newJObject()
  add(path_593242, "Id", newJString(Id))
  result = call_593241.call(path_593242, nil, nil, nil, nil)

var getDistributionConfig20161125* = Call_GetDistributionConfig20161125_593229(
    name: "getDistributionConfig20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distribution/{Id}/config",
    validator: validate_GetDistributionConfig20161125_593230, base: "/",
    url: url_GetDistributionConfig20161125_593231,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetInvalidation20161125_593260 = ref object of OpenApiRestCall_592364
proc url_GetInvalidation20161125_593262(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_GetInvalidation20161125_593261(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `DistributionId` field"
  var valid_593263 = path.getOrDefault("DistributionId")
  valid_593263 = validateParameter(valid_593263, JString, required = true,
                                 default = nil)
  if valid_593263 != nil:
    section.add "DistributionId", valid_593263
  var valid_593264 = path.getOrDefault("Id")
  valid_593264 = validateParameter(valid_593264, JString, required = true,
                                 default = nil)
  if valid_593264 != nil:
    section.add "Id", valid_593264
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
  ...
  ##   X-Amz-SignedHeaders: JString
  section = newJObject()
  var valid_593265 = header.getOrDefault("X-Amz-Signature")
  valid_593265 = validateParameter(valid_593265, JString, required = false,
                                 default = nil)
  if valid_593265 != nil:
    section.add "X-Amz-Signature", valid_593265
  var valid_593266 = header.getOrDefault("X-Amz-Content-Sha256")
  valid_593266 = validateParameter(valid_593266, JString, required = false,
                                 default = nil)
  if valid_593266 != nil:
    section.add "X-Amz-Content-Sha256", valid_593266
  var valid_593267 = header.getOrDefault("X-Amz-Date")
  valid_593267 = validateParameter(valid_593267, JString, required = false,
                                 default = nil)
  if valid_593267 != nil:
    section.add "X-Amz-Date", valid_593267
  var valid_593268 = header.getOrDefault("X-Amz-Credential")
  valid_593268 = validateParameter(valid_593268, JString, required = false,
                                 default = nil)
  if valid_593268 != nil:
    section.add "X-Amz-Credential", valid_593268
  var valid_593269 = header.getOrDefault("X-Amz-Security-Token")
  valid_593269 = validateParameter(valid_593269, JString, required = false,
                                 default = nil)
  if valid_593269 != nil:
    section.add "X-Amz-Security-Token", valid_593269
  var valid_593270 = header.getOrDefault("X-Amz-Algorithm")
  valid_593270 = validateParameter(valid_593270, JString, required = false,
                                 default = nil)
  if valid_593270 != nil:
    section.add "X-Amz-Algorithm", valid_593270
  var valid_593271 = header.getOrDefault("X-Amz-SignedHeaders")
  valid_593271 = validateParameter(valid_593271, JString, required = false,
                                 default = nil)
  if valid_593271 != nil:
    section.add "X-Amz-SignedHeaders", valid_593271
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  if body != nil:
...
proc call*(call_593272: Call_GetInvalidation20161125_593260; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the information about an invalidation. 
  ## 
...
proc call*(call_593273: Call_GetInvalidation20161125_593260;
  ...
  ##   Id: string (required)
  ##     : The identifier for the invalidation request, for example, <code>IDFDVBD632BHDS5</code>.
  var path_593274 = newJObject()
  add(path_593274, "DistributionId", newJString(DistributionId))
  add(path_593274, "Id", newJString(Id))
  result = call_593273.call(path_593274, nil, nil, nil, nil)

var getInvalidation20161125* = Call_GetInvalidation20161125_593260(
    name: "getInvalidation20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distribution/{DistributionId}/invalidation/{Id}",
    validator: validate_GetInvalidation20161125_593261, base: "/",
    url: url_GetInvalidation20161125_593262, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateStreamingDistribution20161125_593289 = ref object of OpenApiRestCall_592364
proc url_UpdateStreamingDistribution20161125_593291(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateStreamingDistribution20161125_593290(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593298 = header.getOrDefault("If-Match")
  valid_593298 = validateParameter(valid_593298, JString, required = false,
                                 default = nil)
  if valid_593298 != nil:
    section.add "If-Match", valid_593298
...
proc call*(call_593302: Call_UpdateStreamingDistribution20161125_593289;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update a streaming distribution. 
  ## 
...
proc call*(call_593303: Call_UpdateStreamingDistribution20161125_593289;
          body: JsonNode; Id: string): Recallable =
  ...
  if body != nil:
    body_593305 = body
  add(path_593304, "Id", newJString(Id))
  result = call_593303.call(path_593304, nil, nil, nil, body_593305)

var updateStreamingDistribution20161125* = Call_UpdateStreamingDistribution20161125_593289(
    name: "updateStreamingDistribution20161125", meth: HttpMethod.HttpPut,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/streaming-distribution/{Id}/config",
    validator: validate_UpdateStreamingDistribution20161125_593290, base: "/",
    url: url_UpdateStreamingDistribution20161125_593291,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetStreamingDistributionConfig20161125_593275 = ref object of OpenApiRestCall_592364
proc url_GetStreamingDistributionConfig20161125_593277(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetStreamingDistributionConfig20161125_593276(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593286: Call_GetStreamingDistributionConfig20161125_593275;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get the configuration information about a streaming distribution. 
  ## 
...
proc call*(call_593287: Call_GetStreamingDistributionConfig20161125_593275;
          Id: string): Recallable =
  ...
  add(path_593288, "Id", newJString(Id))
  result = call_593287.call(path_593288, nil, nil, nil, nil)

var getStreamingDistributionConfig20161125* = Call_GetStreamingDistributionConfig20161125_593275(
    name: "getStreamingDistributionConfig20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/streaming-distribution/{Id}/config",
    validator: validate_GetStreamingDistributionConfig20161125_593276, base: "/",
    url: url_GetStreamingDistributionConfig20161125_593277,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListDistributionsByWebACLId20161125_593306 = ref object of OpenApiRestCall_592364
proc url_ListDistributionsByWebACLId20161125_593308(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListDistributionsByWebACLId20161125_593307(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593309 = path.getOrDefault("WebACLId")
  valid_593309 = validateParameter(valid_593309, JString, required = true,
                                 default = nil)
  if valid_593309 != nil:
    section.add "WebACLId", valid_593309
  result.add "path", section
  ## parameters in `query` object:
  ##   Marker: JString
  ...
  section = newJObject()
  var valid_593310 = query.getOrDefault("Marker")
  valid_593310 = validateParameter(valid_593310, JString, required = false,
                                 default = nil)
  if valid_593310 != nil:
    section.add "Marker", valid_593310
  var valid_593311 = query.getOrDefault("MaxItems")
  valid_593311 = validateParameter(valid_593311, JString, required = false,
                                 default = nil)
  if valid_593311 != nil:
    section.add "MaxItems", valid_593311
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593319: Call_ListDistributionsByWebACLId20161125_593306;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List the distributions that are associated with a specified AWS WAF web ACL. 
  ## 
...
proc call*(call_593320: Call_ListDistributionsByWebACLId20161125_593306;
  ...
  add(query_593322, "MaxItems", newJString(MaxItems))
  add(path_593321, "WebACLId", newJString(WebACLId))
  result = call_593320.call(path_593321, query_593322, nil, nil, nil)

var listDistributionsByWebACLId20161125* = Call_ListDistributionsByWebACLId20161125_593306(
    name: "listDistributionsByWebACLId20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/distributionsByWebACLId/{WebACLId}",
    validator: validate_ListDistributionsByWebACLId20161125_593307, base: "/",
    url: url_ListDistributionsByWebACLId20161125_593308,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_ListTagsForResource20161125_593323 = ref object of OpenApiRestCall_592364
proc url_ListTagsForResource20161125_593325(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ListTagsForResource20161125_593324(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593326 = query.getOrDefault("Resource")
  valid_593326 = validateParameter(valid_593326, JString, required = true,
                                 default = nil)
  if valid_593326 != nil:
    section.add "Resource", valid_593326
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593334: Call_ListTagsForResource20161125_593323; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List tags for a CloudFront resource.
  ## 
...
proc call*(call_593335: Call_ListTagsForResource20161125_593323; Resource: string): Recallable =
  ## listTagsForResource20161125
  ## List tags for a CloudFront resource.
  ##   Resource: string (required)
  ##           :  An ARN of a CloudFront resource.
  var query_593336 = newJObject()
  add(query_593336, "Resource", newJString(Resource))
  result = call_593335.call(nil, query_593336, nil, nil, nil)

var listTagsForResource20161125* = Call_ListTagsForResource20161125_593323(
    name: "listTagsForResource20161125", meth: HttpMethod.HttpGet,
    host: "cloudfront.amazonaws.com", route: "/2016-11-25/tagging#Resource",
    validator: validate_ListTagsForResource20161125_593324, base: "/",
    url: url_ListTagsForResource20161125_593325,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_TagResource20161125_593337 = ref object of OpenApiRestCall_592364
proc url_TagResource20161125_593339(protocol: Scheme; host: string; base: string;
...
proc validate_TagResource20161125_593338(path: JsonNode; query: JsonNode;
  ...
  assert query != nil,
        "query argument is necessary due to required `Resource` field"
  var valid_593340 = query.getOrDefault("Resource")
  valid_593340 = validateParameter(valid_593340, JString, required = true,
                                 default = nil)
  if valid_593340 != nil:
    section.add "Resource", valid_593340
  var valid_593354 = query.getOrDefault("Operation")
  valid_593354 = validateParameter(valid_593354, JString, required = true,
                                 default = newJString("Tag"))
  if valid_593354 != nil:
    section.add "Operation", valid_593354
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593363: Call_TagResource20161125_593337; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Add tags to a CloudFront resource.
  ## 
...
proc call*(call_593364: Call_TagResource20161125_593337; Resource: string;
  ...
  var body_593366 = newJObject()
  add(query_593365, "Resource", newJString(Resource))
  add(query_593365, "Operation", newJString(Operation))
  if body != nil:
    body_593366 = body
  result = call_593364.call(nil, query_593365, nil, nil, body_593366)

var tagResource20161125* = Call_TagResource20161125_593337(
    name: "tagResource20161125", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/tagging#Operation=Tag&Resource",
    validator: validate_TagResource20161125_593338, base: "/",
    url: url_TagResource20161125_593339, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UntagResource20161125_593367 = ref object of OpenApiRestCall_592364
proc url_UntagResource20161125_593369(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UntagResource20161125_593368(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert query != nil,
        "query argument is necessary due to required `Resource` field"
  var valid_593370 = query.getOrDefault("Resource")
  valid_593370 = validateParameter(valid_593370, JString, required = true,
                                 default = nil)
  if valid_593370 != nil:
    section.add "Resource", valid_593370
  var valid_593371 = query.getOrDefault("Operation")
  valid_593371 = validateParameter(valid_593371, JString, required = true,
                                 default = newJString("Untag"))
  if valid_593371 != nil:
    section.add "Operation", valid_593371
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Signature: JString
  ##   X-Amz-Content-Sha256: JString
...
proc call*(call_593380: Call_UntagResource20161125_593367; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Remove tags from a CloudFront resource.
  ## 
...
proc call*(call_593381: Call_UntagResource20161125_593367; Resource: string;
  ...
  add(query_593382, "Resource", newJString(Resource))
  add(query_593382, "Operation", newJString(Operation))
  if body != nil:
    body_593383 = body
  result = call_593381.call(nil, query_593382, nil, nil, body_593383)

var untagResource20161125* = Call_UntagResource20161125_593367(
    name: "untagResource20161125", meth: HttpMethod.HttpPost,
    host: "cloudfront.amazonaws.com",
    route: "/2016-11-25/tagging#Operation=Untag&Resource",
    validator: validate_UntagResource20161125_593368, base: "/",
    url: url_UntagResource20161125_593369, schemes: {Scheme.Https, Scheme.Http})
export
  rest
