...
type
  Call_CreateLifecyclePolicy_603043 = ref object of OpenApiRestCall_602433
proc url_CreateLifecyclePolicy_603045(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_CreateLifecyclePolicy_603044(path: JsonNode; query: JsonNode;
...
proc call*(call_603054: Call_CreateLifecyclePolicy_603043; path: JsonNode;
...
proc call*(call_603055: Call_CreateLifecyclePolicy_603043; body: JsonNode): Recallable =
...
var createLifecyclePolicy* = Call_CreateLifecyclePolicy_603043(
    name: "createLifecyclePolicy", meth: HttpMethod.HttpPost,
    host: "dlm.amazonaws.com", route: "/policies",
    validator: validate_CreateLifecyclePolicy_603044, base: "/",
    url: url_CreateLifecyclePolicy_603045, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicies_602770 = ref object of OpenApiRestCall_602433
proc url_GetLifecyclePolicies_602772(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode): string =
  result = $protocol & "://" & host & base & route

proc validate_GetLifecyclePolicies_602771(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_602884 = query.getOrDefault("targetTags")
  valid_602884 = validateParameter(valid_602884, JArray, required = false,
                                 default = nil)
  if valid_602884 != nil:
    section.add "targetTags", valid_602884
  var valid_602885 = query.getOrDefault("policyIds")
  valid_602885 = validateParameter(valid_602885, JArray, required = false,
                                 default = nil)
  if valid_602885 != nil:
    section.add "policyIds", valid_602885
  var valid_602886 = query.getOrDefault("resourceTypes")
  valid_602886 = validateParameter(valid_602886, JArray, required = false,
                                 default = nil)
  if valid_602886 != nil:
    section.add "resourceTypes", valid_602886
  var valid_602887 = query.getOrDefault("tagsToAdd")
  valid_602887 = validateParameter(valid_602887, JArray, required = false,
                                 default = nil)
  if valid_602887 != nil:
    section.add "tagsToAdd", valid_602887
  var valid_602901 = query.getOrDefault("state")
  valid_602901 = validateParameter(valid_602901, JString, required = false,
                                 default = newJString("ENABLED"))
  if valid_602901 != nil:
    section.add "state", valid_602901
  result.add "query", section
  ## parameters in `header` object:
  ##   X-Amz-Date: JString
  ##   X-Amz-Security-Token: JString
...
proc call*(call_602931: Call_GetLifecyclePolicies_602770; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## <p>Gets summary information about all or the specified data lifecycle policies.</p> <p>To get complete information about a policy, use <a>GetLifecyclePolicy</a>.</p>
  ## 
...
proc call*(call_603002: Call_GetLifecyclePolicies_602770;
  ...
  if targetTags != nil:
    query_603003.add "targetTags", targetTags
  if policyIds != nil:
    query_603003.add "policyIds", policyIds
  if resourceTypes != nil:
    query_603003.add "resourceTypes", resourceTypes
  if tagsToAdd != nil:
    query_603003.add "tagsToAdd", tagsToAdd
  add(query_603003, "state", newJString(state))
  result = call_603002.call(nil, query_603003, nil, nil, nil)

var getLifecyclePolicies* = Call_GetLifecyclePolicies_602770(
    name: "getLifecyclePolicies", meth: HttpMethod.HttpGet,
    host: "dlm.amazonaws.com", route: "/policies",
    validator: validate_GetLifecyclePolicies_602771, base: "/",
    url: url_GetLifecyclePolicies_602772, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetLifecyclePolicy_603057 = ref object of OpenApiRestCall_602433
proc url_GetLifecyclePolicy_603059(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode): string =
...
proc validate_GetLifecyclePolicy_603058(path: JsonNode; query: JsonNode;
  ...
  var valid_603074 = path.getOrDefault("policyId")
  valid_603074 = validateParameter(valid_603074, JString, required = true,
                                 default = nil)
  if valid_603074 != nil:
    section.add "policyId", valid_603074
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_603082: Call_GetLifecyclePolicy_603057; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets detailed information about the specified lifecycle policy.
  ## 
...
proc call*(call_603083: Call_GetLifecyclePolicy_603057; policyId: string): Recallable =
  ## getLifecyclePolicy
  ## Gets detailed information about the specified lifecycle policy.
  ##   policyId: string (required)
  ##           : The identifier of the lifecycle policy.
  var path_603084 = newJObject()
  add(path_603084, "policyId", newJString(policyId))
  result = call_603083.call(path_603084, nil, nil, nil, nil)

var getLifecyclePolicy* = Call_GetLifecyclePolicy_603057(
    name: "getLifecyclePolicy", meth: HttpMethod.HttpGet, host: "dlm.amazonaws.com",
    route: "/policies/{policyId}/", validator: validate_GetLifecyclePolicy_603058,
    base: "/", url: url_GetLifecyclePolicy_603059,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteLifecyclePolicy_603085 = ref object of OpenApiRestCall_602433
proc url_DeleteLifecyclePolicy_603087(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "policyId" in path, "`policyId` is a required path parameter"
  const
...
proc validate_DeleteLifecyclePolicy_603086(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `policyId` field"
  var valid_603088 = path.getOrDefault("policyId")
  valid_603088 = validateParameter(valid_603088, JString, required = true,
                                 default = nil)
  if valid_603088 != nil:
    section.add "policyId", valid_603088
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_603096: Call_DeleteLifecyclePolicy_603085; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified lifecycle policy and halts the automated operations that the policy specified.
  ## 
...
proc call*(call_603097: Call_DeleteLifecyclePolicy_603085; policyId: string): Recallable =
  ## deleteLifecyclePolicy
  ## Deletes the specified lifecycle policy and halts the automated operations that the policy specified.
  ##   policyId: string (required)
  ##           : The identifier of the lifecycle policy.
  var path_603098 = newJObject()
  add(path_603098, "policyId", newJString(policyId))
  result = call_603097.call(path_603098, nil, nil, nil, nil)

var deleteLifecyclePolicy* = Call_DeleteLifecyclePolicy_603085(
    name: "deleteLifecyclePolicy", meth: HttpMethod.HttpDelete,
    host: "dlm.amazonaws.com", route: "/policies/{policyId}/",
    validator: validate_DeleteLifecyclePolicy_603086, base: "/",
    url: url_DeleteLifecyclePolicy_603087, schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateLifecyclePolicy_603099 = ref object of OpenApiRestCall_602433
proc url_UpdateLifecyclePolicy_603101(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode): string =
  assert path != nil, "path is required to populate template"
  assert "policyId" in path, "`policyId` is a required path parameter"
  const
...
proc validate_UpdateLifecyclePolicy_603100(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `policyId` field"
  var valid_603102 = path.getOrDefault("policyId")
  valid_603102 = validateParameter(valid_603102, JString, required = true,
                                 default = nil)
  if valid_603102 != nil:
    section.add "policyId", valid_603102
  result.add "path", section
  section = newJObject()
  result.add "query", section
  ## parameters in `header` object:
...
proc call*(call_603111: Call_UpdateLifecyclePolicy_603099; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specified lifecycle policy.
  ## 
...
proc call*(call_603112: Call_UpdateLifecyclePolicy_603099; policyId: string;
  ...
  add(path_603113, "policyId", newJString(policyId))
  if body != nil:
    body_603114 = body
  result = call_603112.call(path_603113, nil, nil, nil, body_603114)

var updateLifecyclePolicy* = Call_UpdateLifecyclePolicy_603099(
    name: "updateLifecyclePolicy", meth: HttpMethod.HttpPatch,
    host: "dlm.amazonaws.com", route: "/policies/{policyId}",
    validator: validate_UpdateLifecyclePolicy_603100, base: "/",
    url: url_UpdateLifecyclePolicy_603101, schemes: {Scheme.Https, Scheme.Http})
export
  rest
