...
const
  awsServers = {Scheme.Http: {"ap-northeast-1": "autoscaling-plans.ap-northeast-1.amazonaws.com", "ap-southeast-1": "autoscaling-plans.ap-southeast-1.amazonaws.com", "us-west-2": "autoscaling-plans.us-west-2.amazonaws.com", "eu-west-2": "autoscaling-plans.eu-west-2.amazonaws.com", "ap-northeast-3": "autoscaling-plans.ap-northeast-3.amazonaws.com", "eu-central-1": "autoscaling-plans.eu-central-1.amazonaws.com", "us-east-2": "autoscaling-plans.us-east-2.amazonaws.com", "us-east-1": "autoscaling-plans.us-east-1.amazonaws.com", "cn-northwest-1": "autoscaling-plans.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "autoscaling-plans.ap-south-1.amazonaws.com", "eu-north-1": "autoscaling-plans.eu-north-1.amazonaws.com", "ap-northeast-2": "autoscaling-plans.ap-northeast-2.amazonaws.com", "us-west-1": "autoscaling-plans.us-west-1.amazonaws.com", "us-gov-east-1": "autoscaling-plans.us-gov-east-1.amazonaws.com", "eu-west-3": "autoscaling-plans.eu-west-3.amazonaws.com", "cn-north-1": "autoscaling-plans.cn-north-1.amazonaws.com.cn", "sa-east-1": "autoscaling-plans.sa-east-1.amazonaws.com", "eu-west-1": "autoscaling-plans.eu-west-1.amazonaws.com", "us-gov-west-1": "autoscaling-plans.us-gov-west-1.amazonaws.com", "ap-southeast-2": "autoscaling-plans.ap-southeast-2.amazonaws.com", "ca-central-1": "autoscaling-plans.ca-central-1.amazonaws.com"}.toTable, Scheme.Https: {
      "ap-northeast-1": "autoscaling-plans.ap-northeast-1.amazonaws.com",
      "ap-southeast-1": "autoscaling-plans.ap-southeast-1.amazonaws.com",
      "us-west-2": "autoscaling-plans.us-west-2.amazonaws.com",
      "eu-west-2": "autoscaling-plans.eu-west-2.amazonaws.com",
      "ap-northeast-3": "autoscaling-plans.ap-northeast-3.amazonaws.com",
      "eu-central-1": "autoscaling-plans.eu-central-1.amazonaws.com",
      "us-east-2": "autoscaling-plans.us-east-2.amazonaws.com",
      "us-east-1": "autoscaling-plans.us-east-1.amazonaws.com",
      "cn-northwest-1": "autoscaling-plans.cn-northwest-1.amazonaws.com.cn",
      "ap-south-1": "autoscaling-plans.ap-south-1.amazonaws.com",
      "eu-north-1": "autoscaling-plans.eu-north-1.amazonaws.com",
      "ap-northeast-2": "autoscaling-plans.ap-northeast-2.amazonaws.com",
      "us-west-1": "autoscaling-plans.us-west-1.amazonaws.com",
      "us-gov-east-1": "autoscaling-plans.us-gov-east-1.amazonaws.com",
      "eu-west-3": "autoscaling-plans.eu-west-3.amazonaws.com",
      "cn-north-1": "autoscaling-plans.cn-north-1.amazonaws.com.cn",
      "sa-east-1": "autoscaling-plans.sa-east-1.amazonaws.com",
      "eu-west-1": "autoscaling-plans.eu-west-1.amazonaws.com",
      "us-gov-west-1": "autoscaling-plans.us-gov-west-1.amazonaws.com",
      "ap-southeast-2": "autoscaling-plans.ap-southeast-2.amazonaws.com",
      "ca-central-1": "autoscaling-plans.ca-central-1.amazonaws.com"}.toTable}.toTable
const
  awsServiceName = "autoscaling-plans"
method atozHook(call: OpenApiRestCall; url: Uri; input: JsonNode; body: string = ""): Recallable {.
    base.}
type
  Call_CreateScalingPlan_21625779 = ref object of OpenApiRestCall_21625435
proc url_CreateScalingPlan_21625781(protocol: Scheme; host: string; base: string;
...
proc validate_CreateScalingPlan_21625780(path: JsonNode; query: JsonNode;
...
proc call*(call_21625929: Call_CreateScalingPlan_21625779; path: JsonNode = nil;
...
proc call*(call_21625992: Call_CreateScalingPlan_21625779; body: JsonNode): Recallable =
  ## createScalingPlan
  ## Creates a scaling plan.
  ##   body: JObject (required)
...
var createScalingPlan* = Call_CreateScalingPlan_21625779(name: "createScalingPlan",
    ...
    validator: validate_CreateScalingPlan_21625780, base: "/",
    makeUrl: url_CreateScalingPlan_21625781, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteScalingPlan_21626029 = ref object of OpenApiRestCall_21625435
proc url_DeleteScalingPlan_21626031(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeleteScalingPlan_21626030(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626041: Call_DeleteScalingPlan_21626029; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes the specified scaling plan.</p> <p>Deleting a scaling plan deletes the underlying <a>ScalingInstruction</a> for all of the scalable resources that are covered by the plan.</p> <p>If the plan has launched resources or has scaling activities in progress, you must delete those resources separately.</p>
  ## 
...
proc call*(call_21626042: Call_DeleteScalingPlan_21626029; body: JsonNode): Recallable =
  ## deleteScalingPlan
  ## <p>Deletes the specified scaling plan.</p> <p>Deleting a scaling plan deletes the underlying <a>ScalingInstruction</a> for all of the scalable resources that are covered by the plan.</p> <p>If the plan has launched resources or has scaling activities in progress, you must delete those resources separately.</p>
  ##   body: JObject (required)
...
var deleteScalingPlan* = Call_DeleteScalingPlan_21626029(name: "deleteScalingPlan",
    ...
    validator: validate_DeleteScalingPlan_21626030, base: "/",
    makeUrl: url_DeleteScalingPlan_21626031, schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeScalingPlanResources_21626044 = ref object of OpenApiRestCall_21625435
proc url_DescribeScalingPlanResources_21626046(protocol: Scheme; host: string;
...
proc validate_DescribeScalingPlanResources_21626045(path: JsonNode;
...
proc call*(call_21626056: Call_DescribeScalingPlanResources_21626044;
...
proc call*(call_21626057: Call_DescribeScalingPlanResources_21626044;
...
var describeScalingPlanResources* = Call_DescribeScalingPlanResources_21626044(
    ...
    validator: validate_DescribeScalingPlanResources_21626045, base: "/",
    makeUrl: url_DescribeScalingPlanResources_21626046,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DescribeScalingPlans_21626059 = ref object of OpenApiRestCall_21625435
proc url_DescribeScalingPlans_21626061(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DescribeScalingPlans_21626060(path: JsonNode; query: JsonNode;
...
proc call*(call_21626071: Call_DescribeScalingPlans_21626059; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## Describes one or more of your scaling plans.
  ## 
...
proc call*(call_21626072: Call_DescribeScalingPlans_21626059; body: JsonNode): Recallable =
...
var describeScalingPlans* = Call_DescribeScalingPlans_21626059(
    ...
    validator: validate_DescribeScalingPlans_21626060, base: "/",
    makeUrl: url_DescribeScalingPlans_21626061,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetScalingPlanResourceForecastData_21626074 = ref object of OpenApiRestCall_21625435
proc url_GetScalingPlanResourceForecastData_21626076(protocol: Scheme;
...
proc validate_GetScalingPlanResourceForecastData_21626075(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode;
    _: string = ""): JsonNode {.nosinks.} =
  ...
  valid_21626079 = validateParameter(valid_21626079, JString, required = true, default = newJString("AnyScaleScalingPlannerFrontendService.GetScalingPlanResourceForecastData"))
...
proc call*(call_21626086: Call_GetScalingPlanResourceForecastData_21626074;
          path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
          formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Retrieves the forecast data for a scalable resource.</p> <p>Capacity forecasts are represented as predicted values, or data points, that are calculated using historical data points from a specified CloudWatch load metric. Data points are available for up to 56 days. </p>
  ## 
...
proc call*(call_21626087: Call_GetScalingPlanResourceForecastData_21626074;
          body: JsonNode): Recallable =
...
var getScalingPlanResourceForecastData* = Call_GetScalingPlanResourceForecastData_21626074(
    ...
    validator: validate_GetScalingPlanResourceForecastData_21626075, base: "/",
    makeUrl: url_GetScalingPlanResourceForecastData_21626076,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_UpdateScalingPlan_21626089 = ref object of OpenApiRestCall_21625435
proc url_UpdateScalingPlan_21626091(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UpdateScalingPlan_21626090(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_21626101: Call_UpdateScalingPlan_21626089; path: JsonNode = nil;
          query: JsonNode = nil; header: JsonNode = nil; formData: JsonNode = nil;
          body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Updates the specified scaling plan.</p> <p>You cannot update a scaling plan if it is in the process of being created, updated, or deleted.</p>
  ## 
...
proc call*(call_21626102: Call_UpdateScalingPlan_21626089; body: JsonNode): Recallable =
  ## updateScalingPlan
  ## <p>Updates the specified scaling plan.</p> <p>You cannot update a scaling plan if it is in the process of being created, updated, or deleted.</p>
  ##   body: JObject (required)
...
var updateScalingPlan* = Call_UpdateScalingPlan_21626089(name: "updateScalingPlan",
    ...
    validator: validate_UpdateScalingPlan_21626090, base: "/",
    makeUrl: url_UpdateScalingPlan_21626091, schemes: {Scheme.Https, Scheme.Http})
export
  rest
