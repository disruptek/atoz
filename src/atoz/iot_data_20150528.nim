...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "data.iot.ap-northeast-1.amazonaws.com", "ap-southeast-1": "data.iot.ap-southeast-1.amazonaws.com",
                               ...
                               "us-east-1": "data.iot.us-east-1.amazonaws.com", "cn-northwest-1": "data.iot.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "data.iot.ap-south-1.amazonaws.com", "eu-north-1": "data.iot.eu-north-1.amazonaws.com", "ap-northeast-2": "data.iot.ap-northeast-2.amazonaws.com",
                               ...
                               "eu-west-1": "data.iot.eu-west-1.amazonaws.com", "us-gov-west-1": "data.iot.us-gov-west-1.amazonaws.com", "ap-southeast-2": "data.iot.ap-southeast-2.amazonaws.com", "ca-central-1": "data.iot.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_UpdateThingShadow_402656481 = ref object of OpenApiRestCall_402656038
proc url_UpdateThingShadow_402656483(protocol: Scheme; host: string;
...
proc validate_UpdateThingShadow_402656482(path: JsonNode; query: JsonNode;
...
proc call*(call_402656493: Call_UpdateThingShadow_402656481;
...
proc call*(call_402656494: Call_UpdateThingShadow_402656481; body: JsonNode;
  ...
  if body != nil:
    body_402656496 = body
  add(path_402656495, "thingName", newJString(thingName))
  result = call_402656494.call(path_402656495, nil, nil, nil, body_402656496)

var updateThingShadow* = Call_UpdateThingShadow_402656481(
    name: "updateThingShadow", meth: HttpMethod.HttpPost,
    host: "data.iot.amazonaws.com", route: "/things/{thingName}/shadow",
    validator: validate_UpdateThingShadow_402656482, base: "/",
    makeUrl: url_UpdateThingShadow_402656483,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetThingShadow_402656288 = ref object of OpenApiRestCall_402656038
proc url_GetThingShadow_402656290(protocol: Scheme; host: string; base: string;
...
proc validate_GetThingShadow_402656289(path: JsonNode; query: JsonNode;
...
proc call*(call_402656401: Call_GetThingShadow_402656288; path: JsonNode = nil;
...
proc call*(call_402656450: Call_GetThingShadow_402656288; thingName: string): Recallable =
  ## getThingShadow
  ## <p>Gets the thing shadow for the specified thing.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/iot/latest/developerguide/API_GetThingShadow.html">GetThingShadow</a> in the <i>AWS IoT Developer Guide</i>.</p>
  ##   
                                                                                                                                                                                                                                            ## thingName: string (required)
  ...
  add(path_402656451, "thingName", newJString(thingName))
  result = call_402656450.call(path_402656451, nil, nil, nil, nil)

var getThingShadow* = Call_GetThingShadow_402656288(name: "getThingShadow",
    meth: HttpMethod.HttpGet, host: "data.iot.amazonaws.com",
    route: "/things/{thingName}/shadow", validator: validate_GetThingShadow_402656289,
    base: "/", makeUrl: url_GetThingShadow_402656290,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_DeleteThingShadow_402656497 = ref object of OpenApiRestCall_402656038
proc url_DeleteThingShadow_402656499(protocol: Scheme; host: string;
                                     base: string; route: string;
                                     path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DeleteThingShadow_402656498(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656508: Call_DeleteThingShadow_402656497;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Deletes the thing shadow for the specified thing.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/iot/latest/developerguide/API_DeleteThingShadow.html">DeleteThingShadow</a> in the <i>AWS IoT Developer Guide</i>.</p>
                                                                                         ## 
...
proc call*(call_402656509: Call_DeleteThingShadow_402656497; thingName: string): Recallable =
  ## deleteThingShadow
  ## <p>Deletes the thing shadow for the specified thing.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/iot/latest/developerguide/API_DeleteThingShadow.html">DeleteThingShadow</a> in the <i>AWS IoT Developer Guide</i>.</p>
  ##   
                                                                                                                                                                                                                                                     ## thingName: string (required)
  ...
  add(path_402656510, "thingName", newJString(thingName))
  result = call_402656509.call(path_402656510, nil, nil, nil, nil)

var deleteThingShadow* = Call_DeleteThingShadow_402656497(
    name: "deleteThingShadow", meth: HttpMethod.HttpDelete,
    host: "data.iot.amazonaws.com", route: "/things/{thingName}/shadow",
    validator: validate_DeleteThingShadow_402656498, base: "/",
    makeUrl: url_DeleteThingShadow_402656499,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_Publish_402656511 = ref object of OpenApiRestCall_402656038
proc url_Publish_402656513(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_Publish_402656512(path: JsonNode; query: JsonNode;
                                header: JsonNode; formData: JsonNode;
                                body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656524: Call_Publish_402656511; path: JsonNode = nil;
           query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## <p>Publishes state information.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/iot/latest/developerguide/protocols.html#http">HTTP Protocol</a> in the <i>AWS IoT Developer Guide</i>.</p>
                                                                                         ## 
...
proc call*(call_402656525: Call_Publish_402656511; topic: string;
           body: JsonNode; qos: int = 0): Recallable =
  ## publish
  ## <p>Publishes state information.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/iot/latest/developerguide/protocols.html#http">HTTP Protocol</a> in the <i>AWS IoT Developer Guide</i>.</p>
  ##   
  ...
  ##   
                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                         ## (QoS) 
                                                                                                                                                                                                                                                         ## level.
  var path_402656526 = newJObject()
  var query_402656527 = newJObject()
  var body_402656528 = newJObject()
  add(path_402656526, "topic", newJString(topic))
  if body != nil:
    body_402656528 = body
  add(query_402656527, "qos", newJInt(qos))
  result = call_402656525.call(path_402656526, query_402656527, nil, nil, body_402656528)

var publish* = Call_Publish_402656511(name: "publish",
                                      meth: HttpMethod.HttpPost,
                                      host: "data.iot.amazonaws.com",
                                      route: "/topics/{topic}",
                                      validator: validate_Publish_402656512,
                                      base: "/", makeUrl: url_Publish_402656513,
                                      schemes: {Scheme.Https, Scheme.Http})
export
  rest
