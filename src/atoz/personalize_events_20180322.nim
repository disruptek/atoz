...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "personalize-events.ap-northeast-1.amazonaws.com", "ap-southeast-1": "personalize-events.ap-southeast-1.amazonaws.com", "us-west-2": "personalize-events.us-west-2.amazonaws.com", "eu-west-2": "personalize-events.eu-west-2.amazonaws.com", "ap-northeast-3": "personalize-events.ap-northeast-3.amazonaws.com", "eu-central-1": "personalize-events.eu-central-1.amazonaws.com", "us-east-2": "personalize-events.us-east-2.amazonaws.com", "us-east-1": "personalize-events.us-east-1.amazonaws.com", "cn-northwest-1": "personalize-events.cn-northwest-1.amazonaws.com.cn", "ap-south-1": "personalize-events.ap-south-1.amazonaws.com", "eu-north-1": "personalize-events.eu-north-1.amazonaws.com", "ap-northeast-2": "personalize-events.ap-northeast-2.amazonaws.com", "us-west-1": "personalize-events.us-west-1.amazonaws.com", "us-gov-east-1": "personalize-events.us-gov-east-1.amazonaws.com", "eu-west-3": "personalize-events.eu-west-3.amazonaws.com", "cn-north-1": "personalize-events.cn-north-1.amazonaws.com.cn", "sa-east-1": "personalize-events.sa-east-1.amazonaws.com", "eu-west-1": "personalize-events.eu-west-1.amazonaws.com", "us-gov-west-1": "personalize-events.us-gov-west-1.amazonaws.com", "ap-southeast-2": "personalize-events.ap-southeast-2.amazonaws.com", "ca-central-1": "personalize-events.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_PutEvents_402656288 = ref object of OpenApiRestCall_402656038
proc url_PutEvents_402656290(protocol: Scheme; host: string; base: string;
...
proc validate_PutEvents_402656289(path: JsonNode; query: JsonNode;
...
proc call*(call_402656393: Call_PutEvents_402656288; path: JsonNode = nil;
...
proc call*(call_402656442: Call_PutEvents_402656288; body: JsonNode): Recallable =
  ## putEvents
  ## Records user interaction event data.
  ##   body: JObject (required)
...
var putEvents* = Call_PutEvents_402656288(name: "putEvents",
    meth: HttpMethod.HttpPost, host: "personalize-events.amazonaws.com",
    route: "/events", validator: validate_PutEvents_402656289, base: "/",
    makeUrl: url_PutEvents_402656290, schemes: {Scheme.Https, Scheme.Http})
export
  rest
