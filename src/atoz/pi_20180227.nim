...
const
  awsServers = {Scheme.Https: {"ap-northeast-1": "pi.ap-northeast-1.amazonaws.com", "ap-southeast-1": "pi.ap-southeast-1.amazonaws.com",
                               "us-west-2": "pi.us-west-2.amazonaws.com",
                               "eu-west-2": "pi.eu-west-2.amazonaws.com", "ap-northeast-3": "pi.ap-northeast-3.amazonaws.com",
                               ...
                               "eu-north-1": "pi.eu-north-1.amazonaws.com", "ap-northeast-2": "pi.ap-northeast-2.amazonaws.com",
                               "us-west-1": "pi.us-west-1.amazonaws.com", "us-gov-east-1": "pi.us-gov-east-1.amazonaws.com",
                               "eu-west-3": "pi.eu-west-3.amazonaws.com",
                               "cn-north-1": "pi.cn-north-1.amazonaws.com.cn",
                               "sa-east-1": "pi.sa-east-1.amazonaws.com",
                               "eu-west-1": "pi.eu-west-1.amazonaws.com", "us-gov-west-1": "pi.us-gov-west-1.amazonaws.com", "ap-southeast-2": "pi.ap-southeast-2.amazonaws.com",
                               "ca-central-1": "pi.ca-central-1.amazonaws.com"}.toTable, Scheme.Http: {
...
type
  Call_DescribeDimensionKeys_402656288 = ref object of OpenApiRestCall_402656038
proc url_DescribeDimensionKeys_402656290(protocol: Scheme; host: string;
...
proc validate_DescribeDimensionKeys_402656289(path: JsonNode; query: JsonNode;
...
proc call*(call_402656406: Call_DescribeDimensionKeys_402656288;
...
proc call*(call_402656455: Call_DescribeDimensionKeys_402656288; body: JsonNode): Recallable =
...
var describeDimensionKeys* = Call_DescribeDimensionKeys_402656288(
    ...
    validator: validate_DescribeDimensionKeys_402656289, base: "/",
    makeUrl: url_DescribeDimensionKeys_402656290,
    schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResourceMetrics_402656483 = ref object of OpenApiRestCall_402656038
proc url_GetResourceMetrics_402656485(protocol: Scheme; host: string;
...
proc validate_GetResourceMetrics_402656484(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode; _: string = ""): JsonNode {.
    nosinks.} =
...
proc call*(call_402656495: Call_GetResourceMetrics_402656483;
           path: JsonNode = nil; query: JsonNode = nil; header: JsonNode = nil;
           formData: JsonNode = nil; body: JsonNode = nil; _: string = ""): Recallable =
  ## Retrieve Performance Insights metrics for a set of data sources, over a time period. You can provide specific dimension groups and dimensions, and provide aggregation and filtering criteria for each group.
                                                                                         ## 
...
proc call*(call_402656496: Call_GetResourceMetrics_402656483; body: JsonNode): Recallable =
  ## getResourceMetrics
  ## Retrieve Performance Insights metrics for a set of data sources, over a time period. You can provide specific dimension groups and dimensions, and provide aggregation and filtering criteria for each group.
  ##   
                                                                                                                                                                                                                  ## body: JObject (required)
...
var getResourceMetrics* = Call_GetResourceMetrics_402656483(
    name: "getResourceMetrics", meth: HttpMethod.HttpPost,
    host: "pi.amazonaws.com",
    route: "/#X-Amz-Target=PerformanceInsightsv20180227.GetResourceMetrics",
    validator: validate_GetResourceMetrics_402656484, base: "/",
    makeUrl: url_GetResourceMetrics_402656485,
    schemes: {Scheme.Https, Scheme.Http})
export
  rest
