...
type
  Call_DescribeDimensionKeys_593761 = ref object of OpenApiRestCall_593424
proc url_DescribeDimensionKeys_593763(protocol: Scheme; host: string; base: string;
...
proc validate_DescribeDimensionKeys_593762(path: JsonNode; query: JsonNode;
...
proc call*(call_593919: Call_DescribeDimensionKeys_593761; path: JsonNode;
...
proc call*(call_593990: Call_DescribeDimensionKeys_593761; body: JsonNode): Recallable =
...
var describeDimensionKeys* = Call_DescribeDimensionKeys_593761(
    ...
    validator: validate_DescribeDimensionKeys_593762, base: "/",
    url: url_DescribeDimensionKeys_593763, schemes: {Scheme.Https, Scheme.Http})
type
  Call_GetResourceMetrics_594030 = ref object of OpenApiRestCall_593424
proc url_GetResourceMetrics_594032(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_GetResourceMetrics_594031(path: JsonNode; query: JsonNode;
...
proc call*(call_594042: Call_GetResourceMetrics_594030; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieve Performance Insights metrics for a set of data sources, over a time period. You can provide specific dimension groups and dimensions, and provide aggregation and filtering criteria for each group.
  ## 
...
proc call*(call_594043: Call_GetResourceMetrics_594030; body: JsonNode): Recallable =
  ## getResourceMetrics
  ## Retrieve Performance Insights metrics for a set of data sources, over a time period. You can provide specific dimension groups and dimensions, and provide aggregation and filtering criteria for each group.
  ##   body: JObject (required)
...
var getResourceMetrics* = Call_GetResourceMetrics_594030(
    ...
    validator: validate_GetResourceMetrics_594031, base: "/",
    url: url_GetResourceMetrics_594032, schemes: {Scheme.Https, Scheme.Http})
export
  rest
